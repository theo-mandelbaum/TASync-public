 ...
 * @private
 */
export declare function updatePhaseLaneGrids(sourceIndex: number, targetIndex: number, swimlane: NodeModel, diagram: Diagram): void;
/**
 ...
 * @private
 */
export declare function updateSwimLaneObject(diagram: Diagram, obj: Node, swimLane: NodeModel, helperObject: NodeModel, widthDiff?: number, heightDiff?: number): void;
/**
 ...
 * @private
 */
export declare function addHorizontalPhase(diagram: Diagram, node: NodeModel, grid: GridPanel, index: number, orientation: boolean, newPhase: PhaseModel): void;
/**
 ...
 * @private
 */
export declare function addVerticalPhase(diagram: Diagram, node: NodeModel, grid: GridPanel, rowIndex: number, orientation: boolean, newPhase: PhaseModel): void;
/**
 ...
 * @private
 */
export declare function removeLaneGridFromPhase(child: Canvas, swimlane: NodeModel, diagram: Diagram): void;
/**
 ...
 * @private
 */
export declare function isParentNodeSelected(node: Node, diagram: Diagram): boolean;
/**
 ...
 * @private
 */
export declare function checkSameLaneNodes(node1: Node, node2: Node, diagram: Diagram): boolean;
/**
