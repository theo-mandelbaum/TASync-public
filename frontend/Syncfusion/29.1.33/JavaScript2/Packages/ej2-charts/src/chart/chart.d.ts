...
import { ToolbarPositionModel, StackLabelSettingsModel } from './model/chart-base-model';
...
export declare class Chart extends Component<HTMLElement> implements INotifyPropertyChanged {
     ...
     * @private
     */
    chartKeyboardNavigations(e: KeyboardEvent, targetId: string, actionKey: string): void;
    /**
