 ...
 */
export declare type TablePasteOptions = 'InsertAsRows' | 'NestTable' | 'InsertAsColumns' | 'OverwriteCells';
/**
 * Specifies the paste options for table
 *
 * @private
 */
export declare type PasteOptionSwitch = 'DefaultPaste' | 'TextOnly';
/**
 ...
 * @private
 */
export declare type VerticalAlignment = 'None' | 'Top' | 'Bottom' | 'Inline' | 'Inside' | 'Outside' | 'Center' | 'Middle';
/**
 ...
 * @private
 */
export declare type FontHintType = 'Default' | 'EastAsia' | 'CS';
/**
 ...
 * @private
 */
export declare const CONTROL_CHARACTERS: any;
