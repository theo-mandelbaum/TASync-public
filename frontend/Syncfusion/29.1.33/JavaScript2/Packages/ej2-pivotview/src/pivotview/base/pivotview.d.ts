...
import { PivotEngine, IAxisSet, IDataSet } from '../../base/engine';
import { IGroupSettings } from '../../base/engine';
...
import { MultiLevelLabelClickEventArgs, AfterServiceInvokeEventArgs, PivotColumn, ChartLabelInfo, PivotActionFailureEventArgs } from '../../common/base/interface';
...
import { EditMode, ToolbarItems, View, Primary, AggregateTypes, ChartSeriesType, PagerPosition } from '../../common';
 ...
 */
export declare class PagerSettings extends ChildProperty<PagerSettings> {
    /**
 ...
 */
export declare class VirtualScrollSettings extends ChildProperty<VirtualScrollSettings> {
    /**
...
export declare class PivotView extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    minHeight: number;
    /** @hidden */
    allowEngineExport: boolean;
    /** @hidden */
    exportSpecifiedPages: ExportPageSize;
    /** @hidden */
    isTabular: boolean;
    pivotView: PivotView;
    /** @hidden */
    ...
    private virtualTableDiv;
    private virtualScrollDiv;
    /** @hidden */
    gridCellCollection: {
    ...
    /** @hidden */
    pivotDeferLayoutUpdate: boolean;
    /**
    ...
    private onSuccess;
    /** @hidden */
    getEngine(action: string, drillItem?: IDrilledItem, sortItem?: ISort, aggField?: IFieldOptions, cField?: ICalculatedFields, filterItem?: IFilter, memberName?: string, rawDataArgs?: FetchRawDataArgs, editArgs?: UpdateRawDataArgs, excelExportProperties?: ExcelExportProperties): void;
    /**
     ...
     * @returns {string} - string.
     */
    getPersistData(isRemoveDatasource?: boolean): string;
    /**
     * Loads pivot Layout
     *
     ...
     * @private
     */
    templateParser(template: string | Function): Function;
    /**
     ...
     * @returns {void}
     */
    excelExport(excelExportProperties?: ExcelExportProperties, isMultipleExport?: boolean, workbook?: Workbook, isBlob?: boolean): void;
    /**
     ...
     * @returns {void}
     */
    csvExport(excelExportProperties?: ExcelExportProperties, isMultipleExport?: boolean, workbook?: Workbook, isBlob?: boolean): void;
    /**
     *
     ...
     */
    chartExport(type: ExportType, pdfExportProperties?: PdfExportProperties, isMultipleExport?: boolean, pdfDoc?: Object, isBlob?: boolean): Promise<Object>;
    /**
     ...
     */
    pdfExport(pdfExportProperties?: PdfExportProperties, isMultipleExport?: boolean, pdfDoc?: Object, isBlob?: boolean, exportBothTableAndChart?: boolean): Promise<Object>;
    /**
    ...
    private rowDeselect;
    /** @hidden */
    clearSelection(ele: Element, e: MouseEvent | KeyboardEventArgs): void;
    /** @hidden */
     ...
     * @hidden
     */
    getHeaderSortInfo(sortingObj: HeadersSortEventArgs): HeadersSortEventArgs;
    /**
     * De-Register the internal events.
     *
    ...
    /** @hidden */
    applyFormatting(pivotValues: IAxisSet[][]): void;
