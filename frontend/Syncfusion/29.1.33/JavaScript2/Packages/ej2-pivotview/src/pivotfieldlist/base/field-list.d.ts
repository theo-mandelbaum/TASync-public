...
export declare class PivotFieldList extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    /** @hidden */
    staticPivotGridModule: PivotView;
    /** @hidden */
     ...
     * @hidden
     */
    frameCustomProperties(fieldListData?: IOlapField[], fieldList?: IOlapFieldListOptions): ICustomProperties | IOlapCustomProperties;
    /**
