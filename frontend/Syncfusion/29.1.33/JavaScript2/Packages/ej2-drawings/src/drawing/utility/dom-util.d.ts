...
/** @private */
export declare function measureText(text: TextElement, style: TextStyleModel, content: string, maxWidth?: number, maxHeight?: number, pageHeight?: number, textValue?: string): Size;
/** @private */
