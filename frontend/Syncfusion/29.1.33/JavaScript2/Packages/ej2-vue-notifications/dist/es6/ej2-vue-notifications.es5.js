...
var ButtonModelPropsDirective = vueDefineComponent({
 ...
 * ```
 */
var ButtonModelPropDirective = vueDefineComponent({
    render: function () {
        return;
    },
    methods: {
 ...
 * ```
 */
var ToastComponent = vueDefineComponent({
    name: 'ToastComponent',
...
var properties$1 = ['isLazyUpdate', 'plugins', 'content', 'cssClass', 'enablePersistence', 'enableRtl', 'locale', 'severity', 'showCloseIcon', 'showIcon', 'variant', 'visible', 'closed', 'created', 'destroyed'];
var modelProps$1 = [];
 ...
 * ```
 */
var MessageComponent = vueDefineComponent({
...
var properties$2 = ['isLazyUpdate', 'plugins', 'cssClass', 'enablePersistence', 'enableRtl', 'height', 'label', 'locale', 'shape', 'shimmerEffect', 'visible', 'width'];
var modelProps$2 = [];
 ...
 * ```
 */
var SkeletonComponent = vueDefineComponent({
