ej.base.enableRipple(window.ripple)
    ...
    var carouselObj = new ej.navigations.Carousel({
        ...
        items: [
            ...
            { template: '<figure class="img-container"><img src="//npmci.syncfusion.com/development/demos/src/carousel/images/trees.jpg" alt="spring_trees" style="height:100%;width:100%;" /><figcaption class="img-caption">Spring Flower Trees</figcaption></figure>' },
