ej.base.enableRipple(window.ripple)
    ...
    window.getConsultantImage = function (value) {
        ...
        if (resourceName === "GENERAL" || resourceName === "DENTAL") {
            ...
            return "<img class='specialist-img' src='//npmci.syncfusion.com/development/demos/src/schedule/images/" + resourceName.toLowerCase() + ".png'  alt='" + resourceName.toLowerCase() + "' />";
        }
    };
