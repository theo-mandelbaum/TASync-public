...
var andrewBackground = '#ffefef';
    ...
    var listObj = new ej.dropdowns.DropDownList({
        ...
        valueTemplate: function(data) {
          return '<div style="display:flex;">' +
                 '<img class="value" style="border: 1px solid ' + getBorderColor(data.Mail) + '; margin: 0px 0px 5px 15px; border-radius:50%;" src="//npmci.syncfusion.com/development/demos/src/pdfviewer/images/employees/' + data.Eimg + '.png" height="32px" width="32px" alt="employee" />' +
    ...
    finishBtnObj.element.onclick = function(){
        ...
        var url = "https://services.syncfusion.com/js/production/api/pdfviewer/FlattenDownload";
