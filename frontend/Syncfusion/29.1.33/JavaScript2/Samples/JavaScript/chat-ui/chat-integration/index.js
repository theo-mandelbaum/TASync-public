ej.base.enableRipple(window.ripple)
    ...
    function setupChatUser(index) {
        const userSettings = [
            ...
            { headerText: 'Decor bot', headerIconCss: 'chat_bot_avatar', user: { id: 'admin', user: 'Admin', avatarUrl: '//npmci.syncfusion.com/development/demos/src/chat-ui/images/bot.png' }, messages: chatMessages.admin , suggestions: window.chatSuggestions },
