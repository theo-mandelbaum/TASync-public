...
window.chatSuggestions = ["Bedroom", "Kitchen"];

window.walterMessagedata = [
    {
...
window.defaultChatSuggestions = [ "Awesome!", "What kind of painting ?" ];

window.integrationListTemplateData = [
    {
        id: '01',
        title: 'Albert',
