ej.base.enableRipple(window.ripple)
    ...
    var maps = new ej.maps.Maps({
        ...
        load: function (args) {
            // custom code start
            var themeValue = location.hash.split('/')[1];
            themeValue = themeValue ? themeValue : 'Material';
            args.maps.theme = (themeValue.charAt(0).toUpperCase() +
            themeValue.slice(1)).replace(/-dark/i, 'Dark').replace(/contrast/i, 'Contrast').replace(/-high/i, 'High').replace(/5.3/i, '5');
            // custom code end
        },
        titleSettings: {
            textStyle: {
                ...
                markerSettings: [
                    {
                        clusterSettings: {
                            ...
                            shape: 'Image',
                            height: 40, width: 40,
                            imageUrl: '//npmci.syncfusion.com/development/demos/src/maps/images/cluster-france.svg'
                        },
                        visible: true,
                        dataSource: [
                    ...
                    },
                    {
                        clusterSettings: {
                            ...
                            imageUrl: '//npmci.syncfusion.com/development/demos/src/maps/images/cluster-usa.svg'
                        },
                        visible: true,
                        shape: 'Circle',
                        height: 15,
                    ...
                    },
                    {
                        clusterSettings: {
                            ...
                            imageUrl: '//npmci.syncfusion.com/development/demos/src/maps/images/cluster-india.svg'
                        },
                        dataSource: [
                    ...
                    },
                    {
                        ...
                        clusterSettings: {
                            ...
                            height: 40, width: 40,
                            imageUrl: '//npmci.syncfusion.com/development/demos/src/maps/images/cluster-china.svg'
                        },
                        animationDuration: 0
                    }
                ]
