ej.base.enableRipple(window.ripple)
    ...
    var progressLoad = function (args) {
        ...
        if (args.progressBar.element.id === 'label-container') {
            ...
            args.progressBar.annotations[0].content = '<img src="//npmci.syncfusion.com/development/demos/src/progress-bar/images/' + customTheme.replace(/-/i, '') + '-Download.svg" alt="Download Icon"></img>';
        }
        else {
            args.progressBar.annotations[0].content = '<img src="//npmci.syncfusion.com/development/demos/src/progress-bar/images/' + customTheme.replace(/-/i, '') + '-pause.svg" alt="Pause Icon"></img>';
        }
    };
