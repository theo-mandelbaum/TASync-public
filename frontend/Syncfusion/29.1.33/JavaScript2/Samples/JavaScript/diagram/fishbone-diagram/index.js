...
/**
 * Sample for Fishbone diagram
 */

/**
 * Initializes the diagram control with default settings.
 */
    ...
    // Function to create an ellipse node
    function createEllipseNode(id, height, width, offsetX, offsetY, content) {
        return {
            id: id,
            height: height,
            width: width,
            ...
            style: { fill: 'white', strokeColor: '#A52A2A' }
        };
    }
