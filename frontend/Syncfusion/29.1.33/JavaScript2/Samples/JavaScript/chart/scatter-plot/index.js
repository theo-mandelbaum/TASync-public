 ...
 */
    ...
    var chart = new ej.charts.Chart({
        ...
        series: [
            {
                type: 'Scatter',
                dataSource: [   { Breadth : 41.3, Circumference : 78.1 },
            ...
            {
                type: 'Scatter',
                dataSource: [ { Breadth : 45.6, Circumference : 91.6 },
            ...
            {
                type: 'Scatter',
                dataSource: [ { Breadth : 47.6, Circumference : 96.5 },
            ...
            {
                type: 'Scatter',
                dataSource: [ { Breadth : 50.3, Circumference : 107.0 },
            ...
            {
                type: 'Scatter',
                dataSource: [ { Breadth : 53.1, Circumference : 121.3 },
