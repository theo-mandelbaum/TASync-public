ej.base.enableRipple(window.ripple)
    ...
    var Columns = [
        { field: 'Eimg', header: 'Photos', width: 90, headerTemplate: '<div class="header"> <span>Photo</span> </div>', template: '<div><img class="empImage" src="//npmci.syncfusion.com/development/demos/src/multicolumn-combobox/Employees/${Eimg}.png" alt="employee"/> </div>'},
