...
export class API extends SampleBase {
    ...
    render() {
        ...
        <div id="description">
          <p>Pager allows you to display the contents in page segments. The number of items on a page is determined by the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/pager/api-pagerComponent.html#pagesize-number">
            pageSize
        </a></code> property. If no value is specified for the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/pager/api-pagerComponent.html#pagesize-number">
              pageSize
        </a></code> property, the Pager will display 12 items on a page.</p>
          <p>In this demo,</p>
          <ul>
            <li>Change value of <strong>Page Count</strong> textbox to change <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/pager/api-pagerComponent.html#pagecount-number">
              pageCount
        </a></code>.</li>
            <li>Change value of <strong>Current Page</strong> textbox to change
                <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/pager/api-pagerComponent.html#currentpage-number">
                currentPage
        </a></code>.</li>
            <li>Change value of <strong>Page Size</strong> textbox to change <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/pager/api-pagerComponent.html#pagesize-number">
              pageSize
        </a></code>.</li>
            <li>Change value of <strong>totalrecords</strong> textbox to change <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/pager/api-pagerComponent.html#totalrecordscount-number">
              totalRecordsCount
        </a></code>.</li>
          </ul>
        </div>
