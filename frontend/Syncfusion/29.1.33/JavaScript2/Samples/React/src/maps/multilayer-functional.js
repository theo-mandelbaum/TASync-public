        ...
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-md-12' },
                    React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", loaded: onMapsLoad, load: load, zoomSettings: { enable: true, pinchZooming: true }, titleSettings: { text: 'Samsung Semiconductor office locations in USA', textStyle: { size: '16px' } } },
                        ...
                        React.createElement(ej2_react_maps_1.LayersDirective, null,
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: usa, shapeSettings: { fill: '#E5E5E5', border: { color: 'black', width: 0.1 } }, dataLabelSettings: { visible: true, labelPath: 'iso_3166_2', smartLabelMode: 'Hide', textStyle: { color: 'black' } } }),
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: california, type: 'SubLayer', shapeSettings: { fill: 'rgba(141, 206, 255, 0.6)', border: { color: '#1a9cff', width: 0.25 } } },
                                React.createElement(ej2_react_maps_1.MarkersDirective, null,
                                    React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, width: 20, fill: 'white', height: 20, template: '<svg id="markertemplate" width="20" height="20" style={{display:none}}><circle class="svgcircle" cx=10 cy=10 r=6 stroke="rgba(77, 77, 77, 0.8)" fill="rgba(0, 77, 153, 0.8)"/></svg>', dataSource: [{ latitude: 37.3382082, longitude: -121.8863286, name: 'San Jose' }], tooltipSettings: { visible: true, valuePath: 'name', format: '<b>${name}</b><br>Regional Office,<br>Research and Development Center' } }),
                                    React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, dataSource: [{ latitude: 37.09023980307208, longitude: -119.35546875000001 }], template: '<div style="color:black;">CA</div>' }))),
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: texas, type: 'SubLayer', shapeSettings: { fill: 'rgba(141, 206, 255, 0.5)', border: { color: '#1a9cff', width: 0.25 } } },
                                React.createElement(ej2_react_maps_1.MarkersDirective, null,
                                    React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, animationDuration: 0, fill: 'white', width: 20, height: 20, template: '<svg id="markertemplate" width="20" height="20" style={{display:none}}><circle class="svgcircle" cx=10 cy=10 r=6 stroke="rgba(77, 77, 77, 0.8)" fill="rgba(0, 77, 153, 0.8)"/></svg>', dataSource: [{ latitude: 30.267153, longitude: -97.7430608, name: 'Austin' }], tooltipSettings: { visible: true, valuePath: 'name', format: '<b>${name}</b><br>Manufacturing Center,<br>Research and Development Center' } }),
                                    React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, dataSource: [{ latitude: 31.80289258670676, longitude: -98.96484375 }], template: '<div style="color:black;">TX</div>' }))))))),
...
exports.default = MultilayerMaps;
