...
var MarkerCluster = function () {
    ...
    var template = '<div id="template" style="width: 140px;opacity: 90%;background: rgba(53, 63, 76, 0.90);box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.40);padding:10px;border: 1px #abb9c6;border-radius: 4px;">' + '<div style="font-size:13px;color:#ffffff;font-weight: 500;"><center>${city}</center></div>' + '<hr style="margin-top: 2px;margin-bottom:5px;border:0.5px solid #DDDDDD">' + '<div><span style="font-size:13px;color:#cccccc">Rank : </span><span style="font-size:13px;color:#ffffff;font-weight: 500;">${Rank}</span></div>' + '<div><span style="font-size:13px;color:#cccccc">Area : </span><span style="font-size:13px;color:#ffffff;font-weight: 500;">${area} sq kms</span></div></div>';
    ...
    return (React.createElement("main", null,
        React.createElement("div", { className: 'control-panel' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", load: load, useGroupingSeparator: true, format: 'n', zoomSettings: { enable: true }, titleSettings: { text: 'Top 50 largest cities in the World', textStyle: { size: '16px' } } },
                    ...
                    React.createElement(ej2_react_maps_1.LayersDirective, null,
                        React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: worldMap, shapeSettings: { fill: '#C1DFF5' }, markerClusterSettings: { allowClustering: true, shape: 'Image', height: 40, width: 40, labelStyle: { color: 'white' }, imageUrl: 'src/maps/images/cluster.svg' } },
                            React.createElement(ej2_react_maps_1.MarkersDirective, null,
                                React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, dataSource: datasource.cluster, shape: 'Image', imageUrl: 'src/maps/images/ballon.png', tooltipSettings: { visible: true, valuePath: 'area', template: template }, height: 20, width: 20, animationDuration: 0 })))))),
