                    ...
                    React.createElement("div", { className: 'col-md-12' },
                        React.createElement(ej2_react_maps_1.MapsComponent, { id: "container", loaded: this.onMapsLoad.bind(this), load: this.load, ref: function (m) { return _this.mapInstance = m; }, zoomSettings: {
                            ...
                            React.createElement(ej2_react_maps_1.LayersDirective, null,
                                React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: usa, shapePropertyPath: 'name', shapeDataPath: 'State', dataSource: datasource, tooltipSettings: {
                                        visible: false
                                    }, highlightSettings: {
                                        enable: true,
                                        fill: '#A3B0D0'
