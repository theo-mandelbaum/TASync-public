            ...
            React.createElement("div", { className: 'control-pane' },
                ...
                React.createElement("div", { className: 'control-section row' },
                    React.createElement("div", { className: 'col-md-8' },
                        React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", tooltipRender: this.tooltipRender.bind(this), loaded: this.onMapsLoad.bind(this), load: this.load, allowPrint: true, ref: function (m) { return _this.mapInstance = m; }, useGroupingSeparator: true, format: "n", legendSettings: {
                                visible: true,
                                mode: 'Interactive',
                                position: 'Bottom',
                                height: '10',
                            ...
                            React.createElement(ej2_react_maps_1.LayersDirective, null,
                                React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: usa, shapePropertyPath: 'name', shapeDataPath: 'name', dataSource: datasource.print, tooltipSettings: {
                                        visible: true,
