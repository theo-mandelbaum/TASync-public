...
import { MapsComponent, MapsTooltip, Marker, MarkersDirective, MarkerDirective, PdfExport, ImageExport, Inject, LayersDirective, LayerDirective } from '@syncfusion/ej2-react-maps';
        ...
        return (<main><div className='control-pane'>
                ...
                <div className='control-section row'>
                    <div className='col-md-8'>
                        <MapsComponent allowPdfExport={true} allowImageExport={true} id="maps" loaded={this.onMapsLoad.bind(this)} load={this.load} ref={m => this.mapInstance = m} titleSettings={{
                ...
                textStyle: {
                    size: '16px'
                            ...
                            <LayersDirective>
                                <LayerDirective shapeData={worldMap} shapeSettings={{
                fill: 'lightgrey',
