        ...
        return (<main><div className='control-pane'>
                ...
                <div className='control-section row'>
                    <div className='col-md-9'>
                        <MapsComponent id="maps" load={this.load} ref={m => this.mapInstance = m} useGroupingSeparator={true} format={"n"} zoomSettings={{
                enable: true,
                ...
                textStyle: {
                    size: '16px'
                            ...
                            <LayersDirective>
                                <LayerDirective shapeData={worldMap} shapePropertyPath='name' shapeDataPath='Country' dataSource={datasource.southAmericaCountryCapitals} shapeSettings={{
                fill: '#C3E6ED',
                border: {
                    color: 'black',
                    width: .3
