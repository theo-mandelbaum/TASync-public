...
var CyberAttackMaps = function () {
    (0, react_1.useEffect)(function () {
        (0, sample_base_1.updateSampleSection)();
    }, []);
    var navigationLineData = [
        {
            dashArray: '5,1',
            visible: true,
            angle: -0.3,
    ...
    return (React.createElement("main", null,
        React.createElement("div", { className: 'control-panel' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_maps_1.MapsComponent, { id: "container", loaded: loaded, load: load, zoomSettings: { enable: false }, titleSettings: { text: 'Cyber Attack Map of United States', textStyle: { size: '16px' } } },
                    ...
                    React.createElement(ej2_react_maps_1.LayersDirective, null,
                        React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: worldMap, shapeSettings: { border: { color: '#D2691E', width: 0.5 }, fill: '#FFFFE0' }, navigationLineSettings: navigationLineData },
                            React.createElement(ej2_react_maps_1.MarkersDirective, null,
                                React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, template: '<div id="marker_template"><div class="pulse-css"><br /><div class="name">{{:name}}</div></div></div>', animationDuration: 0, height: 15, width: 15, dataSource: markerData }),
                                React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, template: '<div id="parent_template"><div class="parent_css"><br/><div class="name" style="margin-left: -10px;margin-top: -2px">United States</div></div></div>', height: 20, width: 20, animationDuration: 0, dataSource: [{ latitude: 39.864171, longitude: -100.854833 }] })))))),
...
exports.default = CyberAttackMaps;
