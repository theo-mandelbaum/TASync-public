...
var ProjectionMaps = function () {
    (0, react_1.useEffect)(function () {
        (0, sample_base_1.updateSampleSection)();
    }, []);
    var _a = (0, react_1.useState)('Mercator'), projectionType = _a[0], setProjectionType = _a[1];
    ...
    var change = function (args) {
        mapInstance.current.projectionType = args.value;
        ...
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-md-8' },
                    React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", loaded: onMapsLoad, load: load, ref: mapInstance, zoomSettings: { enable: false }, legendSettings: { visible: true }, titleSettings: { text: 'Members of the UN Security Council', textStyle: { size: '16px' }, subtitleSettings: { text: '- In 2017', alignment: 'Far' } }, projectionType: projectionType },
                        ...
                        React.createElement(ej2_react_maps_1.LayersDirective, null,
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: worldMap, shapePropertyPath: 'name', shapeDataPath: 'Country', dataSource: datasource.projection, tooltipSettings: { visible: true, valuePath: 'Country' }, shapeSettings: shapeSettings })))),
                                ...
                                React.createElement("tr", { style: { height: '50px' } },
                                    ...
                                    React.createElement("td", { style: { width: '40%' } },
                                        React.createElement("div", { style: { marginRight: '0px' } },
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "100%", index: 0, change: change, dataSource: droplist, fields: { text: 'value', value: 'value' }, placeholder: 'Select projection type' }))))))))),
...
exports.default = ProjectionMaps;
