...
import { MapsComponent, Inject, LayersDirective, LayerDirective, MapsTooltip, Marker, Zoom, MarkerDirective, MarkersDirective } from '@syncfusion/ej2-react-maps';
        ...
        return (<main><div className='control-pane'>
                ...
                <div className='control-section row'>
                    <div className='col-md-12'>
                        <MapsComponent id="maps" load={this.load} useGroupingSeparator={true} format={"n"} titleSettings={{ text: 'Popular attractions around the world', textStyle: { size: '16px', fontFamily: 'inherit' } }} zoomSettings={{
                        ...
                        toolbarItems: ['Zoom', 'ZoomIn', 'ZoomOut', 'Pan', 'Reset']
                            ...
                            <LayersDirective>
                                <LayerDirective urlTemplate="https://tile.openstreetmap.org/level/tileX/tileY.png">
                                    <MarkersDirective>
                                        <MarkerDirective visible={true} shape='Circle' height={15} width={15} fill='#b38600' border={{
                color: '#e6f2ff',
                width: 2
            }} tooltipSettings={{
                ...
                { latitude: 49.4144, longitude: 0.8322, name: 'The D-Day Landing Beaches', state: 'Normandy', country: 'France' }
                                        ...
                                        <MarkerDirective visible={true} shape='Circle' height={15} width={15} fill='#bf4040' border={{
                color: '#e6f2ff',
                width: 2
            }} tooltipSettings={{
                visible: true, valuePath: 'population', format: '<b>Name:</b> ${name} <br/> <b>State:</b> ${state} <br/> <b>Country:</b> ${country}',
                ...
                { latitude: 28.521894, longitude: -80.681702, name: 'Kennedy Space Center Visitor Complex', state: 'Florida', country: 'United States of America' }
                                        ...
                                        <MarkerDirective visible={true} shape='Circle' height={15} width={15} fill='#00b3b3' border={{
                color: '#e6f2ff',
                width: 2
            }} tooltipSettings={{
                visible: true, valuePath: 'population', format: '<b>Name:</b> ${name} <br/> <b>State:</b> ${state} <br/> <b>Country:</b> ${country}',
                ...
                { latitude: 27.173891, longitude: 78.042068, name: 'The Taj Mahal', state: 'Uttar Pradesh', country: 'India' }
                                        ...
                                        <MarkerDirective visible={true} shape='Circle' height={15} width={15} fill='#b366ff' border={{
                color: '#e6f2ff',
                width: 2
            }} tooltipSettings={{
                visible: true, valuePath: 'population', format: '<b>Name:</b> ${name} <br/> <b>State:</b> ${state} <br/> <b>Country:</b> ${country}',
