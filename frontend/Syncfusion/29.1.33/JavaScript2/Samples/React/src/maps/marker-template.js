...
exports.MarkerTemplateMaps = void 0;
                    ...
                    React.createElement("div", { className: 'col-md-12' },
                        React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", loaded: this.onMapsLoad.bind(this), load: this.load, ref: function (m) { return _this.mapInstance = m; }, zoomSettings: {
                            ...
                            React.createElement(ej2_react_maps_1.LayersDirective, null,
                                React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: australia, tooltipSettings: {
                                        visible: false
                                    }, shapeSettings: {
                                        autofill: true,
                                    ...
                                    React.createElement(ej2_react_maps_1.MarkersDirective, null,
                                        React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, height: 30, width: 30, template: '<div><img alt="Marker weather clear image" style="height:30px;width:30px;display:block;  margin: auto;" src="src/maps/images/weather-clear.png" alt="Weather clear" /><p>{{:Name}}:{{:Temperature}}\u00B0C</p></div>', dataSource: [marker[0]] }),
                                        React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, height: 30, width: 30, template: '<div><img alt="Marker weather cloud image" style="height:30px;width:30px;display:block;  margin: auto;" src="src/maps/images/weather-clouds.png" alt="Weather cloud"/><p>{{:Name}}:{{:Temperature}}\u00B0C</p></div>', dataSource: [marker[1]] }),
                                        React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, height: 30, width: 30, template: '<div><img alt="Marker weather clear image" style="height:30px;width:30px;display:block;  margin: auto;" src="src/maps/images/weather-clear.png" alt="Weather clear"/><p>{{:Name}}:{{:Temperature}}\u00B0C</p></div>', dataSource: [marker[2]] }),
                                        React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, height: 30, width: 30, template: '<div><img alt="Marker weather rain image" style="height:30px;width:30px;display:block;  margin: auto;" src="src/maps/images/weather-rain.png" alt="Weather rain"/><p>{{:Name}}:{{:Temperature}}\u00B0C</p></div>', dataSource: [marker[3]] }),
                                        React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, height: 30, width: 30, template: '<div><img alt="Marker weather clear image" style="height:30px;width:30px;display:block;  margin: auto;" src="src/maps/images/weather-clear.png" alt="Weather clear"/><p>{{:Name}}:{{:Temperature}}\u00B0C</p></div>', dataSource: [marker[4]] }),
                                        React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, height: 30, width: 30, template: '<div><img alt="Marker weather cloud image" style="height:30px;width:30px;display:block;  margin: auto;" src="src/maps/images/weather-clouds.png" alt="Weather cloud"/><p>{{:Name}}:{{:Temperature}}\u00B0C</p></div>', dataSource: [marker[5]] })))))))),
