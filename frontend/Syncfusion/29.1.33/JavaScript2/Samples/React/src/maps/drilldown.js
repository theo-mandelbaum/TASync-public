                    ...
                    React.createElement("div", { className: 'col-md-12' },
                        React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", ref: function (m) { return _this.mapInstance = m; }, loaded: this.loaded, load: this.load, shapeSelected: this.shapeSelected.bind(this), zoomSettings: {
                            ...
                            React.createElement(ej2_react_maps_1.LayersDirective, null,
                                React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: worldMap, shapePropertyPath: 'continent', shapeDataPath: 'continent', dataSource: datasource.default, shapeSettings: {
                                ...
                                React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: africa, shapeSettings: {
                                        fill: '#80306A'
                                    }, highlightSettings: {
                                        enable: true,
                                        fill: '#80306A'
                                ...
                                React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: europe, shapeSettings: {
                                        fill: '#622D6C'
                                    }, highlightSettings: {
                                        enable: true,
                                        fill: '#622D6C'
                                ...
                                React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: asia, shapeSettings: {
                                        fill: '#462A6D'
                                    }, highlightSettings: {
                                        enable: true,
                                        fill: '#462A6D'
                                ...
                                React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: northAmerica, shapeSettings: {
                                        fill: '#C13664'
                                    }, highlightSettings: {
                                        enable: true,
                                        fill: '#C13664'
                                ...
                                React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: southAmerica, shapeSettings: {
                                        fill: '#9C3367'
                                    }, highlightSettings: {
                                        enable: true,
                                        fill: '#9C3367'
                                ...
                                React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: oceania, shapeSettings: {
                                        fill: '#2A2870'
                                    }, highlightSettings: {
                                        enable: true,
                                        fill: '#2A2870'
