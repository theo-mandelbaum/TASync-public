...
const ColorMap = () => {
    ...
    const [hideOne, setHideOne] = useState('hidden');
    const [hideTwo, setHideTwo] = useState('hidden');
    const [hideThree, setHideThree] = useState('hidden');
    let mapInstance = useRef(null);
    let typeElement = useRef(null);
    let minOpacityElement = useRef(null);
    let maxOpacityElement = useRef(null);
    let opacityElement = useRef(null);
    let dropList = [
