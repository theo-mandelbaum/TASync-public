        ...
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-md-12' },
                    React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", loaded: onMapsLoad, load: load, zoomSettings: { enable: false, zoomFactor: 7 }, mapsArea: { background: '#AEE2FA' }, titleSettings: { text: '7.6 Magnitude earthquake strikes Sumatra - 2009', textStyle: { size: '18px' } }, centerPosition: { latitude: 0.720, longitude: 99.867 } },
                        React.createElement(ej2_react_maps_1.Inject, { services: [ej2_react_maps_1.Zoom, ej2_react_maps_1.Marker] }),
                        React.createElement(ej2_react_maps_1.LayersDirective, null,
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: asiaMap, shapePropertyPath: 'name', shapeDataPath: 'name', shapeSettings: { fill: '#FFFDCF', border: { color: '#3497C3', width: 0.5 } } },
                                React.createElement(ej2_react_maps_1.MarkersDirective, null,
                                    React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, height: 100, width: 100, animationDuration: 0, template: marketTemp, dataSource: [{ latitude: 0.720, longitude: 99.867 }] })))))),
...
exports.default = EarthquakeMaps;
