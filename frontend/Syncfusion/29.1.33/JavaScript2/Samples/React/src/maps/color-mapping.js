                ...
                React.createElement("div", { className: 'col-lg-8 control-section' },
                    React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", load: this.load, ref: function (m) { return _this.mapInstance = m; }, titleSettings: {
                        ...
                        React.createElement(ej2_react_maps_1.LayersDirective, null,
                            React.createElement(ej2_react_maps_1.LayerDirective, { dataSource: datasource.color, shapeDataPath: 'State', shapeData: usa, shapePropertyPath: 'name', shapeSettings: {
                        ...
                        React.createElement("table", { id: 'property', role: 'none', title: 'Properties', className: 'property-panel-table', style: { width: '100%', marginBottom: '20px' } },
                            React.createElement("tbody", null,
                                ...
                                React.createElement("tr", { id: "hideTwo", style: { height: '50px' } },
                                    ...
                                    React.createElement("td", null,
                                        React.createElement("div", null,
                                            React.createElement("input", { type: "range", id: 'minOpacity', disabled: true, onChange: this.minOpacityChange.bind(this), ref: function (d) { return _this.minOpacityElement = d; }, min: "0", max: "1", step: "0.1", defaultValue: "0.5", style: { width: '100%' } })))),
                                React.createElement("tr", { id: "hideThree", style: { height: '50px' } },
                                    React.createElement("td", null,
                                        React.createElement("div", { style: { paddingLeft: '0px' } }, "Max Opacity")),
                                    React.createElement("td", null,
                                        React.createElement("div", null,
                                            React.createElement("input", { type: "range", id: 'maxOpacity', disabled: true, onChange: this.maxOpacityChange.bind(this), ref: function (d) { return _this.maxOpacityElement = d; }, min: "0", max: "1", step: "0.1", defaultValue: "1", style: { width: '100%' } }))))))))),
