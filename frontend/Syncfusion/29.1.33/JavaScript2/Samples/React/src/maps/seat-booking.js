...
exports.SeatBookingMaps = void 0;
                ...
                React.createElement("div", { className: 'control-section row' },
                    React.createElement("div", { className: 'col-md-8' },
                        ...
                        React.createElement("div", { style: { border: '3px solid darkgray', width: 200, display: 'block', margin: 'auto' } },
                            ...
                            React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", load: this.load, ref: function (m) { return _this.mapInstance = m; }, zoomSettings: {
                                    enable: false
                                ...
                                React.createElement(ej2_react_maps_1.LayersDirective, null,
                                    React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: seatSelection, geometryType: 'Normal', shapeSettings: {
                                            colorValuePath: 'fill'
                                        }, selectionSettings: {
                                            enable: true,
                                            opacity: 1,
