    ...
    return (<main><div className='control-pane'>
            ...
            <div className='control-section row'>
                <div className='col-md-12'>
                    <MapsComponent id="maps" load={load} useGroupingSeparator={true} format={"n"} titleSettings={{ text: 'Popular attractions around the world', textStyle: { size: '16px', fontFamily: 'inherit' } }} zoomSettings={{
