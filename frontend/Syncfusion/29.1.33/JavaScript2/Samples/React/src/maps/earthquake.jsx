...
.pulse-css {
  ...
  @keyframes pulse-me {
    ...
    `;
let marketTemp = '<div> <div class="pulse-container"><div class="pulse-box"><div class="pulse-css"></div></div></div></div>';
    ...
    render() {
        return (<main><div className='control-pane'>
                ...
                longitude: 99.867
                            ...
                            <LayersDirective>
                                <LayerDirective shapeData={asiaMap} shapePropertyPath='name' shapeDataPath='name' shapeSettings={{
                fill: '#FFFDCF',
                border: {
                    color: '#3497C3',
                    width: 0.5
