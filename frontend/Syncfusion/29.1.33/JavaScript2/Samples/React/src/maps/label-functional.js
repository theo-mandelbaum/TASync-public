...
var LabelMaps = function () {
    (0, react_1.useEffect)(function () {
        (0, sample_base_1.updateSampleSection)();
    }, []);
    var mapInstance = (0, react_1.useRef)(null);
    var dropElement1 = (0, react_1.useRef)(null);
    var dropElement2 = (0, react_1.useRef)(null);
    var droplist = [
        ...
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-md-8' },
                    React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", loaded: onMapsLoad, load: load, ref: mapInstance, zoomSettings: { enable: false } },
                        React.createElement(ej2_react_maps_1.Inject, { services: [ej2_react_maps_1.DataLabel, ej2_react_maps_1.MapsTooltip] }),
                        React.createElement(ej2_react_maps_1.LayersDirective, null,
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: usa, shapePropertyPath: 'iso_3166_2', dataLabelSettings: { visible: true, labelPath: 'name', smartLabelMode: 'Trim', intersectionAction: 'None' }, shapeSettings: { autofill: true }, tooltipSettings: { visible: true, valuePath: 'name' } })))),
                                ...
                                React.createElement("tr", { style: { height: '50px' } },
                                    ...
                                    React.createElement("td", null,
                                        React.createElement("div", { style: { marginTop: '3px' } },
                                            React.createElement("input", { type: "checkbox", onClick: showlabel.bind(_this), defaultChecked: true, id: "select", style: { marginTop: '0px', marginLeft: '0px' } })))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", null,
                                        React.createElement("div", { style: { paddingLeft: '0px' } }, "Smart label mode")),
                                    React.createElement("td", null,
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "100%", index: 0, change: smartlabel, ref: dropElement2, dataSource: droplist, fields: { text: 'text', value: 'value' }, placeholder: 'Select smartlabel mode' })))),
                                React.createElement("tr", { style: { height: "50px" } },
                                    React.createElement("td", null,
                                        React.createElement("div", { style: { paddingLeft: '0px' } }, "Intersect action")),
                                    React.createElement("td", null,
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "100%", index: 1, change: intersectaction, ref: dropElement1, dataSource: droplist, fields: { text: 'text', value: 'value' }, placeholder: 'Select intersect action' })))))))))),
