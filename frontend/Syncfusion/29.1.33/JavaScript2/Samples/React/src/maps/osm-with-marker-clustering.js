...
exports.OSMMarkerCluster = void 0;
var React = require("react");
var ej2_react_maps_1 = require("@syncfusion/ej2-react-maps");
var sample_base_1 = require("../common/sample-base");
var SAMPLE_CSS = "\n     .control-fluid {\n         padding: 0px !important;\n     }";
var OSMMarkerCluster = /** @class */ (function (_super) {
    __extends(OSMMarkerCluster, _super);
    function OSMMarkerCluster() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    OSMMarkerCluster.prototype.render = function () {
        return (React.createElement("main", null,
            React.createElement("div", { className: 'control-pane' },
                React.createElement("style", null, SAMPLE_CSS),
                React.createElement("div", { className: 'control-section row' },
                    React.createElement("div", { className: 'col-md-12' },
                        React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", load: this.load, useGroupingSeparator: true, format: "n", titleSettings: { text: 'Popular attractions around the world', textStyle: { size: '16px', fontFamily: 'inherit' } }, zoomSettings: {
    ...
    OSMMarkerCluster.prototype.load = function (args) {
        // custom code start
    ...
    ;
    return OSMMarkerCluster;
}(sample_base_1.SampleBase));
exports.OSMMarkerCluster = OSMMarkerCluster;
