...
const ZoomingMaps = () => {
    ...
    const [range1, setRange1] = useState('500ms');
    const [isDisableSingleTab, setIsDisableSingleTab] = useState(false);
    const [isDisableDoubleTab, setIsDisableDoubleTab] = useState(false);
    let mapInstance = useRef(null);
    let animationElement = useRef(null);
    ...
    return (<main><div className='control-pane'>
            ...
            <div className='control-section row'>
                <div className='col-md-8'>
                    <MapsComponent id="maps" loaded={onMapsLoad} load={load} ref={mapInstance} zoomSettings={{ enable: true, pinchZooming: true,
            toolbarSettings: {
                buttonSettings: {
