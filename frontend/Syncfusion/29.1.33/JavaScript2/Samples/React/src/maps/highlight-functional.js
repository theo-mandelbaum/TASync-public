...
var okalahomaMap = require("./map-data/okalahoma.json");
        ...
        React.createElement("div", { className: 'control-panel' },
            ...
            React.createElement("div", { className: 'control-section row' },
                ...
                React.createElement("div", { className: 'col-md-12' },
                    React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", loaded: onMapsLoad, load: load, zoomSettings: { enable: false, zoomFactor: 2 }, centerPosition: { latitude: 35.65, longitude: -97.3 } },
                        ...
                        React.createElement(ej2_react_maps_1.LayersDirective, null,
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: okalahomaMap, shapeSettings: { fill: '#F5F5F5', border: { color: '#EEDA97', width: 1 } } },
                                React.createElement(ej2_react_maps_1.MarkersDirective, null,
                                    React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, width: 20, height: 20, shape: 'Image', imageUrl: 'src/maps/images/ballon.png', fill: '#000080', border: { color: 'transparent' }, dataSource: marker2, tooltipSettings: { visible: true, valuePath: 'title' } }),
