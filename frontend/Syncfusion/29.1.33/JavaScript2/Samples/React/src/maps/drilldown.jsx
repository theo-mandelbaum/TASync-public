    ...
    render() {
        return (<main><div className='control-pane'>
                ...
                enable: false
                        ...
                        <LayersDirective>
                            <LayerDirective shapeData={worldMap} shapePropertyPath='continent' shapeDataPath='continent' dataSource={datasource.default} shapeSettings={{
                ...
                valuePath: 'continent'
                            ...
                            <LayerDirective shapeData={africa} shapeSettings={{
                fill: '#80306A'
            }} highlightSettings={{
                enable: true,
                fill: '#80306A'
                ...
                valuePath: 'name'
                            ...
                            <LayerDirective shapeData={europe} shapeSettings={{
                fill: '#622D6C'
            }} highlightSettings={{
                enable: true,
                fill: '#622D6C'
                ...
                valuePath: 'name'
                            ...
                            <LayerDirective shapeData={asia} shapeSettings={{
                fill: '#462A6D'
            }} highlightSettings={{
                enable: true,
                fill: '#462A6D'
                ...
                valuePath: 'name'
                            ...
                            <LayerDirective shapeData={northAmerica} shapeSettings={{
                fill: '#C13664'
            }} highlightSettings={{
                enable: true,
                fill: '#C13664'
                ...
                valuePath: 'name'
                            ...
                            <LayerDirective shapeData={southAmerica} shapeSettings={{
                fill: '#9C3367'
            }} highlightSettings={{
                enable: true,
                fill: '#9C3367'
                ...
                valuePath: 'name'
                            ...
                            <LayerDirective shapeData={oceania} shapeSettings={{
                fill: '#2A2870'
            }} highlightSettings={{
                enable: true,
                fill: '#2A2870'
