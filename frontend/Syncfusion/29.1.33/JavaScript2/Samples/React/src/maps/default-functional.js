    ...
    return (React.createElement("main", null,
        React.createElement("div", { className: 'control-panel' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", loaded: onMapsLoad.bind(_this), load: load, zoomSettings: { enable: false }, legendSettings: { visible: true }, titleSettings: { text: 'YouTube office locations', textStyle: { size: '16px' } } },
                    ...
                    React.createElement(ej2_react_maps_1.LayersDirective, null,
                        React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: worldMap, shapePropertyPath: 'continent', shapeDataPath: 'continent', dataSource: datasource.default, shapeSettings: { colorValuePath: 'color' } },
                            React.createElement(ej2_react_maps_1.MarkersDirective, null,
                                ...
                                React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, shape: 'Image', imageUrl: 'src/maps/images/ballon.png', height: 20, width: 20, animationDuration: 0, tooltipSettings: { visible: true, valuePath: 'name' }, dataSource: data })))))),
