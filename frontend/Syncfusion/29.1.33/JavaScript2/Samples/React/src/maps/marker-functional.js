        ...
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-md-9' },
                    React.createElement(ej2_react_maps_1.MapsComponent, { id: "maps", loaded: onMapsLoad, load: load, ref: mapInstance, useGroupingSeparator: true, format: "n", zoomSettings: { enable: false }, titleSettings: { text: 'Top 25 populated cities in the world', textStyle: { size: '16px' } } },
                        React.createElement(ej2_react_maps_1.Inject, { services: [ej2_react_maps_1.Marker, ej2_react_maps_1.MapsTooltip] }),
                        React.createElement(ej2_react_maps_1.LayersDirective, null,
                            React.createElement(ej2_react_maps_1.LayerDirective, { shapeData: worldMap, shapePropertyPath: 'name', shapeDataPath: 'Country', dataSource: datasource.population, shapeSettings: { fill: '#C3E6ED' } },
                                React.createElement(ej2_react_maps_1.MarkersDirective, null,
                                    React.createElement(ej2_react_maps_1.MarkerDirective, { visible: true, animationDuration: 0, shape: 'Circle', fill: 'white', width: 10, border: { color: '#285255', width: 2 }, dataSource: datasource.population, tooltipSettings: { template: template, visible: true, valuePath: 'population' } }))))),
                                ...
                                React.createElement("tr", { style: {} },
                                    ...
                                    React.createElement("td", { style: { width: "30%" } },
                                        React.createElement("div", { className: 'col', style: { paddingTop: '0px', marginTop: '-10px' } },
                                            React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: "shapeCheckBox", change: shapeChange })))),
                                React.createElement("tr", { style: {} },
                                    React.createElement("td", { style: { width: "70%" } },
                                        React.createElement("div", { className: 'property-text', style: { padding: '0px' } }, "Bind markers color from data source")),
                                    React.createElement("td", { style: { width: "30%" } },
                                        React.createElement("div", { className: "col", style: { paddingTop: '0px', marginTop: '-10px' } },
                                            React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: "colorCheckBox", change: colorChange })))))))))),
