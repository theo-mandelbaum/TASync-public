...
export class OutlookLayout extends SampleBase {
    ...
    content2() {
        return (<div className='splitter-content'>
                <ListViewComponent id='groupedList-split' fields={this.listFields} className='splitter-list' dataSource={this.dataSource} cssClass={'e-list-template'} template={this.listTemplate} ref={(listview) => { this.listViewObj = listview; }}/>
            </div>);
    }
    ;
    content3() {
    ...
    listTemplate = '<div class="settings e-list-wrapper e-list-multi-line e-list-avatar">' +
