...
const AccordionIntegration = () => {
    ...
    let items;
    let splitterInstance = useRef(null);
    let ListData1 = [
        { text: "Grid", id: "1" },
        { text: "Schedule", id: "2" },
        { text: "Chart", id: "7" }
    ...
    const accordionElement = () => {
        return (<AccordionComponent id="split_pane1" expanding={expanding.bind(this)} expanded={expand.bind(this)}>
    ...
    const splitlist1 = () => {
        return (<ListViewComponent id="split-list1" dataSource={ListData1} select={onSelect.bind(this)}/>);
    };
    const splitlist2 = () => {
        return (<ListViewComponent id="split-list2" dataSource={ListData2} select={onSelect.bind(this)}/>);
    };
    const splitlist3 = () => {
        return (<ListViewComponent id="split-list3" dataSource={ListData3} select={onSelect.bind(this)}/>);
    };
