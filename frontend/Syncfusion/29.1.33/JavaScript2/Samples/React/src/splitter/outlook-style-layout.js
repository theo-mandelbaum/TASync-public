...
var OutlookLayout = /** @class */ (function (_super) {
    ...
    OutlookLayout.prototype.content2 = function () {
        var _this = this;
        return (React.createElement("div", { className: 'splitter-content' },
            React.createElement(ej2_react_lists_1.ListViewComponent, { id: 'groupedList-split', fields: this.listFields, className: 'splitter-list', dataSource: this.dataSource, cssClass: 'e-list-template', template: this.listTemplate, ref: function (listview) { _this.listViewObj = listview; } })));
    };
    ;
