...
var ExpandCollapse = function () {
    ...
    var rightPaneContent1 = function () {
    ...
    var rightPaneContent2 = function () {
        return (React.createElement("div", { className: "splitter-content-expand" },
    ...
    var innerSplitterInstance = (0, react_1.useRef)(null);
    var splitterInstance = (0, react_1.useRef)(null);
    var leftPaneContent = function () {
        return (React.createElement("div", { className: "splitter-content-expand" },
    ...
    var onCreate = function (e) {
        ...
        var cont = innerSplitterInstance.current.element.querySelectorAll(".e-pane")[1];
    ...
    return (React.createElement("div", { id: "target", className: "control-section splitter-expand" },
        React.createElement(ej2_react_layouts_1.SplitterComponent, { id: "Expand", separatorSize: 3, height: "350px", width: "100%", ref: innerSplitterInstance },
            React.createElement(ej2_react_layouts_1.PanesDirective, null,
                React.createElement(ej2_react_layouts_1.PaneDirective, { size: '48%', collapsible: true, content: leftPaneContent }),
                React.createElement(ej2_react_layouts_1.PaneDirective, { collapsible: true }))),
        React.createElement(ej2_react_layouts_1.SplitterComponent, { id: "Collapse", separatorSize: 3, orientation: "Vertical", ref: splitterInstance, created: onCreate.bind(_this) },
            React.createElement(ej2_react_layouts_1.PanesDirective, null,
                React.createElement(ej2_react_layouts_1.PaneDirective, { collapsible: true, size: '50%', content: rightPaneContent1 }),
                React.createElement(ej2_react_layouts_1.PaneDirective, { collapsible: true, content: rightPaneContent2 }))),
