...
function StabilityAiModel(file, prompt, searchPrompt) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, getStabilityAiModel(file, prompt, searchPrompt)];
                case 1:
                    response = _d.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch('https://api.stability.ai/v2beta/stable-image/edit/search-and-replace', {
                            method: 'POST',
                            headers: {
...
function StabilityAiModelBGRemover(file) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, getStabilityAiModelBGRemover(file)];
                case 1:
                    response = _d.sent();
                    if (!!response.ok) return [3 /*break*/, 3];
                    _a = Error.bind;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    formData = new form_data_1.default();
                    formData.append('image', file);
                    return [4 /*yield*/, fetch('https://api.stability.ai/v2beta/stable-image/edit/remove-background', {
                            method: 'POST',
                            headers: {
                                'Authorization': "Bearer YOUR_API_KEY",
                                'Accept': 'image/*'
...
function StabilityAiModelMagicEraser(file, maskFile) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, getStabilityAiModelMagicEraser(file, maskFile)];
                case 1:
                    response = _d.sent();
                    if (!!response.ok) return [3 /*break*/, 3];
                    _a = Error.bind;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch('https://api.stability.ai/v2beta/stable-image/edit/erase', {
                            method: 'POST',
                            headers: {
                                'Authorization': "Bearer YOUR_API_KEY",
                                'Accept': 'image/*'
