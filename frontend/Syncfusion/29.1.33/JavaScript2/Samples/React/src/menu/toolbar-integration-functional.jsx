...
const ToolbarIntegration = () => {
    ...
    let data = dataSource;
    let searchTemplate = '<div class="e-input-group"><input class="e-input" type="text" placeholder="Search" /><span class="e-input-group-icon em-icons e-search"></span></div>';
    let tbObj = useRef(null);
    const menuTemplate = () => {
