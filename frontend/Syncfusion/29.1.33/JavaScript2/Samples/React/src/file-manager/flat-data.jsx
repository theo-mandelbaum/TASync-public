...
export class FlatData extends SampleBase {
    ...
    resultData = [].slice.call(this.fileData);
    render() {
        return (<div>
                <div className="control-section">
                    <FileManagerComponent id="flatdata" fileSystemData={this.resultData} toolbarSettings={{ items: ['NewFolder', 'Cut', 'Copy', 'Paste', 'Delete', 'Rename', 'SortBy', 'Refresh', 'Selection', 'View', 'Details'] }} contextMenuSettings={{
