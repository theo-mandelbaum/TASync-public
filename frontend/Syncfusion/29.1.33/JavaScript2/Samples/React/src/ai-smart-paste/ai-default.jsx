...
import { ButtonComponent, ChipListComponent, SmartPasteButtonComponent } from "@syncfusion/ej2-react-buttons";
...
function Default() {
    ...
    const serverAIRequest = async (options) => {
        let output = '';
        try {
            output = await window.getAzureChatAIRequest(options);
        }
        catch (error) {
    ...
    return (<>
            ...
            lineHeight: "35px", backgroundColor: "#f3f4f6"
                        ...
                        <div className="form-footer">
                            ...
                            <SmartPasteButtonComponent type="button" id="smart-paste" className="form-button" content={'Smart Paste'} iconCss={"e-icons e-paste"} aiAssistHandler={serverAIRequest}/>
                        </div>
                    </form>
                        ...
                        <div className="property-panel-section">
                            <div className="property-panel-content">
                                ...
                                <div className="chip-container">
                                    <ChipListComponent id="chip-choice" aria-label="choiceChips" ref={chip => chipList = chip} chips={bugPresets} selection={'Single'} selectedChips={[0]} click={chipsClickHandler}></ChipListComponent>
                                </div>
                                <div id="bug-report-text"></div>
                                <ButtonComponent id="copy-btn" ref={button => copyButton = button} content='Copy' iconCss="e-icons e-copy" onClick={onCopyClickHandler}></ButtonComponent>
                            </div>
                        </div>
                    </div>
