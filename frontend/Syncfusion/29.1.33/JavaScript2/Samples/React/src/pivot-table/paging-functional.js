...
function Paging() {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'col-lg-9 control-section component-section', style: { overflow: 'auto' } },
            React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', ref: function (pivotview) { pivotObj = pivotview; }, dataSourceSettings: dataSourceSettings, width: '100%', height: '600', gridSettings: { columnWidth: 120 }, pageSettings: {
                    rowPageSize: 10,
                    columnPageSize: 5,
                    currentColumnPage: 1,
                    currentRowPage: 1
                        ...
                        React.createElement("tr", { style: { height: "50px" } },
                            ...
                            React.createElement("td", null,
                                React.createElement("div", null,
                                    React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { change: onDropDownChange.bind(this), id: "Pager_Position", dataSource: pagerPositions, index: 1 })))),
                        React.createElement("tr", { style: { height: "50px" } },
                            React.createElement("td", null,
                                React.createElement("div", { className: "hdrlabel" }, "Show Pager")),
                            React.createElement("td", null,
                                React.createElement("div", null,
                                    React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { change: onDropDownChange.bind(this), id: "Pager_View", dataSource: pagerViewData, index: 2 })))),
                        React.createElement("tr", { style: { height: "50px" } },
                            React.createElement("td", null,
                                React.createElement("div", { className: "hdrlabel" }, "Show Page Size")),
                            React.createElement("td", null,
                                React.createElement("div", null,
                                    React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { change: onDropDownChange.bind(this), id: "Page_Size", dataSource: pageSizes, index: 2 })))),
                        React.createElement("tr", { style: { height: "50px" } },
                            React.createElement("td", null,
                                React.createElement("div", { className: "hdrlabel" }, "Compact View")),
                            React.createElement("td", null,
                                React.createElement("div", null,
                                    React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: 'Compact_View', change: compactCheckBoxChange.bind(this) })))),
                        React.createElement("tr", { style: { height: "50px" } },
                            React.createElement("td", null,
                                React.createElement("div", { className: "hdrlabel" }, "Inverse Pager")),
                            React.createElement("td", null,
                                React.createElement("div", null,
                                    React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: 'Inverse', change: inverseCheckBoxChange.bind(this) })))))))),
