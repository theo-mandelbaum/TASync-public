    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { className: 'col-lg-9 adaptive' },
                React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', ref: function (pivotview) { pivotObj = pivotview; }, showTooltip: false, dataSourceSettings: dataSourceSettings, width: '100%', height: '290', gridSettings: { columnWidth: 140 }, editSettings: { allowEditing: true, allowAdding: true, allowDeleting: true, mode: 'Normal' } })),
                            ...
                            React.createElement("tr", null,
                                React.createElement("td", null,
                                    React.createElement("div", { className: 'row', style: { margin: '0px' } },
                                        React.createElement(ej2_react_buttons_1.RadioButtonComponent, { id: "inline", change: onRadioChange.bind(this), checked: true, label: 'Inline Editing', name: 'EditOperation', value: "Inline Editing" })))),
                            React.createElement("tr", null,
                                React.createElement("td", null,
                                    React.createElement("div", { className: 'row', style: { margin: '0px' } },
                                        React.createElement(ej2_react_buttons_1.RadioButtonComponent, { id: "batch", change: onRadioChange.bind(this), label: 'Batch Editing', name: 'EditOperation', value: "Batch Editing" })))),
                            React.createElement("tr", null,
                                React.createElement("td", null,
                                    React.createElement("div", { className: 'row', style: { margin: '0px' } },
                                        React.createElement(ej2_react_buttons_1.RadioButtonComponent, { id: "dialog", change: onRadioChange.bind(this), label: 'Dialog Editing', name: 'EditOperation', value: "Dialog Editing" })))),
                            React.createElement("tr", null,
                                React.createElement("td", null,
                                    React.createElement("div", { className: 'row', style: { margin: '0px' } },
                                        React.createElement(ej2_react_buttons_1.RadioButtonComponent, { id: "cc", change: onRadioChange.bind(this), label: 'Command Columns', name: 'EditOperation', value: "Command Columns" }))))))))),
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                "More information on the editing can be found in this ",
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/pivotview/editing" }, "documentation section"),
                "."))));
}
