...
export class HeatMap extends SampleBase {
    colourScheme = ['range1', 'range2', 'range3', 'range4', 'range5', 'range6',
    ...
    cellColour(value) {
        let percentage = (this.maxValue - this.minValue) / this.colourScheme.length;
    ...
    render() {
        return (<div className='control-pane'>
            <div className='control-section'>
               <PivotViewComponent id='PivotView-Heatmap' dataSourceSettings={this.dataSourceSettings} width={'100%'} height={'500'} gridSettings={{ rowHeight: 35, columnWidth: 120 }} cellTemplate={this.cellTemplate.bind(this)} enginePopulated={this.enginePopulated.bind(this)} aggregateCellInfo={this.aggregateCellInfo.bind(this)}>
               </PivotViewComponent>
            </div>
