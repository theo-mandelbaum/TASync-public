...
function Selection() {
    ...
    return (<div className='control-pane'>
            <div className='col-lg-8 control-section' style={{ overflow: 'auto' }}>
                <PivotViewComponent id='PivotView' ref={d => pivotObj = d} dataSourceSettings={dataSourceSettings} width={'100%'} height={'400'} cellSelected={onSelected.bind(this)} gridSettings={{
            ...
            <div id="description">
                ...
                <p>
                    More information on the selection can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/pivotview/row-and-column#selection">
