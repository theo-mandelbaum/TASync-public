...
function Selection() {
    ...
    function onSelected(args) {
        ...
        if (args.selectedCellsInfo.length > 0) {
            for (var _i = 0, _a = args.selectedCellsInfo; _i < _a.length; _i++) {
                ...
                appendElement((cell.columnHeaders == '' ? '' : 'Column Headers: ' + '<b>' + cell.columnHeaders + '</b></br>') +
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'col-lg-8 control-section', style: { overflow: 'auto' } },
            React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', ref: function (d) { return pivotObj = d; }, dataSourceSettings: dataSourceSettings, width: '100%', height: '400', cellSelected: onSelected.bind(this), gridSettings: {
                        ...
                        React.createElement("tr", { style: { height: '50px' } },
                            ...
                            React.createElement("td", null,
                                React.createElement("div", null,
                                    React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { floatLabelType: 'Auto', fields: fields, change: modeOnChange.bind(this), id: "mode", index: 0, enabled: true, dataSource: modes })))),
                        React.createElement("tr", { style: { height: '50px' } },
                            React.createElement("td", null,
                                React.createElement("div", null, "Selection Types:")),
                            React.createElement("td", null,
                                React.createElement("div", null,
                                    React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { floatLabelType: 'Auto', fields: fields, change: typeOnChange.bind(this), id: "type", index: 0, enabled: true, dataSource: types })))),
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                ...
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/pivotview/row-and-column#selection" }, "documentation section"),
                "."))));
}
