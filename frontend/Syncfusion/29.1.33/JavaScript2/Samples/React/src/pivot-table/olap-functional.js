...
function OlapSample() {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section', id: 'pivot-table-section', style: { overflow: 'initial' } },
            React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', ref: function (scope) { pivotObj = scope; }, dataSourceSettings: dataSourceSettings, width: '100%', height: '500', enableValueSorting: true, showFieldList: true, showGroupingBar: true, gridSettings: { columnWidth: 140 }, allowExcelExport: true, allowConditionalFormatting: true, allowPdfExport: true, showToolbar: true, enableFieldSearching: true, allowCalculatedField: true, displayOption: { view: 'Both' }, toolbar: toolbarOptions, newReport: newReport.bind(this), renameReport: renameReport.bind(this), removeReport: removeReport.bind(this), loadReport: loadReport.bind(this), fetchReport: fetchReport.bind(this), saveReport: saveReport.bind(this), toolbarRender: beforeToolbarRender.bind(this), chartSettings: { title: 'Sales Analysis', load: chartOnLoad.bind(this) } },
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("table", null,
                ...
                React.createElement("tr", null,
                    ...
                    React.createElement("td", null, "Allows user to view data in graphical format. The chart types include column, bar, line, area, etc. It also has options for showing and hiding legends and displaying chart series of different measures on single and multiple axes.")),
                React.createElement("tr", null,
                    React.createElement("td", { style: { verticalAlign: 'top', padding: '4px 0' } },
            ...
            React.createElement("p", null,
                "More information on the olap can be found in this ",
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/pivotview/olap" }, "documentation section"),
                "."))));
}
exports.default = OlapSample;
