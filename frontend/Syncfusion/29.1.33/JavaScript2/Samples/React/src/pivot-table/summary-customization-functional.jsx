...
function SummaryCustomization() {
    ...
    function select(args) {
        for (let i = 0; i < pivotObj.dataSourceSettings.columns.length; i++) {
        ...
        for (let i = 0; i < pivotObj.dataSourceSettings.rows.length; i++) {
                    ...
                    <table id="property" title="Properties" style={{ width: '100%', height: '100%' }}>
                        <tbody>
                            <tr style={{ height: '50px' }}>
                                ...
                                <td style={{ width: 'auto' }}>
                                    <div>
                                        <DropDownListComponent enabled={true} ref={(scope) => { optionsdll = scope; }} change={onChange0.bind(this)} width={"100%"} id="options" type='text' tabIndex={0} dataSource={options} fields={{ value: 'value', text: 'text' }} value="grandTotals"/>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                        ...
                        <table className="property-panel-table">
                            <tbody>
                                ...
                                <tr>
                                    <td colSpan={2}>
                                        <div>
                                            <MultiSelectComponent id="summary-values" dataSource={values} fields={field} mode="CheckBox" showClearButton={true} enableSelectionOrder={false} showDropDownIcon={true} placeholder={placeholder} select={select.bind(this)} removed={removed.bind(this)} open={open.bind(this)}>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style={{ padding: '4px 0' }}>: Allows to display the grand totals either at top or bottom of the row and
                                ...
                                To display the grand totals at top, set the property <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/dataSourceSettingsModel/#grandtotalsposition">
                                    grandTotalsPosition</a> as <b>Top</b>. And, to display the grand
                                totals at bottom, set the property <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/dataSourceSettingsModel/#grandtotalsposition">
                        ...
                        <tr>
                            ...
                            <td style={{ padding: '4px 0' }}>: Allows to hide grand totals in row, column, or both by selecting the
                                appropriate radio button options. To hide grand totals in both row and column, set the property<a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/dataSourceSettingsModel/#showgrandtotals">
                                    showGrandTotals</a> as <b>false</b>. To hide the row and column
                                grand totals separately,
                                set the property <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/dataSourceSettingsModel/#showrowgrandtotals">
                                        showRowGrandTotals</a> and <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/dataSourceSettingsModel/#showcolumngrandtotals">
                        ...
                        <tr>
                            ...
                            <td style={{ padding: '4px 0' }}>: Allows to display the sub-totals at top, bottom, or default position of
                                ...
                                To display the sub-totals at top, set the property <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/dataSourceSettingsModel/#subtotalsposition">
                                    subTotalsPosition</a> as <b>Top</b>. And, to display the
                                sub-totals at bottom, set the property <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/dataSourceSettingsModel/#subtotalsposition">
                        ...
                        <tr>
                            ...
                            <td style={{ padding: '4px 0' }}>: Allows to hide sub-totals in row, column, or both by selecting the
                                appropriate radio button options. To hide sub-totals in both row and column, set the property<a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/dataSourceSettingsModel/#showsubtotals">
                                    showSubTotals</a> as <b>false</b>. To hide the row and column
                                sub-totals separately,
                                set the property <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/dataSourceSettingsModel/#showrowsubtotals">
                                        showRowSubTotals</a> and <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/dataSourceSettingsModel/#showcolumnsubtotals">
                        ...
                        <tr>
                            ...
                            <td style={{ padding: '4px 0' }}>: Allows to hide sub-totals for specific fields in row and column by
                                ...
                                To hide sub-totals for a specific field, set the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/fieldOptionsModel/#showsubtotals">
                                        showSubTotals</a> property as <b>false</b> inside the field definition.</td>
                        </tr>
                    </tbody>
                </table><br />
                <p>
                    More information on the show/hide totals can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/pivotview/show-hide-totals">
