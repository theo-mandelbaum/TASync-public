...
function LabelFilter() {
    ...
    return (React.createElement("div", { className: 'control-pane' },
                            ...
                            React.createElement("tr", { className: "input1cls", style: { height: "50px" } },
                                ...
                                React.createElement("td", { style: { paddingBottom: '16px' } },
                                    React.createElement("div", { className: "value1cls" },
                                        React.createElement(ej2_react_inputs_1.MaskedTextBoxComponent, { id: "value1", ref: function (scope) { valueInput1 = scope; }, value: '', width: '100%', change: onValue1Change.bind(this), placeholder: 'Example: "Germany"' })))),
                            React.createElement("tr", { className: "input2cls", style: { height: "50px", display: "none" } },
                                ...
                                React.createElement("td", { style: { paddingBottom: '16px' } },
                                    React.createElement("div", { className: "value2cls" },
                                        React.createElement(ej2_react_inputs_1.MaskedTextBoxComponent, { id: "value2", ref: function (scope) { valueInput2 = scope; }, value: '', width: '100%', change: onValue2Change.bind(this), placeholder: 'Example: "States"' })))),
                            React.createElement("tr", { style: { height: '50px' } },
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("br", null),
            React.createElement("p", null,
                "More information on the label filtering can be found in this ",
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/pivotview/filtering#label-filtering" }, "documentation section"),
                "."))));
}
