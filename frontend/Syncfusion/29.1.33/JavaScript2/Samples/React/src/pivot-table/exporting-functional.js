    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { className: 'col-lg-8 adaptive' },
                React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', ref: function (pivotview) { pivotObj = pivotview; }, dataSourceSettings: dataSourceSettings, allowExcelExport: true, allowPdfExport: true, showFieldList: true, width: '100%', height: '300', gridSettings: { columnWidth: 140 } },
                            ...
                            React.createElement("tr", { style: { height: '50px' } },
                                ...
                                React.createElement("td", null,
                                    React.createElement("div", { style: { paddingLeft: 0 } },
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: '160px', id: "etype", value: "pdf", ref: function (d) { return mode = d; }, dataSource: exportType, fields: { text: 'text', value: 'value' }, placeholder: "PDF" })))),
                            React.createElement("tr", { style: { height: '50px' } },
                                React.createElement("td", null),
                                React.createElement("td", null,
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                ...
                " , ",
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/pivotview/excel-export#csv-export" }, "CSV Export"),
                " & ",
