...
function LiveData() {
    ...
    return (<div className='control-pane'>
            ...
            <div id="description">
                ...
                <p>
                    More information on the Essential<sup>®</sup> JS2 Pivot Table can be found in these <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/pivotview/row-and-column#cell-template">Cell Template</a> & <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/pivotview/pivot-chart">Pivot Chart</a> documentation section.
                </p>
            </div>
        </div>);
}
