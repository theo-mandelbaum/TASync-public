    ...
    return (<div className='control-pane'>
            <div className='control-section' style={{ overflow: 'auto' }}>
                <div className='col-lg-8 adaptive'>
                    <PivotViewComponent id='PivotView' ref={(pivotview) => { pivotObj = pivotview; }} showTooltip={false} dataSourceSettings={dataSourceSettings} width={'100%'} height={'600'} gridSettings={{ columnWidth: 140 }} hyperlinkSettings={hyperlinkSettings} hyperlinkCellClick={onCellClick.bind(this)}></PivotViewComponent>
                </div>
                        ...
                        <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                            <tbody>
                                <tr style={{ height: "50px" }}>
                                    ...
                                    <td>
                                        <div>
                                            <DropDownListComponent ref={(scope) => { optionsdll = scope; }} index={3} width={'100%'} id="fields" change={onOptionChange.bind(this)} dataSource={options} fields={measureFields}></DropDownListComponent>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr className="conditioncls" style={{ height: "50px", display: "none" }}>
                                    ...
                                    <td>
                                        <div className='conditionscls'>
                                            <DropDownListComponent ref={(scope) => { operatorddl = scope; }} value={'NotEquals'} width={'100%'} id="conditions" change={onOperatorChange.bind(this)} dataSource={operators}></DropDownListComponent>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div id="description">
                ...
                <p>
                    More information on the hyperlink can be found in this <a target='_blank' href='https://ej2.syncfusion.com/react/documentation/pivotview/hyper-link'>
