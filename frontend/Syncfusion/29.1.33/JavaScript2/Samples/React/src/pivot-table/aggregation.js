...
var Aggregation = /** @class */ (function (_super) {
    ...
    Aggregation.prototype.setSummaryType = function (fieldName, summaryType) {
        var isAvail = false;
        for (var vCnt = 0; vCnt < this.pivotObj.dataSourceSettings.values.length; vCnt++) {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { className: 'col-lg-9 adaptive' },
                    React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', ref: function (pivotview) { _this.pivotObj = pivotview; }, load: this.onLoad, dataSourceSettings: dataSourceSettings, showFieldList: true, width: '100%', height: '290', gridSettings: { columnWidth: 140 } },
