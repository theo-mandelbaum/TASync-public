...
function LabelFilter() {
    ...
    return (<div className='control-pane'>
                                ...
                                <tr className="input1cls" style={{ height: "50px" }}>
                                    ...
                                    <td style={{ paddingBottom: '16px' }}>
                                        <div className="value1cls">
                                            <MaskedTextBoxComponent id="value1" ref={(scope) => { valueInput1 = scope; }} value={''} width={'100%'} change={onValue1Change.bind(this)} placeholder='Example: "Germany"'>
                                ...
                                <tr className="input2cls" style={{ height: "50px", display: "none" }}>
                                    ...
                                    <td style={{ paddingBottom: '16px' }}>
                                        <div className="value2cls">
                                            <MaskedTextBoxComponent id="value2" ref={(scope) => { valueInput2 = scope; }} value={''} width={'100%'} change={onValue2Change.bind(this)} placeholder='Example: "States"'>
                                            </MaskedTextBoxComponent>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div id="description">
                ...
                <p>
                    More information on the label filtering can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/pivotview/filtering#label-filtering">
