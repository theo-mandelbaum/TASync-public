                                ...
                                <tr style={{ height: '50px' }}>
                                    <td>
                                        <div>
                                            ...
                                            <DropDownListComponent id='mode' floatLabelType={'Auto'} placeholder={'Units'} width={'100%'} dataSource={qData} fields={fields} value={mVal} change={changeBalance.bind(this)}/>
                                        </div>
                                    </td>
                                </tr>
                                <tr style={{ height: '50px' }}>
                                    <td>
                                        <div>
                                            {/* Render the DropDownList Component */}
                                            <DropDownListComponent id='mode' floatLabelType={'Auto'} placeholder={'Cost'} width={'100%'} dataSource={cData} fields={fields} value={mVal} change={changeQuantity.bind(this)}/>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
