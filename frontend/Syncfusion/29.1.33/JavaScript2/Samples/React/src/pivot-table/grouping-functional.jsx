...
function Grouping() {
    ...
    return (<div className='control-pane'>
                            ...
                            <tr className="input2cls" style={{ height: '50px' }}>
                                ...
                                <td style={{ paddingBottom: '16px' }}>
                                    <div className="numbercls">
                                        <NumericTextBoxComponent id="numbergroup" ref={(scope) => { numberGroup = scope; }} value={4} width={'150'} placeholder={'Example: 4'} format={'###'} min={1} max={10}>
            ...
            <div id="description">
                ...
                <p>
                    More information on the grouping can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/pivotview/grouping">
