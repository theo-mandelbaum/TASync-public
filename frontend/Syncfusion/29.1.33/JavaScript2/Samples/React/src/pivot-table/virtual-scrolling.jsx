    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div className='control-section'>
                    ...
                    <PivotViewComponent id='PivotView' ref={(pivotview) => { pivotObj = pivotview; }} dataSourceSettings={dataSourceSettings} enableVirtualization={true} width={'100%'} height={300} dataBound={this.onDataBound} virtualScrollSettings={{ allowSinglePage: true }}>
                ...
                <div id="description">
                    <p>The pivot table provides an optimized way to render rows and columns inside the view-port alone without
                        calculating the value of the entire pivot. To enable virtual scrolling, set <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/pivotview/#enablevirtualization">
