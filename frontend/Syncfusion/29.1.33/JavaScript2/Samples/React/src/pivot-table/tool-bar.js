        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "description" },
                ...
                React.createElement("table", null,
                    ...
                    React.createElement("tr", null,
                        React.createElement("td", { style: { verticalAlign: 'top', padding: '4px 0' } },
                            React.createElement("code", null, "Number formatting:")),
                        React.createElement("td", null, "Allows user to dynamically apply number formatting to value fields.")),
                    React.createElement("tr", null,
                        React.createElement("td", { style: { verticalAlign: 'top', padding: '4px 0' } },
                ...
                React.createElement("p", null,
                    "More information on the toolbar can be found in this ",
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/pivotview/tool-bar" }, "documentation section"),
                    "."))));
    };
    return PivotToolbar;
