    ...
    return (<div className='control-pane'>
            ...
            <div className='control-section'>
                <div className='performance-time-container' style={{ marginBottom: '15px' }}>
                    <DropDownListComponent id="performance" width='240' dataSource={ddlData} index={0} ref={(dropdownlist) => { ddObj = dropdownlist; }} fields={fields} change={onChange.bind(this)} placeholder="Select a Data Range" popupHeight="240px">
                    </DropDownListComponent>
                    <span id="performanceTime">Time Taken: 0 sec</span>
                </div>
                <PivotViewComponent id='PivotView' ref={(pivotview) => { pivotObj = pivotview; }} dataSourceSettings={dataSourceSettings} enableVirtualization={true} width={'100%'} height={300} gridSettings={{ columnWidth: 120 }} dataBound={onDataBound} load={load}>
