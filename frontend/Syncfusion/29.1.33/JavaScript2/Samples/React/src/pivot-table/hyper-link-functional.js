    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section', style: { overflow: 'auto' } },
            React.createElement("div", { className: 'col-lg-8 adaptive' },
                React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', ref: function (pivotview) { pivotObj = pivotview; }, showTooltip: false, dataSourceSettings: dataSourceSettings, width: '100%', height: '600', gridSettings: { columnWidth: 140 }, hyperlinkSettings: hyperlinkSettings, hyperlinkCellClick: onCellClick.bind(this) })),
                        ...
                        React.createElement("tbody", null,
                            React.createElement("tr", { style: { height: "50px" } },
                                React.createElement("td", null,
                                    React.createElement("div", null, "Show Hyperlink:")),
                                React.createElement("td", null,
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { ref: function (scope) { optionsdll = scope; }, index: 3, width: '100%', id: "fields", change: onOptionChange.bind(this), dataSource: options, fields: measureFields })))),
                            ...
                            React.createElement("tr", { className: "measurecls", style: { height: "50px", display: "none" } },
                                React.createElement("td", null,
                                    React.createElement("div", null, "Measures:")),
                                React.createElement("td", null,
                                    React.createElement("div", null,
                            ...
                            React.createElement("tr", { className: "conditioncls", style: { height: "50px", display: "none" } },
                                React.createElement("td", null,
                                    React.createElement("div", null, "Condition:")),
                                React.createElement("td", null,
                                    React.createElement("div", { className: 'conditionscls' },
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { ref: function (scope) { operatorddl = scope; }, value: 'NotEquals', width: '100%', id: "conditions", change: onOperatorChange.bind(this), dataSource: operators })))),
                            React.createElement("tr", { className: "input1cls", style: { height: "50px", display: "none" } },
                                React.createElement("td", null,
                                    React.createElement("div", null, "Value 1:")),
                                React.createElement("td", null,
                            ...
                            React.createElement("tr", { className: "input2cls", style: { height: "50px", display: "none" } },
                                React.createElement("td", null,
                                    React.createElement("div", null, "Value 2:")),
                                React.createElement("td", null,
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                "More information on the hyperlink can be found in this ",
                React.createElement("a", { target: '_blank', href: 'https://ej2.syncfusion.com/react/documentation/pivotview/hyper-link' }, "documentation section"),
                "."))));
}
