...
export class ValueSorting extends SampleBase {
    render() {
        return (<div className='control-pane'>
                ...
                <p>
                    More information on the value sorting can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/pivotview/sorting#value-sorting">
