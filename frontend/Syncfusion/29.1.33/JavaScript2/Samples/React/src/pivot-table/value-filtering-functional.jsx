...
function ValueFilter() {
    ...
    return (<div className='control-pane'>
                        ...
                        <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                            <tbody>
                                ...
                                <tr style={{ height: "50px" }}>
                                    ...
                                    <td>
                                        <div>
                                            <DropDownListComponent ref={(scope) => { measuresddl = scope; }} index={0} width={'100%'} id="measures" change={onMeasureChange.bind(this)} dataSource={measures} fields={measureFields}></DropDownListComponent>
                                        </div>
                                    </td>
                                </tr>
                                <tr style={{ height: "50px" }}>
                                ...
                                <tr className="input1cls" style={{ height: "50px" }}>
                                    ...
                                    <td>
                                        <div className="value1cls">
                                            <NumericTextBoxComponent id="value1" ref={(scope) => { valueInput1 = scope; }} value={0} width={'100%'} change={onValue1Change.bind(this)} placeholder='Example: 9590'>
                                ...
                                <tr className="input2cls" style={{ height: "50px", display: "none" }}>
                                    ...
                                    <td>
                                        <div className="value2cls">
                                            <NumericTextBoxComponent id="value2" ref={(scope) => { valueInput2 = scope; }} value={0} width={'100%'} change={onValue2Change.bind(this)} placeholder='Example: 17500'>
                                            </NumericTextBoxComponent>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div id="description">
                ...
                <p>
                    More information on the value filtering can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/pivotview/filtering#value-filtering">
