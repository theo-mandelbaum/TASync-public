...
function Remote() {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section component-section' },
            ...
            React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', ref: function (pivotview) { pivotObj = pivotview; }, dataSourceSettings: jsonReport, width: '100%', height: '300', gridSettings: { columnWidth: 120 } })),
