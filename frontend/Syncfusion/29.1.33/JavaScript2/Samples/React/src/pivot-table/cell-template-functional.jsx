...
function CellTemplate() {
    ...
    let pivotObj;
    let cellTemplate = '<span class="tempwrap e-pivot-trend-neutral pv-icons"></span>';
    /* jshint ignore:start */
    function trend() {
    ...
    return (<div className='control-pane'>
            <div className='control-section' id='pivot-table-section'>
                <PivotViewComponent id='PivotView' dataSourceSettings={dataSourceSettings} width={'100%'} height={'300'} gridSettings={{ columnWidth: 140 }} load={onLoad} dataBound={trend.bind(this)} ref={(pivotview) => { pivotObj = pivotview; }} cellTemplate={cellTemplate}>
                </PivotViewComponent>
            </div>
