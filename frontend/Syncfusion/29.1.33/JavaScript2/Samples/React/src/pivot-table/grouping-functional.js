...
var dataSourceSettings = {
    dataSource: (0, ej2_base_1.extend)([], data, null, true),
    expandAll: false,
    enableSorting: true,
...
function Grouping() {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'col-lg-8 control-section', id: 'pivot-table-section', style: { overflow: 'initial' } },
            React.createElement(ej2_react_pivotview_1.PivotViewComponent, { id: 'PivotView', ref: function (scope) { pivotObj = scope; }, dataSourceSettings: dataSourceSettings, width: '100%', height: '450', showGroupingBar: true, gridSettings: { columnWidth: 140, columnRender: beforeColumnsRender } },
                        ...
                        React.createElement("tr", { className: "input2cls", style: { height: '50px' } },
                            ...
                            React.createElement("td", { style: { paddingBottom: '16px' } },
                                React.createElement("div", { className: "numbercls" },
                                    React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: "numbergroup", ref: function (scope) { numberGroup = scope; }, value: 4, width: '150', placeholder: 'Example: 4', format: '###', min: 1, max: 10 })))),
                        React.createElement("tr", { style: { height: '50px' } },
                            React.createElement("td", null),
                            React.createElement("td", null,
                                React.createElement("div", { style: { float: 'right', marginRight: "4px" } },
                                    React.createElement(ej2_react_buttons_1.ButtonComponent, { id: 'group-apply', onClick: onClick.bind(this), isPrimary: true }, "Apply")))))))),
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                ...
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/pivotview/grouping" }, "documentation section"),
                "."))));
}
