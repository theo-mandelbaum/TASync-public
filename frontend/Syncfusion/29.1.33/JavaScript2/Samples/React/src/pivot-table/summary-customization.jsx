                        ...
                        <table id="property" title="Properties" style={{ width: '100%', height: '100%' }}>
                            <tbody>
                                <tr style={{ height: '50px' }}>
                                    ...
                                    <td style={{ width: 'auto' }}>
                                        <div>
                                            <DropDownListComponent enabled={true} ref={(scope) => { this.optionsdll = scope; }} change={this.onChange0.bind(this)} width={"100%"} id="options" type='text' tabIndex={0} dataSource={options} fields={{ value: 'value', text: 'text' }} value="grandTotals"/>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <table className="property-panel-table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td colSpan={2}>
                                            <div>
                                                <MultiSelectComponent id="summary-values" dataSource={values} fields={field} mode="CheckBox" showClearButton={true} enableSelectionOrder={false} showDropDownIcon={true} placeholder={placeholder} select={this.select.bind(this)} removed={this.removed.bind(this)} open={this.open.bind(this)}>
