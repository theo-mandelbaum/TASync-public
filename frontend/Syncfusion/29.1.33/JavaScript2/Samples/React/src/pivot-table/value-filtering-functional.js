...
function ValueFilter() {
    ...
    function onMeasureChange(args) {
        setFilters(fieldsddl.value, args.value, operatorddl.value, valueInput1.value.toString(), valueInput2.value.toString());
    }
    function onOperatorChange(args) {
        ...
        setFilters(fieldsddl.value, measuresddl.value, args.value, valueInput1.value.toString(), valueInput2.value.toString());
    }
    function onValue1Change(e) {
        setFilters(fieldsddl.value, measuresddl.value, operatorddl.value, e.value.toString(), valueInput2.value.toString());
    }
    function onValue2Change(e) {
        setFilters(fieldsddl.value, measuresddl.value, operatorddl.value, valueInput1.value.toString(), e.value.toString());
    }
    ...
    return (React.createElement("div", { className: 'control-pane' },
                            ...
                            React.createElement("tr", { style: { height: "50px" } },
                                ...
                                React.createElement("td", null,
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { ref: function (scope) { fieldsddl = scope; }, index: 0, width: '100%', id: "fields", change: onFieldChange.bind(this), dataSource: fields })))),
                            React.createElement("tr", { style: { height: "50px" } },
                                React.createElement("td", null, "Measures:"),
                                React.createElement("td", null,
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { ref: function (scope) { measuresddl = scope; }, index: 0, width: '100%', id: "measures", change: onMeasureChange.bind(this), dataSource: measures, fields: measureFields })))),
                            React.createElement("tr", { style: { height: "50px" } },
                                React.createElement("td", null, "Condition:"),
                                React.createElement("td", null,
                                    React.createElement("div", { className: 'conditionscls' },
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { ref: function (scope) { operatorddl = scope; }, value: 'DoesNotEquals', width: '100%', id: "conditions", change: onOperatorChange.bind(this), dataSource: operators })))),
                            React.createElement("tr", { className: "input1cls", style: { height: "50px" } },
                                ...
                                React.createElement("td", null,
                                    React.createElement("div", { className: "value1cls" },
                                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: "value1", ref: function (scope) { valueInput1 = scope; }, value: 0, width: '100%', change: onValue1Change.bind(this), placeholder: 'Example: 9590' })))),
                            React.createElement("tr", { className: "input2cls", style: { height: "50px", display: "none" } },
                                ...
                                React.createElement("td", null,
                                    React.createElement("div", { className: "value2cls" },
                                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: "value2", ref: function (scope) { valueInput2 = scope; }, value: 0, width: '100%', change: onValue2Change.bind(this), placeholder: 'Example: 17500' })))),
                            React.createElement("tr", { style: { height: '50px' } },
                                React.createElement("td", { colSpan: 2 },
                                    React.createElement("div", { style: { float: 'right', marginRight: "4px" } },
                                        React.createElement(ej2_react_buttons_1.ButtonComponent, { id: 'clear', onClick: onClear.bind(this) }, "Clear")),
                                    React.createElement("div", { style: { float: 'right', marginRight: "4px" } },
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("br", null),
            React.createElement("p", null,
                "More information on the value filtering can be found in this ",
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/pivotview/filtering#value-filtering" }, "documentation section"),
                "."))));
}
exports.default = ValueFilter;
