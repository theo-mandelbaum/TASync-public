                            ...
                            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                                <tbody>
                                    ...
                                    <tr style={{ height: "50px" }}>
                                        ...
                                        <td>
                                            <div>
                                                <MultiSelectComponent id="checkbox" placeholder="Select members" ref={(scope) => { valuesddl = scope; }} dataSource={values} fields={field} mode="CheckBox" showClearButton={true} enableSelectionOrder={false} showDropDownIcon={true} select={this.select.bind(this)} removed={this.removed.bind(this)} open={this.open.bind(this)} aria-expanded={'false'}>
