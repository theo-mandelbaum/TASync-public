...
var Api = /** @class */ (function (_super) {
    ...
    function Api(props) {
        ...
        _this.directionFields = { text: 'Text', value: 'Id' };
        _this.animationFields = { text: 'Effect', value: 'Id' };
        _this.easeValue = 'ease';
        _this.directionValue = 'Rtl';
    ...
    Api.prototype.onProgressDirection = function () {
    ...
    Api.prototype.rendereComplete = function () {
        document.addEventListener('click', function (e) {
            if (!(0, ej2_base_1.isNullOrUndefined)(this.toastObj) && e.target !== this.toastBtnShow.element) {
                this.toastObj.hide('All');
            }
        }.bind(this));
    };
                ...
                React.createElement("div", { className: "e-sample-resize-container" },
                    ...
                    React.createElement("div", { className: "row" },
                        React.createElement("div", { className: "col-lg-6 padding" },
                            ...
                            React.createElement("div", { className: "input-form" },
                                React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { ref: function (dropdownlist) { _this.dropDownListProgressDirection = dropdownlist; }, id: "ProgressDirection", floatLabelType: "Auto", dataSource: this.directionData, fields: this.directionFields, placeholder: "ProgressDirection", change: this.onProgressDirection.bind(this), value: this.directionValue })),
                            React.createElement("div", { className: "input-form" },
