...
var Templates = /** @class */ (function (_super) {
    ...
    Templates.prototype.onOpenToast = function () {
        ...
        document.addEventListener('click', function (e) {
            ...
            if (!(0, ej2_base_1.isNullOrUndefined)(this.toastObj) && e.target !== this.AlarmTurnOn.element && e.target !== this.toastMailRemainder.element && closestEle !== this.toastObj.element && closestEle !== this.toastObjEmail.element) {
    ...
    Templates.prototype.cardTemplateFn = function (data) {
        return (0, ej2_base_2.compile)(this.template.trim())(data);
    };
