...
var Types = /** @class */ (function (_super) {
    ...
    Types.prototype.render = function () {
        ...
        document.addEventListener('click', function (e) {
            if (!(0, ej2_base_1.isNullOrUndefined)(this.toastObj) && e.target !== this.infoBtn.element && e.target !== this.warnBtn.element && e.target !== this.successBtn.element && e.target !== this.errorBtn.element) {
                this.toastObj.hide('All');
            }
        }.bind(this));
