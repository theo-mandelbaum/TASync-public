    ...
    render() {
        return (<div className='control-pane'>
                <div className='control-section'>
                    ...
                    <GridComponent dataSource={[]} enableInfiniteScrolling={true} enableColumnVirtualization={true} height={400} pageSettings={{ pageSize: 50 }} ref={g => this.grid = g}>
                        <ColumnsDirective>
                ...
                <p>
                    ...
                    To enable Infinite scrolling, set the <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/#enableinfinitescrolling">
                    ...
                    Enable column virtualization by setting the <code><a target="_blank" className="code" href="http://ej2.syncfusion.com/react/documentation/api/grid/#enablecolumnvirtualization">
                    ...
                    <p>
                        Note: The <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/#height">
                            height</a></code> property must be defined when enabling the <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/#enableinfinitescrolling">
                ...
                <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/grid/scrolling/infinite-scrolling">
