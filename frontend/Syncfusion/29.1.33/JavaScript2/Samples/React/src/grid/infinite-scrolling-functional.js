...
function InfiniteScrolling() {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            ...
            React.createElement(ej2_react_grids_1.GridComponent, { dataSource: [], enableInfiniteScrolling: true, enableColumnVirtualization: true, height: 400, pageSettings: { pageSize: 50 }, ref: function (g) { return grid = g; } },
