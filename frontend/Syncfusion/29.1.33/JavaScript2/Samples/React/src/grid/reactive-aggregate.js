...
exports.ReactiveAggregate = void 0;
    ...
    ReactiveAggregate.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_grids_1.GridComponent, { dataSource: data_1.data, allowPaging: true, pageSettings: this.pageSettings, allowSorting: true, allowFiltering: true, filterSettings: this.filterSettings, toolbar: this.toolbarOptions, editSettings: this.editSettings, allowGrouping: true, groupSettings: this.groupSettings },
                    ...
                    React.createElement(ej2_react_grids_1.Inject, { services: [ej2_react_grids_1.Page, ej2_react_grids_1.Aggregate, ej2_react_grids_1.Edit, ej2_react_grids_1.Toolbar, ej2_react_grids_1.Group, ej2_react_grids_1.Sort, ej2_react_grids_1.Filter] })),
