    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { className: 'col-lg-8' },
                React.createElement(ej2_react_grids_1.GridComponent, { dataSource: data_1.orderDetails, height: '350', frozenRows: 2, frozenColumns: 1, allowSelection: false, enableHover: false, allowResizing: true, allowSorting: true, allowFiltering: true, filterSettings: filterSettings, allowMultiSorting: false, ref: function (g) { return grid = g; } },
                            ...
                            React.createElement("tr", null,
                                ...
                                React.createElement("td", { style: { width: '70%', paddingRight: '10px' } },
                                    React.createElement("div", { style: { minWidth: '148px' } },
                                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { min: 0, max: 5, validateDecimalOnType: true, decimals: 0, format: 'n', value: 2, ref: function (numeric) { return rowInstance = numeric; }, "aria-label": "Frozen rows" })))),
                            React.createElement("tr", null,
                                React.createElement("td", { style: { width: '30%' } },
                                    React.createElement("div", null, "Frozen Columns ")),
                                React.createElement("td", { style: { width: '70%', paddingRight: '10px' } },
                                    React.createElement("div", { style: { minWidth: '148px' } },
                                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { min: 0, max: ej2_base_1.Browser.isDevice ? 1 : 2, validateDecimalOnType: true, decimals: 0, format: 'n', value: 1, ref: function (numeric) { return columnInstance = numeric; }, "aria-label": "Frozen columns" })))),
                            React.createElement("tr", null,
                                React.createElement("td", null),
                                React.createElement("td", null,
                                    React.createElement("div", { style: { float: 'right', marginRight: '10px' } },
                                        React.createElement(ej2_react_buttons_1.ButtonComponent, { onClick: btnClick.bind(this) }, "Set"))))))))),
