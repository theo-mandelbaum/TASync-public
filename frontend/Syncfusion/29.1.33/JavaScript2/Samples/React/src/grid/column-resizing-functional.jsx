...
import { GridComponent, ColumnsDirective, ColumnDirective, Resize, Inject, Sort, Toolbar, Filter, Edit } from '@syncfusion/ej2-react-grids';
...
function ColumnResizing() {
    ...
    return (<div className='control-pane'>
            ...
            <div id="description">
                ...
                <p>The Grid columns can be resized by clicking and dragging at the right edge of column's header. To enable column, resize behavior, set the <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/#allowresizing">allowResizing
                    ...
                    And, by double clicking at the right edge of column header, the respective column width will get auto adjusted to its fit using the <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/#autofitcolumns">autoFitColumns
                    </a></code> method.
                </p>
                <p>
