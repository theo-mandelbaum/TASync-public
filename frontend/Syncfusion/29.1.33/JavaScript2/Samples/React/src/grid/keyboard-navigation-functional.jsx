...
function KeyboardNavigation() {
    ...
    return (<div className='control-pane'>
      <div className='control-section'>
        <GridComponent dataSource={data} toolbar={toolbarOptions} allowPaging={true} allowFiltering={true} editSettings={editSettings} pageSettings={pageSettings} filterSettings={{ type: 'Menu' }} allowSorting={true} allowGrouping={true}>
          <ColumnsDirective>
