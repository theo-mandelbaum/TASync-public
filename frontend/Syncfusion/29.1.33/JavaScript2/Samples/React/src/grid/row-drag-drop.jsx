...
import { GridComponent, ColumnsDirective, ColumnDirective, Page, RowDD, Inject, Sort, Toolbar, Filter, Edit } from '@syncfusion/ej2-react-grids';
...
export class Source extends SampleBase {
    ...
    rowDropSettings2 = { targetID: 'Grid' };
    rowDragStart = () => {
    ...
    render() {
        return (<div className='control-pane'>
            ...
            enabling <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid#allowrowdraganddrop">
                            allowRowDragAndDrop
        </a></code> property. The target control on which the
            Grid rows has to be dropped can be set by using <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid#rowdropsettings">
            ...
            <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/grid/row/row-drag-and-drop">
