...
var AdvancedExporting = /** @class */ (function (_super) {
    ...
    function AdvancedExporting() {
        ...
        _this.toolbarOptions = ['Add', 'Edit', 'Delete', 'Update', 'Cancel', 'ExcelExport', 'PdfExport'];
        _this.editSettings = { allowEditing: true, allowAdding: true, allowDeleting: true };
        _this.productnameRule = { required: true, minLength: 5 };
        _this.productidRules = { required: true, number: true };
        return _this;
    }
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", null,
                    React.createElement(ej2_react_grids_1.GridComponent, { id: "Grid", dataSource: data_1.productData, ref: function (grid) { return _this.gridInstance = grid; }, toolbar: this.toolbarOptions, allowExcelExport: true, allowPdfExport: true, toolbarClick: this.toolbarClick.bind(this), allowPaging: true, allowSorting: true, editSettings: this.editSettings, allowFiltering: true, filterSettings: this.filterSettings, pageSettings: { pageCount: 2, pageSize: 10 } },
                        React.createElement(ej2_react_grids_1.ColumnsDirective, null,
                            React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'ProductID', headerText: 'Product ID', width: '120', textAlign: 'Right', validationRules: this.productidRules, isPrimaryKey: true }),
                            React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'ProductName', headerText: 'Product Name', width: '200', validationRules: this.productnameRule }),
