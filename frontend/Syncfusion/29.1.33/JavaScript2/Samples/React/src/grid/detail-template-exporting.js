...
exports.DetailTemplateExport = void 0;
...
var DetailTemplateExport = /** @class */ (function (_super) {
    __extends(DetailTemplateExport, _super);
    ...
    DetailTemplateExport.prototype.gridTemplate = function (props) {
    ...
    DetailTemplateExport.prototype.toolbarClick = function (args) {
        switch (args.item.id) {
    ...
    DetailTemplateExport.prototype.exportDetailTemplate = function (args) {
        args.value = {
            columnCount: 3,
            rows: [
                {
    ...
    DetailTemplateExport.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_grids_1.GridComponent, { id: 'DetailTemplateExport', dataSource: data_1.employeeData, ref: function (grid) { return _this.gridInstance = grid; }, toolbar: this.toolbarOptions, allowExcelExport: true, allowSorting: true, allowFiltering: true, filterSettings: this.filterSettings, allowPdfExport: true, toolbarClick: this.toolbarClick.bind(this), detailTemplate: this.template.bind(this), exportDetailTemplate: this.exportDetailTemplate.bind(this), width: 'auto' },
    ...
    return DetailTemplateExport;
}(sample_base_1.SampleBase));
exports.DetailTemplateExport = DetailTemplateExport;
