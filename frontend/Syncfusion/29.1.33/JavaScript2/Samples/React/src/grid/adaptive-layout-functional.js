...
function Adaptive() {
    ...
    var grid;
    var checkboxObj;
    var toolbarOptions = ['Add', 'Edit', 'Delete', 'Update', 'Cancel', 'Search', 'ColumnChooser', 'ExcelExport', 'PdfExport'];
        ...
        React.createElement("div", { className: 'control-section' },
            ...
            React.createElement("div", { className: "col-md-9 e-bigger e-adaptive-demo" }, !ej2_base_1.Browser.isDevice ? (React.createElement("div", { className: "e-mobile-layout" },
                React.createElement("div", { className: "e-mobile-content" },
                    React.createElement(ej2_react_grids_1.GridComponent, { id: "adaptivebrowser", dataSource: data_1.data, height: '100%', ref: function (g) { grid = g; }, enableAdaptiveUI: true, rowRenderingMode: renderingMode, allowFiltering: true, allowSorting: true, allowGrouping: false, showColumnChooser: true, showColumnMenu: true, allowPaging: true, groupSettings: groupOptions, filterSettings: filterOptions, toolbar: toolbarOptions, editSettings: editSettings, pageSettings: { pageCount: 3, pageSizes: true }, load: load, toolbarClick: toolbarClick, allowExcelExport: true, allowPdfExport: true },
                        React.createElement(ej2_react_grids_1.ColumnsDirective, null,
                            React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'OrderID', headerText: 'Order ID', width: '180', isPrimaryKey: true, validationRules: orderidRules }),
                            React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'Freight', headerText: 'Freight', width: '180', format: 'C2', editType: 'numericedit', validationRules: validationRule }),
                            React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'CustomerName', headerText: 'Name', width: '180', validationRules: validationRule }),
                        ...
                        React.createElement(ej2_react_grids_1.Inject, { services: [ej2_react_grids_1.Filter, ej2_react_grids_1.Sort, ej2_react_grids_1.Group, ej2_react_grids_1.Edit, ej2_react_grids_1.Resize, ej2_react_grids_1.Toolbar, ej2_react_grids_1.Aggregate, ej2_react_grids_1.Page, ej2_react_grids_1.ExcelExport, ej2_react_grids_1.PdfExport, ej2_react_grids_1.ColumnChooser, ej2_react_grids_1.ColumnMenu] }))))) : (React.createElement(ej2_react_grids_1.GridComponent, { id: "adaptivedevice", dataSource: data_1.data, height: '100%', ref: function (g) { grid = g; }, enableAdaptiveUI: true, rowRenderingMode: renderingMode, allowFiltering: true, allowSorting: true, allowGrouping: false, showColumnChooser: true, showColumnMenu: true, allowPaging: true, groupSettings: groupOptions, filterSettings: filterOptions, toolbar: toolbarOptions, editSettings: editSettings, pageSettings: { pageCount: 3, pageSizes: true }, load: load, toolbarClick: toolbarClick, allowExcelExport: true, allowPdfExport: true },
                React.createElement(ej2_react_grids_1.ColumnsDirective, null,
                    React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'OrderID', headerText: 'Order ID', width: '180', isPrimaryKey: true, validationRules: orderidRules }),
                    React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'Freight', headerText: 'Freight', width: '180', format: 'C2', editType: 'numericedit', validationRules: validationRule }),
                    React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'CustomerName', headerText: 'Name', width: '180', validationRules: validationRule }),
                            ...
                            React.createElement("tr", null,
                                ...
                                React.createElement("td", null,
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_buttons_1.CheckBoxComponent, { ref: function (scope) { checkboxObj = scope; }, change: onChange.bind(this), "aria-label": "Enable horizontal row mode" })))))))),
