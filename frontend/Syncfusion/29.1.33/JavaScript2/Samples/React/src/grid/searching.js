    ...
    Searching.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section row' },
                React.createElement(ej2_react_grids_1.GridComponent, { dataSource: data_1.categoryData, toolbar: this.toolbarOptions, allowSorting: true, allowFiltering: true, filterSettings: this.filterSettings, allowPaging: true, pageSettings: { pageSize: 10, pageCount: 5 } },
