...
function Print() {
    ...
    const toolbar = ['Add', 'Edit', 'Delete', 'Update', 'Cancel', 'Print'];
    const editSettings = { allowEditing: true, allowAdding: true, allowDeleting: true };
    const firstnameRule = { required: true, minLength: 5 };
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                ...
                <br />
                <GridComponent ref={r => grid = r} dataSource={employeeData} childGrid={childGrid} editSettings={editSettings} allowFiltering={true} filterSettings={filterSettings} toolbar={toolbar} allowSorting={true} hierarchyPrintMode={'All'} cssClass={document.querySelector('.fluent2-highcontrast') ? 'e-print-fluent2-highcontrast' : ''}>
                    <ColumnsDirective>
