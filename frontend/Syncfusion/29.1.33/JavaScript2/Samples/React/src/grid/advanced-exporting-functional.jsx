...
function AdvancedExporting() {
    ...
    const toolbarOptions = ['Add', 'Edit', 'Delete', 'Update', 'Cancel', 'ExcelExport', 'PdfExport'];
    const editSettings = { allowEditing: true, allowAdding: true, allowDeleting: true };
    const productnameRule = { required: true, minLength: 5 };
