...
function RemoteDataBinding() {
    ...
    var data = new ej2_data_1.DataManager({ url: hostUrl + 'api/Orders', adaptor: new ej2_data_1.WebApiAdaptor });
    var gridInstance;
    var onChanged = function (args) {
        gridInstance.dataSource = new ej2_data_1.DataManager({ url: hostUrl + 'api/Orders', adaptor: new ej2_data_1.WebApiAdaptor, enableCache: args.checked });
    };
            ...
            React.createElement("div", { style: { display: 'flex' } },
                React.createElement("div", { id: "export-cache-container" },
                    ...
                    React.createElement("div", null,
                        React.createElement(ej2_react_buttons_1.SwitchComponent, { id: "unchecked", checked: false, change: onChanged.bind(this) })))),
            React.createElement(ej2_react_grids_1.GridComponent, { id: "Grid", dataSource: data, ref: function (grid) { return gridInstance = grid; }, allowPaging: true },
