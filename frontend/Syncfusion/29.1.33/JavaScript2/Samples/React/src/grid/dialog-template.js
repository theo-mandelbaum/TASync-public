...
exports.DialogFormTemplate = exports.DialogTemplate = void 0;
    ...
    DialogTemplate.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_grids_1.GridComponent, { dataSource: data_1.data, toolbar: this.toolbarOptions, allowSorting: true, allowFiltering: true, filterSettings: this.filterSettings, allowPaging: true, editSettings: this.editSettings, pageSettings: this.pageSettings, actionComplete: this.actionComplete.bind(this) },
