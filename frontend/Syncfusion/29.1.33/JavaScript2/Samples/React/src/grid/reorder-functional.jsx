...
import { GridComponent, ColumnsDirective, ColumnDirective, Reorder, Inject, Sort, Toolbar, Filter, Edit } from '@syncfusion/ej2-react-grids';
...
function Reordering() {
    ...
    return (<div className='control-pane'>
            ...
            <div id='description'>
                <p>
                    Reordering can be enabled by setting  <code><a target='_blank' className='code' href='https://ej2.syncfusion.com/react/documentation/api/grid/#allowreordering'>
