...
import { GridComponent, ColumnsDirective, ColumnDirective, Sort, Inject, Toolbar, ExcelExport, PdfExport, Page, Filter, Edit } from '@syncfusion/ej2-react-grids';
...
export class AdvancedExporting extends SampleBase {
    ...
    toolbarOptions = ['Add', 'Edit', 'Delete', 'Update', 'Cancel', 'ExcelExport', 'PdfExport'];
    editSettings = { allowEditing: true, allowAdding: true, allowDeleting: true };
    productnameRule = { required: true, minLength: 5 };
    ...
    render() {
        ...
        <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/#excelexport">excelExport</a></code>,
                    <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/#pdfexport">pdfExport</a></code>
              methods.
              </p>
