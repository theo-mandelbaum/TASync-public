...
var Print = /** @class */ (function (_super) {
    ...
    function Print() {
        ...
        _this.toolbar = ['Add', 'Edit', 'Delete', 'Update', 'Cancel', 'Print'];
    ...
    Print.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                ...
                React.createElement(ej2_react_grids_1.GridComponent, { ref: function (r) { return _this.grid = r; }, dataSource: data_1.employeeData, childGrid: this.childGrid, editSettings: this.editSettings, allowFiltering: true, filterSettings: this.filterSettings, toolbar: this.toolbar, allowSorting: true, hierarchyPrintMode: 'All', cssClass: document.querySelector('.fluent2-highcontrast') ? 'e-print-fluent2-highcontrast' : '' },
                    React.createElement(ej2_react_grids_1.ColumnsDirective, null,
                        ...
                        React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'FirstName', headerText: 'Name', width: '125', validationRules: this.firstnameRule }),
