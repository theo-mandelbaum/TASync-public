...
export class KeyboardNavigation extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <GridComponent dataSource={data} toolbar={this.toolbarOptions} allowPaging={true} allowFiltering={true} editSettings={this.editSettings} pageSettings={this.pageSettings} filterSettings={{ type: 'Menu' }} allowSorting={true} allowGrouping={true} selectionSettings={{ type: 'Multiple' }}>
            <ColumnsDirective>
