...
var DetailTemplate = /** @class */ (function (_super) {
    ...
    function DetailTemplate() {
        ...
        _this.detailDataBound = function (args) {
            var rowData = args.data;
            _this.taskData = data_1.taskDetail.filter(function (task) { return task.Assignee === rowData.Name; });
            _this.salesData = _this.generateData(_this.taskData);
        };
        _this.cardTemplate = function (props) {
        ...
        _this.taskTemplate = function () {
            return (React.createElement("div", { style: { paddingTop: '20px', paddingBottom: '20px' } },
                React.createElement(ej2_react_kanban_1.KanbanComponent, { id: "kanban", cssClass: "kanban-swimlane-template", keyField: "Status", dataSource: _this.taskData, cardSettings: { template: _this.cardTemplate.bind(_this), headerField: 'Id' } },
            ...
            return (React.createElement("div", { style: { paddingTop: "20px", paddingBottom: "20px" } },
                React.createElement(ej2_react_charts_1.ChartComponent, { height: '302px', tooltip: { enable: true }, primaryXAxis: { valueType: 'Category', title: 'Status' }, title: "Burndown Chart" },
                    ...
                    React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: _this.salesData, xName: "taskid", yName: "estimatedHours", name: "Estimated Hours", marker: { visible: true, width: 10, height: 10 } }),
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: _this.salesData, xName: "taskid", yName: "spentHours", name: "Spent Hours", marker: { visible: true, width: 10, height: 10 } })))));
        };
        _this.detailTemplate = function () {
            var headertext = [{ text: "Taskboard" }, { text: "Burndown Chart" }];
            return (React.createElement("div", null,
                React.createElement("p", { style: { textAlign: "center", paddingTop: "3px", fontSize: "18px" } },
                ...
                React.createElement(ej2_react_navigations_1.TabComponent, { animation: {
                    ...
                    React.createElement(ej2_react_navigations_1.TabItemsDirective, null,
                        React.createElement(ej2_react_navigations_1.TabItemDirective, { header: headertext[0], content: _this.taskTemplate }),
                        React.createElement(ej2_react_navigations_1.TabItemDirective, { header: headertext[1], content: _this.chartTemplate })))));
        };
        _this.employeeTemplate = function (props) {
    ...
    DetailTemplate.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_grids_1.GridComponent, { dataSource: data_1.employeeDetail, height: '600', detailDataBound: this.detailDataBound.bind(this), detailTemplate: this.detailTemplate.bind(this), width: 'auto', allowSorting: true, allowFiltering: true, filterSettings: { type: 'CheckBox' } },
                    React.createElement(ej2_react_grids_1.ColumnsDirective, null,
                        React.createElement(ej2_react_grids_1.ColumnDirective, { headerText: 'Image', width: '180', template: this.employeeTemplate, textAlign: 'Center' }),
                        ...
                        React.createElement(ej2_react_grids_1.ColumnDirective, { field: "MailID", headerText: 'Email', width: 120, template: this.emailTemplate }),
