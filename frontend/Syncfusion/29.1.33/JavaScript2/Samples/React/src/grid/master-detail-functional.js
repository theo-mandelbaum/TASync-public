...
function MasterDetail() {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_grids_1.GridComponent, { dataSource: master, selectedRowIndex: 2, rowSelected: rowselect.bind(this) },
            ...
            React.createElement(ej2_react_grids_1.GridComponent, { dataSource: detail, allowSelection: false, ref: function (grid) { return detailGrid = grid; } },
                React.createElement(ej2_react_grids_1.ColumnsDirective, null,
        ...
        React.createElement("div", { id: 'description' },
            ...
            React.createElement("ul", null,
                React.createElement("li", null,
                    ...
                    React.createElement("code", null,
                        React.createElement("a", { target: "_blank", className: "code", href: "https://ej2.syncfusion.com/react/documentation/api/grid/#rowselected" }, "rowSelected")),
                    " event."),
                React.createElement("li", null,
            ...
            React.createElement("p", null,
                "Use ",
                React.createElement("code", null,
                    React.createElement("a", { target: "_blank", className: "code", href: "https://ej2.syncfusion.com/react/documentation/api/grid/#selectedrowindex" }, "selectedRowIndex")),
