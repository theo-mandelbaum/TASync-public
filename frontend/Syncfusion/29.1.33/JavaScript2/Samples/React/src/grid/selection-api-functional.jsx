...
function SelectionAPI() {
    ...
    function checkboxTemp() {
        return (<CheckBoxComponent label='Enable Column Selection' ref={(columnSelection) => { checkboxObj = columnSelection; }} change={setColumnSelection.bind(this)}/>);
    }
    const template = checkboxTemp;
    return (<div className='control-pane'>
            <div className='control-section'>
                ...
                <br />
                <GridComponent dataSource={data} ref={grid => gridInstance = grid} enableHover={false} allowSorting={true} allowFiltering={true} filterSettings={filterSettings} allowPaging={true} pageSettings={{ pageCount: 5 }} selectionSettings={selectionsettings} rowSelecting={selectingEvents} cellSelecting={selectingEvents}>
                    <ColumnsDirective>
