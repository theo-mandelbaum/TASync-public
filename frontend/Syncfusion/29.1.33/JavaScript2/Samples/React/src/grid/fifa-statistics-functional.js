...
function FIFAStatistics() {
    ...
    var fifaGridIns = (0, react_1.useRef)(null);
    var tooltipObj = (0, react_1.useRef)(null);
    var isverticalPopup;
    var colTemplate = function (args) {
    ...
    var topScoreTemplate = function (args) {
    ...
    var awardTemplate = function (args) {
    ...
    var beforeRender = function (args) {
        var _a;
        var rowInfo = (_a = fifaGridIns.current) === null || _a === void 0 ? void 0 : _a.getRowInfo(args.target.closest('td'));
    ...
    function queryCellInfo(args) {
        ...
        if (((_a = args.column) === null || _a === void 0 ? void 0 : _a.field) === 'BestPlayerAward') {
            ...
            if (rowIndex > 0) {
                if (((_c = fifaGridIns.current) === null || _c === void 0 ? void 0 : _c.currentViewData[rowIndex - 1])[args.column.field] !== args.data[args.column.field]) {
    ...
    function calculateRowspan(args, rowIndex) {
        var _a, _b, _c, _d, _e;
        var rowspan = 1;
        for (var i = rowIndex + 1, j = 0; i < ((_a = fifaGridIns.current) === null || _a === void 0 ? void 0 : _a.currentViewData.length); i++, j++) {
            if (!(args.data[(_b = args.column) === null || _b === void 0 ? void 0 : _b.field] === ((_c = fifaGridIns.current) === null || _c === void 0 ? void 0 : _c.currentViewData[i])[(_d = args.column) === null || _d === void 0 ? void 0 : _d.field])) {
                rowspan = j + 1;
                break;
            }
            if (i === ((_e = fifaGridIns.current) === null || _e === void 0 ? void 0 : _e.currentViewData.length) - 1) {
                rowspan = j + 2;
                break;
            }
        }
    ...
    var dataBound = function () {
        var _a;
        var tableEle = (_a = fifaGridIns.current) === null || _a === void 0 ? void 0 : _a.element.querySelector('.e-gridcontent table');
        if (tableEle) {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_popups_1.TooltipComponent, { id: 'tooltip', cssClass: 'fifa_tooltip', target: '.infotooltip', beforeRender: beforeRender, beforeOpen: beforeOpen, ref: tooltipObj, opensOn: 'Hover', width: 275 },
                React.createElement(ej2_react_grids_1.GridComponent, { ref: fifaGridIns, id: 'fifa_grid', dataSource: data_1.fifaData, gridLines: 'Both', allowSorting: true, enableStickyHeader: true, allowTextWrap: true, textWrapSettings: { wrapMode: 'Content' }, enableAltRow: true, enableHover: false, allowSelection: false, queryCellInfo: queryCellInfo, dataBound: dataBound, load: load },
                    React.createElement(ej2_react_grids_1.ColumnsDirective, null,
                        React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'Year', headerText: 'Year', width: '100', textAlign: 'Right' }),
                        React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'Host', headerText: 'Organizer', template: colTemplate, width: '140' }),
                        React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'Champions', headerText: 'Champions', template: colTemplate, width: '140' }),
                        React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'Coach', headerText: 'Winning Coach', template: colTemplate, width: '185' }),
                        React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'TopScorer', headerText: 'Most Scorer(s)', template: topScoreTemplate, width: '185' }),
                        React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'BestPlayerAward', headerText: 'Player of season', template: awardTemplate, width: '170' })),
...
exports.default = FIFAStatistics;
