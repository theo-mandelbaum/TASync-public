    ...
    render() {
        return (<div className='control-pane'>
                <div className='control-section row'>
                    <GridComponent dataSource={data} allowPaging={true} allowFiltering={true} height={365} allowReordering={true} editSettings={{ allowEditing: true, allowAdding: false, allowDeleting: false, mode: 'Normal' }} allowGrouping={true} enableRtl={true} filterSettings={{ type: 'Menu' }} allowSorting={true} pageSettings={{ pageSize: 10, pageCount: 2 }}>
                        <ColumnsDirective>
                            ...
                            <ColumnDirective field='OrderDate' editType='datepickeredit' headerText='Order Date' width='130' format='yMd' textAlign='Right' allowGrouping={false}/>
        ...
        enabled by setting <code> <a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/#enablertl">enableRtl
