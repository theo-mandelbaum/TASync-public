...
import { GridComponent, ColumnsDirective, ColumnDirective, Page, Inject, Resize, Sort, Toolbar, ColumnChooser, Filter, Edit } from '@syncfusion/ej2-react-grids';
...
export class StackedHeader extends SampleBase {
    ...
    feedbackTemplate(props) {
        return (<div>
            <RatingComponent value={props.Feedback} cssClass={'custom-rating'} readOnly={true}/>
        </div>);
    }
    ...
    columnChooserSettings = { template: this.Template, headerTemplate: this.HeaderTemplate, footerTemplate: this.FooterTemplate };
    render() {
        return (<div className='control-pane'>
                ...
                <div id='description'>
                    ...
                    <p>The Grid allows grouping columns to display multiple levels of headers using the <code><a target='_blank' className='code' href='https://ej2.syncfusion.com/react/documentation/api/grid#columns'> columns</a></code> property.</p>
