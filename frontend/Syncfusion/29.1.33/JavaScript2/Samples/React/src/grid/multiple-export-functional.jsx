...
function MultipleExport() {
    ...
    return (<div className='control-pane'>
        ...
        <p className="e-mastertext">Master Grid</p>
                <GridComponent id='MasterGrid' dataSource={master} selectedRowIndex={2} ref={grid => masterGrid = grid} allowExcelExport={true} allowPdfExport={true} toolbar={toolbarOptions} exportGrids={gridsToexport} rowSelected={rowselect.bind(this)} toolbarClick={toolbarClick.bind(this)}>
                    <ColumnsDirective>
