...
export class DetailTemplate extends SampleBase {
    ...
    detailDataBound = (args) => {
        ...
        this.taskData = taskDetail.filter((task) => task.Assignee === rowData.Name);
    ...
    render() {
        ...
        <p>
            ...
            Syncfusion Kanban component</a></code> used to list assigned tasks and their current statuses, and the second tab contains <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/demos/#/fluent2/chart/overview.html"> Syncfusion Chart Component</a></code> used to 
            display the burndown chart of employee task estimated time vs actual spend time.
                    ...
                    <p>
                      ...
                      <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/grid/row/detail-template">
