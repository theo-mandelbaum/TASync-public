...
import { GridComponent, ColumnsDirective, ColumnDirective, Sort, Inject, Page, Aggregate, Group, AggregateColumnsDirective, AggregateColumnDirective, AggregateDirective, AggregatesDirective, Filter } from '@syncfusion/ej2-react-grids';
...
function AggregateGroup() {
    ...
    const groupSettings = { showDropArea: false, columns: ['ConsumptionCategory'], showGroupedColumn: true };
    ...
    return (<div className='control-pane'>
      ...
      <GridComponent id="group-aggregate-grid" dataSource={energyData} allowSorting={true} gridLines='Vertical' enableHover={false} allowMultiSorting={true} height={300} allowGrouping={true} groupSettings={groupSettings} allowFiltering={true} filterSettings={filterSettings}>
        ...
        <ul>
            ...
            <li><code>Custom</code> - Requires the <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/aggregateColumn/#customaggregate">
            customAggregate
        ...
        <p>
            In this demo, the <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/aggregateColumn/#groupfootertemplate">
            groupFooterTemplate</a></code> property is used to display the group footer aggregation for the <strong><i>Energy Produced</i></strong> column and the <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/aggregateColumn/#groupcaptiontemplate">
            groupCaptionTemplate</a></code> property is used to display its group caption aggregation.
        </p>    
        <p>    To enable group footer aggregation for the <strong><i>Energy Produced</i></strong> column, use the <code>Sum</code> aggregate type by setting the <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/aggregateColumn/#type">
            type</a></code> and set the <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/aggregateColumn/#field">
            field</a></code> property to <strong><i>EnergyProduced</i></strong> which will be used to perform the aggregation.
            The aggregate value is accessed inside the <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/aggregateColumn/#groupfootertemplate">
            groupFooterTemplate</a></code> using its <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/aggregateColumn/#type">
            type</a></code> name (<code>Sum</code>).
        </p>
        <p>    To enable group caption aggregation for the <strong><i>Energy Produced</i></strong> column, the <code>max</code> and <code>min</code>aggregate types are used by setting the <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/aggregateColumn/#type">
            type</a></code> and the <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/aggregateColumn/#field">
            field</a></code> property is set to <strong><i>EnergyProduced</i></strong>, which will be used to perform the aggregation.
            The aggregate value is accessed inside the<code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/aggregateColumn/#groupcaptiontemplate">
            groupCaptionTemplate</a></code> using its <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/aggregateColumn/#type">
            type</a></code> name (<code>Max</code> and <code>Min</code>).
        </p>
        <p>In this sample, we use the <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/aggregateColumn/#groupcaptiontemplate">
