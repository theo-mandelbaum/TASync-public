...
import { GridComponent, Inject, ColumnsDirective, ColumnDirective, DetailRow, Toolbar, PdfExport, ExcelExport, Page } from '@syncfusion/ej2-react-grids';
...
export class HierarchyExport extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <GridComponent id='MasterDetailsExport' ref={r => this.grid = r} dataSource={employeeData} childGrid={this.childGrid} toolbar={['PdfExport', 'ExcelExport']} allowPdfExport={true} allowExcelExport={true} toolbarClick={this.toolbarClick.bind(this)}>
              <ColumnsDirective>
