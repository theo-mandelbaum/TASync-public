...
import { GridComponent, ColumnsDirective, ColumnDirective, Sort, Inject, Filter } from '@syncfusion/ej2-react-grids';
        ...
        ui: {
            ...
            read: (args) => {
                ...
                if (this.dropInstance?.value.length) {
                    args.fltrObj.filterByColumn(args.column.field, args.operator, this.dropInstance?.value.sort().join(', '));
                }
            },
        },
    };
    render() {
        ...
        Image column.
                ...
                <p>
                    ...
                    <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/column/#template">columns-&gt;template
                ...
                <p>
                    ...
                    <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/grid/columns/column-template">
