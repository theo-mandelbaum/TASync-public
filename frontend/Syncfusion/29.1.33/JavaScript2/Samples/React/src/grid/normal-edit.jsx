...
export class NormalEdit extends SampleBase {
    ...
    freightRule = { required: true, min: 0 };
    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-md-9'>
            <GridComponent dataSource={orderDataSource} ref={grid => this.gridInstance = grid} allowSorting={true} allowFiltering={true} filterSettings={this.filterSettings} toolbar={this.toolbarOptions} allowPaging={true} editSettings={this.editSettings} pageSettings={this.pageSettings} actionBegin={this.actionBegin.bind(this)}>
              <ColumnsDirective>
        ...
        <div id="description">
          ...
          <p>
            ...
            <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/grid/editing/in-line-editing">
