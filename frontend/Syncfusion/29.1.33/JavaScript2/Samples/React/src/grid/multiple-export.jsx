...
import { GridComponent, ColumnsDirective, ColumnDirective, Selection, Inject, PdfExport, ExcelExport, Toolbar } from '@syncfusion/ej2-react-grids';
...
export class MultipleExport extends SampleBase {
    ...
    names = ['AROUT', 'BERGS', 'BLONP', 'CHOPS', 'ERNSH'];
    master = customerData.filter((e) => this.names.indexOf(e.CustomerID) !== -1);
    ;
    rowselect(args) {
    ...
    render() {
        return (<div className='control-pane'>
                ...
                <p className="e-mastertext">Master Grid</p>
                    <GridComponent id='MasterGrid' ref={grid => this.masterGrid = grid} dataSource={this.master} selectedRowIndex={2} allowExcelExport={true} allowPdfExport={true} toolbar={this.toolbarOptions} exportGrids={this.exportGrids} rowSelected={this.rowselect.bind(this)} toolbarClick={this.toolbarClick.bind(this)}>
                        <ColumnsDirective>
                ...
                <div id='description'>
                    ...
                    <p>
                        More information on the exporting configuration can be found in this <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/grid/excel-export/excel-exporting">
