...
function GridLines() {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            ...
            React.createElement(ej2_react_grids_1.GridComponent, { dataSource: data_1.employeeData, ref: function (grid) { return gridInstance = grid; }, gridLines: 'Default', allowSorting: true, editSettings: editSettings, allowFiltering: true, filterSettings: filterSettings, toolbar: toolbar },
                React.createElement(ej2_react_grids_1.ColumnsDirective, null,
                    ...
                    React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'FirstName', headerText: 'FirstName', width: '125', validationRules: firstnameRule }),
