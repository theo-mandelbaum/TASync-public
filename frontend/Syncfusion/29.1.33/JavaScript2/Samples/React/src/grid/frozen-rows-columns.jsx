...
import { GridComponent, ColumnsDirective, ColumnDirective, Freeze, Inject, Resize, Sort, Filter } from '@syncfusion/ej2-react-grids';
...
export class FrozenRowsColumns extends SampleBase {
    ...
    render() {
        ...
        <div id='description'>
          ...
          <p>
              In this demo sample, the first column and two rows are set to frozen by using the <a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/#frozenrows"><code>frozenRows</code></a> and
