...
export class FrozenAPI extends SampleBase {
    ...
    directionChange(e) {
        if (this.refresh) {
            ...
            let mvblColumns = this.grid.getMovableColumns();
    ...
    columnChange(e) {
        ...
        let column = this.grid.getColumnByField(columnName);
    ...
    render() {
        ...
        <DialogComponent id="alertDialog" header='Frozen' visible={false} animationSettings={{ effect: 'None' }} width='300px' content='Atleast one Column should be in movable' ref={(alertdialog) => { this.alertDialogInstance = alertdialog; }} target='.control-section' buttons={this.confirmButton} showCloseIcon={false}></DialogComponent>
