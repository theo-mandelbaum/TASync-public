    ...
    return (<div className='control-pane'>
            ...
            <div id='description'>
                <p>
                    ...
                    By default, paging is disabled. To enable paging, set <code><a target='_blank' className='code' href='https://ej2.syncfusion.com/react/documentation/api/grid/#allowpaging'>
                        allowPaging</a></code> property to true.
                    <code><a target='_blank' className='code' href='https://ej2.syncfusion.com/react/documentation/api/grid/pageSettings/#pagesizes'>
                ...
                <p>
                    ...
                    <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/grid/pageSettings/#pagecount">
