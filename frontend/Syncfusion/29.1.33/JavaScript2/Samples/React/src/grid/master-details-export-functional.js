...
function HierarchyExport() {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_grids_1.GridComponent, { id: 'MasterDetailsExport', ref: function (r) { return grid = r; }, dataSource: data_1.employeeData, childGrid: childGrid, toolbar: ['PdfExport', 'ExcelExport'], allowPdfExport: true, allowExcelExport: true, toolbarClick: toolbarClick.bind(this) },
...
exports.default = HierarchyExport;
