...
function HierarchyExport() {
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                <GridComponent id='MasterDetailsExport' ref={r => grid = r} dataSource={employeeData} childGrid={childGrid} toolbar={['PdfExport', 'ExcelExport']} allowPdfExport={true} allowExcelExport={true} toolbarClick={toolbarClick.bind(this)}>
                    <ColumnsDirective>
