...
var Filtering = /** @class */ (function (_super) {
    ...
    Filtering.prototype.onChanged = function (args) {
        if (args.checked) {
    ...
    Filtering.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'col-lg-9 control-section' },
                ...
                React.createElement(ej2_react_grids_1.GridComponent, { dataSource: data_1.categoryData, allowPaging: true, allowSorting: true, ref: function (grid) { return _this.gridInstance = grid; }, pageSettings: { pageSize: 10, pageCount: 5 }, allowFiltering: true },
                        ...
                        React.createElement("tbody", null,
                            React.createElement("tr", null,
                                ...
                                React.createElement("td", { style: { width: '30%', padding: '10px 10px 10px 0px' } },
                                    React.createElement(ej2_react_buttons_1.CheckBoxComponent, { ref: function (scope) { _this.checkboxObj = scope; }, change: this.onChanged.bind(this), "aria-label": "Enable Filterbar operator" }))))))),
