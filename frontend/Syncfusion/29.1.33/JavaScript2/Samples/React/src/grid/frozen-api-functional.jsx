...
import { GridComponent, ColumnsDirective, ColumnDirective, Inject, Sort, Freeze, Toolbar, Filter, Edit } from '@syncfusion/ej2-react-grids';
...
function FrozenAPI() {
    ...
    function directionChange(e) {
        if (refresh) {
            let columnName = columnDropDown.value;
            let mvblColumns = grid.getMovableColumns();
    ...
    function columnChange(e) {
        ...
        let column = grid.getColumnByField(columnName);
    ...
    return (<div className='control-pane'>
      ...
      <DialogComponent id="alertDialog" header='Frozen' visible={false} animationSettings={{ effect: 'None' }} width='300px' content='Atleast one Column should be in movable' ref={(alertdialog) => { alertDialogInstance = alertdialog; }} target='.control-section' buttons={confirmButton} showCloseIcon={false}></DialogComponent>
