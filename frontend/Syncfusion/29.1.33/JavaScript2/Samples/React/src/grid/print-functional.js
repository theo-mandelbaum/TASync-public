...
function Print() {
    ...
    var toolbar = ['Add', 'Edit', 'Delete', 'Update', 'Cancel', 'Print'];
    ...
    function click(e) {
        ...
        grid.hierarchyPrintMode = grid.childGrid.hierarchyPrintMode = element.innerHTML;
    }
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { className: 'e-statustext' }, "Select Hierarchy PrintMode"),
            React.createElement(ej2_react_navigations_1.ToolbarComponent, { id: "toolbar", onClick: click.bind(this) },
            ...
            React.createElement(ej2_react_grids_1.GridComponent, { ref: function (r) { return grid = r; }, dataSource: data_1.employeeData, childGrid: childGrid, editSettings: editSettings, allowFiltering: true, filterSettings: filterSettings, toolbar: toolbar, allowSorting: true, hierarchyPrintMode: 'All', cssClass: document.querySelector('.fluent2-highcontrast') ? 'e-print-fluent2-highcontrast' : '' },
                React.createElement(ej2_react_grids_1.ColumnsDirective, null,
                    React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'EmployeeID', headerText: 'Employee ID', width: '125', textAlign: 'Right', validationRules: employeeidRules, isPrimaryKey: true }),
                    React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'FirstName', headerText: 'Name', width: '125', validationRules: firstnameRule }),
                    React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'Title', headerText: 'Title', width: '180' }),
                    React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'HireDate', headerText: 'Hire Date', width: '135', format: 'yMd', textAlign: 'Right', editType: 'datepickeredit' }),
                    React.createElement(ej2_react_grids_1.ColumnDirective, { field: 'ReportsTo', headerText: 'Reports To', width: '135', textAlign: 'Right' })),
                React.createElement(ej2_react_grids_1.Inject, { services: [ej2_react_grids_1.DetailRow, ej2_react_grids_1.Toolbar, ej2_react_grids_1.Sort, ej2_react_grids_1.Page, ej2_react_grids_1.Filter, ej2_react_grids_1.Edit] }))),
        ...
        React.createElement("div", { id: "description" },
            React.createElement("p", null,
                ...
                React.createElement("code", null,
                    React.createElement("a", { target: "_blank", className: "code", href: "https://ej2.syncfusion.com/react/documentation/api/grid#print" }, "print")),
                ...
                React.createElement("code", null,
                    React.createElement("a", { target: "_blank", className: "code", href: "https://ej2.syncfusion.com/react/documentation/api/grid#printmode" }, "printMode")),
                " property value as ",
            ...
            React.createElement("p", null,
                ...
                React.createElement("code", null,
                    React.createElement("a", { target: "_blank", className: "code", href: "https://ej2.syncfusion.com/react/documentation/api/grid#hierarchyprintmode" }, "hierarchyPrintMode")),
                " property."),
            React.createElement("p", null,
            ...
            React.createElement("p", null,
                ...
                React.createElement("code", null,
                    React.createElement("a", { target: "_blank", className: "code", href: "https://ej2.syncfusion.com/react/documentation/api/grid/detailRow/" }, "DetailRow ")),
                " module into the ",
