        ...
        React.createElement("div", { className: "col-lg-8 control-section" },
            React.createElement("div", { className: "control-wrapper" },
                React.createElement("div", { id: "default", style: { paddingTop: '75px' } },
                    React.createElement(ej2_react_dropdowns_1.AutoCompleteComponent, { id: "games", dataSource: records, placeholder: "e.g. Item", allowObjectBinding: true, fields: fields, change: onChange.bind(_this), value: value, popupHeight: "220px" })))),
