...
var DisabledItems = function () {
    ...
    var statusFields = { value: "Status", disabled: "State" };
    ...
    var vegetableFields = { groupBy: 'Category', value: 'Vegetable', disabled: 'State' };
        ...
        React.createElement("div", { className: 'control-section', id: 'dropIcon' },
            React.createElement("div", { className: 'col-lg-6' },
                React.createElement("div", { id: "disabled-status" },
                    ...
                    React.createElement(ej2_react_dropdowns_1.AutoCompleteComponent, { id: "status", dataSource: statusData, fields: statusFields, placeholder: "Select Status" }))),
            React.createElement("div", { className: 'col-lg-6' },
                React.createElement("div", { id: "vegetable" },
                    React.createElement("h4", null, "Vegetable"),
                    React.createElement(ej2_react_dropdowns_1.AutoCompleteComponent, { id: "vegetables", dataSource: vegetableData, fields: vegetableFields, placeholder: "Select Vegetable" })))),
