...
export function setSelectList() {
    const listItems = document.querySelectorAll('#controlList .e-list-item.e-level-1');
    ...
    if (control) {
        ...
        let treeControl = select('#controlTree').ej2_instances[0];
...
export class LeftPane extends React.Component {
     ...
     */
    controlSampleData = {};
    samplesTreeList = this.getTreeviewList(this.getDataSource());
    /**
     * TreeView Configuration
     */
    treeFields = { dataSource: this.samplesTreeList, id: 'id', parentID: 'pid', text: 'name', hasChildren: 'hasChild', htmlAttributes: 'url', sortOrder: 'order' };
    /**
     * ListView Configuration
     */
    fields = { id: 'id', text: 'name', groupBy: 'order', htmlAttributes: 'data' };
    ...
    groupTemlate = '${if(items[0]["category"])}<div class="e-text-content">' +
