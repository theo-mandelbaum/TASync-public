...
function setSelectList() {
    ...
    var control = (0, ej2_base_1.select)('[control-name="' + hash[2] + '"]') || (0, ej2_base_1.select)('[control-name="grid"]');
    if (control) {
    ...
    LeftPane.prototype.controlSelect = function (arg) {
        ...
        if (path) {
            ...
            if (path !== curHashCollection) {
                ...
                if (arg.item && ((isMobile && !(0, ej2_base_1.select)('#left-sidebar').classList.contains('sb-hide')) ||
