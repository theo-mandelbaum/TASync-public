        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section tab-control-section row' },
                React.createElement("div", { className: 'col-lg-8 control-section' },
                    React.createElement("div", { className: 'tab-control-resize-container' },
                        React.createElement(ej2_react_navigations_1.TabComponent, { ref: function (tab) { _this.tabObj = tab; }, cssClass: 'responsive-mode', heightAdjustMode: 'None', height: '250px', width: 'auto' },
