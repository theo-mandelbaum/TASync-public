    ...
    Orientation.prototype.render = function () {
        ...
        function template1() {
            return (React.createElement("div", null,
                ...
                React.createElement(ej2_react_lists_1.ListViewComponent, { id: "rome", dataSource: this.romeEmployees, template: this.templateString })));
        }
        function template2() {
            return (React.createElement("div", null,
                React.createElement("div", { className: "content-title" },
                    React.createElement("div", { className: "cnt-text" }, "Employee Info")),
                React.createElement(ej2_react_lists_1.ListViewComponent, { id: "paris", dataSource: this.parisEmployees, template: this.templateString })));
        }
        function template3() {
            return (React.createElement("div", null,
                React.createElement("div", { className: "content-title" },
                    React.createElement("div", { className: "cnt-text" }, "Employee Info")),
                React.createElement(ej2_react_lists_1.ListViewComponent, { id: "london", dataSource: this.londonEmployees, template: this.templateString })));
        }
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section tab-control-section row' },
                React.createElement("div", { className: 'col-lg-8' },
                    React.createElement(ej2_react_navigations_1.TabComponent, { ref: function (tab) { _this.tabObj = tab; }, cssClass: 'orientation-tab', showCloseButton: true, height: 320 },
