...
var Wizard = /** @class */ (function (_super) {
    ...
    Wizard.prototype.removeItem = function () {
        var tabItems = this.tab.element.querySelectorAll('.e-item');
        ...
        switch (e.target.id) {
            ...
            case "confirmTickets":
                ...
                if (name_1.value === "" || age === "" || gender === "") {
                    ...
                    this.reserved = [];
                    var paymentTab = this.tab.element.querySelectorAll('.e-item')[3];
                    if (paymentTab) {
                        paymentTab.remove();
                    }
    ...
    Wizard.prototype.content0 = function () {
        ...
        return (React.createElement("div", { id: "booking" },
            ...
            React.createElement("div", { className: "responsive-align" },
                ...
                React.createElement("div", { className: "row" },
                    React.createElement("div", { className: "col-xs-6 col-sm-6 col-lg-6 col-md-6 search-item" },
                        React.createElement(ej2_react_calendars_1.DatePickerComponent, { ref: function (calendar) { return (_this.journeyDate = calendar); }, width: "100%", placeholder: "Journey Date", floatLabelType: "Auto", value: this.today, min: this.dateMin, max: this.dateMax, focus: this.focusIn.bind(this) })),
                    React.createElement("div", { className: "col-xs-6 col-sm-6 col-lg-6 col-md-6 search-item" },
    ...
    Wizard.prototype.content3 = function () {
        ...
        return (React.createElement("div", { id: "confirm" },
            ...
            React.createElement("br", null),
            React.createElement("div", { id: "amount" }, this.amountDetails),
            React.createElement("br", null),
            React.createElement("div", { className: "btn-container" },
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: "col-lg-12 control-section e-tab-section" },
                React.createElement("div", { className: "e-sample-resize-container" },
                    React.createElement(ej2_react_navigations_1.TabComponent, { id: "tab-wizard", ref: function (tab) { return (_this.tab = tab); }, heightAdjustMode: "None", height: 'auto', selecting: this.tabSelecting.bind(this) },
                    ...
                    React.createElement(ej2_react_popups_1.DialogComponent, { ref: function (dialog) { return (_this.alertDlg = dialog); }, header: "Success", width: 250, isModal: true, visible: false, showCloseIcon: true, content: "Your payment was successfully processed", target: this.dlgTarget, buttons: this.dlgButtons, created: this.dlgCreated.bind(this) }))),
