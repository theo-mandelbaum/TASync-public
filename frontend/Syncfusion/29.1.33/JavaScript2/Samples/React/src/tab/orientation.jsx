    ...
    render() {
        function template1() {
            return (<div>
                    ...
                    <ListViewComponent id="rome" dataSource={this.romeEmployees} template={this.templateString}>
                    </ListViewComponent>
                </div>);
        }
        function template2() {
            return (<div>
                    ...
                    <ListViewComponent id="paris" dataSource={this.parisEmployees} template={this.templateString}>
                    </ListViewComponent>
                </div>);
        }
        function template3() {
            return (<div>
                    ...
                    <ListViewComponent id="london" dataSource={this.londonEmployees} template={this.templateString}>
                    </ListViewComponent>
                </div>);
        }
