    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div className='col-md-8 control-section'>
                    <SmithchartComponent load={this.load.bind(this)} id='container' ref={gauge => this.smithchartInstance = gauge} horizontalAxis={{ minorGridLines: { visible: true } }} radialAxis={{ minorGridLines: { visible: true } }} radius={1} legendSettings={{
                visible: true,
                shape: 'Circle',
                position: 'Top'
            }}>
