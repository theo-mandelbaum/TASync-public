...
function Customization() {
    ...
    return (<div className='control-pane'>
            ...
            <div className='col-md-8 control-section'>
                <SmithchartComponent load={load.bind(this)} id='container' ref={gauge => smithchartInstance = gauge} horizontalAxis={{ minorGridLines: { visible: true } }} radialAxis={{ minorGridLines: { visible: true } }} radius={1} legendSettings={{
            visible: true,
            shape: 'Circle',
            position: 'Top'
        }}>
