    ...
    Customization.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'col-md-8 control-section' },
                React.createElement(ej2_react_charts_1.SmithchartComponent, { load: this.load.bind(this), id: 'container', ref: function (gauge) { return _this.smithchartInstance = gauge; }, horizontalAxis: { minorGridLines: { visible: true } }, radialAxis: { minorGridLines: { visible: true } }, radius: 1, legendSettings: {
                        visible: true,
                        shape: 'Circle',
                        position: 'Top'
                    } },
