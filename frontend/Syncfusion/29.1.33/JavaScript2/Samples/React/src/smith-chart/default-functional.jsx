...
function Default() {
    ...
    return (<div className='control-pane'>
            ...
            <div className='col-md-9 control-section'>
                <SmithchartComponent load={load.bind(this)} id='container' ref={gauge => smithchartInstance = gauge} legendSettings={{ visible: true, shape: 'Circle' }}>
