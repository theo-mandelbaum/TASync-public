...
const Api = () => {
    ...
    const ddlData1 = data["sort"];
    let ddlData2 = data["selectionMode"];
    ...
    const ddlFields = { text: 'type', value: 'type' };
    const sortChange = (args) => {
        setState({ ...state, sortOrder: args.value });
    };
    const selectionChange = (args) => {
        setState({ ...state, selectionSettings: { mode: args.value } });
    };
    return (<div className='control-pane'>
            <div className="col-lg-8 control-section">
                <div id="listbox-api-control">
                    <ListBoxComponent dataSource={dataA} fields={fields} sortOrder={state.sortOrder} selectionSettings={state.selectionSettings}/>
                </div>
            </div>
