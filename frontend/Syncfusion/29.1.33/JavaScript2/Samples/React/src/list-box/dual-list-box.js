...
var DualListBox = /** @class */ (function (_super) {
    ...
    function DualListBox() {
        ...
        _this.noRecordsTemplate = '<div class= "e-list-nrt"><span>NO DATA AVAILABLE</span></div>';
        return _this;
    }
            ...
            React.createElement("div", { className: "control-section" },
                React.createElement("div", { className: "dual-list-wrapper" },
                    React.createElement("div", { className: "dual-list-groupa" },
                        ...
                        React.createElement(ej2_react_dropdowns_1.ListBoxComponent, { dataSource: this.dataA, fields: this.fields, height: "330px", scope: "#combined-listbox", toolbarSettings: this.toolbarSettings, noRecordsTemplate: this.noRecordsTemplate })),
                    React.createElement("div", { className: "dual-list-groupb" },
                        React.createElement("h4", null, "Group B"),
                        React.createElement(ej2_react_dropdowns_1.ListBoxComponent, { id: "combined-listbox", dataSource: this.dataB, height: "330px", fields: this.fields, noRecordsTemplate: this.noRecordsTemplate })))),
