    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-lg-8'>
            <GanttComponent id='WorkingTimeRange' ref={gantt => this.ganttInstance = gantt} dataSource={workTimeRange} highlightWeekends={true} taskFields={this.taskFields} labelSettings={this.labelSettings} height='410px' timelineSettings={this.timelineSettings} durationUnit={this.durationUnit} splitterSettings={this.splitterSettings} projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate}>
              <ColumnsDirective>
              ...
              <table id="property" className="property-panel-table" title="Properties" style={{ width: '100%', paddingLeft: '0px' }}>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div>
                        <DropDownListComponent ref={dropselect => this.selectObj = dropselect} id="WorkWeek" value={this.defaultValue} dataSource={this.workDays} width='100%' popupHeight='350px' fields={{ text: 'day', value: 'id' }} select={this.select.bind(this)}/>
                      </div>
                    </td>
                  </tr>
                  <tr>
