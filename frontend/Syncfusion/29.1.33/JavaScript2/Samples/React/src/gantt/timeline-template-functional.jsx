...
const TimelineTemplate = () => {
    ...
    const convertArabicNumeralsToWestern = (arabicNumerals) => {
    ...
    const timelineTemplate = (props) => {
        if (props.tier == 'topTier') {
            return (<div className="e-header-cell-label e-gantt-top-cell-text" style={{
                    width: '100%',
                    fontWeight: 'bold',
                    height: '100%',
                    display: 'flex',
    ...
    return (<div className='control-pane'>
      ...
      <GanttComponent id='TimelineTemplate' dataSource={timelineTemplateData} ref={gantt => ganttInstance = gantt} splitterSettings={splitterSettings} taskFields={taskFields} height='550px' projectStartDate={projectStartDate} projectEndDate={projectEndDate} timelineSettings={timelineSettings} timelineTemplate={timelineTemplate} labelSettings={labelSettings} treeColumnIndex={1}> 
            <ColumnsDirective>
