    ...
    return (<div className='control-pane'>
      <div className='control-section'>
        <div className='col-lg-9'>
          <GanttComponent id='GridLines' ref={ganttInstance} dataSource={projectNewData} highlightWeekends={true} taskFields={taskFields} labelSettings={labelSettings} height='410px' treeColumnIndex={1} gridLines={gridLines} splitterSettings={splitterSettings} projectStartDate={projectStartDate} projectEndDate={projectEndDate}>
            <ColumnsDirective>
          ...
          <PropertyPane title='Properties'>
            ...
            <tbody>
              ...
              <tr>
                <td style={{ width: '100%' }}>
                  <div>
                    <DropDownListComponent id='gridLines' dataSource={linesData} fields={{ text: 'type', value: 'id' }} value='Both' change={changeLine.bind(this)}></DropDownListComponent>
                  </div>
                </td>
              </tr>
              </tbody>
