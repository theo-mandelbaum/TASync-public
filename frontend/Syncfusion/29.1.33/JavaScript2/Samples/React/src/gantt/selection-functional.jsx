...
const GanttSelection = () => {
    ...
    let dropdownModeList = useRef(null);
    let dropdownTypeList = useRef(null);
    let dropdownToggleList = useRef(null);
    const dropdownModeListData = [
        { id: 'Row', type: 'Row' },
        { id: 'Cell', type: 'Cell' }
    ];
    const dropDownTypeListData = [
        { id: 'Single', type: 'Single' },
        { id: 'Multiple', type: 'Multiple' }
    ];
    const dropdownToggleListData = [
        { id: true, type: 'Enable' },
          ...
          <PropertyPane title='Properties'>
            ...
            <tbody>
              ...
              <tr>
                <td style={{ width: '100%', paddingRight: '5px' }}>
                  <div style={{ width: '150px' }}>
                    <DropDownListComponent ref={dropdownModeList} id='SelectionModeList' tabIndex={1} dataSource={dropdownModeListData} fields={{ text: 'type', value: 'id' }} value='Row'></DropDownListComponent>
                  </div>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td style={{ width: '100%', paddingRight: '5px' }}>
                  <div style={{ width: '150px' }}>
                    <DropDownListComponent ref={dropdownTypeList} id='SelectionTypeList' tabIndex={1} dataSource={dropDownTypeListData} fields={{ text: 'type', value: 'id' }} value='Single'></DropDownListComponent>
                  </div>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td style={{ width: '100%', paddingRight: '5px' }}>
                  <div style={{ width: '150px' }}>
                    <DropDownListComponent ref={dropdownToggleList} id='SelectionTypeList' tabIndex={1} dataSource={dropdownToggleListData} fields={{ text: 'type', value: 'id' }} value={toggleValue}></DropDownListComponent>
                  </div>
                </td>
              </tr>
              <tr>
