...
export class Virtualscroll extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <GanttComponent id='SplitTasks' dataSource={virtualData} treeColumnIndex={1} labelSettings={this.labelSettings} allowSelection={true} highlightWeekends={true} enableVirtualization={true} enableTimelineVirtualization={true} taskFields={this.taskFields} splitterSettings={this.splitterSettings} height='450px' projectEndDate={this.projectEndDate} projectStartDate={this.projectStartDate}>
			<ColumnsDirective>
