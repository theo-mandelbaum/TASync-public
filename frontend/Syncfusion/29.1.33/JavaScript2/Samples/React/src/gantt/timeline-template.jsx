...
export class TimelineTemplate extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <GanttComponent id='TimelineTemplate' dataSource={timelineTemplateData} highlightWeekends={true} splitterSettings={this.splitterSettings} taskFields={this.taskFields} height='550px' labelSettings={this.labelSettings} projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate} timelineSettings={this.timelineSettings} timelineTemplate={this.timelineTemplate} treeColumnIndex={1}>
            <ColumnsDirective>
