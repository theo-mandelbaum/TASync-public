...
var Taskbar = /** @class */ (function (_super) {
    ...
    function Taskbar() {
        ...
        _this.eventMarkerDay1 = new Date('03/05/2024 07:09:00 PM');
        _this.eventMarkerDay2 = new Date('03/05/2024 07:46:00 PM');
        _this.eventMarkerDay3 = new Date('03/05/2024 07:59:00 PM');
        _this.eventMarkerDay4 = new Date('03/05/2024 08:08:00 PM');
        _this.eventMarkerDay5 = new Date('03/05/2024 08:24:00 PM');
        _this.eventMarkerDay6 = new Date('03/05/2024 08:31:00 PM');
        _this.eventMarkerDay7 = new Date('03/05/2024 08:47:00 PM');
        _this.labelSettings = {
            leftLabel: 'TaskName',
        };
        ...
        _this.projectStartDate = new Date('03/05/2024 06:00 PM');
        _this.projectEndDate = new Date('03/05/2024 09:50 PM');
        return _this;
    }
