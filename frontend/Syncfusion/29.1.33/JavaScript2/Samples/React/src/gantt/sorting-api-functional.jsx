...
const SortingAPI = () => {
    ...
    let dropdownColumns = useRef(null);
    let dropdownDirection = useRef(null);
    const dropdownColumnsData = [
    ...
    const dropdownDirectionData = [
        { id: 'Ascending', type: 'Ascending' },
        { id: 'Descending', type: 'Descending' },
    ];
    const sortColumn = () => {
        let columnName = dropdownColumns.current.value;
        let sortType = dropdownDirection.current.value;
            ...
            <tbody>
              ...
              <tr>
                <td style={{ width: '100%', paddingRight: '10px' }}>
                  <div>
                    <DropDownListComponent ref={dropdownColumns} id='columns' width="150px" tabIndex={1} dataSource={dropdownColumnsData} fields={{ text: 'type', value: 'id' }} value='TaskID'></DropDownListComponent>
                  </div>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td style={{ width: '100%', paddingRight: '10px' }}>
                  <div>
                    <DropDownListComponent ref={dropdownDirection} id='direction' width="150px" tabIndex={1} dataSource={dropdownDirectionData} fields={{ text: 'type', value: 'id' }} value='Ascending'></DropDownListComponent>
                  </div>
                </td>
              </tr>
              <tr>
