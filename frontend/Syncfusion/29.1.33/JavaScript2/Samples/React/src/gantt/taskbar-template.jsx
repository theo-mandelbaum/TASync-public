...
export class Taskbar extends SampleBase {
    ...
    eventMarkerDay1 = new Date('03/05/2024 07:09:00 PM');
    eventMarkerDay2 = new Date('03/05/2024 07:46:00 PM');
    eventMarkerDay3 = new Date('03/05/2024 07:59:00 PM');
    eventMarkerDay4 = new Date('03/05/2024 08:08:00 PM');
    eventMarkerDay5 = new Date('03/05/2024 08:24:00 PM');
    eventMarkerDay6 = new Date('03/05/2024 08:31:00 PM');
    eventMarkerDay7 = new Date('03/05/2024 08:47:00 PM');
    labelSettings = {
        leftLabel: 'TaskName',
    };
    ...
    ;
    childTaskbarTemplate = this.taskbarTemplate.bind(this);
    ...
    ;
    milestone = this.milstoneTemplate.bind(this);
