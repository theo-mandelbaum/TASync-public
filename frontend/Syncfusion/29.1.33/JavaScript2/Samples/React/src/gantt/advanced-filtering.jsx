    ...
    render() {
        ...
        <div className='control-section' style={{ paddingTop: '0px' }}>
          <div id='ganttsidebar-parent' style={{ overflow: 'hidden', height: '460px' }}>
            ...
            {this.state.isSideBar && (<SidebarComponent id='ganttSidebar' ref={this.sidebarRef} target={this.target} width={'65%'} type='Over' isOpen={this.state.sidebarToggle} position='Right'>
                ...
                <QueryBuilderComponent id='ganttquerybuilder' ref={this.queryBuilderRef} dataSource={projectNewData} allowValidation={true} columns={[
                ...
                ]} ruleChange={this.updateRule} created={this.created}></QueryBuilderComponent>
