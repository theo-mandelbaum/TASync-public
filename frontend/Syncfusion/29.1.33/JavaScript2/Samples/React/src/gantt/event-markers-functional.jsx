...
const EventMarkers = () => {
    ...
    const eventMarkerDay2 = new Date('04/09/2024');
    const eventMarkerDay3 = new Date('04/19/2024');
    const eventMarkerDay4 = new Date('05/23/2024');
    const eventMarkerDay5 = new Date('06/20/2024');
    const labelSettings = {
        leftLabel: 'TaskName'
    };
    ...
    return (<div className='control-pane'>
      <div className='control-section'>
        <GanttComponent id='EventMarkers' dataSource={projectNewData} highlightWeekends={true} taskFields={taskFields} labelSettings={labelSettings} height='410px' projectStartDate={projectStartDate} projectEndDate={projectEndDate}>
          <ColumnsDirective>
