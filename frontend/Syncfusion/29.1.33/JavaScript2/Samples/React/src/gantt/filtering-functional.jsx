...
const Filtering = () => {
    ...
    const actionCompleteEvent = (args) => {
        ...
        <PropertyPane title='Properties'>
          ...
          <tbody>
              <tr>
                ...
                <td style={{ width: '70%' }}>
                  <div>
                    <DropDownListComponent width="100px" id="seltype" change={onChange.bind(this)} dataSource={filterType} value="Menu"/>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td style={{ width: '70%' }}>
                  <div>
                    <DropDownListComponent width="100px" id="selmode" change={onChange2.bind(this)} dataSource={modes} value="Parent"/>
                  </div>
                </td>
              </tr>
            </tbody>
