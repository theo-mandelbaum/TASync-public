    ...
    Sorting.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_gantt_1.GanttComponent, { id: 'Sorting', dataSource: data_1.editingData, highlightWeekends: true, allowSelection: true, taskFields: this.taskFields, splitterSettings: this.splitterSettings, treeColumnIndex: 1, labelSettings: this.labelSettings, height: '410px', selectedRowIndex: 0, sortSettings: this.sortSettings, allowSorting: true, projectStartDate: this.projectStartDate, projectEndDate: this.projectEndDate },
