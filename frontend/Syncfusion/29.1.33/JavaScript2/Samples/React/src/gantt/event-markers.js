...
var EventMarkers = /** @class */ (function (_super) {
    ...
    function EventMarkers() {
        ...
        _this.eventMarkerDay1 = new Date('04/02/2024');
        _this.eventMarkerDay2 = new Date('04/09/2024');
        _this.eventMarkerDay3 = new Date('04/19/2024');
        _this.eventMarkerDay4 = new Date('05/23/2024');
        _this.eventMarkerDay5 = new Date('06/20/2024');
        _this.labelSettings = {
            leftLabel: 'TaskName'
        };
