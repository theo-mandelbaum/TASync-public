...
const Zooming = () => {
    ...
    return (<div className='control-pane'>
      <div className='control-section'>
        <GanttComponent id='Zooming' dataSource={zoomingData} toolbar={toolbar} treeColumnIndex={1} splitterSettings={splitterSettings} taskFields={taskFields} labelSettings={labelSettings} height='410px'>
          <ColumnsDirective>
