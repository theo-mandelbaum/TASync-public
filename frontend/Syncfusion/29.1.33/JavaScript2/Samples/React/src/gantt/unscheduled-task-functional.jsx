...
const UnscheduledTask = () => {
    ...
    const projectStartDate = new Date('01/01/2024');
    const projectEndDate = new Date('01/20/2024');
    ...
    return (<div className='control-pane'>
      <div className='control-section'>
        <GanttComponent id='Unscheduled' ref={ganttInstance} dataSource={unscheduledData} taskFields={taskFields} height='410px' editSettings={editSettings} allowSelection={true} toolbar={toolbar} labelSettings={labelSettings} allowUnscheduledTasks={true} toolbarClick={toolbarClickEvent.bind(this)} splitterSettings={splitterSettings} columns={columns} projectStartDate={projectStartDate} projectEndDate={projectEndDate}>
