...
var Timeline = /** @class */ (function (_super) {
    ...
    function Timeline() {
        ...
        _this.projectStartDate = new Date('02/03/2024');
        _this.projectEndDate = new Date('03/23/2024');
                        ...
                        React.createElement("table", { id: "property", className: "property-panel-table", title: "Properties", style: { width: '100%' } },
                            React.createElement("tbody", null,
                                React.createElement("tr", null,
                                    React.createElement("td", { style: { width: '30%', paddingBottom: '10px', display: 'flex', alignItems: 'center' } },
                                        React.createElement("div", null, "Unit width")),
                                    React.createElement("td", { style: { width: '70%', paddingBottom: '10px', display: 'flex', alignItems: 'center' } },
                                ...
                                React.createElement("tr", null,
                                    ...
                                    React.createElement("td", { style: { width: '70%', paddingBottom: '10px', display: 'flex', alignItems: 'center' } },
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_buttons_1.CheckBoxComponent, { ref: function (CheckBox) { return _this.multitaskbarcheckbox = CheckBox; }, id: "multitaskbarCheck", onClick: this.multitaskbarCheck.bind(this), className: "checkbox", checked: false }))))))))),
