...
export class LoadOnDemand extends SampleBase {
    dataSource = new DataManager({
        url: 'http://localhost:62728/api/GanttLoadOnDemand',
    ...
    render() {
        ...
        <div className='control-section'>
          <GanttComponent id='LoadOnDemand' dataSource={this.dataSource} treeColumnIndex={1} taskFields={this.taskFields} enableVirtualization={true} loadChildOnDemand={true} height='460px' projectStartDate={this.projectStartDate} projectEndDate={this.projectEndDate}>
              <ColumnsDirective>
