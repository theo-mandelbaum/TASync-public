...
const ResourceAllocation = () => {
    ...
    const dropdownlist = {
        ...
        write: (args) => {
            ...
            let existingResourceIds = ganttInstance.treeGridModule.getResourceIds(args.rowData);
