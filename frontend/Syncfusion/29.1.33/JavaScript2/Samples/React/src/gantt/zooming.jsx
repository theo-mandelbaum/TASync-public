...
export class Zooming extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <GanttComponent id='Zooming' dataSource={zoomingData} toolbar={this.toolbar} treeColumnIndex={1} splitterSettings={this.splitterSettings} taskFields={this.taskFields} labelSettings={this.labelSettings} height='410px'>
            <ColumnsDirective>
