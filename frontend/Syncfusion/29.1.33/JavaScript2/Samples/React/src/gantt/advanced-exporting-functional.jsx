...
import { GanttComponent, Inject, Selection, Toolbar, ExcelExport, PdfExport, ColumnsDirective, ColumnDirective, DayMarkers, CriticalPath } from '@syncfusion/ej2-react-gantt';
...
const AdvancedExporting = () => {
    ...
    const projectEndDate = new Date('06/25/2025');
    ...
    const RightLabelTemplate = (props) => {
        if (props.ganttProperties.resourceInfo) {
            ...
            for (let index = 0; index < resources.length; index++) {
                ...
                let img = (<img key={`img-${index}`} src={src} height="40px" alt={resources[index].resourceName}/>);
                let span = (<span key={`span-${index}`} style={{ marginLeft: '5px', marginRight: '5px' }}>
    ...
    return (<div className='control-pane'>
      ...
      <div style={{ display: 'flex' }}>
        ...
        <GanttComponent id='AdvancedExporting' ref={ganttInstance} dataSource={pdfExport} dateFormat={'MMM dd, y'} enableCriticalPath={true} treeColumnIndex={1} allowExcelExport={true} allowPdfExport={true} allowSelection={true} showColumnMenu={false} highlightWeekends={true} allowUnscheduledTasks={true} projectStartDate={projectStartDate} projectEndDate={projectEndDate} splitterSettings={splitterSettings} taskFields={taskFields} timelineSettings={timelineSettings} labelSettings={labelSettings} toolbarClick={toolbarClick.bind(this)} height='410px' gridLines={gridLines} toolbar={toolbar} resourceFields={resourceFields} holidays={holidays} eventMarkers={eventMarkers} resources={editingResources} pdfQueryTaskbarInfo={pdfQueryTaskbarInfo} queryTaskbarInfo={queryTaskbarInfo}>
          <ColumnsDirective>
      ...
      <div id="action-description">
        <p>This sample demonstrates the advanced PDF export features of the Gantt Chart, allowing customization of various
          ...
          <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/gantt/pdfExportProperties/">pdfExportProperties</a>
          and
          <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/gantt/pdfQueryTaskbarInfoEventArgs/">pdfQueryTaskbarInfo</a>
          event.
        </p>
      </div>
      <div id="description">
      <p>In this sample, the Gantt Chart's PDF export functionality
        ...
        <ul>
          <li>
            ...
            <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/gantt/pdfExportProperties/#header">header</a>
            and
            <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/gantt/pdfExportProperties/#footer">footer</a>
          ...
          <li>
            ...
            <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/gantt/pdfQueryTaskbarInfoEventArgs">pdfQueryTaskbarInfoEvent</a>.
          </li>
          <li>
            ...
            in <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/gantt/pdfExportProperties">pdfExportProperties</a>.
          </li>
          <li>
            ...
            <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/gantt/pdfExportProperties/#fittowidthsettings">fitToWidthSettings</a>
            in <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/gantt/pdfExportProperties">pdfExportProperties</a>.
          </li>
        </ul>

        <p>More information about advanced PDF exporting features in Gantt can be found in the <a target="_blank" href="https://ej2.syncfusion.com/javascript/documentation/gantt/pdf-export/pdf-export">documentation
          section</a>.</p>
