...
const AdvancedFiltering = () => {
    ...
    const [predicateValue, setPredicateValue] = useState(null);
    const [searchQuery, setSearchQuery] = useState(new Query());
    let ganttRef = useRef(null);
    let sidebarRef = useRef(null);
    let queryBuilderRef = useRef(null);
    const taskFields = {
        id: 'TaskID',
        name: 'TaskName',
        startDate: 'StartDate',
    ...
    const labelSettings = { rightLabel: 'TaskName' };
    ...
    const updateRule = useCallback((args) => {
    ...
    return (<div className='control-pane'>
      <div className='control-section' style={{ paddingTop: '0px' }}>
        <div id='ganttsidebar-parent' style={{ overflow: 'hidden', height: '460px' }}>
          ...
          {isSideBar && (<SidebarComponent id='ganttSidebar' ref={sidebarRef} target={target} width={'65%'} type='Over' isOpen={sidebarToggle} position='Right'>
              ...
              <QueryBuilderComponent id='ganttquerybuilder' ref={queryBuilderRef} dataSource={projectNewData} allowValidation={true} columns={[
            ...
            ]} ruleChange={updateRule} created={created}></QueryBuilderComponent>
