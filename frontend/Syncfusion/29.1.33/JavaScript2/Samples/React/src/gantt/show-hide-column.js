                            ...
                            React.createElement("tr", null,
                                ...
                                React.createElement("td", { style: { width: '70%', paddingRight: '10px' } },
                                    React.createElement("div", { id: 'columnddl' },
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "120px", id: "dropDown", change: this.change.bind(this), dataSource: this.columnsName, fields: { text: 'name', value: 'id' }, ref: function (dropdown) { return _this.dropdownObj = dropdown; } })))),
                            React.createElement("tr", null,
                                React.createElement("td", { style: { width: '30%' } },
                                ...
                                React.createElement("td", { style: { width: '70%' } },
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_buttons_1.ButtonComponent, { id: 'show', ref: function (button) { return _this.showButtonObj = button; }, onClick: this.showButtonClick.bind(this) }, " Show ")))),
                            React.createElement("tr", null,
                                React.createElement("td", { style: { width: '30%' } },
