...
export class Overview extends SampleBase {
    ...
    statusTemplate = this.statustemplate.bind(this);
    priorityTemplate = this.prioritytemplate.bind(this);
    taskFields = {
        id: 'TaskId',
        name: 'TaskName',
        startDate: 'StartDate',
    ...
    gridLines = 'Vertical';
    toolbarOptions = ['ExpandAll', 'CollapseAll', 'ZoomIn', 'ZoomOut', 'ZoomToFit', 'ExcelExport', 'CsvExport', 'PdfExport'];
    change(args) {
    ...
    eventMarkerDay1 = new Date('04/04/2024');
    eventMarkerDay2 = new Date('06/30/2024');
    eventMarkerDay3 = new Date('09/29/2024');
    ...
    load() {
        ...
        let check = themeCollection.indexOf(this.theme);
        if (check >= 0) {
    ...
    // slide bar
    defaultObj;
    defaultTicks = { placement: 'Before', largeStep: 10, smallStep: 10, showSmallTicks: true };
    tooltip = {
        placement: 'Before',
        isVisible: true,
        showOn: 'Hover'
    ...
    durationFields = { text: 'Text', value: 'id' };
    durationValue = 'Day';
    changeDuraiton(args) {
        const gantt = document.getElementsByClassName('e-gantt')[0].ej2_instances[0];
        ...
        return (<div>
                <div className='control-section'>
                    <div id='gantt-sidebar-parent'>
                        <SidebarComponent id="sidebar" ref={Sidebar => this.sidebarobj = Sidebar} type="Over" className="default-sidebar" width="282px" target="#sidebar-gantt" position="Right">
                            ...
                            <ul className="settings-list" style={{ margin: '15px 15px', paddingLeft: '5px' }}>
                                ...
                                <li className="list-fields" style={{ padding: '20px', paddingBottom: '0px', marginBottom: '0px' }}>
                                    <div id="rowHeightSlider">
                                        <SliderComponent value={30} min={40} max={60} step={5} changed={this.onChanged} ticks={this.defaultTicks} width={180} tooltip={this.tooltip} ref={(slider) => { this.defaultObj = slider; }}/>
                                    </div>
                                </li>
                                ...
                                <li className="list-fields">
                                    ...
                                    <div className="switch" style={{ marginLeft: '20px' }}>
                                        <SwitchComponent id="showGridLinesSwitch" className="checked" change={this.gridLinesChange}/>
                                    </div>
                                </li>
                                {/* event markers */}
                                <li className="list-fields">
                                    ...
                                    <div className="switch" style={{ marginLeft: '20px' }}>
                                        <SwitchComponent id="showGridLinesSwitch" className="checked" checked={true} change={this.showEventMarkers}/>
                                    </div>
                                </li>
                                {/* dependency */}
                                <li className="list-fields">
                                    ...
                                    <div className="switch" style={{ marginLeft: '20px' }}>
                                        <SwitchComponent id="dependencyLines" className="checkeddependency" checked={true} change={this.dependencyChange}/>
                                    </div>
                                </li>
                                {/* taskLabelChange */}
                                <li className="list-fields">
                                    ...
                                    <div className="switch" style={{ marginLeft: '20px' }}>
                                        <SwitchComponent id="taskLabelChange" className="checked" checked={true} change={this.taskLabelChange}/>
                                    </div>
                                </li>
                                ...
                                <li className="list-field stack-container">
                                    ...
                                    <div style={{ paddingLeft: '10px' }}>
                                        <MultiSelectComponent ref={multiselect => this.multiselectObj = multiselect} id="WorkWeek" style={{ padding: '2px' }} mode="CheckBox" value={this.defaultValue} dataSource={this.workDays} showDropDownIcon={true} popupHeight='350px' fields={{ text: 'day', value: 'id' }} select={this.select.bind(this)} removed={this.removed.bind(this)}>
