...
export class AdvancedExporting extends SampleBase {
    ...
    ;
    templateLeft = this.LeftLabelTemplate;
    ...
    ;
    templateRight = this.RightLabelTemplate;
    labelSettings = {
