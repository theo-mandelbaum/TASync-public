...
export class Timezone extends SampleBase {
    ...
    render() {
        ...
        <div className="control-section">
            <GanttComponent id='Timezone' dataSource={this.timezoneData} timelineSettings={this.timelineSettings} height='450px' timezone='UTC' durationUnit='Hour' includeWeekend={true} treeColumnIndex={1} dateFormat='hh:mm a' dayWorkingTime={this.dayWorkingTime} taskFields={this.taskFields}> 
              <ColumnsDirective>
