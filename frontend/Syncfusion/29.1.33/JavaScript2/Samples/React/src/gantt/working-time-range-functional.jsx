...
const WorkingTimeRange = () => {
    ...
    let workStartTime = useRef(null);
    let workStartTime1 = useRef(null);
    let workEndTime1 = useRef(null);
    let dropselectObj = useRef(null);
    let workEndTime = useRef(null);
    ...
    const projectStartDate = new Date('04/02/2024');
    const projectEndDate = new Date('04/28/2024');
    const perform = () => {
    ...
    return (<div className='control-pane'>
      <div className='control-section'>
        <div className='col-lg-8'>
          <GanttComponent id='WorkingTimeRange' ref={ganttInstance} dataSource={workTimeRange} highlightWeekends={true} taskFields={taskFields} labelSettings={labelSettings} height='410px' timelineSettings={timelineSettings} durationUnit={durationUnit} splitterSettings={splitterSettings} projectStartDate={projectStartDate} projectEndDate={projectEndDate}>
            <ColumnsDirective>
              ...
              <tr>
                ...
                <td>
                  <div style={{ paddingTop: '0px', paddingLeft: '0px' }}>
                    <DropDownListComponent ref={dropselectObj} id="WorkWeek" style={{ padding: '2px' }} value={defaultValue} dataSource={workDays} width='100%' popupHeight='350px' fields={{ text: 'day', value: 'id' }} select={select.bind(this)}>
