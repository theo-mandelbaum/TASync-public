...
var Api = /** @class */ (function (_super) {
    ...
    Api.prototype.changeValue = function (e) {
        ...
        this.setState({ colorValue: val && val.length > 2 ? (val[0] !== '#' ? "#".concat(val) : val) : '#008000' });
    };
                            ...
                            React.createElement("tbody", null,
                                React.createElement("tr", null,
                                    ...
                                    React.createElement("td", { style: { width: '50%', paddingRight: '0px' } },
                                        React.createElement("div", { style: { maxWidth: '200px' } },
                                            React.createElement("input", { id: "hex-input", "aria-label": "Value", ref: "hexInput", type: "text", className: "e-input", maxLength: 9, onInput: this.changeValue.bind(this) })))),
                                React.createElement("tr", null,
                                    React.createElement("td", { style: { width: '50%' } },
                                ...
                                React.createElement("tr", null,
                                    ...
                                    React.createElement("td", { style: { width: '50%', paddingRight: '0px', paddingTop: '13px' } },
                                        React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: "disabled", "aria-label": "Disable", checked: false, change: this.onDisableChange.bind(this) }))),
                                React.createElement("tr", null,
                                    ...
                                    React.createElement("td", { style: { width: '50%', paddingRight: '0px', paddingTop: '15px' } },
                                        React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: "button", "aria-label": "Show Buttons", checked: true, change: this.onButtonChange.bind(this) }))),
                                React.createElement("tr", null,
                                    ...
                                    React.createElement("td", { style: { width: '50%', paddingRight: '0px', paddingTop: '15px', paddingBottom: '10px' } },
                                        React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: "mode-switch", "aria-label": "Mode Switcher", checked: true, change: this.onModeChange.bind(this) })))))))),
