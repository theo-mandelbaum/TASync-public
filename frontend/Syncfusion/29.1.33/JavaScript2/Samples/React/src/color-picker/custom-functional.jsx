...
const CustomPalette = () => {
    ...
    const beforeSquareTileRender = (args) => {
        args.element.classList.add('e-square-palette');
    };
    const beforeRoundedTileRender = (args) => {
        args.element.classList.add('e-rounded-palette');
    };
    const beforeScrollTileRender = (args) => {
    ...
    const roundedPaletteChange = (args) => {
