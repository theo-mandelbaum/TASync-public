...
function PeriodSelectorCandle() {
    ...
    return (<div className='control-pane'>
            ...
            <div className='control-section'>
                <div className="row" id="rowStyles">
                    ...
                    <div className="col-sm-4">
                        ...
                        <SwitchComponent id="checked" checked={true} name="Closing Value" value="Closing Value" cssClass="custom-iOS" change={switchChanged.bind(this)}>
                        </SwitchComponent>
                        <label id="switchname" htmlFor="checked-1"> OHLC </label>
                    </div>
                </div>
                <div className="row">
                    <RangeNavigatorComponent id='rangenavigator' ref={rangenavigator => rangenavigator1 = rangenavigator} style={{ textAlign: "center" }} valueType='DateTime' labelPosition='Outside' width={Browser.isDevice ? '100%' : '80%'} xName='date' yName='Close' disableRangeSelector={true} dataSource={data} periodSelectorSettings={{
            position: 'Top',
            periods: [
                ...
                <div className="row">
                    <ChartComponent id='chart' ref={chart => chart1 = chart} style={{ textAlign: "center" }} primaryXAxis={{
            valueType: 'DateTime',
        ...
        }} height='250' width={Browser.isDevice ? '100%' : '80%'} load={chartLoad.bind(this)} axisLabelRender={labelRender.bind(this)} tooltipRender={renderTooltip.bind(this)} chartMouseMove={mouseMove.bind(this)} axisRangeCalculated={rangeCalculate.bind(this)} chartArea={{ border: { width: 0 } }} tooltip={{ enable: true, shared: true }} legendSettings={{ visible: false }} zoomSettings={{ enableMouseWheelZooming: true, mode: 'X', toolbarItems: [] }} crosshair={{
            enable: true
        }}>
            ...
            StripLine, MomentumIndicator, Tooltip]}/>
                ...
                <div className="row">
                    <RangeNavigatorComponent id='rangenavigator2' ref={rangenavigator => rangenavigator2 = rangenavigator} style={{ textAlign: "center" }} valueType='DateTime' labelPosition='Outside' width={Browser.isDevice ? '100%' : '80%'} value={[new Date('2017-04-30'), new Date('2018-04-30')]} load={rangeLoad2.bind(this)} changed={changed2.bind(this)}>
