...
import { RangeNavigatorComponent, AreaSeries, DateTime, Crosshair, Inject, SeriesCollectionDirective, SeriesDirective, RangeTooltip, RangenavigatorSeriesCollectionDirective, RangenavigatorSeriesDirective, ChartComponent, ChartAnnotation, SplineSeries, Tooltip, Legend } from '@syncfusion/ej2-react-charts';
...
function DateTimeAxis() {
    ...
    return (<div className='control-pane'>
            ...
            <div className='control-section'>
                ...
                <div className="row">
                    <RangeNavigatorComponent id='rangenavigator' ref={rangenavigator => rangenavigator1 = rangenavigator} style={{ textAlign: "center" }} labelPosition='Outside' valueType='DateTime' majorTickLines={{
            width: 0
        }} tooltip={{ enable: true, format: 'yyyy/MM/dd', displayMode: 'Always' }} value={[new Date('2011-01-01'), new Date('2013-12-31')]} width={Browser.isDevice ? '100%' : '80%'} load={rangeLoad.bind(this)} changed={changed.bind(this)}>
            ...
            lineStyle: { width: 0 }
        }} width={Browser.isDevice ? '100%' : '80%'} legendSettings={{ visible: false }} load={chartLoad.bind(this)} height='350' chartArea={{ border: { width: 0 } }} tooltip={{
