...
exports.startDate = exports.stockData = exports.zoomPosition = exports.zoomFactor = void 0;
/**
...
function EmptyData() {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        ...
        React.createElement("div", { className: 'control-section row' },
            ...
            React.createElement("div", { className: "row" },
                React.createElement(ej2_react_charts_1.RangeNavigatorComponent, { id: 'rangenavigator', ref: function (rangenav) { return rangeInstance = rangenav; }, style: { textAlign: "center" }, labelPosition: 'Outside', valueType: 'DateTime', majorTickLines: {
                        width: 0
                    }, majorGridLines: {
                        width: 0
                    }, tooltip: { enable: true, displayMode: 'Always' }, value: [new Date('2013-12-27'), new Date('2015-03-23')], width: ej2_base_1.Browser.isDevice ? '100%' : '80%', load: rangeLoad.bind(this), changed: changed.bind(this) },
            ...
            React.createElement("div", { className: "row" },
                React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', ref: function (chart) { return chartInstance = chart; }, style: { textAlign: "center" }, primaryXAxis: {
                    ...
                    }, width: ej2_base_1.Browser.isDevice ? '100%' : '80%', load: chartLoad.bind(this), height: '350', chartArea: { border: { width: 0 } }, tooltip: {
    ...
    function chartLoad(args) {
        ...
        args.chart.series[0].border.color = theme_color_1.borderColor[theme_color_1.themes.indexOf(args.chart.theme.toLowerCase())];
        chartRendered = true;
    }
    ;
}
