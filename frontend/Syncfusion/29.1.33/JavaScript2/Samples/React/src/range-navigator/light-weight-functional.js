...
exports.data = (0, data_service_1.GetDateTimeData)(new Date(2018, 0, 1), new Date(2019, 0, 1));
        ...
        React.createElement("div", { className: 'control-section' },
            ...
            React.createElement("div", { className: "row" },
                React.createElement(ej2_react_charts_1.RangeNavigatorComponent, { id: 'rangenavigator', style: { textAlign: "center" }, valueType: 'DateTime', intervalType: 'Months', labelFormat: 'MMM', height: '52', navigatorStyleSettings: {
                    ...
                    }, load: load.bind(this), width: ej2_base_1.Browser.isDevice ? '100%' : '80%', value: [new Date('2018-06-01'), new Date('2018-07-01')], dataSource: exports.data, xName: 'x', yName: 'y', changed: changed.bind(this) },
