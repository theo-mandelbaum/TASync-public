...
exports.NumericAxis = exports.backgroundColor = exports.theme = exports.selectedTheme = exports.chartAnnotation = exports.zoomPosition = exports.zoomFactor = void 0;
/**
...
exports.selectedTheme = exports.selectedTheme ? exports.selectedTheme : 'Fluent2';
            ...
            React.createElement("div", { className: 'control-section' },
                ...
                React.createElement("div", { className: "row" },
                    React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', ref: function (chart) { return _this.chart1 = chart; }, style: { textAlign: "center" }, primaryXAxis: {
                            ...
                            lineStyle: { width: 0 }
                        }, width: ej2_base_1.Browser.isDevice ? '100%' : '80%', height: '350', theme: exports.theme, annotations: exports.chartAnnotation, legendSettings: { visible: false }, load: this.chartLoad.bind(this), loaded: this.chartLoaded.bind(this), axisLabelRender: this.labelRender.bind(this), chartArea: { border: { width: 0 } } },
