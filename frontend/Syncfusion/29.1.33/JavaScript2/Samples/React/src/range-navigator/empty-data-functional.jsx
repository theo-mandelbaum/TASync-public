...
function EmptyData() {
    ...
    return (<div className='control-pane'>
            ...
            <div className='control-section row'>
                ...
                <div className="row">
                    <RangeNavigatorComponent id='rangenavigator' ref={rangenav => rangeInstance = rangenav} style={{ textAlign: "center" }} labelPosition='Outside' valueType='DateTime' majorTickLines={{
            width: 0
        }} majorGridLines={{
            width: 0
        }} tooltip={{ enable: true, displayMode: 'Always' }} value={[new Date('2013-12-27'), new Date('2015-03-23')]} width={Browser.isDevice ? '100%' : '80%'} load={rangeLoad.bind(this)} changed={changed.bind(this)}>
                ...
                <div className="row">
                    <ChartComponent id='charts' ref={chart => chartInstance = chart} style={{ textAlign: "center" }} primaryXAxis={{
            valueType: 'DateTime',
        ...
        }} width={Browser.isDevice ? '100%' : '80%'} load={chartLoad.bind(this)} height='350' chartArea={{ border: { width: 0 } }} tooltip={{
