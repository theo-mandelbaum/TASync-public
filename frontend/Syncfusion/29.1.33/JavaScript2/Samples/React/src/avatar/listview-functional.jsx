...
const Listview = () => {
    ...
    return (<div className='control-pane' style={{ marginTop: "10px" }}>
            <div className="sample_container listview">
                {/* ListView element */}
                <ListViewComponent id='letterAvatarList' dataSource={listData} headerTitle='Contacts' showHeader={true} sortOrder="Ascending" template={listTemplate}></ListViewComponent>
            </div>
