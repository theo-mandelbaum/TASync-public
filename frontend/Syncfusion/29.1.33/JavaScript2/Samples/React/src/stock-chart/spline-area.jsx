...
import { StockChartComponent, StockChartSeriesCollectionDirective, StockChartSeriesDirective, Inject, Crosshair, DateTime, SplineAreaSeries, LineSeries, SplineSeries, CandleSeries, HiloOpenCloseSeries, HiloSeries, RangeAreaSeries, Trendlines, RangeTooltip, Tooltip } from '@syncfusion/ej2-react-charts';
...
export class SplineArea extends SampleBase {
    ...
    load(args) {
        let selectedTheme = loadStockChartTheme(args);
