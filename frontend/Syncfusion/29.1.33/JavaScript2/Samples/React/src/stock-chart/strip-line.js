        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_charts_1.StockChartComponent, { id: 'stockchartstripline', primaryXAxis: {
                    ...
                    }, load: this.load.bind(this), indicatorType: [], seriesType: [], trendlineType: ['Linear', 'Exponential', 'Polynomial', 'Logarithmic', 'MovingAverage'], title: 'AAPL Historical', chartArea: { border: { width: 0 } } },
