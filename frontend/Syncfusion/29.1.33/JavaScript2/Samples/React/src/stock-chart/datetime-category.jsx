...
import { StockChartComponent, StockChartSeriesCollectionDirective, StockChartSeriesDirective, Inject, DateTimeCategory, AreaSeries, CandleSeries, HiloOpenCloseSeries, HiloSeries, LineSeries, SplineSeries, Trendlines, RangeTooltip, Tooltip, Crosshair } from '@syncfusion/ej2-react-charts';
...
export class DatetimeCategoryAxis extends SampleBase {
    render() {
        return (<div className='control-pane'>
            ...
            }} chartArea={{ border: { width: 0 } }} tooltip={{ enable: true, header: 'AAPL Stock Price', format: '${point.x}: <b>${point.y}</b>' }} crosshair={{ enable: true }} load={this.load.bind(this)} title='AAPL Stock Price'>
