...
var PlotLine = function () {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        ...
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_charts_1.StockChartComponent, { id: 'stockchartplotline', primaryXAxis: { valueType: 'DateTime', majorGridLines: { color: 'transparent' } }, primaryYAxis: { stripLines: [{ start: 150, sizeType: 'Pixel', size: 1, color: 'green', dashArray: '10,5' },
                        { start: 190, sizeType: 'Pixel', size: 1, color: 'red', dashArray: '10,5' }], lineStyle: { color: 'transparent' }, majorTickLines: { color: 'transparent', height: 0 } }, load: load.bind(_this), indicatorType: [], seriesType: [], trendlineType: ['Linear', 'Exponential', 'Polynomial', 'Logarithmic', 'MovingAverage'], chartArea: { border: { width: 0 } }, title: 'Plot line on Y axis' },
