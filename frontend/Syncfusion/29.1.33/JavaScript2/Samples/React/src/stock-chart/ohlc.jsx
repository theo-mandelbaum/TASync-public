...
export class OHLC extends SampleBase {
    render() {
        return (<div className='control-pane'>
            ...
            }} load={this.load.bind(this)} chartArea={{ border: { width: 0 } }} tooltip={{ enable: true, shared: true, position: 'Nearest' }} tooltipRender={tooltipRender} crosshair={{ enable: true }} title='AAPL Stock Price'>
