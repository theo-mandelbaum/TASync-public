...
const Filter = () => {
    ...
    const fields = { text: 'Name', value: 'Experience' };
    const mccbDropdownListData = ['StartsWith', 'EndsWith', 'Contains'];
                ...
                <div className='control-section'>
                    <div className="col-lg-8">
                        <div className="control-wrapper multicolumn">
                            ...
                            <MultiColumnComboBoxComponent type="text" dataSource={data.employee} fields={fields} placeholder='Select a name' filterType={filterType} popupHeight={'200px'} popupWidth={'650px'}>
                            <ColumnsDirective>
