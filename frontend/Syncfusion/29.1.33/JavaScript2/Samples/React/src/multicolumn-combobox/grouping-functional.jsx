...
const Group = () => {
    ...
    const fields = { text: 'Name', value: 'Name', groupBy: 'Category' };
    return (<div className='control-pane'>
            <div className="control-section">
                <div className='control-wrapper grouping-multicolumn'>
                    <div style={{ paddingTop: '60px' }}>
                    <label>Select a product</label>
                        <MultiColumnComboBoxComponent type="text" dataSource={data.products} fields={fields} placeholder='e.g. Laptop' popupHeight={'230px'} popupWidth={'550px'} allowSorting={false}>
                        <ColumnsDirective>
