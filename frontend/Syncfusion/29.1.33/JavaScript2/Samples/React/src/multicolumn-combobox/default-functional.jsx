                ...
                <div className="col-lg-8">
                    <div className="control-wrapper multicolumn">
                        ...
                        <label>Select a product</label>
                            <MultiColumnComboBoxComponent dataSource={data.products} fields={{ text: 'Name', value: 'Category' }} popupHeight={'230px'} popupWidth={'520px'} placeholder='Select any product' value={value} text={text} change={valueChange} showClearButton={true}>
                                <ColumnsDirective>
