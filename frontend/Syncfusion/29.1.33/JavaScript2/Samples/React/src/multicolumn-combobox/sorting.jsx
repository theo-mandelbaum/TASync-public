                ...
                <div className="control-section">
                    <div className='control-wrapper sorting-multicolumn'>
                        ...
                        <label>Select a product</label>
                            <MultiColumnComboBoxComponent type="text" dataSource={data.products} fields={this.fields} placeholder='e.g. laptop' popupHeight={'230px'} popupWidth={'600px'} allowSorting={true} sortOrder={SortOrder.Ascending} sortType='MultiColumn'>
                            <ColumnsDirective>
