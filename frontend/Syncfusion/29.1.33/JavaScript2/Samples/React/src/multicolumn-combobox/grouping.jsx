                ...
                <div className="control-section">
                    <div className='control-wrapper grouping-multicolumn'>
                        ...
                        <label>Select a product</label>
                            <MultiColumnComboBoxComponent type="text" dataSource={data.products} fields={this.fields} placeholder='e.g. Laptop' popupHeight={'230px'} popupWidth={'550px'} allowSorting={false}>
                            <ColumnsDirective>
