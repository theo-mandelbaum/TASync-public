                    ...
                    <div className="col-lg-8">
                        <div className="control-wrapper multicolumn">
                            ...
                            <label>Select a product</label>
                                <MultiColumnComboBoxComponent dataSource={data.products} fields={{ text: 'Name', value: 'Category' }} popupHeight={'230px'} popupWidth={'520px'} placeholder='Select any product' value={this.value} text={this.text} change={this.valueChange.bind(this)} showClearButton={true}>
                                <ColumnsDirective>
