                ...
                <div className="control-section">
                    <div className='control-wrapper keyboard-multicolumn'>
                        ...
                        <label>Select a product</label>
                            <MultiColumnComboBoxComponent type="text" dataSource={data.productDetails} fields={this.fields} placeholder='Select any product' popupHeight={'230px'} popupWidth={'530px'}>
                            <ColumnsDirective>
