                ...
                <div className="control-section">
                    <div className='control-wrapper template-multicolumn'>
                        ...
                        <label>Select an employee</label>
                            <MultiColumnComboBoxComponent cssClass='multicolumn-customize' type="text" dataSource={data.empList} fields={this.fields} placeholder='e.g. Andrew Fuller' popupHeight={'230px'} popupWidth={'540px'} gridSettings={{ rowHeight: 40 }}>
                                <ColumnsDirective>
