...
const Sort = () => {
    ...
    const fields = { text: 'Name', value: 'Category' };
    return (<div className='control-pane'>
            <div className="control-section">
                <div className='control-wrapper sorting-multicolumn'>
                    <div style={{ paddingTop: '60px' }}>
                    <label>Select a product</label>
                        <MultiColumnComboBoxComponent type="text" dataSource={data.products} fields={fields} placeholder='e.g. laptop' popupHeight={'230px'} popupWidth={'600px'} allowSorting={true} sortOrder={SortOrder.Ascending} sortType='MultiColumn'>
                        <ColumnsDirective>
