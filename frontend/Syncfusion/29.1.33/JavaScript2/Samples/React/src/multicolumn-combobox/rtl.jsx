                ...
                <div className="control-section">
                    <div className='control-wrapper rtl-multicolumn'>
                        ...
                        <label>Select a title</label>
                            <MultiColumnComboBoxComponent type="text" dataSource={data.bookDetails} fields={this.fields} placeholder='e.g. The Hobbit' popupHeight={'230px'} popupWidth={'680px'} enableRtl={true}>
                            <ColumnsDirective>
