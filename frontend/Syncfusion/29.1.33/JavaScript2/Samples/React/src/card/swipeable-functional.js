...
var Swipeable = function () {
    ...
    var rendereComplete = function () {
        ...
        swipeable();
        new ej2_base_1.Touch(ele, { swipe: touchSwipeHandler });
    ...
    var touchSwipeHandler = function (e) {
        var ele = (0, ej2_base_1.closest)(e.originalEvent.target, '.e-card');
        if ((0, ej2_base_1.isNullOrUndefined)(ele)) {
            return;
        }
    ...
    return (React.createElement("div", { className: 'control-pane' },
                    ...
                    React.createElement("div", { className: "row card-layout" },
                        React.createElement("div", { className: "col-xs-6 col-sm-6 col-lg-6 col-md-6", id: "horizontal_product" },
                            React.createElement("div", { className: "e-card e-card-horizontal" },
                                React.createElement("img", { src: './src/card/images/newyork.png', alt: "newyork" }),
                                React.createElement("div", { className: 'e-card-stacked' },
                                    ...
                                    React.createElement("div", { className: "e-card-actions" },
                                        React.createElement("button", { style: { padding: '0px', border: '0px', height: '24px', width: '24px' }, "aria-label": "button" },
                            ...
                            React.createElement("div", { className: "e-card e-card-horizontal" },
                                React.createElement("img", { src: './src/card/images/malaysia.png', alt: "malaysia" }),
                                React.createElement("div", { className: 'e-card-stacked' },
                                    ...
                                    React.createElement("div", { className: "e-card-actions" },
                                        ...
                                        React.createElement("button", { style: { padding: '0px', border: '0px', height: '24px', width: '24px' }, "aria-label": "button" },
                                            React.createElement("span", { className: "e-share-icon cb-icons " }))))),
                            React.createElement("div", { className: "e-card e-card-horizontal" },
                                React.createElement("img", { src: './src/card/images/eiffeltower.png', alt: "eiffeltower" }),
                                React.createElement("div", { className: 'e-card-stacked' },
                                    ...
                                    React.createElement("div", { className: "e-card-actions" },
                                        ...
                                        React.createElement("button", { style: { padding: '0px', border: '0px', height: '24px', width: '24px' } },
                                            React.createElement("span", { className: "e-share-icon cb-icons " }))))),
                            React.createElement("div", { className: "e-card e-card-horizontal" },
                                React.createElement("img", { src: './src/card/images/sydney.png', alt: "sydney" }),
                                React.createElement("div", { className: 'e-card-stacked' },
        ...
        React.createElement("div", { id: "description" },
            React.createElement("p", null, "The sample illustrates a stacked collection of cards overlapping each other, which can be bound to swipe actions to move cards one after the other. CSS animation is used to achieve swiping on every left or right swipe."),
            React.createElement("p", null,
