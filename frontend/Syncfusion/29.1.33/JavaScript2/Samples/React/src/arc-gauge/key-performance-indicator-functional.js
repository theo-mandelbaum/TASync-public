...
var KeyPerformanceIndicator = function () {
    ...
    return (React.createElement("main", null,
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_circulargauge_1.CircularGaugeComponent, { load: load.bind(_this), id: "gauge", background: "transparent" },
                    ...
                    React.createElement(ej2_react_circulargauge_1.AxesDirective, null,
                        React.createElement(ej2_react_circulargauge_1.AxisDirective, { startAngle: 220, endAngle: 140, radius: "90%", minimum: 0, maximum: 100, majorTicks: { width: 0, }, lineStyle: { width: 0 }, minorTicks: { width: 0 }, labelStyle: { format: '{value} %', font: { size: '0px' }, position: 'Outside', offset: -18, } },
                            ...
                            React.createElement(ej2_react_circulargauge_1.RangesDirective, null,
                                ...
                                React.createElement(ej2_react_circulargauge_1.RangeDirective, { start: 30, end: 50, radius: "90%", linearGradient: rangeLinearGradient, startWidth: 30, endWidth: 30 }))))))),
...
exports.default = KeyPerformanceIndicator;
