    ...
    return (React.createElement("main", null,
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_circulargauge_1.CircularGaugeComponent, { load: load.bind(_this), id: "gauge", background: "transparent", height: "500px", title: "Female (% usage) on popular social network", titleStyle: { size: '18px', fontFamily: 'inherit' } },
