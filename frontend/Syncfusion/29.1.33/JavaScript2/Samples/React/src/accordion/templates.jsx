...
export class Templates extends SampleBase {
    render() {
        ...
        function hardwareContent() {
            return (<div id="Hard_Soft_features">
          <table>
            <tbody>
              <tr>
        ...
        <div id="description">
          ...
          <p>
            ...
            <a aria-label="Accordion getting started" target="_blank" href="https://ej2.syncfusion.com/react/documentation/accordion/getting-started/">
              documentation
            </a>{" "}
            section.
          </p>
