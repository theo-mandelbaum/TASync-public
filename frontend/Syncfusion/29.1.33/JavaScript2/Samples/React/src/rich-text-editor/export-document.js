...
exports.ExportDocument = void 0;
var React = require("react");
var ej2_react_richtexteditor_1 = require("@syncfusion/ej2-react-richtexteditor");
var sample_base_1 = require("../common/sample-base");
;
var ExportDocument = /** @class */ (function (_super) {
    __extends(ExportDocument, _super);
    ...
    ExportDocument.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section', id: "rteTools" },
                React.createElement("div", { className: 'rte-control-section' },
                    React.createElement(ej2_react_richtexteditor_1.RichTextEditorComponent, { id: "exportDocument", exportPdf: this.exportPdf, exportWord: this.exportWord, value: this.rteValue, toolbarSettings: this.toolbarSettings, enableXhtml: true, insertImageSettings: this.insertImageSettings },
            ...
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "This example illustrates how to use the import/export feature of the Rich Text Editor to export the editor content into a PDF or Word document."),
