...
function ImageEditorIntegration() {
    ...
    return (<div className='control-pane'>
            <div className='control-section' id="rte">
                ...
                <RichTextEditorComponent id="rteImageEditor" ref={(scope) => {
            rteObj = scope;
            ...
            <DialogComponent id="ImageEditorDialog" ref={(scope) => {
            dialogObj = scope;
                ...
                <ImageEditorComponent id="image-editor" height="400px" ref={(scope) => {
