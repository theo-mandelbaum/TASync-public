...
function AutoSave() {
    ...
    let savingEle;
    let savingRef = (element) => {
        savingEle = element;
    };
    let savedELe;
    let savedRef = (element) => {
        savedELe = element;
    };
    let rteObj;
    let switchObj;
    // Rich Text Editor items list
    const items = ['Bold', 'Italic', 'Underline', '|', 'Formats', 'Alignments', 'Blockquote',
            ...
            <div className='col-lg-8'>
                <div className='control-section' id="rteAPI">
                    <div className='rte-control-section'>
                        <RichTextEditorComponent id="autoSaveRTE" ref={(richtexteditor) => { rteObj = richtexteditor; }} enablePersistence={true} placeholder={'Start to type a content to save'} saveInterval={5000} toolbarSettings={toolbarSettings} change={updateStatus.bind(this)}>
