            ...
            <div className='control-section' id='rteInline'>
                <div className='col-lg-8'>
                    <div className="content-wrapper">
                        <RichTextEditorComponent id="inlineRTE" ref={(richtexteditor) => { rteObj = richtexteditor; }} inlineMode={inlineMode} toolbarSettings={toolbarSettings} format={format} fontFamily={fontFamily}>
