...
function InsertSpecialCharacters() {
    ...
    let rteObj;
    let rteSpecialCharEle = null;
    let rteSpecialCharRef = (element) => {
        rteSpecialCharEle = element;
    };
    let rteSectionEle = null;
    let rteSectionRef = (element) => {
    ...
    const items = ['Bold', 'Italic', 'Underline', '|', 'Formats', 'Alignments', 'Blockquote', 'OrderedList',
    ...
    const dlgButtons = [{ buttonModel: { content: "Insert", isPrimary: true }, click: onInsert.bind(this) },
        { buttonModel: { content: 'Cancel' }, click: onCancel }];
    const header = 'Special Characters';
    const target = rteSectionEle;
    const height = 'auto';
    function onCreate() {
    ...
    return (<div className='control-pane'>
            <div className='control-section e-rte-custom-tbar-section' id="rteCustomTool">
                <div className='rte-control-section' ref={rteSectionRef} id='rteSection'>
                    <RichTextEditorComponent id="specialCharRTE" ref={(scope) => { rteObj = scope; }} toolbarSettings={toolbarSettings} actionComplete={actionCompleteHandler.bind(this)} created={onCreate.bind(this)}>
                    ...
                    <DialogComponent id='customTbarDlg' ref={(scope) => { dialogObj = scope; }} buttons={dlgButtons} overlayClick={dialogOverlay.bind(this)} header={header} visible={false} showCloseIcon={false} width='43%' target={'#rteSection'} height={height} created={dialogCreate.bind(this)} isModal={true}>
                    </DialogComponent>
