 ...
 */
import { HtmlEditor, Image, Inject, Link, QuickToolbar, RichTextEditorComponent, Toolbar, EmojiPicker, PasteCleanup, Table, Video, Audio } from '@syncfusion/ej2-react-richtexteditor';
    ...
    return (<div className='control-pane'>
            <div className='control-section e-rte-custom-tbar-section' id="rteCustomTool">
                <div className='rte-control-section' ref={rteSectionRef} id='rteSection'>
                    <RichTextEditorComponent id="EmotionIconstRTE" ref={(scope) => { rteObj = scope; }} toolbarSettings={toolbarSettings}>
