...
import { RichTextEditorComponent, Toolbar, Inject, Image, Table, Link, HtmlEditor, QuickToolbar, Audio, Video, PasteCleanup } from '@syncfusion/ej2-react-richtexteditor';
...
function InsertMedia() {
    ...
    let rteObj;
    // Rich Text Editor items list
    const items = ['Bold', 'Italic', 'Underline', '|', 'Formats', 'Alignments', 'Blockquote', 'OrderedList', 'UnorderedList', '|', 'CreateLink', 'Image', 'Audio', 'Video', '|', 'SourceCode', 'Undo', 'Redo'];
                ...
                <div className="content-wrapper">
                    <RichTextEditorComponent id="insertMedia" ref={(richtexteditor) => { rteObj = richtexteditor; }} toolbarSettings={toolbarSettings}>
                        ...
                        <p><video style={{ width: '30%' }} controls>
                            <source src="https://cdn.syncfusion.com/ej2/richtexteditor-resources/RTE-Ocean-Waves.mp4" type="video/mp4"/>
                        </video></p>
