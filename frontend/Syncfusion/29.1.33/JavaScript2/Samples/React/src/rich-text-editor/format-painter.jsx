import { RichTextEditorComponent, HtmlEditor, Toolbar, FormatPainter, QuickToolbar, Link, Image, Table, Audio, Video, Inject } from "@syncfusion/ej2-react-richtexteditor";
            ...
            <div className='col-lg-8'>
                <div className='control-section' id="rteAPI">
                    <div className='rte-control-section'>
                        <RichTextEditorComponent id="formatPainterRTE" ref={(richtexteditor) => { this.formatPainterRTE = richtexteditor; }} toolbarSettings={this.toolbarSettings}>
                        ...
                        <tbody>
                            <tr>
                                <td style={{ padding: '8px', width: '50%' }}>
                                    ...
                                    <div style={{ paddingLeft: '10px' }}>
                                        <TextBoxComponent id="allowedFormatInput" cssClass="e-outline" floatLabelType='Never' placeholder='span; strong; em; sup, sub; code;' blur={this.setAllowedFormats}>
                                        </TextBoxComponent>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style={{ padding: '8px', width: '50%' }}>
                                    ...
                                    <div style={{ paddingLeft: '10px' }}>
                                        <TextBoxComponent id="deniedFormatInput" cssClass="e-outline" floatLabelType='Never' placeholder="span(important)[title]{background-color,color};" blur={this.setdeniedFormats}>
                                        </TextBoxComponent>                                
                                    </div>
                                </td>
                            </tr>
