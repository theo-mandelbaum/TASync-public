...
export class Overview extends SampleBase {
    ...
    mirrorConversion(e) {
        const id = this.editor.getID() + 'mirror-view';
        const rteContainer = this.editor.element.querySelector('.e-rte-container');
        let mirrorView = this.editor.element.querySelector('#' + id);
