            ...
            <div className='col-lg-8'>
                <div className='control-section' id="rteAPI">
                    <div className='rte-control-section'>
                        <RichTextEditorComponent id="API" ref={(richtexteditor) => { rteObj = richtexteditor; }} showCharCount={true} maxLength={1000}>
