...
function Type() {
    ...
    function onChange(args) {
        switch (args.value) {
            case '1':
                rteObj.toolbarSettings.type = ej2_react_richtexteditor_1.ToolbarType.Expand;
                break;
            case '2':
                rteObj.toolbarSettings.type = ej2_react_richtexteditor_1.ToolbarType.MultiRow;
                break;
            case '3':
                rteObj.toolbarSettings.type = ej2_react_richtexteditor_1.ToolbarType.Scrollable;
                break;
        }
    }
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section', id: 'rteTypes' },
            React.createElement("div", { className: 'col-lg-8', style: { paddingBottom: '20px' } },
                React.createElement(ej2_react_richtexteditor_1.RichTextEditorComponent, { id: "typesRTE", ref: function (scope) { rteObj = scope; }, floatingToolbarOffset: 0, toolbarSettings: toolbarSettings, actionBegin: handleFullScreen.bind(this), actionComplete: actionCompleteHandler.bind(this) },
                    React.createElement("p", null, "The Rich Text Editor is a WYSIWYG (\"what you see is what you get\") editor useful to create and edit content, and return the valid HTML markup or markdown of the content"),
                    React.createElement("p", null,
                        React.createElement("b", null, "Toolbar")),
                    React.createElement("ol", null,
                        React.createElement("li", null,
                            React.createElement("p", null, "The Toolbar contains commands to align the text, insert a link, insert an image, insert list, undo/redo operations, HTML view, etc ")),
                        React.createElement("li", null,
                            React.createElement("p", null, "The Toolbar is fully customizable "))),
                    React.createElement("p", null,
                            ...
                            React.createElement("tr", null,
                                React.createElement("td", null,
                                    React.createElement("div", { style: { paddingLeft: '10px', paddingBottom: '10px' } },
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: "types", dataSource: ddlValue, ref: function (dropdownlist) { listObj = dropdownlist; }, fields: fields, change: onChange.bind(this), floatLabelType: 'Auto', placeholder: "Types", index: 0, popupHeight: '220px' })))),
                            React.createElement("tr", null,
                                React.createElement("td", null,
                                    React.createElement("div", { style: { paddingLeft: '10px' } },
                                        React.createElement(ej2_react_buttons_1.CheckBoxComponent, { checked: false, label: 'Enable Floating', ref: function (scope) { checkboxObj = scope; }, change: onFloatChange.bind(this) }))))))))),
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                ...
                React.createElement("code", null, "Toolbar, Link, Image, Count, HtmlEditor, QuickToolbar, EmojiPicker, PasteCleanup, Audio, Video, FormatPainter, Table"),
