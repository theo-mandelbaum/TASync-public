...
exports.QuickFormatToolbar = void 0;
/**
...
var QuickFormatToolbar = /** @class */ (function (_super) {
    __extends(QuickFormatToolbar, _super);
    function QuickFormatToolbar() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        //Rich Text Editor ToolbarSettings
        _this.toolbarSettings = {
            type: ej2_react_richtexteditor_1.ToolbarType.MultiRow,
    ...
    QuickFormatToolbar.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section', id: "rte" },
                React.createElement("div", { className: 'rte-control-section' },
                    React.createElement(ej2_react_richtexteditor_1.RichTextEditorComponent, { id: "quickRTE", toolbarSettings: this.toolbarSettings, quickToolbarSettings: this.quickToolbarSettings },
    ...
    return QuickFormatToolbar;
}(sample_base_1.SampleBase));
exports.QuickFormatToolbar = QuickFormatToolbar;
