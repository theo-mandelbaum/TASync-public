...
const Default = () => {
    const chatUser1Ref = useRef(null);
    const chatUser2Ref = useRef(null);
    useEffect(() => {
        updateSampleSection();
