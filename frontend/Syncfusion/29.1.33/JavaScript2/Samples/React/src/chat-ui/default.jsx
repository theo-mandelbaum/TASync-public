...
export class Default extends SampleBase {
    ...
    initializeDropdown(chatUser, buttonId) {
    ...
    handleUserTyping = (args, otherChatUser) => {
        if (!args.isTyping) {
            if (otherChatUser) {
