...
var Presets = /** @class */ (function (_super) {
    ...
    function Presets() {
        ...
        _this.monthEnd = new Date(new Date(new Date(new Date().setMonth(new Date().getMonth() + 1)).setDate(0)).toDateString());
        _this.lastStart = new Date(new Date(new Date(new Date().setMonth(new Date().getMonth() - 1)).setDate(1)).toDateString());
        _this.lastEnd = new Date(new Date(new Date().setDate(0)).toDateString());
        _this.yearStart = new Date(new Date(new Date().getFullYear() - 1, 0, 1).toDateString());
        _this.yearEnd = new Date(new Date(new Date().getFullYear() - 1, 11, 31).toDateString());
        return _this;
    }
