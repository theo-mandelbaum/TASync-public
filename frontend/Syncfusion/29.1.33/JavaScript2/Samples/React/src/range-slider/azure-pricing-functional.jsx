...
const Cloudpricing = () => {
    ...
    let processorSlider = useRef(null);
    let memorySlider = useRef(null);
    let storageSlider = useRef(null);
    let alertObj = useRef(null);
    ...
    let elemValue;
    let finalValue;
    let objElements = ['#xSmallBtn', '#smallBtn', '#mediumBtn', '#largeBtn', '#xLargeBtn'];
    let buttonObj = { obj: ButtonComponent, functionprop: { cssClass: 'e-info', isPrimary: true } };
    let content = '<div id = "dialog-content"><div id = "dialog-header">Cloud Price Details</div>' +
    ...
    const onChange = (elem, value, notation) => {
    ...
    const sliderValueChange = () => {
        if (!isNullOrUndefined(valueObj.current) && !isNullOrUndefined(processorSlider.current)
            ...
            let porcessorValue = processorSlider.current.value;
            let memoryValue = memorySlider.current.value;
            let storageValue = storageSlider.current.value;
    ...
    const sliderPriceValue = (processor, memory, storage) => {
