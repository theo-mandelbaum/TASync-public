...
var APIs = /** @class */ (function (_super) {
    ...
    function APIs() {
        ...
        _this.tooltip = { placement: 'Before', isVisible: true, showOn: 'Hover' };
                                ...
                                React.createElement("tr", null,
                                    ...
                                    React.createElement("td", { style: { width: '50%' } },
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { value: 30, format: 'n0', change: this.onValueChange.bind(this), ref: function (value) { _this.numbericValue = value; }, "aria-labelledby": "valueLabel" })))),
                                React.createElement("tr", null,
                                    React.createElement("td", { style: { width: '50%' } },
                                        React.createElement("div", { id: "minLabel", className: "userselect" }, "Min")),
                                    React.createElement("td", { style: { width: '50%' } },
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { value: 0, format: 'n0', change: this.onMinChange.bind(this), "aria-labelledby": "minLabel" })))),
                                React.createElement("tr", null,
                                    React.createElement("td", { style: { width: '50%' } },
                                        React.createElement("div", { id: "maxLabel", className: "userselect" }, "Max")),
                                    React.createElement("td", { style: { width: '50%' } },
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { value: 100, format: 'n0', change: this.onMaxChange.bind(this), "aria-labelledby": "maxLabel" })))),
                                React.createElement("tr", null,
                                    React.createElement("td", { style: { width: '50%' } },
                                        React.createElement("div", { id: "stepLabel", className: "userselect" }, "Step")),
                                    React.createElement("td", { style: { width: '50%' } },
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { value: 1, change: this.onStepChange.bind(this), "aria-labelledby": "stepLabel" })))),
