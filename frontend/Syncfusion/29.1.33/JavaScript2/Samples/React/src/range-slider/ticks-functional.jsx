...
function Ticks() {
    ...
    let defaultTicks = { placement: 'Before', largeStep: 0.20, smallStep: 0.05, showSmallTicks: true };
    let rangeTicks = { placement: 'Before', largeStep: 20, smallStep: 5, showSmallTicks: true };
    //Dropdownlist datasource values for changing ticks placement for slider component
    let option = [{ text: 'Before', value: 'Before' }, { text: 'After', value: 'After' },
