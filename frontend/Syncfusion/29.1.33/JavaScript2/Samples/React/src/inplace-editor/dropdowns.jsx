...
export class DropDowns extends SampleBase {
    ...
    dropDownData = ['Australia', 'Bermuda', 'Canada', 'Cameroon', 'Denmark', 'Finland', 'Greenland', 'Poland'];
    dropDownModel = { dataSource: this.dropDownData, placeholder: 'Find a country' };
    autoCompleteModel = { dataSource: this.dropDownData, placeholder: ' Type to search country' };
    comboBoxModel = { dataSource: this.dropDownData, placeholder: 'Find a country' };
    multiSelectModel = { dataSource: this.dropDownData, placeholder: 'Choose the countries', mode: 'Box', width: 150 };
