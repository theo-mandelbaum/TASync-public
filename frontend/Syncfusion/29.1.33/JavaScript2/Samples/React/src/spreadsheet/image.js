...
var Image = /** @class */ (function (_super) {
    ...
    function Image() {
        ...
        _this.image = [{ src: data_1.base64ImageUrl,
    ...
    Image.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section spreadsheet-control' },
                React.createElement(ej2_react_spreadsheet_3.SpreadsheetComponent, { openUrl: 'https://ej2services.syncfusion.com/production/web-services/api/spreadsheet/open', saveUrl: 'https://ej2services.syncfusion.com/production/web-services/api/spreadsheet/save', ref: function (ssObj) { _this.spreadsheet = ssObj; }, created: this.onCreated.bind(this), showRibbon: false, showFormulaBar: false },
                            ...
                            React.createElement(ej2_react_spreadsheet_2.RowsDirective, null,
                                ...
                                React.createElement(ej2_react_spreadsheet_2.RowDirective, { height: 150 },
                                    React.createElement(ej2_react_spreadsheet_2.CellsDirective, null,
                                        React.createElement(ej2_react_spreadsheet_2.CellDirective, { index: 1, image: this.image }))),
                                React.createElement(ej2_react_spreadsheet_2.RowDirective, { height: 20 }),
