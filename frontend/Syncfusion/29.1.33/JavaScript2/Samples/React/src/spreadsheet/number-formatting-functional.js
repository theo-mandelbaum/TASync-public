...
function NumberFormatting() {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section spreadsheet-control' },
            React.createElement(ej2_react_spreadsheet_1.SpreadsheetComponent, { showRibbon: false, showFormulaBar: false, ref: function (ssObj) { spreadsheet = ssObj; }, created: onCreated.bind(this) },
                React.createElement(ej2_react_spreadsheet_1.SheetsDirective, null,
                    React.createElement(ej2_react_spreadsheet_1.SheetDirective, { name: 'Restaurant Invoice', selectedRange: 'E17' },
                        ...
                        React.createElement(ej2_react_spreadsheet_1.RowsDirective, null,
                            ...
                            React.createElement(ej2_react_spreadsheet_1.RowDirective, null,
                                React.createElement(ej2_react_spreadsheet_1.CellsDirective, null,
                                    React.createElement(ej2_react_spreadsheet_1.CellDirective, { index: 1, value: 'Total Amount:', style: bold }),
                                    React.createElement(ej2_react_spreadsheet_1.CellDirective, { index: 4, formula: '=SUM(E15-E16)', format: (0, ej2_react_spreadsheet_1.getFormatFromType)('Accounting'), style: bold })))),
...
exports.default = NumberFormatting;
