...
import { SpreadsheetComponent, SheetDirective, RowsDirective, CellsDirective, CellDirective, RowDirective, SheetsDirective, ColumnsDirective, ColumnDirective, RangesDirective, RangeDirective, getFormatFromType } from '@syncfusion/ej2-react-spreadsheet';
...
function Print() {
    ...
    let spreadsheet;
    const cellStyle = { fontSize: '13pt', fontWeight: 'bold', textAlign: 'center', backgroundColor: '#919aff', verticalAlign: 'middle', color: '#ffffff' };
    const currencyFormat = getFormatFromType('Currency');
    const chart = [{ type: 'Column', range: 'C2:D58' }];
    let dropDownListInstance;
    const printTypeDataSource = [
        { text: 'Active Sheet', value: 'ActiveSheet' },
        { text: 'Workbook', value: 'Workbook' },
    ];
    let allowGridLines = false;
    let allowRowColumnHeader = false;
    let printType = "ActiveSheet";
