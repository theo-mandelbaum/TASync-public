 ...
 */
var FreezePane = /** @class */ (function (_super) {
    __extends(FreezePane, _super);
    function FreezePane() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.cellStyle = { fontSize: '12pt', fontWeight: 'bold', textAlign: 'center', verticalAlign: 'middle' };
        _this.bold = { fontWeight: 'bold' };
        return _this;
    }
    FreezePane.prototype.onCreated = function () {
        this.spreadsheet.wrap("C2:P2");
        this.spreadsheet.merge('A1:B1');
        this.spreadsheet.merge('C1:P1');
        this.spreadsheet.cellFormat({ backgroundColor: '#4e4ee6', color: '#FFFFF4', fontSize: '12pt', fontWeight: 'bold', textAlign: 'center', verticalAlign: 'middle' }, 'A1:P2');
    ...
    FreezePane.prototype.render = function () {
        var _this = this;
                            ...
                            React.createElement(ej2_react_spreadsheet_2.RowsDirective, null,
                                React.createElement(ej2_react_spreadsheet_2.RowDirective, null,
                                    React.createElement(ej2_react_spreadsheet_2.CellsDirective, null,
                                        React.createElement(ej2_react_spreadsheet_2.CellDirective, { index: 1, value: 'Period', style: this.cellStyle }),
                                        React.createElement(ej2_react_spreadsheet_2.CellDirective, { index: 3, value: 'Total Gross Salary', style: this.cellStyle }))),
                                React.createElement(ej2_react_spreadsheet_2.RowDirective, { index: 26 },
                                    React.createElement(ej2_react_spreadsheet_2.CellsDirective, null,
                                        React.createElement(ej2_react_spreadsheet_2.CellDirective, { index: 13, value: "Total Amount:", style: this.bold }),
                                        React.createElement(ej2_react_spreadsheet_2.CellDirective, { formula: '=SUM(O4:O26)', style: this.cellStyle }),
                                        React.createElement(ej2_react_spreadsheet_2.CellDirective, { formula: '=SUM(P4:P26)', style: this.cellStyle })))),
