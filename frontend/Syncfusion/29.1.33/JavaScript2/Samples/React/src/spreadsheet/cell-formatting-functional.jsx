...
function CellFormatting() {
    ...
    return (<div className='control-pane'>
            <div className='control-section spreadsheet-control'>
                <SpreadsheetComponent showRibbon={false} showFormulaBar={false} sheets={sheetSettings} ref={(ssObj) => { spreadsheet = ssObj; }} created={createdHandler.bind(this)} beforeCellRender={beforeCellRender.bind(this)}>
