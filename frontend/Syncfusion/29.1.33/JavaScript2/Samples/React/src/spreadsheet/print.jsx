...
export class Print extends SampleBase {
    spreadsheet;
    cellStyle = { fontSize: '13pt', fontWeight: 'bold', textAlign: 'center', backgroundColor: '#919aff', verticalAlign: 'middle', color: '#ffffff' };
    currencyFormat = getFormatFromType('Currency');
    chart = [{ type: 'Column', range: 'C2:D58' }];
    ...
    enableRowColumnHeader(args) {
        this.allowRowColumnHeader = args.checked;
    }
    enableGridLines(args) {
