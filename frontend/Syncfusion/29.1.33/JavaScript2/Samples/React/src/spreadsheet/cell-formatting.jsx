    ...
    render() {
        return (<div className='control-pane'>
                <div className='control-section spreadsheet-control'>
                    <SpreadsheetComponent showRibbon={false} showFormulaBar={false} sheets={this.sheetSettings} ref={(ssObj) => { this.spreadsheet = ssObj; }} created={this.createdHandler.bind(this)} beforeCellRender={this.beforeCellRender.bind(this)}>
