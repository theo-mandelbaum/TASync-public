...
function SortingAndFiltering() {
    ...
    return (<div className='control-pane'>
            <div className='control-section spreadsheet-control'>
                <SpreadsheetComponent ref={(ssObj) => { spreadsheet = ssObj; }} openUrl='http://localhost:62728/api/spreadsheet/open' saveUrl='http://localhost:62728/api/spreadsheet/save' created={onCreated.bind(this)}>
                    <SheetsDirective>
