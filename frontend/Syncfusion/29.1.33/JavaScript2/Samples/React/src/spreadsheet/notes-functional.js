...
function Notes() {
    ...
    var spreadsheet;
    var cellStyle = { fontWeight: 'bold', textAlign: 'center' };
                    ...
                    React.createElement(ej2_react_spreadsheet_1.SheetDirective, { name: 'Cart' },
                        ...
                        React.createElement(ej2_react_spreadsheet_1.RowsDirective, null,
                            ...
                            React.createElement(ej2_react_spreadsheet_1.RowDirective, { index: 2 },
                                React.createElement(ej2_react_spreadsheet_1.CellsDirective, null,
                                    React.createElement(ej2_react_spreadsheet_1.CellDirective, { value: 'Product ID', style: cellStyle }),
                            ...
                            React.createElement(ej2_react_spreadsheet_1.RowDirective, null,
                                React.createElement(ej2_react_spreadsheet_1.CellsDirective, null,
                                    ...
                                    React.createElement(ej2_react_spreadsheet_1.CellDirective, { formula: '=Sum(F4:F12)', format: currencyFormat, style: { border: '1px solid #A6A6A6', textAlign: 'right', verticalAlign: 'middle', fontWeight: 'bold' } })))),
