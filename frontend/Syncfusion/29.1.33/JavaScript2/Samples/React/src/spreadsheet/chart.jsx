...
export class Chart extends SampleBase {
    spreadsheet;
    style = { backgroundColor: '#e56590', color: '#fff',
        fontWeight: 'bold', textAlign: 'center', verticalAlign: 'middle' };
    chart = [{ type: 'Column', range: 'A3:E10' }];
    onCreated() {
    ...
    <div id="description">
        <p>
            ...
            property in the cell object. You can also insert a chart by using the <a target="_blank" href="https://ej2.syncfusion.com/javascript/documentation/api/spreadsheet#insertchart"> insertChart</a>
             method.
            To enable or disable this feature use the <a target="_blank" href="https://ej2.syncfusion.com/javascript/documentation/api/spreadsheet#allowchart"> allowChart</a>
