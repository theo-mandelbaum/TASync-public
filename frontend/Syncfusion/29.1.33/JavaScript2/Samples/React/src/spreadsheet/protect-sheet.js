 ...
 * ProtectSheet sample
 */
var ProtectSheet = /** @class */ (function (_super) {
    __extends(ProtectSheet, _super);
    function ProtectSheet() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.boldCenter = { fontWeight: 'bold', textAlign: 'center' };
        return _this;
    }
    ProtectSheet.prototype.onCreated = function () {
        this.spreadsheet.numberFormat('$#,##0.00', 'EMI Schedule!C2:F13');
    };
    ProtectSheet.prototype.beforeCellRender = function (args) {
        if (this.spreadsheet.activeSheetIndex === 0 && args.address === 'B1') {
            args.element.colSpan = 2;
        }
    };
    ProtectSheet.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section spreadsheet-control' },
                React.createElement(ej2_react_spreadsheet_1.SpreadsheetComponent, { password: 'spreadsheet', openUrl: 'https://ej2services.syncfusion.com/production/web-services/api/spreadsheet/open', saveUrl: 'https://ej2services.syncfusion.com/production/web-services/api/spreadsheet/save', ref: function (ssObj) { _this.spreadsheet = ssObj; }, created: this.onCreated.bind(this), beforeCellRender: this.beforeCellRender.bind(this) },
                    React.createElement(ej2_react_spreadsheet_1.SheetsDirective, null,
                            ...
                            React.createElement(ej2_react_spreadsheet_1.RowsDirective, null,
                                React.createElement(ej2_react_spreadsheet_1.RowDirective, null,
                                    React.createElement(ej2_react_spreadsheet_1.CellsDirective, null,
                                        React.createElement(ej2_react_spreadsheet_1.CellDirective, { index: 1, value: 'Home Loan Calculator', style: this.boldCenter }))),
                                React.createElement(ej2_react_spreadsheet_1.RowDirective, null,
                                    React.createElement(ej2_react_spreadsheet_1.CellsDirective, null,
                        ...
                        React.createElement(ej2_react_spreadsheet_1.SheetDirective, { name: 'EMI Schedule', isProtected: true },
                            ...
                            React.createElement(ej2_react_spreadsheet_1.RowsDirective, null,
                                React.createElement(ej2_react_spreadsheet_1.RowDirective, null,
                                    React.createElement(ej2_react_spreadsheet_1.CellsDirective, null,
                                        React.createElement(ej2_react_spreadsheet_1.CellDirective, { style: this.boldCenter }),
                                        React.createElement(ej2_react_spreadsheet_1.CellDirective, { style: this.boldCenter }),
                                        React.createElement(ej2_react_spreadsheet_1.CellDirective, { style: this.boldCenter }),
                                        React.createElement(ej2_react_spreadsheet_1.CellDirective, { style: this.boldCenter }),
                                        React.createElement(ej2_react_spreadsheet_1.CellDirective, { style: this.boldCenter }),
