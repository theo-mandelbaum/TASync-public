...
const CallHistory = () => {
    ...
    let fields = { text: 'text', groupBy: 'category' };
    ...
    let allInstance = useRef(null);
    let receivedInstance = useRef(null);
    let missedInstance = useRef(null);
    let listObjects = [];
    let headerText = [
        { "text": "All" },
        { "text": "Received" },
               ...
               <div className={deviceLayout}>
                   ...
                   <div className="layout">
                       <div id="list-container">
                           ...
                           {/* ListView element */}
                           <ListViewComponent id="all" dataSource={callHistoryData} fields={fields} style={styleNone} cssClass='e-list-template' template={listTemplate} ref={(listview) => { allInstance = listview; }}></ListViewComponent>
                           <ListViewComponent id="received" dataSource={callHistoryData} fields={fields} style={styleNone} cssClass='e-list-template' template={listTemplate} ref={(listview) => { receivedInstance = listview; }}></ListViewComponent>
                           <ListViewComponent id="missed" dataSource={callHistoryData} fields={fields} style={styleNone} cssClass='e-list-template' template={listTemplate} ref={(listview) => { missedInstance = listview; }}></ListViewComponent>
                       </div>
                   </div>
