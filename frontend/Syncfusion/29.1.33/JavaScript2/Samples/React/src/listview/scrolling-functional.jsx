...
const Scrolling = () => {
    ...
    const listTemplate = (data) => {
        ...
        if (!Browser.isDevice) {
            return (<div className="e-list-wrapper" style={{ borderBottom: "inset" }}>
            ...
            return (<div className="e-list-wrapper e-list-multi-line e-list-avatar" style={{ paddingLeft: "122px", paddingRight: "1.0666em", borderBottom: "inset" }}>
    ...
    const onListScroll = (args) => {
        let newData = [];
        let instance = document.getElementById('list-scrolling');
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                <div id="listview-scrolling">
                    ...
                    {/* ListView element */}
                    <ListViewComponent id='list-scrolling' height={500} dataSource={foodData} cssClass='e-list-template' scroll={onListScroll.bind(this)} template={listTemplate}></ListViewComponent>
                </div>
            </div>
