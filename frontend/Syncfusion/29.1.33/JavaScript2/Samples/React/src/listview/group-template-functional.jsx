...
const GroupTemplate = () => {
    ...
    let fields = { text: 'Name', groupBy: 'order' };
    ...
    return (<div className='control-pane'>
           <div className='control-section'>
               {/* ListView element */}
               <ListViewComponent id='groupedList' dataSource={groupDataSource} headerTitle='Settings' showHeader={true} fields={fields} cssClass="e-list-template" template={listTemplate} groupTemplate={groupTemplate}></ListViewComponent>
           </div>
