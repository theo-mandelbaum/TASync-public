        ...
        return (<div className='control-pane'>
                <div className='control-section'>
                    <div id="listview-scrolling">
                        ...
                        {/* ListView element */}
                        <ListViewComponent id='list-scrolling' height={500} dataSource={foodData} cssClass='e-list-template' scroll={this.onListScroll.bind(this)} template={this.listTemplate}></ListViewComponent>
                    </div>
                </div>
