...
var Scrolling = function () {
    ...
    var onListScroll = function (args) {
        var newData = [];
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { id: "listview-scrolling" },
                ...
                React.createElement(ej2_react_lists_1.ListViewComponent, { id: 'list-scrolling', height: 500, dataSource: listData_1.foodData, cssClass: 'e-list-template', scroll: onListScroll.bind(_this), template: listTemplate }))),
