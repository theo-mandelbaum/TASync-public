...
const CustomAggregate = () => {
    ...
    return (<div className="control-pane">
      ...
      <div className="control-section">
        <TreeGridComponent dataSource={summaryData} treeColumnIndex={1} childMapping="subtasks" height="400" ref={treegridObj} dataBound={dataBound.bind(this)}>
          <ColumnsDirective>
