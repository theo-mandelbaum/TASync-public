...
const KeyBoard = () => {
    ...
    const editparams = { params: { format: "n" } };
    ...
    return (<div className="control-pane">
            <div className="control-section">
                <div className="col-md-9">
                    <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="900" allowSelection={true} selectionSettings={{ type: "Multiple" }} editSettings={editSettings}>
                        <ColumnsDirective>
                            <ColumnDirective field="taskID" headerText="Task ID" isPrimaryKey={true} width="90" textAlign="Right"></ColumnDirective>
                            <ColumnDirective field="taskName" headerText="Task Name" width="240" validationRules={validationRule}></ColumnDirective>
                            <ColumnDirective field="startDate" headerText="Start Date" format="yMd" textAlign="Right" editType="datepickeredit" validationRules={validationRule1} width="105"/>
                            <ColumnDirective field="duration" headerText="Duration" width="120" textAlign="Right" editType="numericedit" edit={editparams} validationRules={validationRule2}/>
                            <ColumnDirective field="progress" headerText="Progress" width="130" textAlign="Right" editType="numericedit" edit={editparams}/>
                        </ColumnsDirective>
