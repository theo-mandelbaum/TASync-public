...
var EditType = /** @class */ (function (_super) {
    ...
    function EditType() {
        ...
        _this.validationRule1 = { date: ['M/d/y hh:mm a', 'Please enter a valid date'] };
        _this.validationRule2 = { required: true, number: true };
        _this.editparams2 = { params: { format: 'n' } };
        _this.editparams3 = { params: { format: 'M/d/y hh:mm a' } };
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_treegrid_1.TreeGridComponent, { dataSource: data_1.sampleData, treeColumnIndex: 1, childMapping: 'subtasks', height: '400', editSettings: this.editSettings, pageSettings: this.pageSettings, toolbar: this.toolbarOptions },
                    React.createElement(ej2_react_treegrid_1.ColumnsDirective, null,
                        ...
                        React.createElement(ej2_react_treegrid_1.ColumnDirective, { field: 'startDate', headerText: 'Start Date', width: '170', textAlign: 'Right', editType: 'datetimepickeredit', format: this.format, edit: this.editparams3, validationRules: this.validationRule1 }),
                        React.createElement(ej2_react_treegrid_1.ColumnDirective, { field: 'duration', headerText: 'Duration', width: '150', editType: 'numericedit', textAlign: 'Right', validationRules: this.validationRule2, edit: this.editparams2 }),
                        React.createElement(ej2_react_treegrid_1.ColumnDirective, { field: 'progress', headerText: 'Progress', width: '150', textAlign: 'Right', editType: 'dropdownedit', edit: this.editparams }),
                        React.createElement(ej2_react_treegrid_1.ColumnDirective, { field: 'priority', headerText: 'Priority', width: '150', textAlign: 'Right', editType: 'dropdownedit', edit: this.editparams })),
