    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-md-9'>
            <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='350' allowPaging={true} ref={treegrid => this.treegridObj = treegrid} pageSettings={{ pageSize: 10 }} gridLines='Vertical'>
              <ColumnsDirective>
                  ...
                  <tr style={{ height: '50px' }}>
                    ...
                    <td style={{ width: '60%' }}>
                      <div style={{ paddingLeft: '15px' }}>
                        <DropDownListComponent width="138px" id="selmode" change={this.change.bind(this)} dataSource={this.lines} fields={{ text: 'type', value: 'id' }} value="Vertical"/>
                      </div>
                    </td>
                  </tr>
                </tbody>
