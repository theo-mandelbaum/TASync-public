...
var DetailTemplate = function () {
    ...
    var detailtemplate = function (props) {
    ...
    var template = detailtemplate;
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("style", null, textcolor_CSS),
        React.createElement("div", { className: "control-section" },
            React.createElement(ej2_react_treegrid_1.TreeGridComponent, { dataSource: data_1.textdata, childMapping: "Children", detailTemplate: template.bind(_this), treeColumnIndex: 0, height: "335" },
        ...
        React.createElement("div", { id: "description" },
            React.createElement("p", null,
                ...
                "property accepts either string or HTML elements ID value, which will be used as the template for the detail row."),
