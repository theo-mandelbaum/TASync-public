...
const Overview = () => {
    ...
    const treezoneTemplate = (props) => {
        ...
        return (<div>
        <img src="src/treegrid/images/__Normal.png" alt="Normal" style={{ filter: "brightness(150%)" }} className={classValue}></img>
    ...
    return (<div className="control-pane" role="control" aria-label="Tree Grid Control">
      <div className="control-section">
        <TreeGridComponent dataSource={countries} childMapping="states" height="400" allowReordering={true} allowFiltering={true} allowSorting={true} filterSettings={{ type: "Menu", hierarchyMode: "Parent" }}>
          <ColumnsDirective>
            <ColumnDirective field="name" headerText="Province" width="210" template={flagtemplate} filter={provinceFilter}></ColumnDirective>
      ...
      <div id="action-description">
        <p>
          This{" "}
          <a target="_blank" href="https://www.syncfusion.com/react-ui-components/react-tree-grid">
            {" "}
            React Tree Grid
          </a>{" "}
