...
const ShowHideColumn = () => {
    ...
    const btnClick = () => {
        ...
        let column = treegridObj.current.getColumnByField(columnName);
              ...
              <tbody>
                <tr>
                  ...
                  <td style={{ width: "70%", paddingRight: "10px" }}>
                    <div id="columnddl">
                      <DropDownListComponent width="132px" id="ddlelement" dataSource={columnsName} fields={{ text: "name", value: "id" }} change={change.bind(this)} value="taskID" ref={dropdownObj}/>
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style={{ width: "70%", padding: "10px 10px 10px 0px" }}>
                    <div>
                      <textarea id="hiddencolumns" style={{
            resize: "none",
            height: "65px",
            width: "100%",
            backgroundColor: "#fff",
