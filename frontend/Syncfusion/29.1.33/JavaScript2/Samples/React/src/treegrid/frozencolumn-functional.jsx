    ...
    return (<div className="control-pane">
            ...
            <div id="description">
                ...
                <p>
                    ...
                    using the{" "}
                    <code>
                        <a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/treegrid/column/#frozencolumns">
                            frozenColumns
                        </a>
                    </code>{" "}
                    properties.
                ...
                <p>
                    ...
                    <code>
                        <a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/api/treegrid/frozenrowsandcolumns">
                            {" "}
                            Freeze{" "}
                        </a>{" "}
                    </code>{" "}
