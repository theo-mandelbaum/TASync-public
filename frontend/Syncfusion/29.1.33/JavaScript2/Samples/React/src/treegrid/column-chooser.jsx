...
export class TreeGridColumnChooser extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='350' allowPaging={true} pageSettings={{ pageSize: 10 }} showColumnChooser={true} toolbar={this.toolbarOptions}>
              <ColumnsDirective>
