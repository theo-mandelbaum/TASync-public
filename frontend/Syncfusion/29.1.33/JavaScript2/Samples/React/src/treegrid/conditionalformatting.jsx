...
export class Format extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <div>
            <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='350' allowPaging={true} pageSettings={{ pageSize: 11 }} queryCellInfo={this.queryCellinfo.bind(this)}>
              <ColumnsDirective>
