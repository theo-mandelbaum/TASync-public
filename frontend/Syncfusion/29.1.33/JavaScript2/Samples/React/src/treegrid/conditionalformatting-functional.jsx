...
const Format = () => {
    ...
    return (<div className="control-pane">
      <div className="control-section" role="main" aria-label="Treegrid section">
        <div>
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="350" allowPaging={true} pageSettings={{ pageSize: 11 }} queryCellInfo={queryCellinfo.bind(this)}>
            <ColumnsDirective>
