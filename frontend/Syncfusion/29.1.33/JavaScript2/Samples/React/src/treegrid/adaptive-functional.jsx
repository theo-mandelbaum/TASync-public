...
const Adaptive = () => {
    ...
    const validationRule1 = { required: true, number: true };
    const load = function () {
        ...
        <div className="col-md-9 e-bigger e-adaptive-demo">
          {!Browser.isDevice ? (<div className="e-mobile-layout">
              <div className="e-mobile-content">
                <TreeGridComponent id="adaptivebrowser" dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="100%" ref={treegridobj} enableAdaptiveUI={true} allowFiltering={true} allowSorting={true} allowPaging={true} filterSettings={filterOptions} toolbar={toolbarOptions} editSettings={editSettings} load={load}>
                  <ColumnsDirective>
            ...
            </div>) : (<TreeGridComponent id="adaptivedevice" dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="100%" ref={treegridobj} enableAdaptiveUI={true} allowFiltering={true} allowSorting={true} allowPaging={true} filterSettings={filterOptions} toolbar={toolbarOptions} editSettings={editSettings} load={load}>
              <ColumnsDirective>
                <ColumnDirective field="taskID" headerText="Task ID" isPrimaryKey={true} width="135" textAlign="Right" validationRules={validationRule1}></ColumnDirective>
                <ColumnDirective field="taskName" headerText="Task Name" width="280" validationRules={validationRule}></ColumnDirective>
