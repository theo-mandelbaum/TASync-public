...
const RowHeight = () => {
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="350" rowHeight={20} toolbar={toolbarOptions} ref={treegridObj} toolbarClick={toolbarClick.bind(this)}>
          <ColumnsDirective>
