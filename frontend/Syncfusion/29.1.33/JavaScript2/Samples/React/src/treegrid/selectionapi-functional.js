...
{ /* custom code end */ }
var SelectionAPI = function () {
    (0, react_1.useEffect)(function () {
        (0, sample_base_1.updateSampleSection)();
    }, []);
    var treegridObj = (0, react_1.useRef)(null);
    var numericObj = (0, react_1.useRef)(null);
    var numericObj2 = (0, react_1.useRef)(null);
    var btnClick = function () {
        var startRow = numericObj.current.value;
        var toRow = numericObj2.current.value;
        var rows = [];
    ...
    return (React.createElement("div", { className: "control-pane" },
        ...
        React.createElement("div", { className: "control-section" },
            React.createElement("div", { className: "col-md-9" },
                React.createElement(ej2_react_treegrid_1.TreeGridComponent, { dataSource: data_1.sampleData, treeColumnIndex: 1, childMapping: "subtasks", height: "350", allowPaging: true, allowSelection: true, ref: treegridObj, pageSettings: { pageSize: 10 }, selectionSettings: { type: "Multiple" } },
                        ...
                        React.createElement("tbody", null,
                            ...
                            React.createElement("tr", null,
                                ...
                                React.createElement("td", { style: { width: "80%", paddingRight: "10px" } },
                                    React.createElement("div", { id: "numericbox", style: { minWidth: "110%", paddingLeft: '5px' } },
                                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: "start", format: "##", min: 0, max: 11, ref: numericObj, width: "109%" })))),
                            React.createElement("tr", null,
                                React.createElement("td", null,
                                    React.createElement("div", { style: { paddingTop: "8px" } }, " To ")),
                                React.createElement("td", { style: { width: "80%", paddingRight: "10px" } },
                                    React.createElement("div", { id: "numericbox", style: { minWidth: "110%", paddingLeft: '5px' } },
                                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: "to", format: "##", min: 0, max: 11, ref: numericObj2, width: "109%" })))),
                            React.createElement("tr", null,
                                React.createElement("td", { colSpan: 2 },
                                    React.createElement("div", { className: "col-md-6" },
                                        React.createElement(ej2_react_buttons_1.ButtonComponent, { onClick: btnClick.bind(_this) }, "Select Row")))),
                            React.createElement("tr", null,
                                React.createElement("td", null,
                            ...
                            React.createElement("tr", null,
                                React.createElement("td", { colSpan: 2 },
                                    React.createElement("div", { className: "col-md-6", style: { paddingBottom: "10px" } },
                                        React.createElement(ej2_react_buttons_1.ButtonComponent, { onClick: btnClick2.bind(_this) }, "Clear Selection"))))))))),
        React.createElement("div", { id: "description" },
            ...
            React.createElement("ul", null,
                React.createElement("li", null,
                    ...
                    " - Enabled by default. Enables row selection in Tree Grid."),
                React.createElement("li", null,
                    React.createElement("code", null, "Cell"),
                    " - Enables cell selection in Tree Grid."),
                React.createElement("li", null,
                    React.createElement("code", null, "Both"),
                    " - Enables both row and cell selection in Tree Grid. Clicking any cell will select both the row and cell simultaneously.")),
            React.createElement("p", null,
