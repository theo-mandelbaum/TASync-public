    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-md-9'>
           <TreeGridComponent dataSource={sampleData} ref={treegrid => this.treegridInstance = treegrid} treeColumnIndex={1} childMapping='subtasks' height='350' allowPaging={true} allowFiltering={true} filterSettings={{ mode: 'Immediate', type: 'FilterBar', hierarchyMode: 'Parent' }}>
            <ColumnsDirective>
              ...
              <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                <tbody>
                  <tr>
                    ...
                    <td style={{ width: '70%' }}>
                      <div>
                        <DropDownListComponent width="110px" id="selmode" change={this.onChange.bind(this)} dataSource={this.modes} value="Parent"/>
                      </div>
                    </td>
                  </tr>
                </tbody>
