    ...
    return (<div className="control-pane">
            <div className="control-section">
                <div className="col-lg-9">
                    <TreeGridComponent dataSource={sampleData} ref={treegridInstance} height="350" treeColumnIndex={1} childMapping="subtasks" allowPaging={true} allowSelection={true} selectionSettings={{ type: "Multiple" }} pageSettings={{ pageSize: 10 }} toolbar={toolbarOptions} toolbarClick={toolbarClick.bind(this)}>
                        <ColumnsDirective>
                ...
                <div>
                    <DialogComponent id="alertDialog" header="Copy with Header" visible={visible} animationSettings={animationSettings} width="300px" content="Atleast one row should be selected to copy with header" ref={alertDialogInstance} target=".control-section" buttons={alertButtons}></DialogComponent>
            ...
            <div id="description">
                <p>
                    ...
                    <code>
                        <a target="_blank" href="https://ej2.syncfusion.com/documentation/api/treegrid/#copy">
                            copy
                        </a>
                    </code>{" "}
                    method.
