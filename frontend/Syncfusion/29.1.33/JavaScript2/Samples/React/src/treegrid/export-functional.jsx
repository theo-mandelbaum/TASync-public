...
const Export = () => {
    ...
    let collapsedStatePersist = true;
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <div className="col-md-9">
          <TreeGridComponent dataSource={sampleData} ref={treegridInstance} treeColumnIndex={1} childMapping="subtasks" toolbar={toolbarOptions} toolbarClick={toolbarClick.bind(this)} height="410" allowExcelExport={true} allowPdfExport={true}>
            <ColumnsDirective>
            ...
            <table id="property" className="property-panel-table" style={{ width: "100%" }}>
              <tbody>
                <tr style={{ height: "50px" }}>
                  <td style={{ width: "60%" }}>
                    <CheckBoxComponent checked={true} label="Persist collapsed state" labelPosition="Before" change={onChange.bind(this)}></CheckBoxComponent>
                  </td>
                </tr>
              </tbody>
            </table>
