...
export class TreeContextMenu extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <TreeGridComponent dataSource={sampleData} allowResizing={true} treeColumnIndex={1} childMapping='subtasks' height='350' allowPaging={true} editSettings={this.editSettings} pageSettings={this.pageSettings} contextMenuItems={this.contextMenuItems} allowSorting={true} allowExcelExport={true} allowPdfExport={true}>
            <ColumnsDirective>
              ...
              <ColumnDirective field='duration' headerText='Duration' width='130' minWidth='120' editType='numericedit' textAlign='Right' validationRules={this.validationRule2} edit={this.editparams2}/>
              <ColumnDirective field='progress' headerText='Progress' width='120' textAlign='Right' editType='dropdownedit' edit={this.editparams}/>
