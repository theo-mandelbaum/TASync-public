...
const Command = () => {
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="400" editSettings={editSettings}>
          <ColumnsDirective>
            ...
            <ColumnDirective field="duration" headerText="Duration" width="130" editType="numericedit" textAlign="Right" validationRules={durationRule} edit={editparams2}/>
