        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { className: 'col-md-9' },
                    React.createElement(ej2_react_treegrid_1.TreeGridComponent, { dataSource: data_1.sampleData, treeColumnIndex: 1, allowPaging: true, childMapping: 'subtasks', height: '350', allowReordering: true, pageSettings: { pageCount: 4, pageSize: 11 }, ref: function (treegrid) { return _this.treegridObj = treegrid; }, actionComplete: this.actionComplete.bind(this) },
                                ...
                                React.createElement("tr", { style: { height: '50px' } },
                                    ...
                                    React.createElement("td", { style: { width: '70%', paddingRight: '10px' } },
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "140px", id: "columns", change: this.change.bind(this), dataSource: this.columnNames, fields: { text: 'name', value: 'id' }, value: "taskID", ref: function (dropdown) { return _this.dropdownObj = dropdown; } })))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", null,
                                        React.createElement("div", null, " Column Index ")),
                                    React.createElement("td", { style: { width: '70%', paddingRight: '10px' } },
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "140px", id: "columnindex", change: this.change2.bind(this), dataSource: this.columnsIndex, fields: { text: 'name', value: 'id' }, value: "0", ref: function (dropdown) { return _this.dropdownObj2 = dropdown; } })))))))),
