...
export class Batch extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
            <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='350' editSettings={this.editSettings} toolbar={this.toolbarOptions} ref={treegrid => this.treegridObj = treegrid}>
            <ColumnsDirective>
    ...
    <div id='description'>
          ...
          <p>
            More information on the selection configuration can be found in this <code><a target="_blank" href="https://ej2.syncfusion.com/react/documentation/treegrid/edit/#batch">
