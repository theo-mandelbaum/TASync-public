...
const SortingAPI = () => {
    ...
    let columnName = useRef(null);
    let sortDirection = useRef(null);
    const columnsName = [
    ...
    const btnClick = () => {
        let columnNam = columnName.current.value;
        let sortType = sortDirection.current.value;
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <div className="col-md-9">
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="410" ref={treegridObj} allowSorting={true}>
            <ColumnsDirective>
                ...
                <tr>
                  ...
                  <td style={{ width: "80%", paddingRight: "10px" }}>
                    <div style={{ paddingLeft: '8px' }}>
                      <DropDownListComponent width="146px" id="columns" ref={columnName} dataSource={columnsName} fields={{ text: "name", value: "id" }} value="taskID"/>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style={{ width: "80%", paddingRight: "10px" }}>
                    <div style={{ paddingLeft: '8px' }}>
                      <DropDownListComponent width="146px" id="direction" ref={sortDirection} dataSource={direction} fields={{ text: "name", value: "id" }} value="Ascending"/>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td colSpan={2} style={{ paddingTop: '10%', paddingLeft: '10px' }}>
                    <ButtonComponent style={{ marginRight: '10px' }} onClick={btnClick.bind(this)}>
                      Sort
                    </ButtonComponent>
