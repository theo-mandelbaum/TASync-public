...
export class Paging extends SampleBase {
    render() {
        ...
        <div className='control-section'>
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='350' allowPaging={true} pageSettings={{ pageSizes: true, pageSize: 10, pageCount: 2 }}>
            <ColumnsDirective>
