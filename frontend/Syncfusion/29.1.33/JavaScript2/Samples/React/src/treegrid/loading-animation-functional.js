...
var LoadingAnimation = function () {
    ...
    var indicatorChange = function (e) {
    ...
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("div", { className: "control-section" },
            React.createElement("div", { className: "col-md-9" },
                React.createElement(ej2_react_treegrid_1.TreeGridComponent, { id: "TreeGrid", dataSource: data, ref: treegridInstance, hasChildMapping: "isParent", height: "400", pageSettings: { pageCount: 3 }, treeColumnIndex: 1, allowPaging: true, idMapping: "TaskID", parentIdMapping: "parentItem", loadingIndicator: { indicatorType: "Shimmer" }, allowSorting: true },
                            ...
                            React.createElement("tr", { style: { height: "50px" } },
                                ...
                                React.createElement("td", { style: { width: "70%" } },
                                    React.createElement("div", { id: "columnddl" },
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { dataSource: indicatortypes, value: "Shimmer", change: indicatorChange.bind(_this), fields: fields, width: "130px", ref: function (indicateDropDown) {
