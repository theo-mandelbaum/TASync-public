...
export class Reorders extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          ...
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} allowPaging={true} childMapping='subtasks' height='350' allowReordering={true} pageSettings={{ pageCount: 4, pageSize: 11 }} ref={treegrid => this.treegridObj = treegrid} actionComplete={this.actionComplete.bind(this)}>
            <ColumnsDirective>
                ...
                <tbody>
                  <tr style={{ height: '50px' }}>
                    ...
                    <td style={{ width: '70%', paddingRight: '10px' }}>
                      <div>
                        <DropDownListComponent width="140px" id="columns" change={this.change.bind(this)} dataSource={this.columnNames} fields={{ text: 'name', value: 'id' }} value="taskID" ref={dropdown => this.dropdownObj = dropdown}/>
                      </div>
                    </td>
                  </tr>
                  <tr style={{ height: '50px' }}>
                    ...
                    <td style={{ width: '70%', paddingRight: '10px' }}>
                      <div>
                        <DropDownListComponent width="140px" id="columnindex" change={this.change2.bind(this)} dataSource={this.columnsIndex} fields={{ text: 'name', value: 'id' }} value="0" ref={dropdown => this.dropdownObj2 = dropdown}/>
                      </div>
                    </td>
                  </tr>
                </tbody>
