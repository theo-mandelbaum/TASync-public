...
const SelectionAPI = () => {
    ...
    let numericObj = useRef(null);
    let numericObj2 = useRef(null);
    const btnClick = () => {
        let startRow = numericObj.current.value;
        let toRow = numericObj2.current.value;
        let rows = [];
        for (let i = startRow > toRow ? toRow : startRow; i <= (startRow > toRow ? startRow : toRow); i++) {
            rows.push(i);
        }
    ...
    return (<div className="control-pane">
      ...
      <div className="control-section">
        <div className="col-md-9">
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="350" allowPaging={true} allowSelection={true} ref={treegridObj} pageSettings={{ pageSize: 10 }} selectionSettings={{ type: "Multiple" }}>
            <ColumnsDirective>
                ...
                <tr>
                  ...
                  <td style={{ width: "80%", paddingRight: "10px" }}>
                    <div id="numericbox" style={{ minWidth: "110%", paddingLeft: '5px' }}>
                      <NumericTextBoxComponent id="start" format="##" min={0} max={11} ref={numericObj} width="109%"></NumericTextBoxComponent>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style={{ width: "80%", paddingRight: "10px" }}>
                    <div id="numericbox" style={{ minWidth: "110%", paddingLeft: '5px' }}>
                      <NumericTextBoxComponent id="to" format="##" min={0} max={11} ref={numericObj2} width="109%"></NumericTextBoxComponent>
                    </div>
                  </td>
                </tr>
                <tr>
