...
import { TreeGridComponent, ColumnsDirective, ColumnDirective, Page, Inject, Edit, Toolbar, ContextMenu, Sort, Resize, ExcelExport, PdfExport, RowDD } from '@syncfusion/ej2-react-treegrid';
...
const TreeContextMenu = () => {
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="350" allowPaging={true} editSettings={editSettings} pageSettings={pageSettings} contextMenuItems={contextMenuItems} allowSorting={true} allowExcelExport={true} allowPdfExport={true} allowResizing={true}>
          <ColumnsDirective>
            ...
            <ColumnDirective field="taskName" headerText="Task Name" width="180" validationRules={validationRule}></ColumnDirective>
            <ColumnDirective field="startDate" headerText="Start Date" width="130" textAlign="Right" editType="datepickeredit" type="date" format="yMd" validationRules={validationRule1}/>
            <ColumnDirective field="endDate" headerText="End Date" width="130" textAlign="Right" editType="datepickeredit" type="date" format="yMd" validationRules={validationRule1}/>
            <ColumnDirective field="duration" headerText="Duration" width="130" minWidth="120" editType="numericedit" textAlign="Right" validationRules={validationRule2} edit={editparams2}/>
            <ColumnDirective field="progress" headerText="Progress" width="120" textAlign="Right" editType="dropdownedit" edit={editparams}/>
