...
const Selection = () => {
    ...
    let typeDropdownObj = useRef(null);
    let modeDropdownObj = useRef(null);
    ...
    const typeChange = (args) => {
        let type = args.value;
        let mode = modeDropdownObj.current.value;
    ...
    const modeChange = (args) => {
        let mode = args.value;
        let type = typeDropdownObj.current.value;
    ...
    return (<div className="control-pane">
      ...
      <div className="control-section">
        <div className="col-md-9">
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="350" allowPaging={true} allowSelection={true} selectionSettings={{ type: "Multiple" }} pageSettings={{ pageSize: 10 }} ref={treegridObj}>
            <ColumnsDirective>
              ...
              <tbody>
                <tr>
                  ...
                  <td style={{ width: "70%", paddingRight: "10px" }}>
                    <div id='selectiondd1'>
                      <DropDownListComponent width="120px" id="type" change={typeChange.bind(this)} dataSource={types} fields={{ text: "type", value: "id" }} value="Multiple" ref={typeDropdownObj}/>
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style={{ width: "70%" }}>
                    <div style={{ paddingRight: "10px" }}>
                      <DropDownListComponent width="120px" id="mode" change={modeChange.bind(this)} dataSource={modes} fields={{ text: "mode", value: "id" }} value="Row" ref={modeDropdownObj}/>
                    </div>
                  </td>
                </tr>
                <tr id="cellselection" style={{ display: display }}>
                  ...
                  <td style={{ width: "70%" }}>
                    <div style={{ paddingRight: "10px", paddingBottom: "10px" }}>
                      <DropDownListComponent width="120px" id="cellmode" change={cellmodeChange.bind(this)} dataSource={cellmodes} fields={{ text: "mode", value: "id" }} value="Flow"/>
                    </div>
                  </td>
                </tr>
              </tbody>
