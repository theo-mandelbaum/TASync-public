        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { className: 'col-md-9' },
                    React.createElement(ej2_react_treegrid_1.TreeGridComponent, { dataSource: data_1.sortData, treeColumnIndex: 0, childMapping: 'subtasks', height: '350', allowPaging: true, allowSorting: true, sortSettings: this.sortingOptions, ref: function (treegrid) { return _this.treegridObj = treegrid; }, actionComplete: this.sort.bind(this) },
