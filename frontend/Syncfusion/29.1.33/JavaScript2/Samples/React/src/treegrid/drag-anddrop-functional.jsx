...
const DragAndDropBetween = () => {
            ...
            <div className='control-section'>
                ...
                <div style={{ display: 'inline-block' }}>
                    <div style={{ float: 'left', width: '49%' }}>
                        <TreeGridComponent id="TreeGrid" dataSource={dragData} treeColumnIndex={1} childMapping='subtasks' allowPaging={true} pageSettings={{ pageCount: 2 }} allowRowDragAndDrop={true} rowDropSettings={{ targetID: 'DestGrid' }} selectionSettings={{ type: 'Multiple' }}>
                            <ColumnsDirective>
                    ...
                    <div style={{ float: 'right', width: '49%' }}>
                        <TreeGridComponent id="DestGrid" childMapping='subtasks' treeColumnIndex={1} allowPaging={true} pageSettings={{ pageCount: 2 }} allowRowDragAndDrop={true} rowDropSettings={{ targetID: 'TreeGrid' }} selectionSettings={{ type: 'Multiple' }}>
                            <ColumnsDirective>
                                <ColumnDirective field='taskID' isPrimaryKey={true} headerText='Task ID' width='100' textAlign='Right'></ColumnDirective>
                                <ColumnDirective field='taskName' headerText='Task Name' width='180'></ColumnDirective>
                                <ColumnDirective field='startDate' headerText='Start Date' width='110' format='yMd' textAlign='Right' type='date'/>
    ...
    <div id="description">
        <p>Enabling the <code><a target="_blank" href="https://helpej2.syncfusion.com/react/documentation/api/treegrid/#allowrowdraganddrop">
            allowRowDragAndDrop
             ...
             the <code><a target="_blank" href="https://helpej2.syncfusion.com/react/documentation/api/treegrid/#rowdropsettings">
                TreeGridRowDropSettings
            </a></code> component's <code>
                <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/treegrid/rowDropSettings/#targetid">
                targetID </a></code> property specifies the target onto which the Tree Grid rows should be dropped.</p>
          <p>For the row drag and drop feature to function correctly, it's essential to have a primary key column. To define this primary key, ensure that <code><a target="_blank" href="https://ej2.syncfusion.com/react/documentation/api/treegrid/column/#isprimarykey">
            isPrimaryKey
        </a></code> is set to <code>true</code> for a unique data column.</p>
        <p>To select the rows, enable the <code><a target="_blank" href="https://ej2.syncfusion.com/react/documentation/treegrid/selection/selection">
