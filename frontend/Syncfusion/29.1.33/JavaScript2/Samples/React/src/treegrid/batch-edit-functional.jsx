...
const Batch = () => {
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="350" editSettings={editSettings} toolbar={toolbarOptions} ref={treegridObj}>
          <ColumnsDirective>
            <ColumnDirective field="taskID" headerText="Task ID" width="90" textAlign="Right" validationRules={validationRule} isPrimaryKey={true}></ColumnDirective>
      ...
      <div id="description">
        ...
        <p>
          ...
          <code>
            <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/treegrid/edit/#batch">
