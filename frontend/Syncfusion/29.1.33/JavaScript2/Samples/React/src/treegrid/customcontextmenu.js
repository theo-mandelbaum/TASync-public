...
var CustomContextMenu = /** @class */ (function (_super) {
    ...
    CustomContextMenu.prototype.contextMenuOpen = function (args) {
        ...
        if (elem.closest('.e-row')) {
            if ((0, ej2_base_1.isNullOrUndefined)(uid) || (0, ej2_base_1.isNullOrUndefined)((0, ej2_base_1.getValue)('hasChildRecords', this.treegridObj.grid.getRowObjectFromUID(uid).data)) ||
                !(0, ej2_base_1.getValue)('hasChildRecords', this.treegridObj.grid.getRowObjectFromUID(uid).data)) {
                args.cancel = true;
            }
            else {
                var flag = (0, ej2_base_1.getValue)('expanded', this.treegridObj.grid.getRowObjectFromUID(uid).data);
