...
const PagingAPI = () => {
    ...
    let sizemodeObj = useRef(null);
    let pageSizeObj = useRef(null);
    let pageCountObj = useRef(null);
    let currentPageObj = useRef(null);
    const onChange = (args) => {
    ...
    const currentPageChange = () => {
        currentPageObj.current.value =
            currentPageObj.current.value > currentPageObj.current.max
                ...
                : currentPageObj.current.value;
        let pageNumber = currentPageObj.current.value;
    ...
    const toggleInputs = (state, isPager) => {
        ...
        let flag = sizemodeObj.current.value === "All";
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <div className="col-md-9">
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="350" allowPaging={true} ref={treegridObj} pageSettings={{ pageCount: 2 }}>
            <ColumnsDirective>
              ...
              <tbody>
                ...
                <tr className="con-prop1">
                  ...
                  <td style={{ width: "50%", paddingTop: "10px 10px 10px 0px" }}>
                    <div id="dropdown">
                      <DropDownListComponent width="115px" id="sizemode" change={change.bind(this)} dataSource={type} fields={{ text: "type", value: "id" }} value="All" ref={sizemodeObj}/>
                    </div>
                  </td>
                </tr>
                <tr className="con-prop2">
                  ...
                  <td style={{ width: "50%", paddingTop: "10px 10px 10px 0px" }}>
                    <div id="numericbox">
                      <NumericTextBoxComponent id="pagesize" format="##" min={1} max={200} value={12} width="115px" ref={pageSizeObj} change={changeNum.bind(this)}></NumericTextBoxComponent>
                    </div>
                  </td>
                </tr>
                <tr className="con-prop2">
                  ...
                  <td style={{ width: "50%", paddingTop: "10px 10px 10px 0px" }}>
                    <div id="numericbox">
                      <NumericTextBoxComponent id="pagecount" format="##" min={1} max={4} value={2} width="115px" ref={pageCountObj} change={countChange.bind(this)}></NumericTextBoxComponent>
                    </div>
                  </td>
                </tr>
                <tr className="con-prop2">
                  ...
                  <td style={{ width: "50%", paddingTop: "10px 10px 10px 0px" }}>
                    <div id="numericbox">
                      <NumericTextBoxComponent id="currentpage" format="##" min={1} max={17} value={1} width="115px" ref={currentPageObj} change={currentPageChange.bind(this)}></NumericTextBoxComponent>
                    </div>
                  </td>
                </tr>
              </tbody>
