    ...
    return (<div className="control-pane">
      <div className="control-section">
        <div className="col-md-9">
          <TreeGridComponent dataSource={sampleData} ref={treegridInstance} treeColumnIndex={1} childMapping="subtasks" height="350" allowPaging={true} toolbar={toolbarOptions}>
            <ColumnsDirective>
            ...
            <table id="property" title="Properties" className="property-panel-table" style={{ width: "100%" }}>
              <tbody>
                <tr>
                  ...
                  <td style={{ width: "70%" }}>
                    <div>
                      <DropDownListComponent width="110px" id="selmode" change={onChange.bind(this)} dataSource={modes} value="Parent"/>
                    </div>
                  </td>
                </tr>
              </tbody>
