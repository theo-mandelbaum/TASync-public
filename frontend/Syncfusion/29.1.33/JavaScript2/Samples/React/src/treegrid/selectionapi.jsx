    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-md-9'>
            <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='350' allowPaging={true} allowSelection={true} ref={treegrid => this.treegridObj = treegrid} pageSettings={{ pageSize: 10 }} selectionSettings={{ type: 'Multiple' }}>
              <ColumnsDirective>
              ...
              <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style={{ width: '80%', paddingRight: '10px' }}>
                      <div id='numericbox' style={{ minWidth: '110%', paddingLeft: '5px' }}>
                        <NumericTextBoxComponent id='start' format='##' min={0} max={11} ref={numeric => this.numericObj = numeric} width='110%'>
                  ...
                  <tr>
                    ...
                    <td style={{ width: '80%', paddingRight: '10px' }}>
                      <div id='numericbox' style={{ minWidth: '110%', paddingLeft: '5px' }}>
                        <NumericTextBoxComponent id='to' format='##' min={0} max={11} ref={numeric => this.numericObj2 = numeric} width='110%'>
                        </NumericTextBoxComponent>
                      </div>
                    </td>
                  </tr>
