...
export class EditType extends SampleBase {
    ...
    editSettings = { allowEditing: true, allowAdding: true, allowDeleting: true, showDeleteConfirmDialog: true, mode: 'Row',
        newRowPosition: 'Above' };
    editparams = { params: { popupHeight: '300px' } };
    validationRule = { required: true };
    validationRule1 = { date: ['M/d/y hh:mm a', 'Please enter a valid date'] };
    validationRule2 = { required: true, number: true };
    editparams2 = { params: { format: 'n' } };
    editparams3 = { params: { format: 'M/d/y hh:mm a' } };
        ...
        <div className='control-section'>
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping='subtasks' height='400' editSettings={this.editSettings} pageSettings={this.pageSettings} toolbar={this.toolbarOptions}>
            <ColumnsDirective>
              ...
              <ColumnDirective field='startDate' headerText='Start Date' width='170' textAlign='Right' editType='datetimepickeredit' format={this.format} edit={this.editparams3} validationRules={this.validationRule1}/>
              <ColumnDirective field='duration' headerText='Duration' width='150' editType='numericedit' textAlign='Right' validationRules={this.validationRule2} edit={this.editparams2}/>
              <ColumnDirective field='progress' headerText='Progress' width='150' textAlign='Right' editType='dropdownedit' edit={this.editparams}/>
              <ColumnDirective field='priority' headerText='Priority' width='150' textAlign='Right' editType='dropdownedit' edit={this.editparams}/>
            </ColumnsDirective>
