        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { className: 'col-md-9' },
                    React.createElement(ej2_react_treegrid_1.TreeGridComponent, { dataSource: data_1.sampleData, treeColumnIndex: 1, childMapping: 'subtasks', height: '350', allowPaging: true, allowSelection: true, ref: function (treegrid) { return _this.treegridObj = treegrid; }, pageSettings: { pageSize: 10 }, selectionSettings: { type: 'Multiple' } },
                                ...
                                React.createElement("tr", null,
                                    ...
                                    React.createElement("td", { style: { width: '80%', paddingRight: '10px' } },
                                        React.createElement("div", { id: 'numericbox', style: { minWidth: '110%', paddingLeft: '5px' } },
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: 'start', format: '##', min: 0, max: 11, ref: function (numeric) { return _this.numericObj = numeric; }, width: '110%' })))),
                                React.createElement("tr", null,
                                    React.createElement("td", null,
                                        React.createElement("div", { style: { paddingTop: '8px' } }, " To ")),
                                    React.createElement("td", { style: { width: '80%', paddingRight: '10px' } },
                                        React.createElement("div", { id: 'numericbox', style: { minWidth: '110%', paddingLeft: '5px' } },
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: 'to', format: '##', min: 0, max: 11, ref: function (numeric) { return _this.numericObj2 = numeric; }, width: '110%' })))),
                                React.createElement("tr", null,
