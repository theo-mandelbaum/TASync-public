...
export class FrozenAPI extends SampleBase {
    ...
    directionChange(e) {
        if (this.refresh) {
            ...
            let mvblColumns = this.treegrid.getMovableColumns();
    ...
    render() {
        return (<div className='control-pane'>
          <div className='control-section'>
            ...
            <TreeGridComponent ref={g => (this.treegrid = g)} dataSource={frozenSampleData} childMapping="subtasks" treeColumnIndex={1} allowSorting={true} allowSelection={false} height="410">
              <ColumnsDirective>
            ...
            <DialogComponent id="alertDialog" header='Frozen' visible={false} animationSettings={{ effect: 'None' }} width='300px' content='Atleast one Column should be in movable' ref={(alertdialog) => { this.alertDialogInstance = alertdialog; }} target='.control-section' buttons={this.confirmButton} showCloseIcon={false}>
              </DialogComponent>
          </div>
          ...
          <div id="description">
            <p>The freezing feature enables the user to freeze certain rows/columns at both sides to scroll remaining movable
              content. This can be achieved by setting <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/treegrid/scrolling/#frozen-rows-and-columns">freeze</a></code> property in column settings.
            </p>
            ...
            <p> Tree Grid features are segregated into individual feature-wise modules. To use frozen rows and columns feature, we
              need to inject <code><a target="_blank" className="code" href="https://ej2.syncfusion.com/react/documentation/treegrid/scrolling/#frozen-rows-and-columns">Freeze
