...
const ColumnFormat = () => {
    ...
    const format = { type: "dateTime", format: "M/d/yyyy" };
    const columnNames = [
        { id: "price", name: "Price" },
    ...
    const change = (args) => {
        ...
        if (columnName === "price") {
            ...
            let priceColumn = treegridObj.current.getColumnByField("price");
            dropdownObj2.current.value = priceColumn.format.toString();
        }
        if (columnName === "orderDate") {
            dropdownObj2.current.dataSource = dateFormat;
            let format = treegridObj.current.getColumnByField("orderDate").format;
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <div className="col-lg-9">
          <TreeGridComponent dataSource={formatData} treeColumnIndex={1} childMapping="subtasks" height="350" allowPaging={true} ref={treegridObj} pageSettings={{ pageCount: 5 }}>
            <ColumnsDirective>
              ...
              <tbody>
                <tr style={{ height: "50px" }}>
                  ...
                  <td style={{ width: "70%", paddingRight: "10px" }}>
                    <div>
                      <DropDownListComponent width="145px" id="columns" change={change.bind(this)} dataSource={columnNames} fields={{ text: "name", value: "id" }} value="price" ref={dropdownObj}/>
                    </div>
                  </td>
                </tr>
                <tr style={{ height: "50px" }}>
                  ...
                  <td style={{ width: "70%", paddingRight: "10px" }}>
                    <div>
                      <DropDownListComponent width="145px" id="colformat" change={change2.bind(this)} dataSource={priceFormat} fields={{ text: "format", value: "id" }} value="c2" ref={dropdownObj2}/>
                    </div>
                  </td>
                </tr>
              </tbody>
