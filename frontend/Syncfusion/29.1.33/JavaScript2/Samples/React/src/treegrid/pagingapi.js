        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { className: 'col-md-9' },
                    React.createElement(ej2_react_treegrid_1.TreeGridComponent, { dataSource: data_1.sampleData, treeColumnIndex: 1, childMapping: 'subtasks', height: '350', allowPaging: true, ref: function (treegrid) { return _this.treegridObj = treegrid; }, pageSettings: { pageCount: 2 } },
                                ...
                                React.createElement("tr", { className: 'con-prop1' },
                                    ...
                                    React.createElement("td", { style: { width: '50%', paddingTop: '10px 10px 10px 0px' } },
                                        React.createElement("div", { id: 'dropdown' },
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "115px", id: "sizemode", change: this.change.bind(this), dataSource: this.type, fields: { text: 'type', value: 'id' }, value: "All", ref: function (dropdown) { return _this.sizemodeObj = dropdown; } })))),
                                React.createElement("tr", { className: 'con-prop2' },
                                    ...
                                    React.createElement("td", { style: { width: '50%', paddingTop: '10px 10px 10px 0px' } },
                                        React.createElement("div", { id: 'numericbox' },
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: 'pagesize', format: '##', min: 1, max: 200, value: 12, width: '115px', ref: function (numeric) { return _this.pageSizeObj = numeric; }, change: this.changeNum.bind(this) })))),
                                React.createElement("tr", { className: 'con-prop2' },
                                    React.createElement("td", { style: { width: '50%' } },
                                        React.createElement("div", { style: { paddingTop: '7px' } }, " Page Count ")),
                                    React.createElement("td", { style: { width: '50%', paddingTop: '10px 10px 10px 0px' } },
                                        React.createElement("div", { id: 'numericbox' },
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: 'pagecount', format: '##', min: 1, max: 4, value: 2, width: '115px', ref: function (numeric) { return _this.pageCountObj = numeric; }, change: this.countChange.bind(this) })))),
                                React.createElement("tr", { className: 'con-prop2' },
                                    React.createElement("td", { style: { width: '50%' } },
                                        React.createElement("div", { style: { paddingTop: '7px' } }, " Current Page ")),
                                    React.createElement("td", { style: { width: '50%', paddingTop: '10px 10px 10px 0px' } },
                                        React.createElement("div", { id: 'numericbox' },
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: 'currentpage', format: '##', min: 1, max: 17, value: 1, width: '115px', ref: function (numeric) { return _this.currentPageObj = numeric; }, change: this.currentPageChange.bind(this) }))))))))),
