                  ...
                  <tr>
                    ...
                    <td style={{ width: '80%', paddingRight: '10px' }}>
                      <div style={{ paddingLeft: '8px' }}>
                        <DropDownListComponent width="146px" id="columns" ref={columnname => this.columnName = columnname} dataSource={this.columnsName} fields={{ text: 'name', value: 'id' }} value="taskID"/>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td style={{ width: '80%', paddingRight: '10px' }}>
                      <div style={{ paddingLeft: '8px' }}>
                        <DropDownListComponent width="146px" id="direction" ref={sortdirection => this.sortDirection = sortdirection} dataSource={this.direction} fields={{ text: 'name', value: 'id' }} value="Ascending"/>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td colSpan={2} style={{ paddingTop: '10%', paddingLeft: '10px' }}>
                      <ButtonComponent style={{ marginRight: '10px' }} onClick={this.btnClick.bind(this)}>
                        Sort
                      </ButtonComponent>
