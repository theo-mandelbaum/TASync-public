...
const Sorting = () => {
    ...
    let orderNameObj = useRef(null);
    let categoryObj = useRef(null);
    let orderDateObj = useRef(null);
    let unitsObj = useRef(null);
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <div className="col-md-9">
          <TreeGridComponent dataSource={sortData} treeColumnIndex={0} childMapping="subtasks" height="350" allowPaging={true} allowSorting={true} sortSettings={sortingOptions} ref={treegridObj} actionComplete={sort.bind(this)}>
            <ColumnsDirective>
              ...
              <tr>
                ...
                <td style={{ width: "30%", padding: "10px 10px 10px 0px" }}>
                  <div className="col-md-6">
                    <CheckBoxComponent checked={true} change={orderNameChange.bind(this)} ref={orderNameObj}></CheckBoxComponent>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td style={{ width: "30%", padding: "10px 10px 10px 0px" }}>
                  <div className="col-md-6">
                    <CheckBoxComponent checked={true} change={categoryChange.bind(this)} ref={categoryObj}></CheckBoxComponent>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td style={{ width: "30%", padding: "10px 10px 10px 0px" }}>
                  <div className="col-md-6">
                    <CheckBoxComponent change={orderDateChange.bind(this)} ref={orderDateObj}></CheckBoxComponent>
                  </div>
                </td>
              </tr>
              <tr>
                ...
                <td style={{ width: "30%", padding: "10px 10px 10px 0px" }}>
                  <div className="col-md-6">
                    <CheckBoxComponent change={unitsChange.bind(this)} ref={unitsObj}></CheckBoxComponent>
                  </div>
                </td>
              </tr>
            </tbody>
