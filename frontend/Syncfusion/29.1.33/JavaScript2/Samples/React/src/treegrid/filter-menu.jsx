    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-md-9'>
           <TreeGridComponent dataSource={sampleData} ref={treegrid => this.treegridInstance = treegrid} treeColumnIndex={1} childMapping='subtasks' height='350' allowPaging={true} allowFiltering={true} filterSettings={{ type: 'Menu', hierarchyMode: 'Parent' }}>
            <ColumnsDirective>
              ...
              <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
                <tbody>
                  <tr>
                    ...
                    <td style={{ width: '70%' }}>
                      <div>
                        <DropDownListComponent width="110px" id="seltype" change={this.onChange.bind(this)} dataSource={this.filterType} value="Menu"/>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td style={{ width: '70%' }}>
                      <div>
                        <DropDownListComponent width="110px" id="selmode" change={this.onChange2.bind(this)} dataSource={this.modes} value="Parent"/>
                      </div>
                    </td>
                  </tr>
                </tbody>
