        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { className: 'col-md-9' },
                    React.createElement(ej2_react_treegrid_1.TreeGridComponent, { dataSource: data_1.sampleData, treeColumnIndex: 1, childMapping: 'subtasks', height: '350', allowPaging: true, allowSelection: true, selectionSettings: { type: 'Multiple' }, pageSettings: { pageSize: 10 }, ref: function (treegrid) { return _this.treegridObj = treegrid; } },
                            ...
                            React.createElement("tbody", null,
                                React.createElement("tr", null,
                                    React.createElement("td", null,
                                        React.createElement("div", { style: { paddingTop: '7px', paddingLeft: '10px' } }, " Selection Type ")),
                                    React.createElement("td", { style: { width: '70%', paddingRight: '10px' } },
                                        React.createElement("div", { id: 'selectiondd1' },
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "120px", id: "type", change: this.typeChange.bind(this), dataSource: this.types, fields: { text: 'type', value: 'id' }, value: "Multiple", ref: function (dropdown) { return _this.typeDropdownObj = dropdown; } })))),
                                React.createElement("tr", null,
                                    React.createElement("td", null,
                                        React.createElement("div", { style: { paddingLeft: '10px' } }, " Selection Mode ")),
                                    React.createElement("td", { style: { width: '70%' } },
                                        React.createElement("div", { style: { paddingRight: '10px' } },
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "120px", id: "mode", change: this.modeChange.bind(this), dataSource: this.modes, fields: { text: 'mode', value: 'id' }, value: "Row", ref: function (dropdown) { return _this.modeDropdownObj = dropdown; } })))),
                                React.createElement("tr", { id: 'cellselection', style: { display: 'none' } },
                                    ...
                                    React.createElement("td", { style: { width: '70%' } },
                                        React.createElement("div", { style: { paddingRight: '10px', paddingBottom: '10px' } },
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "120px", id: "cellmode", change: this.cellmodeChange.bind(this), dataSource: this.cellmodes, fields: { text: 'mode', value: 'id' }, value: "Flow" })))))))),
