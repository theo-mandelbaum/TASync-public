...
export class RemoteData extends SampleBase {
    ...
    render() {
        ...
        <div className='control-section'>
          <TreeGridComponent dataSource={this.data} ref={treegrid => this.treegridInstance = treegrid} hasChildMapping='isParent' height='350' pageSettings={{ pageCount: 3 }} treeColumnIndex={1} allowPaging={true} idMapping='TaskID' parentIdMapping='parentItem'>
            <ColumnsDirective>
