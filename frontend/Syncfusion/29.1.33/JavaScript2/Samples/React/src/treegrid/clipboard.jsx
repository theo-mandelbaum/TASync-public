...
export class Clipboard extends SampleBase {
    toolbarOptions = [{ text: 'Copy', tooltipText: 'Copy', prefixIcon: 'e-copy', id: 'copy' }, { text: 'Copy With Header', tooltipText: 'Copy With Header', prefixIcon: 'e-copy', id: 'copyHeader' }];
    treegridInstance;
    visible = false;
    modes = [
    ...
    render() {
        ...
        <div className='control-section'>
          <div className='col-lg-9'>
           <TreeGridComponent dataSource={sampleData} ref={treegrid => this.treegridInstance = treegrid} height='350' treeColumnIndex={1} childMapping='subtasks' allowPaging={true} allowSelection={true} selectionSettings={{ type: 'Multiple' }} pageSettings={{ pageSize: 10 }} toolbar={this.toolbarOptions} toolbarClick={this.toolbarClick.bind(this)}>
            <ColumnsDirective>
    ...
    <p>Selected rows or cells data in the Tree Grid can be copied into the clipboard using the Keyboard shortcuts and
        <code><a target="_blank" href="https://ej2.syncfusion.com/documentation/api/treegrid/#copy">copy
        </a></code> method.
    </p>
