...
var Command = /** @class */ (function (_super) {
    ...
    function Command() {
        ...
        _this.editSettings = { allowEditing: true, allowAdding: true, allowDeleting: true, mode: 'Row', allowEditOnDblClick: false };
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_treegrid_1.TreeGridComponent, { dataSource: data_1.sampleData, treeColumnIndex: 1, childMapping: 'subtasks', height: '400', editSettings: this.editSettings },
                    React.createElement(ej2_react_treegrid_1.ColumnsDirective, null,
                        ...
                        React.createElement(ej2_react_treegrid_1.ColumnDirective, { field: 'duration', headerText: 'Duration', width: '130', editType: 'numericedit', textAlign: 'Right', validationRules: this.durationRule, edit: this.editparams2 }),
