    ...
    return (<div className="control-pane">
      <div className="control-section">
        <div className="col-md-9">
          <TreeGridComponent dataSource={summaryRowData} treeColumnIndex={0} childMapping="children" height="410" toolbar={toolbarOptions} toolbarClick={toolbarClick.bind(this)} allowExcelExport={true} allowPdfExport={true} ref={treegridObj} excelQueryCellInfo={QueryCellInfo} pdfQueryCellInfo={QueryCellInfo}>
            <ColumnsDirective>
            ...
            <AggregatesDirective>
              <AggregateDirective>
                <AggregateColumnsDirective>
                  <AggregateColumnDirective field="TotalUnits" columnName="TotalUnits" type="Min" footerTemplate="Minimum: ${Min}">
                    {" "}
                  </AggregateColumnDirective>
                  <AggregateColumnDirective field="UnitWeight" columnName="UnitWeight" type="Max" footerTemplate="Maximum: ${Max}">
                    {" "}
                  </AggregateColumnDirective>
                </AggregateColumnsDirective>
              </AggregateDirective>
