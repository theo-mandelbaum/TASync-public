                ...
                <tbody>
                  <tr style={{ height: '50px' }}>
                    ...
                    <td style={{ width: '70%', paddingRight: '10px' }}>
                      <div>
                        <DropDownListComponent width="133px" id="columns" change={this.change.bind(this)} dataSource={this.columnNames} fields={{ text: 'name', value: 'id' }} value="taskID" ref={dropdown => this.dropdownObj = dropdown}/>
                      </div>
                    </td>
                  </tr>
                  <tr style={{ height: '50px' }}>
                    ...
                    <td style={{ width: '70%', padding: '10px 10px 10px 0px' }}>
                      <div>
                        <DropDownListComponent width="133px" id="alignment" change={this.change2.bind(this)} dataSource={this.alignment} fields={{ text: 'name', value: 'id' }} value="Right" ref={dropdown => this.dropdownObj2 = dropdown}/>
                      </div>
                    </td>
                  </tr>
                </tbody>
