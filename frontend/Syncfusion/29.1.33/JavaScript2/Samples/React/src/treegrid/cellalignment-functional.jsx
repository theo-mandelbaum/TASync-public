...
const CellAlign = () => {
    ...
    const change = (args) => {
        ...
        let alignment = treegridObj.current.getColumnByField(columnName).textAlign;
    ...
    return (<div className="control-pane">
      ...
      <div className="control-section">
        <div className="col-md-9">
          <TreeGridComponent dataSource={sampleData} treeColumnIndex={1} childMapping="subtasks" height="350" allowPaging={true} ref={treegridObj} pageSettings={{ pageSize: 10 }}>
            <ColumnsDirective>
              ...
              <tbody>
                <tr style={{ height: "50px" }}>
                  ...
                  <td style={{ width: "70%", paddingRight: "10px" }}>
                    <div>
                      <DropDownListComponent width="133px" id="columns" change={change.bind(this)} dataSource={columnNames} fields={{ text: "name", value: "id" }} value="taskID" ref={dropdownObj}/>
                    </div>
                  </td>
                </tr>
                <tr style={{ height: "50px" }}>
                  ...
                  <td style={{ width: "70%", padding: "10px 10px 10px 0px" }}>
                    <div>
                      <DropDownListComponent width="133px" id="alignment" change={change2.bind(this)} dataSource={alignment} fields={{ text: "name", value: "id" }} value="Right" ref={dropdownObj2}/>
                    </div>
                  </td>
                </tr>
              </tbody>
