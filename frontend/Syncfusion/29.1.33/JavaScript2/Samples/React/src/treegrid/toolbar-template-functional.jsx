...
const ToolbarTemplate = () => {
    ...
    return (<div className="control-pane">
      <div className="control-section">
        <div>
          <TreeGridComponent dataSource={treesampleData} treeColumnIndex={1} childMapping="subtasks" height="350" allowPaging={true} allowFiltering={true} toolbar={toolbarOptions} ref={treegridObj} toolbarClick={toolbarClick.bind(this)} filterSettings={{ type: "Menu" }} pageSettings={{ pageSize: 11 }}>
            <ColumnsDirective>
