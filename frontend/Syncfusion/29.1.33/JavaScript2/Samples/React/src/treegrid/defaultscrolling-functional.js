...
var DefaultScrolling = function () {
    ...
    return (React.createElement("div", { className: "control-pane" },
        ...
        React.createElement("div", { id: "action-description" },
            React.createElement("p", null, "This sample demonstrates the Tree Grid component with the horizontal and vertical scrollbars to view the exceeded Tree Grid content.")),
        React.createElement("div", { id: "description" },
            React.createElement("p", null, "The Tree Grid will show scrollbar when the content exceeds the element width or height. The vertical and horizontal scrollbar will be displayed based on the following criteria."),
            React.createElement("ul", null,
                React.createElement("li", null, "The vertical scrollbar appears when the total height of rows present in Tree Grid exceeds its element height."),
                React.createElement("li", null, "The horizontal scrollbar appears when the sum of column`s width exceeds Tree Grid element width.")),
            React.createElement("p", null,
                ...
                " ",
                "property is used to set the Tree Grid height and width respectively. The value of these properties can be a numeric value, pixel(",
            ...
            React.createElement("p", null,
                ...
                "respectively. Now, the Tree Grid will render with vertical scrollbar when the total height of rows exceeds its element height and horizontal scrollbar will appear when the total column width exceeds the element width."))));
};
exports.default = DefaultScrolling;
