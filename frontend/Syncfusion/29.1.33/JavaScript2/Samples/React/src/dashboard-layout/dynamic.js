...
var DynamicWidget = /** @class */ (function (_super) {
    ...
    DynamicWidget.prototype.lineTemplate = function () {
        ...
        return (React.createElement("div", { className: "template" },
            React.createElement(ej2_react_charts_1.ChartComponent, { style: { "height": "100%", "width": "100%" }, load: this.load.bind(this), primaryXAxis: { valueType: 'Category', interval: 1, majorGridLines: { width: 0 } }, primaryYAxis: {
                    majorGridLines: { width: 0 },
    ...
    DynamicWidget.prototype.pieTemplate = function () {
        ...
        return (React.createElement("div", { className: "template" },
            React.createElement(ej2_react_charts_1.AccumulationChartComponent, { style: { "height": "100%", "width": "100%" }, legendSettings: { visible: false }, enableSmartLabels: true, enableAnimation: true, center: { x: '50%', y: '50%' }, load: this.Pieload.bind(this), tooltip: { enable: true, header: '<b>${point.x}</b>', format: 'Composition : <b>${point.y}%</b>' } },
    ...
    DynamicWidget.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { id: 'edit_target', className: "control-section" },
                React.createElement("div", null,
                    React.createElement("div", { style: { "width": "100%", "marginBottom": "10px", "marginTop": "10px", "height": "30px" } },
                        React.createElement(ej2_react_buttons_1.ButtonComponent, { id: "togglebtn", cssClass: 'e-outline e-flat e-primary', ref: function (scope) { _this.btnobj = scope; }, iconCss: 'edit', isToggle: true, onClick: this.btnClick.bind(this), style: { "float": "right", "width": "75px" } }, "Edit")),
                ...
                React.createElement(ej2_react_layouts_1.DashboardLayoutComponent, { id: "edit_dashboard", columns: 2, cellSpacing: this.cellSpacing, ref: function (scope) { _this.dashboardObj = scope; }, resizeStop: this.onPanelResize.bind(this), allowResizing: false, allowDragging: false },
                    React.createElement(ej2_react_layouts_1.PanelsDirective, null,
                        React.createElement(ej2_react_layouts_1.PanelDirective, { sizeX: 1, sizeY: 1, row: 0, col: 0, content: this.lineTemplate.bind(this), header: "<div>Line Chart</div>" }),
                        React.createElement(ej2_react_layouts_1.PanelDirective, { sizeX: 1, sizeY: 1, row: 0, col: 1, content: this.pieTemplate.bind(this), header: "<div>Pie Chart</div>" }),
                        React.createElement(ej2_react_layouts_1.PanelDirective, { sizeX: 2, sizeY: 1, row: 1, col: 0, content: this.splineTemplate.bind(this), header: "<div>Spline Chart</div>" })))),
            ...
            React.createElement(ej2_react_popups_1.DialogComponent, { id: "listdialog", width: "500px", height: "260px", visible: false, header: "Add a widget", showCloseIcon: true, animationSettings: { effect: 'Zoom' }, isModal: true, target: '#edit_target', ref: function (scope) { _this.dialogObj = scope; }, content: this.content })));
    };
    DynamicWidget.prototype.dlgClick = function () {
        ...
        document.getElementById('linetemplate').onclick = function () {
            ...
            var panel = [{
                    ...
                    header: '<div>Line Chart</div>', content: _this.lineTemplate.bind(_this)
                }];
            _this.count = _this.count + 1;
            _this.dashboardObj.addPanel(panel[0]);
            _this.dialogObj.visible = false;
            setTimeout(function () {
        ...
        document.getElementById('pietemplate').onclick = function () {
            ...
            var panel = [{
                    'id': '_layout' + countValue, 'sizeX': 1, 'sizeY': 1, 'row': 0, 'col': 0,
                    header: '<div>Pie Chart</div>', content: _this.pieTemplate.bind(_this)
                }];
            _this.count = _this.count + 1;
            _this.dashboardObj.addPanel(panel[0]);
            _this.dialogObj.visible = false;
        ...
        document.getElementById('splinetemplate').onclick = function () {
            ...
            var panel = [{
                    ...
                    header: '<div>Spline Chart</div>', content: _this.splineTemplate.bind(_this)
                }];
            _this.count = _this.count + 1;
            _this.dashboardObj.addPanel(panel[0]);
            _this.dialogObj.visible = false;
    ...
    DynamicWidget.prototype.load = function (args) {
        var selectedTheme = location.hash.split('/')[1];
        selectedTheme = selectedTheme ? selectedTheme : 'Material';
        args.chart.theme = (selectedTheme.charAt(0).toUpperCase() + selectedTheme.slice(1)).replace(/-dark/i, "Dark");
    };
    ;
    DynamicWidget.prototype.Pieload = function (args) {
        var selectedTheme = location.hash.split('/')[1];
        selectedTheme = selectedTheme ? selectedTheme : 'Material';
