    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { id: 'multifilter', className: "control-styles" },
                React.createElement("label", { className: "h4" }, "Resize"),
                React.createElement(ej2_react_dropdowns_1.MultiSelectComponent, { id: "comboelement", dataSource: dataLocal, allowResize: true, fields: fields, placeholder: "Select countries" }))),
