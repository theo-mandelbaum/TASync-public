...
const SelectionLimit = () => {
    ...
    const [maximumSelectionLength, setMaximumSelectionLength] = useState(3);
    ...
    return (<div id="multichecbox" className='control-pane'>
            <div className='control-section col-lg-8'>
                ...
                <label className="h4">Selection Limit</label>
                    <MultiSelectComponent id="checkbox" dataSource={countries} fields={checkFields} placeholder="Select countries" mode="CheckBox" value={value} showDropDownIcon={true} maximumSelectionLength={maximumSelectionLength} filterBarPlaceholder="Search countries" popupHeight="350px">
