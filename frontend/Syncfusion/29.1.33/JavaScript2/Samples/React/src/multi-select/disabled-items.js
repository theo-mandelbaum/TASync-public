...
var Grouping = /** @class */ (function (_super) {
    ...
    function Grouping() {
        ...
        _this.tagData = data[_this.temp];
        // map the groupBy field with tag
        _this.tagFields = { value: "ID", text: "Text", disabled: "State" };
            ...
            React.createElement("div", { className: 'control-section', id: 'dropIcon' },
                React.createElement("div", { className: 'col-lg-6' },
                    React.createElement("div", { id: "disabled-tag" },
                        ...
                        React.createElement(ej2_react_dropdowns_1.MultiSelectComponent, { id: "tag", dataSource: this.tagData, fields: this.tagFields, placeholder: "Select Tags", allowFiltering: true }))),
                React.createElement("div", { className: 'col-lg-6' },
                    React.createElement("div", { id: "vegetable" },
                        React.createElement("h4", null, "Vegetables"),
                        React.createElement(ej2_react_dropdowns_1.MultiSelectComponent, { id: "icons", dataSource: this.vegetableData, fields: this.vegetableFields, placeholder: "Select Vegetables" },
