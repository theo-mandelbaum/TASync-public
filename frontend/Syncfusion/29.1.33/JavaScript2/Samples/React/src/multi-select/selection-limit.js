        ...
        return (React.createElement("div", { id: "multichecbox", className: 'control-pane' },
            React.createElement("div", { className: 'control-section col-lg-8' },
                React.createElement("div", { id: "multigroup", className: "control-styles" },
                    ...
                    React.createElement(ej2_react_dropdowns_1.MultiSelectComponent, { id: "checkbox", cssClass: "e-specific", ref: function (scope) { _this.mulObj = scope; }, dataSource: this.countries, fields: this.checkFields, placeholder: "Select countries", mode: "CheckBox", showDropDownIcon: true, maximumSelectionLength: 3, filterBarPlaceholder: "Search countries", popupHeight: "350px" },
