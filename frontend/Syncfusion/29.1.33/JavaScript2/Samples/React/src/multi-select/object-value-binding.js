            ...
            React.createElement("div", { className: "col-lg-8 control-section" },
                React.createElement("div", { className: "control-wrapper" },
                    React.createElement("div", { id: "default", style: { paddingTop: '75px' } },
                        React.createElement(ej2_react_dropdowns_1.MultiSelectComponent, { id: "defaultelement", ref: function (multiselect) { _this.modeObj = multiselect; }, dataSource: this.records, mode: "Default", change: this.Change.bind(this), allowObjectBinding: true, fields: this.fields, placeholder: "eg Item" })))),
