...
var Default = /** @class */ (function (_super) {
    ...
    function Default() {
        ...
        _this.treeFields = { dataSource: _this.treeData, id: "id", text: "name", selected: "selected", parentID: "pid", hasChildren: "hasChild", expanded: "expanded" };
        return _this;
    }
    Default.prototype.listTemplate = function (data) {
    ...
    Default.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "control-section", id: "sidebar-wrapper" },
            React.createElement("div", null,
                React.createElement(ej2_react_navigations_1.ToolbarComponent, { cssClass: "defaultToolbar", id: "defaultToolbar", clicked: this.toolbarCliked.bind(this) },
            ...
            React.createElement("div", { className: "maincontent" },
                React.createElement(ej2_react_lists_1.ListViewComponent, { id: "listView", ref: function (ListView) { return _this.listObj = ListView; }, template: this.listTemplate, cssClass: "e-list-template", dataSource: this.inboxData, fields: fields, select: this.onListSelect.bind(this), statelessTemplates: ['template'] })),
            React.createElement(ej2_react_navigations_1.SidebarComponent, { id: "defaultSidebar", ref: function (Sidebar) { return _this.sidebarobj = Sidebar; }, className: "default-sidebar", width: "260px", target: ".maincontent", position: "Left" },
                React.createElement(ej2_react_navigations_1.TreeViewComponent, { id: "defaultTree", fields: this.treeFields, nodeSelecting: this.beforeSelect.bind(this), nodeSelected: this.onSelect.bind(this) })),
    ...
    Default.prototype.toolbarCliked = function (args) {
        if (args.item.tooltipText == "Menu") {
            this.sidebarobj.toggle();
        }
    };
    Default.prototype.beforeSelect = function (args) {
        if (args.nodeData.text == "Favorites" || args.nodeData.text == "John") {
            args.cancel = true;
        }
    };
    Default.prototype.onSelect = function (args) {
    ...
    Default.prototype.onListSelect = function (args) {
