...
const Default = () => {
    ...
    let treeFields = { dataSource: treeData, id: "id", text: "name", selected: "selected", parentID: "pid", hasChildren: "hasChild", expanded: "expanded" };
    ...
    let imageEle = '<div class= "image-container"><img height="20px" src="src/sidebar/images/user.svg" alt="John"></img></div>';
    ...
    return (<div className="control-section" id="sidebar-wrapper">
            ...
            <div className="maincontent">
                <ListViewComponent id="listView" ref={listObj} template={listTemplate} cssClass="e-list-template" dataSource={data} fields={fields} select={onListSelect.bind(this)} statelessTemplates={['template']}></ListViewComponent>
            </div>
