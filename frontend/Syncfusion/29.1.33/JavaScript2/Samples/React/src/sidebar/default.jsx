    ...
    render() {
        ...
        return (<div className="control-section" id="sidebar-wrapper">
                ...
                <div className="maincontent">
                    <ListViewComponent id="listView" ref={ListView => this.listObj = ListView} template={this.listTemplate} cssClass="e-list-template" dataSource={this.inboxData} fields={fields} select={this.onListSelect.bind(this)} statelessTemplates={['template']}>
                    </ListViewComponent>
                </div>
