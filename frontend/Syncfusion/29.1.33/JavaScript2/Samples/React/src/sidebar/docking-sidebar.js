...
var Dock = /** @class */ (function (_super) {
    ...
    Dock.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "control-section", id: "dock-wrapper" },
            React.createElement("div", null,
                React.createElement(ej2_react_navigations_1.ToolbarComponent, { cssClass: "dockToolbar", id: "dockToolbar", clicked: this.toolbarCliked.bind(this) },
            ...
            React.createElement("div", { id: "main-content container-fluid col-md-12", className: "dockmaincontent" },
                React.createElement("div", null,
                    React.createElement("div", { id: "dockContent", className: "dockContent" }, "The React DataGrid is a feature-rich component useful for displaying data in a tabular format. Its wide range of functionalities includes data binding, editing, Excel-like filtering, custom sorting, aggregating rows, selection, and support for Excel, CSV, and PDF formats. It loads millions of records in just a second. It has flexible editing and intuitive record selection modes. Also, it has seamless data exporting options like PDF, CSV, and Excel."))),
            React.createElement(ej2_react_navigations_1.SidebarComponent, { id: "dockSidebar", ref: function (Sidebar) { return _this.dockBar = Sidebar; }, className: "dockSidebar", width: "220px", dockSize: "60px", target: ".dockmaincontent", enableDock: true, type: "Auto" },
                React.createElement(ej2_react_lists_1.ListViewComponent, { id: "dockList", dataSource: ListData, cssClass: "e-template-list", showIcon: true, fields: listFields, select: this.onSelect.bind(this) })),
    ...
    Dock.prototype.toolbarCliked = function (args) {
        if (args.item.tooltipText == "Menu") {
            this.dockBar.toggle();
        }
    };
    Dock.prototype.onSelect = function (args) {
