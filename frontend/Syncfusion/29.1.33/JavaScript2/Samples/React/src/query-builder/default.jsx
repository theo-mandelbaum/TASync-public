...
export class Default extends SampleBase {
    ...
    createdControl() {
        ...
        let validRule = this.qbObj.getValidRules(this.qbObj.rule);
                ...
                <div className="control-section">
                    ...
                    <div className="row">
                        <div className="col-lg-12 control-section">
                            ...
                            <QueryBuilderComponent dataSource={employeeData} columns={this.columnData} rule={this.importRules} created={this.createdControl.bind(this)} ref={(scope) => { this.qbObj = scope; }}>
