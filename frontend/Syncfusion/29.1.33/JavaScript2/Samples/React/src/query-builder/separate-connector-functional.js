...
var SeparateConnector = function () {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { className: 'col-lg-12 control-section' },
                ...
                React.createElement(ej2_react_querybuilder_1.QueryBuilderComponent, { id: "querybuilder", dataSource: data_source_1.employeeData, columns: columnData, rule: importRules, ref: qryBldrObj, ruleChange: updateRule, enableSeparateConnector: true }),
                React.createElement("div", { className: "e-query-preview" },
                    React.createElement(ej2_react_navigations_1.TabComponent, { id: 'defaultTab', ref: tabObj, selected: changeTab, created: tabCreated },
                        React.createElement(ej2_react_navigations_1.TabItemsDirective, null,
                            ...
                            React.createElement(ej2_react_navigations_1.TabItemDirective, { header: headertext[1], content: MongoDBTemplate })))))),
...
exports.default = SeparateConnector;
