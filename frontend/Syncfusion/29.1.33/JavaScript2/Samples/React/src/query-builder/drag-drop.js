...
exports.AllowDragAndDropTemplate = void 0;
...
var AllowDragAndDropTemplate = /** @class */ (function (_super) {
    __extends(AllowDragAndDropTemplate, _super);
    function AllowDragAndDropTemplate(args) {
    ...
    AllowDragAndDropTemplate.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { className: 'col-lg-12 control-section' },
                    React.createElement("div", { className: "App" }),
                    React.createElement(ej2_react_querybuilder_1.QueryBuilderComponent, { id: "querybuilder", dataSource: data_source_1.employeeData, columns: this.columnData, rule: this.importRules, ref: function (scope) { _this.qryBldrObj = scope; }, showButtons: { lockGroup: true }, ruleChange: this.updateRule, allowDragAndDrop: true }),
    ...
    return AllowDragAndDropTemplate;
}(sample_base_1.SampleBase));
exports.AllowDragAndDropTemplate = AllowDragAndDropTemplate;
