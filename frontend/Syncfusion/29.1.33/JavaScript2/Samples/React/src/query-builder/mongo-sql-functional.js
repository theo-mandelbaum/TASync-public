...
var MongoSQlTemplate = function () {
    ...
    var onSelect = function (args) {
        var validRule = qryBldrObj.current.getValidRules(qryBldrObj.rule);
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { className: "top-right-element" },
                React.createElement(ej2_react_splitbuttons_1.DropDownButtonComponent, { id: "element", items: items, cssClass: 'e-caret-hide', select: onSelect }, "Import")),
...
exports.default = MongoSQlTemplate;
