...
const Default = () => {
    ...
    const createdControl = () => {
        ...
        let validRule = qbObj.current.getValidRules(qbObj.current.rule);
    ...
    const dialogOpen = () => {
        let dlgContentElement = document.getElementById('json-content-area');
        let errorElem = document.getElementById('dlgSpan');
            ...
            <div className="control-section">
                ...
                <div className="row">
                    <div className="col-lg-12 control-section">
                        ...
                        <QueryBuilderComponent dataSource={employeeData} columns={columnData} rule={importRules} ruleChange={updateRule} created={createdControl} ref={qbObj}></QueryBuilderComponent>
