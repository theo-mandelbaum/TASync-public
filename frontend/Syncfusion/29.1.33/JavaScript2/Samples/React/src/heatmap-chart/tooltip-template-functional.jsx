...
const TooltipTemplate = () => {
    ...
    return (<main><div className='control-pane'>
            ...
            <div className='control-section'>
                <HeatMapComponent id='heatmap-container' titleSettings={title} xAxis={xAxis} yAxis={yAxis} dataSource={data.defaultTableDataSource} cellSettings={cellSettings} legendSettings={{ visible: false }} tooltipSettings={tooltipSetting} paletteSettings={paletteSettings} load={load.bind(this)}>
