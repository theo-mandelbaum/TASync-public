    ...
    return (React.createElement("main", null,
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_heatmap_1.HeatMapComponent, { id: 'heatmap-container', titleSettings: title, xAxis: xAxis, tooltipSettings: { textStyle: { fontFamily: 'inherit' } }, legendSettings: { textStyle: { fontFamily: 'inherit' } }, yAxis: yAxis, dataSourceSettings: dataSourceSettings, dataSource: jsonCellData, cellSettings: cellSettings, load: load.bind(_this), paletteSettings: paletteSettings },
