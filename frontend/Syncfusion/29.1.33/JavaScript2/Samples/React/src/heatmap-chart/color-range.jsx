                            ...
                            <tbody>
                                <tr style={{ height: '50px' }}>
                                    ...
                                    <td style={{ width: '40%' }}>
                                        ...
                                        <div className='row'>
                                            <RadioButtonComponent id='fixed' label='Fixed' name='paletteType' value="Fixed" change={this.fixed.bind(this)}></RadioButtonComponent>
                                        </div>
                                        <div className='row'>
                                            <RadioButtonComponent id='gradient' checked={true} label='Gradient' name='paletteType' value="Gradient" change={this.gradient.bind(this)}></RadioButtonComponent>
                                        </div>
