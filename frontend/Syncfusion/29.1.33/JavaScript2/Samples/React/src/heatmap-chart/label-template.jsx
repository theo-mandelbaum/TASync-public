...
import { HeatMapComponent, Tooltip, Inject, Adaptor, Legend } from '@syncfusion/ej2-react-heatmap';
    ...
    render() {
        return (<main><div className='control-pane'>
                ...
                <div className='control-section'>
                    <HeatMapComponent id='heatmap-container' xAxis={{
                title: {
                    text: 'LIKELIHOOD',
                    textStyle: {
                        fontFamily: 'inherit'
             ...
             <section id="description" aria-label="Description of the HeatMap features demonstrated in this sample">
                ...
                <p>
                    Heatmap component features are separated into discrete feature-based modules. To use a tooltip and adaptor, inject the <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/heatmap-chart/tooltip">Tooltip</a> and <a href="https://ej2.syncfusion.com/react/documentation/api/heatmap/adaptorType/" target='_blank'>Adaptor </a> module using the <code>{'<Inject services={[Tooltip, Adaptor]} />'}</code> method.
                </p>
