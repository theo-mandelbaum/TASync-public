...
var ColorRange = /** @class */ (function (_super) {
    ...
    ColorRange.prototype.fixed = function (args) {
        this.heatmap.paletteSettings.type = 'Fixed';
        this.heatmap.dataBind();
    };
    ColorRange.prototype.gradient = function (args) {
        this.heatmap.paletteSettings.type = 'Gradient';
        this.heatmap.dataBind();
    };
    ColorRange.prototype.render = function () {
        var _this = this;
            ...
            React.createElement("div", null,
                React.createElement("div", { className: 'col-md-9 control-section' },
                    ...
                    React.createElement(ej2_react_heatmap_1.HeatMapComponent, { id: 'heatmap-container', ref: function (t) { return _this.heatmap = t; }, titleSettings: {
                        ...
                        }, dataSource: data.colorRangeSample, paletteSettings: {
                            palette: [
                                ...
                                React.createElement("tr", { style: { height: '50px' } },
                                    ...
                                    React.createElement("td", { style: { width: '40%' } },
                                        React.createElement("div", { className: 'row' },
                                            React.createElement(ej2_react_buttons_1.RadioButtonComponent, { id: 'fixed', label: 'Fixed', name: 'paletteType', value: "Fixed", change: this.fixed.bind(this) })),
                                        React.createElement("div", { className: 'row' },
                                            React.createElement(ej2_react_buttons_1.RadioButtonComponent, { id: 'gradient', checked: true, label: 'Gradient', name: 'paletteType', value: "Gradient", change: this.gradient.bind(this) }))))))))),
    ...
    ColorRange.prototype.load = function (args) {
        // custom code start
