...
export class Range extends SampleBase {
    minDate = new Date(new Date().getFullYear(), new Date().getMonth(), 7, 10);
    maxDate = new Date(new Date().getFullYear(), new Date().getMonth(), 27, 22, 30);
    minTime = new Date(new Date().getFullYear(), new Date().getMonth(), 7, 10);
    maxTime = new Date(new Date().getFullYear(), new Date().getMonth(), 27, 20, 30);
    dateValue = new Date(new Date().getFullYear(), new Date().getMonth(), 14, 10, 30);
    render() {
