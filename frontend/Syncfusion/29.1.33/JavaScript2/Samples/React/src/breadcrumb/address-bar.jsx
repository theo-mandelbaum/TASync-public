...
export class AddressBar extends SampleBase {
    ...
    subMenuSelectHandler(args) {
        if (!args.element.parentElement.classList.contains('e-menu') && args.item.parentObj.items) {
            ...
            for (let i = 0; i < subItems.length; i++) {
                for (let j = 0; j < this.breadcrumbItems.length; j++) {
    ...
    separatorTemplate(data) {
        let subMenuItems = this.getItems(data.previousItem.text);
        return (<div style={{ display: "flex" }}>
    ...
    initialBreadcrumbItems = [].slice.call(this.breadcrumbItems);
    items = [
        {
    ...
    getItems(text, needParent) {
        let mItems = [].slice.call(this.items);
        let isBreaked;
        if (!text) {
                    ...
                    <div className="content-wrapper breadcrumb-control-wrapper">
                        <div className="row material2">
                            <div className="col-xs-12 col-sm-12 col-lg-12 col-md-12">
                                ...
                                <ButtonComponent cssClass='e-small reset-btn' ref={(scope) => { this.btnobj = scope; }} onClick={this.btnClick.bind(this)}>Reset State</ButtonComponent>
                            </div>
                        </div>
                        <div className="row material2">
                            <div className="col-xs-12 col-sm-12 col-lg-12 col-md-12">
