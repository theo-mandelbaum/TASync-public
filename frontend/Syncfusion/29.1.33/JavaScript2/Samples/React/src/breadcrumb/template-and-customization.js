...
exports.TemplateAndCustomization = void 0;
...
var TemplateAndCustomization = /** @class */ (function (_super) {
    __extends(TemplateAndCustomization, _super);
    function TemplateAndCustomization() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TemplateAndCustomization.prototype.chipTemplate = function (data) {
    ...
    TemplateAndCustomization.prototype.arrowSeparatorTemplate = function () {
        return (React.createElement("span", { className: "e-icons e-arrow" }));
    };
    TemplateAndCustomization.prototype.specificItemTemplate = function (data) {
    ...
    TemplateAndCustomization.prototype.customTemplate = function (data) {
    ...
    TemplateAndCustomization.prototype.customSeparatorTemplate = function () {
        return (React.createElement("div", { className: "e-custom-separator" }));
    };
    TemplateAndCustomization.prototype.beforeItemRenderHandler = function (args) {
        if (args.item.text !== 'Program Files') {
            args.item.disabled = true;
        }
    };
    TemplateAndCustomization.prototype.btnClick = function () {
    ...
    TemplateAndCustomization.prototype.render = function () {
                ...
                React.createElement("div", { className: "content-wrapper breadcrumb-control-wrapper" },
                    React.createElement("div", { className: "row material2" },
                        React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-12 col-md-12" },
                            ...
                            React.createElement(ej2_react_buttons_2.ButtonComponent, { cssClass: 'e-small reset-btn', onClick: this.btnClick.bind(this) }, "Reset State"))),
                    React.createElement("div", { className: "row material2" },
                        React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-12 col-md-12" },
                            React.createElement(ej2_react_navigations_1.BreadcrumbComponent, { cssClass: "e-breadcrumb-chips", itemTemplate: this.chipTemplate },
                    ...
                    React.createElement("div", { className: "row material2" },
                        React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-12 col-md-12" },
                            React.createElement(ej2_react_navigations_1.BreadcrumbComponent, { itemTemplate: this.specificItemTemplate, cssClass: "e-specific-item-template", enableNavigation: false },
                                React.createElement(ej2_react_navigations_1.BreadcrumbItemsDirective, null,
                    ...
                    React.createElement("div", { className: "row material2" },
                        React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-12 col-md-12 e-bc-separator" },
                            React.createElement(ej2_react_navigations_1.BreadcrumbComponent, { separatorTemplate: this.arrowSeparatorTemplate },
                                React.createElement(ej2_react_navigations_1.BreadcrumbItemsDirective, null,
                                    React.createElement(ej2_react_navigations_1.BreadcrumbItemDirective, { text: "Cart" }),
                                    React.createElement(ej2_react_navigations_1.BreadcrumbItemDirective, { text: "Billing" }),
                                    React.createElement(ej2_react_navigations_1.BreadcrumbItemDirective, { text: "Shipping" }),
                    ...
                    React.createElement("div", { className: "row material2" },
                        React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-12 col-md-12" },
                            React.createElement(ej2_react_navigations_1.BreadcrumbComponent, { cssClass: "e-custom-breadcrumb", itemTemplate: this.customTemplate, separatorTemplate: this.customSeparatorTemplate },
                                React.createElement(ej2_react_navigations_1.BreadcrumbItemsDirective, null,
                                    React.createElement(ej2_react_navigations_1.BreadcrumbItemDirective, { text: "Cart" }),
                                    React.createElement(ej2_react_navigations_1.BreadcrumbItemDirective, { text: "Billing" }),
                                    React.createElement(ej2_react_navigations_1.BreadcrumbItemDirective, { text: "Shipping" }),
                    ...
                    React.createElement("div", { className: "row material2" },
                        React.createElement("div", { className: "col-xs-12 col-sm-12 col-lg-12 col-md-12 e-breadcrumb-icons" },
                            React.createElement(ej2_react_navigations_1.BreadcrumbComponent, { beforeItemRender: this.beforeItemRenderHandler },
                                React.createElement(ej2_react_navigations_1.BreadcrumbItemsDirective, null,
                                    React.createElement(ej2_react_navigations_1.BreadcrumbItemDirective, { text: "Program Files", iconCss: "e-bicons e-folder" }),
                                    React.createElement(ej2_react_navigations_1.BreadcrumbItemDirective, { text: "Commom Files", iconCss: "e-bicons e-folder" }),
                                    React.createElement(ej2_react_navigations_1.BreadcrumbItemDirective, { text: "Services", iconCss: "e-bicons e-folder" }),
    ...
    return TemplateAndCustomization;
}(sample_base_1.SampleBase));
exports.TemplateAndCustomization = TemplateAndCustomization;
