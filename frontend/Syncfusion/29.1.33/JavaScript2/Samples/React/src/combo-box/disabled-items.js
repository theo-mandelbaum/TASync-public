            ...
            React.createElement("div", { className: 'control-section', id: 'dropIcon' },
                React.createElement("div", { className: 'col-lg-6' },
                    React.createElement("div", { id: "disabled-status" },
                        ...
                        React.createElement(ej2_react_dropdowns_1.ComboBoxComponent, { id: "status", dataSource: this.statusData, fields: this.statusFields, placeholder: "Select Status", allowFiltering: true }))),
                React.createElement("div", { className: 'col-lg-6' },
                    React.createElement("div", { id: "vegetable" },
                        React.createElement("h4", null, "Vegetable"),
                        React.createElement(ej2_react_dropdowns_1.ComboBoxComponent, { id: "vegetables", dataSource: this.vegetableData, fields: this.vegetableFields, placeholder: "Select Vegetable" })))),
