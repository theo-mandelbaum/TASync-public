        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: "col-lg-8 control-section" },
                React.createElement("div", { className: "control-wrapper" },
                    React.createElement("div", { id: "default", style: { paddingTop: '75px' } },
                        React.createElement(ej2_react_dropdowns_1.ComboBoxComponent, { id: "games", dataSource: this.records, ref: function (combobox) { _this.listObj = combobox; }, fields: this.fields, change: this.onChange.bind(this), placeholder: "Select a Item", allowObjectBinding: true, popupHeight: "220px" })))),
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null,
                    "This sample demonstrates the object value binding functionalities of the ComboBox. Type a character in the ComboBox element or click the drodown icon to choose an item from the ",
                    React.createElement("code", null, "options"),
                    " list. The corresponding object value of the selected item is then assigned to the value property. In the property panel, the ",
