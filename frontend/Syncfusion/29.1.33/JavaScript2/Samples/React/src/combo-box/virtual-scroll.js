            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { className: 'col-lg-6' },
                    React.createElement("div", { id: "local" },
                        ...
                        React.createElement(ej2_react_dropdowns_1.ComboBoxComponent, { id: "localdata", dataSource: this.records, fields: this.fields, placeholder: "e.g. Item 1", allowFiltering: true, enableVirtualization: true, popupHeight: "200px" },
                ...
                React.createElement("div", { className: 'col-lg-6' },
                    React.createElement("div", { id: "remote" },
                        ...
                        React.createElement(ej2_react_dropdowns_1.ComboBoxComponent, { id: "remotedata", dataSource: this.customerData, fields: this.customerField, placeholder: "OrderId", allowFiltering: true, enableVirtualization: true, popupHeight: "200px" },
                            React.createElement(ej2_react_dropdowns_1.Inject, { services: [ej2_react_dropdowns_1.VirtualScroll] })))),
                React.createElement("div", { className: 'col-lg-6' },
                    React.createElement("div", { id: "remote" },
                        React.createElement("h4", null, "Grouping"),
                        React.createElement(ej2_react_dropdowns_1.ComboBoxComponent, { id: "groupdata", dataSource: this.records, fields: this.groupField, placeholder: "e.g. Item 1", allowFiltering: true, enableVirtualization: true, popupHeight: "200px" },
                            React.createElement(ej2_react_dropdowns_1.Inject, { services: [ej2_react_dropdowns_1.VirtualScroll] }))))),
