...
var BindUIToDocument = function () {
    ...
    var nameBox = (0, react_1.useRef)(null);
    var dateBox = (0, react_1.useRef)(null);
    var addressBox = (0, react_1.useRef)(null);
    var phoneBox = (0, react_1.useRef)(null);
    var emailBox = (0, react_1.useRef)(null);
    var toolbarOptions = [
        'New',
        'Open',
        'Separator',
    ...
    var bindToDocument = function () {
        ...
        if (!(0, ej2_base_1.isNullOrUndefined)(bookmarkobj['Name'])) {
            var contentControlData = { title: placeHolderPrefix + 'Name', tag: '', value: bookmarkobj['Name'], canDelete: false, canEdit: false, type: 'RichText' };
            data.push(contentControlData);
        }
        if (!(0, ej2_base_1.isNullOrUndefined)(bookmarkobj['DOB'])) {
            var contentControlData = { title: placeHolderPrefix + 'DOB', tag: '', value: bookmarkobj['DOB'], canDelete: false, canEdit: false, type: 'Date' };
            data.push(contentControlData);
        }
        if (!(0, ej2_base_1.isNullOrUndefined)(bookmarkobj['address'])) {
            var contentControlData = { title: placeHolderPrefix + 'Address', tag: '', value: bookmarkobj['Address'], canDelete: false, canEdit: false, type: 'RichText' };
            data.push(contentControlData);
        }
        if (!(0, ej2_base_1.isNullOrUndefined)(bookmarkobj['Phone'])) {
            var contentControlData = { title: placeHolderPrefix + 'Phone', tag: '', value: bookmarkobj['Phone'], canDelete: false, canEdit: false, type: 'RichText' };
            data.push(contentControlData);
        }
        if (!(0, ej2_base_1.isNullOrUndefined)(bookmarkobj['Email'])) {
            var contentControlData = { title: placeHolderPrefix + 'Email', tag: '', value: bookmarkobj['Email'], canDelete: false, canEdit: false, type: 'RichText' };
            data.push(contentControlData);
        }
        container.current.documentEditor.importContentControlData(data);
    };
    var bindToForm = function () {
        var contentControlInfos = container.current.documentEditor.exportContentControlData();
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: "col-lg-9 control-section" },
            ...
            React.createElement("div", { id: "documenteditor_container_body" },
                React.createElement(ej2_react_documenteditor_1.DocumentEditorContainerComponent, { id: "container", ref: container, style: { display: 'block' }, height: '590px', serviceUrl: hostUrl, enableToolbar: true, locale: 'en-US', toolbarItems: toolbarOptions }))),
        React.createElement("div", { className: "col-lg-3 property-section" },
            React.createElement("div", { className: "content-wrapper sb-content-tab-header" },
                ...
                React.createElement("div", null,
                    React.createElement(ej2_react_inputs_1.TextBoxComponent, { id: "firstName", ref: nameBox, placeholder: "Name", floatLabelType: "Auto" })),
                React.createElement("div", { style: { marginTop: '20px', marginBottom: '0px' } },
                    React.createElement(ej2_react_inputs_1.TextBoxComponent, { id: "birthDate", ref: dateBox, placeholder: "Date[DD/MM/YYYY]", floatLabelType: "Auto" })),
                React.createElement("div", { style: { marginTop: '20px', marginBottom: '0px' } },
                    React.createElement(ej2_react_inputs_1.TextBoxComponent, { id: "address", ref: addressBox, placeholder: "Address", floatLabelType: "Auto" })),
                React.createElement("div", { style: { marginTop: '20px', marginBottom: '0px' } },
                    React.createElement(ej2_react_inputs_1.TextBoxComponent, { id: "phone", ref: phoneBox, placeholder: "Phone", floatLabelType: "Auto" })),
                React.createElement("div", { style: { marginTop: '20px', marginBottom: '20px' } },
                    React.createElement(ej2_react_inputs_1.TextBoxComponent, { id: "email", ref: emailBox, placeholder: "Email", floatLabelType: "Auto" }))),
            React.createElement("div", { className: "content-wrapper" },
                React.createElement("div", { style: { marginTop: '20px', marginRight: '10px', marginBottom: '10px', marginLeft: '0px' } },
                    React.createElement(ej2_react_buttons_1.ButtonComponent, { id: "BindToDocument", onClick: bindToDocument.bind(_this) }, "Bind Form UI Data To Document")),
                React.createElement("div", { style: { marginTop: '10px', marginBottom: '0px' } },
                    React.createElement(ej2_react_buttons_1.ButtonComponent, { id: "BindToForm", onClick: bindToForm.bind(_this) }, "Bind Document Data To Form UI")))),
...
exports.default = BindUIToDocument;
