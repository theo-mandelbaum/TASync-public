...
var TrackChanges = /** @class */ (function (_super) {
    __extends(TrackChanges, _super);
    function TrackChanges() {
        ...
        _this.onLoadDefault = function () {
            ...
            _this.container.documentEditor.documentName = 'Track Changes';
    ...
    TrackChanges.prototype.rendereComplete = function () {
    ...
    TrackChanges.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                ...
                React.createElement("div", { id: "documenteditor_container_body" },
                    React.createElement(ej2_react_documenteditor_1.DocumentEditorContainerComponent, { id: "container", ref: function (scope) { _this.container = scope; }, style: { 'display': 'block' }, height: '590px', serviceUrl: this.hostUrl, enableToolbar: true, locale: 'en-US', showPropertiesPane: false, enableTrackChanges: true, userColor: '#b70f34', currentUser: 'Nancy Davolio' }))),
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This example demonstrates the track changes in DocumentEditor to view, make and accept or reject the changes. To unprotect the document, use password '123'.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "In this example, you can find track changes feature in the document editor."),
                React.createElement("ul", null,
                    React.createElement("li", null, "Accept changes"),
                    React.createElement("li", null, "Reject changes"),
                    React.createElement("li", null, "Accept all"),
                    React.createElement("li", null, "Reject all")),
                React.createElement("p", { style: { 'display': 'block' } },
                    " More information about the document editor features can be found in this ",
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/document-editor/track-changes/" }, "documentation section.")))));
    };
    return TrackChanges;
