    ...
    return (<div className="control-pane">
            <div className="control-section">
                ...
                <div id="documenteditor_container_body">
                    <DocumentEditorContainerComponent id="container" ref={container} style={{ display: "block" }} height={"590px"} serviceUrl={hostUrl} enableToolbar={true} locale="en-US" showPropertiesPane={false} enableTrackChanges={true} userColor={"#b70f34"} currentUser={"Nancy Davolio"}/>
                </div>
            </div>
            ...
            <div id="description">
                ...
                <p style={{ display: "block" }}>
                    ...
                    this{" "}
                    <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/document-editor/getting-started/">
