...
exports.MultipleColumnsView = void 0;
...
var MultipleColumnsView = /** @class */ (function (_super) {
    __extends(MultipleColumnsView, _super);
    function MultipleColumnsView() {
        ...
        _this.onLoadDefault = function () {
            ...
            _this.container.documentEditor.documentName = 'Multiple Columns';
    ...
    MultipleColumnsView.prototype.rendereComplete = function () {
    ...
    MultipleColumnsView.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This example demonstrates multiple column layout in document editor.")),
            React.createElement("div", { id: "description" },
                React.createElement("div", null,
                    React.createElement("p", null, "In this example, section formatting features in the document editor can be found."),
                    React.createElement("ul", null,
                        React.createElement("li", null, "Continuous section break."),
                        React.createElement("li", null, "Two and three column layout.")),
                    React.createElement("p", { style: { 'display': 'block' } },
                        "More information about the document editor features can be found in this ",
                        React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/document-editor/section-format/" }, "documentation section."))))));
    };
    return MultipleColumnsView;
}(sample_base_1.SampleBase));
exports.MultipleColumnsView = MultipleColumnsView;
