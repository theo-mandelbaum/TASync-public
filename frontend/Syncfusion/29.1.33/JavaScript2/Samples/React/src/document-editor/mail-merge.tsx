...
export class MailMerge extends SampleBase<{}, {}> {
    private hostUrl: string = 'https://ej2services.syncfusion.com/production/web-services/api/documenteditor/';
    ...
    mergeDocument(): void {
        this.container.documentEditor.saveAsBlob('Docx').then((blob: Blob) => {
            ...
            fileReader.onload = (): void => {
                ...
                let baseUrl: string = 'https://ej2services.syncfusion.com/production/web-services/api/documenteditor/MailMerge';
