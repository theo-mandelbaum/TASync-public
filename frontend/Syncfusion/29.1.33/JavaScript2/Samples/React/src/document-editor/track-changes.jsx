        ...
        return (<div className='control-pane'>
            <div className='control-section'>
                ...
                <div id="documenteditor_container_body">
                    <DocumentEditorContainerComponent id="container" ref={(scope) => { this.container = scope; }} style={{ 'display': 'block' }} height={'590px'} serviceUrl={this.hostUrl} enableToolbar={true} locale='en-US' showPropertiesPane={false} enableTrackChanges={true} userColor={'#b70f34'} currentUser={'Nancy Davolio'}/>
                </div>
            </div>
