...
const BindUIToDocument = () => {
    ...
    let hostUrl = 'http://localhost:62728/api/documenteditor/';
    ...
    return (<div className='control-pane'>
            <div className="col-lg-9 control-section">
                ...
                <div id="documenteditor_container_body">
                    <DocumentEditorContainerComponent id="container" ref={container} style={{ display: 'block' }} height={'590px'} serviceUrl={hostUrl} enableToolbar={true} locale='en-US' toolbarItems={toolbarOptions}/>
                </div>
            </div>
