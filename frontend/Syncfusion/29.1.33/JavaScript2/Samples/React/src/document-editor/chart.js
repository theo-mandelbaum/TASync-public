...
exports.DocumentEditorChart = void 0;
...
var DocumentEditorChart = /** @class */ (function (_super) {
    __extends(DocumentEditorChart, _super);
    function DocumentEditorChart() {
        ...
        _this.onLoadDefault = function () {
            ...
            _this.container.documentEditor.documentName = 'Product Report';
    ...
    DocumentEditorChart.prototype.rendereComplete = function () {
    ...
    DocumentEditorChart.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This example shows chart preservation support in document editor.")),
            React.createElement("div", { id: "description" },
                React.createElement("div", null,
                    React.createElement("p", null, "With Document Editor, you can see the chart reports from your word document"),
                    React.createElement("p", { style: { 'display': 'block' } },
                        " More information about the document editor features can be found in this ",
                        React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/document-editor/chart/" }, "documentation section."))))));
    };
    return DocumentEditorChart;
}(sample_base_1.SampleBase));
exports.DocumentEditorChart = DocumentEditorChart;
