...
var FormFields = /** @class */ (function (_super) {
    __extends(FormFields, _super);
    function FormFields() {
        ...
        _this.onLoadDefault = function () {
            ...
            _this.container.documentEditor.documentName = 'Form Fields';
    ...
    FormFields.prototype.rendereComplete = function () {
    ...
    FormFields.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section' },
                ...
                React.createElement("div", { id: "documenteditor_container_body" },
                    React.createElement(ej2_react_documenteditor_1.DocumentEditorContainerComponent, { id: "container", ref: function (scope) { _this.container = scope; }, style: { 'display': 'block' }, height: '590px', serviceUrl: this.hostUrl, enableToolbar: true, showPropertiesPane: false, locale: 'en-US', documentEditorSettings: this.settings }))),
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This example demonstrate the design and fill legacy form fields(text, check box, and drop down).To unprotect the document, use password '123'.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "In this example you can find legacy form fields."),
                React.createElement("ul", null,
                    React.createElement("li", null, "Text form field"),
                    React.createElement("li", null, "Check box form field"),
                    React.createElement("li", null, "Drop down field")),
                React.createElement("p", { style: { 'display': 'block' } },
                    " More information about the document editor features can be found in this ",
                    React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/document-editor/form-fields/" }, "documentation section.")))));
    };
    return FormFields;
