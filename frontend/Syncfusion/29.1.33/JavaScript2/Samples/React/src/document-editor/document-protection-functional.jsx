    ...
    return (<div className="control-pane">
            <div className="col-lg-9 control-section">
                ...
                <div id="documenteditor_container_body">
                    <DocumentEditorContainerComponent id="container" ref={container} style={{ display: "block" }} height={"590px"} serviceUrl={hostUrl} enableToolbar={true} locale="en-US" documentEditorSettings={settings}/>
                </div>
            </div>
            ...
            <div id="description">
                <div>
                    ...
                    <p style={{ display: "block" }}>
                        ...
                        this{" "}
                        <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/document-editor/document-management/">
