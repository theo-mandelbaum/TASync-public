...
const FormFields = () => {
    ...
    return (<div className="control-pane">
            ...
            container = scope;
        }} style={{ display: "block" }} height={"590px"} serviceUrl={hostUrl} enableToolbar={true} showPropertiesPane={false} locale="en-US" documentEditorSettings={settings}/>
                </div>
            </div>
            ...
            <div id="description">
                ...
                <p style={{ display: "block" }}>
                    ...
                    this{" "}
                    <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/document-editor/form-fields/">
