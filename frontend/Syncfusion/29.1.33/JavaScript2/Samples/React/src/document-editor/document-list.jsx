...
export class DocumentList extends SampleBase {
    ...
    render() {
        return (<div className='control-pane documenteditor-list-sample'>
          ...
          <DialogComponent id="defaultDialog" visible={!this.state.hideDialog} isModal={true} width={'90%'} height={'90%'} zIndex={1500} ref={dialog => this.dialogInstance = dialog} open={this.dialogOpen.bind(this)} close={this.dialogClose.bind(this)}>
            <div>
              <div id='documenteditor_titlebar' className="e-de-ctn-title"></div>
              <div id="documenteditor_container_body">
                <DocumentEditorContainerComponent id="container" showPropertiesPane={false} ref={(scope) => { this.container = scope; }} style={{ 'display': 'block' }} serviceUrl={this.hostUrl} zIndex={3000} enableToolbar={true} locale='en-US' height='780px'/>
              </div>
            </div>
          </DialogComponent>
