...
var Default = /** @class */ (function (_super) {
    ...
    function Default() {
        ...
        _this.onLoadDefault = function () {
            ...
            _this.container.documentEditor.documentName = 'Getting Started';
            _this.titleBar.updateDocumentTitle();
            _this.container.documentEditor.documentEditorSettings.showRuler = true;
            _this.container.documentEditor.documentEditorSettings.showNavigationPane = true;
    ...
    Default.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This example demonstrates how to enable the heading navigation pane in Document Editor.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null, "In this example, you can navigate documents by heading allows users to move around the document very quickly."),
