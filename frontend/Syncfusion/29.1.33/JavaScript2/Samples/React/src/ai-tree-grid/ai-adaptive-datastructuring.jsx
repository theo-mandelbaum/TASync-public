...
function AdaptiveDataStructuring() {
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                <div id='container'>
                    <TreeGridComponent ref={treegrid => treeGridInstance = treegrid} dataSource={projectData} idMapping='CategoryId' parentIdMapping='ParentId' treeColumnIndex={1} toolbar={toolbarOptions}>
                        <ColumnsDirective>
