            ...
            React.createElement("div", { className: "control-section" },
                React.createElement("div", { id: 'lineargauge-volume-settings', className: 'container', style: { paddingTop: "12px" } },
                    React.createElement("div", { style: { padding: "6px" } },
                        React.createElement(ej2_react_lineargauge_1.LinearGaugeComponent, { load: load, background: 'transparent', id: 'gaugeone', width: '60px', height: '350px', orientation: 'Vertical', container: { width: 30, roundedCornerRadius: 15, type: 'RoundedRectangle', border: { width: 1 }, backgroundColor: 'transparent' } },
                            ...
                            React.createElement(ej2_react_lineargauge_1.AxesDirective, null,
                                React.createElement(ej2_react_lineargauge_1.AxisDirective, { minimum: 0, maximum: 100, line: { width: 0 }, minorTicks: { interval: 10, height: 0 }, majorTicks: { interval: 20, height: 0 }, labelStyle: { font: { size: '0px' } } },
                    ...
                    React.createElement("div", { style: { padding: "6px" } },
                        React.createElement(ej2_react_lineargauge_1.LinearGaugeComponent, { load: load, background: 'transparent', id: 'gaugetwo', width: '60px', height: '350px', orientation: 'Vertical', container: { width: 30, roundedCornerRadius: 15, type: 'RoundedRectangle', border: { width: 1 }, backgroundColor: 'transparent' } },
                            React.createElement(ej2_react_lineargauge_1.Inject, { services: [ej2_react_lineargauge_1.Annotations] }),
                            React.createElement(ej2_react_lineargauge_1.AxesDirective, null,
                                React.createElement(ej2_react_lineargauge_1.AxisDirective, { minimum: 0, maximum: 100, line: { width: 0 }, minorTicks: { interval: 10, height: 0 }, majorTicks: { interval: 20, height: 0 }, labelStyle: { font: { size: '0px' } } },
                                    React.createElement(ej2_react_lineargauge_1.PointersDirective, null,
                    ...
                    React.createElement("div", { style: { padding: "6px" } },
                        React.createElement(ej2_react_lineargauge_1.LinearGaugeComponent, { load: load, background: 'transparent', id: 'gaugethree', width: '60px', height: '350px', orientation: 'Vertical', container: { width: 30, roundedCornerRadius: 15, type: 'RoundedRectangle', border: { width: 1 }, backgroundColor: 'transparent' } },
                            React.createElement(ej2_react_lineargauge_1.Inject, { services: [ej2_react_lineargauge_1.Annotations] }),
                            React.createElement(ej2_react_lineargauge_1.AxesDirective, null,
                                React.createElement(ej2_react_lineargauge_1.AxisDirective, { minimum: 0, maximum: 100, line: { width: 0 }, minorTicks: { interval: 10, height: 0 }, majorTicks: { interval: 20, height: 0 }, labelStyle: { font: { size: '0px' } } },
                                    React.createElement(ej2_react_lineargauge_1.PointersDirective, null,
...
exports.default = VolumeSettings;
