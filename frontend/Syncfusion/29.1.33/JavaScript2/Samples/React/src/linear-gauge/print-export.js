            ...
            React.createElement("div", { className: 'control-pane' },
                ...
                React.createElement("div", { className: 'control-section row' },
                    React.createElement("div", { className: 'col-lg-8' },
                        React.createElement(ej2_react_lineargauge_1.LinearGaugeComponent, { load: this.load.bind(this), id: 'gauge', allowPrint: true, allowPdfExport: true, allowImageExport: true, title: 'Speedometer', titleStyle: { fontFamily: 'inherit' }, orientation: 'Horizontal', ref: function (gauge) { return _this.gauge = gauge; } },
                                    ...
                                    React.createElement("tr", { style: { height: "50px" } },
                                        ...
                                        React.createElement("td", null,
                                            React.createElement("div", { style: { 'marginTop': '0px', height: '45px' } },
                                                React.createElement(ej2_react_inputs_1.TextBoxComponent, { className: "e-input", value: 'Linear Gauge', style: { width: '100%', padding: "0px", paddingLeft: '5px' }, id: "fileName", ref: function (d) { return _this.textElement = d; } })))),
                                    React.createElement("tr", { style: { height: '60px' } },
                                        React.createElement("td", { style: { width: '50%' } },
                                            React.createElement("div", { id: "btn-control" },
                                                React.createElement(ej2_react_buttons_1.ButtonComponent, { onClick: this.onClickExport.bind(this), style: { marginLeft: '30%' }, isPrimary: true }, "Export"))),
                                        React.createElement("td", { style: { width: '50%' } },
                                            React.createElement("div", { id: "btn-control" },
                                                React.createElement(ej2_react_buttons_1.ButtonComponent, { onClick: this.onClickPrint.bind(this), style: { marginLeft: '-20%' }, isPrimary: true }, "Print")))))))))),
