...
var BatteryIndicator = function () {
    ...
    var load = function (args) {
        ...
        args.gauge.annotations[0].content = "<div style=\"width: 16px;height: 37px;border: 5px solid ".concat(borderColor, ";margin-left:26px;margin-top:57px;border-radius: 6px;\" />");
    };
        ...
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement("div", { style: { display: 'flex', justifyContent: 'center', alignItems: 'center' } },
                    React.createElement(ej2_react_lineargauge_1.LinearGaugeComponent, { load: load, background: 'transparent', id: 'gauge', orientation: 'Horizontal', width: '200px', container: { width: 58, type: 'RoundedRectangle', border: { width: 5 } } },
...
exports.default = BatteryIndicator;
