...
function WeatherPrediction() {
    ...
    ;
    let tomorrowButton;
    let secondDayButtonInstance;
    let thirdDayButtonInstance;
    let fourthDayButtonInstance;
    let fifthDayButtonInstance;
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                <div id='container'>
                    <MapsComponent ref={map => mapInstance = map} id='Maps' height='630px' centerPosition={{
        ...
        }} annotations={[
            {
                ...
                zIndex: '1'
                        ...
                        <LayersDirective>
                            <LayerDirective urlTemplate='https://a.tile.openstreetmap.org/level/tileX/tileY.png' tooltipSettings={{
            visible: true,
            valuePath: 'name'
        }} markerSettings={[{
                visible: true,
                ...
                animationDuration: 0,
                        ...
                        <AnnotationsDirective>
                            <AnnotationDirective x='80%' y='0%' zIndex='1' content={'<div style="display: flex">' +
            '<div style="background-color: dodgerblue; color:white; font-size: 16px; padding:5px 10px 5px; width: max-content;">Weather Forecast</div>' +
            '<div style="background-color: white; color:black; font-size: 16px; padding:5px 10px 5px">Today</div>' +
            '</div>'}></AnnotationDirective>
                        </AnnotationsDirective>
