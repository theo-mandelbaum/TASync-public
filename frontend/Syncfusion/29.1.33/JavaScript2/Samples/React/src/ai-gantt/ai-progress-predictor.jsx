...
function Progress() {
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                <div id='container'>
                    <GanttComponent ref={gantt => ganttInstance = gantt} dataSource={TaskDataCollection} enableContextMenu={true} allowSorting={true} allowReordering={true} taskFields={taskFields} editSettings={{
            allowAdding: true,
            allowEditing: true,
            allowDeleting: true,
