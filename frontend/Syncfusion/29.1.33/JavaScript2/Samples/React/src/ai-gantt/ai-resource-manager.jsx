...
import { GanttComponent, Toolbar, Edit, Selection, ColumnsDirective, ColumnDirective, Inject, Sort, Reorder, ContextMenu, DayMarkers } from '@syncfusion/ej2-react-gantt';
...
function ResourceOptimization() {
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                <div id='container'>
                    <GanttComponent id="GanttContainer" ref={gantt => ganttInstance = gantt} dataSource={tasksCollection} resources={resourceCollection} viewType='ResourceView' showOverAllocation={true} enableContextMenu={true} allowSorting={true} allowReordering={true} taskFields={taskFields} resourceFields={{
            id: 'resourceId',
            name: 'resourceName',
            unit: 'resourceUnit',
            group: 'resourceGroup'
