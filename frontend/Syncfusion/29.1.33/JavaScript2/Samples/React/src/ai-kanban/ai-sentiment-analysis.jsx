...
import { pizzaData } from './datasource';
...
function SentimentAnalysis() {
                ...
                <div className="card-template-wrap">
                                            ...
                                            <table className="card-template-wrap">
                                                <tbody>
                                                    <tr className="e-tooltip-text">
                                                        {(data.Category === "Menu" || data.Category === "Order" || data.Category === "Ready to Serve") ? (<td colSpan={2}>
                    ...
                    day: "2-digit",
                                                            ...
                                                            <tr>
                                                                ...
                                                                {data.Emoji && (<td className="e-prepare">
                                                    ...
                                                    {data.Category !== "Delivered" && data.Category !== "Served" && (<tr>
        ...
        return (<table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <DropDownListComponent type="text" name="Category" id="Category" className="e-field" value={data.Category} popupHeight='300px' dataSource={categoryData} fields={{ text: 'Category', value: 'Category' }} placeholder='Category'></DropDownListComponent>
                        </td>
                    </tr>
                    <tr>
                        <td className="e-label">Title</td>
                        <td>
                            <TextBoxComponent type="text" name="Title" id="Title" className="e-field" value={data.Title} placeholder='Title'/>
                        </td>
                    </tr>
                    <tr>
                        <td className="e-label">Size</td>
                        <td>
                            <TextBoxComponent type="text" name="Size" id="Size" className="e-field" value={data.Size} placeholder='Size'/>
                        </td>
                    </tr>
                    <tr>
                        <td className="e-label">Description</td>
                        <td>
                            <TextAreaComponent name="Description" id="Description" className="e-field" value={data.Description} placeholder='Description'></TextAreaComponent>
                    ...
                    <tr>
                        ...
                        <td>
                            <DatePickerComponent type="text" className="e-field" id="datepicker" value={data.Date} format='MM/dd/yyyy'/>
                        </td>
                    </tr>
                    {data.Category === "Delivered" && (<tr>
                            <td className="e-label">Feedback</td>
                            <td>
                                <TextBoxComponent type="text" className="e-field" id="feedback" value={data.Feedback} placeholder='Feedback' multiline={true}/>
                            </td>
                        </tr>)}
                </tbody>
            </table>);
    ...
    return (<>
            <div id="ai-button" style={{ margin: '10px' }}>
                <ProgressButtonComponent ref={button => sentiment = button} id="sentiment" content="Check Customer Sentiments" enableProgress={false} begin={() => {
            ...
            <div className="control-section">
                <div className="control_wrapper">
                    <KanbanComponent ref={kanban => kanbanObj = kanban} id="Kanban" keyField="Category" dataSource={dataSource} cardSettings={{
            headerField: 'Id',
            ...
            <ToastComponent ref={toastObj => toast = toastObj} id="toast" position={{ X: 'Right', Y: 'Top' }} showCloseButton={true} target="#Kanban"></ToastComponent>
        </>);
}
