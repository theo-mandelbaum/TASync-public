        ...
        return (<div className='kanban-control-section'>
                <div className='col-lg-9 control-section'>
                    <div className='control-wrapper'>
                        <KanbanComponent id="kanban" cssClass="kanban-tooltip" keyField="Status" dataSource={this.data} ref={(kanban) => { this.kanbanObj = kanban; }} cardSettings={{ contentField: "Summary", headerField: "Id" }} enableTooltip={true} tooltipTemplate={this.template.bind(this)}>
                            <ColumnsDirective>
