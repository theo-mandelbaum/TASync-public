...
const VirtualScrolling = () => {
    ...
    const generateKanbanDataVirtualScrollData = () => {
        const kanbanData = [];
        const BUG_TASKS = [
    ...
    return (<div className="kanban-control-section">
            <div className="col-lg-12 control-section">
                <div className="control-wrapper">
                    <KanbanComponent id="KanbanVirtualScrolling" enableVirtualization={true} keyField="Status" dataSource={generateKanbanDataVirtualScrollData()} enableTooltip={true} cardSettings={{
            headerField: "Id",
