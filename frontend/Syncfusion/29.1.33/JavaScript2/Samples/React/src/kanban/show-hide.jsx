        ...
        return (<div className='kanban-control-section'>
                <div className='col-lg-9 control-section'>
                    <div className='control-wrapper'>
                        <KanbanComponent id="kanban" keyField="Status" dataSource={this.data} ref={(kanban) => { this.kanbanObj = kanban; }} cardSettings={{ contentField: "Summary", headerField: "Id" }}>
                            <ColumnsDirective>
                    ...
                    <table id='property' title='Show / Hide Columns' className='property-panel-table' style={{ width: '100%' }}>
                        <tbody>
                            <tr style={{ height: '50px' }}>
                                <td style={{ width: '100%' }}>
                                    <CheckBoxComponent ref={(kanban) => { this.checkObj = kanban; }} data-id='Open' checked={true} label='To Do' change={this.onChange.bind(this)}></CheckBoxComponent>
                                </td>
                            </tr>
                            <tr style={{ height: '50px' }}>
                                <td style={{ width: '100%' }}>
                                    <CheckBoxComponent ref={(kanban) => { this.progressObj = kanban; }} data-id='InProgress' checked={true} label='In Progress' change={this.onChangeProgress.bind(this)}></CheckBoxComponent>
                                </td>
                            </tr>
                            <tr style={{ height: '50px' }}>
                                <td style={{ width: '100%' }}>
                                        <CheckBoxComponent ref={(kanban) => { this.reviewObj = kanban; }} data-id='Review' checked={true} label='In Review' change={this.onChangeReview.bind(this)}></CheckBoxComponent>
                                </td>
                            </tr>
                            <tr style={{ height: '50px' }}>
                                <td style={{ width: '100%' }}>
                                    <CheckBoxComponent ref={(kanban) => { this.closeObj = kanban; }} data-id='Close' checked={true} label='Done' change={this.onChangeClose.bind(this)}></CheckBoxComponent>
                                </td>
                            </tr>
                        </tbody>
                        </table>
