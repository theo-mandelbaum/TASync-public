        ...
        return (<div className='kanban-control-section'>
                <div className='col-lg-9 control-section'>
                    <div className='control-wrapper'>
                        <KanbanComponent id="kanban" keyField="Status" dataSource={this.data} ref={(kanban) => { this.kanbanObj = kanban; }} cardSettings={{ contentField: "Summary", headerField: "Id" }} swimlaneSettings={{ keyField: "Assignee" }}>
                            <ColumnsDirective>
                            ...
                            <form id="column">
                                <table className="e-constraint-table">
                                    ...
                                    <tr>
                                        ...
                                        <td><DropDownListComponent id='key' ref={(kanban) => { this.dropObj = kanban; }} dataSource={this.statusData} change={this.changeColumns.bind(this)} fields={this.fields} placeholder='Header Text '></DropDownListComponent></td>
                                    </tr>
                                    <tr>
                                        <td className="e-constraint-label">
                                            <div>MinCount</div>
