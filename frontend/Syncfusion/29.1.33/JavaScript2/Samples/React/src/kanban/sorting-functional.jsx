...
const Sorting = () => {
    ...
    let sortByObj = useRef(null);
    let fieldObj = useRef(null);
    let directionObj = useRef(null);
    const sortByData = [
        { Id: "DataSourceOrder", Sort: "Data Source Order" },
        { Id: "Index", Sort: "Index" },
        { Id: "Custom", Sort: "Custom" },
    ];
    let fields = { text: "Sort", value: "Id" };
    let fieldData = ["None"];
    let directionData = ["Ascending", "Descending"];
    const change = (args) => {
        ...
        if (args.value === "Ascending") {
            const data = sortByObj.current.value === "Index" ? "RankId" : "None";
            setFieldValue(data);
    ...
    const cardTemplate = (props) => {
        return (<div className={"card-template " + props.Priority}>
    ...
    return (<div className="kanban-control-section">
            <div className="col-lg-9 control-section">
                <div className="control-wrapper">
                    <KanbanComponent id="kanban" ref={kanbanObj} keyField="Status" dataSource={data} cardSettings={{
            headerField: "Id",
                ...
                <PropertyPane title="Properties">
                    <table id="property" title="Properties" className="property-panel-table" style={{ width: "100%" }}>
                        ...
                        <tr>
                            ...
                            <td>
                                <DropDownListComponent id="sortBy" ref={sortByObj} dataSource={sortByData} change={change.bind(this)} fields={fields} index={1}></DropDownListComponent>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <DropDownListComponent id="field" ref={fieldObj} dataSource={fieldData} enabled={false} index={0}></DropDownListComponent>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <DropDownListComponent id="direction" ref={directionObj} dataSource={directionData} change={change.bind(this)} index={0}></DropDownListComponent>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <ButtonComponent id="sort" className="e-btn" onClick={sortClick.bind(this)}>
                                    Sort
                                </ButtonComponent>
                            </td>
                            <td>
                                <ButtonComponent id="clear" className="e-btn" onClick={clearClick.bind(this)}>
                                    Clear
                                </ButtonComponent>
                            </td>
                        </tr>
