...
export class API extends SampleBase {
    ...
    deleteIndex;
    dialogInstance;
    statusData = [{ Id: 0, text: 'Testing' }, { Id: 1, text: 'Review' }, { Id: 2, text: 'Validate' }];
    dlgButtonClick() {
        ...
        return (<div className='kanban-control-section'>
                <div className='col-lg-9 control-section'>
                    <div className='control-wrapper'>
                        <KanbanComponent id="kanban" keyField="Status" cssClass="kanban-api" dataSource={this.data} ref={(kanban) => { this.kanbanObj = kanban; }} cardSettings={{ contentField: "Summary", headerField: "Id" }}>
                            <ColumnsDirective>
