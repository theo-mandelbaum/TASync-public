...
const WIPValidation = () => {
    ...
    let minimum = useRef(null);
    let maximum = useRef(null);
    ...
    const changeContraintType = (args) => {
        kanbanObj.current.constraintType = args.value;
    };
    const changeColumns = (args) => {
        let changeIndex = args.value;
        if (changeIndex !== null) {
    ...
    return (<div className="kanban-control-section">
            <div className="col-lg-9 control-section">
                <div className="control-wrapper">
                    <KanbanComponent id="kanban" keyField="Status" dataSource={data} ref={kanbanObj} cardSettings={{ contentField: "Summary", headerField: "Id" }} swimlaneSettings={{ keyField: "Assignee" }}>
                        <ColumnsDirective>
                ...
                <PropertyPane title="Constraint">
                    <table className="e-constraint-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <DropDownListComponent id="type" dataSource={columnType} change={changeContraintType.bind(this)} value={value}></DropDownListComponent>
                                </div>
                            </td>
                        </tr>
                        </tbody>
                        ...
                        <form id="column">
                            <table className="e-constraint-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <DropDownListComponent id="key" ref={dropObj} dataSource={statusData} change={changeColumns.bind(this)} fields={fields} placeholder="Header Text "></DropDownListComponent>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="e-constraint-label">
                                    ...
                                    <td>
                                        <NumericTextBoxComponent ref={minimum} id="minIndex" format="###.##" min={0} placeholder="Minimum Count"></NumericTextBoxComponent>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="e-constraint-label">
                                    ...
                                    <td>
                                        <NumericTextBoxComponent ref={maximum} id="maxIndex" format="###.##" min={0} placeholder="Maximum Count"></NumericTextBoxComponent>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            <div className="e-validate">
                                <ButtonComponent id="validate" className="e-btn" onClick={onFormValidate.bind(this)}>
                                    Validate
                                </ButtonComponent>
                            </div>
                        </form>
