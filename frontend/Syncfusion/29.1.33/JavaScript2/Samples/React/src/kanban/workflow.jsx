    ...
    cardTemplate(props) {
        ...
        return (<div className="card-template">
                    ...
                    <div className='e-card-custom-footer'>
                        {props.Tags.split(",").map((tag) => <div className="e-card-tag-field">{tag}</div>)}
                    </div>
                </div>);
    }
    render() {
        return (<div className='kanban-control-section'>
                <div className='col-lg-12 control-section'>
                    <div className='control-wrapper'>
                        <KanbanComponent cssClass="kanban-workflow" id="kanban" keyField="Category" dataSource={this.data} cardSettings={{ headerField: "Id", contentField: "Description", template: this.cardTemplate.bind(this) }}>
                            <ColumnsDirective>
