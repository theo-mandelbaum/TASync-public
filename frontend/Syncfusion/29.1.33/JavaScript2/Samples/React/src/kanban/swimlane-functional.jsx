...
const Swimlane = () => {
    ...
    const changeRow = (args) => {
        kanbanObj.current.swimlaneSettings.showEmptyRow = args.checked;
    };
    const changeCount = (args) => {
        kanbanObj.current.swimlaneSettings.showItemCount = args.checked;
    };
    const changeFrozen = (args) => {
        kanbanObj.current.swimlaneSettings.enableFrozenRows = args.checked;
    };
    return (<div className="kanban-control-section">
            <div className="col-lg-8 control-section">
                <div className="control-wrapper">
                    <KanbanComponent id="kanban" cssClass="kanban-swimlane" ref={kanbanObj} keyField="Status" dataSource={data} cardSettings={{ contentField: "Summary", headerField: "Id" }} swimlaneSettings={{ keyField: "Assignee" }} height="500px">
                        <ColumnsDirective>
