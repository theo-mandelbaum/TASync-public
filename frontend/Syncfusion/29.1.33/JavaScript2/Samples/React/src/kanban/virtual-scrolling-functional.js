...
var VirtualScrolling = function () {
    ...
    var generateKanbanDataVirtualScrollData = function () {
        var kanbanData = [];
        var BUG_TASKS = [
    ...
    return (React.createElement("div", { className: "kanban-control-section" },
        React.createElement("div", { className: "col-lg-12 control-section" },
            React.createElement("div", { className: "control-wrapper" },
                React.createElement(ej2_react_kanban_1.KanbanComponent, { id: "KanbanVirtualScrolling", enableVirtualization: true, keyField: "Status", dataSource: generateKanbanDataVirtualScrollData(), enableTooltip: true, cardSettings: {
                        headerField: "Id",
                    ...
                    }, cardRendered: onCardRendered.bind(_this) },
