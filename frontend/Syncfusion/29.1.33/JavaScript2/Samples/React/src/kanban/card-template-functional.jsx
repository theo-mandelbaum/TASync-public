...
const CardTemplate = () => {
    ...
    const data = extend([], dataSource.kanbanPizzaData, null, true);
    const cardTemplate = (props) => {
        ...
        return (<div className="card-template">
                ...
                props.Category == "Ready to Serve") && (<td colSpan={2}>
                                                                    {props.Category == "Menu" && (<div className="e-description e-tooltip-text">
                                                                            {props.Description}
                                                                        </div>)}
                                                                    {props.Category != "Menu" && (<div className="e-description e-tooltip-text">
                                                                            {props.OrderID}
                                                    ...
                                                    <tr>
                                                        ...
                                                        {props.Category != "Menu" && (<td className="card-content">
                                                                {props.Category == "Order" && (<div className="e-preparingText e-tooltip-text">
                                                                        Preparing
                                                                    </div>)}
                                                                {props.Category === "Ready to Serve" && (<div className="e-readyText e-tooltip-text">
                                                                        Ready to Serve
                                                                    </div>)}
                                                                {(props.Category == "Delivered") && (<div className="e-deliveredText e-tooltip-text">
                                                                            Delivered
                                                                        </div>)}
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <DropDownListComponent id="Category" name="Category" dataSource={categoryData} className="e-field" placeholder="Category" value={data.Category}></DropDownListComponent>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div className="e-float-input e-control-wrapper">
                                    <textarea name="Description" className="e-field" value={data.Description} onChange={onChange.bind(this)}></textarea>
                                </div>
                            </td>
                        </tr>
                        <tr>
    ...
    return (<div className="kanban-control-section">
            <div className="control-section">
                <div className="control-wrapper">
                    <KanbanComponent cssClass="kanban-card-template" id="kanban" keyField="Category" dataSource={data} cardSettings={{
            headerField: "Id",
