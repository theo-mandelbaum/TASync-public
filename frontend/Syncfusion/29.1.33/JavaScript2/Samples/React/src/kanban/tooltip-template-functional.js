    ...
    return (React.createElement("div", { className: "kanban-control-section" },
        React.createElement("div", { className: "col-lg-9 control-section" },
            React.createElement("div", { className: "control-wrapper" },
                React.createElement(ej2_react_kanban_1.KanbanComponent, { id: "kanban", cssClass: "kanban-tooltip", keyField: "Status", dataSource: data, ref: kanbanObj, cardSettings: { contentField: "Summary", headerField: "Id" }, enableTooltip: true, tooltipTemplate: template.bind(_this) },
                        ...
                        React.createElement("tr", { style: { height: "50px" } },
                            React.createElement("td", { style: { width: "90%" } },
                                React.createElement("div", { className: "enableTooltip" },
                                    React.createElement(ej2_react_buttons_1.CheckBoxComponent, { checked: true, label: "Enable Tooltip", change: onToolTipChange.bind(_this) })))),
                        React.createElement("tr", { style: { height: "50px" } },
                            React.createElement("td", { style: { width: "90%" } },
                                React.createElement("div", { className: "enableTooltipTemplate" },
                                    React.createElement(ej2_react_buttons_1.CheckBoxComponent, { checked: true, label: "Enable Tooltip Template", change: onToolTipTemplateChange.bind(_this) })))))))),
