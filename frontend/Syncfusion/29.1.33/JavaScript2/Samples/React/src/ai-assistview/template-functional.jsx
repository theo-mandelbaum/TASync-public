...
const Template = () => {
    ...
    const promptSuggestionsHeader = 'Hello! Ask Questions, to better understand how your prompt interacts with AI AssistView!';
    const prompts = data["defaultPromptResponseData"];
    const suggestion = data["defaultSuggestions"];
    const templateAiAssistView = useRef(null);
    const assistViewCarousel = useRef(null);
    const buttonVisible = 'Visible';
    const dataSource = [
    ...
    const promptRequest = (args) => {
        setTimeout(() => {
            ...
            templateAiAssistView.current.promptSuggestions = foundPrompt?.suggestions || suggestion;
        }, 2000);
    };
