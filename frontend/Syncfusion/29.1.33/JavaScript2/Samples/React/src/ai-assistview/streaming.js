...
var Streaming = /** @class */ (function (_super) {
    ...
    function Streaming() {
        ...
        _this.handleStopResponse = function () {
        ...
        _this.onPromptRequest = function (args) {
            ...
            var streamResponse = function (response) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: "control-section" },
                React.createElement("div", { className: "stream-aiassistview" },
                    React.createElement(ej2_react_interactive_chat_1.AIAssistViewComponent, { id: "streamAssistView", ref: function (aiassistView) { return (_this.streamingAIAssistView = aiassistView); }, promptSuggestions: this.suggestion, toolbarSettings: this.assistViewToolbarSettings, promptRequest: this.onPromptRequest, stopRespondingClick: this.handleStopResponse, bannerTemplate: this.bannerTemplate }))),
