...
const Streaming = () => {
    ...
    const streamingAIAssistView = useRef(null);
    ...
    const prompts = data["streamingPromptResponseData"];
    const suggestion = data["streamingSuggestions"];
    ...
    const onPromptRequest = (args) => {
        let lastResponse = "";
        let streamingResponse = prompts.find((data) => data.prompt === args.prompt);
