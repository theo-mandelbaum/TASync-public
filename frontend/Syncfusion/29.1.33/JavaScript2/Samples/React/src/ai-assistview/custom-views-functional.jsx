...
const CustomViews = () => {
    ...
    const viewTemplate = '<div class="view-container"><h5>Custom view content</h5></div>';
    const suggestions = data["defaultSuggestions"];
    const created = () => {
        ...
        var generateBtn = new Button({ cssClass: 'e-primary generate-btn', content: 'Generate Prompt', disabled: true });
    ...
    const updateResponseView = (prompt) => {
