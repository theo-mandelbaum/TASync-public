...
import { PdfViewerComponent, Toolbar, Magnification, Navigation, Annotation, LinkAnnotation, ThumbnailView, BookmarkView, TextSelection, TextSearch, FormFields, Inject, FormFieldDataFormat } from '@syncfusion/ej2-react-pdfviewer';
...
function SmartFill() {
    ...
    function getSmartFillResult() {
        ...
        let url = SERVICE_URL + "/SmartFillClicked";
                ...
                <div id="e-pv-smart-fill-container">
                    <div id="e-pv-smartfill-left-container">
                        <div id="e-pv-smartfill-appbar-container" style={{ display: 'none' }}>
                            <AppBarComponent id="e-pv-smartfill-defaultappbar" colorMode='Primary'>
                                <span className="e-pv-smartfill-regular">Smart Fill</span>
                            </AppBarComponent>
                        </div>
                        <ToolbarComponent id="e-pv-smartfill-toolbar" style={{ top: '0px' }} ref={toolbar => toolbarObj = toolbar}>
                            <ItemsDirective>
                                ...
                                <ItemDirective tooltipText="Smart Fill" text="Smart Form Fill" align="Right" id="smartFillButton" template={() => (!Browser.isDevice ?
            <ButtonComponent isPrimary={true} id="smartfill_btn" iconCss='e-icons e-smart-paste' isToggle={true} content='Smart Form Fill'/> :
            <ButtonComponent isPrimary={true} id="smartfill_btn" iconCss='e-icons e-smart-paste' isToggle={true}/>)} cssClass="e-pv-smartfill-btn-container" click={getSmartFillResult}/>
                            </ItemsDirective>
                        </ToolbarComponent>
                        <PdfViewerComponent id="e-pv-smartfill-pdfviewer" ref={pdfviewerObj => pdfviewer = pdfviewerObj} serviceUrl={SERVICE_URL} enableAnnotationToolbar={false} enableToolbar={false} enablePageOrganizer={false} zoomMode="FitToPage" downloadFileName="SmartFill.pdf" created={sampleCreated} documentLoad={documentLoaded}>
                        ...
                        <input type="file" ref={fileUpload => fileUploadBtn = fileUpload} id="e-pv-smartfill-fileUpload" accept=".pdf" style={{ display: 'block', visibility: 'hidden', width: '0', height: '0' }}/>
                        <div id="e-pv-smartfill-right-container-blackout" style={{ display: 'none' }} ref={container => rightContainerBlack = container}></div>
                    </div>
                    <div id="e-pv-smartfill-right-container" ref={container => rightContainer = container}>
                        ...
                        <div tabIndex={0} className="e-card" id="e-pv-card1">
                            <ButtonComponent cssClass='e-copy-icon' iconCss='e-icons e-copy' id="e-pv-copy-card1" style={{ display: 'none' }} ref={btn => copyObjBtn1 = btn}></ButtonComponent>
                        ...
                        <div tabIndex={0} className="e-card" id="e-pv-card2">
                            <ButtonComponent cssClass='e-copy-icon' ref={btn => copyObjBtn2 = btn} iconCss='e-icons e-copy' id="e-pv-copy-card2" style={{ display: 'none' }}></ButtonComponent>
                        ...
                        <div tabIndex={0} className="e-card" id="e-pv-card3">
                            <ButtonComponent cssClass='e-copy-icon' ref={btn => copyObjBtn3 = btn} iconCss='e-icons e-copy' id="e-pv-copy-card3" style={{ display: 'none' }}></ButtonComponent>
