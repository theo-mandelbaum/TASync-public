...
const ComponentsDialog = () => {
    ...
    const content1 = () => {
        return (<ScheduleComponent height="300px" selectedDate={new Date(2019, 0, 10)} eventSettings={{ dataSource: scheduleData }} dragStart={onDragStart}>
        <ViewsDirective>
    ...
    const content3 = () => {
        return (<RichTextEditorComponent id="defaultRTE">
        <p>
