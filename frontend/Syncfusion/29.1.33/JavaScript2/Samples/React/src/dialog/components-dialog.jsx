...
export class ComponentsDialog extends SampleBase {
    ...
    content2() {
        return (<ChartComponent id='DialogChart' primaryXAxis={{
                valueType: 'DateTime',
                labelFormat: 'y',
                intervalType: 'Years',
  ...
  Users can format their content using standard toolbar commands.</p>
    ...
    ;
    onChartLoad(args) {
        let chart = document.getElementById('DialogChart');
    ...
    render() {
        return (<div className='control-pane'>
          ...
          <DialogComponent id="defaultDialog" showCloseIcon={true} animationSettings={this.animationSettings} visible={true} width={'700px'} ref={dialog => this.dialogInstance = dialog} target={'#targetElement'} header='Syncfusion Components inside Dialog' buttons={this.buttons} open={this.dialogOpen.bind(this)} close={this.dialogClose.bind(this)}>
