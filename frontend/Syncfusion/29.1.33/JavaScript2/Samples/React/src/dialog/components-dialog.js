...
exports.ComponentsDialog = void 0;
...
var ComponentsDialog = /** @class */ (function (_super) {
    ...
    ComponentsDialog.prototype.content2 = function () {
        return (React.createElement(ej2_react_charts_1.ChartComponent, { id: 'DialogChart', primaryXAxis: {
                valueType: 'DateTime',
                labelFormat: 'y',
                intervalType: 'Years',
            ...
            }, chartArea: { border: { width: 0 } }, tooltip: { enable: true }, width: "100%", height: "300px", title: 'Inflation - Consumer Price', loaded: this.onChartLoad.bind(this) },
    ...
    ComponentsDialog.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { id: 'targetElement', className: 'control-section col-lg-12 defaultDialogComponent dialog-target' },
                ...
                React.createElement(ej2_react_popups_1.DialogComponent, { id: "defaultDialog", showCloseIcon: true, animationSettings: this.animationSettings, visible: true, width: '700px', ref: function (dialog) { return _this.dialogInstance = dialog; }, target: '#targetElement', header: 'Syncfusion Components inside Dialog', buttons: this.buttons, open: this.dialogOpen.bind(this), close: this.dialogClose.bind(this) },
