...
var GroupEditing = /** @class */ (function (_super) {
    ...
    function GroupEditing() {
        ...
        _this.data = (0, ej2_base_1.extend)([], dataSource.resourceConferenceData, null, true);
        _this.resourceData = [
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-12 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { cssClass: 'group-editing', width: '100%', height: '650px', selectedDate: new Date(2021, 5, 5), currentView: 'WorkWeek', resourceHeaderTemplate: this.resourceHeaderTemplate.bind(this), eventSettings: {
