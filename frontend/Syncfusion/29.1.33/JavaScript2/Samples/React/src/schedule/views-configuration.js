...
exports.ViewConfigurations = void 0;
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-12 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { cssClass: 'schedule-views-config', width: '100%', height: '650px', ref: function (t) { return _this.scheduleObj = t; }, currentView: 'Month', selectedDate: new Date(2021, 5, 20), eventSettings: { dataSource: this.data, fields: { location: { name: 'City' } } } },
