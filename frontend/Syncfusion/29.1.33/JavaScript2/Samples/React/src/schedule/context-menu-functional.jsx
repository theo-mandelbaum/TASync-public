        ...
        switch (selectedMenuItem) {
            ...
            case 'EditSeries':
                if (selectedMenuItem === 'EditSeries') {
                    eventObj = new DataManager(scheduleObj.current.eventsData).executeLocal(new Query().where(scheduleObj.current.eventFields.id, 'equal', eventObj[scheduleObj.current.eventFields.recurrenceID]))[0];
                }
