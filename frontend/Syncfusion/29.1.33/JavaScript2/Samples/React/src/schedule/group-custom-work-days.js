...
exports.GroupCustomWorkDays = void 0;
...
var GroupCustomWorkDays = /** @class */ (function (_super) {
    ...
    function GroupCustomWorkDays() {
        ...
        _this.data = (0, ej2_base_2.extend)([], dataSource.doctorData, null, true);
        _this.resourceData = [
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-12 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { ref: function (schedule) { return _this.scheduleObj = schedule; }, cssClass: 'custom-work-days', width: '100%', height: '650px', selectedDate: new Date(2021, 3, 6), currentView: 'WorkWeek', resourceHeaderTemplate: this.resourceHeaderTemplate.bind(this), eventSettings: {
