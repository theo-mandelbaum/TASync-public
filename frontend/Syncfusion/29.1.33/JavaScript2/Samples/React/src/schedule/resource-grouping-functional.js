...
var Group = function () {
    ...
    var getAirlineImage = function (value) {
        var airlineName = getAirlineName(value);
        return airlineName.replace(' ', '-').toLowerCase();
    };
    var getAirlineName = function (value) {
        return ((value.resourceData) ? value.resourceData[value.resource.textField] : value.resourceName);
    };
    var getAirlineModel = function (value) {
        var airlineName = getAirlineName(value);
        return (airlineName === 'Airways 1') ? 'CRJ 700' : (airlineName === 'Airways 2') ? 'Airbus A330' : 'ATR 72-600';
    };
    var getAirlineSeats = function (value) {
        var airlineName = getAirlineName(value);
    ...
    var resourceHeaderTemplate = function (props) {
        return (React.createElement("div", { className: "template-wrap" },
            React.createElement("div", { className: "airline-image " + getAirlineImage(props) }),
            React.createElement("div", { className: "airline-details" },
                React.createElement("div", { className: "airline-name" }, getAirlineName(props)),
                React.createElement("div", { className: "airline-model" },
                    " Model no: ",
                    getAirlineModel(props)),
                React.createElement("div", { className: "airline-seats" },
                    " No.of seats: ",
                    getAirlineSeats(props)))));
    };
    return (React.createElement("div", { className: 'schedule-control-section' },
        React.createElement("div", { className: 'col-lg-12 control-section' },
            React.createElement("div", { className: 'control-wrapper' },
                ...
                React.createElement(ej2_react_schedule_1.ScheduleComponent, { cssClass: 'schedule-group', width: '100%', height: '650px', selectedDate: new Date(2021, 3, 6), eventSettings: { dataSource: generateEvents(), fields: { subject: { title: 'Travel Summary', name: 'Subject' }, location: { title: 'Source', name: 'Location' }, description: { title: 'Comments', name: 'Description' }, startTime: { title: 'Departure Time', name: 'StartTime' }, endTime: { title: 'Arrival Time', name: 'EndTime' } } }, group: { resources: ['Airlines'] }, resourceHeaderTemplate: resourceHeaderTemplate },
                    React.createElement(ej2_react_schedule_1.ResourcesDirective, null,
                        React.createElement(ej2_react_schedule_1.ResourceDirective, { field: 'AirlineId', title: 'Airline Name', name: 'Airlines', allowMultiple: true, dataSource: resourceData, textField: 'AirlineName', idField: 'AirlineId', colorField: 'AirlineColor' })),
