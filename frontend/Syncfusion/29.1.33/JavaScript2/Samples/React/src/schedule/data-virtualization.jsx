        ...
        return (<div className='schedule-control-section'>
                <div className='col-lg-12 control-section'>
                    <div className='control-wrapper'>
                        <ScheduleComponent width='100%' height='650px' selectedDate={new Date(2023, 3, 1)} readonly={true} group={{ resources: ['Resources'] }} eventSettings={{ dataSource: this.dataManager }}>
                            <ResourcesDirective>
