 ...
 */
var DataVirtualization = function () {
    ...
    return (React.createElement("div", { className: 'schedule-control-section' },
        React.createElement("div", { className: 'col-lg-12 control-section' },
            React.createElement("div", { className: 'control-wrapper' },
                React.createElement(ej2_react_schedule_1.ScheduleComponent, { width: '100%', height: '650px', selectedDate: new Date(2023, 3, 1), readonly: true, group: { resources: ['Resources'] }, eventSettings: { dataSource: dataManager } },
...
exports.default = DataVirtualization;
