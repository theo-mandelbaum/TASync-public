            ...
            React.createElement("div", { className: 'col-lg-9 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement("div", { className: 'col-md-12' },
                        React.createElement(ej2_react_schedule_1.ScheduleComponent, { id: 'schedule', cssClass: 'resource', width: '100%', height: '650px', selectedDate: new Date(2021, 0, 10), ref: function (schedule) { return _this.scheduleObj = schedule; }, eventSettings: { dataSource: this.data } },
