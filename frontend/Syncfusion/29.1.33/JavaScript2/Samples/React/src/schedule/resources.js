...
var Resources = /** @class */ (function (_super) {
    ...
    Resources.prototype.onChange = function (args) {
        ...
        var scheduleData = (0, ej2_base_1.extend)([], this.dManager, null, true);
    ...
    Resources.prototype.generateEvents = function (scheduleObj) {
        ...
        this.dManager = (0, ej2_base_1.extend)([], collections, null, true);
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-9 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    ...
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { ref: function (schedule) { return _this.scheduleObj = schedule; }, cssClass: 'schedule-resources', width: '100%', height: '650px', readonly: true, selectedDate: new Date(2021, 3, 1), eventSettings: {
