...
export class HideWeekend extends SampleBase {
    ...
    localFields = { text: 'Name', value: 'Value' };
    value = ['1', '3', '4', '5'];
    onChange() {
    ...
    render() {
        ...
        <div className='col-lg-9 control-section'>
          <div className='control-wrapper'>
            <ScheduleComponent width='100%' height='650px' ref={t => this.scheduleObj = t} workDays={[1, 3, 4, 5]} workHours={{ start: '08:00' }} selectedDate={new Date(2021, 1, 15)} eventSettings={{ dataSource: this.data }} showWeekend={false} eventRendered={this.OnEventRendered.bind(this)}>
              <ViewsDirective>
                  ...
                  <td style={{ width: '100%' }}>
                    <div className='multi-prop'>
                      <div className='workdayscheckbox' style={{ paddingBottom: '10px' }}>
                        <MultiSelectComponent id='workdayscheckbox' dataSource={this.weekDays} fields={this.localFields} mode='CheckBox' value={this.value} change={this.onMultiSelectChange.bind(this)} showDropDownIcon={true} showClearButton={false} placeholder='Working days' floatLabelType='Always'>
