...
export class EditorCustomField extends SampleBase {
    scheduleObj;
    data = extend([], dataSource.eventsData, null, true);
    onPopupOpen(args) {
        if (args.type === 'Editor') {
    ...
    render() {
        ...
        <div className='col-lg-12 control-section'>
          <div className='control-wrapper'>
            <ScheduleComponent width='100%' height='650px' selectedDate={new Date(2021, 1, 15)} ref={t => this.scheduleObj = t} eventSettings={{ dataSource: this.data }} popupOpen={this.onPopupOpen.bind(this)} eventRendered={this.onEventRendered.bind(this)}>
