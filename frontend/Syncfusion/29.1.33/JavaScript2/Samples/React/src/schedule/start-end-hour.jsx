    ...
    render() {
        ...
        <div className='col-lg-9 control-section'>
          <div className='control-wrapper'>
            <ScheduleComponent width='100%' height='650px' ref={schedule => this.scheduleObj = schedule} startHour='08:00' endHour='20:00' selectedDate={new Date(2021, 1, 15)} eventSettings={{ dataSource: this.data }} workHours={{ highlight: false }} eventRendered={this.onEventRendered.bind(this)}>
              <ViewsDirective>
                ...
                <tr style={{ height: '50px' }}>
                  <td style={{ width: '100%' }}>
                    <div className='timepicker-control-section range'>
                      <TimePickerComponent id='startTime' value={new Date(2000, 0, 1, 8)} format='HH:mm' placeholder='Start Hour' floatLabelType='Always'></TimePickerComponent>
                    </div>
                  </td>
                </tr>
                <tr style={{ height: '50px' }}>
                  <td style={{ width: '100%' }}>
                    <div className='timepicker-control-section range'>
                      <TimePickerComponent id='endTime' value={new Date(2000, 0, 1, 20)} format='HH:mm' placeholder='End Hour' floatLabelType='Always'></TimePickerComponent>
                    </div>
                  </td>
                </tr>
                <tr style={{ height: '50px' }}>
