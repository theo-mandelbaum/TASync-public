...
var AgendaView = /** @class */ (function (_super) {
    ...
    AgendaView.prototype.onVirtualChange = function (args) {
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-9 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { width: '100%', height: '650px', ref: function (schedule) { return _this.scheduleObj = schedule; }, currentView: 'Agenda', selectedDate: new Date(2021, 1, 15), eventSettings: { dataSource: (0, helper_1.generateObject)() } },
                            ...
                            React.createElement("tr", { style: { height: '50px' } },
                                React.createElement("td", { style: { width: '100%' } },
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { style: { padding: '6px' }, value: false, dataSource: this.virtualScrollOptions, fields: this.fields, change: this.onVirtualChange.bind(this), floatLabelType: 'Always', placeholder: 'Allow Virtual Scrolling' })))),
                            React.createElement("tr", { style: { height: '50px' } },
                                React.createElement("td", { style: { width: '100%' } },
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { style: { padding: '6px' }, value: true, dataSource: this.hideEmptyAgendaDaysOptions, fields: this.fields, change: this.onEmptyAgendaDaysChange.bind(this), floatLabelType: 'Always', placeholder: 'Hide Empty Days' })))),
                            React.createElement("tr", { style: { height: '50px' } },
                                React.createElement("td", { style: { width: '100%' } },
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { format: 'n0', value: 7, min: 1, max: 15, change: this.onCountChange.bind(this), floatLabelType: 'Always', placeholder: 'Days Count' })))))))),
