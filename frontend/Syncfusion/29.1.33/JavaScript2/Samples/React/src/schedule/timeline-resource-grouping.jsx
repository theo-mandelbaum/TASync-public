        ...
        return (<div className='schedule-control-section'>
                <div className='col-lg-12 control-section'>
                    <div className='control-wrapper'>
                        <ScheduleComponent cssClass='timeline-resource-grouping' width='100%' height='650px' selectedDate={new Date(2023, 0, 4)} currentView='TimelineWeek' workDays={this.workDays} eventSettings={{ dataSource: this.data }} group={{ resources: ['Projects', 'Categories'] }}>
                            <ResourcesDirective>
