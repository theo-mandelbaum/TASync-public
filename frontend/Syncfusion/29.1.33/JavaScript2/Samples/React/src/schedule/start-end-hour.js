        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-9 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { width: '100%', height: '650px', ref: function (schedule) { return _this.scheduleObj = schedule; }, startHour: '08:00', endHour: '20:00', selectedDate: new Date(2021, 1, 15), eventSettings: { dataSource: this.data }, workHours: { highlight: false }, eventRendered: this.onEventRendered.bind(this) },
                            ...
                            React.createElement("tr", { style: { height: '50px' } },
                                React.createElement("td", { style: { width: '100%' } },
                                    React.createElement("div", { className: 'timepicker-control-section range' },
                                        React.createElement(ej2_react_calendars_1.TimePickerComponent, { id: 'startTime', value: new Date(2000, 0, 1, 8), format: 'HH:mm', placeholder: 'Start Hour', floatLabelType: 'Always' })))),
                            React.createElement("tr", { style: { height: '50px' } },
                                React.createElement("td", { style: { width: '100%' } },
                                    React.createElement("div", { className: 'timepicker-control-section range' },
                                        React.createElement(ej2_react_calendars_1.TimePickerComponent, { id: 'endTime', value: new Date(2000, 0, 1, 20), format: 'HH:mm', placeholder: 'End Hour', floatLabelType: 'Always' })))),
                            React.createElement("tr", { style: { height: '50px' } },
