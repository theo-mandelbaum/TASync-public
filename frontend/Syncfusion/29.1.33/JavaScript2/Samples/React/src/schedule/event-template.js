...
var EventTemplate = /** @class */ (function (_super) {
    ...
    function EventTemplate() {
        ...
        _this.data = (0, ej2_base_1.extend)([], dataSource.webinarData, null, true);
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-12 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { cssClass: 'event-template', width: '100%', height: '550px', selectedDate: new Date(2021, 1, 15), readonly: true, startHour: '08:00', endHour: '18:00', workHours: { start: '08:00' }, eventSettings: { dataSource: this.data } },
