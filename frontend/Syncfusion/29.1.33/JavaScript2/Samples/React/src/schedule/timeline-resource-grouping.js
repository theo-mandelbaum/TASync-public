...
exports.TimelineGrouping = void 0;
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-12 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { cssClass: 'timeline-resource-grouping', width: '100%', height: '650px', selectedDate: new Date(2023, 0, 4), currentView: 'TimelineWeek', workDays: this.workDays, eventSettings: { dataSource: this.data }, group: { resources: ['Projects', 'Categories'] } },
