 ...
 */
var GroupByChild = function () {
    (0, react_1.useEffect)(function () {
        (0, sample_base_1.updateSampleSection)();
    }, []);
    var data = (0, ej2_base_1.extend)([], dataSource.resourceTeamData, null, true);
    var projectData = [
    ...
    return (React.createElement("div", { className: 'schedule-control-section' },
        React.createElement("div", { className: 'col-lg-12 control-section' },
            React.createElement("div", { className: 'control-wrapper' },
                React.createElement(ej2_react_schedule_1.ScheduleComponent, { cssClass: 'group-bychild', width: '100%', height: '650px', selectedDate: new Date(2021, 5, 5), currentView: 'WorkWeek', startHour: '09:00', endHour: '19:00', eventSettings: { dataSource: data, fields: { subject: { title: 'Summary', name: 'Subject' }, description: { title: 'Comments', name: 'Description' } } }, group: { byGroupID: false, resources: ['Projects', 'Categories'] } },
                    React.createElement(ej2_react_schedule_1.ResourcesDirective, null,
                        ...
                        React.createElement(ej2_react_schedule_1.ResourceDirective, { field: 'CategoryId', title: 'Category', name: 'Categories', allowMultiple: true, dataSource: categoryData, textField: 'text', idField: 'id', colorField: 'color' })),
