...
var Resource = /** @class */ (function (_super) {
    ...
    function Resource() {
        ...
        _this.data = (0, ej2_base_1.extend)([], dataSource.resourceSampleData, null, true);
        _this.resourceData = [
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-9 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { cssClass: 'resource', width: '100%', height: '650px', selectedDate: new Date(2021, 5, 6), ref: function (schedule) { return _this.scheduleObj = schedule; }, eventSettings: { dataSource: this.data } },
