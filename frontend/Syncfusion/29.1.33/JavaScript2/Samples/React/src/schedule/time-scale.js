...
var Timescale = /** @class */ (function (_super) {
    ...
    Timescale.prototype.minorSlotTemplate = function (props) {
        return (React.createElement("div", { style: { textAlign: 'center' } }, this.instance.formatDate(props.date, { skeleton: 'ms' }).replace(':00', '')));
    };
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-9 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { height: '550px', cssClass: 'time-scale', ref: function (schedule) { return _this.scheduleObj = schedule; }, selectedDate: new Date(2021, 0, 10), workDays: this.workDays, eventSettings: { dataSource: this.data }, currentView: 'TimelineWeek', timeScale: { enable: true, interval: 60, slotCount: 6 } },
                            ...
                            React.createElement("tr", { style: { height: '50px' } },
                                React.createElement("td", { style: { width: '100%' } },
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { style: { padding: '6px' }, value: 60, fields: this.fields, dataSource: this.intervalList, change: this.onIntervalChange.bind(this), placeholder: 'Interval (in minutes)', floatLabelType: 'Always' })))),
                            React.createElement("tr", { style: { height: '50px' } },
                                React.createElement("td", { style: { width: '100%' } },
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { style: { padding: '6px' }, value: 6, fields: this.fields, dataSource: this.slotCountList, change: this.onSlotCountChange.bind(this), placeholder: 'Slot Count', floatLabelType: 'Always' })))),
                            React.createElement("tr", { style: { height: '50px' } },
                                React.createElement("td", { style: { width: '100%' } },
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { style: { padding: '6px' }, value: 'enable', fields: this.fields, dataSource: this.timeScaleOptions, change: this.onTimeScaleChange.bind(this), placeholder: 'Gridlines', floatLabelType: 'Always' })))),
                            React.createElement("tr", { style: { height: '50px' } },
                                React.createElement("td", { style: { width: '100%' } },
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { style: { padding: '6px' }, value: false, fields: this.fields, dataSource: this.templateOptions, change: this.onTemplateChange.bind(this), placeholder: 'Apply Template', floatLabelType: 'Always' })))))))),
