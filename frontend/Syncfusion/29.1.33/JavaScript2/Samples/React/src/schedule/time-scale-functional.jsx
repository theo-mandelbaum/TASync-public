...
const Timescale = () => {
    ...
    const onSlotCountChange = (args) => {
        setTimeScale({ ...timeScale, slotCount: args.value });
        scheduleObj.current.dataBind();
    };
    const onIntervalChange = (args) => {
        setTimeScale({ ...timeScale, interval: args.value });
    };
    const onTimeScaleChange = (args) => {
        setTimeScale({ ...timeScale, enable: (args.value === 'enable') ? true : false });
        scheduleObj.current.dataBind();
    };
    const onTemplateChange = (args) => {
        setTimeScale({
            ...timeScale,
