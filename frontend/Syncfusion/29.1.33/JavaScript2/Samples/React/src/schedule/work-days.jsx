    ...
    render() {
        ...
        <div className='col-lg-9 control-section'>
          <div className='control-wrapper'>
            <ScheduleComponent width='100%' height='650px' ref={schedule => this.scheduleObj = schedule} workHours={{ start: '08:00' }} currentView='WorkWeek' selectedDate={new Date(2021, 1, 15)} eventSettings={{ dataSource: this.data }} workDays={this.workDays} eventRendered={this.onEventRendered.bind(this)}>
              <ViewsDirective>
            ...
            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
              <tbody>
                <tr style={{ height: '50px' }}>
                  <td style={{ width: '100%' }}>
                    <div>
                      <DropDownListComponent style={{ padding: '6px' }} value={'1,3,5'} dataSource={this.workDaysOptions} fields={this.fields} change={this.onWorkDaysChange.bind(this)} popupWidth='180px' placeholder='Work days' floatLabelType='Always'>
                ...
                <tr style={{ height: '50px' }}>
                  <td style={{ width: '100%' }}>
                    <div>
                      <DropDownListComponent style={{ padding: '6px' }} value={0} dataSource={this.dayOfWeekOptions} fields={this.fields} change={this.onDayOfWeekChange.bind(this)} placeholder='First day of week' floatLabelType='Always'>
                      </DropDownListComponent>
                    </div>
                  </td>
                </tr>
