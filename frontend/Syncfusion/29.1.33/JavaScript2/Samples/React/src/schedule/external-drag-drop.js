...
exports.ExternalDragDrop = void 0;
...
var ExternalDragDrop = /** @class */ (function (_super) {
    ...
    function ExternalDragDrop() {
        ...
        _this.data = (0, ej2_base_1.extend)([], dataSource.hospitalData, null, true);
    ...
    ExternalDragDrop.prototype.onItemSelecting = function (args) {
        args.cancel = true;
    };
    ExternalDragDrop.prototype.onTreeDrag = function (event) {
    ...
    ExternalDragDrop.prototype.onTreeDragStart = function () {
            ...
            React.createElement("div", { className: 'col-lg-12 control-section' },
                React.createElement("div", { className: 'control-wrapper drag-sample-wrapper' },
                    React.createElement("div", { className: "schedule-container" },
                        ...
                        React.createElement(ej2_react_schedule_1.ScheduleComponent, { ref: function (schedule) { return _this.scheduleObj = schedule; }, cssClass: 'schedule-drag-drop', width: '100%', height: '650px', selectedDate: new Date(2021, 7, 2), currentView: 'TimelineDay', resourceHeaderTemplate: this.resourceHeaderTemplate.bind(this), eventSettings: {
