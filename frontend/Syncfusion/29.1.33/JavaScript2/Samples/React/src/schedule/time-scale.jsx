    ...
    render() {
        ...
        <div className='col-lg-9 control-section'>
          <div className='control-wrapper'>
            <ScheduleComponent height='550px' cssClass='time-scale' ref={schedule => this.scheduleObj = schedule} selectedDate={new Date(2021, 0, 10)} workDays={this.workDays} eventSettings={{ dataSource: this.data }} currentView='TimelineWeek' timeScale={{ enable: true, interval: 60, slotCount: 6 }}>
              <ViewsDirective>
            ...
            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
              <tbody>
                <tr style={{ height: '50px' }}>
                  <td style={{ width: '100%' }}>
                    <div>
                      <DropDownListComponent style={{ padding: '6px' }} value={60} fields={this.fields} dataSource={this.intervalList} change={this.onIntervalChange.bind(this)} placeholder='Interval (in minutes)' floatLabelType='Always'>
                ...
                <tr style={{ height: '50px' }}>
                  <td style={{ width: '100%' }}>
                    <div>
                      <DropDownListComponent style={{ padding: '6px' }} value={6} fields={this.fields} dataSource={this.slotCountList} change={this.onSlotCountChange.bind(this)} placeholder='Slot Count' floatLabelType='Always'>
                      </DropDownListComponent>
                    </div>
                  </td>
                </tr>
                <tr style={{ height: '50px' }}>
                  <td style={{ width: '100%' }}>
                    <div>
                      <DropDownListComponent style={{ padding: '6px' }} value={'enable'} fields={this.fields} dataSource={this.timeScaleOptions} change={this.onTimeScaleChange.bind(this)} placeholder='Gridlines' floatLabelType='Always'>
                      </DropDownListComponent>
                    </div>
                  </td>
                </tr>
                <tr style={{ height: '50px' }}>
                  <td style={{ width: '100%' }}>
                    <div>
                      <DropDownListComponent style={{ padding: '6px' }} value={false} fields={this.fields} dataSource={this.templateOptions} change={this.onTemplateChange.bind(this)} placeholder='Apply Template' floatLabelType='Always'></DropDownListComponent>
                    </div>
                  </td>
                </tr>
              </tbody>
