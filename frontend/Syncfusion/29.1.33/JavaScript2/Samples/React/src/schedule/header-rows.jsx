...
import { ScheduleComponent, ViewsDirective, ViewDirective, TimelineMonth, getWeekNumber, Inject, HeaderRowDirective, HeaderRowsDirective, Resize, DragAndDrop, getWeekLastDate } from '@syncfusion/ej2-react-schedule';
...
export class HeaderRows extends SampleBase {
    data = extend([], dataSource.headerRowData, null, true);
    scheduleObj;
        ...
        return (<div className='schedule-control-section'>
                <div className='col-lg-12 control-section'>
                    <div className='control-wrapper'>
                        <ScheduleComponent ref={schedule => this.scheduleObj = schedule} width='100%' height='650px' selectedDate={new Date(2021, 0, 1)} eventSettings={{ dataSource: this.data }} eventRendered={this.onEventRendered.bind(this)}>
                            <HeaderRowsDirective>
