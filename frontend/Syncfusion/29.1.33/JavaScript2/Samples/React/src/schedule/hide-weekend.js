        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-9 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { width: '100%', height: '650px', ref: function (t) { return _this.scheduleObj = t; }, workDays: [1, 3, 4, 5], workHours: { start: '08:00' }, selectedDate: new Date(2021, 1, 15), eventSettings: { dataSource: this.data }, showWeekend: false, eventRendered: this.OnEventRendered.bind(this) },
                                ...
                                React.createElement("td", { style: { width: '100%' } },
                                    React.createElement("div", { className: 'multi-prop' },
                                        React.createElement("div", { className: 'workdayscheckbox', style: { paddingBottom: '10px' } },
                                            React.createElement(ej2_react_dropdowns_1.MultiSelectComponent, { id: 'workdayscheckbox', dataSource: this.weekDays, fields: this.localFields, mode: 'CheckBox', value: this.value, change: this.onMultiSelectChange.bind(this), showDropDownIcon: true, showClearButton: false, placeholder: 'Working days', floatLabelType: 'Always' }))))),
                            React.createElement("tr", { style: { height: '50px' } },
                                React.createElement("td", { style: { width: '100%' } },
