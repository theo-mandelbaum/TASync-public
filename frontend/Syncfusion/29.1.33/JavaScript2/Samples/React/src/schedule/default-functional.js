...
var Default = function () {
    ...
    var _a = (0, react_1.useState)(new Date(2021, 0, 10)), scheduleData = _a[0], setScheduleData = _a[1];
    ...
    return (React.createElement("div", { className: 'schedule-control-section' },
        React.createElement("div", { className: 'col-lg-9 control-section' },
            React.createElement("div", { className: 'control-wrapper' },
                React.createElement(ej2_react_schedule_1.ScheduleComponent, { height: '650px', ref: scheduleObj, selectedDate: scheduleData, eventSettings: { dataSource: data }, dragStart: (onDragStart) },
                        ...
                        React.createElement("tr", { style: { height: '50px' } },
                            React.createElement("td", { style: { width: '100%' } },
                                React.createElement("div", { className: 'datepicker-control-section' },
                                    React.createElement(ej2_react_calendars_1.DatePickerComponent, { value: scheduleData, showClearButton: false, change: change, placeholder: 'Current Date', floatLabelType: 'Always' })))))))),
