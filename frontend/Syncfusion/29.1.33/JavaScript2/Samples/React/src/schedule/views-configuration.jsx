    ...
    render() {
        ...
        <div className='col-lg-12 control-section'>
          <div className='control-wrapper'>
            <ScheduleComponent cssClass='schedule-views-config' width='100%' height='650px' ref={t => this.scheduleObj = t} currentView='Month' selectedDate={new Date(2021, 5, 20)} eventSettings={{ dataSource: this.data, fields: { location: { name: 'City' } } }}>
              <ResourcesDirective>
