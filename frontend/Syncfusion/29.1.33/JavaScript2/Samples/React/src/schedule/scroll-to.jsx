    ...
    render() {
        ...
        <div className='col-lg-9 control-section'>
          <div className='control-wrapper'>
            <ScheduleComponent width='100%' height='650px' ref={schedule => this.scheduleObj = schedule} selectedDate={new Date(2021, 0, 10)} eventSettings={{ dataSource: this.data }} eventRendered={this.onEventRendered.bind(this)}>
              <ViewsDirective>
            ...
            <table id='property' title='Properties' className='property-panel-table' style={{ width: '100%' }}>
              <tbody>
                <tr style={{ height: '50px' }}>
                  <td style={{ width: '100%' }}>
                    <div>
                      <TimePickerComponent value={new Date(2000, 0, 1, 9)} format='HH:mm' change={this.onChange.bind(this)} placeholder='Scroll To' floatLabelType='Always'>
                      </TimePickerComponent>
                    </div>
                  </td>
                </tr>
