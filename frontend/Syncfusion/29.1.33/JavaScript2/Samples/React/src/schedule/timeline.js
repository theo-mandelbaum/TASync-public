...
var TimelineView = /** @class */ (function (_super) {
    ...
    function TimelineView() {
        ...
        _this.data = (0, ej2_base_1.extend)([], dataSource.scheduleData.concat(dataSource.timelineData), null, true);
        return _this;
    }
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-9 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { height: '650px', ref: function (schedule) { return _this.scheduleObj = schedule; }, selectedDate: new Date(2021, 0, 10), workDays: this.workDays, eventSettings: { dataSource: this.data } },
                            ...
                            React.createElement("tr", { style: { height: '50px' } },
                                React.createElement("td", { style: { width: '100%' } },
                                    React.createElement("div", { className: 'datepicker-control-section' },
                                        React.createElement(ej2_react_calendars_1.DatePickerComponent, { value: new Date(2021, 0, 10), showClearButton: false, change: this.change.bind(this), placeholder: 'Current Date', floatLabelType: 'Always' })))))))),
