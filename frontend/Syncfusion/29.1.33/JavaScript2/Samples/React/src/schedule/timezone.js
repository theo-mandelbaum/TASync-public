...
var TimeZone = /** @class */ (function (_super) {
    ...
    function TimeZone() {
        ...
        _this.fifaEvents = (0, ej2_base_1.extend)([], (dataSource.fifaEventsData), null, true);
    ...
    TimeZone.prototype.componentDidMount = function () {
                            ...
                            React.createElement("tr", { style: { height: '50px' } },
                                ...
                                React.createElement("td", { style: { width: '70%' } },
                                    React.createElement("div", null,
                                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { style: { padding: '6px' }, value: 'UTC', popupWidth: 'auto', fields: this.fields, dataSource: this.timeZoneOptions, change: this.onTimeZoneChange.bind(this), floatLabelType: 'Always', width: '250' })))))),
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { width: '100%', height: '650px', ref: function (schedule) { return _this.scheduleObj = schedule; }, selectedDate: new Date(2021, 5, 20), timezone: 'UTC', workHours: { start: '11:00' }, eventSettings: { dataSource: this.fifaEvents }, eventRendered: this.onEventRendered.bind(this) },
