...
export class Resources extends SampleBase {
    ...
    generateEvents(scheduleObj) {
        ...
        this.dManager = extend([], collections, null, true);
        let filteredCollection = this.filterByFare(collections, scheduleObj);
        ...
        return (<div className='schedule-control-section'>
                <div className='col-lg-9 control-section'>
                    <div className='control-wrapper'>
                        ...
                        <ScheduleComponent ref={schedule => this.scheduleObj = schedule} cssClass='schedule-resources' width='100%' height='650px' readonly={true} selectedDate={new Date(2021, 3, 1)} eventSettings={{
