...
var BlockEvents = /** @class */ (function (_super) {
    ...
    function BlockEvents() {
        ...
        _this.data = (0, ej2_base_1.extend)([], dataSource.blockData, null, true);
        _this.employeeData = [
            ...
            React.createElement("div", { className: 'col-lg-12 control-section' },
                React.createElement("div", { className: 'control-wrapper drag-sample-wrapper' },
                    React.createElement("div", { className: "schedule-container" },
                        React.createElement(ej2_react_schedule_1.ScheduleComponent, { cssClass: 'block-events', width: '100%', height: '650px', selectedDate: new Date(2021, 7, 2), currentView: 'TimelineDay', resourceHeaderTemplate: this.resourceHeaderTemplate.bind(this), eventSettings: { dataSource: this.data }, group: { enableCompactView: false, resources: ['Employee'] } },
