...
exports.RecurrenceEvents = void 0;
...
var RecurrenceEvents = /** @class */ (function (_super) {
    ...
    function RecurrenceEvents() {
        ...
        _this.data = (0, ej2_base_1.extend)([], dataSource.recurrenceData, null, true);
        return _this;
    }
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-9 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { width: '100%', height: '650px', selectedDate: new Date(2021, 1, 20), ref: function (t) { return _this.scheduleObj = t; }, eventSettings: { dataSource: this.data }, eventRendered: this.onEventRendered.bind(this) },
