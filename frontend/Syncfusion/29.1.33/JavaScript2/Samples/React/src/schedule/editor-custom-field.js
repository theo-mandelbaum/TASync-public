...
exports.EditorCustomField = void 0;
...
var EditorCustomField = /** @class */ (function (_super) {
    ...
    function EditorCustomField() {
        ...
        _this.data = (0, ej2_base_1.extend)([], dataSource.eventsData, null, true);
        return _this;
    }
        ...
        return (React.createElement("div", { className: 'schedule-control-section' },
            React.createElement("div", { className: 'col-lg-12 control-section' },
                React.createElement("div", { className: 'control-wrapper' },
                    React.createElement(ej2_react_schedule_1.ScheduleComponent, { width: '100%', height: '650px', selectedDate: new Date(2021, 1, 15), ref: function (t) { return _this.scheduleObj = t; }, eventSettings: { dataSource: this.data }, popupOpen: this.onPopupOpen.bind(this), eventRendered: this.onEventRendered.bind(this) },
