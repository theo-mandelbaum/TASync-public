                ...
                <div className="col-xs-10 left">
                  <form id="form1" method="post">
                    <div id='barcodevaluediv'>
                      <TextBoxComponent ref={value => (barcodeValueInstance = value)} value='01234567' id='textbox_0' change={valueOnChange}/>
                    </div>
                  </form>
                </div>
              </div>
        ...
        id="width" width={100} enabled={true} format={"###.##"} value={150} step={2} min={100} max={200} change={barcodeheightChange}/>
          ...
          <div className="row sb-child-row">
            ...
            <div className="col-xs-9">
              ...
              <TextBoxComponent ref={value => (barcodetextInstance = value)} value='01234567' change={textOnChange}/>
            </div>
          </div>
          <div className="row sb-child-row">
