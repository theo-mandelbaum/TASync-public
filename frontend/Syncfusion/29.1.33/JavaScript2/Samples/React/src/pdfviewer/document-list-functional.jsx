...
function DocumentList() {
    ...
    let mode;
    const commands = [{ type: 'View', buttonOption: { cssClass: 'e-icons e-eye e-flat', title: 'View' } },
      ...
      <div id="targetElement" className="control-section col-lg-12 defaultDialogComponent dialog-target">
        <div className="flex-container">
          ...
          <GridComponent ref={gridInstance} dataSource={gridData} commandClick={buttonClick} destroyed={destroyed}>
            <ColumnsDirective>
              <ColumnDirective headerText='File Name' headerTextAlign='Left' template={(props) => (<div className="file-name-container">
