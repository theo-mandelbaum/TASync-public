    ...
    function Default() {
        ...
        _this.documentLoaded = function () {
            if (_this.isInitialLoading) {
                _this.viewer.isPageOrganizerOpen = true;
                _this.isInitialLoading = false;
            }
            else {
                _this.viewer.isPageOrganizerOpen = false;
            }
        };
    ...
    Default.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: 'control-section' },
                ...
                React.createElement(ej2_react_pdfviewer_1.PdfViewerComponent, { ref: function (scope) { _this.viewer = scope; }, id: "container", documentPath: "https://cdn.syncfusion.com/content/pdf/pdf-succinctly.pdf", resourceUrl: "https://cdn.syncfusion.com/ej2/23.2.6/dist/ej2-pdfviewer-lib", documentLoad: this.documentLoaded, style: { 'height': '640px' } },
