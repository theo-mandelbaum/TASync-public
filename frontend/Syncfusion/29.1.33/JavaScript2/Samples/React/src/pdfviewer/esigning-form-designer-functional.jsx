...
function ESignFormDesigner() {
    ...
    let sidebarobj = React.useRef(null);
    let textBtn = React.useRef(null);
    let signatureBtn = React.useRef(null);
    let passwordBtn = React.useRef(null);
    let checkBoxBtn = React.useRef(null);
    let radioBtn = React.useRef(null);
    let dropdownBtn = React.useRef(null);
    let listBoxBtn = React.useRef(null);
    let initialBtn = React.useRef(null);
    let currentUserColorId = 'ff0000';
    let currentUser = React.useRef('andrew@mycompany.com');
    let borderColor = React.useRef('1px solid red');
    let isDropped = false;
    let currentFieldType = "";
    let fieldType = "";
    let userColor = 'rgba(255, 0, 0, 0.06)';
    let defaultFieldWidth = 200;
    let defaultFieldHeight = 24;
    let checkBoxFieldSize = 20;
    let radioFieldSize = 20;
    let SignatureFieldSize = 66;
    let ListFieldSize = 66;
    let zoomFactor;
    let isMobile = Browser.isDevice;
    let defaultZoomFactor;
    let userDetails = [
