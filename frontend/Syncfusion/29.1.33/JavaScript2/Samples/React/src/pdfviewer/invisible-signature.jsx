...
import { PdfViewerComponent, FormDesigner, FormFields, Magnification, Navigation, LinkAnnotation, BookmarkView, ThumbnailView, Print, Annotation, TextSearch, PageOrganizer, Inject } from '@syncfusion/ej2-react-pdfviewer';
