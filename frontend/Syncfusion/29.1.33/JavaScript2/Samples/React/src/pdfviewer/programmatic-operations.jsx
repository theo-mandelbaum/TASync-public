...
import { PdfViewerComponent, Toolbar, Magnification, Navigation, LinkAnnotation, BookmarkView, ThumbnailView, Print, TextSelection, TextSearch, Annotation, FormFields, FormDesigner, PageOrganizer, Inject, DynamicStampItem, SignStampItem, StandardBusinessStampItem, AllowedInteraction } from '@syncfusion/ej2-react-pdfviewer';
...
class ProgrammaticOperations extends SampleBase {
    constructor(props) {
        super(props);
    ...
    vertexTableNumberFormat = NumberFormat.numberFormatter(undefined, { maximumFractionDigits: 0 }, undefined);
    ...
    intractionsListfield = { dataSource: this.intractionsList, value: 'Value', text: 'Type' };
    annotationsList = [
    ...
    annotationListFields = { text: 'Text', value: 'className' };
    ...
    render() {
      ...
      <div className="col-lg-3 e-pv-property-section-pdfviewer e-pv-main-panel">
        <div className="property-panel-header header-panel">
          Properties
          <button id="e-pv-refresh-button-icon" className="e-btn e-bigger e-lib e-flat e-icon-btn" value='' onClick={this.Reset}>
        ...
        <div className="e-pv-property-panel-content">
          ...
          <div className="e-pv-input-item">
            <DropDownListComponent dataSource={this.annotationsList} value={this.state.annotationType} change={(e) => this.onAnnotationChange(e)} fields={this.annotationListFields} enabled={this.state.showAnnotationList}/>
          </div>
          <div className="e-pv-annot-inner-container" hidden={!this.state.showStampType}>
            ...
            <div className="e-pv-input-item">
              <DropDownListComponent dataSource={this.stampTypeDataList} fields={this.stampTypeDatafields} value={this.state.stampType} change={(e) => { this.onStampTypeChange(e); this.onpropertiesvaluechanges("stampType", e); }}/>
            </div>
            <div className="e-pv-pdfviewer-input-title"><span>Comments</span></div>
            <div className="e-pv-input-item">
              <DropDownListComponent dataSource={this.currentCommentsList} fields={this.stampCommentsTypeDatafields} value={this.state.stampComment} change={(e) => this.onpropertiesvaluechanges('stampComment', e)}/>
            </div>
          </div>
          <div className="e-pv-pdfviewer-input-title" id='e-pv-customStamp' hidden={this.state.showFileUploader}>
            <UploaderComponent ref={(scope) => { this.dropImageElement; this.uploaderObj = scope; }} asyncSettings={this.pdfviewerApiPath} dropArea={this.dropImageElement} removing={this.onFileRemove} success={this.onFileSuccess}/>
          </div>
          <div className="e-pv-pdfviewer-input-title"><span>Page Number</span></div>
          <div className="e-pv-input-item">
            <NumericTextBoxComponent id="e-pv-pdfViewer-pagenumber-annotation" format="n0" value={this.state.pageNumber} change={(e) => this.onpropertiesvaluechanges('pageNumber', e)} min={1} max={this.state.pageCount} enabled={this.state.showPageNumber}/>
          </div>
          ...
          <div className="e-pv-annot-inner-container" style={{ padding: '0 0 12px 0' }}>
                  ...
                  <td>
                    <div>
                      <div className="e-pv-pdfviewer-text-content">
                        ...
                        <div className="e-pv-input-item">
                          <NumericTextBoxComponent value={this.state.x} min={0} format='###.##' showSpinButton={false} change={(e) => this.onpropertiesvaluechanges('x', e)}/>
                        </div>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div>
                      <div className="e-pv-pdfviewer-text-content">
                        ...
                        <div className="e-pv-input-item">
                          <NumericTextBoxComponent value={this.state.y} min={0} format='###.##' showSpinButton={false} change={(e) => this.onpropertiesvaluechanges('y', e)}/>
                        </div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td>
                    <div>
                      <div className="e-pv-pdfviewer-text-content">
                        <span>Width</span>
                        <div className="e-pv-input-item">
                          <NumericTextBoxComponent value={this.state.width} min={0} format='###.##' showSpinButton={false} change={(e) => this.onpropertiesvaluechanges('width', e)}/>
                        </div>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div>
                      <div className="e-pv-pdfviewer-text-content">
                        <span>Height</span>
                        <div className="e-pv-input-item">
                          <NumericTextBoxComponent value={this.state.height} min={0} format='###.##' showSpinButton={false} change={(e) => this.onpropertiesvaluechanges('height', e)}/>
                        </div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td>
                    <div>
                      <div className="e-pv-pdfviewer-text-content">
                        ...
                        <div className="e-pv-input-item">
                          <NumericTextBoxComponent value={this.state.x1} min={0} format='###.##' showSpinButton={false} change={(e) => this.onpropertiesvaluechanges('vertexX1', e)}/>
                        </div>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div>
                      <div className="e-pv-pdfviewer-text-content">
                        ...
                        <div className="e-pv-input-item">
                          <NumericTextBoxComponent value={this.state.y1} min={0} format='###.##' showSpinButton={false} change={(e) => this.onpropertiesvaluechanges('vertexY1', e)}/>
                        </div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td>
                    <div>
                      <div className="e-pv-pdfviewer-text-content">
                        ...
                        <div className="e-pv-input-item">
                          <NumericTextBoxComponent value={this.state.x2} min={0} format='###.##' showSpinButton={false} change={(e) => this.onpropertiesvaluechanges('vertexX2', e)}/>
                        </div>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div>
                      <div className="e-pv-pdfviewer-text-content">
                        ...
                        <div className="e-pv-input-item">
                          <NumericTextBoxComponent value={this.state.y2} min={0} format='###.##' showSpinButton={false} change={(e) => this.onpropertiesvaluechanges('vertexY2', e)}/></div>
                      </div>
                    </div>
                  </td>
                </tr>
                  ...
                  <td>
                    <div>
                      <div className="e-pv-pdfviewer-text-content">
                        ...
                        <div className="e-pv-input-item">
                          <NumericTextBoxComponent value={this.state.opacity} format='n0' showSpinButton={false} min={0} max={100} change={(e) => this.onpropertiesvaluechanges('opacity', e)}/>
                        </div>
                      </div>
                    </div>
                  </td>
                  <td hidden={!this.state.showFillColor}>
                    <div>
                      <div className="e-pv-pdfviewer-text-content">
                        ...
                        <div className="e-pv-input-item">
                          <ColorPickerComponent value={this.state.fillColor ?? "#FFFFFF00"} change={(e) => this.onpropertiesvaluechanges('fillColor', e)} mode='Palette'/>
                        </div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td>
                    <div>
                      <div className="e-pv-pdfviewer-text-content">
                        ...
                        <div className="e-pv-input-item">
                          <NumericTextBoxComponent value={this.state.strokeThickness} min={0} max={12} format='n0' showSpinButton={false} change={(e) => this.onpropertiesvaluechanges('thickness', e)}/>
                        </div>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div>
                      <div className="e-pv-pdfviewer-text-content">
                        ...
                        <div className="e-pv-input-item">
                          <ColorPickerComponent value={this.state.strokeColor} change={(e) => this.onpropertiesvaluechanges('strokeColor', e)} mode='Palette'/>
                        </div>
                      </div>
                    </div>
                  </td>
            ...
            <table className="e-pv-annot-inner-table e-pv-annot-bounds-list" style={{ borderCollapse: "collapse" }}>
              ...
              <table className="e-pv-annot-inner-table e-pv-pdfViewer-coordinate-table" style={{ borderCollapse: "collapse" }}>
                ...
                (this.state.vertexPoints.map((item, index) => {
                    return (<tr key={item.id}>
                        {index % 2 === 0 ? (<>
                            <td>
                              <div className="e-pv-table-items">
                            ...
                            {index + 1 < this.state.vertexPoints.length ? (<td>
                                <div className="e-pv-table-items">
            ...
            <div hidden={!this.state.showBoundsButtons}>
              <div className="e-pv-annot-button-section" style={{ padding: '12px 12px 0 0', border: 0 }}>
                <ButtonComponent isPrimary={true} style={{ textTransform: 'capitalize' }} onClick={this.OnBoundsDelete} disabled={this.state.isDeleteBoundsDisabled}>
                  Delete
                </ButtonComponent>
                <ButtonComponent isPrimary={true} style={{ textTransform: 'capitalize' }} onClick={() => { this.addBounds(); this.onpropertiesvaluechanges("", { isInteracted: true }); }}>
                  Add Bounds
                </ButtonComponent>
              </div>
            </div>
            <div id='e-pv-lineistrue' hidden={!this.state.showLineProps} style={{ padding: '0px 12px 12px 12px' }}>
              ...
              <div className="e-pv-input-item">
                <DropDownListComponent dataSource={this.lineHeadstatusList} fields={this.lineHeadstatusfield} value={this.state.lineHeadStartStyle} change={(e) => this.onpropertiesvaluechanges('lineHeadStartStyle', e)}/>
              </div>
              <div className="e-pv-pdfviewer-input-title"><span>Line Head End</span></div>
              <div className="e-pv-input-item">
                <DropDownListComponent dataSource={this.lineHeadstatusList} fields={this.lineHeadstatusfield} value={this.state.lineHeadEndStyle} change={(e) => this.onpropertiesvaluechanges('lineHeadEndStyle', e)}/>
              </div>
              <div id='e-pv-distanceistrue' hidden={!this.state.showLeaderLength}>
                ...
                <div className="e-pv-input-item">
                  <NumericTextBoxComponent value={this.state.leaderLength} format='###.##' showSpinButton={false} change={(e) => this.onpropertiesvaluechanges('leaderLength', e)}/>
                </div>
              </div>
              <div hidden={!this.state.showVertexButtons}>
                <div className="e-pv-annot-button-section" style={{ padding: '12px 12px 0 0', border: 0 }}>
                  <ButtonComponent isPrimary={true} style={{ textTransform: 'capitalize' }} onClick={this.onDeleteVertex} disabled={this.state.isDeleteVertexDisabled}>
                    Delete
                  </ButtonComponent>
                  <ButtonComponent isPrimary={true} style={{ textTransform: 'capitalize' }} onClick={() => { this.addVertex(); this.onpropertiesvaluechanges("", { isInteracted: true }); }}>
                    Add Vertex
                  </ButtonComponent>
                </div>
              </div>
        ...
        <div hidden={!this.state.showInkAnnotationType}>
          <div style={{ padding: '0 0 12px 0' }}>
            ...
            <div className="e-pv-input-item">
              <DropDownListComponent dataSource={this.inkAnnotationDataList} fields={this.inkAnnotationfield} value={this.state.inkAnnotationType} change={(e) => this.onpropertiesvaluechanges('inkAnnotationType', e)} enabled={!this.state.disableInkAnnotField}/>
            </div>
          </div>
        </div>
        ...
        <div id='e-pv-textistrue' className="e-pv-annot-inner-container" hidden={!this.state.showFreeTextProps}>
          ...
          <div className="e-pv-annot-inner-container">
            ...
            <div className="e-pv-input-item">
              <TextBoxComponent value={this.state.defaultText} change={(e) => this.onpropertiesvaluechanges('defaultText', e)}/>
            </div>
            <div className="e-pv-pdfviewer-input-title"><span>Font Family</span></div>
            <div className="e-pv-input-item">
              <DropDownListComponent dataSource={this.freeTextFontFamilyList} fields={this.freetextFontFamilyFields} value={this.state.fontFamily} change={(e) => this.onpropertiesvaluechanges('fontFamily', e)}/>
            </div>
            <div className="e-pv-pdfviewer-input-title"><span>Alignment</span></div>
            <div className="e-pv-input-item">
              <DropDownListComponent dataSource={this.freeTextAlignmentList} fields={this.freeTextAlignmentField} value={this.state.alignment} change={(e) => this.onpropertiesvaluechanges('alignment', e)}/>
            </div>
            <div className="e-pv-pdfviewer-input-title"><span>Font Style</span></div>
            <div className="e-pv-input-item">
              <DropDownListComponent dataSource={this.freeTextFontStyleList} fields={this.freeTextFontStyleFields} value={this.state.fontStyle} change={(e) => this.onpropertiesvaluechanges('fontStyle', e)}/>
            </div>
                ...
                <tbody>
                  <tr>
                    <td style={{ width: '50%', padding: '0' }}>
                      <span>Font Size</span>
                      <div className="e-pv-input-item">
                        <NumericTextBoxComponent value={this.state.fontSize} format='n0' showSpinButton={false} change={(e) => this.onpropertiesvaluechanges('fontSize', e)}/>
                      </div>
                    </td>
                    <td style={{ padding: '0' }}>
                      <div style={{ marginLeft: '12px' }} className="e-pv-text-content">
                        ...
                        <div className="e-pv-input-item">
                          <ColorPickerComponent value={this.state.fontColor} mode="Palette" change={(e) => this.onpropertiesvaluechanges('fontColor', e)}/>
                        </div>
                      </div>
                    </td>
                  </tr>
            ...
            <tbody>
              <tr>
                <td className="e-pv-check-box-row">
                  <CheckBoxComponent checked={this.state.printAnnotation} change={(e) => { this.onPrintCheckBoxChange(e); this.onpropertiesvaluechanges("", { isInteracted: true }); }}/>
                </td>
                <td className="e-pv-check-box-row"><span>Print Annotation</span></td>
              </tr>
              <tr>
                <td className="e-pv-check-box-row">
                  <CheckBoxComponent checked={this.state.lockAnnotation} change={(e) => { this.onCheckboxChangeIntractionBox(e); this.onpropertiesvaluechanges("", { isInteracted: true }); }}/>
                </td>
        ...
        <div id='e-pv-allowInteraction' hidden={!this.state.lockAnnotation}>
          ...
          <div className="e-pv-input-item">
            <DropDownTreeComponent fields={this.intractionsListfield} showCheckBox={true} value={this.state.allowedInteractions} change={(e) => { this.onInteractionValueChange(e); this.onpropertiesvaluechanges("", { isInteracted: true }); }}/>
          </div>
        </div>
        ...
        <div className="e-pv-input-item">
          <TextBoxComponent placeholder="Enter text" value={this.state.author} change={(e) => this.onpropertiesvaluechanges('author', e)}/>
        </div>
        <div className="e-pv-pdfviewer-input-title"><span>Content</span></div>
        <div className="e-pv-input-item">
          <TextBoxComponent value={this.state.comment} change={(e) => this.onpropertiesvaluechanges('comment', e)} placeholder='New Comment'/>
        </div>
        <div className="e-pv-pdfviewer-input-title"><span>Status</span></div>
        <div className="e-pv-input-item">
          <DropDownListComponent dataSource={this.commentStatusList} fields={this.commentStatusListfields} value={this.state.commentState} change={(e) => this.onpropertiesvaluechanges('setState', e)}/>
        </div>
        <div className="e-pv-pdfviewer-input-title">
          <table>
            <tbody>
              <tr>
                <td className="e-pv-check-box-row">
                  <CheckBoxComponent checked={this.state.isReplyBoxChecked} change={(e) => { this.onCheckboxChangeReplyBox(e); this.onpropertiesvaluechanges("", { isInteracted: true }); }}/>
                </td>
        ...
        <div hidden={!this.state.isReplyBoxChecked}>
          ...
          <div className="e-pv-annot-inner-container replies">
            {this.state.replies.map((comment) => (<div className="e-pv-reply-container" id={comment.id} key={comment.id}>
                ...
                }} onMouseDown={() => { this.getCommentID(comment.id); }} style={{ padding: "5px 4px" }}>
                    <span className="e-icons e-more-vertical-1 e-btn-icon"></span>
                  </button>
                </div>
              </div>))}
          </div>
          <ContextMenuComponent ref={(scope) => { this.contextMenu = scope; }} items={this.selectedAnnotation.replyMenuItems} select={(event) => { this.contextMenuItemSelected(event); }}></ContextMenuComponent>
        </div>
        ...
        <div className="e-pv-annot-inner-container e-pv-pdfViewer-checked-Content" id='e-pv-replyBox' style={{ padding: '10px' }} hidden={!this.state.isReplyBoxChecked}>
          <div className="e-pv-pdfviewer-input-title"><span>Author</span></div>
          <div className="e-pv-input-item">
            <TextBoxComponent placeholder="Enter text" value={this.state.replyAuthor} change={(e) => this.onpropertiesvaluechanges('replyAuthor', e)}/>
          </div>
          <div className="e-pv-pdfviewer-input-title"><span>Content</span></div>
          <div className="e-pv-input-item">
            <TextBoxComponent value={this.state.replyComment} change={(e) => this.onpropertiesvaluechanges('replyComment', e)} placeholder='Reply Comment'/>
          </div>
          <div className="e-pv-pdfviewer-input-title"><span>Status</span></div>
          <div className="e-pv-input-item">
            <DropDownListComponent id='' dataSource={this.commentStatusList} fields={this.commentStatusListfields} value={this.state.replyState} change={(e) => this.onpropertiesvaluechanges('replyState', e)}/>
          </div>
    ...
    addVertex() {
        let newVertex = { x: this.selectedAnnotation.x, y: this.selectedAnnotation.y, id: this.generateUniqueId() };
    ...
    ;
    onInteractionValueChange(event) {
        if (isNullOrUndefined(this.selectedAnnotation.allowedInteractions) || (this.selectedAnnotation.allowedInteractions.length === 0)) {
            ...
            this.selectedAnnotation.allowedInteractions = (event.value ?? [AllowedInteraction.Select, AllowedInteraction.Resize]);
        }
        this.setState({
            allowedInteractions: [...this.selectedAnnotation.allowedInteractions]
        });
    ...
    annotationSettings = () => ({
        ...
        lineHeadEndStyle: this.viewer.annotation.getArrowString(this.selectedAnnotation.lineHeadEndStyle),
        lineHeadStartStyle: this.viewer.annotation.getArrowString(this.selectedAnnotation.lineHeadStartStyle),
        leaderLength: this.selectedAnnotation.leaderLength,
        inkAnnotationType: this.selectedAnnotation.inkAnnotationType,
        ...
        if (this.selectedAnnotation.annotationType === "Highlight") {
            ...
            if (this.selectedAnnotation.stampType === 'Dynamic') {
                if (this.selectedAnnotation.dynamicStamps) {
                    const selectedStampItem = this.selectedAnnotation.dynamicStamps.find((stamp) => stamp === this.selectedAnnotation.stampComment);
                ...
                if (this.selectedAnnotation.signStamps) {
                    const selectedStampItem = this.selectedAnnotation.signStamps.find((stamp) => stamp === this.selectedAnnotation.stampComment);
                    if (selectedStampItem) {
                ...
                if (this.selectedAnnotation.signStamps) {
                    const selectedStampItem = this.selectedAnnotation.standardBusinessStamps.find((stamp) => stamp === this.selectedAnnotation.stampComment);
                    if (selectedStampItem) {
    ...
    updateProperties(currentannotation) {
        ...
        if (currentannotation.textMarkupAnnotationType === "Highlight" || currentannotation.textMarkupAnnotationType === "Underline" || currentannotation.textMarkupAnnotationType === "Strikethrough") {
            ...
            if (currentannotation.vertexPoints) {
                this.selectedAnnotation.vertexPoints = this.addUniqueId([...currentannotation.vertexPoints]);
            }
    ...
    onAnnotationMoved(annotationMoveEventArgs) {
        this.selectedAnnotation.annotationSelected = true;
    ...
    onAnnotationResized(annotationResizeEventArgs) {
        this.selectedAnnotation.annotationSelected = true;
    ...
    updatePropertiesInUI() {
        ...
        this.setState({
            ...
            vertexPoints: (this.selectedAnnotation.vertexPoints ? [...this.selectedAnnotation.vertexPoints] : []),
            ...
            replies: (this.selectedAnnotation.replies && (this.selectedAnnotation.replies.length > 0)) ? [...this.selectedAnnotation.replies] : [],
    ...
    onEditButtonClick(commentId) {
        const comment = this.selectedAnnotation.replies.find((comment) => comment.id === commentId);
        if (comment) {
    ...
    onreplycommentdelete(commentId) {
        const commentIndex = this.selectedAnnotation.replies.findIndex((comment) => comment.id === commentId);
        if (commentIndex !== -1) {
    ...
    updateEditReply() {
        ...
        if (this.state.isEditing && this.currentEditCommentId) {
            let replyIndex;
            replyIndex = this.selectedAnnotation.replies.findIndex((comment) => comment.id === this.currentEditCommentId);
            if (replyIndex !== -1) {
    ...
    annotationUpdate(currentAnnotation) {
        ...
        if (this.selectedAnnotation.annotationType === "Highlight" || this.selectedAnnotation.annotationType === "Underline" || this.selectedAnnotation.annotationType === "Strikethrough") {
            ...
            if (this.selectedAnnotation.bounds?.length === 0) {
                ...
                this.selectedAnnotation.bounds.forEach((value, index) => {
                    currentAnnotation.bounds.push({
                        id: this.generateUniqueId(),
        ...
        if (this.selectedAnnotation.isLocked) {
            currentAnnotation.allowedInteractions = this.selectedAnnotation.allowedInteractions.map((value) => value.toString());
    ...
    updateAnnotationComments(currentAnnotation) {
        ...
        if (this.selectedAnnotation.replies?.length > 0) {
            if (this.selectedAnnotation.replies.length > currentAnnotation.comments.length) {
                let diff = (this.selectedAnnotation.replies.length - currentAnnotation.comments.length);
                currentAnnotation.commentType = "add";
