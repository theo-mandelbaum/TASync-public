...
export class MultiFormatViewer extends SampleBase {
    ...
    onSelect = (args) => {
        ...
        if (isNullOrUndefined(this.uploadObj.current.element.querySelector('.e-upload-files'))) {
    ...
    render() {
        ...
        <div className='control-section'>
          ...
          <div id='pdfviewer_container' style={{ display: 'none' }}>
            ...
            <PdfViewerComponent id="pdfviewer" className="e-pv-multi-format-pdfviewer" toolbarSettings={{
