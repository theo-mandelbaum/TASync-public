...
export class DocumentList extends SampleBase {
    dialogInstance;
    viewer;
    gridInstance;
    commands = [{ type: 'View', buttonOption: { cssClass: 'e-icons e-eye e-flat', title: 'View' } },
    ...
    render() {
        return (<div className='control-pane pdfviewer-document-list'>
        <div className='control-section col-lg-12 defaultDialogComponent dialog-target'>
          ...
          <DialogComponent id="defaultDialog" showCloseIcon={true} visible={!this.state.hideDialog} minHeight={'90%'} width={'90%'} height={'90%'} isModal={true} ref={dialog => this.dialogInstance = dialog} open={this.dialogOpen.bind(this)} close={this.dialogClose.bind(this)}>
            <div className='control-section'>
              <PdfViewerComponent ref={(scope) => { this.viewer = scope; }} style={{ 'height': '735px' }} id="container" resourceUrl="https://cdn.syncfusion.com/ej2/23.2.6/dist/ej2-pdfviewer-lib">
