...
export class CustomToolbar extends SampleBase {
    ...
    stampTemplate() {
        const onItemSelect = function (args) {
    ...
    signTemplate() {
        ...
        const onsignatureCilck = function (event) {
    ...
    render() {
        ...
        const disableInkAnnotation = function (args) {
        ...
        const currentPageClicked = function (args) {
            let currentPage = document.getElementById('currentPage');
            currentPage.select();
        };
        const checkSearchActive = function (args) {
            if (viewer && viewer.textSearchModule && !this.searchActive) {
                viewer.textSearchModule.clearAllOccurrences();
            }
        };
        const onPageChange = function (args) {
        ...
        const documentLoaded = function (args) {
      ...
      <div className='control-section'>
        ...
        <div>
          ...
          <div id="textSearchToolbar" style={{ display: 'none', marginLeft: '840px' }}>
            <div className="e-pv-search-bar" id="container_search_box" style={{ right: '0px' }}>
              <div className="e-pv-search-bar-elements" id="container_search_box_elements">
                <div className="e-input-group e-pv-search-input" id="container_search_input_container">
                  <input className="e-input" id="container_search_input" type="text" placeholder="Find in document" onKeyPress={this.searchInputKeypressed} onChange={this.inputChange}/>
                  <span className="e-input-group-icon e-input-search-group-icon e-icons e-search" id="container_search_box-icon" onClick={this.searchClickHandler}></span>
                </div>
                <button className="e-btn e-icon-btn e-pv-search-btn e-icons e-chevron-left" id="container_prev_occurrence" type="button" disabled aria-label="Previous Search text">
                  <span className="e-pv-icon-search e-pv-prev-search-icon" id="container_prev_occurrenceIcon" onClick={this.previousTextSearch}></span>
                </button>
                <button className="e-btn e-icon-btn e-pv-search-btn e-icons e-chevron-right" id="container_next_occurrence" type="button" disabled aria-label="Next Search text">
                  <span className="e-pv-icon-search e-pv-next-search-icon" id="container_next_occurrenceIcon" onClick={this.nextTextSearch}></span>
                </button>
              </div>
              <div className="e-pv-match-case-container" id="container_match_case_container">
                <div className="e-checkbox-wrapper e-wrapper e-pv-match-case">
                  <label htmlFor="container_match_case">
                    <input id="container_match_case" type="checkbox" className="e-control e-checkbox e-lib" onClick={this.checkBoxChanged}/>
