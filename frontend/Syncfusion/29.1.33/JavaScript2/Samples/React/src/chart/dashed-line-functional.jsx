...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, ChartAnnotation, LineSeries, Crosshair, Category, Tooltip, Highlight, Double, Legend } from '@syncfusion/ej2-react-charts';
import { Browser } from '@syncfusion/ej2-base';
import { updateSampleSection } from '../common/sample-base';
import { loadChartTheme } from './theme-color';
export let dashedLineData = [
...
const DashedLine = () => {
    ...
    const sharedTooltipRender = (args) => {
    ...
    const legendRender = (args) => {
        const cancelLegendNames = new Set([
            'Total1',
            'Ages1 65+',
            'Ages1 25-64',
            'Unders-25s',
