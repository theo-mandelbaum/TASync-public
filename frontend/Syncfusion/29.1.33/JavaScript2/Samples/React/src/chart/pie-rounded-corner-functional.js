        ...
        React.createElement("div", { className: 'control-section row' },
            React.createElement(ej2_react_charts_1.AccumulationChartComponent, { id: 'pie-chart', title: 'Company Budget Distribution', load: load.bind(_this), style: { textAlign: 'center' }, legendSettings: { visible: false }, enableSmartLabels: true, enableAnimation: false, center: { x: '50%', y: '50%' }, enableBorderOnMouseMove: false, width: ej2_base_1.Browser.isDevice ? '100%' : '75%', tooltip: { enable: true, header: '<b>Budget</b>', format: '${point.x}: <b>${point.y}%</b>', enableHighlight: true }, loaded: onChartLoad.bind(_this), pointRender: onPointRender.bind(_this) },
                ...
                React.createElement(ej2_react_charts_1.AccumulationAnnotationsDirective, null,
                    React.createElement(ej2_react_charts_1.AccumulationAnnotationDirective, { content: "<div style=\"padding: 5px 5px 5px 5px; font-size: ".concat(ej2_base_1.Browser.isDevice ? '10px' : '14px', "; color: #FFFFFF;\">30%</div>"), region: 'Series', coordinateUnits: 'Point', x: 'Operations', y: 30.0 }),
                    React.createElement(ej2_react_charts_1.AccumulationAnnotationDirective, { content: "<div style=\"padding: 5px 5px 5px 5px; font-size: ".concat(ej2_base_1.Browser.isDevice ? '10px' : '14px', "; color: #FFFFFF;\">10%</div>"), region: 'Series', coordinateUnits: 'Point', x: 'Miscellaneous', y: 10.0 }),
                    React.createElement(ej2_react_charts_1.AccumulationAnnotationDirective, { content: "<div style=\"padding: 5px 5px 5px 5px; font-size: ".concat(ej2_base_1.Browser.isDevice ? '10px' : '14px', "; color: #FFFFFF;\">15%</div>"), region: 'Series', coordinateUnits: 'Point', x: 'Human Resources', y: 15.0 }),
                    React.createElement(ej2_react_charts_1.AccumulationAnnotationDirective, { content: "<div style=\"padding: 5px 5px 5px 5px; font-size: ".concat(ej2_base_1.Browser.isDevice ? '10px' : '14px', "; color: #FFFFFF;\">20%</div>"), region: 'Series', coordinateUnits: 'Point', x: 'Research and Development', y: 20.0 }),
                    React.createElement(ej2_react_charts_1.AccumulationAnnotationDirective, { content: "<div style=\"padding: 5px 5px 5px 5px; font-size: ".concat(ej2_base_1.Browser.isDevice ? '10px' : '14px', "; color: #FFFFFF;\">25%</div>"), region: 'Series', coordinateUnits: 'Point', x: 'Marketing', y: 25.0 })))),
