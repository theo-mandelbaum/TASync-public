...
export class HiloOpenClose extends SampleBase {
    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div className="row">
                    <ChartComponent id='charts' load={this.load.bind(this)} style={{ textAlign: "center" }} ref={chart => this.chart1 = chart} loaded={this.loaded.bind(this)} primaryXAxis={{
                valueType: 'DateTime',
            ...
            }} title="AAPL Historical" axisLabelRender={this.axisLabelRender.bind(this)} width={Browser.isDevice ? '100%' : '80%'} legendSettings={{ visible: false }} crosshair={{ enable: true, lineType: 'Vertical', line: { width: 0 } }}>
