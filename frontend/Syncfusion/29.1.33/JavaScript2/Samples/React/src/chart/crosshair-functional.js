...
var CrosshairChart = function () {
    (0, react_1.useEffect)(function () {
        (0, sample_base_1.updateSampleSection)();
    }, []);
    var selectedTheme = (0, theme_color_1.loadChartTheme)(null, true);
    ...
    return (React.createElement("div", { className: 'control-pane' },
        ...
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', style: { textAlign: "center" }, primaryXAxis: {
                ...
                }, chartArea: { border: { width: 0 } }, width: ej2_base_1.Browser.isDevice ? '100%' : '75%', title: 'Intraday Stock Price Movement', loaded: onChartLoad.bind(_this), crosshair: { enable: true, snapToData: true, dashArray: '5,5' }, legendSettings: { visible: false } },
...
exports.default = CrosshairChart;
