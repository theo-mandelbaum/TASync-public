...
const HorizontalWaterfall = () => {
    ...
    return (<div className='control-pane'>
            ...
            <div className='control-section'>
                <ChartComponent id='charts' load={load.bind(this)} style={{ textAlign: "center" }} primaryXAxis={{
            valueType: 'Category',
            ...
            header: " "
        }} width={Browser.isDevice ? '100%' : '75%'} legendSettings={{ mode: 'Point', toggleVisibility: false }} title='Revenue Variation' loaded={onChartLoad.bind(this)} legendRender={legendRender} isTransposed={true} chartArea={{ border: { width: 0 }, margin: { bottom: 12 } }}>
