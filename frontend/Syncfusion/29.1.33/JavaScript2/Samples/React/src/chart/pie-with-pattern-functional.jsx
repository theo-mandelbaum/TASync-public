...
import { AccumulationChartComponent, AccumulationSeriesCollectionDirective, AccumulationSeriesDirective, Inject, AccumulationTooltip, AccumulationDataLabel, PieSeries } from '@syncfusion/ej2-react-charts';
...
const PieWithPattern = () => {
    ...
    return (<div className="control-pane">
            ...
            <div className="control-section">
                ...
                <AccumulationChartComponent id='pie-chart' style={{ textAlign: 'center' }} title='Browser Market Share' load={load.bind(this)} enableBorderOnMouseMove={false} width={Browser.isDevice ? '100%' : '75%'} pointRender={onPointRender.bind(this)} tooltip={{ enable: true, format: '<b>${point.x}</b><br>Browser Share: <b>${point.y}%</b>', header: "", enableHighlight: true }} legendSettings={{ visible: false }}>
                    <Inject services={[AccumulationTooltip, AccumulationDataLabel, PieSeries]}/>
                    <AccumulationSeriesCollectionDirective>
                        <AccumulationSeriesDirective dataSource={data} xName='x' yName='y' type='Pie' applyPattern={true} dataLabel={{
            visible: true,
            position: 'Outside',
            name: 'text',
            font: { fontWeight: '600' },
            ...
            <div id="description">
                ...
                <p>
                    More information on the pie series can be found in this <a target="_blank" href="https://ej2.syncfusion.com/documentation/accumulation-chart/pie-dough-nut/#pie-chart" aria-label="Navigate to the documentation for Pie Chart in TypeScript Accumulation Chart control">documentation
                        section</a>.
                </p>
            </div>
        </div>);
