...
exports.dashLineData = exports.dashedLineData = void 0;
/**
...
var DashedLine = function () {
        ...
        if (args.text && Array.isArray(args.point) && Array.isArray(args.series)) {
            args.text = args.point.map(function (point, i) {
                if (point && point.y !== undefined && args.series[i]) {
                    ...
                    var seriesName = args.series[i].name || "Series ".concat(i + 1);
                    seriesName = seriesNameMapping[seriesName] || seriesName;
                    return "".concat(seriesName, ": <b>").concat(formattedValue, "</b>");
                }
                return null;
            }).filter(Boolean);
        }
    ...
    return (React.createElement("div", { className: "control-pane" },
        ...
        React.createElement("div", { className: "control-section" },
            React.createElement(ej2_react_charts_1.ChartComponent, { id: "charts", style: { textAlign: 'center' }, primaryXAxis: { valueType: 'Double', majorGridLines: { width: 0 }, minimum: 1950, maximum: 2100, interval: 30, labelIntersectAction: ej2_base_1.Browser.isDevice ? 'None' : 'Trim', labelRotation: ej2_base_1.Browser.isDevice ? -45 : 0, majorTickLines: { width: 0 }, minorTickLines: { width: 0 } }, load: load.bind(_this), primaryYAxis: { maximum: 12e9, interval: 2e9, lineStyle: { width: 0 }, title: 'Population (in Billions)', majorTickLines: { width: 0 }, minorTickLines: { width: 0 } }, chartArea: { border: { width: 0 }, margin: { bottom: 12 } }, tooltip: { enable: true, shared: true, showNearestTooltip: true }, legendSettings: { visible: true, enableHighlight: true }, crosshair: { enable: false, line: { color: 'rgba(204,214,235,0.25)', width: ej2_base_1.Browser.isDevice ? 50 : 20 }, lineType: 'Vertical' }, width: ej2_base_1.Browser.isDevice ? '100%' : '75%', title: "Global Population Trends by Age Group (1950\u20132100)", subTitle: 'Source: ourworldindata.org', loaded: onChartLoad.bind(_this), axisLabelRender: axisLabelRender.bind(_this), sharedTooltipRender: sharedTooltipRender.bind(_this), legendRender: legendRender.bind(_this) },
                React.createElement(ej2_react_charts_1.Inject, { services: [ej2_react_charts_1.LineSeries, ej2_react_charts_1.Category, ej2_react_charts_1.Tooltip, ej2_react_charts_1.Crosshair, ej2_react_charts_1.ChartAnnotation, ej2_react_charts_1.Highlight, ej2_react_charts_1.Double, ej2_react_charts_1.Legend] }),
                React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.dashedLineData, xName: "x", yName: "y", width: 2, marker: { visible: false, width: 7, height: 7 }, type: "Line", name: "Total" }),
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.dashLineData, xName: "x", yName: "y", width: 2, marker: { visible: false, width: 7, height: 7 }, dashArray: '4,4', type: "Line", name: "Total1" }),
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.dashedLineData, xName: "x", yName: "y1", width: 2, marker: { visible: false, width: 7, height: 7 }, type: "Line", name: "Ages 65+" }),
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.dashLineData, xName: "x", yName: "y1", width: 2, marker: { visible: false, width: 7, height: 7 }, dashArray: '4,4', type: "Line", name: "Ages1 65+" }),
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.dashedLineData, xName: "x", yName: "y2", width: 2, marker: { visible: false, width: 7, height: 7 }, type: "Line", name: "Ages 25-64" }),
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.dashLineData, xName: "x", yName: "y2", width: 2, marker: { visible: false, width: 7, height: 7 }, dashArray: '4,4', type: "Line", name: "Ages1 25-64" }),
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.dashedLineData, xName: "x", yName: "y3", width: 2, marker: { visible: false, width: 7, height: 7 }, type: "Line", name: "Under-25s" }),
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.dashLineData, xName: "x", yName: "y3", width: 2, marker: { visible: false, width: 7, height: 7 }, dashArray: '4,4', type: "Line", name: "Unders-25s" }),
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.dashedLineData, xName: "x", yName: "y4", width: 2, marker: { visible: false, width: 7, height: 7 }, type: "Line", name: "Under-15s" }),
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.dashLineData, xName: "x", yName: "y4", width: 2, marker: { visible: false, width: 7, height: 7 }, dashArray: '4,4', type: "Line", name: "Unders-15s" }),
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.dashedLineData, xName: "x", yName: "y5", width: 2, marker: { visible: false, width: 7, height: 7 }, type: "Line", name: "Under-5s" }),
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.dashLineData, xName: "x", yName: "y5", width: 2, marker: { visible: false, width: 7, height: 7 }, dashArray: '4,4', type: "Line", name: "Unders-5s" })))),
        React.createElement("div", { id: "action-description" },
            React.createElement("p", null, "This sample illustrates global population trends from 1950 to 2100, with solid lines representing historical data and dashed lines for projections.")),
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                ...
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/chart/chart-types/line#series-customization", "aria-label": "Navigate to the documentation for Series customization in React Chart component" }, "documentation section"),
                "."))));
};
