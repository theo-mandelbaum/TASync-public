...
exports.Striplinerecurrence = exports.data2 = exports.data1 = void 0;
/**
                                ...
                                React.createElement("tr", { style: { height: '50px' } },
                                    ...
                                    React.createElement("td", { style: { width: '40%' } },
                                        React.createElement("div", null,
                                            React.createElement("input", { type: "checkbox", id: "xIndex", defaultChecked: true, onChange: this.xIndex.bind(this), style: { marginLeft: '-5px' }, ref: function (d) { return _this.xcheckElement = d; }, "aria-labelledby": "Checkbox checked" })))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", { style: { width: '60%' } },
                                        React.createElement("div", { id: "yAxis" }, "Y Axis:")),
                                    React.createElement("td", { style: { width: '40%' } },
                                        React.createElement("div", null,
                                            React.createElement("input", { type: "checkbox", id: "yIndex", defaultChecked: true, onChange: this.yIndex.bind(this), style: { marginLeft: '-5px' }, ref: function (d) { return _this.ycheckElement = d; }, "aria-labelledby": "Checkbox checked" }))))))))),
