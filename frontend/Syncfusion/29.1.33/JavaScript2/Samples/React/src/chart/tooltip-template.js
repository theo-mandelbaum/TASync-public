...
exports.ChartTooltipTemplate = exports.data1 = void 0;
/**
                ...
                React.createElement("tbody", null,
                    ...
                    React.createElement("tr", null,
                        React.createElement("th", { rowSpan: 2, style: { backgroundColor: '#C1272D' } },
                            React.createElement("img", { src: 'src/chart/images/grain.png', alt: "Grain Picture" })),
        ...
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_charts_1.ChartComponent, { id: 'chartTooltip', style: { textAlign: "center" }, backgroundImage: 'src/chart/images/wheat.png', primaryXAxis: {
                        ...
                        lineStyle: { width: 0 },
                    }, chartArea: { border: { width: 0 } }, tooltip: { enable: true, showNearestTooltip: true, enableHighlight: true,
                        template: this.tooltipTemplate.bind(this) }, width: ej2_base_1.Browser.isDevice ? '100%' : '75%', title: 'USA Wheat Production', loaded: this.onChartLoad.bind(this) },
