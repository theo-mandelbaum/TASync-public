    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div className='control-section'>
                    ...
                    <ChartComponent id="drilldown" style={{ textAlign: "center" }} ref={this.chartRef} primaryXAxis={{
                valueType: 'Category',
                ...
                majorTickLines: { width: 0 },
                lineStyle: { width: 0 }
            }} width={Browser.isDevice ? '100%' : '75%'} title={this.title} subTitle={this.subTitle} tooltip={{ enable: true, header: "<b>Population - 2023</b>", format: '${point.x}: <b>${point.y}M</b>' }} legendSettings={{ visible: false }} chartArea={{ border: { width: 0 } }} load={this.load.bind(this)} loaded={this.loaded.bind(this)} pointRender={this.onPointRender} pointClick={this.pointClick} axisLabelClick={this.onAxisLabelClick} tooltipRender={this.tooltipRender.bind(this)}>
                        <Inject services={[ColumnSeries, DataLabel, Category, Legend, Tooltip, Highlight]}/>
                        <SeriesCollectionDirective>
                            <SeriesDirective dataSource={this.data} xName='drilldown' yName='y' name='Population' type='Column' cornerRadius={{ topLeft: 5, topRight: 5 }} marker={{
                dataLabel: {
                    visible: true,
                    position: 'Outer',
                }
                ...
                <div id="description">
                    ...
                    <p>
                        ...
                        <a target="_blank" href="https://ej2.syncfusion.com/react/documentation/chart/Chart-types/column" aria-label="Navigate to the documentation for Column Chart in TypeScript Chart control"> documentation
                            section</a>.
                    </p>
                </div>
            </div>);
