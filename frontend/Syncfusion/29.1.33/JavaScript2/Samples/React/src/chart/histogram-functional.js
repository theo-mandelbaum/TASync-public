...
var Histogram = function () {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        ...
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', style: { textAlign: "center" }, load: load.bind(_this), primaryXAxis: { majorGridLines: { width: 0 }, title: 'Score of Final Examination', minimum: 0, maximum: 100, edgeLabelPlacement: 'Shift' }, primaryYAxis: { title: 'Number of Students', minimum: 0, maximum: 50, interval: 10, majorTickLines: { width: 0 }, lineStyle: { width: 0 } }, chartArea: { border: { width: 0 } }, tooltip: { enable: true, header: " " }, width: ej2_base_1.Browser.isDevice ? '100%' : '75%', legendSettings: { visible: false }, title: 'Examination Result', loaded: onChartLoad.bind(_this) },
