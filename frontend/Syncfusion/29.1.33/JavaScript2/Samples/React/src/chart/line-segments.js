...
exports.LineZone = exports.lineZoneData = void 0;
/**
...
var content = "<div style='color:#228B22; font-weight:bold; font-size:14px'>Medium</div>";
var content1 = "<div style='color:#0047AB; font-weight:bold;font-size:14px'>High</div>";
var content2 = "<div style='color:#D32F2F; font-weight:bold; font-size:14px'>Low</div>";
    ...
    LineZone.prototype.render = function () {
        return (React.createElement("div", { className: "control-pane" },
            React.createElement("div", { className: "control-section" },
                React.createElement(ej2_react_charts_1.ChartComponent, { id: "charts", style: { textAlign: 'center' }, primaryXAxis: { valueType: 'DateTime', minimum: new Date(1895, 0, 1), maximum: new Date(2025, 0, 1), edgeLabelPlacement: 'Shift', majorGridLines: { width: 0 } }, primaryYAxis: { labelFormat: '{value}mm', title: 'Precipitation (mm)', minimum: 10, maximum: 100, interval: 20, lineStyle: { width: 0 }, majorTickLines: { width: 0 }, minorTickLines: { width: 0 } }, tooltip: { enable: true, showNearestTooltip: true, enableAnimation: false, header: '<b>Rainfall</b>', format: '${point.x} : <b>${point.y}</b>', enableHighlight: true }, legendSettings: { visible: false }, chartArea: { border: { width: 0 } }, load: this.load.bind(this), width: ej2_base_1.Browser.isDevice ? '100%' : '75%', title: "Annual Mean Precipitation in the United States (1895-2025)", subTitle: 'Source: ncei.noaa.gov', loaded: this.onChartLoad.bind(this) },
                    React.createElement(ej2_react_charts_1.Inject, { services: [ej2_react_charts_1.MultiColoredLineSeries, ej2_react_charts_1.ChartAnnotation, ej2_react_charts_1.DateTime, ej2_react_charts_1.Tooltip, ej2_react_charts_1.Highlight] }),
                    React.createElement(ej2_react_charts_1.AnnotationsDirective, null,
                        React.createElement(ej2_react_charts_1.AnnotationDirective, { content: content, coordinateUnits: 'Point', verticalAlignment: 'Middle', x: new Date(1959, 0, 1), y: 65 }),
                        React.createElement(ej2_react_charts_1.AnnotationDirective, { content: content1, coordinateUnits: 'Point', verticalAlignment: 'Middle', x: new Date(1916, 0, 1), y: 96.27 }),
                        React.createElement(ej2_react_charts_1.AnnotationDirective, { content: content2, coordinateUnits: 'Point', verticalAlignment: 'Middle', x: new Date(1981, 0, 1), y: 24.89 })),
                    React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.lineZoneData, xName: "x", width: 2, yName: "y", type: "MultiColoredLine", segmentAxis: "Y", marker: { visible: true, isFilled: true, border: { width: 2, color: 'white' } } },
                            React.createElement(ej2_react_charts_1.SegmentsDirective, null,
                                React.createElement(ej2_react_charts_1.SegmentDirective, { value: 50, color: "#D32F2F" }),
                                React.createElement(ej2_react_charts_1.SegmentDirective, { value: 65, color: "#228B22" }),
                                React.createElement(ej2_react_charts_1.SegmentDirective, { color: "#0047AB" })))))),
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample visualizes the annual mean rainfall in Australia with multi-colored line series in the chart. Data points are enhanced with segments and tooltips.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    ...
                    " series. Points under the range can be configured with ",
                    React.createElement("code", null, "color"),
                    " and ",
                    React.createElement("code", null, "dashArray"),
                    " properties in the ChartSegment."),
                React.createElement("p", null,
