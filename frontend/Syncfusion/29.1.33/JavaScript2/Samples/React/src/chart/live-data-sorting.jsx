...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, ColumnSeries, Category, DataLabel, sort } from '@syncfusion/ej2-react-charts';
    ...
    load = (args) => {
        ...
        this.intervalId = setInterval(() => {
            ...
            if (container && container.id === args.chart.element.id) {
                let newData = (eval('updatedData' + this.yearIndex) || []).map((item) => {
    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div className='control-section row'>
                    <ChartComponent style={{ textAlign: 'center' }} id='data-sorting-container' ref={chart => this.chart = chart} primaryXAxis={{
                valueType: 'Category',
                ...
                lineStyle: { width: 0 },
                majorTickLines: { width: 0 }
            }} chartArea={{ border: { width: 0 } }} title='Nitrogen Fertilizer Usage' pointRender={labelRender} width={Browser.isDevice ? '100%' : '75%'} load={this.load.bind(this)} loaded={this.onChartLoad.bind(this)} axisRangeCalculated={this.axisRangeCalculated}>
