...
var UpdateColumnDataSource = function () {
    ...
    var textRender = function (args) {
        ...
        if (selectedTheme.includes('fabric')) {
            args.text = theme_color_1.fabricColors[args.point.index % 10];
        }
        else if (selectedTheme === 'material') {
            args.text = theme_color_1.materialColors[args.point.index % 10];
        }
        else if (selectedTheme === 'highcontrast') {
            args.text = theme_color_1.highContrastColors[args.point.index % 10];
        }
        else if (selectedTheme === 'fluent2') {
            args.text = theme_color_1.fluent2Colors[args.point.index % 10];
        }
        else if (selectedTheme === 'fluent2-dark') {
            args.text = theme_color_1.fluent2DarkColors[args.point.index % 10];
        }
        else {
            args.text = theme_color_1.bootstrapColors[args.point.index % 10];
        }
    ...
    return (React.createElement("div", { className: 'control-pane' },
        ...
        React.createElement("div", { className: 'control-section row' },
            React.createElement(ej2_react_charts_1.ChartComponent, { style: { textAlign: 'center' }, id: 'data-sorting-container', ref: function (chart) { return chart = chart; }, primaryXAxis: {
                    valueType: 'Category',
                    ...
                    lineStyle: { width: 0 },
                    majorTickLines: { width: 0 }
                }, loaded: onChartLoad.bind(_this), chartArea: { border: { width: 0 } }, title: 'Nitrogen Fertilizer Usage', pointRender: pointRender, width: ej2_base_1.Browser.isDevice ? '100%' : '75%', load: load.bind(_this), axisRangeCalculated: axisRangeCalculated },
