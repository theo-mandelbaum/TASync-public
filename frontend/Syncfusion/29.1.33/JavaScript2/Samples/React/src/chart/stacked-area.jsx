...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Highlight, Inject, Tooltip, DateTime, StackingAreaSeries, Legend, } from '@syncfusion/ej2-react-charts';
...
export class StackedArea extends SampleBase {
    render() {
        ...
        <div className="control-section">
          <ChartComponent id="charts" style={{ textAlign: 'center' }} primaryXAxis={{ valueType: 'DateTime', intervalType: 'Years', majorGridLines: { width: 0 }, labelFormat: 'y', edgeLabelPlacement: 'Shift' }} load={this.load.bind(this)} primaryYAxis={{ title: 'Amount of sales in €', minimum: 0, maximum: 7, interval: 1, lineStyle: { width: 0 }, majorTickLines: { width: 0 }, minorTickLines: { width: 0 }, labelFormat: '{value}k' }} chartArea={{ border: { width: 0 } }} width={Browser.isDevice ? '100%' : '75%'} legendSettings={{ enableHighlight: true }} title="Amount of Sales by Payment Method" loaded={this.onChartLoad.bind(this)} tooltip={{ enable: true, enableHighlight: true, showNearestTooltip: true }}>
