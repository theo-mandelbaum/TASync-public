...
const UpdatePieDataSource = () => {
    ...
    const updateData = (args) => {
        ...
        intervalId = setInterval(function () {
            ...
            if (container && container.id === args.chart.element.id) {
                let newData = (eval('updatedData' + yearIndex) || []).map(function (item) {
    ...
    return (<div className='control-pane'>
            ...
            <div className='control-section row'>
                <AccumulationChartComponent id='donut-container' ref={pieRef} title='Average Stock Market Prices of Leading Tech Giants' style={{ textAlign: 'center' }} titleStyle={{ size: '18px' }} load={load.bind(this)} loaded={onChartLoad.bind(this)} textRender={textRender} legendSettings={{ visible: false }} centerLabel={{
            text: '2010',
            textStyle: {
                fontWeight: '600',
                size: Browser.isDevice ? '25px' : '40px'
            }
        }} enableBorderOnMouseMove={false} width={Browser.isDevice ? '100%' : '75%'}>
