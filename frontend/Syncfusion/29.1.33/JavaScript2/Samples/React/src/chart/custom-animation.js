        ...
        return (React.createElement("div", { className: "control-pane" },
            ...
            React.createElement("div", { className: "control-section" },
                React.createElement(ej2_react_charts_1.ChartComponent, { id: "charts", style: { textAlign: 'center' }, primaryXAxis: { valueType: 'DateTime', edgeLabelPlacement: 'Shift', majorGridLines: { width: 0 }, labelFormat: 'y' }, load: this.load.bind(this), primaryYAxis: { title: 'Yield (In Tons per Hectare)', lineStyle: { width: 0 }, majorTickLines: { width: 0 }, maximum: 8, interval: 2, minorTickLines: { width: 0 } }, chartArea: { border: { width: 0 }, margin: { bottom: 12 } }, tooltip: {
                    ...
                    }, legendSettings: { visible: true, enableHighlight: true }, width: ej2_base_1.Browser.isDevice ? '100%' : '75%', title: "Almond Yield Comparison Across Countries (2010\u20132022)", loaded: this.onChartLoad.bind(this) },
