...
export class InversedAxis extends SampleBase {
    render() {
        return (<div className='control-pane'>
            ...
            }} pointRender={labelRender} chartArea={{ border: { width: 0 } }} legendSettings={{ visible: false }} title='Exchange Rate (INR per USD)' width={Browser.isDevice ? '100%' : '75%'} loaded={this.onChartLoad.bind(this)} tooltip={{
                enable: true
            }}>
