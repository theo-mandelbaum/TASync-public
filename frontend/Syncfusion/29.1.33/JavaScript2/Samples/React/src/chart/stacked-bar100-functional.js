...
var StackedBar100 = function () {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        ...
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', ref: chartInstance, style: { textAlign: "center" }, legendSettings: { enableHighlight: true, shapeWidth: 9, shapeHeight: 9 }, primaryXAxis: { valueType: 'Category', majorGridLines: { width: 0 }, majorTickLines: { width: 0 } }, width: ej2_base_1.Browser.isDevice ? '100%' : '75%', chartArea: { border: { width: 0 }, margin: { bottom: 12 } }, primaryYAxis: { lineStyle: { width: 0 }, majorTickLines: { width: 0 }, edgeLabelPlacement: 'Shift' }, load: load.bind(_this), title: 'Annual Renewable Energy Generation in China (2020\u20132023) by Source', subTitle: 'Source: wikipedia.org', loaded: onChartLoad.bind(_this), tooltip: { enable: true, enableHighlight: true, header: '<b>Renewable Energy Generation</b>' }, legendClick: onLegendClick.bind(_this), tooltipRender: tooltipRender.bind(_this) },
