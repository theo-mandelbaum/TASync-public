  ...
  <defs>
    ...
    <linearGradient id="fluent2-dark-gradient-chart" style={{ opacity: 0.75 }} className="chart-gradient" x1="0" x2="0" y1="0" y2="1">
      ...
      <stop offset="1"></stop>
        ...
        }} chartArea={{ border: { width: 0 } }} width={Browser.isDevice ? '100%' : '75%'} title='Intraday Stock Price Movement' loaded={onChartLoad.bind(this)} crosshair={{ enable: true, snapToData: true, dashArray: '5,5' }} legendSettings={{ visible: false }}>
