...
exports.RangeColorMapping = exports.color3 = exports.color2 = exports.color1 = exports.data = void 0;
/**
...
var RangeColorMapping = /** @class */ (function (_super) {
    __extends(RangeColorMapping, _super);
    function RangeColorMapping() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RangeColorMapping.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("style", null, SAMPLE_CSS),
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', style: { textAlign: "center" }, highlightMode: 'Point', highlightPattern: 'DiagonalForward', primaryXAxis: { valueType: 'Category', majorGridLines: { width: 0 } }, primaryYAxis: { lineStyle: { width: 0 },
                        majorTickLines: { width: 0 },
                        minorTickLines: { width: 0 },
                        labelFormat: '{value}°C' }, title: "USA CLIMATE - WEATHER BY MONTH", loaded: this.onChartLoad.bind(this), load: this.load.bind(this), chartArea: { border: { width: 0 } }, width: ej2_base_1.Browser.isDevice ? '100%' : '75%', legendSettings: {
                        mode: 'Range',
                        visible: true,
                    ...
                    React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
                        React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.data, name: 'USA', xName: 'x', yName: 'y', type: 'Column', animation: { enable: false }, cornerRadius: {
    ...
    RangeColorMapping.prototype.onChartLoad = function (args) {
        var chart = document.getElementById('charts');
        chart.setAttribute('title', '');
    };
    ;
    RangeColorMapping.prototype.load = function (args) {
        var selectedTheme = location.hash.split('/')[1];
        selectedTheme = selectedTheme ? selectedTheme : 'Fluent2';
        args.chart.theme = (selectedTheme.charAt(0).toUpperCase() + selectedTheme.slice(1)).replace(/-dark/i, "Dark").replace(/contrast/i, 'Contrast').replace(/-highContrast/i, 'HighContrast');
    };
    ;
    return RangeColorMapping;
}(sample_base_1.SampleBase));
exports.RangeColorMapping = RangeColorMapping;
