...
exports.SplineInversed = exports.inversedData = void 0;
/**
    ...
    SplineInversed.prototype.render = function () {
        return (React.createElement("div", { className: "control-pane" },
            ...
            React.createElement("div", { className: "control-section" },
                React.createElement(ej2_react_charts_1.ChartComponent, { id: "charts", style: { textAlign: 'center' }, isTransposed: true, primaryXAxis: { valueType: 'Category', minorTickLines: { width: 0 }, lineStyle: { width: 0 }, majorTickLines: { width: 0 }, labelPlacement: 'OnTicks' }, load: this.load.bind(this), width: ej2_base_1.Browser.isDevice ? '100%' : '75%', legendSettings: { visible: false }, chartArea: { border: { width: 0 } }, primaryYAxis: { labelFormat: '{value}%', title: 'Capitalization Ratio (% of GDP)', interval: 40, edgeLabelPlacement: 'Shift', lineStyle: { width: 0 }, majorTickLines: { width: 0 }, majorGridLines: { width: 0 }, labelRotation: ej2_base_1.Browser.isDevice ? -45 : 0 }, tooltip: { enable: true, showNearestTooltip: true, header: '<b>Stock Market Cap</b>', format: '${point.x}: <b>${point.y}</b>', enableHighlight: true }, title: "Stock Market Capitalization as a Percentage of GDP by Country", subTitle: 'Source: wikipedia.org', loaded: this.onChartLoad.bind(this) },
