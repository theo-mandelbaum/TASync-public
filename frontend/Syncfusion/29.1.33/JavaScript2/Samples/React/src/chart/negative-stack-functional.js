...
var NegativeStack = function () {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        ...
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', style: { textAlign: "center" }, primaryXAxis: { valueType: 'Category', title: 'Population by Age Range', minimum: 0, interval: 3, majorGridLines: { width: 0 }, majorTickLines: { width: 0 } }, width: ej2_base_1.Browser.isDevice ? '100%' : '75%', chartArea: { border: { width: 0 }, margin: { bottom: 12 } }, primaryYAxis: { labelFormat: '{value}%', interval: 3, title: 'Share of Total Population (%)', lineStyle: { width: 0 }, edgeLabelPlacement: 'Shift', rangePadding: 'Round', majorTickLines: { width: 0 } }, axisLabelRender: labelRender.bind(_this), legendSettings: { enableHighlight: true, shapeWidth: 8, shapeHeight: 8 }, load: load.bind(_this), title: 'Belize Demographic Breakdown by Age and Gender (2024)', subTitle: 'Source: statisticstimes.com', loaded: onChartLoad.bind(_this), tooltip: { enable: true, header: '${point.x}', enableHighlight: true }, tooltipRender: tooltipRender.bind(_this) },
