...
const StepLineWithoutRiser = () => {
    ...
    return (<div className='control-pane'>
            ...
            minimum: 0,
            maximum: 100
        }} load={load.bind(this)} width={Browser.isDevice ? '100%' : '75%'} chartArea={{ border: { width: 0 } }} tooltip={{ enable: true, showNearestTooltip: true }} title='Sales of Product Over Time' legendSettings={{ visible: false }} loaded={onChartLoad.bind(this)}>
            ...
            <div id="description">
                ...
                <p>
                    More information on the step area series can be found in this <a target="_blank" href="https://ej2.syncfusion.com/documentation/chart/Chart-types/step-area" aria-label="Navigate to the documentation for Step Area Chart in TypeScript Chart control">documentation
                        section</a>.
                </p>
            </div>
        </div>);
