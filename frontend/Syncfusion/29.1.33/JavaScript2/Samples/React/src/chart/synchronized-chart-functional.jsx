...
import { AreaSeries, LineSeries, DateTime, DataLabel, Tooltip, Highlight, Crosshair, Zoom, Legend, Selection, ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject } from '@syncfusion/ej2-react-charts';
...
let SynchronizedChart = () => {
    ...
    return (<div className="control-pane">
            ...
            <div className="row" style={{ margin: 0 }}>
                    <div className="col">
                        <ChartComponent id="container1" ref={chart => chart1 = chart} style={{ textAlign: 'center' }} primaryXAxis={{
            ...
            toolbarItems: ['Pan', 'Reset']
        }} zoomComplete={zoomComplete.bind(this)} chartMouseLeave={chartMouseLeave.bind(this)} chartMouseMove={chartMouseMove.bind(this)} chartMouseUp={chartMouseUp.bind(this)} load={load.bind(this)} loaded={onChartLoad.bind(this)} titleStyle={{ textAlignment: 'Near' }} tooltip={{ enable: true, fadeOutDuration: Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>€${point.y}</b><br>${point.x} 2023', enableMarker: false, enableHighlight: true }} crosshair={{ enable: true, lineType: 'Vertical', dashArray: '2,2' }} title="US to Euro">
                    ...
                    <div className="col">
                        <ChartComponent id="container2" ref={chart => chart2 = chart} style={{ textAlign: 'center' }} primaryXAxis={{
            minimum: new Date(2023, 1, 18),
            maximum: new Date(2023, 7, 18),
            valueType: 'DateTime',
            labelFormat: 'MMM d',
            ...
            mode: 'X',
            toolbarItems: ['Pan', 'Reset']
        }} zoomComplete={zoomComplete.bind(this)} chartMouseLeave={chartobjMouseLeave.bind(this)} chartMouseMove={chartobjMouseMove.bind(this)} chartMouseUp={chart2MouseUp.bind(this)} load={load.bind(this)} loaded={onChartLoad2.bind(this)} titleStyle={{ textAlignment: 'Near' }} tooltip={{ enable: true, fadeOutDuration: Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>¥${point.y}</b><br>${point.x} 2023', enableMarker: false, enableHighlight: true }} crosshair={{ enable: true, lineType: 'Vertical', dashArray: '2,2' }} title="US to Yen">
                            <Inject services={[AreaSeries, LineSeries, DataLabel, DateTime, Tooltip, Zoom, Highlight, Legend, Selection, Crosshair]}/>
                            <SeriesCollectionDirective>
                ...
                <div className="row" style={{ margin: 0 }}>
                    <div className="col">
                        <ChartComponent id="container3" ref={chart => chart3 = chart} style={{ textAlign: 'center' }} primaryXAxis={{
            minimum: new Date(2023, 1, 18),
            maximum: new Date(2023, 7, 18),
            valueType: 'DateTime',
            labelFormat: 'MMM d',
            ...
            mode: 'X',
            toolbarItems: ['Pan', 'Reset']
        }} zoomComplete={zoomComplete.bind(this)} chartMouseLeave={chart3MouseLeave.bind(this)} chartMouseMove={chart3MouseMove.bind(this)} chartMouseUp={chart3MouseUp.bind(this)} load={load.bind(this)} loaded={onChartLoad3.bind(this)} titleStyle={{ textAlignment: 'Near' }} tooltip={{ enable: true, fadeOutDuration: Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>$${point.y}</b><br>${point.x} 2023', enableMarker: false }} crosshair={{ enable: true, lineType: 'Vertical', dashArray: '2,2' }} title="US to SGD">
                            <Inject services={[AreaSeries, LineSeries, DataLabel, DateTime, Tooltip, Zoom, Highlight, Legend, Selection, Crosshair]}/>
                            <SeriesCollectionDirective>
                    ...
                    <div className="col">
                        <ChartComponent id="container4" ref={chart => chart4 = chart} style={{ textAlign: 'center' }} primaryXAxis={{
            minimum: new Date(2023, 1, 18),
            maximum: new Date(2023, 7, 18),
            valueType: 'DateTime',
            labelFormat: 'MMM d',
            ...
            mode: 'X',
            toolbarItems: ['Pan', 'Reset']
        }} zoomComplete={zoomComplete.bind(this)} chartMouseLeave={chart4MouseLeave.bind(this)} chartMouseMove={chart4MouseMove.bind(this)} chartMouseUp={chart4MouseUp.bind(this)} load={load.bind(this)} loaded={onChartLoad4.bind(this)} titleStyle={{ textAlignment: 'Near' }} tooltip={{ enable: true, fadeOutDuration: Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>₹${point.y}</b><br>${point.x} 2023', enableMarker: false }} crosshair={{ enable: true, lineType: 'Vertical', dashArray: '2,2' }} title="US to INR">
                            <Inject services={[AreaSeries, LineSeries, DataLabel, DateTime, Tooltip, Zoom, Highlight, Legend, Selection, Crosshair]}/>
                            <SeriesCollectionDirective>
