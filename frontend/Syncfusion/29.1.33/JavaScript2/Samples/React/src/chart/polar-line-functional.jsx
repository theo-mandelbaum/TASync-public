...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, Tooltip, Legend, DataLabel, LineSeries, Category, PolarSeries, RadarSeries, Highlight } from '@syncfusion/ej2-react-charts';
    ...
    return (<div className='control-pane'>
            ...
            <div className='control-section row'>
                <div className='col-md-8'>
                    <ChartComponent id='charts' ref={chart => chartInstance = chart} primaryXAxis={{
            title: 'Months',
            valueType: 'Category',
            ...
            labelFormat: '{value}°C'
        }} title='Alaska Weather Statistics - 2016' loaded={onChartLoad.bind(this)} legendSettings={{ enableHighlight: true }} tooltip={{ enable: true, enableHighlight: true }}>
                        <Inject services={[LineSeries, Legend, DataLabel, Category, PolarSeries, RadarSeries, Tooltip, Highlight]}/>
                        <SeriesCollectionDirective>
                            <SeriesDirective dataSource={data1} xName='x' yName='y' name='Germany' type='Polar' marker={{
            visible: true, height: 7, width: 7, shape: 'Pentagon', isFilled: true
        }} width={2}>
                            </SeriesDirective>
                            <SeriesDirective dataSource={data2} xName='x' yName='y' name='England' type='Polar' marker={{
            visible: true, height: 7, width: 7, shape: 'Pentagon', isFilled: true
        }} width={2}>
                            </SeriesDirective>
                        </SeriesCollectionDirective>
