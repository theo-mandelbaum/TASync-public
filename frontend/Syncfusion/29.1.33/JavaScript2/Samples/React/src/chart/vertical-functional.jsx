...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, ColumnSeries, Legend, LineSeries, Category, AxesDirective, AxisDirective, Tooltip } from '@syncfusion/ej2-react-charts';
...
const VerticalChart = () => {
    ...
    const onChartLoad = (args) => {
        let chart = document.getElementById('charts-vertical');
