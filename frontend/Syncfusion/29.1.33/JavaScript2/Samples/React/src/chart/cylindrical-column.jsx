...
import { ChartComponent, ColumnSeries, Category, DataLabel, Tooltip, SeriesDirective, SeriesCollectionDirective, Inject, Legend } from '@syncfusion/ej2-react-charts';
import { Browser } from '@syncfusion/ej2-base';
import { SampleBase } from '../common/sample-base';
import { loadChartTheme } from './theme-color';
export let cylindricalData = [
    ...
    render() {
        return (<div className='control-pane'>
                <div className='control-section'>
                    <ChartComponent id='charts' style={{ textAlign: "center" }} chartArea={{ border: { width: 0 } }} title='Year-wise Renewable Energy Generation Trends in India' subTitle='Source: wikipedia.org' primaryXAxis={{
                valueType: 'Category',
                interval: 1,
            ...
            }} legendSettings={{ visible: false }} load={this.load.bind(this)} loaded={this.onChartLoad.bind(this)} width={Browser.isDevice ? '100%' : '75%'}>
                        <Inject services={[ColumnSeries, Category, DataLabel, Tooltip, Legend]}/>
                        <SeriesCollectionDirective>
                            <SeriesDirective dataSource={cylindricalData} columnFacet='Cylinder' type='Column' name='India' xName='year' yName='energy' columnSpacing={0.3}>
                            </SeriesDirective>
                        </SeriesCollectionDirective>
                    </ChartComponent>
                </div>
