...
var themes = ['bootstrap5', 'bootstrap5dark', 'tailwind', 'tailwinddark', 'material', 'materialdark', 'bootstrap4', 'bootstrap', 'bootstrapdark', 'fabric', 'fabricdark', 'highcontrast', 'fluent', 'fluentdark', 'material3', 'material3dark', 'fluent2', 'fluent2highcontrast', 'fluent2dark'];
...
var Zooming = function () {
    ...
    for (i = 1; i < data.length; i++) {
        point1 = { x: new Date(1941, i + 2, i), y: data[i] / 1000 - 0.5 };
        series1.push(point1);
    }
    var data1 = series1;
    return (React.createElement("div", { className: 'control-pane' },
        ...
        React.createElement("div", { className: 'control-section' },
            React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', style: { textAlign: "center" }, primaryXAxis: { valueType: 'DateTime', majorGridLines: { width: 0 }, majorTickLines: { width: 0 }, scrollbarSettings: { enableZoom: false, position: 'Bottom' } }, primaryYAxis: { title: 'Temperature Anomaly (°C)', labelFormat: '{value}°C', majorTickLines: { width: 0 }, lineStyle: { width: 0 }, enableScrollbarOnZooming: false }, chartArea: { border: { width: 0 } }, zoomSettings: { enableSelectionZooming: true, enableMouseWheelZooming: true, enableDeferredZooming: false, enableScrollbar: true, enablePinchZooming: true, enableAnimation: true, mode: 'X', showToolbar: true, toolbarPosition: { y: -60, draggable: true } }, load: load.bind(_this), loaded: onChartLoad.bind(_this), margin: { top: 20 }, tooltip: { enable: true, showNearestTooltip: true, header: '<b>${point.x}</b>', format: 'Temperature: <b>${point.y}</b>', enableHighlight: true }, title: ej2_base_1.Browser.isDevice ? 'Monthly Temperature Anomalies' : 'Global Warming: Monthly Temperature Anomalies', titleStyle: { textAlignment: ej2_base_1.Browser.isDevice ? 'Near' : 'Center' }, width: ej2_base_1.Browser.isDevice ? '100%' : '80%' },
                React.createElement(ej2_react_charts_1.Inject, { services: [ej2_react_charts_1.LineSeries, ej2_react_charts_1.DateTime, ej2_react_charts_1.Zoom, ej2_react_charts_1.Crosshair, ej2_react_charts_1.Tooltip, ej2_react_charts_1.ScrollBar] }),
                React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: data1, xName: 'x', yName: 'y', type: 'Line' })))),
        React.createElement("div", { id: "action-description" },
            React.createElement("p", null, "This sample demonstrates the zooming and panning features of the chart, allowing users to explore data interactively.")),
        React.createElement("div", { id: "description" },
            React.createElement("p", null,
                "The chart component supports four types of zooming, which can be configured using the ",
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/documentation/api/chart/zoomSettingsModel/#enableselectionzooming", "aria-label": "Navigate to the enableSelectionZooming property reference for TypeScript Chart ZoomSettings" }, "enableSelectionZooming"),
                ", ",
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/documentation/api/chart/zoomSettingsModel/#enablepinchzooming", "aria-label": "Navigate to the enablePinchZooming property reference for TypeScript Chart ZoomSettings" }, "enablePinchZooming"),
                ", ",
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/documentation/api/chart/zoomSettingsModel/#enablemousewheelzooming", "aria-label": "Navigate to the enableMouseWheelZooming property reference for TypeScript Chart ZoomSettings" }, "enableMouseWheelZooming"),
                ", and ",
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/documentation/api/chart/zoomSettingsModel/#enabledeferredzooming", "aria-label": "Navigate to the enableDeferredZooming property reference for TypeScript Chart ZoomSettings" }, "enableDeferredZooming"),
                " properties. This sample demonstrates the following zooming and panning behaviors:"),
            React.createElement("ul", null,
                React.createElement("li", null,
                    React.createElement("b", null, "Selection Zooming"),
                    " : Click and drag the mouse over the chart area to enable selection zooming."),
                React.createElement("li", null,
                    React.createElement("b", null, "Toolbar"),
                    " : Hover over the toolbar at the top-right corner of the chart area to switch between zooming and panning."),
                React.createElement("li", null,
                    React.createElement("b", null, "Pinch Zooming"),
                    " : Pinch in or pinch out on the chart area to zoom in or out on touch-enabled devices."),
                React.createElement("li", null,
                    React.createElement("b", null, "Panning"),
                    " : Touch and drag to pan the chart."),
                React.createElement("li", null,
                    React.createElement("b", null, "Reset Zoom"),
                    " : Double-tap to reset the zoomed chart.")),
            React.createElement("p", null,
                "The chart also supports different zooming modes, which can be configured using the ",
                React.createElement("a", { target: "_blank", href: "http://ej2.syncfusion.com/documentation/chart/api-zoomSettings.html#mode-zoommode", "aria-label": "Navigate to the mode property reference for TypeScript Chart ZoomSettings" }, "mode"),
                " property."),
            React.createElement("ul", null,
                React.createElement("li", null,
                    React.createElement("b", null, "XY"),
                    " - Zoom the chart with respect to both axes."),
                React.createElement("li", null,
                    React.createElement("b", null, "X"),
                    " - Zoom the chart with respect to the horizontal axis only."),
                React.createElement("li", null,
                    React.createElement("b", null, "Y"),
                    " - Zoom the chart with respect to the vertical axis only.")),
            React.createElement("p", null,
                "The ",
                React.createElement("code", null, "toolbarPosition"),
                " property is used to adjust the position of the zoom toolbar. In this example, the toolbar is moved 60 pixels upward from its default position. The ",
                React.createElement("code", null, "draggable"),
                " property is used to drag and drop the zoom toolbar to any position within the chart area"),
            React.createElement("p", null,
                "The chart supports different scrollbar positions. By default, it appears next to the axis line, but you can adjust its placement using the ",
                React.createElement("code", null, "position"),
                " property of ",
                React.createElement("code", null, "scrollbarSettings"),
                ". This positioning allows better customization and flexibility in the chart's design."),
            React.createElement("p", null,
            ...
            React.createElement("p", null,
                ...
                " module using ",
                React.createElement("code", null, "Chart.Inject(Zoom)"),
                " method."),
            React.createElement("p", null,
                "More information on the Zooming can be found in this",
                React.createElement("a", { target: "_blank", href: "https://ej2.syncfusion.com/react/documentation/chart/zooming", "aria-label": "Navigate to the documentation for Zooming in TypeScript Chart control" }, " documentation section"),
                "."))));
};
