...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, LineSeries, ScatterSeries, SplineSeries, Tooltip, Legend, Inject, Highlight } from '@syncfusion/ej2-react-charts';
...
const AxisCrossing = () => {
    ...
    let checkboxElement = useRef(null);
    let numericValue = useRef(null);
    let droplist = [
        { value: 'X' },
        { value: 'Y' },
    ];
