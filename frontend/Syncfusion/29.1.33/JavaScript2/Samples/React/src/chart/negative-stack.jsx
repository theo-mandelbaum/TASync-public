...
import { ChartComponent, SeriesCollectionDirective, SeriesDirective, Inject, Legend, Category, StackingBarSeries, Tooltip, DataLabel, Highlight } from '@syncfusion/ej2-react-charts';
import { loadChartTheme } from './theme-color';
import { SampleBase } from '../common/sample-base';
import { Browser } from '@syncfusion/ej2-base';
;
let negativeStackData = [
...
export class NegativeStack extends SampleBase {
    ...
    ;
    tooltipRender(args) {
        const ageGroup = args.point.x;
        const dataPoint = negativeStackData.find((d) => d.age === ageGroup);
