...
const ClickAddPoint = () => {
    ...
    return (<div className='control-pane'>
            ...
            <div className='control-section'>
                <ChartComponent id='AddPoint' ref={chartInstance} style={{ textAlign: "center" }} primaryXAxis={{
            edgeLabelPlacement: 'Shift',
            rangePadding: 'Additional',
            majorGridLines: { width: 0 }
        }} primaryYAxis={{
            title: 'Value', interval: 20, lineStyle: { width: 0 }, majorTickLines: { width: 0 }
        }} chartMouseClick={chartMouseClick.bind(this)} axisRangeCalculated={axisRangeCalculated.bind(this)} tooltip={{ enable: true, enableHighlight: true }} chartArea={{ border: { width: 0 } }} load={load.bind(this)} loaded={loaded.bind(this)} width={Browser.isDevice ? '100%' : '70%'} title='User supplied data'>
