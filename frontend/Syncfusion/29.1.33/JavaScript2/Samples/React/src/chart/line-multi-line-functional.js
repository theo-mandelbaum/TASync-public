...
exports.multiColoredLineData = void 0;
/**
...
var LineMultiLine = function () {
    ...
    return (React.createElement("div", { className: "control-pane" },
        ...
        React.createElement("div", { className: "control-section" },
            React.createElement(ej2_react_charts_1.ChartComponent, { id: "charts", style: { textAlign: 'center' }, primaryXAxis: { valueType: 'DateTime', labelFormat: 'y', intervalType: 'Years', minimum: new Date(1895, 0, 1), maximum: new Date(2025, 0, 1), edgeLabelPlacement: 'Shift', majorGridLines: { width: 0 } }, primaryYAxis: { labelFormat: '{value}°F', minimum: 20, maximum: 40, interval: 4, title: 'Mean Temperature (°F)', lineStyle: { width: 0 }, majorTickLines: { width: 0 }, minorTickLines: { width: 0 } }, tooltip: { enable: true, showNearestTooltip: true, enableAnimation: false, header: '<b>Year: ${point.x}</b>', format: 'Avg Temp : <b>${point.y}</b>', enableHighlight: true }, legendSettings: { visible: false }, chartArea: { border: { width: 0 } }, load: load.bind(_this), width: ej2_base_1.Browser.isDevice ? '100%' : '75%', title: "U.S. Historical Average Temperature (1895\u20132025)", subTitle: 'Source: ncei.noaa.gov', loaded: onChartLoad.bind(_this) },
