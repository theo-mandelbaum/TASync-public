...
const UpdateSpline = () => {
    ...
    return (<div className='control-pane'>
            ...
            <div className='control-section'>
                <ChartComponent id='spline' style={{ textAlign: "center" }} primaryXAxis={{ valueType: 'DateTime', edgeLabelPlacement: Browser.isDevice ? 'None' : 'Shift', majorGridLines: { width: 0 }, labelRotation: Browser.isDevice ? 45 : 0, interval: 7, plotOffsetRight: 30, labelIntersectAction: 'Hide' }} primaryYAxis={{ title: 'Value', lineStyle: { width: 0 }, majorTickLines: { width: 0 }, interval: 20 }} axisRangeCalculated={axisRangeCalculated.bind(this)} chartArea={{ border: { width: 0 } }} load={load.bind(this)} loaded={loaded.bind(this)} width={Browser.isDevice ? '100%' : '75%'} title='Live data'>
