...
function InversedAxis() {
    ...
    return (<div className='control-pane'>
        ...
        }} pointRender={pointRender} chartArea={{ border: { width: 0 } }} legendSettings={{ visible: false }} title='Exchange Rate (INR per USD)' width={Browser.isDevice ? '100%' : '75%'} loaded={onChartLoad.bind(this)} tooltip={{
            enable: true
        }}>
