...
exports.SmartAxisLabels = exports.data1 = exports.pointRender = void 0;
/**
                ...
                React.createElement("div", { className: 'col-md-8' },
                    React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', ref: function (chart) { return _this.chartInstance = chart; }, style: { textAlign: "center" }, primaryXAxis: {
                        ...
                        React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
                            React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: exports.data1, xName: 'x', yName: 'y', name: "Users", type: 'Column', marker: { dataLabel: { visible: true, position: ej2_base_1.Browser.isDevice ? 'Outer' : 'Top', format: "{value}M", font: { fontWeight: '600', color: ej2_base_1.Browser.isDevice ? '#404041' : '#ffffff' } } } })))),
                            ...
                            React.createElement("tbody", null,
                                ...
                                React.createElement("tr", { style: { height: '50px' } },
                                    ...
                                    React.createElement("td", null,
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "120px", id: "selchange", change: this.change.bind(this), ref: function (d) { return _this.dropElement = d; }, dataSource: this.droplist, fields: { text: 'value', value: 'value' }, value: "Hide" })))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", null,
                                        React.createElement("div", null,
                                            "Edge Label",
                                ...
                                React.createElement("tr", { style: { height: '50px' } },
                                    ...
                                    React.createElement("td", { style: { width: '40%' } },
                                        React.createElement("div", null,
                                            React.createElement("input", { type: "checkbox", id: "trimmode", defaultChecked: false, onChange: this.trim.bind(this), style: { marginLeft: '-5px' }, ref: function (d) { return _this.checkElement = d; }, "aria-labelledby": "Checkbox unchecked" })))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", { style: { width: '60%' } },
                                        React.createElement("div", { id: "labelWidth" }, "Maximum Label Width:")),
                                    React.createElement("td", { style: { padding: 10, width: '40%' } },
                                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { width: 120, value: 34, min: 1, change: this.xwid.bind(this), ref: function (d) { return _this.widthElement = d; }, "aria-labelledby": "Text" })))))))),
