    ...
    render() {
        return (<div className="control-pane">
                ...
                <div className="control-section">
                    ...
                    <AccumulationChartComponent id='pie-chart' style={{ textAlign: 'center' }} title='Browser Market Share' load={this.load.bind(this)} enableBorderOnMouseMove={false} width={Browser.isDevice ? '100%' : '75%'} pointRender={this.onPointRender.bind(this)} tooltip={{ enable: true, format: '<b>${point.x}</b><br>Browser Share: <b>${point.y}%</b>', header: "", enableHighlight: true }} legendSettings={{ visible: false }}>
