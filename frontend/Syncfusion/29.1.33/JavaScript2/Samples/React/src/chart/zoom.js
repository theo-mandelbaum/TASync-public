...
var data1 = series1;
var themes = ['bootstrap5', 'bootstrap5dark', 'tailwind', 'tailwinddark', 'material', 'materialdark', 'bootstrap4', 'bootstrap', 'bootstrapdark', 'fabric', 'fabricdark', 'highcontrast', 'fluent', 'fluentdark', 'material3', 'material3dark'];
    ...
    Zooming.prototype.render = function () {
        return (React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_charts_1.ChartComponent, { id: 'charts', style: { textAlign: "center" }, primaryXAxis: { valueType: 'DateTime', majorGridLines: { width: 0 }, majorTickLines: { width: 0 }, scrollbarSettings: { enableZoom: false } }, primaryYAxis: { title: 'Temperature', labelFormat: '{value}°C', majorTickLines: { width: 0 }, lineStyle: { width: 0 }, enableScrollbarOnZooming: false }, chartArea: { border: { width: 0 } }, margin: { top: 20 }, zoomSettings: { enableSelectionZooming: true, enableMouseWheelZooming: true, enableDeferredZooming: false, enableScrollbar: true, enablePinchZooming: true, mode: 'X', enableAnimation: true, showToolbar: true, toolbarPosition: { y: -60, draggable: true } }, load: this.load.bind(this), loaded: this.onChartLoad.bind(this), tooltip: { enable: true, showNearestTooltip: true, header: '<b>${point.x}</b>', format: 'Temperature: <b>${point.y}</b>', enableHighlight: true }, title: ej2_base_1.Browser.isDevice ? 'Monthly Temperature Anomalies' : 'Global Warming: Monthly Temperature Anomalies', titleStyle: { textAlignment: ej2_base_1.Browser.isDevice ? 'Near' : 'Center' }, width: ej2_base_1.Browser.isDevice ? '100%' : '80%' },
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample demonstrates the zooming and panning features of the charts.")),
