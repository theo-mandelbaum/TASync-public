...
const PieCornerRadius = () => {
    ...
    return (<div className='control-pane'>
            ...
            <div className='control-section row'>
                <AccumulationChartComponent id='pie-chart' title='Company Budget Distribution' load={load.bind(this)} style={{ textAlign: 'center' }} legendSettings={{ visible: false }} enableSmartLabels={true} enableAnimation={false} center={{ x: '50%', y: '50%' }} enableBorderOnMouseMove={false} width={Browser.isDevice ? '100%' : '75%'} tooltip={{ enable: true, header: '<b>Budget</b>', format: '${point.x}: <b>${point.y}%</b>', enableHighlight: true }} loaded={onChartLoad.bind(this)} pointRender={onPointRender.bind(this)}>
                    <Inject services={[AccumulationLegend, PieSeries, AccumulationTooltip, AccumulationDataLabel, AccumulationAnnotation]}/>
                    <AccumulationSeriesCollectionDirective>
                        <AccumulationSeriesDirective dataSource={chartData} name='Company Budget' xName='x' yName='y' type='Pie' innerRadius='50%' dataLabel={{
            visible: true,
            position: 'Outside',
            name: 'x',
            ...
            <div id="description">
                ...
                <p>
                    More information about the donut series can be found in this <a target="_blank" href="https://ej2.syncfusion.com/documentation/accumulation-chart/pie-dough-nut/#doughnut-chart" aria-label="Navigate to the documentation for Doughnut Chart in TypeScript Accumulation Chart control">documentation
                        section</a>.
                </p>
            </div>
        </div>);
