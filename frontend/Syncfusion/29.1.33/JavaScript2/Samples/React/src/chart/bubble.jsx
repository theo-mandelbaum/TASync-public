...
export class Bubble extends SampleBase {
    render() {
        return (<div className='control-pane'>
                ...
                crossesAt: 85,
                interval: 2.5
            }} width={Browser.isDevice ? '100%' : '75%'} title='World Countries Details' pointRender={pointRender} legendSettings={{ visible: false }} loaded={this.onChartLoad.bind(this)} tooltip={{
                enableMarker: false,
                enable: true,
                ...
                format: "Literacy Rate : <b>${point.x}%</b> <br/>GDP Annual Growth Rate : <b>${point.y}</b><br/>Population : <b>${point.size} Billion</b>"
                        ...
                        <SeriesCollectionDirective>
                            <SeriesDirective dataSource={data} type='Bubble' minRadius={3} maxRadius={8} tooltipMappingName='text' border={{ width: 2 }} xName='x' yName='y' size='size' marker={{ dataLabel: { visible: true, name: 'r', position: 'Middle', font: { fontWeight: '500', color: '#ffffff' } } }}>
                            </SeriesDirective>
                        </SeriesCollectionDirective>
                    </ChartComponent>
                </div>
