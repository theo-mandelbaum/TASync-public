...
exports.PolarLine = exports.data2 = exports.data1 = void 0;
/**
                        ...
                        React.createElement("table", { id: 'property', title: 'Properties', className: 'property-panel-table', style: { width: '100%' } },
                            React.createElement("tbody", null,
                                ...
                                React.createElement("tr", { style: { height: '50px' } },
                                    ...
                                    React.createElement("td", { style: { width: '40%' } },
                                        React.createElement("div", null,
                                            React.createElement("input", { type: "checkbox", id: "isClosed", defaultChecked: true, onChange: this.closed.bind(this), style: { marginLeft: '-5px' }, ref: function (d) { return _this.checkElement = d; }, "aria-labelledby": "Checkbox checked" })))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", { style: { width: '60%' } },
                                        React.createElement("div", { id: "st-lbl" }, "Start Angle: 0")),
                                    React.createElement("td", { style: { width: '40%' } },
                                        React.createElement("div", { "data-role": "rangeslider" },
                                            React.createElement("input", { type: "range", defaultValue: "0", min: "0", max: "360", id: "startangle", onChange: this.startAngle.bind(this), style: { marginLeft: '-5px' }, ref: function (d) { return _this.startangle = d; }, "aria-labelledby": "Slider" })))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", { style: { width: '60%' } },
                                        React.createElement("div", { id: "inversed" }, "Inversed: ")),
                                    React.createElement("td", { style: { width: '40%' } },
                                        React.createElement("div", null,
                                            React.createElement("input", { type: "checkbox", id: "isinversed", onChange: this.isInversed.bind(this), style: { marginLeft: '-5px' }, ref: function (d) { return _this.inversed = d; }, "aria-labelledby": "Checkbox unchecked" }))))))))),
