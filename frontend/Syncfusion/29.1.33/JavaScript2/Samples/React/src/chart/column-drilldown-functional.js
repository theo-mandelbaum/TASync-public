...
var ColumnDrilldown = function () {
    ...
    var title = 'Top Populated Continents of 2023';
    var subTitle = 'A Look at Population Rankings and Trends in 2023';
    var categoryText = '';
    ...
    var onAxisLabelClick = function (args) {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        ...
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { id: "link" },
                React.createElement("a", { id: "category", style: { visibility: clicked ? 'visible' : 'hidden', display: 'inline-block', cursor: 'pointer' }, onClick: goBack }, "Population"),
                React.createElement("p", { style: { visibility: clicked ? 'visible' : 'hidden', display: 'inline-block' }, id: "symbol" }, "\u00A0>>\u00A0"),
                React.createElement("p", { id: "text", style: { visibility: clicked ? 'visible' : 'hidden', display: 'inline-block' } }, categoryText)),
            React.createElement(ej2_react_charts_1.ChartComponent, { id: "drilldown", style: { textAlign: "center" }, ref: chartRef, primaryXAxis: {
                    valueType: 'Category',
                    ...
                    majorTickLines: { width: 0 },
                    lineStyle: { width: 0 }
                }, width: ej2_base_1.Browser.isDevice ? '100%' : '75%', title: title, subTitle: subTitle, tooltip: { enable: true, header: "<b>Population - 2023</b>", format: '${point.x}: <b>${point.y}M</b>' }, legendSettings: { visible: false }, chartArea: { border: { width: 0 } }, load: onLoad.bind(_this), loaded: loaded.bind(_this), pointRender: onPointRender, pointClick: pointClick, axisLabelClick: onAxisLabelClick, tooltipRender: tooltipRender.bind(_this) },
                ...
                React.createElement(ej2_react_charts_1.SeriesCollectionDirective, null,
                    React.createElement(ej2_react_charts_1.SeriesDirective, { dataSource: data, xName: 'drilldown', yName: 'y', name: 'Population', type: 'Column', cornerRadius: { topLeft: 5, topRight: 5 }, marker: {
                            dataLabel: {
                                visible: true,
                                position: 'Outer',
                            }
...
exports.default = ColumnDrilldown;
