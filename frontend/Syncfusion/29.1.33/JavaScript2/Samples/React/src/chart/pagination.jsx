...
export class Pagination extends SampleBase {
    ...
    weather = 'Sunny';
    isFahrenheit = false;
    updateChart = (buttonId, img, tempCount, chartDay, zoomPos, zoomFactor, rainfall, moistureLevel, breezeSpeed, weatherCondition) => {
        this.image = img;
    ...
    annotationRender = (args) => {
        if (args.content.id === 'container_Annotation_0') {
            ...
            const tempDisplay = this.isFahrenheit ? this.temperatureData[buttonIndex].fahrenheit : this.temperatureData[buttonIndex].celsius;
    ...
    render() {
      ...
      <div className='control-section' style={{ textAlign: "center" }}>
        <ChartComponent id='container' style={{ textAlign: "center" }} ref={chartInstance => this.chartInstance = chartInstance} primaryXAxis={{
                interval: 1,
                zoomFactor: 0.175,
                zoomPosition: 0,
            ...
            }} height='70%' width={Browser.isDevice ? '100%' : '75%'} chartArea={{ border: { width: 0 } }} annotationRender={this.annotationRender.bind(this)} chartMouseClick={this.chartMouseClick.bind(this)} load={this.load.bind(this)} resized={this.resize.bind(this)}>
      ...
      <div id="description">
        ...
        <p>
          More information on zooming and panning can be found in this <a target="_blank" href="https://ej2.syncfusion.com/documentation/chart/zooming/" aria-label="Navigate to the documentation for Zooming in TypeScript Chart control">documentation
            section</a>.
        </p>
      </div>
    </div>);
