...
var Pagination = function () {
    ...
    var updateChart = function (buttonId, img, tempCount, chartDay, zoomPos, zoomFactor, rainfall, moistureLevel, breezeSpeed, weatherCondition) {
        image = img;
        count = tempCount;
        day = chartDay;
        rainfalls = rainfall;
    ...
    var chartMouseClick = function (args) {
        if (chartInstance.current) {
            ...
            if (index !== -1 && temperatureData[index]) {
                var _a = temperatureData[index], celsius = _a.celsius, fahrenheit = _a.fahrenheit;
    ...
    var annotationRender = function (args) {
        if (args.content.id === 'container_Annotation_0') {
            ...
            args.content.innerHTML = ej2_base_1.Browser.isDevice ? '<div id="days" style="text-align: right; font-size: 9px; opacity: 0.7;">' + day + '</div>' : '<div id="days" style="text-align: right; font-size: 15px; opacity: 0.7;">' + day + '</div>';
        }
    ...
    return (React.createElement("div", { className: 'control-pane', style: { textAlign: "center" } },
        ...
        React.createElement("div", { className: 'control-section', style: { textAlign: "center" } },
            React.createElement(ej2_react_charts_1.ChartComponent, { id: 'container', style: { textAlign: "center" }, ref: chartInstance, primaryXAxis: {
                ...
                }, height: '70%', width: ej2_base_1.Browser.isDevice ? '100%' : '75%', chartArea: { border: { width: 0 } }, annotationRender: annotationRender.bind(_this), chartMouseClick: chartMouseClick.bind(_this), load: load.bind(_this), resized: resize.bind(_this) },
            ...
            React.createElement("div", { id: "chart-button-container" },
                React.createElement("button", { id: "friday", className: "chart-custom-button active", onClick: function () { buttonIndex = 0; updateChart('friday', 'sunny_image', 12, 'Friday', 0, 0.175, 0, 30, 5, 'Sunny'); } },
                ...
                React.createElement("button", { id: "saturday", className: "chart-custom-button", onClick: function () { buttonIndex = 1; updateChart('saturday', 'sunny_image', 16, 'Saturday', 0.206, 0.175, 0, 35, 6, 'Sunny'); } },
                ...
                React.createElement("button", { id: "sunday", className: "chart-custom-button", onClick: function () { buttonIndex = 2; updateChart('sunday', 'cloudy', 18, 'Sunday', 0.413, 0.175, 1, 40, 4, 'Cloudy'); } },
                ...
                React.createElement("button", { id: "monday", className: "chart-custom-button", onClick: function () { buttonIndex = 3; updateChart('monday', 'cloudy', 16, 'Monday', 0.620, 0.175, 2, 45, 5, 'Cloudy'); } },
                ...
                React.createElement("button", { id: "tuesday", className: "chart-custom-button", onClick: function () { buttonIndex = 4; updateChart('tuesday', 'rainy', 18, 'Tuesday', 0.827, 0.175, 5, 50, 6, 'Rainy'); } },
