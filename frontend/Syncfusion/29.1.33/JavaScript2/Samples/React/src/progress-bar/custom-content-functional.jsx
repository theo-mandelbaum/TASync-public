...
const ProgressBarCustomContents = () => {
    ...
    const content1 = `<img src="src/progress-bar/images/material-pause.svg" alt="Pause Icon"></img>`;
    const content2 = `<img src="src/progress-bar/images/material-Download.svg" alt="Download Icon"></img>`;
