        ...
        return (<div className='control-pane'>
                ...
                <div className='control-section'>
                    <div className="row linear-parent">
                        <div id="success" className="linear-progress">
                            <ProgressBarComponent id="progress-success" ref={linear1 => this.linearOne = linear1} type='Linear' height='40' width='100%' showProgressValue={true} value={40} trackThickness={24} progressThickness={24} labelStyle={{
                ...
                delay: 0,
                        ...
                        <div id="info" className="linear-progress">
                            <ProgressBarComponent id="progress-info" ref={linear2 => this.linearTwo = linear2} type='Linear' height='40' width='100%' showProgressValue={true} value={50} trackThickness={24} progressThickness={24} labelStyle={{
                textAlignment: 'Center',
                ...
                delay: 0,
                        ...
                        <div id="warning" className="linear-progress">
                            <ProgressBarComponent id="progress-warning" ref={linear3 => this.linearThree = linear3} type='Linear' height='40' width='100%' showProgressValue={true} value={60} trackThickness={24} progressThickness={24} labelStyle={{
                textAlignment: 'Center',
                ...
                delay: 0,
                        ...
                        <div id="danger" className="linear-progress">
                            <ProgressBarComponent id="progress-danger" ref={linear4 => this.linearFour = linear4} type='Linear' height='40' width='100%' showProgressValue={true} value={70} trackThickness={24} progressThickness={24} labelStyle={{
                textAlignment: 'Center',
