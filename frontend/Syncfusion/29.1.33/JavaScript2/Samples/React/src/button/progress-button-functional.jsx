...
const ProgressButton = () => {
    ...
    const spinRight = { position: 'Right' };
    const spinTop = { position: 'Top' };
    const spinBottom = { position: 'Bottom' };
    const spinCenter = { position: 'Center' };
    const zoomOut = { effect: 'ZoomOut' };
    const slideLeft = { effect: 'SlideLeft' };
    const slideRight = { effect: 'SlideRight' };
    const zoomIn = { effect: 'ZoomIn' };
    const duration = 4000;
    const [contractCssClass, setContractCssClass] = useState("e-success e-small");
    const contractBegin = () => {
                ...
                <div className='progress-button-section'>
                    <div id='progress-button-control'>
                        ...
                        <div className='row'>
                            <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
                                <div className="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                                    <ProgressButtonComponent id="roundbtn" spinSettings={spinCenter} animationSettings={zoomOut} cssClass="e-round e-small e-success" iconCss="e-btn-sb-icons e-play-icon"></ProgressButtonComponent>
                                </div>

                                <div className="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                                    <ProgressButtonComponent id="contract" content="Contract" enableProgress cssClass={contractCssClass} begin={contractBegin} end={contractEnd}></ProgressButtonComponent>
                                </div>
                            </div>

                            <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
                                <div className="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                                    <ProgressButtonComponent content="Slide Left" enableProgress spinSettings={spinCenter} animationSettings={slideLeft} cssClass="e-flat e-success"></ProgressButtonComponent>
                                </div>

                                <div className="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                                    <ProgressButtonComponent content="Slide Right" enableProgress spinSettings={spinCenter} animationSettings={slideRight} cssClass="e-outline e-success"></ProgressButtonComponent>
                                </div>
                            </div>
                        </div>
                        <div className='row'>
                            <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
                                <div className="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                                    <ProgressButtonComponent id="zoomin" content="Zoom In" enableProgress spinSettings={spinCenter} animationSettings={zoomIn} cssClass="e-round-corner e-danger"></ProgressButtonComponent>
                                </div>

                                <div className="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                                    <ProgressButtonComponent content="Zoom Out" enableProgress spinSettings={spinCenter} animationSettings={zoomOut} cssClass="e-small e-danger"></ProgressButtonComponent>
                                </div>
                            </div>

                            <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
                                <div className="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                                    <ProgressButtonComponent content="Download" enableProgress duration={duration} cssClass="e-hide-spinner e-progress-top" iconCss="e-btn-sb-icons e-download-icon"></ProgressButtonComponent>
                                </div>
