                    ...
                    <div id='button-control'>
                        <div className='row'>
                            ...
                            <div className="col-xs-6 col-sm-6 col-lg-6 col-md-6">
                                ...
                                <div className="col-xs-12 col-sm-12 col-lg-6 col-md-6">
                                    <ButtonComponent cssClass='e-flat e-primary' iconCss={play ? 'e-btn-sb-icons e-play-icon' : 'e-btn-sb-icons e-pause-icon'} onClick={togglePlay}>{play ? 'Play' : 'Pause'}</ButtonComponent>
                                </div>
                            </div>
