...
const LocalData = () => {
    ...
    const fields = { dataSource: data.hierarchicalData, value: 'code', text: 'name', child: 'countries' };
    // Self-referential list data source for Dropdown Tree component
    const listfields = { dataSource: data.localData, value: 'id', parentValue: 'pid', text: 'name', hasChildren: 'hasChild' };
