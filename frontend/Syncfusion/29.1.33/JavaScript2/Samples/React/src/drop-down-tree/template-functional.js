...
var Templates = function () {
    ...
    var fields = { dataSource: data.templateData, value: 'id', parentValue: 'pid', text: 'name', hasChildren: 'hasChild' };
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section dropdowntree-templates' },
            React.createElement("div", { className: 'control_wrapper' },
                React.createElement(ej2_react_dropdowns_1.DropDownTreeComponent, { fields: fields, placeholder: "Select an employee", itemTemplate: itemTemplate, footerTemplate: footerTemplate, headerTemplate: headerTemplate, valueTemplate: valueTemplate, popupHeight: "270px", cssClass: "ddt-template", width: "100%" }))),
