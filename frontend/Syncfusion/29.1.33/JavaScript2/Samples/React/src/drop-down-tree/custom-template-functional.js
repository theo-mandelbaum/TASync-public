...
var CustomTemplate = function () {
    ...
    var data = dataSource;
    var fields = { dataSource: data.customTemplateData, value: 'id', parentValue: 'pid', text: 'name', hasChildren: 'hasChild' };
    var showCheckBox = true;
    var treeSettings = { autoCheck: true };
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'col-lg-12 control-section dropdowntree-custom' },
            React.createElement("div", { className: 'control_wapper' },
                React.createElement(ej2_react_dropdowns_1.DropDownTreeComponent, { fields: fields, treeSettings: treeSettings, customTemplate: customTemplate, showCheckBox: showCheckBox, mode: "Custom", placeholder: "Select items", popupHeight: "200px" }))),
