...
export class LocalData extends SampleBase {
    ...
    fields = { dataSource: this.data.hierarchicalData, value: 'code', text: 'name', child: 'countries' };
    // Self-referential list data source for Dropdown Tree component
    listfields = { dataSource: this.data.localData, value: 'id', parentValue: 'pid', text: 'name', hasChildren: 'hasChild' };
    render() {
