    ...
    return (<div className='control-pane'>
                        ...
                        <thead></thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td style={padding10}>
                                        <SparklineComponent load={load.bind(this)} id='spark1-container' height='100px' width='170px' lineWidth={1} type='Column' valueType='DateTime' fill='#3C78EF' tooltipSettings={{
            ...
            { xDate: new Date(2018, 0, 31), x: 22, yval: 7 }
                                ...
                                <tr>
                                    ...
                                    <td style={padding10}>
                                        <SparklineComponent load={load.bind(this)} id='spark2-container' height='100px' width='170px' lineWidth={1} type='Column' valueType='Category' fill='#3C78EF' tooltipSettings={{
            ...
            { x: 11, xval: 'Elizabeth', yval: 57 }
                                ...
                                <tr>
                                    ...
                                    <td style={padding10}>
                                        <SparklineComponent load={load.bind(this)} id='spark3-container' height='100px' width='170px' lineWidth={1} type='Column' valueType='Numeric' fill='#3C78EF' tooltipSettings={{
