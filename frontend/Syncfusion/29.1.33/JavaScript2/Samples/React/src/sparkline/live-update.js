...
var LiveUpdate = /** @class */ (function (_super) {
    ...
    LiveUpdate.prototype.updateSparkline1 = function (args) {
        ...
        setTimeout(function () {
            ...
            _this.timer1 = setInterval(function () { return _this.update(); }, 500);
        }, 500);
    };
    LiveUpdate.prototype.updateSparkline2 = function (args) {
        ...
        setTimeout(function () {
            ...
            _this.timer2 = setInterval(function () { return _this.update2(); }, 500);
        }, 500);
    };
    LiveUpdate.prototype.updateSparkline3 = function (args) {
        ...
        setTimeout(function () {
            ...
            _this.timer3 = setInterval(function () { return _this.update1(); }, 500);
        }, 500);
    };
    LiveUpdate.prototype.updateSparkline4 = function (args) {
        ...
        setTimeout(function () {
            ...
            _this.timer4 = setInterval(function () { return _this.update4(); }, 500);
        }, 500);
    };
