                        ...
                        React.createElement("tbody", null,
                            React.createElement("tr", null,
                                React.createElement("td", { style: { "textAlign": "center" } },
                                    React.createElement("div", { style: { "textAlign": "center", "fontSize": "14px", "fontWeight": "600", "fontFamily": "Roboto" } }, "Mean working hours for a month"),
                                    React.createElement("div", null,
                                        React.createElement("i", null, "(DateTime axis)"))),
                                React.createElement("td", { style: padding10 },
                                    React.createElement(ej2_react_charts_1.SparklineComponent, { load: load.bind(this), id: 'spark1-container', height: '100px', width: '170px', lineWidth: 1, type: 'Column', valueType: 'DateTime', fill: '#3C78EF', tooltipSettings: {
                            ...
                            React.createElement("tr", null,
                                React.createElement("td", { style: { "textAlign": "center" } },
                                    React.createElement("div", { style: { "textAlign": "center", "fontSize": "14px", "fontWeight": "600", "fontFamily": "Roboto" } }, "Percentage of the students in a class"),
                                    React.createElement("div", null,
                                        React.createElement("i", null, "(Category axis)"))),
                                React.createElement("td", { style: padding10 },
                                    React.createElement(ej2_react_charts_1.SparklineComponent, { load: load.bind(this), id: 'spark2-container', height: '100px', width: '170px', lineWidth: 1, type: 'Column', valueType: 'Category', fill: '#3C78EF', tooltipSettings: {
                            ...
                            React.createElement("tr", null,
                                React.createElement("td", { style: { "textAlign": "center" } },
                                    React.createElement("div", { style: { "textAlign": "center", "fontSize": "14px", "fontWeight": "600", "fontFamily": "Roboto" } }, "Expenditure details of various trips"),
                                    React.createElement("div", null,
                                        React.createElement("i", null, "(Numeric axis)"))),
                                React.createElement("td", { style: padding10 },
                                    React.createElement(ej2_react_charts_1.SparklineComponent, { load: load.bind(this), id: 'spark3-container', height: '100px', width: '170px', lineWidth: 1, type: 'Column', valueType: 'Numeric', fill: '#3C78EF', tooltipSettings: {
