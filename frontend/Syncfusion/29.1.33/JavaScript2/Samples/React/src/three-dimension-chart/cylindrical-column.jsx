...
export class CylindricalColumn extends SampleBase {
    render() {
        return (<div className='control-pane'>
            ...
            }} rotation={10} tilt={18} depth={100} load={this.load.bind(this)} loaded={this.onChartLoad.bind(this)} pointRender={pointRender} axisLabelRender={this.axisLabelRender.bind(this)} width={Browser.isDevice ? '100%' : '75%'}>
