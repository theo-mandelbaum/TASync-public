...
import { Chart3DComponent, Chart3DSeriesCollectionDirective, Chart3DSeriesDirective, Inject, BarSeries3D, Category3D, Legend3D, Tooltip3D, Highlight3D } from '@syncfusion/ej2-react-charts';
    ...
    render() {
        return (<div className='control-pane'>
                ...
                <div className='control-section'>
                    <div>
                        <Chart3DComponent id='charts' style={{ textAlign: "center" }} legendSettings={{ enableHighlight: true }} rotation={25} tilt={18} depth={100} enableRotation={true} primaryXAxis={{ valueType: 'Category', labelPlacement: 'BetweenTicks' }} primaryYAxis={{ labelFormat: '{value}%', edgeLabelPlacement: 'Shift', maximum: 7, majorTickLines: { width: 0 } }} load={this.load.bind(this)} width={Browser.isDevice ? '100%' : '75%'} title='GDP percent by Country in 2017' loaded={this.onChartLoad.bind(this)} tooltip={{ enable: true }}>
