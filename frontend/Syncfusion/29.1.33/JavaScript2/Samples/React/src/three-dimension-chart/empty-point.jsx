    ...
    render() {
        return (<div className='control-pane'>
                <div className='control-section'>
                    <Chart3DComponent id='charts' style={{ textAlign: "center" }} title='Olympic Gold Medal Counts - Tokyo 2020' enableRotation={true} rotation={10} tilt={18} depth={100} primaryXAxis={{
            ...
            }} pointRender={pointRender} load={this.load.bind(this)} loaded={this.onChartLoad.bind(this)} width={Browser.isDevice ? '100%' : '75%'}>
                        <Inject services={[ColumnSeries3D, Category3D, Tooltip3D]}/>
                        <Chart3DSeriesCollectionDirective>
                            <Chart3DSeriesDirective dataSource={data} type='Column' xName='x' yName='y' name='Gold' columnSpacing={0.1}>
