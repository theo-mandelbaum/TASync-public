...
const Bar = () => {
    ...
    return (<div className='control-pane'>
            ...
            <div className='control-section'>
                <div>
                    <Chart3DComponent id='charts' style={{ textAlign: "center" }} legendSettings={{ enableHighlight: true }} rotation={22} depth={100} height='400' enableRotation={true} primaryXAxis={{ valueType: 'Category', labelPlacement: 'BetweenTicks' }} primaryYAxis={{ labelFormat: '{value}%', maximum: Browser.isDevice ? 8 : 7, interval: Browser.isDevice ? 2 : 1, edgeLabelPlacement: 'Shift' }} load={load.bind(this)} width={Browser.isDevice ? '100%' : '70%'} title='GDP Percentage by Country in 2017' loaded={onChartLoad.bind(this)} tooltip={{ enable: true }}>
