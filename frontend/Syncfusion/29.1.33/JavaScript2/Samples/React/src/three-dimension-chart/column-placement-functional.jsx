...
import { Chart3DComponent, Chart3DSeriesCollectionDirective, Chart3DSeriesDirective, Inject, ColumnSeries3D, Category3D, Tooltip3D, Legend3D, Highlight3D } from '@syncfusion/ej2-react-charts';
...
const ColumnPlacement = () => {
    ...
    return (<div className='control-pane'>
            ...
            <div className='control-section'>
                <Chart3DComponent id='charts' style={{ textAlign: "center" }} load={load.bind(this)} rotation={Browser.isDevice ? 5 : 25} depth={500} height='400' primaryXAxis={{
            valueType: 'Category', interval: 1,
            labelPlacement: 'BetweenTicks',
            labelRotation: -45
        }} primaryYAxis={{
            interval: Browser.isDevice ? 4 : 2
        }} enableSideBySidePlacement={false} title='Fruit Consumption by Individuals' tooltip={{ enable: true }} legendSettings={{ visible: true, enableHighlight: true }} width={Browser.isDevice ? '100%' : '75%'} loaded={onChartLoad.bind(this)}>
