...
const StackedBar100 = () => {
    ...
    return (<div className='control-pane'>
        ...
        }} enableRotation={true} rotation={22} height='400' depth={100} width={Browser.isDevice ? '100%' : '70%'} load={load.bind(this)} title='Motor Vehicle Production by Manufacturer' loaded={onChartLoad.bind(this)} tooltip={{ enable: true, format: '${point.x} : <b>${point.y} (${point.percentage}%)</b>' }}>
