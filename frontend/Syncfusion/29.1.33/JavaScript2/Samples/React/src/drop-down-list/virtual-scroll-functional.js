        ...
        React.createElement("div", { className: 'control-section' },
            React.createElement("div", { className: 'col-lg-6' },
                React.createElement("div", { className: 'drop-down-list-content', id: "local" },
                    ...
                    React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: "localdata", dataSource: records, placeholder: "e.g. Item 1", allowFiltering: false, enableVirtualization: true, fields: fields, popupHeight: "200px" },
            ...
            React.createElement("div", { className: 'col-lg-6' },
                React.createElement("div", { className: 'drop-down-list-content', id: "remote" },
                    ...
                    React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: "remotedata", dataSource: customerData, placeholder: "OrderId", allowFiltering: true, enableVirtualization: true, fields: customerField, popupHeight: "200px" },
                        React.createElement(ej2_react_dropdowns_1.Inject, { services: [ej2_react_dropdowns_1.VirtualScroll] })))),
            React.createElement("div", { className: 'col-lg-6' },
                React.createElement("div", { className: 'drop-down-list-content', id: "group" },
                    React.createElement("label", { className: "h4" }, "Grouping"),
                    React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: "groupdata", dataSource: records, placeholder: "e.g. Item 1", allowFiltering: true, enableVirtualization: true, fields: groupField, popupHeight: "200px" },
                        React.createElement(ej2_react_dropdowns_1.Inject, { services: [ej2_react_dropdowns_1.VirtualScroll] }))))),
