        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: "col-lg-8 control-section" },
                React.createElement("div", { className: "control-wrapper" },
                    React.createElement("div", { id: "default", style: { paddingTop: '75px' } },
                        React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: "games", dataSource: this.records, ref: function (dropdownlist) { _this.listObj = dropdownlist; }, allowObjectBinding: true, fields: this.fields, change: this.onChange.bind(this), placeholder: "Select a Item", popupHeight: "220px" })))),
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null,
                    "This sample demonstrates the object value binding functionalities of the DropDownList. Click the DropDownList element and select an item from the ",
                    React.createElement("code", null, "options"),
                    " list.The corresponding object value of the selected item is then assigned to the value property."),
                "In the property panel, the ",
