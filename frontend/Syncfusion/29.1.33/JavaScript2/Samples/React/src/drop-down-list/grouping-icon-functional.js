...
var Grouping = function () {
    ...
    return (React.createElement("div", { className: 'control-pane' },
        React.createElement("div", { className: 'control-section', id: 'dropIcon' },
            React.createElement("div", { className: 'col-lg-6' },
                React.createElement("div", { className: 'drop-down-list-content', id: "group" },
                    ...
                    React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: "vegetables", dataSource: vegetableData, fields: groupFields, placeholder: "Select a vegetable", popupHeight: "220px" }))),
            React.createElement("div", { className: 'col-lg-6' },
                React.createElement("div", { className: 'drop-down-list-content', id: "icon" },
                    React.createElement("label", { className: "h4" }, " Icons"),
                    React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: "icons", dataSource: socialMediaData, fields: iconFields, placeholder: "Select a social media", popupHeight: "220px" })))),
        ...
        React.createElement("div", { id: "description" },
            ...
            React.createElement("p", null,
                "The second DropDownList is populated with icons that is rendered by mapping the ",
