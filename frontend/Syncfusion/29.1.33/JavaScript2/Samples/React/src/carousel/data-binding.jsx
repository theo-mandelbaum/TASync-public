    ...
    render() {
        ...
        <div className='control-section db-carousel-section'>
          <div className='control carousel-sample'>
            ...
            <CarouselComponent cssClass="db-carousel" animationEffect="Fade" dataSource={this.productDetails} buttonsVisibility={this.showButtons} itemTemplate={this.productTemplate.bind(this)}>
            </CarouselComponent>
          </div></div>
