...
const Default = () => {
    ...
    return (<div className='control-pane'>
      ...
      <div id="description">
        ...
        <p>
          More information about React Carousel component can be found in this <a aria-label="Carousel getting started" target='_blank' href="https://ej2.syncfusion.com/documentation/carousel/getting-started/">documentation section</a>.
        </p>
      </div>
    </div>);
};
