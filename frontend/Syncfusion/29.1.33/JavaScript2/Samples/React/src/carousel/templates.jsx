    ...
    render() {
        ...
        <div className='control-section template-carousel-section'>
          <div className='control carousel-sample'>
            ...
            <CarouselComponent cssClass="templateCarousel" animationEffect="Fade" buttonsVisibility="Visible" indicatorsTemplate={this.indicatorTemplate.bind(this)} previousButtonTemplate={this.previousButtonTemplate.bind(this)} nextButtonTemplate={this.nextButtonTemplate.bind(this)}>
