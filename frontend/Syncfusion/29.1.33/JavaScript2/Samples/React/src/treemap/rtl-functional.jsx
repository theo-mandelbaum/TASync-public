...
const RTL = () => {
    ...
    return (<main><div className="control-pane">
            ...
            <div className="control-section">
                <TreeMapComponent load={load.bind(this)} id="treemap-container" ref={treemapInstance} palette={[
            "#5B244D",
            "#6F3953",
            " #87525A",
            "#A26F63",
            ...
            <div style={{ float: "right", marginRight: "10px" }}>
                Source:
                <a href="https://www.indexmundi.com/facts/visualizations/treemap#SL.UEM.TOTL.ZS:SL.UEM.TOTL.ZS" target="_blank">
                    www.indexmundi.com
                </a>
            </div>
        </div>
