...
exports.machineDataList = exports.MedicalRecords = void 0;
;
exports.MedicalRecords = [
...
;
var description = "The factors that supporting the Production rate is relevant to the count produced, hence the row data is marked as normal data.";
exports.machineDataList = [
    {
        MachineID: "M001",
        Temperature: 85,
        Pressure: 120,
