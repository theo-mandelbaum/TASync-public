...
function AnamolyDetection() {
    ...
    function DetectAnamolyData() {
        ...
        let aiOutput = window.getAzureChatAIRequest({ messages: [{ role: 'user', content: userInput }] });
    ...
    return (<div className='control-pane'>
            <div className='control-section'>
                <div id='container'>
                    <GridComponent id='Grid' ref={grid => gridInstance = grid} dataSource={machineDataList} toolbar={toolbarOptions} queryCellInfo={CustomizeCell} enableHover={false} enableStickyHeader={true} allowTextWrap={true} rowHeight={75} height={450}>
                        <ColumnsDirective>
