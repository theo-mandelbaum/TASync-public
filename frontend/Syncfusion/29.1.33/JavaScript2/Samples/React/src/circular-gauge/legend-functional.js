...
var Circle = function () {
    ...
    var alignElement = (0, react_1.useRef)(null);
    var positionElement = (0, react_1.useRef)(null);
    var legendPosition;
    var loaded = false;
    var positionlist = [
        { value: 'Bottom' },
    ...
    var position = function () {
        gauge.current.legendSettings.position = positionElement.current.value;
    };
    var alignment = function () {
        gauge.current.legendSettings.alignment = alignElement.current.value;
    };
    var shape = function () {
        gauge.current.legendSettings.shape = dropElement.current.value;
    };
    ...
    var onChartLoad = function (args) {
        if (!loaded) {
            loaded = true;
            legendPosition = new ej2_react_dropdowns_1.DropDownList({
                index: 0,
                width: 130,
                change: function () {
                    var position = legendPosition.value.toString();
                }
            });
            legendPosition.appendTo('#legendPosition');
        }
    };
    var enableToggleLegend = function (args) {
        gauge.current.legendSettings.toggleVisibility = args.checked;
    };
    var enableLegend = function (args) {
        ...
        React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-lg-8' },
                    ...
                    React.createElement(ej2_react_circulargauge_1.CircularGaugeComponent, { load: load.bind(_this), background: 'transparent', id: 'range-container', loaded: onChartLoad.bind(_this), title: 'Measure of wind speed in km/h', titleStyle: { fontFamily: 'inherit' }, legendSettings: { visible: true, position: "Bottom", textStyle: { fontFamily: 'inherit', size: '12px' } }, ref: gauge },
                        ...
                        React.createElement(ej2_react_circulargauge_1.AxesDirective, null,
                            React.createElement(ej2_react_circulargauge_1.AxisDirective, { startAngle: 210, endAngle: 150, radius: '80%', minimum: 0, maximum: 120, majorTicks: { color: '#9E9E9E', height: 16, interval: 20 }, lineStyle: { width: 2 }, minorTicks: { height: 8, interval: 10 }, labelStyle: { position: 'Inside', useRangeColor: false, font: { fontFamily: 'inherit' } } },
                                ...
                                React.createElement(ej2_react_circulargauge_1.PointersDirective, null,
                                    React.createElement(ej2_react_circulargauge_1.PointerDirective, { value: 70, radius: '60%', pointerWidth: 8, animation: { enable: true }, cap: { radius: 7 }, needleTail: { length: '18%' } })))))),
                                ...
                                React.createElement("tr", { style: { height: '50px' } },
                                    ...
                                    React.createElement("td", { style: { width: '40%' } },
                                        React.createElement("div", { className: 'legendPadding' },
                                            React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: 'enable', checked: true, change: enableLegend.bind(_this) })))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", { style: { width: '20%' } },
                                        React.createElement("div", { id: 'enable', style: { fontSize: "14px" } }, "Show range when the legend item is toggled")),
                                    React.createElement("td", { style: { width: '40%' } },
                                        React.createElement("div", { className: 'legendPadding' },
                                            React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: 'enableToggle', checked: true, change: enableToggleLegend.bind(_this) })))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", null,
                                        React.createElement("div", { id: 'position', style: { fontSize: "14px" } }, "Position")),
                                    React.createElement("td", null,
                                        React.createElement("div", { style: { paddingLeft: '20px' } },
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "100%", index: 0, change: position.bind(_this), ref: positionElement, dataSource: positionlist, fields: { text: 'value', value: 'value' } })))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", null,
                                        React.createElement("div", { id: 'range', style: { fontSize: "14px" } }, "Alignment")),
                                    React.createElement("td", null,
                                        React.createElement("div", { style: { paddingLeft: '20px' } },
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "100%", index: 0, change: alignment.bind(_this), ref: alignElement, dataSource: alignlist, fields: { text: 'value', value: 'value' } })))),
                                React.createElement("tr", { style: { height: '50px' } },
                                    React.createElement("td", null,
                                        React.createElement("div", { id: 'pointColor', style: { fontSize: "14px" } }, "Shape")),
                                    React.createElement("td", null,
                                        React.createElement("div", { style: { paddingLeft: '20px' } },
                                            React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { width: "100%", index: 0, change: shape.bind(_this), ref: dropElement, dataSource: shapelist, fields: { text: 'text', value: 'value' } })))))))))),
