...
exports.CustomLabels = void 0;
var React = require("react");
var ej2_react_circulargauge_1 = require("@syncfusion/ej2-react-circulargauge");
var sample_base_1 = require("../common/sample-base");
var SAMPLE_CSS = "\n    .control-fluid {\n\t\tpadding: 0px !important;\n    }";
var CustomLabels = /** @class */ (function (_super) {
    __extends(CustomLabels, _super);
    ...
    CustomLabels.prototype.load = function (args) {
        // custom code start
    ...
    CustomLabels.prototype.axisLabelRender = function (args) {
        args.text = this.textValues[(args.value)];
    };
    CustomLabels.prototype.render = function () {
        return (React.createElement("main", null,
            React.createElement("div", { className: 'control-pane' },
                React.createElement("style", null, SAMPLE_CSS),
                React.createElement("div", { className: 'control-section' },
                    React.createElement(ej2_react_circulargauge_1.CircularGaugeComponent, { load: this.load.bind(this), animationDuration: 2000, axisLabelRender: this.axisLabelRender.bind(this), id: 'custom-labels', background: 'transparent' },
                        React.createElement(ej2_react_circulargauge_1.Inject, { services: [ej2_react_circulargauge_1.Gradient] }),
                        React.createElement(ej2_react_circulargauge_1.AxesDirective, null,
                            React.createElement(ej2_react_circulargauge_1.AxisDirective, { startAngle: 210, endAngle: 150, radius: '80%', minimum: 0, maximum: 8, majorTicks: {
                                    width: 0, interval: 1
                                ...
                                React.createElement(ej2_react_circulargauge_1.PointersDirective, null,
                                    React.createElement(ej2_react_circulargauge_1.PointerDirective, { pointerWidth: 10, radius: '85%', needleStartWidth: 10, needleEndWidth: 5, value: 6.2, color: '#E63B86', cap: { radius: 0, border: { width: 0 } }, needleTail: { length: '0%' }, animation: { enable: false }, linearGradient: this.pointerLinearGradient })),
                                React.createElement(ej2_react_circulargauge_1.RangesDirective, null,
                                    React.createElement(ej2_react_circulargauge_1.RangeDirective, { start: 0, end: 6.2, color: '#E63B86', startWidth: 22, endWidth: 22, linearGradient: this.rangeLinearGradient }),
