        ...
        if (!this.loaded) {
            ...
            this.tickPosition = new DropDownList({
                ...
                change: () => {
                    ...
                    if (this.isMajorTicks) {
                        this.gauge.axes[0].majorTicks.position = value;
                    }
                    else {
                        this.gauge.axes[0].minorTicks.position = value;
                    }
                    this.gauge.refresh();
                }
            });
            ...
            this.labelPosition = new DropDownList({
                ...
                change: () => {
                    ...
                    this.gauge.axes[0].labelStyle.position = value;
                    this.gauge.refresh();
                }
            });
                ...
                <div className='control-section row'>
                    <div className='col-lg-8'>
                        <CircularGaugeComponent load={this.load.bind(this)} background='transparent' id='range-container' loaded={this.onChartLoad.bind(this)} ref={gauge => this.gauge = gauge}>
                            ...
                            <AxesDirective>
                                <AxisDirective startAngle={210} endAngle={150} radius='80%' minimum={0} maximum={170} showLastLabel={false} majorTicks={{
