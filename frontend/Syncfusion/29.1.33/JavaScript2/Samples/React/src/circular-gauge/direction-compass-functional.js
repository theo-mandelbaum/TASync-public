...
var Direction = function () {
    ...
    var onLabelRender = function (args) {
    ...
    return (React.createElement("main", null,
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_circulargauge_1.CircularGaugeComponent, { load: load.bind(_this), id: 'direction-gauge', background: 'transparent', axisLabelRender: onLabelRender.bind(_this) },
                    React.createElement(ej2_react_circulargauge_1.Inject, { services: [ej2_react_circulargauge_1.Gradient] }),
                    React.createElement(ej2_react_circulargauge_1.AxesDirective, null,
                        React.createElement(ej2_react_circulargauge_1.AxisDirective, { radius: '80%', startAngle: 0, endAngle: 360, minimum: 0, maximum: 8, majorTicks: { height: 15, interval: 1 }, lineStyle: { width: 20, color: '#E0E0E0' }, minorTicks: { height: 10, interval: 0.5 }, labelStyle: { font: { fontFamily: 'inherit' }, autoAngle: true, offset: 10, hiddenLabel: 'Last' } },
                            React.createElement(ej2_react_circulargauge_1.PointersDirective, null,
                                React.createElement(ej2_react_circulargauge_1.PointerDirective, { value: 7, radius: '50%', color: '#e20a22', pointerWidth: 30, linearGradient: pointerLinearGradient, cap: { radius: 15, color: '#ffffff', border: { width: 0 } }, animation: { enable: false } }),
                                React.createElement(ej2_react_circulargauge_1.PointerDirective, { value: 3, radius: '50%', color: '#f7f7f7', pointerWidth: 30, cap: { radius: 15, color: '#ffffff', border: { width: 0 } }, animation: { enable: false } }))))))),
