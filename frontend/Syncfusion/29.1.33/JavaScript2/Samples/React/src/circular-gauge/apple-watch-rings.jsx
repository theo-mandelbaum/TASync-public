        ...
        return (<main><div className='control-pane'>
                ...
                useRangeColor: true
                                    ...
                                    <AnnotationsDirective>
                                        <AnnotationDirective content='<div id="annotation1"><img alt="Red arrow" style="width:22px;height:22 px;" src="src/circular-gauge/images/image1.svg" /></div>' angle={8} radius='80%' zIndex='1'/>
