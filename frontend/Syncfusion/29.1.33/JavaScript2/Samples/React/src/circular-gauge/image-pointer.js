            ...
            React.createElement("div", { className: 'control-pane' },
                ...
                React.createElement("div", { className: 'control-section row' },
                    React.createElement("div", { className: 'col-lg-12' },
                        React.createElement(ej2_react_circulargauge_1.CircularGaugeComponent, { load: this.load.bind(this), title: 'Shot Put Distance', background: 'transparent', loaded: this.onChartLoad.bind(this), id: 'image-container', enablePointerDrag: true, titleStyle: { fontFamily: 'inherit' }, centerY: "57%'" },
                            React.createElement(ej2_react_circulargauge_1.Inject, { services: [ej2_react_circulargauge_1.Annotations] }),
                            React.createElement(ej2_react_circulargauge_1.AxesDirective, null,
                                React.createElement(ej2_react_circulargauge_1.AxisDirective, { startAngle: 200, endAngle: 130, radius: '80%', minimum: 0, maximum: 14, lineStyle: {
                                        width: 0,
                                    }, majorTicks: {
                                        width: 0,
                                    }, minorTicks: {
                                    ...
                                    React.createElement(ej2_react_circulargauge_1.AnnotationsDirective, null,
                                        React.createElement(ej2_react_circulargauge_1.AnnotationDirective, { description: '12 M', content: '<div style="color:#9E9E9E; font-family:inherit; font-size:14px;"> 12 M </div>', radius: '108%', angle: 98, zIndex: '1' }),
                                        React.createElement(ej2_react_circulargauge_1.AnnotationDirective, { description: '11 M', content: '<div style="color:#9E9E9E; font-family:inherit; font-size:14px;"> 11 M </div>', radius: '80%', angle: 81, zIndex: '1' }),
                                        React.createElement(ej2_react_circulargauge_1.AnnotationDirective, { description: '10 M', content: '<div style="color:#9E9E9E; font-family:inherit; font-size:14px;"> 10 M </div>', radius: '50%', angle: 69, zIndex: '1' }),
                                        React.createElement(ej2_react_circulargauge_1.AnnotationDirective, { description: 'Doe', content: '<div style="color:#9E9E9E; font-family:inherit; font-size:14px;"> Doe </div>', radius: '106%', angle: 189, zIndex: '1' }),
                                        React.createElement(ej2_react_circulargauge_1.AnnotationDirective, { description: 'Almaida', content: '<div style="color:#9E9E9E; font-family:inherit; font-size:14px;"> Almaida </div>', radius: '78%', angle: 180, zIndex: '1' }),
                                        React.createElement(ej2_react_circulargauge_1.AnnotationDirective, { description: 'John', content: '<div style="color:#9E9E9E; font-family:inherit; font-size:14px;"> John </div>', radius: '48%', angle: 175, zIndex: '1' })))))))),
