        ...
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-lg-12' },
                    React.createElement(ej2_react_circulargauge_1.CircularGaugeComponent, { background: 'transparent', animationDuration: 2000, loaded: onChartLoad.bind(_this), dragEnd: dragEnd.bind(_this), id: 'tooltip-container', ref: gauge, enablePointerDrag: true, load: load.bind(_this), tooltip: { enable: true, type: ['Range', 'Pointer'], showAtMousePosition: true, format: 'Current Value:  {value}', enableAnimation: false, textStyle: { size: '13px', fontFamily: 'inherit' }, rangeSettings: { showAtMousePosition: true, format: "Start Value: {start} <br/> End Value: {end}", textStyle: { size: '13px', fontFamily: 'inherit' } } } },
                        React.createElement(ej2_react_circulargauge_1.Inject, { services: [ej2_react_circulargauge_1.GaugeTooltip] }),
                        React.createElement(ej2_react_circulargauge_1.AxesDirective, null,
                            React.createElement(ej2_react_circulargauge_1.AxisDirective, { startAngle: 240, endAngle: 120, radius: '90%', minimum: 0, maximum: 120, majorTicks: { color: 'white', offset: -4, height: 10 }, lineStyle: { width: 0 }, minorTicks: { width: 0 }, labelStyle: { useRangeColor: true, font: { fontFamily: 'inherit' } } },
                                React.createElement(ej2_react_circulargauge_1.PointersDirective, null,
                                    React.createElement(ej2_react_circulargauge_1.PointerDirective, { value: 70, radius: '60%', cap: { radius: 10, border: { color: '#33BCBD', width: 5 } }, animation: { enable: true, duration: 1500 }, color: '#33BCBD' })),
