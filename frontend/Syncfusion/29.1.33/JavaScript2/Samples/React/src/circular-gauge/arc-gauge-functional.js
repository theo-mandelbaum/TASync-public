...
var ArcGauge = function () {
    (0, react_1.useEffect)(function () {
        (0, sample_base_1.updateSampleSection)();
    }, []);
    var gauge = (0, react_1.useRef)(null);
    var sliderElement = (0, react_1.useRef)(null);
    ...
    var sliderChange = function () {
        sliderValue = sliderElement.current.value;
    ...
    return (React.createElement("main", null,
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { id: 'circular_gauge_sample', className: 'control-section' },
                React.createElement(ej2_react_circulargauge_1.CircularGaugeComponent, { title: 'Progress Tracker', background: 'transparent', titleStyle: { fontFamily: 'inherit' }, load: load.bind(_this), loaded: loaded.bind(_this), ref: gauge, id: 'gauge' },
                    React.createElement(ej2_react_circulargauge_1.Inject, { services: [ej2_react_circulargauge_1.Annotations] }),
                    React.createElement(ej2_react_circulargauge_1.AxesDirective, null,
                        React.createElement(ej2_react_circulargauge_1.AxisDirective, { radius: '80%', startAngle: 200, endAngle: 160, minimum: 1, maximum: 100, lineStyle: { width: 0 }, labelStyle: { font: { fontFamily: 'inherit', size: '0px' } }, majorTicks: { height: 0 }, minorTicks: { height: 0 } },
                            React.createElement(ej2_react_circulargauge_1.AnnotationsDirective, null,
                                ...
                                React.createElement(ej2_react_circulargauge_1.AnnotationDirective, { description: 'Slider', content: '<div id="slider" style="height:70px;width:250px;"></div>', angle: 0, radius: '-100%', zIndex: '1' })),
                            ...
                            React.createElement(ej2_react_circulargauge_1.PointersDirective, null,
                                React.createElement(ej2_react_circulargauge_1.PointerDirective, { animation: { enable: false }, value: 60, radius: '90%', color: '#e5ce20', pointerWidth: 30, type: 'RangeBar', roundedCornerRadius: 20, border: { width: 0 } }))))),
                React.createElement(ej2_react_inputs_1.SliderComponent, { className: 'sliderwrap', id: "slider", style: { width: '250px', marginTop: '-45px' }, type: 'MinRange', min: 0, max: 100, value: sliderValue, limits: { enabled: true, minStart: 0, minEnd: 100 }, change: sliderChange.bind(_this), ref: sliderElement }))),
