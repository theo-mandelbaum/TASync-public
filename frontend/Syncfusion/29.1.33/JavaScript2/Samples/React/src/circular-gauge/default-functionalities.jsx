        ...
        return (<main><div className='control-pane'>
                ...
                <div className='control-section'>
                    <CircularGaugeComponent animationDuration={2000} load={this.load.bind(this)} id='gauge' background="transparent">
                        <AxesDirective>
                            <AxisDirective radius='80%' startAngle={230} endAngle={130} majorTicks={{ offset: 5 }} lineStyle={{ width: 8, color: '#E0E0E0' }} minorTicks={{ offset: 5 }} labelStyle={{
                font: {
                    fontFamily: 'inherit',
                },
                offset: -1
                                ...
                                <PointersDirective>
                                    <PointerDirective value={60} radius='60%' pointerWidth={7} color='#c06c84' animation={{ enable: true, duration: 500 }} cap={{
                radius: 8,
                color: '#c06c84',
                border: { width: 0 }
            }} needleTail={{
