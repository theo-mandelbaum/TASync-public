...
var Export = function () {
    ...
    var onClickPrint = function (e) {
        gauge.current.print();
    };
    var onClickExport = function (e) {
        ...
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-lg-8' },
                    React.createElement(ej2_react_circulargauge_1.CircularGaugeComponent, { load: load.bind(_this), id: 'gauge', background: 'transparent', allowPrint: true, allowPdfExport: true, allowImageExport: true, ref: gauge },
                        ...
                        React.createElement(ej2_react_circulargauge_1.AxesDirective, null,
                            React.createElement(ej2_react_circulargauge_1.AxisDirective, { radius: '80%', startAngle: 0, endAngle: 0, direction: 'AntiClockWise', majorTicks: { width: 1, height: 25, interval: 10, position: "Outside", useRangeColor: true }, lineStyle: { width: 0 }, minorTicks: { width: 1, height: 8, interval: 2, position: "Outside", useRangeColor: true }, labelStyle: { hiddenLabel: 'Last', offset: 2, font: { fontFamily: 'inherit' }, position: 'Outside', useRangeColor: true } },
                                ...
                                React.createElement("tr", { style: { height: "50px" } },
                                    ...
                                    React.createElement("td", null,
                                        React.createElement("div", { style: { 'marginTop': '0px' } },
                                            React.createElement(ej2_react_inputs_1.TextBoxComponent, { className: "e-input", value: 'Circular Gauge', style: { width: '100%', padding: '0px', paddingLeft: '5px' }, id: "fileName", ref: function (d) { return textElement = d; } })))),
                                React.createElement("tr", { style: { height: '60px' } },
                                    React.createElement("td", { align: "right", style: { paddingRight: '5%' } },
                                        React.createElement(ej2_react_buttons_1.ButtonComponent, { onClick: onClickExport.bind(_this), isPrimary: true }, "Export")),
                                    React.createElement("td", { align: "left", style: { paddingLeft: '5%' } },
                                        React.createElement(ej2_react_buttons_1.ButtonComponent, { onClick: onClickPrint.bind(_this), isPrimary: true }, "Print"))))))))),
