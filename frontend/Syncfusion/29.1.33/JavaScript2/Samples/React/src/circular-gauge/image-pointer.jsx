        ...
        return (<main><div className='control-pane'>
                ...
                <div className='control-section row'>
                    <div className='col-lg-12'>
                        <CircularGaugeComponent load={this.load.bind(this)} title='Shot Put Distance' background='transparent' loaded={this.onChartLoad.bind(this)} id='image-container' enablePointerDrag={true} titleStyle={{ fontFamily: 'inherit' }} centerY="57%'">
                            <Inject services={[Annotations]}/>
                            <AxesDirective>
                                <AxisDirective startAngle={200} endAngle={130} radius='80%' minimum={0} maximum={14} lineStyle={{
                width: 0,
            }} majorTicks={{
                width: 0,
            }} minorTicks={{
