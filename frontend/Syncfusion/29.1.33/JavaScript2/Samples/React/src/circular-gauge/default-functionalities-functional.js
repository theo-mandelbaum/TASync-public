    ...
    return (React.createElement("main", null,
        React.createElement("div", { className: 'control-pane' },
            ...
            React.createElement("div", { className: 'control-section' },
                React.createElement(ej2_react_circulargauge_1.CircularGaugeComponent, { animationDuration: 2000, load: load.bind(_this), id: 'gauge', background: "transparent" },
                    React.createElement(ej2_react_circulargauge_1.AxesDirective, null,
                        React.createElement(ej2_react_circulargauge_1.AxisDirective, { radius: '80%', startAngle: 230, endAngle: 130, majorTicks: { offset: 5 }, lineStyle: { width: 8, color: '#E0E0E0' }, minorTicks: { offset: 5 }, labelStyle: { font: { fontFamily: 'inherit' }, offset: -1 } },
                            React.createElement(ej2_react_circulargauge_1.PointersDirective, null,
                                React.createElement(ej2_react_circulargauge_1.PointerDirective, { value: 60, radius: '60%', pointerWidth: 7, color: '#c06c84', animation: { enable: true, duration: 500 }, cap: { radius: 8, color: '#c06c84', border: { width: 0 } }, needleTail: { length: '0%' } }))))))),
