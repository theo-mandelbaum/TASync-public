...
const Circle = () => {
    ...
    let alignElement = useRef(null);
    let positionElement = useRef(null);
    let legendPosition;
    let loaded = false;
    let positionlist = [
        { value: 'Bottom' },
