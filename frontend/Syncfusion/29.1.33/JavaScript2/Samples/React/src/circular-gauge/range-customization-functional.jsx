...
const Range = () => {
    ...
    const [startMax, setStartMax] = useState("40");
    const [endMin, setEndMin] = useState("0");
    const [endMax, setEndMax] = useState("40");
    const [rangeEndWidth, setRangeEndWidth] = useState("10");
    const [rangeStartWidth, setRangeStartWidth] = useState("10");
    const [startValue, setStartValue] = useState("0");
    const [endValue, setEndValue] = useState("40");
    const [radiusValue, setRadiusValue] = useState("0");
    let gauge = useRef(null);
    let startWidthElement = useRef(null);
    let endWidthElement = useRef(null);
    let radiusElement = useRef(null);
    let rangeSelectRef = useRef(null);
    let startElementOne = useRef(null);
    let endElementOne = useRef(null);
    let selectedRange;
    const load = (args) => {
    };
    let rangeSelectList = [
    ...
    const rangeSelectChange = () => {
        let index = rangeSelectRef.current.index;
    ...
    const start = () => {
        let index = rangeSelectRef.current.index;
        let min = parseInt(startElementOne.current.value);
    ...
    const end = () => {
        let index = rangeSelectRef.current.index;
        let max = parseInt(endElementOne.current.value);
    ...
    const startWidth = () => {
        let index = rangeSelectRef.current.index;
        let startWidth = parseFloat(startWidthElement.current.value);
    ...
    const endWidth = () => {
        let index = rangeSelectRef.current.index;
        let endWidth = parseFloat(endWidthElement.current.value.toString());
    ...
    const radius = () => {
        let index = rangeSelectRef.current.index;
        let radius = parseFloat(radiusElement.current.value.toString());
                        ...
                        <table id='property' role='none' title='Properties' className='property-panel-table' style={{ width: '90%' }}>
                            <tbody>
                                <tr style={{ height: '50px' }}>
                                    ...
                                    <td style={{ width: '41%' }}>
                                        <DropDownListComponent id="rangeSelect" width="100%" index={0} change={rangeSelectChange.bind(this)} ref={rangeSelectRef} dataSource={rangeSelectList} fields={{ text: 'text', value: 'value' }}/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
