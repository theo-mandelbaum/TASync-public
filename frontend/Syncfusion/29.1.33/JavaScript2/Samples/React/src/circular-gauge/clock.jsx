        ...
        return (<main><div className='control-pane'>
                ...
                <div className='control-section'>
                    <CircularGaugeComponent loaded={this.onChartLoad.bind(this)} resized={this.onResized.bind(this)} load={this.load.bind(this)} id='axis-background' background='transparent' ref={gauge => this.gauge = gauge}>
                        ...
                        <AxesDirective>
                            <AxisDirective startAngle={0} endAngle={0} radius='90%' minimum={0} maximum={12} majorTicks={{
                ...
                font: { fontFamily: 'inherit' }
                                ...
                                <AnnotationsDirective>
                                    ...
                                    <AnnotationDirective content='<div id="subGaugeTwo" style="margin-left: -110%;margin-top: -50%;"></div>' description='Sub gauge two' angle={90} radius='0%' zIndex='1'/>
                                </AnnotationsDirective>
                            </AxisDirective>
                        </AxesDirective>
