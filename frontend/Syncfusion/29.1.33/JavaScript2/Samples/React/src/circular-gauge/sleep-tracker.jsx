        ...
        return (<main><div className='control-pane'>
                ...
                font: {
                    fontFamily: 'inherit'
                                ...
                                <PointersDirective>
                                    <PointerDirective type="Marker" value={4.7} markerShape='Image' radius='97%' markerWidth={28} markerHeight={28} imageUrl="src/circular-gauge/images/sun-icon.png" animation={{
                enable: false
            }}>
                                    </PointerDirective>
                                    <PointerDirective type="Marker" value={9} markerShape='Image' radius='98%' markerWidth={28} markerHeight={28} imageUrl="src/circular-gauge/images/moon-icon.png" animation={{
                enable: false
            }}>
                                    </PointerDirective>
                                </PointersDirective>
