        ...
        return (<main><div className='control-pane'>
                ...
                <div id='circular_gauge_sample' className='control-section'>
                    <CircularGaugeComponent title='Progress Tracker' background='transparent' titleStyle={{ fontFamily: 'inherit' }} load={this.load.bind(this)} loaded={this.loaded.bind(this)} ref={gauge => this.gauge = gauge} id='gauge'>
                        ...
                        <AxesDirective>
                            <AxisDirective radius='80%' startAngle={200} endAngle={160} minimum={1} maximum={100} lineStyle={{ width: 0 }} labelStyle={{
                font: {
                    fontFamily: 'inherit',
                    size: '0px',
                },
                                ...
                                <AnnotationsDirective>
                                    ...
                                    <AnnotationDirective content='<div id="slider" style="height:70px;width:250px;"></div>' description='Slider' angle={0} radius='-100%' zIndex='1'/>
                                </AnnotationsDirective>
                                <RangesDirective>
                ...
                width: 0
                    ...
                    <SliderComponent className='sliderwrap' id="slider" style={{ width: '250px', marginTop: '-45px' }} type='MinRange' min={0} max={100} value={sliderValue} limits={{ enabled: true, minStart: 0, minEnd: 100 }} change={this.sliderChange.bind(this)} ref={d => this.sliderElement = d}/>
                </div>
            </div>
