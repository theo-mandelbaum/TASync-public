...
exports.TextPointer = void 0;
var React = require("react");
var ej2_react_circulargauge_1 = require("@syncfusion/ej2-react-circulargauge");
var sample_base_1 = require("../common/sample-base");
var SAMPLE_CSS = "\n    .control-fluid {\n\t\tpadding: 0px !important;\n    }";
var TextPointer = /** @class */ (function (_super) {
    __extends(TextPointer, _super);
    function TextPointer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TextPointer.prototype.load = function (args) {
        // custom code start
    ...
    TextPointer.prototype.render = function () {
        return (React.createElement("main", null,
            React.createElement("div", { className: 'control-pane' },
                React.createElement("style", null, SAMPLE_CSS),
                React.createElement("div", { className: 'control-section' },
                    React.createElement(ej2_react_circulargauge_1.CircularGaugeComponent, { load: this.load.bind(this), centerY: '75%', id: 'text-pointer', background: 'transparent' },
                        React.createElement(ej2_react_circulargauge_1.AxesDirective, null,
                            React.createElement(ej2_react_circulargauge_1.AxisDirective, { startAngle: 270, endAngle: 90, radius: '120%', minimum: 0, maximum: 120, rangeGap: 3, majorTicks: {
                                    width: 0
...
exports.TextPointer = TextPointer;
