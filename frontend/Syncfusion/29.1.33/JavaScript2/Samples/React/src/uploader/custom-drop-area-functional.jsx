    ...
    const renderComplete = () => {
        ...
        document.getElementById('customdropArea').onclick = (args) => {
            ...
            if (target.classList.contains('e-file-delete-btn')) {
                for (let i = 0; i < uploadObj.current.getFilesData().length; i++) {
                ...
                <div className='col-lg-12 control-section upload-custom'>
                    <div className='customdrop_wrapper'>
                        ...
                        <div id="customdropArea">
                            ...
                            {/* Render Uploader */}
                            <UploaderComponent id='UploadFiles' type='file' ref={uploadObj} asyncSettings={asyncSettings} selected={onSelect.bind(this)} removing={onRemoveFile.bind(this)} progress={onUploadInProgress.bind(this)} success={onUploadSuccess.bind(this)} failure={onUploadFailed.bind(this)} allowedExtensions={allowedExtensions} template={listTemplate} dropArea={target.current}></UploaderComponent>
                        </div>
                    </div>
                </div>
            </div>
