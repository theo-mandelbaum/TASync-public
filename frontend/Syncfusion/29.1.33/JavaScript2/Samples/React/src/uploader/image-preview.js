...
var Preview = /** @class */ (function (_super) {
    ...
    Preview.prototype.rendereComplete = function () {
        ...
        document.getElementById('clearbtn').onclick = function () {
            ...
            (0, ej2_base_1.detach)(_this.dropElement.querySelector('ul'));
            _this.filesList = [];
            _this.filesDetails = [];
            _this.filesName = [];
            _this.uploadObj.element.value = '';
            if (_this.dropArea.classList.contains('e-spinner-pane')) {
                (0, ej2_react_popups_1.hideSpinner)(_this.dropArea);
                (0, ej2_base_1.detach)(_this.dropElement.querySelector('.e-spinner-pane'));
            }
        };
    ...
    Preview.prototype.onSelect = function (args) {
        ...
        if ((0, ej2_base_1.isNullOrUndefined)(this.dropArea.querySelector('.e-upload-files'))) {
            this.parentElement = (0, ej2_base_1.createElement)('ul', { className: 'e-upload-files' });
    ...
    Preview.prototype.formSelectedData = function (file, proxy) {
        ...
        liEle.appendChild((0, ej2_base_1.createElement)('div', { className: 'file-size', innerHTML: proxy.uploadObj.bytesToSize(file.size) }));
        var clearbtn;
        var uploadbtn;
