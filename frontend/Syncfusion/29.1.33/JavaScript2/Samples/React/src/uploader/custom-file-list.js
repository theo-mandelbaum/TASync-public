...
var CustomTemplate = /** @class */ (function (_super) {
    ...
    CustomTemplate.prototype.onFileSelect = function (args) {
        if ((0, ej2_base_1.isNullOrUndefined)(this.dropAreaEle.querySelector('.upload-list-root'))) {
            this.parentElement = (0, ej2_base_1.createElement)('div', { className: 'upload-list-root' });
            this.parentElement.appendChild((0, ej2_base_1.createElement)('ul', { className: 'ul-element' }));
    ...
    CustomTemplate.prototype.formSelectedData = function (selectedFiles, proxy) {
        ...
        liEle.appendChild((0, ej2_base_1.createElement)('span', { className: 'file-size ', innerHTML: this.uploadObj.bytesToSize(selectedFiles.size) }));
        if (selectedFiles.statusCode === '1') {
            this.progressbarContainer = (0, ej2_base_1.createElement)('span', { className: 'progress-bar-container' });
            this.progressbarContainer.appendChild((0, ej2_base_1.createElement)('progress', { className: 'progress', attrs: { value: '0', max: '100' } }));
    ...
    CustomTemplate.prototype.rendereComplete = function () {
        ...
        document.getElementById('clearbtn').onclick = function () {
            ...
            (0, ej2_base_1.detach)(document.getElementsByClassName('upload-list-root')[0]);
            _this.filesList = [];
            _this.filesDetails = [];
        };
