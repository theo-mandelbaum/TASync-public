    ...
    render() {
        return (<div className='control-pane' ref={this.dropContainerRef}>
			...
			<div id="action-description">
				<p>This <a href="https://www.syncfusion.com/react-ui-components/react-file-upload" target="_blank">&nbsp;React File Upload</a> example demonstrates how to add an image preview of the uploaded files.
