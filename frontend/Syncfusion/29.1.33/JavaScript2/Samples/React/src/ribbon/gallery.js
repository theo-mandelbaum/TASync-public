...
var Gallery = /** @class */ (function (_super) {
    ...
    function Gallery() {
        ...
        _this.gallerySettings = ({
            select: _this.gallerySelect,
            popupWidth: '544px',
            itemCount: 3,
            groups: [{
                    itemWidth: '100',
    ...
    Gallery.prototype.enablePaste = function () {
    ...
    Gallery.prototype.updateContent = function (args) {
        this.toastInstance.show({ content: "Last clicked item is " + args });
    };
    Gallery.prototype.gallerySelect = function (args) {
        this.updateContent("Gallery -> " + args.currentItem.content);
    };
    Gallery.prototype.fileSelect = function (args) {
    ...
    Gallery.prototype.launchClick = function (args) {
            ...
            React.createElement("div", { className: 'col-lg-12 control-section ribbon-gallery-section' },
                React.createElement("div", { className: 'control ribbon-sample' },
                    React.createElement("div", { id: "gallery-ribbonContainer", className: 'ribbon-gallery-container' },
                        React.createElement(ej2_react_ribbon_1.RibbonComponent, { id: 'gallery-ribbon', cssClass: 'ribbonGallery', ref: function (ribbonDefault) { _this.ribbonObj = ribbonDefault; }, fileMenu: { visible: true, menuItems: this.fileOptions, select: this.fileSelect }, launcherIconClick: this.launchClick },
                                    ...
                                    React.createElement(ej2_react_ribbon_1.RibbonGroupsDirective, null,
                                        ...
                                        React.createElement(ej2_react_ribbon_1.RibbonGroupDirective, { header: "Gallery", id: 'gallery', groupIconCss: "e-icons e-paste", showLauncherIcon: true },
                                            React.createElement(ej2_react_ribbon_1.RibbonCollectionsDirective, null,
                                                React.createElement(ej2_react_ribbon_1.RibbonCollectionDirective, null,
                                                    React.createElement(ej2_react_ribbon_2.RibbonItemsDirective, null,
                                                        React.createElement(ej2_react_ribbon_2.RibbonItemDirective, { type: "Gallery", allowedSizes: ej2_react_ribbon_2.RibbonItemSize.Large, gallerySettings: this.gallerySettings }))))),
                                    ...
                                    React.createElement(ej2_react_ribbon_1.RibbonGroupsDirective, null,
                                        ...
                                        React.createElement(ej2_react_ribbon_1.RibbonGroupDirective, { header: "Illustration", overflowHeader: "Illustrations", id: "illustration", groupIconCss: "e-icons e-image", enableGroupOverflow: true, orientation: "Row" },
                                            React.createElement(ej2_react_ribbon_1.RibbonCollectionsDirective, null,
                                                React.createElement(ej2_react_ribbon_1.RibbonCollectionDirective, null,
                                                    React.createElement(ej2_react_ribbon_2.RibbonItemsDirective, null,
                                                        React.createElement(ej2_react_ribbon_2.RibbonItemDirective, { id: 'pictureddl', type: "DropDown", dropDownSettings: { iconCss: "e-icons e-image", content: "Pictures", target: '#gallery-pictureList' } }),
                            ...
                            React.createElement(ej2_react_ribbon_2.Inject, { services: [ej2_react_ribbon_2.RibbonFileMenu, ej2_react_ribbon_2.RibbonColorPicker, ej2_react_ribbon_2.RibbonGallery] })),
                        React.createElement("div", { id: "gallery-ribbonPlaceHolder" },
                            ...
                            React.createElement(ej2_react_notifications_1.ToastComponent, { id: 'toast', ref: function (toast) { return _this.toastInstance = toast; }, position: { X: 'Right' }, width: 'auto', height: 25, timeOut: 2000, cssClass: 'e-toast-info', showCloseButton: true, target: "#gallery-ribbonPlaceHolder", newestOnTop: true, animation: { show: { effect: 'FadeIn' }, hide: { effect: 'FadeOut' } } })),
                        React.createElement(ej2_react_lists_1.ListViewComponent, { id: 'gallery-pictureList', dataSource: ['This Device', 'Stock Images', 'Online Images'], showHeader: true, headerTitle: "Insert Picture From", select: function (args) { this.updateContent("Picture -> " + args.text); } })))),
