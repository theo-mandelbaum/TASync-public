...
import { RibbonFileMenu, RibbonItemsDirective, RibbonItemDirective, RibbonItemSize, Inject, RibbonColorPicker, RibbonGallery } from '@syncfusion/ej2-react-ribbon';
                                    ...
                                    <RibbonGroupsDirective>
                                        ...
                                        <RibbonGroupDirective header="Gallery" id='gallery' groupIconCss="e-icons e-paste" showLauncherIcon={true}>
                                            <RibbonCollectionsDirective>
                                                <RibbonCollectionDirective>
                                                    <RibbonItemsDirective>
                                                        <RibbonItemDirective type="Gallery" allowedSizes={RibbonItemSize.Large} gallerySettings={this.gallerySettings}>
                                                        </RibbonItemDirective>
                                                    </RibbonItemsDirective>
                                                </RibbonCollectionDirective>
                                            </RibbonCollectionsDirective>
