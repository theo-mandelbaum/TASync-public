...
var Backstage = /** @class */ (function (_super) {
    ...
    function Backstage() {
        ...
        _this.menuItems = [
            { id: 'home', text: 'Home', iconCss: 'e-icons e-home', content: _this.getBackstageContent('home') },
            { id: 'new', text: 'New', iconCss: 'e-icons e-file-new', content: _this.getBackstageContent('new') },
            { id: 'open', text: 'Open', iconCss: 'e-icons e-folder-open', content: _this.getBackstageContent('open') },
            { separator: true },
            { text: 'Info', content: _this.getBackstageContent('info') },
            { text: 'Save as', content: _this.getBackstageContent('save') },
            { text: 'Export', content: _this.getBackstageContent('export') },
            { text: 'Print', backStageItemClick: _this.backstageClickHandler.bind(_this) },
            { text: 'Share', content: _this.getBackstageContent('share') },
            { separator: true, isFooter: true },
            { text: 'Account', isFooter: true, content: _this.getBackstageContent('account') },
            { text: 'Feedback', isFooter: true, content: _this.getBackstageContent('feedback') }
        ];
        return _this;
    }
    Backstage.prototype.enablePaste = function () {
    ...
    Backstage.prototype.updateContent = function (args) {
        this.toastInstance.show({ content: "Last clicked item is " + args });
    };
    Backstage.prototype.launchClick = function (args) {
    ...
    Backstage.prototype.handleClickInsideBackstageContent = function (e) {
        e.stopPropagation();
    ...
    Backstage.prototype.backstageClickHandler = function () {
        this.ribbonObj.ribbonBackstageModule.hideBackstage();
        this.toastInstance.show({ content: 'Print action is selected' });
    };
    Backstage.prototype.getBackstageContent = function (item) {
    ...
    Backstage.prototype.ribbonCreated = function () {
    ...
    Backstage.prototype.backstageClick = function () {
    ...
    Backstage.prototype.render = function () {
        var _this = this;
            ...
            React.createElement("div", { className: 'col-lg-12 control-section ribbon-backstage-section' },
                React.createElement("div", { className: 'control ribbon-sample' },
                    React.createElement("div", { id: "ribbonContainer", className: 'ribbon-backstage-container' },
                        React.createElement(ej2_react_ribbon_1.RibbonComponent, { id: 'backstage-ribbon', ref: function (ribbonDefault) { _this.ribbonObj = ribbonDefault; }, backStageMenu: { text: 'File', visible: true, items: this.menuItems, backButton: { text: 'Close' } }, created: this.ribbonCreated, launcherIconClick: this.launchClick },
                                            ...
                                            React.createElement(ej2_react_ribbon_1.RibbonCollectionsDirective, null,
                                                ...
                                                React.createElement(ej2_react_ribbon_1.RibbonCollectionDirective, null,
                                                    React.createElement(ej2_react_ribbon_2.RibbonItemsDirective, null,
                                                        ...
                                                        React.createElement(ej2_react_ribbon_2.RibbonItemDirective, { type: "Button", allowedSizes: ej2_react_ribbon_2.RibbonItemSize.Small, buttonSettings: { iconCss: "e-icons e-bold", content: "Bold", isToggle: true, clicked: function () { this.updateContent("Bold"); } } }),
                                                        React.createElement(ej2_react_ribbon_2.RibbonItemDirective, { type: "Button", allowedSizes: ej2_react_ribbon_2.RibbonItemSize.Small, buttonSettings: { iconCss: "e-icons e-italic", content: "Italic", isToggle: true, clicked: function () { this.updateContent("Italic"); } } }),
                                                        React.createElement(ej2_react_ribbon_2.RibbonItemDirective, { type: "Button", allowedSizes: ej2_react_ribbon_2.RibbonItemSize.Small, buttonSettings: { iconCss: "e-icons e-underline", content: "Underline", isToggle: true, clicked: function () { this.updateContent("Underline"); } } }),
                                                        React.createElement(ej2_react_ribbon_2.RibbonItemDirective, { type: "Button", allowedSizes: ej2_react_ribbon_2.RibbonItemSize.Small, buttonSettings: { iconCss: "e-icons e-strikethrough", content: "Strikethrough", isToggle: true, clicked: function () { this.updateContent("Strikethrough"); } } }),
                                                        React.createElement(ej2_react_ribbon_2.RibbonItemDirective, { type: "Button", allowedSizes: ej2_react_ribbon_2.RibbonItemSize.Small, buttonSettings: { iconCss: "e-icons e-change-case", content: "Change Case", isToggle: true, clicked: function () { this.updateContent("Change case"); } } }))))),
                            ...
                            React.createElement(ej2_react_ribbon_2.Inject, { services: [ej2_react_ribbon_2.RibbonFileMenu, ej2_react_ribbon_2.RibbonColorPicker, ej2_react_ribbon_2.RibbonBackstage] })),
