...
var Simplified = function () {
    ...
    var simplifiedRibbonObj = (0, react_1.useRef)(null);
        ...
        React.createElement("div", { className: 'col-lg-12 control-section simplified-ribbon-section' },
            React.createElement("div", { className: 'control ribbon-sample' },
                React.createElement("div", { id: "simplified-ribbonContainer", className: 'simplified-ribbon-container' },
                    React.createElement(ej2_react_ribbon_1.RibbonComponent, { id: 'simplified-ribbon', ref: simplifiedRibbonObj, activeLayout: 'Simplified', fileMenu: { visible: true, menuItems: fileOptions, select: fileSelect }, launcherIconClick: launchClick },
                                        ...
                                        React.createElement(ej2_react_ribbon_1.RibbonCollectionsDirective, null,
                                            React.createElement(ej2_react_ribbon_1.RibbonCollectionDirective, null,
                                                React.createElement(ej2_react_ribbon_1.RibbonItemsDirective, null,
                                                    React.createElement(ej2_react_ribbon_1.RibbonItemDirective, { type: "SplitButton", disabled: true, id: "simplified-pastebtn", allowedSizes: ej2_react_ribbon_2.RibbonItemSize.Large, splitButtonSettings: { iconCss: "e-icons e-paste", items: pasteOptions, content: "Paste", select: function (args) { updateContent("Paste -> " + args.item.text); }, click: function () { updateContent("Paste"); } } }))),
                                            React.createElement(ej2_react_ribbon_1.RibbonCollectionDirective, null,
                                                React.createElement(ej2_react_ribbon_1.RibbonItemsDirective, null,
                                ...
                                React.createElement(ej2_react_ribbon_1.RibbonGroupsDirective, null,
                                    ...
                                    React.createElement(ej2_react_ribbon_1.RibbonGroupDirective, { header: "Illustration", overflowHeader: "Illustrations", id: "illustration", groupIconCss: "e-icons e-image", enableGroupOverflow: true, orientation: "Row" },
                                        React.createElement(ej2_react_ribbon_1.RibbonCollectionsDirective, null,
                                            React.createElement(ej2_react_ribbon_1.RibbonCollectionDirective, null,
                                                React.createElement(ej2_react_ribbon_1.RibbonItemsDirective, null,
                                                    React.createElement(ej2_react_ribbon_1.RibbonItemDirective, { id: 'pictureddl', type: "DropDown", dropDownSettings: { iconCss: "e-icons e-image", content: "Pictures", target: '#simplified-pictureList' } }),
                    ...
                    React.createElement("div", { id: "simplified-ribbonPlaceHolder" },
                        ...
                        React.createElement(ej2_react_notifications_1.ToastComponent, { id: 'toast', ref: toastInstance, position: { X: 'Right' }, height: 25, width: 'auto', timeOut: 2000, cssClass: 'e-toast-info', showCloseButton: true, target: "#simplified-ribbonPlaceHolder", newestOnTop: true, animation: { show: { effect: 'FadeIn' }, hide: { effect: 'FadeOut' } } })),
                    React.createElement(ej2_react_lists_1.ListViewComponent, { id: 'simplified-pictureList', dataSource: ['This Device', 'Stock Images', 'Online Images'], showHeader: true, headerTitle: "Insert Picture From", select: function (args) { updateContent("Picture -> " + args.text); } })))),
