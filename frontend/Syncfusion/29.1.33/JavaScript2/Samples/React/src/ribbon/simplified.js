...
require("./simplified.css");
var Simplified = /** @class */ (function (_super) {
    __extends(Simplified, _super);
    function Simplified() {
    ...
    Simplified.prototype.filtering = function (e) {
        var query = new ej2_data_1.Query();
        query = (e.text !== "") ? query.where("Text", "contains", e.text, true) : query;
        e.updateData(this.fontStyle, query);
    };
    Simplified.prototype.enablePaste = function () {
    ...
    Simplified.prototype.updateContent = function (args) {
        this.toastInstance.show({ content: "Last clicked item is " + args });
    };
    Simplified.prototype.fileSelect = function (args) {
    ...
    Simplified.prototype.launchClick = function (args) {
    ...
    Simplified.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'col-lg-12 control-section simplified-ribbon-section' },
                React.createElement("div", { className: 'control ribbon-sample' },
                    React.createElement("div", { id: "simplified-ribbonContainer", className: 'simplified-ribbon-container' },
                        React.createElement(ej2_react_ribbon_1.RibbonComponent, { id: 'simplified-ribbon', ref: function (simplifiedRibbon) { _this.simplifiedRibbonObj = simplifiedRibbon; }, activeLayout: 'Simplified', fileMenu: { visible: true, menuItems: this.fileOptions, select: this.fileSelect }, launcherIconClick: this.launchClick },
                                    ...
                                    React.createElement(ej2_react_ribbon_1.RibbonGroupsDirective, null,
                                            ...
                                            React.createElement(ej2_react_ribbon_1.RibbonCollectionsDirective, null,
                                                React.createElement(ej2_react_ribbon_1.RibbonCollectionDirective, null,
                                                    React.createElement(ej2_react_ribbon_2.RibbonItemsDirective, null,
                                                        React.createElement(ej2_react_ribbon_2.RibbonItemDirective, { type: "SplitButton", disabled: true, id: "simplified-pastebtn", allowedSizes: ej2_react_ribbon_2.RibbonItemSize.Large, splitButtonSettings: { iconCss: "e-icons e-paste", items: this.pasteOptions, content: "Paste", select: function (args) { this.updateContent("Paste -> " + args.item.text); }, click: function () { this.updateContent("Paste"); } } }))),
                                                React.createElement(ej2_react_ribbon_1.RibbonCollectionDirective, null,
                                                    React.createElement(ej2_react_ribbon_2.RibbonItemsDirective, null,
                                        ...
                                        React.createElement(ej2_react_ribbon_1.RibbonGroupDirective, { header: "Font", overflowHeader: "More Font Options", groupIconCss: "e-icons e-bold", isCollapsible: false, enableGroupOverflow: true, orientation: "Row", cssClass: 'font-group' },
                                            React.createElement(ej2_react_ribbon_1.RibbonCollectionsDirective, null,
                                                React.createElement(ej2_react_ribbon_1.RibbonCollectionDirective, null,
                                                    React.createElement(ej2_react_ribbon_2.RibbonItemsDirective, null,
                                                        React.createElement(ej2_react_ribbon_2.RibbonItemDirective, { type: "ComboBox", comboBoxSettings: { dataSource: this.fontStyle, index: 3, label: 'Font Style', width: '115px', popupWidth: '150px', allowFiltering: true, filtering: this.filtering, select: function (args) { if (args.itemData) {
                                                                    this.updateContent("Font Style -> " + args.itemData.text);
                                                                } } } }),
                                                        React.createElement(ej2_react_ribbon_2.RibbonItemDirective, { type: "ComboBox", comboBoxSettings: { dataSource: this.fontSize, index: 3, label: 'Font Size', width: '65px', popupWidth: '85px', select: function (args) { if (args.itemData) {
                        ...
                        React.createElement("div", { id: "simplified-ribbonPlaceHolder" },
                            ...
                            React.createElement(ej2_react_notifications_1.ToastComponent, { id: 'toast', ref: function (toast) { return _this.toastInstance = toast; }, position: { X: 'Right' }, height: 25, width: 'auto', timeOut: 2000, cssClass: 'e-toast-info', showCloseButton: true, target: "#simplified-ribbonPlaceHolder", newestOnTop: true, animation: { show: { effect: 'FadeIn' }, hide: { effect: 'FadeOut' } } })),
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample showcases the ribbon control with a more streamlined and compact UI in Simplified mode.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    "The ribbon supports two layouts: ",
                    React.createElement("code", null, "Classic"),
                    " and ",
                    React.createElement("code", null, "Simplified"),
                    ". The ",
                    React.createElement("code", null, " activeLayout "),
                    " property can be used to define the current layout of the ribbon. In Simplified mode, all ribbon items are arranged in a single row, providing more space for the application's content."))));
    };
    return Simplified;
