...
import { DiagramComponent, Diagram, Inject, DataBinding, UndoRedo, BpmnDiagrams, NodeConstraints, FlipDirection } from '@syncfusion/ej2-react-diagrams';
...
function createNode(id, offsetX, offsetY, width, height, fill, shape = 'Rectangle') {
    return {
        id,
        offsetX,
        offsetY,
    ...
    return (<div className="control-pane">
            <div className="control-section">
                <div className="db-toolbar-container">
                    <ToolbarComponent ref={(toolbar) => (toolbarEditor = toolbar)} id="toolbar_diagram" clicked={toolbarClick} items={toolbarItems} overflowMode={'Scrollable'} width={'100%'}></ToolbarComponent>
                </div>
                <div style={{ width: '100%' }}>
                    <DiagramComponent id="diagram" ref={(diagram) => (diagramInstance = diagram)} width={'100%'} height={'800px'} rulerSettings={{ showRulers: true }} nodes={nodes} historyChange={(args) => {
            historyChange(args);
