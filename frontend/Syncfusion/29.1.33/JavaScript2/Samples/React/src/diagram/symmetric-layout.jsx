...
export class SymmetricLayout extends SampleBase {
    ...
    render() {
        ...
        getConnectorDefaults={(connector) => {
                ...
                return connector;
            }} setNodeTemplate={(node) => { setNodeTemplate(node); }} tool={DiagramTools.ZoomPan}>
            ...
            ].map((property) => (<tr style={{ height: '40px' }}>
                                <td style={{ width: '30%' }}>{property.label}</td>
                                <td style={{ width: '60%' }}>
                                    <NumericTextBoxComponent id={property.id} ref={refObject => {
