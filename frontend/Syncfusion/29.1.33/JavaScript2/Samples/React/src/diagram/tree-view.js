...
var TreeViewSample = /** @class */ (function (_super) {
    __extends(TreeViewSample, _super);
    function TreeViewSample() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    TreeViewSample.prototype.rendereComplete = function () {
    };
    TreeViewSample.prototype.render = function () {
    ...
    return TreeViewSample;
}(sample_base_1.SampleBase));
exports.TreeViewSample = TreeViewSample;
//add function
function add() {
    var nodeId;
