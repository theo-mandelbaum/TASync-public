...
var SAMPLE_CSS = ".diagram-symbolpalette .property-panel-header {\npadding-top: 15px;\npadding-bottom: 15px;\n}";
...
function SymbolPalette() {
    ...
    return (React.createElement("div", { className: "control-pane diagram-symbolpalette" },
        ...
        React.createElement("div", { className: "col-lg-8 control-section", id: "palette-space" },
            React.createElement("div", { className: "content-wrapper", style: { width: "100%" } },
                React.createElement(ej2_react_diagrams_1.SymbolPaletteComponent, { id: "symbolpalette", ref: function (symbolpal) { return (palette = symbolpal); }, expandMode: "Multiple", allowDrag: true, palettes: [
                    ...
                    ], enableAnimation: true, width: "100%", height: "100%", symbolWidth: 80, symbolHeight: 80, getNodeDefaults: nodeDefaults.bind(this), getSymbolInfo: symbolInfo.bind(this), symbolMargin: { left: 15, right: 15, top: 15, bottom: 15 } }))),
        React.createElement("div", { className: "col-lg-4 property-section" },
            ...
            React.createElement("table", { id: "property", title: "Properties" },
                ...
                React.createElement("tr", null,
                    ...
                    React.createElement("td", { style: { width: "60%" } },
                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: "size", value: 80, min: 60, max: 100, width: 120, step: 5, format: "##.##", change: function () {
