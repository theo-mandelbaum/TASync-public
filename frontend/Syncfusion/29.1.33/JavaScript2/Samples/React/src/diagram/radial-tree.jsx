...
export class Radial extends SampleBase {
    ...
    render() {
        return (<div className="control-panel diagram-radialtree">
        ...
        <div className="content-wrapper" style={{ width: "100%" }}>
            ...
            <DiagramComponent id="diagram" ref={diagram => (diagramInstance = diagram)} width={"100%"} height={"600px"} snapSettings={{ constraints: SnapConstraints.None }} 
