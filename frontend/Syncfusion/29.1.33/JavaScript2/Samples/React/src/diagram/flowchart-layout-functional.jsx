            ...
            <div className="control-section">
                <div className="control-wrapper">
                    <div className="content-wrapper" style={{ width: '100%', background: 'white' }}>
                        <DiagramComponent id="diagram" ref={(diagram) => (diagramInstance = diagram)} width={'100%'} height={'1500px'} rulerSettings={{ showRulers: true }} getNodeDefaults={getNodeDefaults} getConnectorDefaults={getConnectorDefaults} tool={DiagramTools.ZoomPan} layout={{
            type: 'Flowchart',
