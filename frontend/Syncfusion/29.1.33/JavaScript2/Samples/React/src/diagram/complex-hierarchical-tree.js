...
exports.ComplexHierarchicalModel = void 0;
...
var ComplexHierarchicalModel = /** @class */ (function (_super) {
    ...
    ComplexHierarchicalModel.prototype.lockConnectorOverlapping = function (args) {
        ...
        return (React.createElement("div", { className: "control-pane diagram-control-pane" },
            ...
            React.createElement("div", { className: "col-lg-8 control-section" },
                React.createElement("div", { className: "content-wrapper", style: { width: "100%" } },
                    React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: "100%", height: 580, layout: {
                        ...
                        , getNodeDefaults: function (obj) { return getNodeDefaults(obj); }, getConnectorDefaults: function (connector) { return getConnectorDefaults(connector); }, dataSourceSettings: {
                            id: "Name",
            ...
            React.createElement("div", { className: "col-lg-4 property-section" },
                ...
                React.createElement("div", { className: "row property-panel-content", style: { paddingTop: "10px" } },
                    ...
                    React.createElement("div", { className: "row property-panel-content", style: { paddingTop: "10px" } },
                        React.createElement("div", { className: "row", style: { paddingTop: "8px" } },
                            React.createElement(ej2_react_buttons_1.CheckBoxComponent, { checked: true, label: "Prevent Connector Overlapping", id: "lock", change: this.lockConnectorOverlapping.bind(this) }))))),
