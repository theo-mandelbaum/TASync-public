    ...
    return (<div className="control-pane diagram-control-pane">
            ...
            <div className="col-lg-8 control-section">
                <div className="content-wrapper" style={{ width: "100%" }}>
                    <DiagramComponent id="diagram" ref={diagram => (diagramInstance = diagram)} width={"100%"} height={580} 
    ...
    layout={{
            ...
            { id: "verticalSpacing", label: "Vertical Spacing", value: 40, min: 20, max: 60 },
                ...
                updateLayoutProperty(id, args.value);
                    ...
                    <div className="row property-panel-content" style={{ paddingTop: "10px" }}>
                        <div className="row" style={{ paddingTop: "8px" }}>
                            <CheckBoxComponent checked={true} label="Prevent Connector Overlapping" id="lock" change={lockConnectorOverlapping.bind(this)}/>
                        </div>
                    </div>
                </div>
            </div>
