    ...
    render() {
          ...
          <div className="row  property-panel-content" style={{ paddingTop: "10px" }}>
            ...
            <div className="row" style={{ paddingTop: "8px" }}>
              ...
              <div className="col-xs-6">
                <NumericTextBoxComponent ref={horizontalSpacingRef => (horizontalSpacing = horizontalSpacingRef)} id="hSpacing" style={{ width: "100%" }} format="###.##" min={20} max={60} step={2} value={40} 
        ...
        change={() => {
            ...
            <div className="row" style={{ paddingTop: "8px" }}>
              ...
              <div className="col-xs-6">
                <NumericTextBoxComponent ref={verticalSpacingRef => (verticalSpacing = verticalSpacingRef)} id="vSpacing" style={{ width: "100%" }} format="###.##" min={20} max={60} step={2} value={30} 
