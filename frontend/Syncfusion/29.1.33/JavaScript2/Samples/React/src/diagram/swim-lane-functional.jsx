...
import { DiagramComponent, SymbolPaletteComponent, PortConstraints, SnapConstraints, SelectorConstraints, PortVisibility, Inject, UndoRedo, DiagramContextMenu, 
//private method
...
function SwimLane() {
    ...
    return (<div className="control-pane diagram-Swimlane">
      ...
      <div className="control-section">
        <div style={{ width: "100%" }}>
          ...
          <div id="palette-space" ref={(paletteSpace) => (paletteSpaceInstance = paletteSpace)} className="sb-mobile-palette">
            <SymbolPaletteComponent id="symbolpalette" expandMode="Multiple" palettes={palettes} getNodeDefaults={getNodeDefaults} getConnectorDefaults={getConnectorDefaults} width={"100%"} height={"560px"} symbolHeight={48} symbolWidth={48} symbolMargin={{ left: 8, right: 8, top: 8, bottom: 8 }} getSymbolInfo={(symbol) => {
            return { tooltip: symbol.addInfo ? symbol.addInfo['tooltip'] : symbol.id };
        }}/>
          </div>
          <div id="diagram-space" className="sb-mobile-diagram">
            <DiagramComponent id="diagram" ref={diagram => (diagramInstance = diagram)} width={"100%"} height={"560px"} snapSettings={{ constraints: SnapConstraints.None }} nodes={nodes} connectors={connectors} getNodeDefaults={getNodeDefaults} getConnectorDefaults={getConnectorDefaults} contextMenuSettings={contextMenu} contextMenuOpen={contextMenuOpen} contextMenuClick={contextMenuClick} 
