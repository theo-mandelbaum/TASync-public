...
import { ComplexHierarchicalTree, DataBinding, LineDistribution, DiagramComponent, ConnectionPointOrigin, Inject, DiagramTools } from "@syncfusion/ej2-react-diagrams";
...
export class ComplexHierarchicalModel extends SampleBase {
    ...
    rendereComplete() {
        ...
        propertyPanelInstance.onclick = (args) => {
    ...
    render() {
        return (<div className="control-pane diagram-control-pane">
            ...
            } getNodeDefaults={(obj) => getNodeDefaults(obj)} // Call getNodeDefaults method
         getConnectorDefaults={(connector) => getConnectorDefaults(connector)} // Call getConnectorDefaults method
         dataSourceSettings={{
                id: "Name",
                ...
                <div className="col-lg-4 property-section">
                    ...
                    <div className="row property-panel-content" id="appearance" ref={appearance => (propertyPanelInstance = appearance)} style={{ paddingTop: "10px" }}>
                        ...
                        <div className="row" style={{ paddingTop: "8px" }}>
                            {["toptobottom", "bottomtotop", "lefttoright"].map((id, index) => (<div className={`image-pattern-style${index === 0 ? "e-selected-style" : ""}`} id={id} style={{
                ...
                { id: "verticalSpacing", label: "Vertical Spacing", value: 40, min: 20, max: 60 },
            ].map(({ id, label, value, min, max }) => (<div className="row" style={{ paddingTop: "8px" }}>
                                ...
                                <div className="col-xs-7">
                                    <NumericTextBoxComponent id={id} value={value} min={min} max={max} step={1} format={"##.##"} change={(args) => {
                    updateLayoutProperty(id, args.value);
                        ...
                        <div className="row property-panel-content" style={{ paddingTop: "10px" }}>
                            <div className="row" style={{ paddingTop: "8px" }}>
                                <CheckBoxComponent checked={true} label="Prevent Connector Overlapping" id="lock" change={this.lockConnectorOverlapping.bind(this)}/>
                            </div>
                        </div>
                    </div>
                </div>
