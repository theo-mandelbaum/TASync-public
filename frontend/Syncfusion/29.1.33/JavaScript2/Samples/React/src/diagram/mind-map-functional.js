...
function MindMap() {
    ...
    function addNode() {
        var obj = {};
        obj.id = (0, ej2_react_diagrams_1.randomId)();
        obj.data = {};
        obj.data.Label = "Node";
        return obj;
    }
    ...
    function addConnector(source, target) {
        var connector = {};
        connector.id = (0, ej2_react_diagrams_1.randomId)();
    ...
    function hideUserHandle(name) {
        for (var _i = 0, _a = diagramInstance.selectedItems.userHandles; _i < _a.length; _i++) {
            var handle_1 = _a[_i];
            if (handle_1.name === name) {
                handle_1.visible = false;
            }
        }
    }
    ...
    function changeUserHandlePosition(change) {
        for (var _i = 0, _a = diagramInstance.selectedItems.userHandles; _i < _a.length; _i++) {
            var handle_2 = _a[_i];
            if (handle_2.name === "delete" && change === "leftHandle") {
                applyHandle(handle_2, "Left", 1, { top: 0, bottom: 0, left: 0, right: 10 }, "Left", "Top");
            }
            else if (handle_2.name === "delete" && change === "rightHandle") {
                applyHandle(handle_2, "Right", 1, { top: 0, bottom: 0, left: 10, right: 0 }, "Right", "Top");
            }
        }
    }
    ...
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("div", { className: "control-section" },
            React.createElement("div", { className: "content-wrapper", style: { width: "100%" } },
                React.createElement(ej2_react_diagrams_1.DiagramComponent, { ref: function (diagram) { return (diagramInstance = diagram); }, id: "diagram", style: { width: "74%", height: "550px", float: "left" }, width: "100%", height: "550px", constraints: ej2_react_diagrams_1.DiagramConstraints.Default & ~ej2_react_diagrams_1.DiagramConstraints.UndoRedo, snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.None }, tool: ej2_react_diagrams_1.DiagramTools.SingleSelect, layout: {
                        type: "MindMap",
