...
function GettingStartedNodes() {
    ...
    function setNodeAspectConstraints(args) {
        for (var i = 0; i < diagramInstance.nodes.length; i++) {
            ...
            if (args.checked) {
                node_1.constraints |= ej2_react_diagrams_1.NodeConstraints.AspectRatio;
            }
            else {
                node_1.constraints &= ~ej2_react_diagrams_1.NodeConstraints.AspectRatio;
            }
    ...
    function setLockConstraints(args) {
        for (var i = 0; i < diagramInstance.nodes.length; i++) {
            ...
            if (args.checked) {
                node_2.constraints &= ~(ej2_react_diagrams_1.NodeConstraints.Resize | ej2_react_diagrams_1.NodeConstraints.Rotate | ej2_react_diagrams_1.NodeConstraints.Drag | ej2_react_diagrams_1.NodeConstraints.Delete);
                node_2.constraints |= ej2_react_diagrams_1.NodeConstraints.ReadOnly;
            }
            else {
                node_2.constraints |= ej2_react_diagrams_1.NodeConstraints.Default & ~(ej2_react_diagrams_1.NodeConstraints.ReadOnly);
            }
        }
        diagramInstance.dataBind();
...
exports.default = GettingStartedNodes;
