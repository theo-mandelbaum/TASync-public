    ...
    return (<div className='control-pane diagram-tooltip'>
                    ...
                    <tr style={{ paddingTop: "10px" }}>
                        ...
                        <td>
                            <div style={{ paddingLeft: "15px" }}>
                                <DropDownListComponent id='mode' ref={dropdown => (modeDropdown = dropdown)} dataSource={modeValue} fields={fields} placeholder='select a mode value' popupWidth='150' width='85%' index={0} change={(args) => {
            if (args.value === 'Mouse') {
            ...
            diagramInstance.dataBind();
                    ...
                    <tr style={{ paddingTop: "10px" }}>
                        ...
                        <td>
                            <div style={{ paddingLeft: "15px" }}>
                                <DropDownListComponent id='position' ref={dropdown => (positionDropdown = dropdown)} dataSource={PositionValue} fields={fields} index={0} placeholder='select a position' popupWidth='150' width='85%' change={(args) => {
            ...
            diagramInstance.dataBind();
                    ...
                    <tr style={{ paddingTop: "10px" }}>
                        ...
                        <td>
                            <div style={{ paddingLeft: "15px" }}>
                                <DropDownListComponent id='effect' ref={dropdown => (effectDropdown = dropdown)} dataSource={EffectValue} fields={fields} placeholder='select a effect' popupWidth='150' width='85%' index={0} change={(args) => {
