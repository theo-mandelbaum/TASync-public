        ...
        React.createElement("div", { className: "col-lg-12 control-section" },
            React.createElement("div", { className: "content-wrapper", style: { width: "100%" } },
                React.createElement("div", null,
                    ...
                    React.createElement("div", null,
                        React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: "100%", height: "645px", nodes: nodes, connectors: connectors, tool: ej2_react_diagrams_1.DiagramTools.ZoomPan //Disables all interactions except zoom/pan
                            , scrollSettings: { currentZoom: 0.8 }, snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.None }, pageSettings: { background: { color: 'white' } }, getNodeDefaults: function (node, diagram) {
