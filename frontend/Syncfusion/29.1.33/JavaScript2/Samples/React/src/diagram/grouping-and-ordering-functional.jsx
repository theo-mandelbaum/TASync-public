...
import { DiagramComponent, Node, SymbolPaletteComponent, SelectorConstraints, } from '@syncfusion/ej2-react-diagrams';
...
const createNode = (id, offsetX, offsetY, width, height, shape, annotations = [], cornerRadius = 0) => ({
    id: id,
    offsetX: offsetX,
    offsetY: offsetY,
    width: width,
...
const createGroupNode = (id, children, padding, annotations) => ({
    id: id,
    children: children,
    padding: padding,
    annotations: annotations
...
const createBasicShape = (id, shape) => ({
    id: id,
...
function GroupandOrder() {
    ...
    function renderFontFamilyDropdown() {
        return (<div className="col-xs-4 column-style" style={{ marginLeft: '4px' }}>
                <DropDownListComponent id="fontfamily" popupWidth={150} width={'150px'} fields={fields} placeholder={'select a font type'} index={0} dataSource={fontType} change={(args) => {
    ...
    function renderFontSizeNumericBox() {
        return (<div className="col-xs-4 column-style">
                <NumericTextBoxComponent id="fontSize" width={'110px'} value={12} min={1} max={30} step={2} format="##.##" change={(args) => {
    ...
    function renderFontColorPicker() {
        return (<div className="col-xs-4 column-style">
                <ColorPickerComponent id="fontcolor" value="#000" mode="Palette" change={(arg) => {
            ...
            <div className="control-section">
                <div style={{ width: '100%' }}>
                    <div className="db-toolbar-container">
                        ...
                        <ToolbarComponent ref={(toolbar) => (toolbarEditor = toolbar)} id="toolbar_diagram" clicked={handleToolbarClick} items={toolbarItems}>
                        </ToolbarComponent>
                    </div>
    ...
    palettes={[
            {
                ...
                title: 'Basic Shapes',
                    ...
                    <div id="diagram-space" className="db-diagram-container">
                        <DiagramComponent id="diagram" ref={(diagram) => (diagramInstance = diagram)} width={'100%'} height={'500px'} selectedItems={{ constraints: SelectorConstraints.UserHandle, userHandles: handles }} rulerSettings={{ showRulers: true }} onUserHandleMouseDown={(args) => { onUserHandleMouseDown(args); }} selectionChange={(args) => { selectionChange(args); }} drawingObject={{ type: 'Orthogonal' }} nodes={nodes}/>
                    </div>
                </div>
            </div>
