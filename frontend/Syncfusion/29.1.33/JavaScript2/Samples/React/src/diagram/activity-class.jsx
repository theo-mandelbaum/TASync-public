...
import { DiagramComponent, SymbolPaletteComponent, Connector } from "@syncfusion/ej2-react-diagrams";
...
export class UMLClassDiagram extends SampleBase {
    ...
    render() {
        return (<div className="control-pane diagram-umlclass">
          <div className="control-section">
            <div style={{ width: "100%" }}>
              ...
              <div id="palette-space" ref={(paletteSpace) => (paletteSpaceInstance = paletteSpace)} className="sb-mobile-palette">
                <SymbolPaletteComponent id="symbolpalette" expandMode="Multiple" palettes={palettes} width={"100%"} height={"700px"} symbolHeight={90} symbolWidth={90} getNodeDefaults={(symbol) => {
                symbol.width = 100;
                symbol.height = 100;
            }} symbolMargin={{ left: 12, right: 12, top: 12, bottom: 12 }} getSymbolInfo={(symbol) => {
                return { fit: true, description: { text: symbol.id, }, tooltip: symbol.addInfo ? symbol.addInfo['tooltip'] : symbol.id };
            }}/>
              </div>
              <div id="diagram-space" className="sb-mobile-diagram">
                <DiagramComponent id="diagram" ref={diagram => (diagramInstance = diagram)} width={"100%"} height={"700px"} nodes={nodes} connectors={connectors} //Sets the default values of a node
