...
import { DiagramComponent, Diagram, BpmnDiagrams, UndoRedo, NodeConstraints, AnnotationConstraints, SnapConstraints, DiagramTools, randomId } from "@syncfusion/ej2-react-diagrams";
...
function WorkFlowEditor() {
    ...
    function tooledit(args) {
        let toolbardiagram = toolbarEditor;
    ...
    return (<div className="control-pane">
      ...
      <div className="col-lg-12 control-section">
        <div className="content-wrapper" style={{ width: "100%" }}>
          <div>
            <div>
              <ToolbarComponent ref={(toolbar) => (toolbarEditor = toolbar)} id="toolbar_diagram" clicked={tooledit}>
                <ItemsDirective>
                  <ItemDirective tooltipText="Execute" text="Execute" prefixIcon='e-play'/>
                  <ItemDirective type="Separator"/>
                  <ItemDirective tooltipText="Reset" text="Reset" disabled={true} prefixIcon="e-icons e-reset"/>
                </ItemsDirective>
              </ToolbarComponent>
            </div>
            <div>
              <DiagramComponent id="diagram" ref={diagram => (diagramInstance = diagram)} width={"100%"} height={"645px"} nodes={nodes} connectors={connectors} tool={DiagramTools.ZoomPan //Disables all interactions except zoom/pan
        } scrollSettings={{ currentZoom: 0.8 }} snapSettings={{ constraints: SnapConstraints.None }} pageSettings={{ background: { color: 'white' } }} getNodeDefaults={(node, diagram) => {
