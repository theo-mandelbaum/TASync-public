        ...
        return (<div className='control-pane diagram-tooltip'>
                        ...
                        <tr style={{ paddingTop: "10px" }}>
                            ...
                            <td>
                                <div style={{ paddingLeft: "15px", width: '70%' }}>
                                    <DropDownListComponent id='mode' ref={dropdown => (modeDropdown = dropdown)} dataSource={modeValue} fields={this.fields} placeholder='select a mode value' popupWidth='150' width='85%' index={0} change={(args) => {
                if (args.value === 'Mouse') {
                ...
                diagramInstance.dataBind();
                        ...
                        <tr style={{ paddingTop: "10px" }}>
                            ...
                            <td>
                                <div style={{ paddingLeft: "15px", width: '70%' }}>
                                    <DropDownListComponent id='position' ref={dropdown => (positionDropdown = dropdown)} dataSource={PositionValue} fields={this.fields} index={0} placeholder='select a position' popupWidth='150' width='85%' change={(args) => {
                    ...
                    if (nodes[i].tooltip) {
                        ...
                        <tr style={{ paddingTop: "10px" }}>
                            ...
                            <td style={{ paddingLeft: "15px" }}>
                                <NumericTextBoxComponent id='duration' value={100} min={100} max={2000} step={100} width={'85%'} change={(args) => {
                        ...
                        <tr style={{ paddingTop: "10px" }}>
                            ...
                            <td>
                                <div style={{ paddingLeft: "15px" }}>
                                    <DropDownListComponent id='effect' ref={dropdown => (effectDropdown = dropdown)} dataSource={EffectValue} fields={this.fields} placeholder='select a effect' popupWidth='150' width='85%' index={0} change={(args) => {
                ...
                diagramInstance.dataBind();
                        ...
                        <tr style={{ paddingTop: "20px" }}>
                            <td>Sticky Mode</td>
                            <td>
                                <CheckBoxComponent checked={false} change={(args) => {
