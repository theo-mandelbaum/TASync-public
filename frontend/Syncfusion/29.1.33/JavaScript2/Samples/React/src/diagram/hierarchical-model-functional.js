            ...
            React.createElement("div", { className: "row  property-panel-content", style: { paddingTop: "10px" } },
                ...
                React.createElement("div", { className: "row", style: { paddingTop: "8px" } },
                    ...
                    React.createElement("div", { className: "col-xs-6" },
                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { ref: function (horizontalSpacingRef) { return (horizontalSpacing = horizontalSpacingRef); }, id: "horizontalSpacing", style: { width: "100%" }, format: "###.##", min: 20, max: 60, step: 2, value: 40, 
                ...
                React.createElement("div", { className: "row", style: { paddingTop: "8px" } },
                    ...
                    React.createElement("div", { className: "col-xs-6" },
                        React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { ref: function (verticalSpacingRef) { return (verticalSpacing = verticalSpacingRef); }, id: "verticalSpacing", style: { width: "100%" }, format: "###.##", min: 20, max: 60, step: 2, value: 30, 
...
exports.default = HierarchicalModel;
