...
exports.VirtualizationModel = void 0;
...
function dataVirtualization() {
    var i = 0;
    var data = [];
    var parentName = diagram_data_1.virtualizationData[0].Name;
    data.push({ 'Name': parentName, 'Parent': "" });
    i++;
    for (var j = 1; j < 100; j++) {
        var name_1 = diagram_data_1.virtualizationData[i].Name;
        data.push({ 'Name': name_1, 'Parent': parentName });
        i++;
        for (var k = 0; k < 2; k++) {
            data.push({ 'Name': diagram_data_1.virtualizationData[i].Name, 'Parent': name_1 });
            i++;
        }
    }
    return data;
}
var VirtualizationModel = /** @class */ (function (_super) {
    __extends(VirtualizationModel, _super);
    function VirtualizationModel() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    VirtualizationModel.prototype.rendereComplete = function () {
        diagramInstance.fitToPage({ mode: 'Page', region: 'CustomBounds', margin: { left: 50, right: 50 }, customBounds: bound });
    };
    // Renders the component UI
    VirtualizationModel.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("style", null, SAMPLE_CSS),
            React.createElement("div", null,
                React.createElement("div", { style: { width: "100%" } },
                    React.createElement(ej2_react_navigations_1.ToolbarComponent, { id: "toolbar_diagram", clicked: handleToolbarItemClick, items: [
                            {
                                type: "Button",
                                tooltipText: "ZoomIn",
                                text: "Zoom In",
                    ...
                    React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: "100%", height: "500px", snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.None }, dataSourceSettings: {
                        ...
                        }, constraints: ej2_react_diagrams_1.DiagramConstraints.Default | ej2_react_diagrams_1.DiagramConstraints.Virtualization, getConnectorDefaults: function (connector) {
            ...
            React.createElement("div", { id: "action-description" },
                React.createElement("p", null, "This sample demonstrates the default UI virtualization functionality. Scroll the diagram for UI virtualization experience.")),
            React.createElement("div", { id: "description" },
                React.createElement("p", null,
                    "Drawing huge amounts of nodes and connectors on initial loading slows the rendering process down. Syncfusion virtualization support helps improve the performance on initial rendering. Virtualization can be enabled by adding the ",
                    React.createElement("code", null, "Virtualization"),
                    " flag to the ",
                    React.createElement("code", null, "constraints"),
                    " property of the diagram."),
                React.createElement("br", null))));
    };
    return VirtualizationModel;
}(sample_base_1.SampleBase));
exports.VirtualizationModel = VirtualizationModel;
...
function handleToolbarItemClick(args) {
    switch (args.item.text) {
        case "Zoom In":
            var zoomInOptions = { type: "ZoomIn", zoomFactor: 0.2 };
            diagramInstance.zoomTo(zoomInOptions);
            break;
        case "Zoom Out":
            var zoomOutOptions = { type: "ZoomOut", zoomFactor: 0.2 };
