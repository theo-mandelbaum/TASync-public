...
function HtmlNode() {
            ...
            return (React.createElement("div", { id: "diagram_control", className: "diagram_border_cus" },
                React.createElement("div", { className: "pane col-xs-12 col-sm-12 col-md-12 pie-container" },
                    ...
                    React.createElement("div", { id: "pieChart", style: { height: '100%', width: '49%', overflow: 'hidden', float: 'left' } },
                        React.createElement(ej2_react_charts_1.AccumulationChartComponent, { style: { display: 'block' }, ref: function (pies) { return (pie = pies); }, id: 'pieChart', width: '100%', height: '350px', legendSettings: acclegendSettings, enableSmartLabels: true, textRender: onTextRender, animationComplete: onAnimateCompleted },
                    ...
                    React.createElement("div", { id: "grid", style: { height: '100%', width: '49%', overflow: 'hidden', float: 'left' } },
                        React.createElement(ej2_react_grids_1.GridComponent, { id: "legend-grid", ref: function (lGrids) { return (lGrid = lGrids); }, dataSource: pieRenderData, style: { boxShadow: 'none' }, rowTemplate: gtemplate, dataBound: onGridDataBound },
    ...
    return (React.createElement("div", { className: "control-pane" },
        React.createElement("div", { id: "custom-diagram", className: "control-section" },
            React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: "100%", backgroundColor: '#f5f5f5', height: "1100px", nodes: nodes, created: function (args) { rendereComplete(); }, nodeTemplate: template.bind(this) })),
