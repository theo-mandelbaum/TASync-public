...
import { DiagramComponent, Node, Diagram, Inject, UndoRedo, Rect, SymbolPaletteComponent, } from '@syncfusion/ej2-react-diagrams';
...
export class ScrollingSample extends SampleBase {
    ...
    render() {
        return (<div className="control-pane diagram-scroll">
        ...
        <div className="control-section">
          <div style={{ width: '100%' }}>
            ...
            <div id="palette-space" ref={(paletteSpace) => (paletteSpaceInstance = paletteSpace)} className="sb-mobile-palette" style={{ width: '20%', float: 'left' }}>
              <SymbolPaletteComponent id="symbolpalette" expandMode="Single" palettes={[
                {
                    id: 'basic',
                    expanded: true,
                    symbols: basicShapes,
            ...
            ]} width={'100%'} height={'700px'} symbolHeight={60} symbolWidth={60} getConnectorDefaults={getConnectorDefaults} getNodeDefaults={(symbol) => {
                let obj = symbol;
            ...
            <div id="diagram-space" className="sb-mobile-diagram" style={{ width: '59%', float: 'left' }}>
              <DiagramComponent id="diagram" ref={(diagram) => (diagramInstance = diagram)} width={'100%'} height={'700px'} rulerSettings={{ showRulers: true }} pageSettings={{ width: 1500, height: 1500 }} scrollSettings={{
                scrollLimit: 'Infinity',
                canAutoScroll: true,
                autoScrollBorder: { left: 30, right: 30, top: 30, bottom: 30 },
                scrollableArea: scrollableArea,
            }} getConnectorDefaults={getConnectorDefaults} created={() => {
                let scrollElement = scrollableDivInstance;
        ...
        dragEnter={(args) => {
            ...
            <div className="row db-prop-row">
              <div className="col-xs-5 db-col-right db-prop-text-style" style={{ paddingTop: '14px' }}>
                <span className="db-prop-text-style db-spacing-text">
                  Scroll Limit
                </span>
              </div>
              <div className="col-xs-7 db-col-left" style={{ paddingTop: '10px', paddingRight: '0px' }}>
                <div className="db-text-input">
                  <DropDownListComponent id="scrollLimit" fields={fields} value={'Infinity'} dataSource={scrollLimitDatasource} change={(args) => {
            ...
            <div id="scrollableDiv" ref={(scrollableDiv) => (scrollableDivInstance = scrollableDiv)}>
              ...
              <div className="row db-prop-row" style={{ paddingTop: '10px' }}>
                <div className="col-xs-6" style={{ paddingRight: '15px', width: '175px' }}>
                  <div style={{ width: '40%', float: 'left', marginTop: '5px' }}>
                ...
                paddingLeft: '20px',
                    ...
                    <TextBoxComponent id="x" value="10" change={(args) => {
              ...
              <div className="row db-prop-row" style={{ paddingTop: '10px' }}>
                ...
                paddingLeft: '20px',
                    ...
                    <TextBoxComponent id="y" value="10" change={(args) => {
              ...
              <div className="row db-prop-row" style={{ paddingTop: '10px' }}>
                <div className="col-xs-6 db-col-left" style={{ width: '175px' }}>
                  <div style={{ width: '40%', float: 'left', marginTop: '5px' }}>
                ...
                paddingLeft: '20px',
                    ...
                    <TextBoxComponent id="width" value="1500" change={(args) => {
              ...
              <div className="row db-prop-row" style={{ paddingTop: '10px' }}>
                <div className="col-xs-6 db-col-right" style={{ width: '175px' }}>
                  <div style={{ width: '40%', float: 'left', marginTop: '5px' }}>
                ...
                paddingLeft: '20px',
                    ...
                    <TextBoxComponent id="height" value="10" change={(args) => {
            ...
            <div style={{ paddingTop: '5px', marginTop: '20px' }}>
              ...
              <div style={{ float: 'left', marginLeft: '10px' }}>
                <CheckBoxComponent id="EnableScroll" checked={true} change={(args) => {
            ...
            <div id="autoScrollDiv" style={{ marginTop: '30px' }} ref={(autoScrollDiv) => (autoScrollDivInstance = autoScrollDiv)}>
              ...
              <div className="row db-prop-row" style={{ paddingTop: '10px' }}>
                ...
                paddingLeft: '20px',
                    ...
                    <TextBoxComponent id="left" value="30" change={(args) => {
              ...
              <div className="row db-prop-row" style={{ paddingTop: '10px' }}>
                ...
                paddingLeft: '20px',
                    ...
                    <TextBoxComponent id="top" value="30" change={(args) => {
              ...
              <div className="row db-prop-row" style={{ paddingTop: '10px' }}>
                ...
                paddingLeft: '20px',
                    ...
                    <TextBoxComponent id="right" value="30" change={(args) => {
              ...
              <div className="row db-prop-row" style={{ paddingTop: '10px' }}>
                ...
                paddingLeft: '20px',
                    ...
                    <TextBoxComponent id="bottom" value="30" change={(args) => {
