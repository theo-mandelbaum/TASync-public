...
exports.EffectValue = exports.PositionValue = exports.modeValue = void 0;
...
function Tooltip() {
    ...
    var fields = { text: 'text', value: 'type' };
            ...
            React.createElement("table", { id: 'diagramTooltipPropertyPanel', title: 'Properties' },
                React.createElement("tbody", null,
                    React.createElement("tr", { style: { paddingTop: "10px" } },
                        ...
                        React.createElement("td", null,
                            React.createElement("div", { style: { paddingLeft: "15px" } },
                                React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: 'mode', ref: function (dropdown) { return (modeDropdown = dropdown); }, dataSource: exports.modeValue, fields: fields, placeholder: 'select a mode value', popupWidth: '150', width: '85%', index: 0, change: function (args) {
                                        if (args.value === 'Mouse') {
                    ...
                    React.createElement("tr", { style: { paddingTop: "10px" } },
                        ...
                        React.createElement("td", null,
                            React.createElement("div", { style: { paddingLeft: "15px" } },
                                React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: 'position', ref: function (dropdown) { return (positionDropdown = dropdown); }, dataSource: exports.PositionValue, fields: fields, index: 0, placeholder: 'select a position', popupWidth: '150', width: '85%', change: function (args) {
                    ...
                    React.createElement("tr", { style: { paddingTop: "10px" } },
                        ...
                        React.createElement("td", null,
                            React.createElement("div", { style: { paddingLeft: "15px" } },
                                React.createElement(ej2_react_dropdowns_1.DropDownListComponent, { id: 'effect', ref: function (dropdown) { return (effectDropdown = dropdown); }, dataSource: exports.EffectValue, fields: fields, placeholder: 'select a effect', popupWidth: '150', width: '85%', index: 0, change: function (args) {
                    ...
                    React.createElement("tr", { style: { paddingTop: "20px" } },
                        ...
                        React.createElement("td", { style: { paddingLeft: "15px", width: '70%' } },
