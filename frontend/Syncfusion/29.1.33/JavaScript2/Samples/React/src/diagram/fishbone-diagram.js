...
var createNode = function (id, height, width, offsetX, offsetY, content) { return ({
    id: id,
    height: height,
    width: width,
    offsetX: offsetX,
...
var createEllipseNode = function (id, height, width, offsetX, offsetY, content, fill, strokeColor) {
    if (content === void 0) { content = ""; }
    if (fill === void 0) { fill = "white"; }
    if (strokeColor === void 0) { strokeColor = '#A52A2A'; }
    return ({
        id: id,
        width: width,
        height: height,
...
var createTextNode = function (id, height, width, offsetX, offsetY, content) { return ({
    id: id,
    width: width,
    height: height,
    offsetX: offsetX,
...
var createConnector = function (id, lineDashArray, source, target, strokeColor) { return ({
    id: id,
    sourceID: source,
    targetID: target,
    style: {
...
var Fishbone = /** @class */ (function (_super) {
    ...
    Fishbone.prototype.renderComplete = function () {
        ...
        return (React.createElement("div", { className: "control-pane" },
            React.createElement("div", { className: "control-section" },
                React.createElement("div", { style: { width: "100%" } },
                    React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: "100%", height: "700px", snapSettings: { constraints: ej2_react_diagrams_1.SnapConstraints.None }, nodes: nodes, connectors: connectors, 
