...
function ScrollingSample() {
    ...
    <style>{sample_css}</style>
        ...
        }} getConnectorDefaults={getConnectorDefaults} symbolMargin={{ left: 15, right: 15, top: 15, bottom: 15 }} getSymbolInfo={(symbol) => {
            return { fit: true };
        }}/>
            </div>
    ...
    dragEnter={(args) => {
            ...
            <div className="row db-prop-row">
              <div className="col-xs-5 db-col-right db-prop-text-style" style={{ paddingTop: '10px' }}>
                <span className="db-prop-text-style db-spacing-text">
                  Scroll Limit
                </span>
              </div>
              <div className="col-xs-7 db-col-left" style={{ paddingTop: '5px', paddingRight: '0px' }}>
            ...
            paddingLeft: '20px',
                    ...
                    <TextBoxComponent id="height" value="1500" change={(args) => {
