...
import { DiagramComponent, Diagram, randomId, AnnotationConstraints, SnapConstraints, UndoRedo, BpmnDiagrams, DiagramTools, NodeConstraints, } from '@syncfusion/ej2-react-diagrams';
        ...
        <div className="col-lg-12 control-section">
          <div>
            <div className="content-wrapper" style={{ width: "100%" }}>
              ...
              <div>
                <DiagramComponent id="diagram" ref={diagram => (diagramInstance = diagram)} width={"100%"} height={"645px"} nodes={nodes} tool={DiagramTools.ZoomPan} connectors={connectors} scrollSettings={{ currentZoom: 0.8 }} snapSettings={{ constraints: SnapConstraints.None }} pageSettings={{ background: { color: 'white' } }} getNodeDefaults={(node, diagram) => {
