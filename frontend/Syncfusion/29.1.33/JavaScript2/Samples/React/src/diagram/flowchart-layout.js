...
exports.FlowchartLayoutSample = void 0;
...
var FlowchartLayoutSample = /** @class */ (function (_super) {
    __extends(FlowchartLayoutSample, _super);
    function FlowchartLayoutSample() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    // Method to fit diagramInstance to page width
    FlowchartLayoutSample.prototype.rendereComplete = function () {
        diagramInstance.fitToPage({ mode: 'Width' });
    };
    FlowchartLayoutSample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("style", null, SAMPLE_CSS),
            React.createElement("div", { className: "control-section" },
                React.createElement("div", { className: "control-wrapper" },
                    React.createElement("div", { className: "content-wrapper", style: { width: '100%', background: 'white' } },
                        React.createElement(ej2_react_diagrams_1.DiagramComponent, { id: "diagram", ref: function (diagram) { return (diagramInstance = diagram); }, width: '100%', height: '1500px', scrollSettings: { scrollLimit: 'Infinity' }, rulerSettings: { showRulers: true }, getNodeDefaults: getNodeDefaults, getConnectorDefaults: getConnectorDefaults, tool: ej2_react_diagrams_1.DiagramTools.ZoomPan, layout: {
                                type: 'Flowchart',
    ...
    return FlowchartLayoutSample;
}(sample_base_1.SampleBase));
exports.FlowchartLayoutSample = FlowchartLayoutSample;
