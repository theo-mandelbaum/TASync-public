...
import { MoveTool, randomId, SelectorConstraints, cloneObject, DiagramComponent, Connector, Node, SnapConstraints } from "@syncfusion/ej2-react-diagrams";
...
function UserHandle() {
    ...
    return (<div className="control-pane diagram-userhandle">
    ...
    //set CustomTool
    getCustomTool={getTool} fixedUserHandleTemplate={fixedUserHandleTemplate.bind(this)} fixedUserHandleClick={() => {
