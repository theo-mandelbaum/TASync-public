                        ...
                        React.createElement("table", { id: "property", title: "Properties" },
                            React.createElement("tbody", null,
                                React.createElement("tr", null,
                                    ...
                                    React.createElement("td", { style: { width: "50%", paddingRight: "10px" } },
                                        React.createElement("div", null,
                                            React.createElement("input", { id: "tooltipContentValue", ref: function (t) { return (_this.text = t); }, onKeyUp: this.handleKeyPress.bind(this), type: "text", className: "e-input", placeholder: "Tooltip content" })))),
                                React.createElement("tr", null,
                                    React.createElement("td", { style: { width: "50%" } },
                                        React.createElement("div", { className: "userselect" }, "Height")),
                                    React.createElement("td", { style: { width: "50%", paddingRight: "10px" } },
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: "height", ref: function (t) { return (_this.height = t); }, value: 45, change: this.onHeightChange.bind(this), "aria-label": "height value" })))),
                                React.createElement("tr", null,
                                    React.createElement("td", { style: { width: "50%" } },
                                        React.createElement("div", { className: "userselect" }, "Width")),
                                    React.createElement("td", { style: { width: "50%", paddingRight: "10px" } },
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_inputs_1.NumericTextBoxComponent, { id: "width", ref: function (t) { return (_this.width = t); }, className: "e-input", value: 100, change: this.onWidthChange.bind(this), "aria-label": "width value" })))),
                                React.createElement("tr", null,
                                    React.createElement("td", { style: { width: "50%" } },
                                ...
                                React.createElement("tr", null,
                                    ...
                                    React.createElement("td", { style: { width: "50%", paddingRight: "10px" } },
                                        React.createElement("div", null,
                                            React.createElement(ej2_react_buttons_1.CheckBoxComponent, { id: "sticky", ref: function (t) { return (_this.sticky = t); }, change: this.checkboxChange.bind(this), "aria-label": "sticky" }))))))))),
