...
const TooltipMenu = () => {
    ...
    let fields = { text: "Name", iconCss: "icon" };
    let animationSettings = { effect: "None", duration: 0, delay: 0 };
    let listData;
    let data1 = [
    ...
    const tooltipTemplate = () => {
        return (<ListViewComponent id="tooltipMenu-list" dataSource={listData} fields={fields} showIcon={true}/>);
    };
    const onClick = (args) => {
        let targetEle;
        if (args) {
