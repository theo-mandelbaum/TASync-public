...
const Default = () => {
    ...
    const [position, SetPosition] = useState('TopCenter');
    ...
    return (<div className='control-pane'>
       <div className='control-section row'>
         <div className='col-lg-8' style={{ minHeight: '350px' }}>
           ...
           {/* Tooltip element */}
           <TooltipComponent content="Let's go green to save the planet!!" position={position} tabIndex={0} style={{ display: 'block', position: 'absolute', left: 'calc( 50% - 60px)', top: '45%' }}>
