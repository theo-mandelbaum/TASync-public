        ...
        return (React.createElement("div", { className: 'control-pane' },
            React.createElement("div", { className: 'control-section row' },
                React.createElement("div", { className: 'col-lg-8', style: { minHeight: '350px' } },
                    React.createElement(ej2_react_popups_1.TooltipComponent, { content: "Let's go green to save the planet!!", position: this.state.position, tabIndex: 0, style: { display: 'block', position: 'absolute', left: 'calc( 50% - 60px)', top: '45%' } },
                            ...
                            React.createElement("tr", null,
                                ...
                                React.createElement("td", { style: { width: '70%', paddingRight: '10px' } },
                                    React.createElement("div", null,
                                        React.createElement("select", { id: 'ddl', name: 'ddl', onChange: this.change.bind(this), className: 'form-control', style: { padding: '6px' }, "aria-label": "positions" },
