                ...
                React.createElement("div", { className: "row custom-margin" },
                    React.createElement("div", { className: "col-xs-6 col-sm-6 col-lg-6 col-md-6" },
                        React.createElement("div", { className: "e-input-group" },
                            ...
                            React.createElement("span", { className: "e-input-group-icon e-date-icon", onMouseDown: this.onIconClick, onMouseUp: this.onIconUnClick }))),
                    React.createElement("div", { className: "col-xs-6 col-sm-6 col-lg-6 col-md-6" },
                        React.createElement("div", { className: "e-input-group e-float-icon-left" },
                            React.createElement("span", { className: "e-input-group-icon e-upload-picture", onMouseDown: this.onIconClick, onMouseUp: this.onIconUnClick }),
