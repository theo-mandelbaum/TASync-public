...
function Icons() {
    ...
    const severityIconChange = (args) => {
        setShowIcon(args.checked ? true : false);
    };
    const closeIconChange = (args) => {
    ...
    return (<div className="control-pane">
            <div className="col-lg-8 control-section msg-icon-section">
                <div className="content-section">
                    ...
                    <MessageComponent id="msg_default_icon" visible={defaultVisible} showCloseIcon={showCloseIcon} closed={defaultClosed.bind(this)} showIcon={showIcon}>
                        Editing is restricted
                    </MessageComponent>
                    <ButtonComponent id="btn2" content="Show Info Message" cssClass={infoCssClass} onClick={infoClick.bind(this)}/>
                    <MessageComponent id="msg_info_icon" severity="Info" showCloseIcon={showCloseIcon} visible={infoVisible} closed={infoClosed.bind(this)} showIcon={showIcon}>
                        Please read the comments carefully
                    </MessageComponent>
                    <ButtonComponent id="btn3" content="Show Success Message" cssClass={successCssClass} onClick={successClick.bind(this)}/>
                    <MessageComponent id="msg_success_icon" severity="Success" showCloseIcon={showCloseIcon} closed={successClosed.bind(this)} visible={successVisible} showIcon={showIcon}>
                        {' '} Your message has been sent successfully
                    </MessageComponent>
                    <ButtonComponent id="btn4" content="Show Warning Message" cssClass={warningCssClass} onClick={warningClick.bind(this)}/>
                    <MessageComponent id="msg_warning_icon" severity="Warning" showCloseIcon={showCloseIcon} closed={warningClosed.bind(this)} visible={warningVisible} showIcon={showIcon}>
                    ...
                    <MessageComponent id="msg_error_icon" severity="Error" showCloseIcon={showCloseIcon} closed={errorClosed.bind(this)} visible={errorVisible} showIcon={showIcon}>
