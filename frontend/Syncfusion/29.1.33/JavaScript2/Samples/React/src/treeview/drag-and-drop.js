                    ...
                    React.createElement("div", { className: "col-lg-4 tree3-data" },
                        ...
                        React.createElement("div", { className: "content" },
                            React.createElement("div", null,
                                React.createElement(ej2_react_lists_1.ListViewComponent, { id: "list", className: "e-droppable", dataSource: [], ref: function (list) { _this.listObj = list; }, actionComplete: this.actionBegin.bind(this), cssClass: 'custom-list', template: "<div class='dropped-list-view-item'><span>${text}</span><span id=${iconId} class=${class}></span></div>" })))),
