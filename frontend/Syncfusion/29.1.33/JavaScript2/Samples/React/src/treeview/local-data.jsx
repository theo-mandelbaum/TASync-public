...
export class LocalData extends SampleBase {
    ...
    fields = { dataSource: this.data.hierarchicalData, id: 'code', text: 'name', child: 'countries' };
    // Self-referential list data source for TreeView component
    listfields = { dataSource: this.data.localData, id: 'id', parentID: 'pid', text: 'name', hasChildren: 'hasChild' };
    render() {
