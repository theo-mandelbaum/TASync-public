...
export class Validation extends SampleBase {
    ...
    componentDidMount() {
        ...
        window.onInputChange = function (val, isEmailInput) {
            ...
            let errElement = this.stepperContentEle.querySelector(`.${elementId}.error-label`);
        ...
        window.onReset = function () {
            ...
            Array.from(this.stepperContentEle.querySelectorAll('.inputContainer')).forEach((ele) => {
                ele.value = '';
    ...
    setValidState(args) {
        ...
        if (this.stepperObj.activeStep === 0) {
            const emailInput = this.stepperContentEle.querySelector('#add-email');
        ...
        if (this.stepperObj.activeStep === 1) {
            const radioInputs = this.stepperContentEle.querySelectorAll('.survey-question input');
