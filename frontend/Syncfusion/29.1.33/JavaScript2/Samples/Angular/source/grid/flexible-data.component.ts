...
export class FlexibleDataBindingComponent implements OnInit {
  ...
  public serviceURL: { [key: string]: Object }[] = [
    ...
    {
      text: 'https://ej2services.syncfusion.com/production/web-services/api/Orders',
      value: 'WebApiAdaptor',
    },
    {
      text: 'https://ej2services.syncfusion.com/production/web-services/api/UrlDataSource',
      value: 'UrlAdaptor',
    },
    {
      text: 'https://services.odata.org/V4/Northwind/Northwind.svc/Orders',
