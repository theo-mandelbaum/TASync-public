...
import { autoShapeDocument, WEB_API_ACTION } from './data';
...
export class AutoShapesComponent {
    ...
    onCreate(): void {
        ...
        this.container.documentEditor.open(JSON.stringify(autoShapeDocument));
