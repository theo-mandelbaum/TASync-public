...
@Component({
    ...
    templateUrl: 'heading-navigation.html',
...
export class HeadingNavigationComponent {
    ...
    onCreate(): void {
        ...
        this.container.documentEditor.documentName = 'Heading navigation';
        this.container.documentEditorSettings.showRuler = true;
        this.container.documentEditorSettings.showNavigationPane = true;
