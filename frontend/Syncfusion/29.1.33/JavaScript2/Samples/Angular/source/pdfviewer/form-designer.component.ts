...
import { PdfViewerComponent, TextFieldSettings, RadioButtonFieldSettings, InitialFieldSettings, CheckBoxFieldSettings, SignatureFieldSettings, LinkAnnotationService, BookmarkViewService, MagnificationService, ThumbnailViewService, ToolbarService, NavigationService, TextSearchService, TextSelectionService, PrintService, AnnotationService, FormFieldsService, FormDesignerService,PageOrganizerService, LoadEventArgs, ValidateFormFieldsArgs, PdfViewerModule } from '@syncfusion/ej2-angular-pdfviewer';
...
public validateFormFields(e: ValidateFormFieldsArgs): void {
    ...
    public change(e: any): void {
        if (e.checked) {
            ...
            this.pdfviewerControl.serviceUrl = 'https://ej2services.syncfusion.com/production/web-services/api/pdfviewer';
        }
