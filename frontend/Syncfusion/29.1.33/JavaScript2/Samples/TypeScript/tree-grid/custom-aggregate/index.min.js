...
/******/ 	var installedChunks = {
/******/ 		"./samples/tree-grid/custom-aggregate/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/tree-grid/custom-aggregate/index.ts","treegrid.min"]);
...
/***/ "./samples/tree-grid/custom-aggregate/data-source.ts":
/*!***********************************************************!*\
  !*** ./samples/tree-grid/custom-aggregate/data-source.ts ***!
  \***********************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-treegrid */ \"./node_modules/@syncfusion/ej2-treegrid/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! ./data-source */ \"./samples/tree-grid/custom-aggregate/data-source.ts\"), __webpack_require__(/*! @syncfusion/ej2-grids */ \"./node_modules/@syncfusion/ej2-grids/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_treegrid_1, ej2_dropdowns_1, data_source_1, ej2_grids_1, ej2_base_2) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_treegrid_1.TreeGrid.Inject(ej2_treegrid_1.Page, ej2_treegrid_1.Aggregate);\n    var value = 'Frozen seafood';\n    var listObj;\n    var foods = [\n        { food: 'Frozen seafood' },\n        { food: 'Dairy' },\n        { food: 'Edible' },\n        { food: 'Solid crystals' },\n    ];\n    var customAggregateFn = function (data) {\n        var sampleData = (0, ej2_grids_1.getObject)('result', data);\n        var countLength;\n        countLength = 0;\n        sampleData.filter(function (item) {\n            var data = (0, ej2_grids_1.getObject)('category', item);\n            if (data === value) {\n                countLength++;\n            }\n        });\n        return countLength;\n    };\n    var grid = new ej2_treegrid_1.TreeGrid({\n        dataSource: data_source_1.summaryData,\n        childMapping: 'subtasks',\n        width: 'auto',\n        height: 400,\n        treeColumnIndex: 1,\n        dataBound: function () {\n            if (!(0, ej2_base_2.isNullOrUndefined)(listObj) && listObj.element.classList.contains('e-' + listObj.getModuleName())) {\n                listObj.destroy();\n            }\n            listObj = new ej2_dropdowns_1.DropDownList({\n                dataSource: foods,\n                fields: { value: 'food' },\n                placeholder: 'Select a Category',\n                width: '160px',\n                value: value,\n                change: function () {\n                    setTimeout(function () {\n                        value = listObj.value.toString();\n                        grid.refresh();\n                    }, 300);\n                }\n            });\n            listObj.appendTo('#customers');\n        },\n        columns: [\n            { field: 'ID', headerText: 'S.No', width: 90, textAlign: 'Right' },\n            { field: 'Name', headerText: 'Shipment Name', width: 220 },\n            { field: 'category', headerText: 'Category', width: 260, minWidth: 260 },\n            { field: 'units', headerText: 'Total Units', width: 130, type: 'number', textAlign: 'Right' },\n            { field: 'unitPrice', headerText: 'Unit Price($)', width: 110, type: 'number', format: 'C2', textAlign: 'Right' },\n            { field: 'price', headerText: 'Price($)', width: 110, textAlign: 'Right', type: 'number', format: 'C' },\n        ],\n        aggregates: [{\n                showChildSummary: false,\n                columns: [{\n                        type: 'Custom',\n                        customAggregate: customAggregateFn,\n                        columnName: 'category',\n                        format: 'C2',\n                        footerTemplate: 'Count of <input type=\"text\" id=\"customers\" /> : ${Custom}'\n                    }]\n            }]\n    });\n    grid.appendTo('#Grid');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/tree-grid/custom-aggregate/index.ts?");
