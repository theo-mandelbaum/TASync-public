...
/******/ 	var installedChunks = {
/******/ 		"./samples/range-navigator/filter/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/range-navigator/filter/index.ts","charts.min"]);
...
/***/ "./samples/range-navigator/filter/index.ts":
/*!*************************************************!*\
  !*** ./samples/range-navigator/filter/index.ts ***!
  \*************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-grids */ \"./node_modules/@syncfusion/ej2-grids/index.js\"), __webpack_require__(/*! ./theme-colors */ \"./samples/range-navigator/filter/theme-colors.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, ej2_base_2, ej2_grids_1, theme_colors_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_1.RangeNavigator.Inject(ej2_charts_1.AreaSeries, ej2_charts_1.DateTime);\n    var theme = (0, theme_colors_1.loadRangeNavigatorTheme)();\n    var datasrc;\n    var fetchApi = new ej2_base_2.Fetch('./src/range-navigator/data-source/grid-data.json', 'GET');\n    fetchApi.send().then();\n    fetchApi.onSuccess = function (data) {\n        datasrc = data;\n        datasrc.map(function (data) {\n            data['HireDate'] = new Date(data['HireDate']);\n        });\n        var grid = new ej2_grids_1.Grid({\n            height: '350',\n            width: ej2_base_2.Browser.isDevice ? '100%' : '80%',\n            columns: [\n                { field: 'EmployeeID', headerText: 'Employee ID', textAlign: 'Center' },\n                { field: 'FirstName', headerText: 'Name', textAlign: 'Center' },\n                { field: 'Title', headerText: 'Title', textAlign: 'Center' },\n                {\n                    field: 'HireDate', headerText: 'Hire Date', textAlign: 'Center',\n                    format: { skeleton: 'yMd', type: 'date' }\n                }\n            ],\n        });\n        grid.appendTo('#grid');\n        var range = new ej2_charts_1.RangeNavigator({\n            animationDuration: 500,\n            width: ej2_base_2.Browser.isDevice ? '100%' : '80%',\n            value: [new Date(1992, 5, 1), new Date(1993, 4, 1)],\n            valueType: 'DateTime',\n            allowSnapping: true,\n            intervalType: 'Quarter',\n            enableGrouping: true,\n            groupBy: 'Years',\n            enableDeferredUpdate: true,\n            dataSource: datasrc, xName: 'HireDate', yName: 'yValue',\n            changed: function (args) {\n                grid.dataSource = datasrc.filter(function (data) {\n                    return (data.HireDate >= new Date(+args.start) && data.HireDate <= new Date(+args.end));\n                });\n                grid.refresh();\n            },\n            theme: theme\n        });\n        range.appendTo('#container');\n    };\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/range-navigator/filter/index.ts?");

/***/ }),

/***/ "./samples/range-navigator/filter/theme-colors.ts":
/*!********************************************************!*\
  !*** ./samples/range-navigator/filter/theme-colors.ts ***!
  \********************************************************/
/*! no static exports found */
