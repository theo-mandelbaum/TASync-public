...
// tslint:disable-next-line:max-func-body-length
    ...
    let dashboard: DashboardLayout = new DashboardLayout({
        ...
        panels: [
            ...
            },
            {
                ...
                header: '<div>Active Visitors</div>', content: '<div id="pie" style="height:80%; width:83%"></div>'
            },
            {
                'sizeX': 2, 'sizeY': 2, 'row': 1, 'col': 2,
                header: '<div>Regional Map</div>', content: '<div id="map" style="height:80%; width:83%"></div>'
            },
            {
                'sizeX': 2, 'sizeY': 2, 'row': 1, 'col': 4,
                header: '<div>Visitors by Type</div>', content: '<div id="colChart" style="height:80%; width:83%"></div>'
            },
            {
                'sizeX': 4, 'sizeY': 2, 'row': 3, 'col': 2,
                header: '<div>Traffic History</div>', content: '<div id="visitorsChart" style="height:80%; width:83%"></div>'
            },
            {
                'sizeX': 2, 'sizeY': 2, 'row': 3, 'col': 0,
                header: '<div>Useage Statistics</div>', content: '<div id="pieChart" style="height:80%; width:83%"></div>'
            },
        ]
    });
    ...
    let maps: Maps = new Maps({
        ...
        layers: [
            {
                shapeData: new MapAjax('./src/dashboardlayout/worldmap.json'),
                shapePropertyPath: 'continent',
                shapeDataPath: 'continent',
                dataSource: new MapAjax('./src/dashboardlayout/datasource.json'),
                shapeSettings: {
                ...
                markerSettings: [
                    {
                        ...
                        shape: 'Image',
                        imageUrl: 'https://ej2.syncfusion.com/demos///npmci.syncfusion.com/development/demos/src/maps/images/ballon.png',
                        height: 20,
                        width: 20,
                        offset: {
                            y: -10,
