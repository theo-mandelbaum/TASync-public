...
/******/ 	var installedChunks = {
/******/ 		"./samples/query-builder/rule-template/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/query-builder/rule-template/index.ts","querybuilder.min"]);
...
/***/ "./samples/query-builder/rule-template/data-source.ts":
/*!************************************************************!*\
  !*** ./samples/query-builder/rule-template/data-source.ts ***!
  \************************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-querybuilder */ \"./node_modules/@syncfusion/ej2-querybuilder/index.js\"), __webpack_require__(/*! ./data-source */ \"./samples/query-builder/rule-template/data-source.ts\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_querybuilder_1, data_source_1, ej2_dropdowns_1, ej2_buttons_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    var filter = [\n        { field: 'EmployeeID', label: 'Employee ID', type: 'number' },\n        { field: 'FirstName', label: 'First Name', type: 'string' },\n        { field: 'LastName', label: 'Last Name', type: 'string' },\n        { field: 'BirthDate', label: 'Hire Date', type: 'date' },\n        { field: 'Country', label: 'Country', type: 'string', ruleTemplate: \"#ruleTemplate\" }\n    ];\n    var fieldObj;\n    var valueObj;\n    var operatorObj0;\n    var operatorObj1;\n    var val = [\n        { field: 'USA', label: 'USA' },\n        { field: 'england', label: 'England' },\n        { field: 'india', label: 'India' },\n        { field: 'spain', label: 'Spain' }\n    ];\n    var importRules = {\n        'condition': 'and',\n        'rules': [\n            {\n                'label': 'Last Name',\n                'field': 'LastName',\n                'type': 'string',\n                'operator': 'equal',\n                'value': 'Davolio'\n            },\n            {\n                'label': 'Country',\n                'field': 'Country',\n                'type': 'string',\n                'operator': 'equal',\n                'value': \"USA\"\n            }\n        ]\n    };\n    var qryBldrObj = new ej2_querybuilder_1.QueryBuilder({\n        dataSource: data_source_1.employeeData,\n        columns: filter,\n        rule: importRules,\n        actionBegin: actionBegin\n    });\n    qryBldrObj.appendTo('#querybuilder');\n    function actionBegin(args) {\n        if (args.requestType === 'template-create') {\n            fieldObj = new ej2_dropdowns_1.DropDownList({\n                dataSource: this.columns,\n                fields: args.fields,\n                value: args.rule.field,\n                change: function (e) {\n                    qryBldrObj.notifyChange(e.value, e.element, 'field');\n                }\n            });\n            fieldObj.appendTo('#' + args.ruleID + '_filterkey');\n            operatorObj0 = new ej2_buttons_1.RadioButton({\n                label: 'Is Equal',\n                name: 'operator',\n                value: 'equal',\n                checked: args.rule.operator === 'equal' ? true : false,\n                change: function (e) {\n                    qryBldrObj.notifyChange(e.value, e.event.target, 'operator');\n                }\n            });\n            operatorObj0.appendTo('#' + args.ruleID + '_operatorkey0');\n            operatorObj1 = new ej2_buttons_1.RadioButton({\n                label: 'Is Not Equal',\n                name: 'operator',\n                value: 'notequal',\n                checked: args.rule.operator === 'notequal' ? true : false,\n                change: function (e) {\n                    qryBldrObj.notifyChange(e.value, e.event.target, 'operator');\n                }\n            });\n            operatorObj1.appendTo('#' + args.ruleID + '_operatorkey1');\n            valueObj = new ej2_dropdowns_1.DropDownList({\n                dataSource: val,\n                fields: args.fields,\n                value: args.rule.value,\n                change: function (e) {\n                    qryBldrObj.notifyChange(e.value, e.element, 'value');\n                }\n            });\n            valueObj.appendTo('#' + args.ruleID + '_valuekey');\n        }\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/query-builder/rule-template/index.ts?");
