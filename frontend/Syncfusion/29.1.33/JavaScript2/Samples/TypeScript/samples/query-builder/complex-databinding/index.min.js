...
/******/ 	var installedChunks = {
/******/ 		"./samples/query-builder/complex-databinding/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/query-builder/complex-databinding/index.ts","querybuilder.min"]);
...
/***/ "./samples/query-builder/complex-databinding/index.ts":
/*!************************************************************!*\
  !*** ./samples/query-builder/complex-databinding/index.ts ***!
  \************************************************************/
/*! no static exports found */
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-querybuilder */ \"./node_modules/@syncfusion/ej2-querybuilder/index.js\"), __webpack_require__(/*! ./data-source */ \"./samples/query-builder/complex-databinding/data-source.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_querybuilder_1, data_source_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    var columns = [\n        { field: 'Employee', label: 'Employee', columns: [\n                { field: 'ID', label: 'ID', type: 'number' },\n                { field: 'DOB', label: 'Date of birth', type: 'date' },\n                { field: 'HireDate', label: 'Hire Date', type: 'date' },\n                { field: 'Salary', label: 'Salary', type: 'number' },\n                { field: 'Age', label: 'Age', type: 'number' },\n                { field: 'Title', label: 'Title', type: 'string' }\n            ] },\n        { field: 'Name', label: 'Name', columns: [\n                { field: 'FirstName', label: 'First Name', type: 'string' },\n                { field: 'LastName', label: 'Last Name', type: 'string' }\n            ] },\n        { field: 'Country', label: 'Country', columns: [\n                { field: 'State', label: 'State', columns: [\n                        { field: 'City', label: 'City', type: 'string' },\n                        { field: 'Zipcode', label: 'Zip Code', type: 'number' }\n                    ] },\n                { field: 'Region', label: 'Region', type: 'string' },\n                { field: 'Name', label: 'Name', type: 'string' }\n            ] }\n    ];\n    var importRules = {\n        condition: 'and',\n        rules: [{\n                label: 'ID',\n                field: 'Employee.ID',\n                type: 'number',\n                operator: 'equal',\n                value: 1001\n            },\n            {\n                label: 'First Name',\n                field: 'Name.FirstName',\n                type: 'string',\n                operator: 'equal',\n                value: 'Mark'\n            },\n            {\n                condition: 'or',\n                rules: [{\n                        label: 'City',\n                        field: 'Country.State.City',\n                        operator: 'equal',\n                        type: 'string',\n                        value: 'Jersey City'\n                    }, {\n                        label: 'Date of birth',\n                        field: 'Employee.DOB',\n                        operator: 'equal',\n                        type: 'date',\n                        value: '7/7/96'\n                    }]\n            }\n        ]\n    };\n    var qryBldrObj = new ej2_querybuilder_1.QueryBuilder({\n        dataSource: data_source_1.complexData,\n        separator: '.',\n        columns: columns,\n        rule: importRules,\n        fieldMode: 'DropdownTree'\n    });\n    qryBldrObj.appendTo('#querybuilder');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/query-builder/complex-databinding/index.ts?");
