...
/******/ 	var installedChunks = {
/******/ 		"./samples/query-builder/header-template/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/query-builder/header-template/index.ts","querybuilder.min"]);
...
/***/ "./samples/query-builder/header-template/data-source.ts":
/*!**************************************************************!*\
  !*** ./samples/query-builder/header-template/data-source.ts ***!
  \**************************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-querybuilder */ \"./node_modules/@syncfusion/ej2-querybuilder/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! ./data-source */ \"./samples/query-builder/header-template/data-source.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_querybuilder_1, ej2_base_2, ej2_dropdowns_1, data_source_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    var filter = [\n        { field: 'EmployeeID', label: 'Employee ID', type: 'number' },\n        { field: 'FirstName', label: 'First Name', type: 'string' },\n        { field: 'LastName', label: 'Last Name', type: 'string' },\n        { field: 'HireDate', label: 'Hire Date', type: 'date' },\n        { field: 'Country', label: 'Country', type: 'string' }\n    ];\n    var importRules = {\n        'condition': 'and',\n        'rules': [{\n                'label': 'First Name',\n                'field': 'FirstName',\n                'type': 'string',\n                'operator': 'equal',\n                'value': 'Nancy'\n            },\n            {\n                'label': 'Country',\n                'field': 'Country',\n                'type': 'string',\n                'operator': 'equal',\n                'value': \"USA\"\n            }\n        ]\n    };\n    var qryBldrObj = new ej2_querybuilder_1.QueryBuilder({\n        dataSource: data_source_1.employeeData,\n        columns: filter,\n        rule: importRules,\n        headerTemplate: '#headerTemplate',\n        actionBegin: actionBegin\n    });\n    qryBldrObj.appendTo('#querybuilder');\n    function actionBegin(args) {\n        if (args.requestType === 'header-template-create') {\n            var ds = [{ 'key': 'AND', 'value': 'and' }, { 'key': 'OR', 'value': 'or' }];\n            var btnObj = new ej2_dropdowns_1.DropDownList({\n                dataSource: ds,\n                fields: { text: 'key', value: 'value' },\n                value: args.condition,\n                cssClass: 'e-custom-group-btn e-active-toggle',\n                change: function (e) {\n                    qryBldrObj.notifyChange(e.value, e.element, 'condition');\n                }\n            });\n            btnObj.appendTo('#' + args.ruleID + '_cndtnbtn');\n            var addGroup = document.getElementById(args.ruleID).querySelector('.e-grp-btn');\n            if (addGroup) {\n                addGroup.onclick = function (e) {\n                    var addbtn = (0, ej2_base_2.closest)(e.target, '.e-grp-btn');\n                    var ddb = addbtn.id.split('_');\n                    qryBldrObj.addGroups([{ condition: 'and', 'rules': [{}] }], ddb[1]);\n                };\n            }\n            var addCond = document.getElementById(args.ruleID).querySelector('.e-cond-btn');\n            if (addCond) {\n                addCond.onclick = function (e) {\n                    var addbtn = (0, ej2_base_2.closest)(e.target, '.e-cond-btn');\n                    var ddb = addbtn.id.split('_');\n                    qryBldrObj.addRules([{}], ddb[1]);\n                };\n            }\n            var deleteGroup = document.getElementById(args.ruleID).querySelector('.e-del-btn');\n            if (deleteGroup) {\n                deleteGroup.onclick = function (e) {\n                    qryBldrObj.deleteGroup((0, ej2_base_2.closest)(e.target.offsetParent, '.e-group-container'));\n                };\n            }\n        }\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/query-builder/header-template/index.ts?");
