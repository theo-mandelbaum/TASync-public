...
/******/ 	var installedChunks = {
/******/ 		"./samples/query-builder/grid/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/query-builder/grid/index.ts","querybuilder.min"]);
...
/***/ "./samples/query-builder/grid/data-source.ts":
/*!***************************************************!*\
  !*** ./samples/query-builder/grid/data-source.ts ***!
  \***************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-querybuilder */ \"./node_modules/@syncfusion/ej2-querybuilder/index.js\"), __webpack_require__(/*! @syncfusion/ej2-data */ \"./node_modules/@syncfusion/ej2-data/index.js\"), __webpack_require__(/*! ./data-source */ \"./samples/query-builder/grid/data-source.ts\"), __webpack_require__(/*! @syncfusion/ej2-grids */ \"./node_modules/@syncfusion/ej2-grids/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_querybuilder_1, ej2_data_1, data_source_1, ej2_grids_1, ej2_base_2) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_grids_1.Grid.Inject(ej2_grids_1.Page, ej2_grids_1.Selection);\n    var columnData = [\n        { field: 'TaskID', label: 'Task ID', type: 'number' },\n        { field: 'Name', label: 'Name', type: 'string' },\n        { field: 'Category', label: 'Category', type: 'string' },\n        { field: 'SerialNo', label: 'Serial No', type: 'string' },\n        { field: 'InvoiceNo', label: 'Invoice No', type: 'string' },\n        { field: 'Status', label: 'Status', type: 'string' }\n    ];\n    var importRules = {\n        'condition': 'or',\n        'rules': [{\n                'label': 'Category',\n                'field': 'Category',\n                'type': 'string',\n                'operator': 'equal',\n                'value': 'Laptop'\n            }]\n    };\n    var qryBldrObj = new ej2_querybuilder_1.QueryBuilder({\n        dataSource: data_source_1.hardwareData,\n        columns: columnData,\n        rule: importRules,\n        ruleChange: updateRule\n    });\n    qryBldrObj.appendTo('#querybuilder');\n    var grid;\n    createGrid(new ej2_data_1.Query().select(['TaskID', 'Name', 'Category', 'SerialNo', 'InvoiceNo', 'Status']));\n    updateRule({ rule: qryBldrObj.getValidRules(qryBldrObj.rule) });\n    function updateRule(args) {\n        var predicate = qryBldrObj.getPredicate(args.rule);\n        var query;\n        if ((0, ej2_base_2.isNullOrUndefined)(predicate)) {\n            query = new ej2_data_1.Query().select(['TaskID', 'Name', 'Category', 'SerialNo', 'InvoiceNo', 'Status']);\n        }\n        else {\n            query = new ej2_data_1.Query().select(['TaskID', 'Name', 'Category', 'SerialNo', 'InvoiceNo', 'Status'])\n                .where(predicate);\n        }\n        grid.query = query;\n        grid.refresh();\n    }\n    function createGrid(query) {\n        grid = new ej2_grids_1.Grid({\n            dataSource: new ej2_data_1.DataManager(data_source_1.hardwareData),\n            query: query,\n            width: '100%',\n            allowPaging: true,\n            columns: [\n                { field: 'TaskID', headerText: 'Task ID', width: 100, textAlign: 'Right' },\n                { field: 'Name', headerText: 'Name', width: 140 },\n                { field: 'Category', headerText: 'Category', width: 120, textAlign: 'Right' },\n                { field: 'InvoiceNo', headerText: 'Invoice No', width: 130 },\n                { field: 'Status', headerText: 'Status', width: 110 },\n                { field: 'SerialNo', headerText: 'Serial No', width: 140 },\n            ],\n            pageSettings: { pageSize: 8, pageCount: 5 },\n        });\n        grid.appendTo('#Grid');\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/query-builder/grid/index.ts?");
