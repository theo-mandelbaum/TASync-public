...
/******/ 	var installedChunks = {
/******/ 		"./samples/ai-assistview/streaming/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/ai-assistview/streaming/index.ts","interactive.min"]);
...
/***/ "./samples/ai-assistview/streaming/index.ts":
/*!**************************************************!*\
  !*** ./samples/ai-assistview/streaming/index.ts ***!
  \**************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __generator = (this && this.__generator) || function (thisArg, body) {\n    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;\n    return g = { next: verb(0), \"throw\": verb(1), \"return\": verb(2) }, typeof Symbol === \"function\" && (g[Symbol.iterator] = function() { return this; }), g;\n    function verb(n) { return function (v) { return step([n, v]); }; }\n    function step(op) {\n        if (f) throw new TypeError(\"Generator is already executing.\");\n        while (_) try {\n            if (f = 1, y && (t = op[0] & 2 ? y[\"return\"] : op[0] ? y[\"throw\"] || ((t = y[\"return\"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;\n            if (y = 0, t) op = [op[0] & 2, t.value];\n            switch (op[0]) {\n                case 0: case 1: t = op; break;\n                case 4: _.label++; return { value: op[1], done: false };\n                case 5: _.label++; y = op[1]; op = [0]; continue;\n                case 7: op = _.ops.pop(); _.trys.pop(); continue;\n                default:\n                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] === 6 || op[0] === 2)) { _ = 0; continue; }\n                    if (op[0] === 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }\n                    if (op[0] === 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }\n                    if (t && _.label < t[2]) { _.label = t[2]; _.ops.push(op); break; }\n                    if (t[2]) _.ops.pop();\n                    _.trys.pop(); continue;\n            }\n            op = body.call(thisArg, _);\n        } catch (e) { op = [6, e]; y = 0; } finally { f = t = 0; }\n        if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, done: true };\n    }\n};\n!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-interactive-chat */ \"./node_modules/@syncfusion/ej2-interactive-chat/index.js\"), __webpack_require__(/*! ./promptResponseData */ \"./samples/ai-assistview/streaming/promptResponseData.ts\"), __webpack_require__(/*! marked */ \"./node_modules/marked/lib/marked.umd.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_interactive_chat_1, promptResponseData_1, Marked) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    var stopStreaming = false;\n    var streamingAIAssistView = new ej2_interactive_chat_1.AIAssistView({\n        promptSuggestions: promptResponseData_1.streamingSuggestions,\n        promptRequest: onPromptRequest,\n        bannerTemplate: \"#bannerContent\",\n        toolbarSettings: {\n            items: [{ iconCss: 'e-icons e-refresh', align: 'Right' }],\n            itemClicked: toolbarItemClicked\n        },\n        stopRespondingClick: handleStopResponse\n    });\n    streamingAIAssistView.appendTo('#streamAssistView');\n    function handleStopResponse() {\n        stopStreaming = true;\n    }\n    function onPromptRequest(args) {\n        var lastResponse = \"\";\n        var streamingResponse = promptResponseData_1.streamingData.find(function (data) { return data.prompt === args.prompt; });\n        var defaultResponse = \"For real-time prompt processing, connect the AI AssistView control to your preferred AI service, such as OpenAI or Azure Cognitive Services. Ensure you obtain the necessary API credentials to authenticate and enable seamless integration.\";\n        var responseUpdateRate = 10;\n        function streamResponse(response) {\n            return __awaiter(this, void 0, void 0, function () {\n                var i, responseLength, htmlResponse;\n                return __generator(this, function (_a) {\n                    switch (_a.label) {\n                        case 0:\n                            i = 0;\n                            responseLength = response.length;\n                            _a.label = 1;\n                        case 1:\n                            if (!(i < responseLength && !stopStreaming)) return [3, 3];\n                            lastResponse += response[i];\n                            i++;\n                            if (i % responseUpdateRate === 0 || i === responseLength) {\n                                htmlResponse = Marked.marked(lastResponse);\n                                streamingAIAssistView.addPromptResponse(htmlResponse, i === responseLength);\n                                streamingAIAssistView.scrollToBottom();\n                            }\n                            return [4, new Promise(function (resolve) { return setTimeout(resolve, 15); })];\n                        case 2:\n                            _a.sent();\n                            return [3, 1];\n                        case 3:\n                            streamingAIAssistView.promptSuggestions = (streamingResponse === null || streamingResponse === void 0 ? void 0 : streamingResponse.suggestions) || promptResponseData_1.streamingSuggestions;\n                            return [2];\n                    }\n                });\n            });\n        }\n        if (streamingResponse) {\n            stopStreaming = false;\n            streamResponse(streamingResponse.response);\n        }\n        else {\n            streamingAIAssistView.addPromptResponse(defaultResponse, true);\n            streamingAIAssistView.promptSuggestions = promptResponseData_1.streamingSuggestions;\n        }\n    }\n    function toolbarItemClicked(args) {\n        if (args.item.iconCss === 'e-icons e-refresh') {\n            streamingAIAssistView.prompts = [];\n            streamingAIAssistView.promptSuggestions = promptResponseData_1.streamingSuggestions;\n        }\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/ai-assistview/streaming/index.ts?");

/***/ }),

/***/ "./samples/ai-assistview/streaming/promptResponseData.ts":
/*!***************************************************************!*\
  !*** ./samples/ai-assistview/streaming/promptResponseData.ts ***!
  \***************************************************************/
/*! no static exports found */
