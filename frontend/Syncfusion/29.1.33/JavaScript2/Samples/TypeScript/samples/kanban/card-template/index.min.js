...
/******/ 	var installedChunks = {
/******/ 		"./samples/kanban/card-template/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/kanban/card-template/index.ts","kanban.min"]);
...
/***/ "./samples/kanban/card-template/datasource.json":
/*!******************************************************!*\
  !*** ./samples/kanban/card-template/datasource.json ***!
  \******************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./datasource.json */ \"./samples/kanban/card-template/datasource.json\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! @syncfusion/ej2-inputs */ \"./node_modules/@syncfusion/ej2-inputs/index.js\"), __webpack_require__(/*! @syncfusion/ej2-kanban */ \"./node_modules/@syncfusion/ej2-kanban/index.js\"), __webpack_require__(/*! @syncfusion/ej2-calendars */ \"./node_modules/@syncfusion/ej2-calendars/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_base_2, dataSource, ej2_dropdowns_1, ej2_inputs_1, ej2_kanban_1, ej2_calendars_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    var data = (0, ej2_base_2.extend)([], dataSource.kanbanPizzaData, null, true);\n    var kanbanObj = new ej2_kanban_1.Kanban({\n        dataSource: data,\n        keyField: 'Category',\n        columns: [\n            { headerText: 'Menu', keyField: 'Menu' },\n            { headerText: 'Order', keyField: 'Order' },\n            { headerText: 'Ready to Serve', keyField: 'Ready to Serve' },\n            { headerText: 'Delivered', keyField: 'Delivered' }\n        ],\n        cardSettings: {\n            headerField: 'Id',\n            template: '#cardTemplate'\n        },\n        dialogSettings: {\n            template: '#dialogTemplate'\n        },\n        dialogClose: onDialogClose,\n        dialogOpen: onDialogOpen\n    });\n    var categoryData = ['Menu', 'Order', 'Ready to Serve', 'Delivered'];\n    kanbanObj.appendTo('#Kanban');\n    function onDialogOpen(args) {\n        if (args.requestType !== 'Delete') {\n            var curData = args.data;\n            var filledTextBox = new ej2_inputs_1.TextBox({});\n            filledTextBox.appendTo(args.element.querySelector('#Id'));\n            var numericObj = new ej2_inputs_1.NumericTextBox({\n                value: curData.Estimate, placeholder: 'Estimate'\n            });\n            numericObj.appendTo(args.element.querySelector('#Estimate'));\n            var categoryDropObj = new ej2_dropdowns_1.DropDownList({\n                value: curData.Category, popupHeight: '300px',\n                dataSource: categoryData, fields: { text: 'Category', value: 'Category' }, placeholder: 'Category'\n            });\n            categoryDropObj.appendTo(args.element.querySelector('#Category'));\n            var titleObj = new ej2_inputs_1.TextBox({\n                placeholder: 'Title',\n            });\n            titleObj.appendTo(args.element.querySelector('#Title'));\n            var sizeObj = new ej2_inputs_1.TextBox({\n                placeholder: 'Size',\n            });\n            sizeObj.appendTo(args.element.querySelector('#Size'));\n            var textareaObj = new ej2_inputs_1.TextBox({\n                placeholder: 'Description',\n                multiline: true\n            });\n            textareaObj.appendTo(args.element.querySelector('#Description'));\n            var datepicker = new ej2_calendars_1.DatePicker({\n                value: curData.Date,\n                format: 'MM/dd/yyyy',\n            });\n            datepicker.appendTo(args.element.querySelector('#datepicker'));\n        }\n    }\n    function onDialogClose(args) {\n        if (args.element.querySelector('#datepicker')) {\n            args.data.Date = args.element.querySelector('#datepicker').ej2_instances[0].value.toLocaleString('es-PR').split(\",\")[0];\n        }\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/kanban/card-template/index.ts?");
