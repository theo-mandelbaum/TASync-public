...
import * as data from './dataSource.json';
    ...
    let listObj: MultiSelect = new MultiSelect({
        ...
        itemTemplate: '<div><img class="empImage" src="//npmci.syncfusion.com/development/demos/src/drop-down-list/Employees/${Eimg}.png" alt="employee"/>' +
        ...
        + '<img class="value" src="//npmci.syncfusion.com/development/demos/src/drop-down-list/Employees/${Eimg}.png" height="26px" width="26px" alt="employee"/>'
