...
/******/ 	var installedChunks = {
/******/ 		"./samples/chat-ui/api/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/chat-ui/api/index.ts","interactive.min"]);
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __spreadArray = (this && this.__spreadArray) || function (to, from, pack) {\n    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {\n        if (ar || !(i in from)) {\n            if (!ar) ar = Array.prototype.slice.call(from, 0, i);\n            ar[i] = from[i];\n        }\n    }\n    return to.concat(ar || Array.prototype.slice.call(from));\n};\n!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-interactive-chat */ \"./node_modules/@syncfusion/ej2-interactive-chat/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! ./messageData */ \"./samples/chat-ui/api/messageData.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_interactive_chat_1, ej2_buttons_1, ej2_dropdowns_1, messageData_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    var chatUiInst = new ej2_interactive_chat_1.ChatUI({\n        messages: messageData_1.communityMessagedata,\n        user: { user: 'Alice', id: 'admin' },\n        headerIconCss: \"chat_header_icon\",\n        headerText: 'Design Community',\n        showTimeBreak: true,\n        timeStampFormat: 'MM/dd hh:mm a'\n    });\n    chatUiInst.appendTo('#chatui');\n    var chatProperties = [\n        { id: 'chatTimestamp', checked: true, property: 'showTimeStamp' },\n        { id: 'chatTimebreak', checked: true, property: 'showTimeBreak' },\n        { id: 'chatHeader', checked: true, property: 'showHeader' },\n        { id: 'chatFooter', checked: true, property: 'showFooter' }\n    ];\n    chatProperties.forEach(function (toggle) {\n        new ej2_buttons_1.Switch({\n            checked: toggle.checked,\n            change: function (args) {\n                chatUiInst[toggle.property] = args.checked;\n            }\n        }).appendTo(\"#\".concat(toggle.id));\n    });\n    new ej2_dropdowns_1.DropDownList({\n        placeholder: 'Format',\n        width: '180px',\n        change: function (args) {\n            chatUiInst.timeStampFormat = args.itemData.value;\n        }\n    }).appendTo('#chat_dateformats');\n    new ej2_dropdowns_1.MultiSelect({\n        placeholder: 'Typing users...',\n        select: function (args) {\n            var user = {\n                user: args.itemData.value,\n                avatarBgColor: '#87cefa'\n            };\n            if (['Laura', 'Charlie'].indexOf(args.itemData.value) !== -1) {\n                user.avatarBgColor = args.itemData.value === 'Charlie' ? '#e6cdde' : '#dec287';\n                user.avatarUrl = \"./src/chat-ui/images/\".concat(args.itemData.value.toLowerCase(), \".png\");\n            }\n            chatUiInst.typingUsers = __spreadArray(__spreadArray([], chatUiInst.typingUsers, true), [user], false);\n        },\n        removed: function (args) {\n            chatUiInst.typingUsers = chatUiInst.typingUsers.filter(function (user) { return user.user !== args.itemData.value; });\n        }\n    }).appendTo('#chat_typingUsers');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/chat-ui/api/index.ts?");

/***/ }),

/***/ "./samples/chat-ui/api/messageData.ts":
/*!********************************************!*\
  !*** ./samples/chat-ui/api/messageData.ts ***!
  \********************************************/
/*! no static exports found */
