...
/******/ 	var installedChunks = {
/******/ 		"./samples/range-navigator/date-time/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/range-navigator/date-time/index.ts","charts.min"]);
...
/***/ "./samples/range-navigator/date-time/index.ts":
/*!****************************************************!*\
  !*** ./samples/range-navigator/date-time/index.ts ***!
  \****************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./theme-colors */ \"./samples/range-navigator/date-time/theme-colors.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, ej2_charts_2, ej2_charts_3, ej2_base_2, theme_colors_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_2.Chart.Inject(ej2_charts_1.DateTime, ej2_charts_1.SplineSeries, ej2_charts_3.Tooltip, ej2_charts_1.Crosshair);\n    ej2_charts_2.RangeNavigator.Inject(ej2_charts_1.AreaSeries, ej2_charts_1.DateTime, ej2_charts_3.RangeTooltip);\n    var theme = (0, theme_colors_1.loadRangeNavigatorTheme)();\n    var dataSource;\n    var fetchApi = new ej2_base_2.Fetch('./src/range-navigator/data-source/stock-data.json', 'GET');\n    fetchApi.send().then();\n    fetchApi.onSuccess = function (data) {\n        dataSource = data;\n        dataSource.map(function (data) {\n            data['x'] = new Date(data['x']);\n        });\n        var chart = new ej2_charts_2.Chart({\n            primaryXAxis: {\n                valueType: 'DateTime',\n                edgeLabelPlacement: 'Shift', majorGridLines: { width: 0 }\n            },\n            series: [{\n                    dataSource: dataSource, xName: 'x', yName: 'y', width: 2, name: 'Rate', type: 'Spline'\n                }],\n            chartArea: { border: { width: 0 } },\n            tooltip: { enable: true, shared: true },\n            primaryYAxis: {\n                labelFormat: 'n1', minimum: 0.6,\n                maximum: 1, interval: 0.1, majorTickLines: { width: 0 }, lineStyle: { width: 0 }\n            },\n            height: '350', legendSettings: { visible: false },\n            width: ej2_base_2.Browser.isDevice ? '100%' : '80%',\n            theme: theme\n        });\n        chart.appendTo('#chart');\n        var range = new ej2_charts_2.RangeNavigator({\n            valueType: 'DateTime',\n            majorTickLines: {\n                width: 0\n            },\n            tooltip: { enable: true, format: 'yyyy/MM/dd', displayMode: 'Always' },\n            value: [new Date('2011-01-01'), new Date('2013-12-31')],\n            series: [\n                {\n                    dataSource: dataSource, xName: 'x', yName: 'y', type: 'Area',\n                    width: 2, animation: { enable: false },\n                    fill: 'url(#' + theme.toLowerCase() + '-gradient-chart)',\n                    border: { width: 2, color: theme_colors_1.borderColor[theme_colors_1.themes.indexOf(theme.toLowerCase())] }\n                }\n            ],\n            changed: function (args) {\n                chart.primaryXAxis.zoomFactor = args.zoomFactor;\n                chart.primaryXAxis.zoomPosition = args.zoomPosition;\n                chart.dataBind();\n            },\n            width: ej2_base_2.Browser.isDevice ? '100%' : '80%',\n            theme: theme\n        });\n        range.appendTo('#container');\n    };\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/range-navigator/date-time/index.ts?");

/***/ }),

/***/ "./samples/range-navigator/date-time/theme-colors.ts":
/*!***********************************************************!*\
  !*** ./samples/range-navigator/date-time/theme-colors.ts ***!
  \***********************************************************/
/*! no static exports found */
