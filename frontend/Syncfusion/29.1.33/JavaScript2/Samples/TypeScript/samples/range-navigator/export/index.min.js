...
/******/ 	var installedChunks = {
/******/ 		"./samples/range-navigator/export/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/range-navigator/export/index.ts","charts.min"]);
...
/***/ "./samples/range-navigator/export/index.ts":
/*!*************************************************!*\
  !*** ./samples/range-navigator/export/index.ts ***!
  \*************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./theme-colors */ \"./samples/range-navigator/export/theme-colors.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, ej2_buttons_1, ej2_dropdowns_1, ej2_base_2, theme_colors_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_1.Chart.Inject(ej2_charts_1.SplineAreaSeries, ej2_charts_1.DateTime, ej2_charts_1.Crosshair, ej2_charts_1.Tooltip, ej2_charts_1.Export);\n    ej2_charts_1.RangeNavigator.Inject(ej2_charts_1.DateTime, ej2_charts_1.StepLineSeries);\n    var theme = (0, theme_colors_1.loadRangeNavigatorTheme)();\n    var datasrc;\n    var fetchApi = new ej2_base_2.Fetch('./src/range-navigator/data-source/export-data.json', 'GET');\n    fetchApi.send().then();\n    fetchApi.onSuccess = function (data) {\n        datasrc = data;\n        datasrc.map(function (data) {\n            data['xDate'] = new Date(data['xDate']);\n        });\n        var chart = new ej2_charts_1.Chart({\n            primaryXAxis: {\n                valueType: 'DateTime', crosshairTooltip: { enable: true },\n                edgeLabelPlacement: 'Shift', majorGridLines: { width: 0 }\n            },\n            series: [{\n                    dataSource: datasrc, xName: 'xDate', yName: 'Close', width: 2,\n                    name: 'Close',\n                    fill: theme_colors_1.printRegionColors[theme_colors_1.printThemes.indexOf(theme)], type: 'SplineArea',\n                    border: { width: 2, color: theme_colors_1.printBorderColor[theme_colors_1.printThemes.indexOf(theme)] }\n                }],\n            chartArea: { border: { width: 0 } },\n            primaryYAxis: {\n                minimum: 81, maximum: 87, interval: 2,\n                majorTickLines: { width: 0 }, lineStyle: { width: 0 },\n                labelFormat: '{value}M', title: 'Million in USD'\n            },\n            tooltip: { enable: true, shared: true },\n            legendSettings: { visible: false },\n            height: '350',\n            theme: theme\n        });\n        chart.appendTo('#chart');\n        var dateTimeControl = new ej2_charts_1.RangeNavigator({\n            valueType: 'DateTime',\n            animationDuration: 500,\n            intervalType: 'Months',\n            labelFormat: 'MMM', theme: theme,\n            enableGrouping: true,\n            value: [new Date('2013-05-01'), new Date('2013-08-01')],\n            dataSource: datasrc,\n            xName: 'xDate', yName: 'Close',\n            changed: function (args) {\n                chart.primaryXAxis.zoomFactor = args.zoomFactor;\n                chart.primaryXAxis.zoomPosition = args.zoomPosition;\n                chart.dataBind();\n            }\n        });\n        dateTimeControl.appendTo('#container');\n        var mode = new ej2_dropdowns_1.DropDownList({\n            index: 0,\n            width: 90\n        });\n        mode.appendTo('#mode');\n        var togglebtn = new ej2_buttons_1.Button({\n            iconCss: 'e-icons e-export-icon', cssClass: 'e-flat', isPrimary: true,\n        });\n        togglebtn.appendTo('#exportBtn');\n        document.getElementById('exportBtn').onclick = function () {\n            var fileName = (document.getElementById('fileName')).value;\n            chart.exportModule.export(mode.value, fileName, null, [dateTimeControl, chart]);\n        };\n        var printBtn = new ej2_buttons_1.Button({\n            iconCss: 'e-icons e-print-icon', cssClass: 'e-flat', isPrimary: true,\n        });\n        printBtn.appendTo('#printBtn');\n        document.getElementById('printBtn').onclick = function () {\n            dateTimeControl.print(['container', 'chart']);\n        };\n    };\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/range-navigator/export/index.ts?");

/***/ }),

/***/ "./samples/range-navigator/export/theme-colors.ts":
/*!********************************************************!*\
  !*** ./samples/range-navigator/export/theme-colors.ts ***!
  \********************************************************/
/*! no static exports found */
