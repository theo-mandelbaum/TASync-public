...
/******/ 	var installedChunks = {
/******/ 		"./samples/range-navigator/light-weight/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/range-navigator/light-weight/index.ts","charts.min"]);
...
/***/ "./samples/range-navigator/light-weight/index.ts":
/*!*******************************************************!*\
  !*** ./samples/range-navigator/light-weight/index.ts ***!
  \*******************************************************/
/*! no static exports found */
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! ./data-service */ \"./samples/range-navigator/light-weight/data-service.ts\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./theme-colors */ \"./samples/range-navigator/light-weight/theme-colors.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, data_service_1, ej2_base_2, theme_colors_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_1.RangeNavigator.Inject(ej2_charts_1.Logarithmic, ej2_charts_1.DateTime);\n    var theme = (0, theme_colors_1.loadRangeNavigatorTheme)();\n    var range = new ej2_charts_1.RangeNavigator({\n        valueType: 'DateTime',\n        intervalType: 'Months',\n        labelFormat: 'MMM',\n        animationDuration: 500,\n        value: [new Date('2018-06-01'), new Date('2018-07-01')],\n        dataSource: (0, data_service_1.GetDateTimeData)(new Date('2018-01-01'), new Date('2019-01-01')),\n        xName: 'x', yName: 'y',\n        width: ej2_base_2.Browser.isDevice ? '100%' : '80%', theme: theme,\n        navigatorStyleSettings: {\n            thumb: {\n                type: 'Rectangle'\n            },\n        },\n        changed: (function (args) {\n            var currentDate = new Date(+args.start);\n            var workingDaysCount = 0;\n            var holidaysDaysCount = 0;\n            while (currentDate <= new Date(+args.end)) {\n                if (currentDate.getDay() > 0 && currentDate.getDay() <= 5) {\n                    workingDaysCount++;\n                }\n                else {\n                    holidaysDaysCount++;\n                }\n                currentDate.setDate(currentDate.getDate() + 1);\n            }\n            document.getElementById('workingcount').innerHTML = ' ' + workingDaysCount;\n            document.getElementById('weekendcount').innerHTML = ' ' + holidaysDaysCount;\n        }),\n    });\n    range.appendTo('#datetime');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/range-navigator/light-weight/index.ts?");

/***/ }),

/***/ "./samples/range-navigator/light-weight/theme-colors.ts":
/*!**************************************************************!*\
  !*** ./samples/range-navigator/light-weight/theme-colors.ts ***!
  \**************************************************************/
/*! no static exports found */
