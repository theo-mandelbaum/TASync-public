...
/******/ 	var installedChunks = {
/******/ 		"./samples/range-navigator/default/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/range-navigator/default/index.ts","charts.min"]);
...
/***/ "./samples/range-navigator/default/index.ts":
/*!**************************************************!*\
  !*** ./samples/range-navigator/default/index.ts ***!
  \**************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./theme-colors */ \"./samples/range-navigator/default/theme-colors.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, ej2_base_2, theme_colors_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_1.RangeNavigator.Inject(ej2_charts_1.DateTime, ej2_charts_1.AreaSeries, ej2_charts_1.RangeTooltip);\n    var theme = (0, theme_colors_1.loadRangeNavigatorTheme)();\n    var datasrc;\n    var fetchApi = new ej2_base_2.Fetch('./src/range-navigator/data-source/default-data.json', 'GET');\n    fetchApi.send().then();\n    fetchApi.onSuccess = function (data) {\n        datasrc = data;\n        datasrc.map(function (data) {\n            data['x'] = new Date(data['x']);\n        });\n        var range = new ej2_charts_1.RangeNavigator({\n            valueType: 'DateTime',\n            tooltip: { enable: true, displayMode: 'Always' },\n            value: [new Date('2017-09-01'), new Date('2018-02-01')],\n            labelFormat: 'MMM-yy',\n            navigatorStyleSettings: {\n                unselectedRegionColor: 'transparent',\n                selectedRegionColor: theme_colors_1.regionColor[theme_colors_1.themes.indexOf(theme.toLowerCase())]\n            },\n            series: [\n                {\n                    dataSource: datasrc,\n                    xName: 'x', yName: 'y', type: 'Area', width: 2,\n                    fill: 'url(#' + theme.toLowerCase() + '-gradient-chart)',\n                    border: { width: 2, color: theme_colors_1.borderColor[theme_colors_1.themes.indexOf(theme.toLowerCase())] }\n                }\n            ],\n            width: ej2_base_2.Browser.isDevice ? '100%' : '80%',\n            theme: theme\n        });\n        range.appendTo('#container');\n    };\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/range-navigator/default/index.ts?");

/***/ }),

/***/ "./samples/range-navigator/default/theme-colors.ts":
/*!*********************************************************!*\
  !*** ./samples/range-navigator/default/theme-colors.ts ***!
  \*********************************************************/
/*! no static exports found */
