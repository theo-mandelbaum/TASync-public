...
/******/ 	var installedChunks = {
/******/ 		"./samples/gantt/resource-multi-taskbar/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/gantt/resource-multi-taskbar/index.ts","gantt.min"]);
...
/***/ "./samples/gantt/resource-multi-taskbar/data-source.ts":
/*!*************************************************************!*\
  !*** ./samples/gantt/resource-multi-taskbar/data-source.ts ***!
  \*************************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./data-source */ \"./samples/gantt/resource-multi-taskbar/data-source.ts\"), __webpack_require__(/*! @syncfusion/ej2-gantt */ \"./node_modules/@syncfusion/ej2-gantt/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, data_source_1, ej2_gantt_1, ej2_buttons_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_gantt_1.Gantt.Inject(ej2_gantt_1.Selection, ej2_gantt_1.DayMarkers, ej2_gantt_1.Toolbar, ej2_gantt_1.Edit, ej2_gantt_1.Resize, ej2_gantt_1.RowDD);\n    var gantt = new ej2_gantt_1.Gantt({\n        dataSource: data_source_1.multiTaskbarData,\n        resources: data_source_1.resources,\n        viewType: 'ResourceView',\n        enableMultiTaskbar: true,\n        showOverAllocation: true,\n        taskType: 'FixedWork',\n        taskFields: {\n            id: 'TaskID',\n            name: 'TaskName',\n            startDate: 'StartDate',\n            endDate: 'EndDate',\n            duration: 'Duration',\n            dependency: 'Predecessor',\n            progress: 'Progress',\n            resourceInfo: 'resources',\n            work: 'work',\n            expandState: 'isExpand',\n            child: 'subtasks'\n        },\n        resourceFields: {\n            id: 'resourceId',\n            name: 'resourceName',\n            unit: 'resourceUnit',\n            group: 'resourceGroup'\n        },\n        editSettings: {\n            allowAdding: true,\n            allowEditing: true,\n            allowDeleting: true,\n            allowTaskbarEditing: true,\n            showDeleteConfirmDialog: true\n        },\n        columns: [\n            { field: 'TaskID', visible: false },\n            { field: 'TaskName', headerText: 'Name', width: 250 },\n            { field: 'work', headerText: 'Work' },\n            { field: 'Progress' },\n            { field: 'resourceGroup', headerText: 'Group' },\n            { field: 'StartDate' },\n            { field: 'Duration' },\n        ],\n        toolbar: ['Add', 'Edit', 'Update', 'Delete', 'Cancel', 'ExpandAll', 'CollapseAll'],\n        labelSettings: {\n            taskLabel: 'TaskName'\n        },\n        splitterSettings: {\n            columnIndex: 2\n        },\n        allowResizing: true,\n        allowSelection: true,\n        highlightWeekends: true,\n        treeColumnIndex: 1,\n        height: '450px',\n        projectStartDate: new Date('03/24/2024'),\n        projectEndDate: new Date('05/18/2024')\n    });\n    gantt.appendTo('#ResourceMultiTaskbar');\n    var taskbarDragDrop = new ej2_buttons_1.Switch({ value: 'allowTaskbarDragAndDrop', change: dragDropChange });\n    taskbarDragDrop.appendTo('#checked');\n    var taskbarOverlap = new ej2_buttons_1.Switch({ value: 'allowTaskbarOverlap', checked: true, change: overlapChange });\n    taskbarOverlap.appendTo('#unchecked');\n    function dragDropChange(args) {\n        var gantt = document.getElementsByClassName('e-gantt')[0].ej2_instances[0];\n        if (args.checked) {\n            gantt.allowTaskbarDragAndDrop = true;\n        }\n        else {\n            gantt.allowTaskbarDragAndDrop = false;\n        }\n    }\n    function overlapChange(args) {\n        var gantt = document.getElementsByClassName('e-gantt')[0].ej2_instances[0];\n        if (args.checked) {\n            gantt.allowTaskbarOverlap = true;\n        }\n        else {\n            gantt.allowTaskbarOverlap = false;\n        }\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/gantt/resource-multi-taskbar/index.ts?");
