...
/******/ 	var installedChunks = {
/******/ 		"./samples/gantt/filtering/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/gantt/filtering/index.ts","gantt.min"]);
...
/***/ "./samples/gantt/filtering/data-source.ts":
/*!************************************************!*\
  !*** ./samples/gantt/filtering/data-source.ts ***!
  \************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-gantt */ \"./node_modules/@syncfusion/ej2-gantt/index.js\"), __webpack_require__(/*! ./data-source */ \"./samples/gantt/filtering/data-source.ts\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_gantt_1, data_source_1, ej2_base_2, ej2_dropdowns_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_gantt_1.Gantt.Inject(ej2_gantt_1.Filter, ej2_gantt_1.Toolbar, ej2_gantt_1.Selection);\n    var type = [\n        { id: 'Menu', type: 'Menu' },\n        { id: 'Excel', type: 'Excel' }\n    ];\n    var mode = [\n        { id: 'Parent', type: 'Parent' },\n        { id: 'Child', type: 'Child' },\n        { id: 'Both', type: 'Both' },\n        { id: 'None', type: 'None' },\n    ];\n    var gantt = new ej2_gantt_1.Gantt({\n        dataSource: data_source_1.filteredData,\n        dateFormat: 'MM/dd/yyyy hh:mm:ss',\n        taskFields: {\n            id: 'TaskID',\n            name: 'TaskName',\n            startDate: 'StartDate',\n            endDate: 'EndDate',\n            duration: 'Duration',\n            dependency: 'Predecessor',\n            child: 'subtasks',\n        },\n        columns: [\n            { field: 'TaskName', headerText: 'Task Name', width: '250', clipMode: 'EllipsisWithTooltip' },\n            { field: 'StartDate', headerText: 'Start Date' },\n            { field: 'Duration', headerText: 'Duration' },\n            { field: 'EndDate', headerText: 'End Date' },\n            { field: 'Predecessor', headerText: 'Predecessor' }\n        ],\n        treeColumnIndex: 0,\n        allowFiltering: true,\n        filterSettings: { type: 'Menu', hierarchyMode: 'Parent' },\n        includeWeekend: true,\n        height: '450px',\n        timelineSettings: {\n            timelineUnitSize: 60,\n            topTier: {\n                format: 'MMM dd, yyyy',\n                unit: 'Day',\n            },\n            bottomTier: {\n                unit: 'Hour',\n                format: 'h.mm a'\n            },\n        },\n        splitterSettings: {\n            columnIndex: 2\n        },\n        durationUnit: 'Hour',\n        dayWorkingTime: [{ from: 1, to: 24 }],\n        labelSettings: {\n            rightLabel: 'TaskName',\n        },\n        projectStartDate: new Date('07/16/2024 01:00:00 AM'),\n        projectEndDate: new Date('07/25/2024'),\n        actionComplete: function (args) {\n            if (args.requestType === 'filterafteropen' &&\n                ((0, ej2_base_2.getValue)('columnName', args) === 'StartDate' || (0, ej2_base_2.getValue)('columnName', args) === 'EndDate')\n                && gantt.filterSettings.type === \"Menu\") {\n                (0, ej2_base_2.getValue)('filterModel', args).dlgDiv.querySelector('.e-datetimepicker').ej2_instances[0].min = new Date(2024, 5, 1);\n                (0, ej2_base_2.getValue)('filterModel', args).dlgDiv.querySelector('.e-datetimepicker').ej2_instances[0].max = new Date(2024, 8, 30);\n                (0, ej2_base_2.getValue)('filterModel', args).dlgDiv.querySelector('.e-datetimepicker').ej2_instances[0].dataBind();\n            }\n        },\n    });\n    gantt.appendTo('#Filtering');\n    var dropDownType = new ej2_dropdowns_1.DropDownList({\n        dataSource: type,\n        popupWidth: '100%',\n        fields: { text: 'type', value: 'id' },\n        value: 'Menu',\n        change: function (e) {\n            var type = e.value;\n            gantt.filterSettings.type = type;\n            gantt.clearFiltering();\n        }\n    });\n    dropDownType.appendTo('#filtertype');\n    var dropDownMode = new ej2_dropdowns_1.DropDownList({\n        dataSource: mode,\n        popupWidth: '100%',\n        fields: { text: 'type', value: 'id' },\n        value: 'Parent',\n        change: function (e) {\n            var mode = e.value;\n            gantt.filterSettings.hierarchyMode = mode;\n            gantt.clearFiltering();\n        }\n    });\n    dropDownMode.appendTo('#mode');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/gantt/filtering/index.ts?");
