...
/******/ 	var installedChunks = {
/******/ 		"./samples/schedule/hide-weekend/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/schedule/hide-weekend/index.ts","schedule.min"]);
...
/***/ "./samples/schedule/hide-weekend/datasource.json":
/*!*******************************************************!*\
  !*** ./samples/schedule/hide-weekend/datasource.json ***!
  \*******************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! @syncfusion/ej2-schedule */ \"./node_modules/@syncfusion/ej2-schedule/index.js\"), __webpack_require__(/*! ./datasource.json */ \"./samples/schedule/hide-weekend/datasource.json\"), __webpack_require__(/*! ./helper */ \"./samples/schedule/hide-weekend/helper.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_base_2, ej2_buttons_1, ej2_dropdowns_1, ej2_schedule_1, dataSource, helper_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_schedule_1.Schedule.Inject(ej2_schedule_1.Day, ej2_schedule_1.Week, ej2_schedule_1.Month, ej2_schedule_1.TimelineViews, ej2_schedule_1.TimelineMonth, ej2_schedule_1.Resize, ej2_schedule_1.DragAndDrop);\n    ej2_dropdowns_1.MultiSelect.Inject(ej2_dropdowns_1.CheckBoxSelection);\n    var data = (0, ej2_base_2.extend)([], dataSource.employeeEventData, null, true);\n    var scheduleObj = new ej2_schedule_1.Schedule({\n        width: '100%',\n        height: '650px',\n        showWeekend: false,\n        workDays: [1, 3, 4, 5],\n        workHours: {\n            start: '08:00'\n        },\n        views: ['Day', 'Week', 'Month', 'TimelineWeek', 'TimelineMonth'],\n        selectedDate: new Date(2021, 1, 15),\n        eventSettings: { dataSource: data },\n        eventRendered: function (args) { return (0, helper_1.applyCategoryColor)(args, scheduleObj.currentView); }\n    });\n    scheduleObj.appendTo('#Schedule');\n    var weekDays = [\n        { Name: 'Sunday', Value: '0' },\n        { Name: 'Monday', Value: '1' },\n        { Name: 'Tuesday', Value: '2' },\n        { Name: 'Wednesday', Value: '3' },\n        { Name: 'Thursday', Value: '4' },\n        { Name: 'Friday', Value: '5' },\n        { Name: 'Saturday', Value: '6' }\n    ];\n    var checkList = new ej2_dropdowns_1.MultiSelect({\n        value: ['1', '3', '4', '5'],\n        dataSource: weekDays,\n        fields: { text: 'Name', value: 'Value' },\n        mode: 'CheckBox',\n        showDropDownIcon: true,\n        showClearButton: false,\n        popupWidth: 180,\n        placeholder: \"Working days\",\n        floatLabelType: \"Always\",\n        change: function (args) {\n            var value = args.value.slice(0).map(Number).sort();\n            scheduleObj.workDays = value.length === 0 ? [0] : value;\n            scheduleObj.dataBind();\n        }\n    });\n    checkList.appendTo('#workdayscheckbox');\n    var toggleBtn = new ej2_buttons_1.Button({ isToggle: true });\n    toggleBtn.appendTo('#showweekendbtn');\n    toggleBtn.element.onclick = function () {\n        if (toggleBtn.element.classList.contains('e-active')) {\n            toggleBtn.content = 'Hide';\n            scheduleObj.showWeekend = true;\n        }\n        else {\n            toggleBtn.content = 'Show';\n            scheduleObj.showWeekend = false;\n        }\n    };\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/schedule/hide-weekend/index.ts?");
