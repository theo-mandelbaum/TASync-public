...
/******/ 	var installedChunks = {
/******/ 		"./samples/schedule/excel-export/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/schedule/excel-export/index.ts","schedule.min"]);
...
/***/ "./samples/schedule/excel-export/datasource.json":
/*!*******************************************************!*\
  !*** ./samples/schedule/excel-export/datasource.json ***!
  \*******************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-schedule */ \"./node_modules/@syncfusion/ej2-schedule/index.js\"), __webpack_require__(/*! ./datasource.json */ \"./samples/schedule/excel-export/datasource.json\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_base_2, ej2_schedule_1, dataSource) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_schedule_1.Schedule.Inject(ej2_schedule_1.Week, ej2_schedule_1.DragAndDrop, ej2_schedule_1.Resize, ej2_schedule_1.ExcelExport);\n    var data = (0, ej2_base_2.extend)([], dataSource.scheduleData, null, true);\n    var scheduleObj = new ej2_schedule_1.Schedule({\n        width: '100%',\n        height: '550px',\n        views: ['Week'],\n        currentView: 'Week',\n        selectedDate: new Date(2021, 0, 10),\n        eventSettings: { dataSource: data },\n        actionBegin: function (args) {\n            if (args.requestType === 'toolbarItemRendering') {\n                var exportItem = {\n                    align: 'Right', showTextOn: 'Both', prefixIcon: 'e-icons e-export-excel',\n                    text: 'Excel Export', cssClass: 'e-excel-export', click: onExportClick\n                };\n                args.items.push(exportItem);\n            }\n        }\n    });\n    scheduleObj.appendTo('#Schedule');\n    function onExportClick() {\n        var exportFields = [\n            { name: 'Id', text: 'Id' },\n            { name: 'Subject', text: 'Summary' },\n            { name: 'StartTime', text: 'Start Date' },\n            { name: 'EndTime', text: 'End Date' },\n            { name: 'Location', text: 'Place' }\n        ];\n        var exportValues = { fieldsInfo: exportFields };\n        scheduleObj.exportToExcel(exportValues);\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/schedule/excel-export/index.ts?");
