...
/******/ 	var installedChunks = {
/******/ 		"./samples/schedule/group-by-date/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/schedule/group-by-date/index.ts","schedule.min"]);
...
/***/ "./samples/schedule/group-by-date/datasource.json":
/*!********************************************************!*\
  !*** ./samples/schedule/group-by-date/datasource.json ***!
  \********************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-schedule */ \"./node_modules/@syncfusion/ej2-schedule/index.js\"), __webpack_require__(/*! ./datasource.json */ \"./samples/schedule/group-by-date/datasource.json\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_schedule_1, dataSource, ej2_buttons_1, ej2_base_2) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_schedule_1.Schedule.Inject(ej2_schedule_1.Day, ej2_schedule_1.Week, ej2_schedule_1.Month, ej2_schedule_1.Agenda, ej2_schedule_1.Resize, ej2_schedule_1.DragAndDrop);\n    var data = (0, ej2_base_2.extend)([], dataSource.resourceData, null, true);\n    var scheduleOptions = {\n        width: '100%',\n        height: '650px',\n        selectedDate: new Date(2023, 0, 6),\n        group: {\n            byDate: true,\n            hideNonWorkingDays: true,\n            resources: ['Owners']\n        },\n        resources: [{\n                field: 'TaskId', title: 'Assignee',\n                name: 'Owners', allowMultiple: true,\n                dataSource: [\n                    { text: 'Alice', id: 1, color: '#df5286', workDays: [1, 2, 3, 4] },\n                    { text: 'Smith', id: 2, color: '#7fa900', workDays: [2, 3, 5] }\n                ],\n                textField: 'text', idField: 'id', colorField: 'color', workDaysField: 'workDays'\n            }],\n        views: ['Day', 'Week', 'Month', 'Agenda'],\n        eventSettings: {\n            dataSource: data,\n            fields: {\n                subject: { title: 'Task', name: 'Subject' },\n                location: { title: 'Project Name', name: 'Location' },\n                description: { title: 'Comments', name: 'Description' }\n            }\n        }\n    };\n    var scheduleObj = new ej2_schedule_1.Schedule(scheduleOptions);\n    scheduleObj.appendTo(document.getElementById('Schedule'));\n    var checkboxObj = new ej2_buttons_1.CheckBox({ label: 'Hide non working days', checked: true, change: onChange });\n    checkboxObj.appendTo('#checkbox');\n    function onChange(args) {\n        if (args.checked) {\n            scheduleObj.group.hideNonWorkingDays = true;\n        }\n        else {\n            scheduleObj.group.hideNonWorkingDays = false;\n        }\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/schedule/group-by-date/index.ts?");
