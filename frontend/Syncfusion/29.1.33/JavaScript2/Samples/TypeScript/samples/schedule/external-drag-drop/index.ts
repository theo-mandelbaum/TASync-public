 ...
 */
    ...
    (window as TemplateFunction).getConsultantImage = (value: ResourceDetails) => {
        ...
        if (resourceName === 'GENERAL' || resourceName === 'DENTAL') {
            ...
            return '<img class="specialist-image" src="//npmci.syncfusion.com/development/demos/src/schedule/images/' + resourceName.toLowerCase() + '.png" alt="' + resourceName.toLowerCase() + '"/>';
        }
    };
