...
/******/ 	var installedChunks = {
/******/ 		"./samples/schedule/print/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/schedule/print/index.ts","schedule.min"]);
...
/***/ "./samples/schedule/print/datasource.json":
/*!************************************************!*\
  !*** ./samples/schedule/print/datasource.json ***!
  \************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-schedule */ \"./node_modules/@syncfusion/ej2-schedule/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! @syncfusion/ej2-calendars */ \"./node_modules/@syncfusion/ej2-calendars/index.js\"), __webpack_require__(/*! ./datasource.json */ \"./samples/schedule/print/datasource.json\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_base_2, ej2_schedule_1, ej2_buttons_1, ej2_buttons_2, ej2_dropdowns_1, ej2_calendars_1, dataSource) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_schedule_1.Schedule.Inject(ej2_schedule_1.Day, ej2_schedule_1.Week, ej2_schedule_1.WorkWeek, ej2_schedule_1.Month, ej2_schedule_1.Agenda, ej2_schedule_1.DragAndDrop, ej2_schedule_1.Resize, ej2_schedule_1.Print);\n    var data = (0, ej2_base_2.extend)([], dataSource.scheduleData, null, true);\n    var scheduleObj = new ej2_schedule_1.Schedule({\n        width: '100%',\n        height: '550px',\n        selectedDate: new Date(2021, 0, 10),\n        eventSettings: { dataSource: data },\n    });\n    scheduleObj.appendTo('#Schedule');\n    var checkBoxObj = new ej2_buttons_2.CheckBox({\n        labelPosition: 'Before',\n        label: 'Print with options',\n        change: function (args) {\n            var classList = ['.e-height-row', '.e-width-row', '.e-selected-date-row'];\n            for (var i = 0; i < classList.length; i++) {\n                var element = document.querySelector(classList[i]);\n                if (args.checked) {\n                    element.classList.remove('e-hide-row');\n                }\n                else {\n                    element.classList.add('e-hide-row');\n                }\n            }\n        }\n    });\n    checkBoxObj.appendTo('#checked');\n    var printHeightAndWidthData = ['auto', '100%', '500px'];\n    var heightObj = new ej2_dropdowns_1.DropDownList({\n        width: '100%',\n        placeholder: 'Height',\n        floatLabelType: 'Always',\n        dataSource: printHeightAndWidthData,\n        popupHeight: '200px',\n        value: 'auto'\n    });\n    heightObj.appendTo('#heightElement');\n    var widthObj = new ej2_dropdowns_1.DropDownList({\n        width: '100%',\n        placeholder: 'Width',\n        floatLabelType: 'Always',\n        dataSource: printHeightAndWidthData,\n        popupHeight: '200px',\n        value: 'auto'\n    });\n    widthObj.appendTo('#widthElement');\n    var selectedDateObj = new ej2_calendars_1.DatePicker({\n        width: '100%',\n        placeholder: 'Selected date',\n        floatLabelType: 'Always',\n        value: new Date(2021, 0, 10)\n    });\n    selectedDateObj.appendTo('#selectedDateElement');\n    var printButton = new ej2_buttons_1.Button({\n        iconCss: 'e-icons e-print',\n        cssClass: 'e-print-btn'\n    });\n    printButton.appendTo('#print-btn');\n    document.getElementById('print-btn').onclick = function () {\n        if (checkBoxObj.checked) {\n            var printOptions = {\n                height: heightObj.value,\n                width: widthObj.value,\n                selectedDate: selectedDateObj.value\n            };\n            scheduleObj.print(printOptions);\n        }\n        else {\n            scheduleObj.print();\n        }\n    };\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/schedule/print/index.ts?");
