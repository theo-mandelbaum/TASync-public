...
/******/ 	var installedChunks = {
/******/ 		"./samples/schedule/add-remove-resources/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/schedule/add-remove-resources/index.ts","schedule.min"]);
...
/***/ "./samples/schedule/add-remove-resources/datasource.json":
/*!***************************************************************!*\
  !*** ./samples/schedule/add-remove-resources/datasource.json ***!
  \***************************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! @syncfusion/ej2-schedule */ \"./node_modules/@syncfusion/ej2-schedule/index.js\"), __webpack_require__(/*! ./datasource.json */ \"./samples/schedule/add-remove-resources/datasource.json\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_buttons_1, ej2_schedule_1, dataSource) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_schedule_1.Schedule.Inject(ej2_schedule_1.Month, ej2_schedule_1.TimelineViews, ej2_schedule_1.TimelineMonth, ej2_schedule_1.Resize, ej2_schedule_1.DragAndDrop);\n    var calendarCollections = [\n        { CalendarText: 'My Calendar', CalendarId: 1, CalendarColor: '#c43081' },\n        { CalendarText: 'Company', CalendarId: 2, CalendarColor: '#ff7f50' },\n        { CalendarText: 'Birthday', CalendarId: 3, CalendarColor: '#AF27CD' },\n        { CalendarText: 'Holiday', CalendarId: 4, CalendarColor: '#808000' }\n    ];\n    var scheduleOptions = {\n        width: '100%',\n        height: '650px',\n        selectedDate: new Date(2021, 3, 1),\n        group: {\n            resources: ['Calendars']\n        },\n        resources: [{\n                field: 'CalendarId', title: 'Calendars',\n                name: 'Calendars', allowMultiple: true,\n                dataSource: [calendarCollections[0]],\n                textField: 'CalendarText', idField: 'CalendarId', colorField: 'CalendarColor'\n            }],\n        views: ['Month', 'TimelineWeek', 'TimelineMonth'],\n        eventSettings: { dataSource: generateCalendarData() }\n    };\n    var scheduleObj = new ej2_schedule_1.Schedule(scheduleOptions, document.getElementById('Schedule'));\n    function onChange(args) {\n        var value = parseInt(args.event.currentTarget.querySelector('input').getAttribute('value'), 10);\n        var resourceData = calendarCollections.filter(function (calendar) { return calendar.CalendarId === value; });\n        if (args.checked) {\n            scheduleObj.addResource(resourceData[0], 'Calendars', value - 1);\n        }\n        else {\n            scheduleObj.removeResource(value, 'Calendars');\n        }\n    }\n    new ej2_buttons_1.CheckBox({ cssClass: 'personal', value: '1', label: 'My Calendar', checked: true, disabled: true, change: onChange }, '#personal');\n    new ej2_buttons_1.CheckBox({ cssClass: 'company', value: '2', label: 'Company', checked: false, change: onChange }, '#company');\n    new ej2_buttons_1.CheckBox({ cssClass: 'birthday', value: '3', label: 'Birthday', checked: false, change: onChange }, '#birthdays');\n    new ej2_buttons_1.CheckBox({ cssClass: 'holiday', value: '4', label: 'Holiday', checked: false, change: onChange }, '#holidays');\n    function generateCalendarData() {\n        var collections = [];\n        var dataCollections = [dataSource.personalData, dataSource.companyData,\n            dataSource.birthdayData, dataSource.holidayData];\n        for (var _i = 0, dataCollections_1 = dataCollections; _i < dataCollections_1.length; _i++) {\n            var data = dataCollections_1[_i];\n            collections = collections.concat(data);\n        }\n        return collections;\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/schedule/add-remove-resources/index.ts?");
