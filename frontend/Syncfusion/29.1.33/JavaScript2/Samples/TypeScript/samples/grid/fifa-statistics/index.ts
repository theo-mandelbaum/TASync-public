 ...
 */
        ...
        if (value) {
            switch (field) {
                case 'Host':
                    ...
                    imageSource = '//npmci.syncfusion.com/development/demos/src/grid/images/country/' + (webpfiles.indexOf(value) > -1 ? value + '.webp' : value + '.png');
                    cellInfo = countryInfo[0][value.replace(/ /g, '_')];
                    break;
                case 'Champions':
                    imageSource = '//npmci.syncfusion.com/development/demos/src/grid/images/team/' + value + '.png';
                ...
                case 'Coach':
                    if (args.target.tagName === 'IMG') {
                        ...
                        imageSource = '//npmci.syncfusion.com/development/demos/src/grid/images/coach/' + value + (value === 'Aymoré Moreira' ? '.png' : '.jpg');
                ...
                case 'TopScorer':
                    ...
                    if (args.target.tagName === 'IMG') {
                        ...
                        imageSource = '//npmci.syncfusion.com/development/demos/src/grid/images/top_scorer/' + value + '.jpg';
                ...
                case 'BestPlayerAward':
                    if (args.target.tagName === 'IMG') {
                        ...
                        imageSource = '//npmci.syncfusion.com/development/demos/src/grid/images/best_player/' + value + '.jpg';
    ...
    function renderImage(rowDetails: FifaDetails, field: string): any {
        ...
        const src: string = '//npmci.syncfusion.com/development/demos/src/grid/images/country/' + (webpfiles.indexOf(value) > -1 ? value + '.webp' : value + '.png');
