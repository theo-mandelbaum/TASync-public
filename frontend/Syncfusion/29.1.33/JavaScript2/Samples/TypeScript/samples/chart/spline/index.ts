...
import {
    ...
    Legend, Tooltip, ILoadedEventArgs, Highlight, Crosshair
} from '@syncfusion/ej2-charts';
import { Browser } from '@syncfusion/ej2-base';
import { loadChartTheme } from './theme-color';
Chart.Inject(SplineSeries, Category, Legend, Tooltip, ChartAnnotation, Highlight, Crosshair);
 ...
 */
    ...
    let chart: Chart = new Chart({
        ...
        annotations: [{
            content: '<div id="chart_cloud"><img src="//npmci.syncfusion.com/development/demos/src/chart/images/cloud.png" alt="Cloud Picture" style="width: 41px; height: 41px"/></div>',
            x: 'Jan', y: 22.75, coordinateUnits: 'Point', verticalAlignment: 'Middle'
        }, {
            content: '<div id="chart_cloud"><img src="//npmci.syncfusion.com/development/demos/src/chart/images/sunny.png" alt="Sunny Picture" style="width: 41px; height: 41px"/></div>',
