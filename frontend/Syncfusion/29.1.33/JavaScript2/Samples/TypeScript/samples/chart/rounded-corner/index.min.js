...
/******/ 	var installedChunks = {
/******/ 		"./samples/chart/rounded-corner/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/chart/rounded-corner/index.ts","charts.min"]);
...
/***/ "./samples/chart/rounded-corner/index.ts":
/*!***********************************************!*\
  !*** ./samples/chart/rounded-corner/index.ts ***!
  \***********************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2/base */ \"./node_modules/@syncfusion/ej2/base.ts\"), __webpack_require__(/*! ./theme-color */ \"./samples/chart/rounded-corner/theme-color.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, base_1, theme_color_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_1.AccumulationChart.Inject(ej2_charts_1.PieSeries, ej2_charts_1.AccumulationTooltip, ej2_charts_1.AccumulationDataLabel, ej2_charts_1.AccumulationAnnotation);\n    var chartData = [\n        { x: 'Operations', y: 30.0, text: '30.0%' },\n        { x: 'Miscellaneous', y: 10.0, text: '10.0%' },\n        { x: 'Human Resources', y: 15.0, text: '15.0%' },\n        { x: 'Research and Development', y: 20.0, text: '20.0%' },\n        { x: 'Marketing', y: 25.0, text: '25.0%' },\n    ];\n    var chart = new ej2_charts_1.AccumulationChart({\n        series: [{\n                type: 'Pie',\n                dataSource: chartData,\n                animation: { enable: true },\n                xName: 'x',\n                yName: 'y',\n                innerRadius: '50%',\n                dataLabel: {\n                    visible: true,\n                    position: 'Outside',\n                    name: 'x',\n                    connectorStyle: { width: 0 },\n                },\n                borderRadius: 8,\n                border: { width: 3 }\n            }],\n        tooltip: {\n            enable: true,\n            header: '<b>Budget</b>', format: '${point.x}: <b>${point.y}%</b>',\n            enableHighlight: true\n        },\n        title: 'Company Budget Distribution',\n        width: base_1.Browser.isDevice ? '100%' : '75%',\n        enableSmartLabels: true,\n        enableBorderOnMouseMove: false,\n        pointRender: theme_color_1.roundedCornnerPointRender,\n        legendSettings: { visible: false },\n        annotations: [\n            {\n                content: \"<div style=\\\" padding: 5px 5px 5px 5px; font-size: \".concat(base_1.Browser.isDevice ? '10px' : '14px', \"; color: #FFFFFF;\\\">30%</div>\"),\n                region: 'Series',\n                coordinateUnits: 'Point',\n                x: 'Operations',\n                y: 30.0\n            },\n            {\n                content: \"<div style=\\\" padding: 5px 5px 5px 5px; font-size: \".concat(base_1.Browser.isDevice ? '10px' : '14px', \"; color: #FFFFFF;\\\" >10%</div>\"),\n                region: 'Series',\n                coordinateUnits: 'Point',\n                x: 'Miscellaneous',\n                y: 10.0\n            },\n            {\n                content: \"<div style=\\\" padding: 5px 5px 5px 5px; font-size: \".concat(base_1.Browser.isDevice ? '10px' : '14px', \"; color: #FFFFFF;\\\">15%</div>\"),\n                region: 'Series',\n                coordinateUnits: 'Point',\n                x: 'Human Resources',\n                y: 15.0\n            },\n            {\n                content: \"<div style=\\\" padding: 5px 5px 5px 5px; font-size: \".concat(base_1.Browser.isDevice ? '10px' : '14px', \"; color: #FFFFFF;\\\">20%</div>\"),\n                region: 'Series',\n                coordinateUnits: 'Point',\n                x: 'Research and Development',\n                y: 20.0\n            },\n            {\n                content: \"<div style=\\\" padding: 5px 5px 5px 5px; font-size: \".concat(base_1.Browser.isDevice ? '10px' : '14px', \"; color: #FFFFFF;\\\">25%</div>\"),\n                region: 'Series',\n                coordinateUnits: 'Point',\n                x: 'Marketing',\n                y: 25.0\n            }\n        ],\n        load: function (args) {\n            (0, theme_color_1.loadAccumulationChartTheme)(args);\n        }\n    });\n    chart.appendTo('#pie-border-container');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/chart/rounded-corner/index.ts?");

/***/ }),

/***/ "./samples/chart/rounded-corner/theme-color.ts":
/*!*****************************************************!*\
  !*** ./samples/chart/rounded-corner/theme-color.ts ***!
  \*****************************************************/
/*! no static exports found */
