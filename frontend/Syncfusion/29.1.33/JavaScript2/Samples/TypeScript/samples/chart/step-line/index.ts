...
import { Chart, StepLineSeries, Double, Tooltip, ILoadedEventArgs, ITooltipRenderEventArgs, Highlight, DataLabel } from '@syncfusion/ej2-charts';
Chart.Inject(StepLineSeries, Double, Tooltip, Highlight, DataLabel);
