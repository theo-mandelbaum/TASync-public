...
import { Chart, DateTime, Tooltip, ChartAnnotation, Highlight } from '@syncfusion/ej2-charts';
import { ILoadedEventArgs, MultiColoredLineSeries } from '@syncfusion/ej2-charts';
import { Browser } from '@syncfusion/ej2-base';
import { loadChartTheme } from './theme-color';
Chart.Inject(DateTime, Tooltip, ChartAnnotation, MultiColoredLineSeries, Highlight);

/**
 * Sample for Line series
 */
let lineZoneData: Object[] = [
        ...
        series: [
            {
                ...
                xName: 'x', yName: 'y', type: 'MultiColoredLine',
