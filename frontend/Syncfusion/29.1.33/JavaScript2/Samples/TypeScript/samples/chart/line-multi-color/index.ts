...
import { Highlight, MultiColoredLineSeries } from '@syncfusion/ej2-charts';
import { Chart, DateTime, Tooltip, ILoadedEventArgs } from '@syncfusion/ej2-charts';
import { Browser } from '@syncfusion/ej2-base';
import { loadChartTheme } from './theme-color';
Chart.Inject(DateTime, Tooltip, MultiColoredLineSeries, Highlight);
...
let multiColoredLineData: DataPoint[] = [
    ...
    let chart: Chart = new Chart({
        ...
        series: [
            {
                dataSource: multiColoredLineData,
                width: 1.5,
                xName: 'x', 
                yName: 'y', 
