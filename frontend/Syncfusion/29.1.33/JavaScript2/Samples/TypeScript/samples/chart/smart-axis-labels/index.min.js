...
/******/ 	var installedChunks = {
/******/ 		"./samples/chart/smart-axis-labels/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/chart/smart-axis-labels/index.ts","charts.min"]);
...
/***/ "./samples/chart/smart-axis-labels/index.ts":
/*!**************************************************!*\
  !*** ./samples/chart/smart-axis-labels/index.ts ***!
  \**************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./theme-color */ \"./samples/chart/smart-axis-labels/theme-color.ts\"), __webpack_require__(/*! @syncfusion/ej2-inputs */ \"./node_modules/@syncfusion/ej2-inputs/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, ej2_dropdowns_1, ej2_base_2, theme_color_1, ej2_inputs_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_1.Chart.Inject(ej2_charts_1.ColumnSeries, ej2_charts_1.Category, ej2_charts_1.DataLabel, ej2_charts_1.Tooltip);\n    var chart = new ej2_charts_1.Chart({\n        primaryXAxis: {\n            valueType: 'Category',\n            interval: 1,\n            majorGridLines: { width: 0 },\n            labelIntersectAction: 'Hide',\n            majorTickLines: { width: 0 },\n            minorTickLines: { width: 0 }\n        },\n        chartArea: {\n            border: {\n                width: 0\n            }\n        },\n        primaryYAxis: {\n            labelStyle: { size: '0px' },\n            majorTickLines: { width: 0 },\n            majorGridLines: { width: 0 },\n            lineStyle: { width: 0 },\n        },\n        series: [\n            {\n                type: 'Column', name: 'Users',\n                dataSource: [{ x: 'South Korea', y: 39 }, { x: 'India', y: 61 },\n                    { x: 'Pakistan', y: 20 }, { x: 'Germany', y: 65 },\n                    { x: 'Australia', y: 16 }, { x: 'Italy', y: 29 },\n                    { x: 'France', y: 45 }, { x: 'United Arab Emirates', y: 10 },\n                    { x: 'Russia', y: 41 }, { x: 'Mexico', y: 31 },\n                    { x: 'Brazil', y: 76 }, { x: 'China', y: 51 }],\n                xName: 'x', width: 2,\n                yName: 'y', marker: {\n                    dataLabel: {\n                        visible: true, enableRotation: ej2_base_2.Browser.isDevice ? true : false, angle: -90, position: 'Top', format: \"{value}M\", font: { fontWeight: '600' }\n                    }\n                }\n            },\n        ],\n        title: 'Internet Users in Millions',\n        tooltip: { enable: true, header: '', format: '<b>${point.x}</b> <br> Internet Users : <b>${point.y}M</b>' }, pointRender: theme_color_1.pointRender,\n        legendSettings: { visible: false },\n        load: function (args) {\n            (0, theme_color_1.loadChartTheme)(args);\n        }\n    });\n    chart.appendTo('#container');\n    chart.series[0].animation.enable = false;\n    var mode = new ej2_dropdowns_1.DropDownList({\n        index: 0,\n        width: 120,\n        change: function () {\n            chart.primaryXAxis.labelIntersectAction = mode.value;\n            chart.refresh();\n        }\n    });\n    mode.appendTo('#selmode');\n    var edgeMode = new ej2_dropdowns_1.DropDownList({\n        index: 0,\n        width: 120,\n        change: function () {\n            chart.primaryXAxis.edgeLabelPlacement = edgeMode.value;\n            chart.dataBind();\n        }\n    });\n    edgeMode.appendTo('#edgemode');\n    var labelMode = new ej2_dropdowns_1.DropDownList({\n        index: 0, width: 120,\n        change: function () {\n            chart.primaryXAxis.labelPosition = labelMode.value;\n            chart.refresh();\n        }\n    });\n    labelMode.appendTo('#position');\n    document.getElementById('Trim').onchange = function () {\n        var trim = document.getElementById('Trim');\n        if (trim.checked) {\n            chart.primaryXAxis.enableTrim = (trim.value === 'true');\n            chart.series[0].animation.enable = false;\n        }\n        else {\n            chart.primaryXAxis.enableTrim = (trim.value === 'false');\n        }\n        chart.refresh();\n    };\n    var labelWidth = new ej2_inputs_1.NumericTextBox({\n        value: 34, min: 1, width: 120,\n        change: function () {\n            chart.primaryXAxis.maximumLabelWidth = labelWidth.value;\n            chart.refresh();\n        }\n    });\n    labelWidth.appendTo('#LabelWidth');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/chart/smart-axis-labels/index.ts?");
