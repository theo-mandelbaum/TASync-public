...
import { Chart, LineSeries, Crosshair, Double, Legend, Tooltip, Highlight, ISharedTooltipRenderEventArgs, IAxisLabelRenderEventArgs, ILegendRenderEventArgs, ILoadedEventArgs } from '@syncfusion/ej2-charts';
import { Browser } from '@syncfusion/ej2-base';
import { loadChartTheme } from './theme-color';
Chart.Inject(LineSeries, Crosshair, Double, Legend, Tooltip, Highlight);

/**
 * Sample for Line Series with Dashed Line
 */
let dashedLineData: Object[] = [
