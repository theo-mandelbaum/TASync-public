...
import {
    Diagram, SymbolPalette, UndoRedo, ConnectorBridging, SnapConstraints,
    NodeModel, ConnectorModel, PathAnnotationModel, DecoratorModel, PointModel, PointPortModel, DiagramConstraints, SymbolInfo,
...
function createConnector(
    id: string,
    sourcePoint: PointModel, targetPoint: PointModel,
