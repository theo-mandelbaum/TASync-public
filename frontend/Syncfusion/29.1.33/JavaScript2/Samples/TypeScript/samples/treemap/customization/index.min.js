...
/******/ 	var installedChunks = {
/******/ 		"./samples/treemap/customization/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/treemap/customization/index.ts","treemap.min"]);
...
/***/ "./samples/treemap/customization/index.ts":
/*!************************************************!*\
  !*** ./samples/treemap/customization/index.ts ***!
  \************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-treemap */ \"./node_modules/@syncfusion/ej2-treemap/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./treemap-data/medals */ \"./samples/treemap/customization/treemap-data/medals.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_treemap_1, ej2_base_2, medals_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_treemap_1.TreeMap.Inject(ej2_treemap_1.TreeMapTooltip);\n    var treemapload = function (args) {\n        var theme = location.hash.split('/')[1];\n        theme = theme ? theme : 'Material';\n        args.treemap.theme = ((theme.charAt(0).toUpperCase() +\n            theme.slice(1)).replace(/-dark/i, 'Dark').replace(/-high/i, 'High').replace(/contrast/i, 'Contrast').replace(/5.3/i, '5'));\n    };\n    var treemap = new ej2_treemap_1.TreeMap({\n        load: treemapload,\n        titleSettings: {\n            text: 'US Gold medal categories in Summer Olympics - 2016',\n            textStyle: { size: '15px', fontFamily: 'Segoe UI' }\n        },\n        dataSource: medals_1.medals,\n        weightValuePath: 'Gold',\n        tooltipSettings: {\n            visible: true,\n            format: '${Sport} : ${Gold}',\n            textStyle: {\n                fontFamily: 'Segoe UI'\n            }\n        },\n        leafItemSettings: {\n            showLabels: !ej2_base_2.Browser.isDevice,\n            labelStyle: {\n                fontFamily: 'Segoe UI'\n            },\n            labelPath: 'Sport',\n            fill: '#993399',\n            templatePosition: 'Center',\n            border: { color: 'black', width: 0.5 },\n            labelFormat: ' ${Sport} - ${Gold}',\n            labelTemplate: '<div style=\"pointer-events: none;\"><img alt=\"Custom label template for illustrations\" src=\"https://ej2.syncfusion.com/demos/src/treemap/image/{{:GameImage}}\"' +\n                ' style=\"height:{{:ItemHeight}};width:{{:ItemWidth}};\"></img></div>'\n        }\n    });\n    treemap.appendTo('#container');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/treemap/customization/index.ts?");

/***/ }),

/***/ "./samples/treemap/customization/treemap-data/medals.ts":
/*!**************************************************************!*\
  !*** ./samples/treemap/customization/treemap-data/medals.ts ***!
  \**************************************************************/
/*! no static exports found */
