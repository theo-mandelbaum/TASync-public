...
/******/ 	var installedChunks = {
/******/ 		"./samples/pivot-table/conditional-formatting/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/pivot-table/conditional-formatting/index.ts","pivotview.min"]);
...
/***/ "./samples/pivot-table/conditional-formatting/index.ts":
/*!*************************************************************!*\
  !*** ./samples/pivot-table/conditional-formatting/index.ts ***!
  \*************************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-pivotview */ \"./node_modules/@syncfusion/ej2-pivotview/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./pivot-data/Pivot_Data.json */ \"./samples/pivot-table/conditional-formatting/pivot-data/Pivot_Data.json\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_pivotview_1, ej2_buttons_1, ej2_base_1, pivotData) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(false);\n    ej2_pivotview_1.PivotView.Inject(ej2_pivotview_1.ConditionalFormatting, ej2_pivotview_1.FieldList);\n    ej2_pivotview_1.PivotView.Inject(ej2_pivotview_1.FieldList);\n    var Pivot_Data = pivotData.data;\n    var pivotObj = new ej2_pivotview_1.PivotView({\n        dataSourceSettings: {\n            dataSource: Pivot_Data,\n            expandAll: false,\n            enableSorting: true,\n            drilledMembers: [{ name: 'Country', items: ['France', 'Germany'] }],\n            columns: [{ name: 'Year' }, { name: 'Order_Source', caption: 'Order Source' }],\n            rows: [{ name: 'Country' }, { name: 'Products' }],\n            values: [{ name: 'In_Stock', caption: 'In Stock' },\n                { name: 'Sold', caption: 'Units Sold' }],\n            filters: [{ name: 'Product_Categories', caption: 'Product Categories' }],\n            conditionalFormatSettings: [\n                {\n                    measure: 'In_Stock',\n                    value1: 5000,\n                    conditions: 'LessThan',\n                    style: {\n                        backgroundColor: '#80cbc4',\n                        color: 'black',\n                        fontFamily: 'Tahoma',\n                        fontSize: '12px'\n                    }\n                },\n                {\n                    value1: 3400,\n                    value2: 40000,\n                    measure: 'Sold',\n                    conditions: 'Between',\n                    style: {\n                        backgroundColor: '#f48fb1',\n                        color: 'black',\n                        fontFamily: 'Tahoma',\n                        fontSize: '12px'\n                    }\n                }\n            ]\n        },\n        allowConditionalFormatting: true,\n        showFieldList: true,\n        width: '100%',\n        height: 300,\n        gridSettings: { columnWidth: 100 }\n    });\n    pivotObj.appendTo('#PivotView');\n    var button = new ej2_buttons_1.Button({ isPrimary: true });\n    button.appendTo('#conditional-formatting-btn');\n    var button1 = new ej2_buttons_1.Button({ isPrimary: true });\n    button1.appendTo('#reset-format');\n    button1.element.onclick = function () {\n        if (pivotObj.dataSourceSettings.conditionalFormatSettings.length > 0) {\n            pivotObj.setProperties({ dataSourceSettings: { conditionalFormatSettings: [] } }, true);\n            pivotObj.renderPivotGrid();\n        }\n        pivotObj.conditionalFormattingModule.destroy();\n        document.getElementById('reset-format').blur();\n    };\n    button.element.onclick = function () {\n        if (pivotObj.conditionalFormattingModule) {\n            pivotObj.conditionalFormattingModule.showConditionalFormattingDialog();\n        }\n    };\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/pivot-table/conditional-formatting/index.ts?");

/***/ }),

/***/ "./samples/pivot-table/conditional-formatting/pivot-data/Pivot_Data.json":
/*!*******************************************************************************!*\
  !*** ./samples/pivot-table/conditional-formatting/pivot-data/Pivot_Data.json ***!
  \*******************************************************************************/
