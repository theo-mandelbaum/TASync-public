...
/******/ 	var installedChunks = {
/******/ 		"./samples/tree-grid/selection-api/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/tree-grid/selection-api/index.ts","treegrid.min"]);
...
/***/ "./samples/tree-grid/selection-api/data-source.ts":
/*!********************************************************!*\
  !*** ./samples/tree-grid/selection-api/data-source.ts ***!
  \********************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! @syncfusion/ej2-inputs */ \"./node_modules/@syncfusion/ej2-inputs/index.js\"), __webpack_require__(/*! @syncfusion/ej2-treegrid */ \"./node_modules/@syncfusion/ej2-treegrid/index.js\"), __webpack_require__(/*! ./data-source */ \"./samples/tree-grid/selection-api/data-source.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_buttons_1, ej2_inputs_1, ej2_treegrid_1, data_source_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_treegrid_1.TreeGrid.Inject(ej2_treegrid_1.Page);\n    var treegrid = new ej2_treegrid_1.TreeGrid({\n        dataSource: data_source_1.sampleData,\n        allowPaging: true,\n        pageSettings: { pageSize: 10 },\n        allowSelection: true,\n        selectionSettings: { type: 'Multiple' },\n        childMapping: 'subtasks',\n        height: 350,\n        treeColumnIndex: 1,\n        columns: [\n            { field: 'taskID', headerText: 'Task ID', textAlign: 'Right', width: 80 },\n            { field: 'taskName', headerText: 'Task Name', width: 200 },\n            { field: 'startDate', headerText: 'Start Date', textAlign: 'Right', width: 100, format: { skeleton: 'yMd', type: 'date' } },\n            { field: 'duration', headerText: 'Duration', textAlign: 'Right', width: 90 },\n            { field: 'progress', headerText: 'Progress', textAlign: 'Right', width: 90 }\n        ]\n    });\n    treegrid.appendTo('#TreeGrid');\n    var start = new ej2_inputs_1.NumericTextBox({\n        format: '##',\n        min: 0,\n        max: 11,\n        width: '95%'\n    });\n    start.appendTo('#start');\n    var to = new ej2_inputs_1.NumericTextBox({\n        min: 0,\n        max: 11,\n        format: '##',\n        width: '95%'\n    });\n    to.appendTo('#to');\n    var select = new ej2_buttons_1.Button();\n    select.appendTo('#select');\n    var clear = new ej2_buttons_1.Button();\n    clear.appendTo('#clear');\n    document.getElementById('select').onclick = function () {\n        var startRow = start.value;\n        var toRow = to.value;\n        var rows = [];\n        for (var i = startRow > toRow ? toRow : startRow; i <= (startRow > toRow ? startRow : toRow); i++) {\n            rows.push(i);\n        }\n        treegrid.selectRows(rows);\n    };\n    document.getElementById('clear').onclick = function () {\n        treegrid.clearSelection();\n    };\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/tree-grid/selection-api/index.ts?");
