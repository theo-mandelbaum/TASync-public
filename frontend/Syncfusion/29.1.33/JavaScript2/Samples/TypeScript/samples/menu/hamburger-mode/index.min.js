...
/******/ 	var installedChunks = {
/******/ 		"./samples/menu/hamburger-mode/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/menu/hamburger-mode/index.ts","navigations.min"]);
...
/***/ "./samples/menu/hamburger-mode/index.ts":
/*!**********************************************!*\
  !*** ./samples/menu/hamburger-mode/index.ts ***!
  \**********************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-navigations */ \"./node_modules/@syncfusion/ej2-navigations/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! ./menu-data.json */ \"./samples/menu/hamburger-mode/menu-data.json\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_navigations_1, ej2_dropdowns_1, dataSource, ej2_base_2) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    var menuOptions = {\n        created: function () {\n            if (ej2_base_2.Browser.isDevice) {\n                (0, ej2_base_2.select)('.property-section').remove();\n                (0, ej2_base_2.select)('#layoutcontainer').removeAttribute('class');\n                (0, ej2_base_2.select)('#layoutcontainer').removeAttribute('id');\n                (0, ej2_base_2.select)('#menu').style.height = '363px';\n            }\n        },\n        items: dataSource.hamburgerData,\n        hamburgerMode: true,\n        showItemOnClick: true,\n        animationSettings: { duration: 800 }\n    };\n    var menuObj = new ej2_navigations_1.Menu(menuOptions, '#menu');\n    new ej2_dropdowns_1.DropDownList({\n        value: 'mobile',\n        popupHeight: '200px',\n        change: function (args) {\n            var container = document.querySelector('#layoutcontainer');\n            switch (args.value) {\n                case 'mobile':\n                case 'tablet':\n                    menuObj.close();\n                    container.classList.add('deviceLayout');\n                    container.classList[args.value === 'mobile' ? 'remove' : 'add']('tabletview');\n                    menuObj.element.parentElement.classList[args.value === 'mobile' ? 'remove' : 'add']('e-menu-icon-left');\n                    menuObj.hamburgerMode = true;\n                    menuObj.showItemOnClick = true;\n                    break;\n                case 'desktop':\n                    container.classList.remove('deviceLayout', 'tabletview');\n                    menuObj.hamburgerMode = false;\n                    menuObj.showItemOnClick = false;\n                    break;\n            }\n        }\n    }, '#ddlViewMode');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/menu/hamburger-mode/index.ts?");
