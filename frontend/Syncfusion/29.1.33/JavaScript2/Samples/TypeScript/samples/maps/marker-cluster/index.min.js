...
/******/ 	var installedChunks = {
/******/ 		"./samples/maps/marker-cluster/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/maps/marker-cluster/index.ts","maps.min"]);
...
/***/ "./samples/maps/marker-cluster/index.ts":
/*!**********************************************!*\
  !*** ./samples/maps/marker-cluster/index.ts ***!
  \**********************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-maps */ \"./node_modules/@syncfusion/ej2-maps/index.js\"), __webpack_require__(/*! ./map-data/world-map */ \"./samples/maps/marker-cluster/map-data/world-map.ts\"), __webpack_require__(/*! ./map-data/marker-cluster */ \"./samples/maps/marker-cluster/map-data/marker-cluster.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_maps_1, world_map_1, marker_cluster_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_maps_1.Maps.Inject(ej2_maps_1.Marker, ej2_maps_1.MapsTooltip, ej2_maps_1.Zoom);\n    var maps = new ej2_maps_1.Maps({\n        load: function (args) {\n            var theme = location.hash.split('/')[1];\n            theme = theme ? theme : 'Material';\n            args.maps.theme = (theme.charAt(0).toUpperCase() +\n                theme.slice(1)).replace(/-dark/i, 'Dark').replace(/-high/i, 'High').replace(/contrast/i, 'Contrast').replace(/5.3/i, '5');\n        },\n        useGroupingSeparator: true,\n        format: 'n',\n        zoomSettings: {\n            enable: true\n        },\n        titleSettings: {\n            text: 'Top 50 largest cities in the World',\n            textStyle: {\n                size: '16px',\n                fontFamily: 'Segoe UI'\n            }\n        },\n        layers: [\n            {\n                shapeData: world_map_1.worldMap,\n                shapeSettings: {\n                    fill: '#C1DFF5'\n                },\n                markerClusterSettings: {\n                    allowClustering: true,\n                    shape: 'Image',\n                    height: 40,\n                    width: 40,\n                    labelStyle: { color: 'white' },\n                    imageUrl: 'https://ej2.syncfusion.com/demos/src/maps/images/cluster.svg'\n                },\n                markerSettings: [\n                    {\n                        visible: true,\n                        dataSource: marker_cluster_1.cluster,\n                        shape: 'Image',\n                        imageUrl: 'https://ej2.syncfusion.com/demos/src/maps/images/ballon.png',\n                        tooltipSettings: {\n                            template: '#template',\n                            visible: true,\n                            valuePath: 'area',\n                        },\n                        height: 20,\n                        width: 20,\n                        animationDuration: 0\n                    },\n                ]\n            }\n        ]\n    });\n    maps.appendTo('#container');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/maps/marker-cluster/index.ts?");

/***/ }),

/***/ "./samples/maps/marker-cluster/map-data/marker-cluster.ts":
/*!****************************************************************!*\
  !*** ./samples/maps/marker-cluster/map-data/marker-cluster.ts ***!
  \****************************************************************/
/*! no static exports found */
