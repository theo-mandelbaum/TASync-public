...
/******/ 	var installedChunks = {
/******/ 		"./samples/maps/projection/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/maps/projection/index.ts","maps.min"]);
...
/***/ "./samples/maps/projection/index.ts":
/*!******************************************!*\
  !*** ./samples/maps/projection/index.ts ***!
  \******************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-maps */ \"./node_modules/@syncfusion/ej2-maps/index.js\"), __webpack_require__(/*! ./map-data/world-map */ \"./samples/maps/projection/map-data/world-map.ts\"), __webpack_require__(/*! ./map-data/projection-datasource */ \"./samples/maps/projection/map-data/projection-datasource.ts\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_maps_1, world_map_1, projection_datasource_1, ej2_dropdowns_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_maps_1.Maps.Inject(ej2_maps_1.Zoom, ej2_maps_1.Legend, ej2_maps_1.MapsTooltip);\n    var maps = new ej2_maps_1.Maps({\n        load: function (args) {\n            var theme = location.hash.split('/')[1];\n            theme = theme ? theme : 'Material';\n            args.maps.theme = (theme.charAt(0).toUpperCase() +\n                theme.slice(1)).replace(/-dark/i, 'Dark').replace(/-high/i, 'High').replace(/contrast/i, 'Contrast').replace(/5.3/i, '5');\n        },\n        titleSettings: {\n            text: 'Members of the UN Security Council',\n            textStyle: {\n                size: '16px',\n                fontFamily: 'Segoe UI'\n            },\n            subtitleSettings: {\n                text: '- In 2017',\n                alignment: 'Far',\n                textStyle: {\n                    fontFamily: 'Segoe UI'\n                }\n            }\n        },\n        legendSettings: {\n            visible: true,\n            textStyle: {\n                fontFamily: 'Segoe UI'\n            }\n        },\n        zoomSettings: {\n            enable: false\n        },\n        layers: [\n            {\n                shapeData: world_map_1.worldMap,\n                shapeDataPath: 'Country',\n                shapePropertyPath: 'name',\n                dataSource: projection_datasource_1.projectionData,\n                tooltipSettings: {\n                    visible: true,\n                    valuePath: 'Country',\n                    textStyle: {\n                        fontFamily: 'Segoe UI'\n                    }\n                },\n                shapeSettings: {\n                    fill: '#E5E5E5',\n                    colorMapping: [\n                        {\n                            value: 'Permanent',\n                            color: '#EDB46F'\n                        },\n                        {\n                            color: '#F1931B',\n                            value: 'Non-Permanent'\n                        }\n                    ],\n                    colorValuePath: 'Membership'\n                }\n            }\n        ]\n    });\n    maps.appendTo('#container');\n    var projection = new ej2_dropdowns_1.DropDownList({\n        index: 0,\n        placeholder: 'Select projection type',\n        width: '100%',\n        change: function () {\n            maps.projectionType = projection.value;\n            maps.refresh();\n        }\n    });\n    projection.appendTo('#projectiontype');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/maps/projection/index.ts?");

/***/ }),

/***/ "./samples/maps/projection/map-data/projection-datasource.ts":
/*!*******************************************************************!*\
  !*** ./samples/maps/projection/map-data/projection-datasource.ts ***!
  \*******************************************************************/
/*! no static exports found */
