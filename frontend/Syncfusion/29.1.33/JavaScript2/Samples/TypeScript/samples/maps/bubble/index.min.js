...
/******/ 	var installedChunks = {
/******/ 		"./samples/maps/bubble/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/maps/bubble/index.ts","maps.min"]);
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./map-data/population-data */ \"./samples/maps/bubble/map-data/population-data.ts\"), __webpack_require__(/*! ./map-data/world-map */ \"./samples/maps/bubble/map-data/world-map.ts\"), __webpack_require__(/*! @syncfusion/ej2-maps */ \"./node_modules/@syncfusion/ej2-maps/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, population_data_1, world_map_1, ej2_maps_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_maps_1.Maps.Inject(ej2_maps_1.Bubble, ej2_maps_1.MapsTooltip, ej2_maps_1.Zoom);\n    var maps = new ej2_maps_1.Maps({\n        load: function (args) {\n            var theme = location.hash.split('/')[1];\n            theme = theme ? theme : 'Material';\n            args.maps.theme = (theme.charAt(0).toUpperCase() +\n                theme.slice(1)).replace(/-dark/i, 'Dark').replace(/-high/i, 'High').replace(/contrast/i, 'Contrast').replace(/5.3/i, '5');\n        },\n        bubbleRendering: function (args) {\n            args.radius = args.data.value;\n        },\n        format: 'n',\n        useGroupingSeparator: true,\n        zoomSettings: {\n            enable: true,\n            toolbarSettings: {\n                orientation: 'Vertical',\n                horizontalAlignment: 'Near',\n            },\n            pinchZooming: true\n        },\n        titleSettings: {\n            text: 'Top 30 countries with highest Internet users',\n            textStyle: {\n                size: '16px',\n                fontFamily: 'Segoe UI'\n            }\n        },\n        layers: [\n            {\n                shapeDataPath: 'name',\n                shapePropertyPath: 'name',\n                shapeData: world_map_1.worldMap,\n                shapeSettings: {\n                    fill: '#E5E5E5'\n                },\n                bubbleSettings: [\n                    {\n                        visible: true,\n                        valuePath: 'value',\n                        colorValuePath: 'color',\n                        minRadius: 3,\n                        maxRadius: 70,\n                        opacity: 0.8,\n                        dataSource: population_data_1.internetUsers,\n                        tooltipSettings: {\n                            visible: true,\n                            valuePath: 'population',\n                            template: '#template'\n                        },\n                    }\n                ]\n            }\n        ]\n    });\n    maps.appendTo('#container');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/maps/bubble/index.ts?");
...
/***/ "./samples/maps/bubble/map-data/world-map.ts":
/*!***************************************************!*\
  !*** ./samples/maps/bubble/map-data/world-map.ts ***!
  \***************************************************/
/*! no static exports found */
