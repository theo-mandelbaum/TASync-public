...
/******/ 	var installedChunks = {
/******/ 		"./samples/kanban/swimlane/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/kanban/swimlane/index.ts","kanban.min"]);
...
/***/ "./samples/kanban/swimlane/datasource.json":
/*!*************************************************!*\
  !*** ./samples/kanban/swimlane/datasource.json ***!
  \*************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-kanban */ \"./node_modules/@syncfusion/ej2-kanban/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! ./datasource.json */ \"./samples/kanban/swimlane/datasource.json\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_kanban_1, ej2_base_2, ej2_buttons_1, ej2_dropdowns_1, dataSource) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    var data = (0, ej2_base_2.extend)([], dataSource.kanbanData, null, true);\n    var kanbanObj = new ej2_kanban_1.Kanban({\n        dataSource: data,\n        keyField: 'Status',\n        columns: [\n            { headerText: 'To Do', keyField: 'Open' },\n            { headerText: 'In Progress', keyField: 'InProgress' },\n            { headerText: 'Done', keyField: 'Close' }\n        ],\n        cardSettings: {\n            contentField: 'Summary',\n            headerField: 'Id',\n        },\n        swimlaneSettings: {\n            keyField: 'Assignee'\n        },\n        height: '500px'\n    });\n    kanbanObj.appendTo('#Kanban');\n    new ej2_buttons_1.CheckBox({ checked: false, change: onChange }, '#acrossDragAndDrop');\n    new ej2_buttons_1.CheckBox({ checked: false, change: onChange }, '#emptyRow');\n    new ej2_buttons_1.CheckBox({ checked: true, change: onChange }, '#itemCount');\n    new ej2_buttons_1.CheckBox({ change: onChange }, '#frozenRows');\n    var sortOrder = new ej2_dropdowns_1.DropDownList({\n        width: '100%',\n        change: changeSortOrder\n    });\n    sortOrder.appendTo('#sort');\n    function onChange(args) {\n        var value = this.element.id;\n        switch (value) {\n            case 'acrossDragAndDrop':\n                kanbanObj.swimlaneSettings.allowDragAndDrop = args.checked;\n                break;\n            case 'emptyRow':\n                kanbanObj.swimlaneSettings.showEmptyRow = args.checked;\n                break;\n            case 'itemCount':\n                kanbanObj.swimlaneSettings.showItemCount = args.checked;\n                break;\n            case 'frozenRows':\n                kanbanObj.swimlaneSettings.enableFrozenRows = args.checked;\n                break;\n            default:\n                break;\n        }\n    }\n    function changeSortOrder(args) {\n        var sortDirection = args.itemData.value;\n        kanbanObj.swimlaneSettings.sortDirection = sortDirection;\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/kanban/swimlane/index.ts?");
