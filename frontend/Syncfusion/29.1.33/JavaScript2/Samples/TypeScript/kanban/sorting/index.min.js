...
/******/ 	var installedChunks = {
/******/ 		"./samples/kanban/sorting/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/kanban/sorting/index.ts","kanban.min"]);
...
/***/ "./samples/kanban/sorting/datasource.json":
/*!************************************************!*\
  !*** ./samples/kanban/sorting/datasource.json ***!
  \************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-kanban */ \"./node_modules/@syncfusion/ej2-kanban/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./datasource.json */ \"./samples/kanban/sorting/datasource.json\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_kanban_1, ej2_dropdowns_1, ej2_base_2, dataSource) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    var data = (0, ej2_base_2.extend)([], dataSource.kanbanData, null, true);\n    var kanbanObj = new ej2_kanban_1.Kanban({\n        dataSource: data,\n        keyField: 'Status',\n        columns: [\n            { headerText: 'To Do', keyField: 'Open' },\n            { headerText: 'In Progress', keyField: 'InProgress' },\n            { headerText: 'Done', keyField: 'Close' }\n        ],\n        cardSettings: {\n            headerField: 'Id',\n            contentField: 'Summary',\n            template: '#cardTemplate'\n        }\n    });\n    kanbanObj.appendTo('#Kanban');\n    var sortBy = new ej2_dropdowns_1.DropDownList({ change: onChange, index: 1 });\n    sortBy.appendTo('#sortBy');\n    var field = new ej2_dropdowns_1.DropDownList({ enabled: false });\n    field.appendTo('#field');\n    var direction = new ej2_dropdowns_1.DropDownList({ change: onChange });\n    direction.appendTo('#direction');\n    document.getElementById('sort').onclick = function () {\n        setKanbanProperties();\n    };\n    document.getElementById('clear').onclick = function () {\n        sortBy.value = 'Index';\n        direction.value = 'Ascending';\n        setFieldValue('None');\n        setKanbanProperties();\n    };\n    function setKanbanProperties() {\n        kanbanObj.sortSettings.sortBy = sortBy.value;\n        kanbanObj.sortSettings.field = field.value;\n        kanbanObj.sortSettings.direction = direction.value;\n    }\n    function onChange(args) {\n        if (args.value === 'DataSourceOrder' || args.value === 'Index') {\n            var data_1 = args.value === 'Index' ? 'RankId' : 'None';\n            setFieldValue(data_1);\n        }\n        if (args.value === 'Custom') {\n            field.dataSource = ['Priority', 'RankId', 'Summary'];\n            field.value = 'Priority';\n            field.enabled = true;\n        }\n        if (args.value === 'Ascending') {\n            var data_2 = sortBy.value === 'Index' ? 'RankId' : 'None';\n            setFieldValue(data_2);\n            direction.value = 'Ascending';\n        }\n        if (args.value === 'Descending') {\n            var data_3 = sortBy.value === 'Index' ? 'RankId' : 'None';\n            setFieldValue(data_3);\n            direction.value = 'Descending';\n        }\n    }\n    function setFieldValue(data) {\n        field.dataSource = [data];\n        field.value = data;\n        field.enabled = false;\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/kanban/sorting/index.ts?");
