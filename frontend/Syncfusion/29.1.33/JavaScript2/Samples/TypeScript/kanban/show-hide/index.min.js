...
/******/ 	var installedChunks = {
/******/ 		"./samples/kanban/show-hide/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/kanban/show-hide/index.ts","kanban.min"]);
...
/***/ "./samples/kanban/show-hide/datasource.json":
/*!**************************************************!*\
  !*** ./samples/kanban/show-hide/datasource.json ***!
  \**************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-kanban */ \"./node_modules/@syncfusion/ej2-kanban/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! ./datasource.json */ \"./samples/kanban/show-hide/datasource.json\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_kanban_1, ej2_base_2, ej2_buttons_1, dataSource) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    var data = (0, ej2_base_2.extend)([], dataSource.kanbanData, null, true);\n    var kanbanObj = new ej2_kanban_1.Kanban({\n        dataSource: data,\n        keyField: 'Status',\n        columns: [\n            { headerText: 'To Do', keyField: 'Open' },\n            { headerText: 'In Progress', keyField: 'InProgress' },\n            { headerText: 'In Review', keyField: 'Review' },\n            { headerText: 'Done', keyField: 'Close' }\n        ],\n        cardSettings: {\n            contentField: 'Summary',\n            headerField: 'Id',\n        }\n    });\n    kanbanObj.appendTo('#Kanban');\n    new ej2_buttons_1.CheckBox({ label: 'To Do', checked: true, change: onChange }, '#Open');\n    new ej2_buttons_1.CheckBox({ label: 'In Progress', checked: true, change: onChange }, '#InProgress');\n    new ej2_buttons_1.CheckBox({ label: 'In Review', checked: true, change: onChange }, '#Review');\n    new ej2_buttons_1.CheckBox({ label: 'Done', checked: true, change: onChange }, '#Close');\n    function onChange(args) {\n        if (args.checked) {\n            kanbanObj.showColumn(this.element.id);\n        }\n        else {\n            kanbanObj.hideColumn(this.element.id);\n        }\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/kanban/show-hide/index.ts?");
