...
/******/ 	var installedChunks = {
/******/ 		"./samples/schedule/header-rows/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/schedule/header-rows/index.ts","schedule.min"]);
...
/***/ "./samples/schedule/header-rows/datasource.json":
/*!******************************************************!*\
  !*** ./samples/schedule/header-rows/datasource.json ***!
  \******************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-schedule */ \"./node_modules/@syncfusion/ej2-schedule/index.js\"), __webpack_require__(/*! ./datasource.json */ \"./samples/schedule/header-rows/datasource.json\"), __webpack_require__(/*! ./helper */ \"./samples/schedule/header-rows/helper.ts\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_schedule_1, dataSource, helper_1, ej2_base_2) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_schedule_1.Schedule.Inject(ej2_schedule_1.TimelineViews, ej2_schedule_1.TimelineMonth, ej2_schedule_1.Resize, ej2_schedule_1.DragAndDrop);\n    var instance = new ej2_base_2.Internationalization();\n    window.getMonthDetails = function (value) {\n        return instance.formatDate(value.date, { skeleton: 'yMMMM' });\n    };\n    window.getWeekDetails = function (value) {\n        return 'Week ' + (0, ej2_schedule_1.getWeekNumber)((0, ej2_schedule_1.getWeekLastDate)(value.date, 0));\n    };\n    var scheduleOptions = {\n        width: '100%',\n        height: '650px',\n        selectedDate: new Date(2021, 0, 1),\n        headerRows: [\n            { option: 'Month', template: '#month-template' },\n            { option: 'Week', template: '#week-template' },\n            { option: 'Date' }\n        ],\n        views: [\n            { option: 'TimelineMonth', interval: 12 }\n        ],\n        eventSettings: {\n            dataSource: (0, ej2_base_2.extend)([], dataSource.headerRowData, null, true)\n        },\n        eventRendered: function (args) { return (0, helper_1.applyCategoryColor)(args, scheduleObj.currentView); }\n    };\n    var scheduleObj = new ej2_schedule_1.Schedule(scheduleOptions, document.getElementById('Schedule'));\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/schedule/header-rows/index.ts?");
