...
/******/ 	var installedChunks = {
/******/ 		"./samples/schedule/editor-custom-field/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/schedule/editor-custom-field/index.ts","schedule.min"]);
...
/***/ "./samples/schedule/editor-custom-field/datasource.json":
/*!**************************************************************!*\
  !*** ./samples/schedule/editor-custom-field/datasource.json ***!
  \**************************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! @syncfusion/ej2-schedule */ \"./node_modules/@syncfusion/ej2-schedule/index.js\"), __webpack_require__(/*! ./datasource.json */ \"./samples/schedule/editor-custom-field/datasource.json\"), __webpack_require__(/*! ./helper */ \"./samples/schedule/editor-custom-field/helper.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_base_2, ej2_dropdowns_1, ej2_schedule_1, dataSource, helper_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_schedule_1.Schedule.Inject(ej2_schedule_1.Day, ej2_schedule_1.Week, ej2_schedule_1.WorkWeek, ej2_schedule_1.Month, ej2_schedule_1.Agenda, ej2_schedule_1.Resize, ej2_schedule_1.DragAndDrop);\n    var data = (0, ej2_base_2.extend)([], dataSource.eventsData, null, true);\n    var scheduleObj = new ej2_schedule_1.Schedule({\n        width: '100%',\n        height: '650px',\n        selectedDate: new Date(2021, 1, 15),\n        eventSettings: {\n            dataSource: data\n        },\n        eventRendered: function (args) { return (0, helper_1.applyCategoryColor)(args, scheduleObj.currentView); },\n        popupOpen: function (args) {\n            if (args.type === 'Editor') {\n                if (!args.element.querySelector('.custom-field-row')) {\n                    var row = (0, ej2_base_2.createElement)('div', { className: 'custom-field-row' });\n                    var formElement = args.element.querySelector('.e-schedule-form');\n                    formElement.firstChild.insertBefore(row, args.element.querySelector('.e-title-location-row'));\n                    var container = (0, ej2_base_2.createElement)('div', { className: 'custom-field-container' });\n                    var inputEle = (0, ej2_base_2.createElement)('input', {\n                        className: 'e-field', attrs: { name: 'EventType' }\n                    });\n                    container.appendChild(inputEle);\n                    row.appendChild(container);\n                    var dropDownList = new ej2_dropdowns_1.DropDownList({\n                        dataSource: [\n                            { text: 'Public Event', value: 'public-event' },\n                            { text: 'Maintenance', value: 'maintenance' },\n                            { text: 'Commercial Event', value: 'commercial-event' },\n                            { text: 'Family Event', value: 'family-event' }\n                        ],\n                        fields: { text: 'text', value: 'value' },\n                        value: args.data.EventType,\n                        floatLabelType: 'Always', placeholder: 'Event Type'\n                    });\n                    dropDownList.appendTo(inputEle);\n                    inputEle.setAttribute('name', 'EventType');\n                }\n            }\n        }\n    });\n    scheduleObj.appendTo('#Schedule');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/schedule/editor-custom-field/index.ts?");
