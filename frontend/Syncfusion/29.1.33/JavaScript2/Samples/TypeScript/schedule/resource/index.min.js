...
/******/ 	var installedChunks = {
/******/ 		"./samples/schedule/resource/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/schedule/resource/index.ts","schedule.min"]);
...
/***/ "./samples/schedule/resource/datasource.json":
/*!***************************************************!*\
  !*** ./samples/schedule/resource/datasource.json ***!
  \***************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! @syncfusion/ej2-data */ \"./node_modules/@syncfusion/ej2-data/index.js\"), __webpack_require__(/*! @syncfusion/ej2-schedule */ \"./node_modules/@syncfusion/ej2-schedule/index.js\"), __webpack_require__(/*! ./datasource.json */ \"./samples/schedule/resource/datasource.json\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_buttons_1, ej2_data_1, ej2_schedule_1, dataSource, ej2_base_2) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_schedule_1.Schedule.Inject(ej2_schedule_1.Day, ej2_schedule_1.Week, ej2_schedule_1.WorkWeek, ej2_schedule_1.Month, ej2_schedule_1.Agenda, ej2_schedule_1.MonthAgenda, ej2_schedule_1.DragAndDrop, ej2_schedule_1.Resize);\n    var ownerCollections = [\n        { OwnerText: 'Margaret', OwnerId: 1, Color: '#ea7a57' },\n        { OwnerText: 'Robert', OwnerId: 2, Color: '#df5286' },\n        { OwnerText: 'Laura', OwnerId: 3, Color: '#865fcf' }\n    ];\n    var data = (0, ej2_base_2.extend)([], dataSource.resourceSampleData, null, true);\n    var scheduleOptions = {\n        width: '100%',\n        height: '650px',\n        selectedDate: new Date(2021, 5, 6),\n        resources: [{\n                field: 'OwnerId', title: 'Owners',\n                name: 'Owners', allowMultiple: true,\n                dataSource: ownerCollections,\n                textField: 'OwnerText', idField: 'OwnerId', colorField: 'Color'\n            }],\n        eventSettings: { dataSource: data }\n    };\n    var scheduleObj = new ej2_schedule_1.Schedule(scheduleOptions, document.getElementById('schedule'));\n    var ownerOneObj = new ej2_buttons_1.CheckBox({ cssClass: 'margaret', value: '1', label: 'Margaret', checked: true, change: onChange });\n    ownerOneObj.appendTo('#margaret');\n    var ownerTwoObj = new ej2_buttons_1.CheckBox({ cssClass: 'robert', value: '2', label: 'Robert', checked: true, change: onChange });\n    ownerTwoObj.appendTo('#robert');\n    var ownerThreeObj = new ej2_buttons_1.CheckBox({ cssClass: 'laura', value: '3', label: 'Laura', checked: true, change: onChange });\n    ownerThreeObj.appendTo('#laura');\n    function onChange() {\n        var predicate;\n        var checkBoxes = [ownerOneObj, ownerTwoObj, ownerThreeObj];\n        checkBoxes.forEach(function (checkBoxObj) {\n            if (checkBoxObj.checked) {\n                if (predicate) {\n                    predicate = predicate.or('OwnerId', 'equal', parseInt(checkBoxObj.value, 10));\n                }\n                else {\n                    predicate = new ej2_data_1.Predicate('OwnerId', 'equal', parseInt(checkBoxObj.value, 10));\n                }\n            }\n        });\n        scheduleObj.eventSettings.query = new ej2_data_1.Query().where(predicate);\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/schedule/resource/index.ts?");
