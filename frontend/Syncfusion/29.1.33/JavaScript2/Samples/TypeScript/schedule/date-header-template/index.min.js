...
/******/ 	var installedChunks = {
/******/ 		"./samples/schedule/date-header-template/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/schedule/date-header-template/index.ts","schedule.min"]);
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-schedule */ \"./node_modules/@syncfusion/ej2-schedule/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./datasource.json */ \"./samples/schedule/date-header-template/datasource.json\"), __webpack_require__(/*! ./helper */ \"./samples/schedule/date-header-template/helper.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_schedule_1, ej2_base_2, dataSource, helper_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_schedule_1.Schedule.Inject(ej2_schedule_1.Day, ej2_schedule_1.Week, ej2_schedule_1.WorkWeek, ej2_schedule_1.Month, ej2_schedule_1.TimelineMonth, ej2_schedule_1.Resize, ej2_schedule_1.DragAndDrop);\n    var instance = new ej2_base_2.Internationalization();\n    window.getDateHeaderText = function (value) {\n        return instance.formatDate(value, { skeleton: 'Ed' });\n    };\n    var getWeather = function (value) {\n        switch (value.getDay()) {\n            case 0:\n                return '<img class=\"weather-image\" src=\"https://ej2.syncfusion.com/demos/src/schedule/images/weather-clear.svg\" alt=\"Clear weather\"/><div class=\"weather-text\">25°C</div>';\n            case 1:\n                return '<img class=\"weather-image\" src=\"https://ej2.syncfusion.com/demos/src/schedule/images/weather-clouds.svg\" alt=\"Clouds weather\"/><div class=\"weather-text\">18°C</div>';\n            case 2:\n                return '<img class=\"weather-image\" src=\"https://ej2.syncfusion.com/demos/src/schedule/images/weather-rain.svg\"/ alt=\"Rain weather\"><div class=\"weather-text\">10°C</div>';\n            case 3:\n                return '<img class=\"weather-image\" src=\"https://ej2.syncfusion.com/demos/src/schedule/images/weather-clouds.svg\" alt=\"Clouds weather\"/><div class=\"weather-text\">16°C</div>';\n            case 4:\n                return '<img class=\"weather-image\" src=\"https://ej2.syncfusion.com/demos/src/schedule/images/weather-rain.svg\" alt=\"Rain weather\"/><div class=\"weather-text\">8°C</div>';\n            case 5:\n                return '<img class=\"weather-image\" src=\"https://ej2.syncfusion.com/demos/src/schedule/images/weather-clear.svg\" alt=\"Clear weather\"/><div class=\"weather-text\">27°C</div>';\n            case 6:\n                return '<img class=\"weather-image\" src=\"https://ej2.syncfusion.com/demos/src/schedule/images/weather-clouds.svg\" alt=\"Clouds weather\"/><div class=\"weather-text\">17°C</div>';\n            default:\n                return null;\n        }\n    };\n    window.getWeather = getWeather;\n    var data = (0, ej2_base_2.extend)([], dataSource.scheduleData, null, true);\n    var scheduleObj = new ej2_schedule_1.Schedule({\n        width: '100%',\n        height: '650px',\n        dateHeaderTemplate: '<div class=\"date-text\">${getDateHeaderText(data.date)}</div>${getWeather(data.date)}',\n        views: ['Day', 'Week', 'WorkWeek', 'Month', 'TimelineMonth'],\n        selectedDate: new Date(2021, 0, 10),\n        eventSettings: { dataSource: data },\n        cssClass: 'schedule-date-header-template',\n        renderCell: function (args) {\n            if (args.elementType === 'monthCells' && scheduleObj && scheduleObj.currentView === 'Month') {\n                var ele = document.createElement('div');\n                ele.innerHTML = getWeather(args.date);\n                (args.element).appendChild(ele.firstChild);\n            }\n        },\n        eventRendered: function (args) { return (0, helper_1.applyCategoryColor)(args, scheduleObj.currentView); }\n    });\n    scheduleObj.appendTo('#Schedule');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/schedule/date-header-template/index.ts?");
