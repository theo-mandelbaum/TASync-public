...
/******/ 	var installedChunks = {
/******/ 		"./samples/sparkline/spark-grid/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/sparkline/spark-grid/index.ts","charts.min"]);
...
/***/ "./samples/sparkline/spark-grid/data-source.ts":
/*!*****************************************************!*\
  !*** ./samples/sparkline/spark-grid/data-source.ts ***!
  \*****************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-grids */ \"./node_modules/@syncfusion/ej2-grids/index.js\"), __webpack_require__(/*! @syncfusion/ej2-data */ \"./node_modules/@syncfusion/ej2-data/index.js\"), __webpack_require__(/*! ./data-source */ \"./samples/sparkline/spark-grid/data-source.ts\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! ./theme-color */ \"./samples/sparkline/spark-grid/theme-color.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_grids_1, ej2_data_1, data_source_1, ej2_charts_1, theme_color_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    exports.getSparkData = exports.columnData = exports.lineData = exports.winloss = exports.sparkload = void 0;\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_grids_1.Grid.Inject(ej2_grids_1.Selection);\n    var sparkload = function (args) {\n        (0, theme_color_1.loadSparkLineTheme)(args);\n    };\n    exports.sparkload = sparkload;\n    var winloss = function () {\n        var windata = [];\n        var r;\n        for (var i = 1; i <= 12; i++) {\n            r = Math.random();\n            if (r <= 0.2) {\n                windata.push(-Math.random() * 10);\n            }\n            else {\n                windata.push(Math.random() * 10);\n            }\n        }\n        return windata;\n    };\n    exports.winloss = winloss;\n    exports.lineData = [\n        [0, 6, 4, 1, 3, 2, 5],\n        [5, 4, 6, 3, 1, 2, 0],\n        [6, 4, 0, 3, 2, 5, 1],\n        [4, 6, 3, 0, 1, 2, 5],\n        [3, 5, 6, 4, 0, 1, 2],\n        [1, 3, 4, 2, 5, 0, 6],\n        [2, 4, 0, 3, 5, 6, 1],\n        [5, 4, 6, 3, 1, 2, 0],\n        [0, 6, 4, 1, 3, 2, 5],\n        [6, 4, 0, 3, 2, 5, 1],\n        [4, 6, 3, 0, 1, 2, 5],\n        [3, 5, 6, 4, 0, 1, 2],\n        [1, 3, 4, 2, 5, 0, 6],\n        [2, 4, 0, 3, 5, 6, 1],\n        [5, 4, 6, 3, 1, 2, 0],\n        [0, 6, 4, 1, 3, 2, 5],\n        [6, 4, 0, 3, 2, 5, 1],\n        [4, 6, 3, 0, 1, 2, 5],\n        [2, 4, 0, 3, 5, 6, 1],\n        [3, 5, 6, 4, 0, 1, 2],\n        [1, 3, 4, 2, 5, 0, 6]\n    ];\n    exports.columnData = [\n        [0, 6, -4, 1, -3, 2, 5],\n        [5, -4, 6, 3, -1, 2, 0],\n        [6, 4, 0, 3, -2, 5, 1],\n        [4, -6, 3, 0, 1, -2, 5],\n        [3, 5, -6, -4, 0, 1, 2],\n        [1, -3, 4, -2, 5, 0, 6],\n        [2, 4, 0, -3, 5, -6, 1],\n        [5, 4, -6, 3, 1, -2, 0],\n        [0, -6, 4, 1, -3, 2, 5],\n        [6, 4, 0, -3, 2, -5, 1],\n        [4, 6, -3, 0, 1, 2, 5],\n        [3, -5, -6, 4, 0, 1, 2],\n        [1, 3, -4, -2, 5, 0, 6],\n        [2, -4, 0, -3, 5, 6, 1],\n        [5, 4, -6, 3, 1, -2, 0],\n        [0, 6, 4, -1, -3, 2, 5],\n        [6, -4, 0, -3, 2, 5, 1],\n        [4, 6, -3, 0, -1, 2, 5],\n        [6, 4, 0, -3, 2, -5, 1],\n        [3, 5, 6, -4, 0, 1, 2],\n        [1, 3, -4, 2, -5, 0, 6]\n    ];\n    var getSparkData = function (type, count) {\n        if (type === 'line') {\n            return exports.lineData[count];\n        }\n        else {\n            return exports.columnData[count];\n        }\n    };\n    exports.getSparkData = getSparkData;\n    var grid = new ej2_grids_1.Grid({\n        dataSource: new ej2_data_1.DataManager(data_source_1.orderdata).executeLocal(new ej2_data_1.Query().take(20)),\n        allowSelection: false,\n        enableHover: true,\n        height: 400,\n        columns: [\n            { field: 'EmployeeID', headerText: 'ID', textAlign: 'Right', width: 40 },\n            { field: 'CustomerID', headerText: 'Name', width: 60 },\n            { field: 'OrderDate', headerText: 'Order Date', width: 65, format: 'yMd', textAlign: 'Right' },\n            { field: 'ShipCountry', headerText: 'Ship Country', width: 70 },\n            { headerText: 'Tax per annum', template: '#columnTemplate1', textAlign: 'Center', width: 100 },\n            { headerText: 'One Day Index', template: '#columnTemplate2', textAlign: 'Center', width: 100 },\n            { headerText: 'Year GR', template: '#columnTemplate3', textAlign: 'Center', width: 100 }\n        ],\n    });\n    grid.appendTo('#Grid');\n    setTimeout(function () {\n        for (var i = 1; i < 21; i++) {\n            var line = new ej2_charts_1.Sparkline({\n                height: '50px',\n                width: '150px', load: exports.sparkload,\n                lineWidth: 2,\n                valueType: 'Numeric',\n                fill: '#3C78EF',\n                dataSource: (0, exports.getSparkData)('line', i)\n            });\n            line.appendTo('#spkline' + i);\n            var column = new ej2_charts_1.Sparkline({\n                height: '50px',\n                width: '150px', load: exports.sparkload,\n                type: 'Column',\n                valueType: 'Numeric',\n                fill: '#3C78EF',\n                negativePointColor: '#f7a816',\n                dataSource: (0, exports.getSparkData)('column', i)\n            });\n            column.appendTo('#spkarea' + i);\n            var winloss_1 = new ej2_charts_1.Sparkline({\n                height: '50px',\n                width: '150px', load: exports.sparkload,\n                type: 'WinLoss',\n                valueType: 'Numeric',\n                fill: '#3C78EF',\n                tiePointColor: 'darkgray',\n                negativePointColor: '#f7a816',\n                dataSource: (0, exports.getSparkData)('column', i)\n            });\n            winloss_1.appendTo('#spkwl' + i);\n        }\n    }, 500);\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/sparkline/spark-grid/index.ts?");
