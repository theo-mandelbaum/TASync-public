...
/******/ 	var installedChunks = {
/******/ 		"./samples/maps/earthquake/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/maps/earthquake/index.ts","maps.min"]);
...
/***/ "./samples/maps/earthquake/index.ts":
/*!******************************************!*\
  !*** ./samples/maps/earthquake/index.ts ***!
  \******************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-maps */ \"./node_modules/@syncfusion/ej2-maps/index.js\"), __webpack_require__(/*! ./map-data/asia */ \"./samples/maps/earthquake/map-data/asia.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_maps_1, asia_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_maps_1.Maps.Inject(ej2_maps_1.Zoom, ej2_maps_1.Marker, ej2_maps_1.DataLabel);\n    var maps = new ej2_maps_1.Maps({\n        load: function (args) {\n            var theme = location.hash.split('/')[1];\n            theme = theme ? theme : 'Material';\n            args.maps.theme = (theme.charAt(0).toUpperCase() +\n                theme.slice(1)).replace(/-dark/i, 'Dark').replace(/-high/i, 'High').replace(/contrast/i, 'Contrast').replace(/5.3/i, '5');\n        },\n        centerPosition: {\n            latitude: 1.5053645409602877,\n            longitude: 105.14038085937499\n        },\n        zoomSettings: {\n            enable: false,\n            zoomFactor: 7,\n            mouseWheelZoom: false\n        },\n        mapsArea: {\n            background: '#AEE2FA'\n        },\n        titleSettings: {\n            text: '7.6 Magnitude earthquake strikes Sumatra - 2009',\n            textStyle: {\n                size: '18px',\n                fontFamily: 'Segoe UI'\n            }\n        },\n        layers: [\n            {\n                animationDuration: 1000,\n                shapeDataPath: 'name',\n                shapePropertyPath: 'name',\n                shapeData: asia_1.asia,\n                markerSettings: [{\n                        visible: true,\n                        height: 100,\n                        width: 100,\n                        template: '#template',\n                        animationDuration: 0,\n                        dataSource: [{\n                                latitude: 1.625758360412755, longitude: 98.5693359375\n                            }]\n                    }],\n                shapeSettings: {\n                    fill: '#FFFDCF',\n                    border: {\n                        color: '#3497C3 ',\n                        width: 0.5\n                    }\n                },\n                dataLabelSettings: {\n                    visible: true,\n                    labelPath: 'name',\n                    smartLabelMode: 'Hide'\n                }\n            }\n        ]\n    });\n    maps.appendTo('#maps');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/maps/earthquake/index.ts?");

/***/ }),

/***/ "./samples/maps/earthquake/map-data/asia.ts":
/*!**************************************************!*\
  !*** ./samples/maps/earthquake/map-data/asia.ts ***!
  \**************************************************/
/*! no static exports found */
