...
/******/ 	var installedChunks = {
/******/ 		"./samples/maps/annotation/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/maps/annotation/index.ts","maps.min"]);
...
/***/ "./samples/maps/annotation/index.ts":
/*!******************************************!*\
  !*** ./samples/maps/annotation/index.ts ***!
  \******************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-maps */ \"./node_modules/@syncfusion/ej2-maps/index.js\"), __webpack_require__(/*! ./map-data/africa-continent */ \"./samples/maps/annotation/map-data/africa-continent.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_maps_1, africa_continent_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_maps_1.Maps.Inject(ej2_maps_1.Annotations, ej2_maps_1.Marker);\n    var maps = new ej2_maps_1.Maps({\n        load: function (args) {\n            var theme = location.hash.split('/')[1];\n            theme = theme ? theme : 'Material';\n            args.maps.theme = (theme.charAt(0).toUpperCase() +\n                theme.slice(1)).replace(/-dark/i, 'Dark').replace(/-high/i, 'High').replace(/contrast/i, 'Contrast').replace(/5.3/i, '5');\n        },\n        zoomSettings: {\n            enable: false\n        },\n        annotations: [\n            {\n                content: '#maps-annotation',\n                x: '0%', y: '70%'\n            }, {\n                content: '#compass-maps',\n                x: '80%', y: '5%'\n            }\n        ],\n        layers: [\n            {\n                shapeDataPath: 'name',\n                shapePropertyPath: 'name',\n                shapeData: africa_continent_1.africaContinent,\n                shapeSettings: {\n                    fill: 'url(#grad1)'\n                },\n                markerSettings: [\n                    {\n                        visible: true,\n                        template: '<h3 style=\"color:white; font-family: Segoe UI;\">{{:name}}</h3>',\n                        animationDuration: 1,\n                        dataSource: [{\n                                name: 'Africa', latitude: 13.97274101999902, longitude: 20.390625\n                            }]\n                    }\n                ]\n            }\n        ]\n    });\n    maps.appendTo('#maps');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/maps/annotation/index.ts?");

/***/ }),

/***/ "./samples/maps/annotation/map-data/africa-continent.ts":
/*!**************************************************************!*\
  !*** ./samples/maps/annotation/map-data/africa-continent.ts ***!
  \**************************************************************/
/*! no static exports found */
