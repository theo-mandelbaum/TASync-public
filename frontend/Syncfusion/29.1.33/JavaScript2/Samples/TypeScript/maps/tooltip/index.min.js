...
/******/ 	var installedChunks = {
/******/ 		"./samples/maps/tooltip/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/maps/tooltip/index.ts","maps.min"]);
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-maps */ \"./node_modules/@syncfusion/ej2-maps/index.js\"), __webpack_require__(/*! ./map-data/world-map */ \"./samples/maps/tooltip/map-data/world-map.ts\"), __webpack_require__(/*! ./map-data/tooltip-datasource */ \"./samples/maps/tooltip/map-data/tooltip-datasource.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_maps_1, world_map_1, tooltip_datasource_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_maps_1.Maps.Inject(ej2_maps_1.MapsTooltip, ej2_maps_1.Legend);\n    var maps = new ej2_maps_1.Maps({\n        load: function (args) {\n            var theme = location.hash.split('/')[1];\n            theme = theme ? theme : 'Material';\n            args.maps.theme = (theme.charAt(0).toUpperCase() +\n                theme.slice(1)).replace(/-dark/i, 'Dark').replace(/-high/i, 'High').replace(/contrast/i, 'Contrast').replace(/5.3/i, '5');\n        },\n        tooltipRender: function (args) {\n            if (!args.options['data']) {\n                args.cancel = true;\n            }\n        },\n        titleSettings: {\n            text: 'Finalist in Cricket World Cup',\n            textStyle: {\n                size: '16px',\n                fontFamily: 'Segoe UI'\n            }\n        },\n        zoomSettings: {\n            enable: false\n        },\n        legendSettings: {\n            visible: true,\n            mode: 'Interactive',\n            position: 'Left',\n            orientation: 'Vertical',\n            height: '70%',\n            width: '10',\n            textStyle: {\n                fontFamily: 'Segoe UI'\n            }\n        },\n        layers: [\n            {\n                shapeData: world_map_1.worldMap,\n                shapePropertyPath: 'name',\n                shapeDataPath: 'name',\n                dataSource: tooltip_datasource_1.tooltipData,\n                tooltipSettings: {\n                    visible: true,\n                    valuePath: 'name',\n                    template: '#template'\n                },\n                shapeSettings: {\n                    fill: '#E5E5E5',\n                    colorMapping: [\n                        {\n                            value: '1',\n                            color: '#b3daff'\n                        },\n                        {\n                            color: '#80c1ff',\n                            value: '2'\n                        },\n                        {\n                            color: '#1a90ff',\n                            value: '3'\n                        },\n                        {\n                            color: '#005cb3',\n                            value: '7'\n                        }\n                    ],\n                    colorValuePath: 'value1'\n                }\n            }\n        ]\n    });\n    maps.appendTo('#container');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/maps/tooltip/index.ts?");

/***/ }),

/***/ "./samples/maps/tooltip/map-data/tooltip-datasource.ts":
/*!*************************************************************!*\
  !*** ./samples/maps/tooltip/map-data/tooltip-datasource.ts ***!
  \*************************************************************/
/*! no static exports found */
