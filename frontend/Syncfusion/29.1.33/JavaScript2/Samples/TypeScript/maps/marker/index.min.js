...
/******/ 	var installedChunks = {
/******/ 		"./samples/maps/marker/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/maps/marker/index.ts","maps.min"]);
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-maps */ \"./node_modules/@syncfusion/ej2-maps/index.js\"), __webpack_require__(/*! ./map-data/world-map */ \"./samples/maps/marker/map-data/world-map.ts\"), __webpack_require__(/*! ./map-data/top-location */ \"./samples/maps/marker/map-data/top-location.ts\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_maps_1, world_map_1, top_location_1, ej2_buttons_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_maps_1.Maps.Inject(ej2_maps_1.Marker, ej2_maps_1.MapsTooltip);\n    var maps = new ej2_maps_1.Maps({\n        load: function (args) {\n            var theme = location.hash.split('/')[1];\n            theme = theme ? theme : 'Material';\n            args.maps.theme = (theme.charAt(0).toUpperCase() +\n                theme.slice(1)).replace(/-dark/i, 'Dark').replace(/-high/i, 'High').replace(/contrast/i, 'Contrast').replace(/5.3/i, '5');\n        },\n        useGroupingSeparator: true,\n        format: 'n',\n        zoomSettings: {\n            enable: false\n        },\n        titleSettings: {\n            text: 'Top 25 populated cities in the world',\n            textStyle: {\n                size: '16px',\n                fontFamily: 'Segoe UI'\n            }\n        },\n        layers: [\n            {\n                shapeData: world_map_1.worldMap,\n                shapeSettings: {\n                    fill: '#C3E6ED'\n                },\n                markerSettings: [\n                    {\n                        dataSource: top_location_1.topPopulation,\n                        visible: true,\n                        animationDuration: 0,\n                        shape: 'Circle',\n                        fill: 'white',\n                        width: 10,\n                        border: { width: 2, color: '#285255' },\n                        tooltipSettings: {\n                            template: '#template',\n                            visible: true,\n                            valuePath: 'population',\n                        }\n                    },\n                ]\n            }\n        ]\n    });\n    maps.appendTo('#container');\n    var markerShape;\n    var markerShapeCheckBox = new ej2_buttons_1.CheckBox({\n        change: markerShape, checked: false\n    }, '#shape');\n    markerShapeCheckBox.change = markerShape = function (e) {\n        if (e.checked) {\n            maps.layers[0].markerSettings[0].shapeValuePath = 'shape';\n        }\n        else {\n            maps.layers[0].markerSettings[0].shapeValuePath = null;\n        }\n    };\n    var markerColor;\n    var markerColorCheckBox = new ej2_buttons_1.CheckBox({\n        change: markerColor, checked: false\n    }, '#color');\n    markerColorCheckBox.change = markerColor = function (e) {\n        if (e.checked) {\n            maps.layers[0].markerSettings[0].colorValuePath = 'color';\n        }\n        else {\n            maps.layers[0].markerSettings[0].colorValuePath = null;\n        }\n    };\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/maps/marker/index.ts?");

/***/ }),

/***/ "./samples/maps/marker/map-data/top-location.ts":
/*!******************************************************!*\
  !*** ./samples/maps/marker/map-data/top-location.ts ***!
  \******************************************************/
/*! no static exports found */
