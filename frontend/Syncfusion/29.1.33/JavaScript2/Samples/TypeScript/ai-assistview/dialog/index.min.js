...
/******/ 	var installedChunks = {
/******/ 		"./samples/ai-assistview/dialog/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/ai-assistview/dialog/index.ts","interactive.min"]);
...
/***/ "./samples/ai-assistview/dialog/index.ts":
/*!***********************************************!*\
  !*** ./samples/ai-assistview/dialog/index.ts ***!
  \***********************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-interactive-chat */ \"./node_modules/@syncfusion/ej2-interactive-chat/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! @syncfusion/ej2-popups */ \"./node_modules/@syncfusion/ej2-popups/index.js\"), __webpack_require__(/*! @syncfusion/ej2-layouts */ \"./node_modules/@syncfusion/ej2-layouts/index.js\"), __webpack_require__(/*! ./promptResponseData */ \"./samples/ai-assistview/dialog/promptResponseData.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_interactive_chat_1, ej2_buttons_1, ej2_popups_1, ej2_layouts_1, promptResponseData_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    var splitterObj = new ej2_layouts_1.Splitter({\n        height: '600px',\n        paneSettings: [\n            { size: '22%', resizable: false },\n            { size: '78%', resizable: false }\n        ]\n    });\n    splitterObj.appendTo('#splitter');\n    var dialogInst = new ej2_popups_1.Dialog({\n        content: document.getElementById('#aiAssistView'),\n        target: '.dialog-aiassistview',\n        width: '440px',\n        height: '100%',\n        visible: false,\n        cssClass: 'custom-dialog'\n    });\n    dialogInst.appendTo('#dialogElem');\n    var dialogAIAssistView = new ej2_interactive_chat_1.AIAssistView({\n        promptSuggestions: promptResponseData_1.defaultSuggestions,\n        promptRequest: onPromptRequest,\n        bannerTemplate: \"#bannerContent\",\n        toolbarSettings: {\n            items: [{ iconCss: 'e-icons e-close', align: 'Right' }],\n            itemClicked: toolbarItemClicked\n        },\n        responseToolbarSettings: {\n            itemClicked: toolbarItemClicked\n        },\n        cssClass: 'custom-aiassistview'\n    });\n    dialogAIAssistView.appendTo('#aiAssistView');\n    function onPromptRequest(args) {\n        setTimeout(function () {\n            var foundPrompt = promptResponseData_1.defaultPromptResponseData.find(function (promptObj) { return promptObj.prompt === args.prompt; });\n            var defaultResponse = 'For real-time prompt processing, connect the AI AssistView control to your preferred AI service, such as OpenAI or Azure Cognitive Services. Ensure you obtain the necessary API credentials to authenticate and enable seamless integration.';\n            dialogAIAssistView.addPromptResponse(foundPrompt ? foundPrompt.response : defaultResponse);\n            dialogAIAssistView.promptSuggestions = (foundPrompt === null || foundPrompt === void 0 ? void 0 : foundPrompt.suggestions) || promptResponseData_1.defaultSuggestions;\n        }, 2000);\n    }\n    function toolbarItemClicked(args) {\n        if (args.item.iconCss === 'e-icons e-close') {\n            dialogOpenClose();\n        }\n        if (args.item.iconCss === 'e-icons e-assist-copy') {\n            var targetElem = document.querySelector('.right-content .content');\n            var response = dialogAIAssistView.prompts[args.dataIndex].response;\n            if (targetElem) {\n                targetElem.innerHTML += response + '<br />';\n                dialogOpenClose();\n            }\n        }\n    }\n    var fabInst = new ej2_buttons_1.Fab({\n        iconCss: 'e-icons e-assistview-icon',\n        content: 'AI Assist',\n        target: '.dialog-aiassistview'\n    });\n    fabInst.appendTo('#fabElem');\n    fabInst.element.onclick = function () {\n        dialogOpenClose();\n    };\n    function dialogOpenClose() {\n        dialogInst.visible = !dialogInst.visible;\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/ai-assistview/dialog/index.ts?");

/***/ }),

/***/ "./samples/ai-assistview/dialog/promptResponseData.ts":
/*!************************************************************!*\
  !*** ./samples/ai-assistview/dialog/promptResponseData.ts ***!
  \************************************************************/
/*! no static exports found */
