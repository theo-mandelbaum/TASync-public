...
/******/ 	var installedChunks = {
/******/ 		"./samples/pivot-table/pivot-chart/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/pivot-table/pivot-chart/index.ts","pivotview.min"]);
...
/***/ "./samples/pivot-table/pivot-chart/index.ts":
/*!**************************************************!*\
  !*** ./samples/pivot-table/pivot-chart/index.ts ***!
  \**************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-pivotview */ \"./node_modules/@syncfusion/ej2-pivotview/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./pivot-data/Pivot_Data.json */ \"./samples/pivot-table/pivot-chart/pivot-data/Pivot_Data.json\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_pivotview_1, ej2_dropdowns_1, ej2_base_1, pivotData) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(false);\n    ej2_pivotview_1.PivotView.Inject(ej2_pivotview_1.PivotChart, ej2_pivotview_1.FieldList);\n    var Pivot_Data = pivotData.data;\n    var pivotObj = new ej2_pivotview_1.PivotView({\n        dataSourceSettings: {\n            enableSorting: true,\n            rows: [\n                { name: 'Year' },\n                { name: 'Order_Source', caption: 'Order Source' }\n            ],\n            columns: [{ name: 'Country' }, { name: 'Products' }],\n            valueSortSettings: { headerDelimiter: ' - ' },\n            dataSource: Pivot_Data,\n            drilledMembers: [{ name: 'Year', items: ['FY 2015'] }],\n            formatSettings: [{ name: 'Amount', format: 'C' }],\n            values: [{ name: 'Amount', caption: 'Sales Amount' }],\n            filters: []\n        },\n        showFieldList: true,\n        displayOption: { view: 'Chart' },\n        chartSettings: {\n            title: 'Sales Analysis',\n            chartSeries: { type: 'Column' },\n            load: function (args) {\n                var selectedTheme = location.hash.split('/')[1];\n                selectedTheme = selectedTheme ? selectedTheme : 'Material';\n                args.chart.theme = (selectedTheme.charAt(0).toUpperCase() +\n                    selectedTheme.slice(1)).replace(/-dark/i, 'Dark').replace(/contrast/i, 'Contrast').replace(/-highContrast/i, 'HighContrast');\n            }\n        },\n        height: 450\n    });\n    pivotObj.appendTo('#PivotView');\n    var chartTypesDropDown = new ej2_dropdowns_1.DropDownList({\n        placeholder: 'Chart Types',\n        floatLabelType: 'Auto',\n        change: function (args) {\n            pivotObj.chartSettings.chartSeries.type = args.value;\n        }\n    });\n    chartTypesDropDown.appendTo('#charttypesddl');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/pivot-table/pivot-chart/index.ts?");

/***/ }),

/***/ "./samples/pivot-table/pivot-chart/pivot-data/Pivot_Data.json":
/*!********************************************************************!*\
  !*** ./samples/pivot-table/pivot-chart/pivot-data/Pivot_Data.json ***!
  \********************************************************************/
