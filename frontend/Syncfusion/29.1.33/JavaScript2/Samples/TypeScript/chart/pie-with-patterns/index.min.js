...
/******/ 	var installedChunks = {
/******/ 		"./samples/chart/pie-with-patterns/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/chart/pie-with-patterns/index.ts","charts.min"]);
...
/***/ "./samples/chart/pie-with-patterns/index.ts":
/*!**************************************************!*\
  !*** ./samples/chart/pie-with-patterns/index.ts ***!
  \**************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2/charts */ \"./node_modules/@syncfusion/ej2/charts.ts\"), __webpack_require__(/*! ./theme-color */ \"./samples/chart/pie-with-patterns/theme-color.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, ej2_base_2, charts_1, theme_color_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_1.Chart.Inject(ej2_charts_1.Category, ej2_charts_1.Tooltip, ej2_charts_1.DateTime, ej2_charts_1.Zoom, ej2_charts_1.Logarithmic, ej2_charts_1.Crosshair, ej2_charts_1.DataLabel, ej2_charts_1.Legend);\n    var data = [\n        { x: 'Internet Explorer', y: 6.12, text: ej2_base_2.Browser.isDevice ? 'Internet Explorer:<br> 6.12%' : 'Internet Explorer: 6.12%' },\n        { x: 'Chrome', y: 57.28, text: ej2_base_2.Browser.isDevice ? 'Chrome:<br> 57.282%' : 'Chrome: 57.28%' },\n        { x: 'Safari', y: 4.73, text: ej2_base_2.Browser.isDevice ? 'Safari:<br> 4.73%' : 'Safari: 4.73%' },\n        { x: 'QQ', y: 5.96, text: ej2_base_2.Browser.isDevice ? 'QQ:<br>5.96%' : 'QQ: 5.96%' },\n        { x: 'UC Browser', y: 4.37, text: ej2_base_2.Browser.isDevice ? 'UC Browser:<br>4.37%' : 'UC Browser: 4.37%' },\n        { x: 'Edge', y: 7.48, text: ej2_base_2.Browser.isDevice ? 'Edge:<br> 7.48%' : 'Edge: 7.48%' },\n        { x: 'Others', y: 14.06, text: ej2_base_2.Browser.isDevice ? 'Others:<br> 14.06%' : 'Others: 14.06%' }\n    ];\n    var chart = new charts_1.AccumulationChart({\n        series: [{\n                type: 'Pie', dataSource: data, xName: 'x', yName: 'y', animation: { enable: true }, applyPattern: true, dataLabel: {\n                    name: 'text', visible: true, position: 'Outside', font: { fontWeight: '600' }, connectorStyle: { length: '20px', type: 'Curve' },\n                }, border: { width: 2 }\n            }],\n        enableBorderOnMouseMove: false,\n        width: ej2_base_2.Browser.isDevice ? '100%' : '75%',\n        pointRender: theme_color_1.piePatternPointrender,\n        legendSettings: { visible: false },\n        title: 'Browser Market Share',\n        tooltip: { enableHighlight: true, enable: true, format: '<b>${point.x}</b><br>Browser Share: <b>${point.y}%</b>', header: \"\" },\n        load: function (args) {\n            (0, theme_color_1.loadAccumulationChartTheme)(args);\n        }\n    });\n    chart.appendTo('#container');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/chart/pie-with-patterns/index.ts?");

/***/ }),

/***/ "./samples/chart/pie-with-patterns/theme-color.ts":
/*!********************************************************!*\
  !*** ./samples/chart/pie-with-patterns/theme-color.ts ***!
  \********************************************************/
/*! no static exports found */
