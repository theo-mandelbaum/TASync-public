...
/******/ 	var installedChunks = {
/******/ 		"./samples/chart/indexed-axis/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/chart/indexed-axis/index.ts","charts.min"]);
...
/***/ "./samples/chart/indexed-axis/index.ts":
/*!*********************************************!*\
  !*** ./samples/chart/indexed-axis/index.ts ***!
  \*********************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2/base */ \"./node_modules/@syncfusion/ej2/base.ts\"), __webpack_require__(/*! @syncfusion/ej2/charts */ \"./node_modules/@syncfusion/ej2/charts.ts\"), __webpack_require__(/*! ./theme-color */ \"./samples/chart/indexed-axis/theme-color.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, base_1, charts_1, theme_color_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_1.Chart.Inject(ej2_charts_1.ColumnSeries, ej2_charts_1.LineSeries, ej2_charts_1.Category, ej2_charts_1.Legend, ej2_charts_1.DataLabel, charts_1.Tooltip);\n    var chart = new ej2_charts_1.Chart({\n        primaryXAxis: {\n            valueType: 'Category',\n            interval: 1,\n            isIndexed: true,\n            labelRotation: base_1.Browser.isDevice ? -45 : 0,\n            labelIntersectAction: base_1.Browser.isDevice ? 'None' : 'Rotate45',\n            majorTickLines: { width: 0 }, crosshairTooltip: { enable: true }\n        },\n        primaryYAxis: {\n            labelFormat: '{value}%', majorTickLines: { width: 0 }, title: 'GDP Growth Rate'\n        },\n        chartArea: {\n            border: {\n                width: 0\n            }\n        },\n        series: [\n            {\n                type: 'Column',\n                dataSource: [\n                    { x: \"India\", y: 7.9 },\n                    { x: \"Myanmar\", y: 7.3 },\n                    { x: \"Bangladesh\", y: 6.0 },\n                    { x: \"Cambodia\", y: 7.0 },\n                    { x: \"China\", y: 6.9 },\n                ],\n                xName: 'x', width: 2, marker: { visible: false, height: 10, width: 10, dataLabel: { visible: true, position: 'Top', font: { size: base_1.Browser.isDevice ? '8px' : '11px' } } },\n                yName: 'y', name: '2015',\n            },\n            {\n                type: 'Column',\n                dataSource: [\n                    { x: \"Australia\", y: 2.5 },\n                    { x: \"Poland\", y: 2.7 },\n                    { x: \"Singapore\", y: 2.0 },\n                    { x: \"Canada\", y: 1.4 },\n                    { x: \"Germany\", y: 1.8 },\n                ],\n                xName: 'x', width: 2, marker: { visible: false, height: 10, width: 10, dataLabel: { visible: true, position: 'Top', font: { size: base_1.Browser.isDevice ? '8px' : '11px' } } },\n                yName: 'y', name: '2016',\n            },\n        ],\n        title: 'GDP by Countries',\n        load: function (args) {\n            (0, theme_color_1.loadChartTheme)(args);\n        }\n    });\n    chart.appendTo('#container');\n    document.getElementById('isIndexed').onchange = function () {\n        var element = (document.getElementById('isIndexed'));\n        chart.primaryXAxis.isIndexed = element.checked;\n        if (chart.primaryXAxis.isIndexed) {\n            chart.series[0].type = 'Column';\n            chart.series[1].type = 'Column';\n            chart.series[0].marker.visible = false;\n            chart.series[1].marker.visible = false;\n            chart.primaryXAxis.labelRotation = 0;\n        }\n        else {\n            chart.series[0].type = 'Line';\n            chart.series[1].type = 'Line';\n            chart.series[0].marker.visible = true;\n            chart.series[0].marker.dataLabel.visible = true;\n            chart.series[0].marker.dataLabel.position = 'Top';\n            chart.series[1].marker.visible = true;\n            chart.series[1].marker.dataLabel.visible = true;\n            chart.series[1].marker.dataLabel.position = 'Top';\n            chart.primaryXAxis.labelRotation = 90;\n        }\n        chart.refresh();\n    };\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/chart/indexed-axis/index.ts?");

/***/ }),

/***/ "./samples/chart/indexed-axis/theme-color.ts":
/*!***************************************************!*\
  !*** ./samples/chart/indexed-axis/theme-color.ts ***!
  \***************************************************/
/*! no static exports found */
