...
/******/ 	var installedChunks = {
/******/ 		"./samples/chart/empty-point/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/chart/empty-point/index.ts","charts.min"]);
...
/***/ "./samples/chart/empty-point/index.ts":
/*!********************************************!*\
  !*** ./samples/chart/empty-point/index.ts ***!
  \********************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! @syncfusion/ej2/base */ \"./node_modules/@syncfusion/ej2/base.ts\"), __webpack_require__(/*! ./theme-color */ \"./samples/chart/empty-point/theme-color.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, ej2_dropdowns_1, base_1, theme_color_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_1.Chart.Inject(ej2_charts_1.ColumnSeries, ej2_charts_1.Category, ej2_charts_1.Legend, ej2_charts_1.Tooltip, ej2_charts_1.SplineSeries, ej2_charts_1.SplineAreaSeries);\n    var chart = new ej2_charts_1.Chart({\n        primaryXAxis: {\n            valueType: 'Category', interval: 1, labelIntersectAction: base_1.Browser.isDevice ? 'None' : 'Rotate45', labelRotation: base_1.Browser.isDevice ? -45 : 0, majorTickLines: { width: 0 },\n            minorTickLines: { width: 0 }, title: 'Product'\n        },\n        primaryYAxis: {\n            minimum: 0, maximum: 100, interval: 20, labelFormat: '{value}%', title: 'Profit'\n        },\n        series: [\n            {\n                type: 'Column', xName: 'x', width: 2, yName: 'y',\n                dataSource: [\n                    { x: 'Rice', y: 80 }, { x: 'Wheat', y: null }, { x: 'Oil', y: 70 },\n                    { x: 'Corn', y: 60 }, { x: 'Gram', y: null },\n                    { x: 'Milk', y: 70 }, { x: 'Peas', y: 80 },\n                    { x: 'Fruit', y: 60 }, { x: 'Butter', y: null }\n                ],\n                marker: { visible: false, height: 7, width: 7 },\n                emptyPointSettings: {\n                    fill: '#e6e6e6',\n                }\n            },\n        ],\n        legendSettings: { visible: false },\n        title: 'Annual Product-Wise Profit Analysis',\n        tooltip: { enable: true, enableMarker: false },\n        load: function (args) {\n            (0, theme_color_1.loadChartTheme)(args);\n        }\n    });\n    chart.appendTo('#container');\n    var mode = new ej2_dropdowns_1.DropDownList({\n        index: 0,\n        placeholder: 'Select Range Bar Color',\n        width: 120,\n        change: function () {\n            chart.series[0].emptyPointSettings.mode = mode.value;\n            chart.refresh();\n        }\n    });\n    mode.appendTo('#emptypointmode');\n    var edgeMode = new ej2_dropdowns_1.DropDownList({\n        index: 0,\n        placeholder: 'Select Range Bar Color',\n        width: 120,\n        change: function () {\n            chart.series[0].type = edgeMode.value;\n            if (edgeMode.value === 'Spline') {\n                chart.series[0].marker.visible = true;\n            }\n            else {\n                chart.series[0].marker.visible = false;\n            }\n            chart.refresh();\n        }\n    });\n    edgeMode.appendTo('#SelectSeriesType');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/chart/empty-point/index.ts?");

/***/ }),

/***/ "./samples/chart/empty-point/theme-color.ts":
/*!**************************************************!*\
  !*** ./samples/chart/empty-point/theme-color.ts ***!
  \**************************************************/
/*! no static exports found */
