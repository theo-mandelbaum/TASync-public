...
/******/ 	var installedChunks = {
/******/ 		"./samples/chart/synchronized-chart/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/chart/synchronized-chart/index.ts","charts.min"]);
...
/***/ "./samples/chart/synchronized-chart/financial-data.ts":
/*!************************************************************!*\
  !*** ./samples/chart/synchronized-chart/financial-data.ts ***!
  \************************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-charts */ \"./node_modules/@syncfusion/ej2-charts/index.js\"), __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! ./financial-data */ \"./samples/chart/synchronized-chart/financial-data.ts\"), __webpack_require__(/*! ./theme-color */ \"./samples/chart/synchronized-chart/theme-color.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_charts_1, ej2_base_2, financial_data_1, theme_color_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_charts_1.Chart.Inject(ej2_charts_1.AreaSeries, ej2_charts_1.SplineAreaSeries, ej2_charts_1.LineSeries, ej2_charts_1.SplineSeries, ej2_charts_1.DataLabel, ej2_charts_1.DateTime, ej2_charts_1.Tooltip, ej2_charts_1.Zoom, ej2_charts_1.Highlight, ej2_charts_1.Legend, ej2_charts_1.Selection, ej2_charts_1.Crosshair);\n    var charts = [];\n    var zoomFactor = 0;\n    var zoomPosition = 0;\n    var chart = new ej2_charts_1.Chart({\n        primaryXAxis: {\n            minimum: new Date(2023, 1, 18),\n            maximum: new Date(2023, 7, 18),\n            valueType: 'DateTime',\n            labelFormat: 'MMM d',\n            lineStyle: { width: 0 },\n            majorGridLines: { width: 0 },\n            edgeLabelPlacement: ej2_base_2.Browser.isDevice ? 'None' : 'Shift',\n            labelRotation: ej2_base_2.Browser.isDevice ? -45 : 0,\n            interval: ej2_base_2.Browser.isDevice ? 2 : 1\n        },\n        primaryYAxis: {\n            labelFormat: 'n2',\n            majorTickLines: { width: 0 },\n            lineStyle: { width: 0 },\n            minimum: 0.86,\n            maximum: 0.96,\n            interval: 0.025\n        },\n        chartArea: { border: { width: 0 } },\n        series: [\n            {\n                type: 'Line', dataSource: financial_data_1.synchronizedData, xName: 'USD', width: 2, yName: 'EUR', emptyPointSettings: { mode: 'Drop' }\n            }\n        ],\n        zoomSettings: {\n            enableMouseWheelZooming: true,\n            enablePinchZooming: true,\n            enableScrollbar: false,\n            enableDeferredZooming: false,\n            enablePan: true,\n            mode: 'X',\n            toolbarItems: ['Pan', 'Reset']\n        },\n        zoomComplete: function (args) {\n            if (args.axis.name === 'primaryXAxis') {\n                zoomFactor = args.currentZoomFactor;\n                zoomPosition = args.currentZoomPosition;\n                zoomCompleteFunction(args);\n            }\n        },\n        chartMouseLeave: function (args) {\n            chartobj.hideCrosshair();\n            chart3.hideCrosshair();\n            chart4.hideCrosshair();\n            chartobj.hideTooltip();\n            chart3.hideTooltip();\n            chart4.hideTooltip();\n        },\n        chartMouseMove: function (args) {\n            if ((!ej2_base_2.Browser.isDevice && !chart.isTouch && !chart.isChartDrag) || chart.startMove) {\n                chartobj.startMove = chart3.startMove = chart4.startMove = chart.startMove;\n                chartobj.showTooltip(args.x, args.y);\n                chart3.showTooltip(args.x, args.y);\n                chart4.showTooltip(args.x, args.y);\n                chartobj.showCrosshair(args.x, args.y);\n                chart3.showCrosshair(args.x, args.y);\n                chart4.showCrosshair(args.x, args.y);\n            }\n        },\n        chartMouseUp: function (args) {\n            if (ej2_base_2.Browser.isDevice && chart.startMove) {\n                chartobj.hideCrosshair();\n                chart3.hideCrosshair();\n                chart4.hideCrosshair();\n                chartobj.hideTooltip();\n                chart3.hideTooltip();\n                chart4.hideTooltip();\n            }\n        },\n        title: 'US to EURO',\n        titleStyle: { textAlignment: 'Near' },\n        tooltip: { enable: true, fadeOutDuration: ej2_base_2.Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>€${point.y}</b> <br> ${point.x} 2023', enableMarker: false, enableHighlight: true },\n        crosshair: { enable: true, lineType: 'Vertical', dashArray: '2,2' },\n        load: load\n    });\n    chart.appendTo('#container3');\n    charts.push(chart);\n    var chartobj = new ej2_charts_1.Chart({\n        primaryXAxis: {\n            minimum: new Date(2023, 1, 18),\n            maximum: new Date(2023, 7, 18),\n            valueType: 'DateTime',\n            labelFormat: 'MMM d',\n            lineStyle: { width: 0 },\n            majorGridLines: { width: 0 },\n            edgeLabelPlacement: ej2_base_2.Browser.isDevice ? 'None' : 'Shift',\n            labelRotation: ej2_base_2.Browser.isDevice ? -45 : 0,\n            interval: ej2_base_2.Browser.isDevice ? 2 : 1\n        },\n        primaryYAxis: {\n            labelFormat: '{value}',\n            majorTickLines: { width: 0 },\n            lineStyle: { width: 0 },\n            minimum: 120,\n            maximum: 152,\n            interval: 8,\n            labelPadding: 8\n        },\n        chartArea: { border: { width: 0 } },\n        series: [\n            {\n                type: 'Line', dataSource: financial_data_1.synchronizedData, xName: 'USD', width: 2, yName: 'JPY'\n            }\n        ],\n        zoomSettings: {\n            enableMouseWheelZooming: true,\n            enablePinchZooming: true,\n            enableScrollbar: false,\n            enableDeferredZooming: false,\n            enablePan: true,\n            mode: 'X',\n            toolbarItems: ['Pan', 'Reset']\n        },\n        zoomComplete: function (args) {\n            if (args.axis.name === 'primaryXAxis') {\n                zoomFactor = args.currentZoomFactor;\n                zoomPosition = args.currentZoomPosition;\n                zoomCompleteFunction(args);\n            }\n        },\n        chartMouseMove: function (args) {\n            if ((!ej2_base_2.Browser.isDevice && !chartobj.isTouch && !chartobj.isChartDrag) || chartobj.startMove) {\n                chart.startMove = chart3.startMove = chart4.startMove = chartobj.startMove;\n                chart.showTooltip(args.x, args.y);\n                chart3.showTooltip(args.x, args.y);\n                chart4.showTooltip(args.x, args.y);\n                chart.showCrosshair(args.x, args.y);\n                chart3.showCrosshair(args.x, args.y);\n                chart4.showCrosshair(args.x, args.y);\n            }\n        },\n        chartMouseLeave: function (args) {\n            chart.hideCrosshair();\n            chart3.hideCrosshair();\n            chart4.hideCrosshair();\n            chart.hideTooltip();\n            chart3.hideTooltip();\n            chart4.hideTooltip();\n        },\n        chartMouseUp: function (args) {\n            if (ej2_base_2.Browser.isDevice && chartobj.startMove) {\n                chart.hideCrosshair();\n                chart3.hideCrosshair();\n                chart4.hideCrosshair();\n                chart.hideTooltip();\n                chart3.hideTooltip();\n                chart4.hideTooltip();\n            }\n        },\n        title: 'US to Yen',\n        titleStyle: { textAlignment: 'Near' },\n        tooltip: { enable: true, fadeOutDuration: ej2_base_2.Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>¥${point.y}</b> <br> ${point.x} 2023', enableMarker: false, enableHighlight: true },\n        crosshair: { enable: true, lineType: 'Vertical', dashArray: '2,2' },\n        load: load\n    });\n    chartobj.appendTo('#container4');\n    charts.push(chartobj);\n    var chart3 = new ej2_charts_1.Chart({\n        primaryXAxis: {\n            minimum: new Date(2023, 1, 18),\n            maximum: new Date(2023, 7, 18),\n            valueType: 'DateTime',\n            labelFormat: 'MMM d',\n            lineStyle: { width: 0 },\n            majorGridLines: { width: 0 },\n            edgeLabelPlacement: ej2_base_2.Browser.isDevice ? 'None' : 'Shift',\n            labelRotation: ej2_base_2.Browser.isDevice ? -45 : 0,\n            interval: ej2_base_2.Browser.isDevice ? 2 : 1\n        },\n        primaryYAxis: {\n            labelFormat: 'n2',\n            majorTickLines: { width: 0 },\n            lineStyle: { width: 0 },\n            minimum: 1.30,\n            maximum: 1.37,\n            interval: 0.0175\n        },\n        chartArea: { border: { width: 0 } },\n        series: [\n            {\n                type: 'Area', dataSource: financial_data_1.synchronizedData, xName: 'USD', width: 2, yName: 'SGD', opacity: 0.6, border: { width: 2 }\n            }\n        ],\n        zoomSettings: {\n            enableMouseWheelZooming: true,\n            enablePinchZooming: true,\n            enableScrollbar: false,\n            enableDeferredZooming: false,\n            enablePan: true,\n            mode: 'X',\n            toolbarItems: ['Pan', 'Reset']\n        },\n        zoomComplete: function (args) {\n            if (args.axis.name === 'primaryXAxis') {\n                zoomFactor = args.currentZoomFactor;\n                zoomPosition = args.currentZoomPosition;\n                zoomCompleteFunction(args);\n            }\n        },\n        chartMouseMove: function (args) {\n            if ((!ej2_base_2.Browser.isDevice && !chart3.isTouch && !chart3.isChartDrag) || chart3.startMove) {\n                chart.startMove = chartobj.startMove = chart4.startMove = chart3.startMove;\n                chart.showTooltip(args.x, args.y);\n                chartobj.showTooltip(args.x, args.y);\n                chart4.showTooltip(args.x, args.y);\n                chart.showCrosshair(args.x, args.y);\n                chartobj.showCrosshair(args.x, args.y);\n                chart4.showCrosshair(args.x, args.y);\n            }\n        },\n        chartMouseLeave: function (args) {\n            chartobj.hideCrosshair();\n            chart.hideCrosshair();\n            chart4.hideCrosshair();\n            chartobj.hideTooltip();\n            chart.hideTooltip();\n            chart4.hideTooltip();\n        },\n        chartMouseUp: function (args) {\n            if (ej2_base_2.Browser.isDevice && chart3.startMove) {\n                chart.hideCrosshair();\n                chartobj.hideCrosshair();\n                chart4.hideCrosshair();\n                chart.hideTooltip();\n                chartobj.hideTooltip();\n                chart4.hideTooltip();\n            }\n        },\n        title: 'US to SGD',\n        titleStyle: { textAlignment: 'Near' },\n        tooltip: { enable: true, fadeOutDuration: ej2_base_2.Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>$${point.y}</b> <br> ${point.x} 2023', enableMarker: false },\n        crosshair: { enable: true, lineType: 'Vertical', dashArray: '2,2' },\n        load: load\n    });\n    chart3.appendTo('#container1');\n    charts.push(chart3);\n    var chart4 = new ej2_charts_1.Chart({\n        primaryXAxis: {\n            minimum: new Date(2023, 1, 18),\n            maximum: new Date(2023, 7, 18),\n            valueType: 'DateTime',\n            labelFormat: 'MMM d',\n            lineStyle: { width: 0 },\n            majorGridLines: { width: 0 },\n            edgeLabelPlacement: ej2_base_2.Browser.isDevice ? 'None' : 'Shift',\n            labelRotation: ej2_base_2.Browser.isDevice ? -45 : 0,\n            interval: ej2_base_2.Browser.isDevice ? 2 : 1\n        },\n        primaryYAxis: {\n            labelFormat: 'n1',\n            majorTickLines: { width: 0 },\n            lineStyle: { width: 0 },\n            minimum: 79,\n            maximum: 85,\n            interval: 1.5\n        },\n        chartArea: { border: { width: 0 } },\n        series: [\n            {\n                type: 'Area', dataSource: financial_data_1.synchronizedData, xName: 'USD', width: 2, yName: 'INR', opacity: 0.6, border: { width: 2 }\n            }\n        ],\n        zoomSettings: {\n            enableMouseWheelZooming: true,\n            enablePinchZooming: true,\n            enableScrollbar: false,\n            enableDeferredZooming: false,\n            enablePan: true,\n            mode: 'X',\n            toolbarItems: ['Pan', 'Reset']\n        },\n        zoomComplete: function (args) {\n            if (args.axis.name === 'primaryXAxis') {\n                zoomFactor = args.currentZoomFactor;\n                zoomPosition = args.currentZoomPosition;\n                zoomCompleteFunction(args);\n            }\n        },\n        chartMouseMove: function (args) {\n            if ((!ej2_base_2.Browser.isDevice && !chart4.isTouch && !chart4.isChartDrag) || chart4.startMove) {\n                chart.startMove = chartobj.startMove = chart3.startMove = chart4.startMove;\n                chart.showTooltip(args.x, args.y);\n                chartobj.showTooltip(args.x, args.y);\n                chart3.showTooltip(args.x, args.y);\n                chart.showCrosshair(args.x, args.y);\n                chartobj.showCrosshair(args.x, args.y);\n                chart3.showCrosshair(args.x, args.y);\n            }\n        },\n        chartMouseLeave: function (args) {\n            chartobj.hideCrosshair();\n            chart3.hideCrosshair();\n            chart.hideCrosshair();\n            chartobj.hideTooltip();\n            chart3.hideTooltip();\n            chart.hideTooltip();\n        },\n        chartMouseUp: function (args) {\n            if (ej2_base_2.Browser.isDevice && chart4.startMove) {\n                chart.hideCrosshair();\n                chartobj.hideCrosshair();\n                chart3.hideCrosshair();\n                chart.hideTooltip();\n                chartobj.hideTooltip();\n                chart3.hideTooltip();\n            }\n        },\n        title: 'US to INR',\n        titleStyle: { textAlignment: 'Near' },\n        tooltip: { enable: true, fadeOutDuration: ej2_base_2.Browser.isDevice ? 2500 : 1000, showNearestTooltip: true, header: '', format: '<b>₹${point.y}</b> <br> ${point.x} 2023', enableMarker: false },\n        crosshair: { enable: true, lineType: 'Vertical', dashArray: '2,2' },\n        load: load\n    });\n    chart4.appendTo('#container2');\n    charts.push(chart4);\n    function zoomCompleteFunction(args) {\n        for (var i = 0; i < charts.length; i++) {\n            if (args.axis.series[0].chart.element.id !== charts[i].element.id) {\n                charts[i].primaryXAxis.zoomFactor = zoomFactor;\n                charts[i].primaryXAxis.zoomPosition = zoomPosition;\n                charts[i].zoomModule.isZoomed = args.axis.series[0].chart.zoomModule.isZoomed;\n                charts[i].zoomModule.isPanning = args.axis.series[0].chart.zoomModule.isPanning;\n            }\n        }\n    }\n    function load(args) {\n        (0, theme_color_1.loadChartTheme)(args);\n        var themeColor = [];\n        if (args.chart.theme === 'MaterialDark') {\n            themeColor = theme_color_1.pointMaterialDarkColors;\n        }\n        else if (args.chart.theme === 'Material') {\n            themeColor = theme_color_1.pointMaterialColors;\n        }\n        else if (args.chart.theme === \"Fabric\") {\n            themeColor = theme_color_1.pointFabricColors;\n        }\n        else if (args.chart.theme === \"FabricDark\") {\n            themeColor = theme_color_1.pointFabricColors;\n        }\n        else if (args.chart.theme === 'Bootstrap5Dark') {\n            themeColor = theme_color_1.pointBootstrap5DarkColors;\n        }\n        else if (args.chart.theme === 'Bootstrap5') {\n            themeColor = theme_color_1.pointBootstrap5Colors;\n        }\n        else if (args.chart.theme === \"Bootstrap4\") {\n            themeColor = theme_color_1.keyBootstrap4Colors;\n        }\n        else if (args.chart.theme === 'TailwindDark') {\n            themeColor = theme_color_1.pointTailwindDarkColors;\n        }\n        else if (args.chart.theme === 'Tailwind') {\n            themeColor = theme_color_1.pointTailwindColors;\n        }\n        else if (args.chart.theme === 'Tailwind3Dark') {\n            themeColor = theme_color_1.pointTailwind3DarkColors;\n        }\n        else if (args.chart.theme === 'Tailwind3') {\n            themeColor = theme_color_1.pointTailwind3Colors;\n        }\n        else if (args.chart.theme === \"HighContrast\") {\n            themeColor = theme_color_1.pointHighContrastColors;\n        }\n        else if (args.chart.theme === 'FluentDark') {\n            themeColor = theme_color_1.pointFluentDarkColors;\n        }\n        else if (args.chart.theme === 'Bootstrap') {\n            themeColor = theme_color_1.pointBootstrapColors;\n        }\n        else if (args.chart.theme === 'BootstrapDark') {\n            themeColor = theme_color_1.pointBootstrapColors;\n        }\n        else if (args.chart.theme === 'Material3') {\n            themeColor = theme_color_1.pointMaterial3Colors;\n        }\n        else if (args.chart.theme === 'Material3Dark') {\n            themeColor = theme_color_1.pointMaterial3DarkColors;\n        }\n        else if (args.chart.theme === 'Fluent2') {\n            themeColor = theme_color_1.pointFluent2Colors;\n        }\n        else if (args.chart.theme === 'Fluent2HighContrast' || args.chart.theme === 'Fluent2Dark') {\n            themeColor = theme_color_1.pointFluent2DarkColors;\n        }\n        else {\n            themeColor = theme_color_1.pointFluentColors;\n        }\n        if (args.chart.element.id === 'container3') {\n            args.chart.series[0].fill = themeColor[0];\n        }\n        else if (args.chart.element.id === 'container4') {\n            args.chart.series[0].fill = themeColor[1];\n        }\n        else if (args.chart.element.id === 'container1') {\n            args.chart.series[0].fill = themeColor[2];\n        }\n        else if (args.chart.element.id === 'container2') {\n            args.chart.series[0].fill = themeColor[3];\n        }\n    }\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/chart/synchronized-chart/index.ts?");

/***/ }),

/***/ "./samples/chart/synchronized-chart/theme-color.ts":
/*!*********************************************************!*\
  !*** ./samples/chart/synchronized-chart/theme-color.ts ***!
  \*********************************************************/
/*! no static exports found */
