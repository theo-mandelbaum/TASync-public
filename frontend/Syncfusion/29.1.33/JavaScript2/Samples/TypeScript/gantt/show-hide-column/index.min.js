...
/******/ 	var installedChunks = {
/******/ 		"./samples/gantt/show-hide-column/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/gantt/show-hide-column/index.ts","gantt.min"]);
...
/***/ "./samples/gantt/show-hide-column/data-source.ts":
/*!*******************************************************!*\
  !*** ./samples/gantt/show-hide-column/data-source.ts ***!
  \*******************************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! @syncfusion/ej2-buttons */ \"./node_modules/@syncfusion/ej2-buttons/index.js\"), __webpack_require__(/*! @syncfusion/ej2-gantt */ \"./node_modules/@syncfusion/ej2-gantt/index.js\"), __webpack_require__(/*! ./data-source */ \"./samples/gantt/show-hide-column/data-source.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_dropdowns_1, ej2_buttons_1, ej2_gantt_1, data_source_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_gantt_1.Gantt.Inject(ej2_gantt_1.Selection);\n    var columnsName = [\n        { id: 'TaskID', name: 'ID' },\n        { id: 'StartDate', name: 'Start Date' },\n        { id: 'EndDate', name: 'End Date' },\n        { id: 'Duration', name: 'Duration' },\n        { id: 'Predecessor', name: 'Dependency' },\n        { id: 'Progress', name: 'Progress' }\n    ];\n    var gantt = new ej2_gantt_1.Gantt({\n        dataSource: data_source_1.projectNewData,\n        height: '450px',\n        highlightWeekends: true,\n        taskFields: {\n            id: 'TaskID',\n            name: 'TaskName',\n            startDate: 'StartDate',\n            endDate: 'EndDate',\n            duration: 'Duration',\n            progress: 'Progress',\n            dependency: 'Predecessor',\n            child: 'subtasks'\n        },\n        treeColumnIndex: 1,\n        labelSettings: {\n            leftLabel: 'TaskName'\n        },\n        splitterSettings: {\n            columnIndex: 3\n        },\n        projectStartDate: new Date('03/24/2024'),\n        projectEndDate: new Date('07/06/2024')\n    });\n    gantt.appendTo('#ShowHideColumn');\n    var dropDownListObject = new ej2_dropdowns_1.DropDownList({\n        dataSource: columnsName,\n        fields: { text: 'name', value: 'id' },\n        value: 'TaskID',\n        change: function (e) {\n            var columnName = e.value;\n            var column = gantt.treeGrid.grid.getColumnByField(columnName);\n            if (column.visible === undefined || column.visible) {\n                show.disabled = true;\n                hide.disabled = false;\n            }\n            else {\n                hide.disabled = true;\n                show.disabled = false;\n            }\n        }\n    });\n    dropDownListObject.appendTo('#ddlelement');\n    var show = new ej2_buttons_1.Button({ disabled: true });\n    show.appendTo('#show');\n    var hide = new ej2_buttons_1.Button();\n    hide.appendTo('#hide');\n    var hiddenColumns = document.getElementById('hiddencolumns');\n    document.getElementById('show').addEventListener('click', function () {\n        var dropValue = dropDownListObject.value;\n        var columnName = gantt.treeGrid.getColumnByField(dropValue).headerText;\n        gantt.showColumn(columnName);\n        show.disabled = true;\n        hide.disabled = false;\n        hiddenColumns.value = hiddenColumns.value.replace(columnName + '\\n', '');\n    });\n    document.getElementById('hide').addEventListener('click', function () {\n        var dropValue = dropDownListObject.value;\n        var columnName = gantt.treeGrid.getColumnByField(dropValue).headerText;\n        gantt.hideColumn(columnName);\n        hide.disabled = true;\n        show.disabled = false;\n        hiddenColumns.value = hiddenColumns.value + columnName + '\\n';\n    });\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/gantt/show-hide-column/index.ts?");
