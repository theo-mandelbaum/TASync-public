...
/******/ 	var installedChunks = {
/******/ 		"./samples/gantt/reorder/index.min": 0
/******/ 	};
/******/
/******/ 	var deferredModules = [];
/******/
...
/******/ 	deferredModules.push(["./samples/gantt/reorder/index.ts","gantt.min"]);
...
/***/ "./samples/gantt/reorder/data-source.ts":
/*!**********************************************!*\
  !*** ./samples/gantt/reorder/data-source.ts ***!
  \**********************************************/
...
eval("var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(/*! @syncfusion/ej2-base */ \"./node_modules/@syncfusion/ej2-base/index.js\"), __webpack_require__(/*! @syncfusion/ej2-dropdowns */ \"./node_modules/@syncfusion/ej2-dropdowns/index.js\"), __webpack_require__(/*! @syncfusion/ej2-gantt */ \"./node_modules/@syncfusion/ej2-gantt/index.js\"), __webpack_require__(/*! ./data-source */ \"./samples/gantt/reorder/data-source.ts\")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, ej2_base_1, ej2_dropdowns_1, ej2_gantt_1, data_source_1) {\n    \"use strict\";\n    Object.defineProperty(exports, \"__esModule\", { value: true });\n    (0, ej2_base_1.enableRipple)(window.ripple);\n    ej2_gantt_1.Gantt.Inject(ej2_gantt_1.Selection, ej2_gantt_1.Reorder);\n    var columnNames = [\n        { id: 'TaskID', name: 'ID' },\n        { id: 'TaskName', name: 'Name' },\n        { id: 'StartDate', name: 'Start Date' },\n        { id: 'EndDate', name: 'End Date' },\n        { id: 'Duration', name: 'Duration' },\n        { id: 'Progress', name: 'Progress' },\n        { id: 'Predecessor', name: 'Dependency' }\n    ];\n    var columnsIndex = [\n        { id: '0', name: '1' },\n        { id: '1', name: '2' },\n        { id: '2', name: '3' },\n        { id: '3', name: '4' },\n        { id: '4', name: '5' },\n        { id: '5', name: '6' },\n        { id: '6', name: '7' }\n    ];\n    var gantt = new ej2_gantt_1.Gantt({\n        dataSource: data_source_1.projectNewData,\n        height: '450px',\n        highlightWeekends: true,\n        allowReordering: true,\n        taskFields: {\n            id: 'TaskID',\n            name: 'TaskName',\n            startDate: 'StartDate',\n            endDate: 'EndDate',\n            duration: 'Duration',\n            progress: 'Progress',\n            dependency: 'Predecessor',\n            child: 'subtasks'\n        },\n        columns: [\n            { field: 'TaskID', headerText: 'ID', width: 100 },\n            { field: 'TaskName', headerText: 'Name', width: 250 },\n            { field: 'StartDate' },\n            { field: 'EndDate' },\n            { field: 'Duration' },\n            { field: 'Progress' },\n            { field: 'Predecessor', headerText: 'Dependency' }\n        ],\n        treeColumnIndex: 1,\n        labelSettings: {\n            leftLabel: 'TaskName'\n        },\n        splitterSettings: {\n            columnIndex: 4\n        },\n        actionComplete: function (args) {\n            if (args.requestType === 'reorder') {\n                var columnName = dropDownColumn.value;\n                var index = gantt.treeGrid.getColumnIndexByField(columnName);\n                dropDownIndex.value = index.toString();\n            }\n        },\n        projectStartDate: new Date('03/24/2024'),\n        projectEndDate: new Date('07/06/2024')\n    });\n    gantt.appendTo('#ReorderColumn');\n    var dropDownColumn = new ej2_dropdowns_1.DropDownList({\n        dataSource: columnNames,\n        fields: { text: 'name', value: 'id' },\n        value: 'TaskID',\n        change: function (e) {\n            var columnName = e.value;\n            var index = gantt.treeGrid.getColumnIndexByField(columnName);\n            dropDownIndex.value = index.toString();\n        }\n    });\n    dropDownColumn.appendTo('#columns');\n    var dropDownIndex = new ej2_dropdowns_1.DropDownList({\n        dataSource: columnsIndex,\n        fields: { text: 'name', value: 'id' },\n        value: '0',\n        change: function (e) {\n            var columnName = dropDownColumn.value;\n            var toColumnIndex = e.value;\n            gantt.reorderColumns(columnName, gantt.treeGrid.columns[toColumnIndex].field);\n        }\n    });\n    dropDownIndex.appendTo('#columnIndex');\n}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),\n\t\t\t\t__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));\n\n\n//# sourceURL=webpack:///./samples/gantt/reorder/index.ts?");
