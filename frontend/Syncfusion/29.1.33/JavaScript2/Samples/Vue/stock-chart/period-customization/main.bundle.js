...
/***/ "./Samples/stock-chart/period-customization/theme-color.ts":
/*!*****************************************************************!*\
  !*** ./Samples/stock-chart/period-customization/theme-color.ts ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   loadStockChartTheme: () => (/* binding */ loadStockChartTheme)\n/* harmony export */ });\nvar loadStockChartTheme = function (args, isGradient) {\n    var selectedTheme = location.hash.split(\"/\")[1];\n    selectedTheme = selectedTheme ? selectedTheme : \"Tailwind3\";\n    var theme = (selectedTheme.charAt(0).toUpperCase() + selectedTheme.slice(1))\n        .replace(/-dark/i, \"Dark\")\n        .replace(/light/i, \"Light\")\n        .replace(/contrast/i, \"Contrast\")\n        .replace(/-highContrast/i, \"HighContrast\");\n    if (args) {\n        args.stockChart.theme = theme;\n        return isGradient ? selectedTheme : args.stockChart.theme;\n    }\n    else if (isGradient && !args) {\n        return selectedTheme;\n    }\n    else {\n        return theme;\n    }\n};\n\n\n//# sourceURL=webpack://ej2-charts-vue-samples/./Samples/stock-chart/period-customization/theme-color.ts?");
