export let Locale: Object={
  "de": {
    ...
    "documenteditor": {
      ...
      "Contextual Spacing": "Fügen Sie keinen Abstand zwischen den Absätzen derselben Stile hinzu.",
      "Password Mismatch": "Das Kennwort stimmt nicht überein  ",
      ...
      "Select Part Of Document And User": "Wählen Sie Teile des Dokuments aus, und wählen Sie Benutzer aus, die sie frei bearbeiten dürfen.  ",
      "Everyone": "Jeder",
      "More users": "Mehr Benutzer",
      "Add Users": "Hinzufügen von Benutzern",
      "Enforcing Protection": "Ja, Starten Sie die Durchsetzung des Schutzes",
      ...
      "Protected Document": "Dieses Dokument ist vor unbeabsichtigter Bearbeitung geschützt. Sie  können in dieser Region bearbeiten.",
      ...
      "more": "Mehr",
      "Type your comment here": "Geben Sie Ihren Kommentar ein",
      "Next Comment": "Nächster Kommentar",
      "Previous Comment": "Vorheriger Kommentar",
      "Un-posted comments": "Nicht gepostete Kommentare",
      "Discard Comment": "Kommentare wurden nicht gepostet. Wenn Sie fortfahren, wird dieser Kommentar verworfen.",
      ...
      "Merge Track": "Diese Aktion wird nicht als Änderung markiert. Möchtest du weiter machen?",
    ...
    "documenteditorcontainer": {
      ...
      "Different Odd And Even Pages": "Verschiedene Odd & Even Seiten",
      ...
      "Underline Tooltip": "Unterstreichung (Strg+U)",
      "Strikethrough": "Durchgestrichen",
      "Superscript Tooltip": "Hochschrift (Strg+Umschalt++)",
      "Subscript Tooltip": "Subskription (Strg+=)",
      "Align left Tooltip": "Links ausrichten (Strg+L)",
      "Center Tooltip": "Mitte (Strg+E)",
      "Align right Tooltip": "Rechts ausrichten (Strg+R)",
      "Justify Tooltip": "Justify (Strg+J)",
      ...
      "Undo Tooltip": "Rückgängigmachen des letzten Vorgangs (Strg+Z).",
      "Redo Tooltip": "Wiederholen Sie den letzten Vorgang (Strg+Y).",
      ...
      "Create Hyperlink": "Erstellen Sie einen Link in Ihrem Dokument für den schnellen Zugriff auf Webseiten und Dateien (Strg+K).",
      ...
      "Find Text": "Suchen von Text im Dokument (Strg+F).",
      ...
      "Current Page Number": "Die aktuelle Seitenzahl im Dokument. Klicken oder tippen Sie, um auf einer bestimmten Seite zu navigieren.",
      "Read only": "Nur lesen",
      "Protections": "Schutz",
      "Error in establishing connection with web server": "Fehler beim Herstellen einer Verbindung mit dem Webserver",
      "Single": "Einzelnen",
    ...
    "schedule": {
      ...
      "overlapAlert": "Veranstaltungen können nicht während der gewählten Zeit geplant werden, da sie sich mit einer anderen Veranstaltung überschneiden.",
      "ok": "OK",
      "yes": "Ja",
      "no": "Nein",
    ...
    "treegrid": {
      ...
      "EmptyDataSourceError": "DataSource darf beim erstmaligen Laden nicht leer sein, da Spalten aus dataSource in AutoGenerate Column TreeGrid generiert werden",
      "Add": "Hinzufügen",
      "Edit": "Bearbeiten",
      "Cancel": "Stornieren",
      "Update": "Aktualisieren",
  ...
  "ar": {
    ...
    "schedule": {
      ...
      "overlapAlert": "لا يمكن جدولة الأحداث خلال الوقت المحدد لأنها تتداخل مع حدث آخر.",
      "ok": "حسنا",
      "yes": "نعم",
      "no": "لا",
      "occurrence": "حادثة",
    ...
    "uploader": {
      ...
      "removedFailedMessage": "غير قادر على إزالة الملف",
      "inProgress": "تحميل",
  ...
  "en": {
    ...
    "treegrid": {
      ...
      "EmptyDataSourceError": "DataSource must not be empty at initial load since columns are generated from dataSource in AutoGenerate Column TreeGrid",
      "Add": "Add",
      "Edit": "Edit",
      "Cancel": "Cancel",
      "Update": "Update",
  ...
  "zh": {
    ...
    "documenteditor": {
      ...
      "Contextual Spacing": "不要在相同樣式的段落之間添加距離。",
      ...
      "Select Part Of Document And User": "選擇文檔的某些部分，並選擇可以自由編輯它們的使用者。",
      "Everyone": "每個",
      "More users": "更多使用者",
      "Add Users": "添加使用者",
      "Enforcing Protection": "是，開始實施保護",
      ...
      "Protected Document": "本文檔受到保護，不受意外編輯。 您可以在此區域中進行編輯。 ",
      ...
      "more": "更",
      "Type your comment here": "輸入您的評論",
      "Next Comment": "下一個評論",
      "Previous Comment": "上一條評論",
      "Un-posted comments": "未發佈的注釋",
      "Discard Comment": "添加了未發佈的注釋。如果繼續，該注釋將被丟棄。",
      "Drop Down Form Field": "下拉表格字段",
      "Drop-down items": "下拉项目",
      "Items in drop-down list": "下拉列表中的项目",
      "ADD": "加",
      "REMOVE": "去掉",
      "Field settings": "栏位设定",
      "Tooltip": "工具提示",
      "Drop-down enabled": "启用下拉",
      "Check Box Form Field": "复选框表格字段",
      "Check box size": "复选框尺寸",
      "Auto": "汽车",
      "Default value": "默认值",
      "Not checked": "未检查",
      "Checked": "已检查",
      "Check box enabled": "复选框已启用",
      "Text Form Field": "文字表格栏位",
      "Type": "类型",
      "Default text": "默认文字",
      "Maximum length": "最大长度",
      "Text format": "文字格式",
      "Fill-in enabled": "启用填写",
      "Default number": "默认号码",
      "Default date": "预设日期",
      "Date format": "日期格式",
      "Merge Track": "此操作不会被标记为更改。你想继续吗?",
      "UnTrack": "无法追踪",
      "Accept": "接受",
      "Reject": "拒绝",
    ...
    "documenteditorcontainer": {
      ...
      "Italic Tooltip": "斜體（Ctrl_I）",
      "Underline Tooltip": "底線 （Ctrl+U）",
      "Strikethrough": "罷工",
      "Superscript Tooltip": "上標（Ctrl_Shift_）",
      "Subscript Tooltip": "下標（Ctrl_）",
      "Align left Tooltip": "向左對齊（Ctrl+L）",
      "Center Tooltip": "中心（Ctrl+E）",
      "Align right Tooltip": "向右對齊（Ctrl+R）",
      "Justify Tooltip": "對齊 （Ctrl_J）",
      ...
      "Undo Tooltip": "撤銷最後一個操作 （Ctrl+Z）。",
      "Redo Tooltip": "重做最後一個操作 （Ctrl+Y）。",
      "Insert inline picture from a file": "從檔中插入內聯圖片。",
      "Insert a table into the document": "將表插入到文檔中",
      "Create Hyperlink": "在文檔中創建連結以快速訪問網頁和檔 （Ctrl+K）。",
      ...
      "Restrict editing.": "限制編輯。",
      "Current Page Number": "文檔中的當前頁碼。按一下或點擊以導航特定頁面。",
      "Read only": "唯讀",
      "Protections": "保護",
      ...
      "DropDown": "落下",
      "Update Fields": "更新栏位",
      "Update cross reference fields": "更新交叉参考字段",
    ...
    "schedule": {
      ...
      "overlapAlert": "無法在所選時間安排事件，因為它們與其他事件重疊。",
      "ok": "好",
      "yes": "是",
      "no": "沒有",
      "occurrence": "發生",
  ...
  "fr-CH": {
    ...
    "documenteditor": {
      ...
      "Linked Style": "Linked (Paragraphe et Caractère)",
      ...
      "Protected Document": "Ce document est protégé contre l'édition involontaire. Vous pouvez modifier dans cette région.",
      ...
      "more": "Plus",
      "Type your comment here": "Tapez votre commentaire entendre",
      "Next Comment": "Commentaire suivant",
      "Previous Comment": "Commentaire précédent",
      "Un-posted comments": "Commentaires non publiés",
      "Discard Comment": "Ajout de commentaires non affichés. Si vous continuez, ce commentaire sera rejeté.",
      ...
      "Merge Track": "Cette action ne sera pas marquée comme un changement. Voulez-vous continuer?",
      "UnTrack": "Ne peut pas être suivi",
      "Accept": "J'accepte",
      "Reject": "Rejeter",
      "Previous Changes": "Modifications précédentes",
      "Next Changes": "Prochaines modifications",
      "Inserted": "Inséré",
      "Deleted": "Effacé",
      "Changes": "Changements",
      ...
      "User": "Utilisatrice(feminine) OR Utilisateur(masculine)",
      "View": "Vue"
    },
    "documenteditorcontainer": {
      "New": "Nouveau",
      ...
      "Bold Tooltip": "Audacieux (Ctrl-B)",
      "Italic Tooltip": "Italique (Ctrl -I)",
      "Underline Tooltip": "Underline (Ctrl-U)",
      "Strikethrough": "Barré",
      "Superscript Tooltip": "Superscript(Ctrl-Shift)",
      "Subscript Tooltip": "Sous-scripte (CtrlMD)",
      "Align left Tooltip": "Alignement à gauche (Ctrl-L)",
      "Center Tooltip": "Centre (Ctrl-E)",
      "Align right Tooltip": "Alignement à droite (Ctrl -R)",
      ...
      "Undo Tooltip": "Annuler la dernière opération (Ctrl-Z).",
      "Redo Tooltip": "Refaites la dernière opération (Ctrl-Y).",
      ...
      "Find Text": "Trouver du texte dans le document (Ctrl-F).",
      ...
      "Restrict editing.": "Restreindre l'édition.",
      "Current Page Number": "Le numéro de page actuel dans le document. Cliquez ou appuyez sur pour naviguer sur une page spécifique.",
      "Read only": "Lire uniquement",
      "Protections": "Protections",
      "Error in establishing connection with web server": "Erreur dans l'établissement de la connexion avec le serveur web",
      "Single": "Seul",
      ...
      "Track Changes": "Gardez une trace des modifications apportées dans le document",
    ...
    "numerictextbox": {
      "incrementTitle": "Valeur d'incrément",
    ...
    "schedule": {
      ...
      "overlapAlert": "Les événements ne peuvent pas être programmés pendant la période sélectionnée car ils se chevauchent avec un autre événement.",
      "ok": "D'accord",
      "yes": "Oui",
      "no": "Non",
      "occurrence": "Occurrence",
