...
<script>
  ...
  const url = "https://ej2services.syncfusion.com/production/web-services/api/pdfviewer/Redaction";
  ...
  export default {
    ...
    data() {
      return {
        ...
        path: {
            saveUrl:
                'https://ej2services.syncfusion.com/production/web-services/api/FileUploader/Save',
            removeUrl:
                'https://ej2services.syncfusion.com/production/web-services/api/FileUploader/Remove',
        },
